...
[섬네일](https://ko.wikipedia.org/wiki/파일:2.4_GHz_Wi-Fi_channels_\(802.11b,g_WLAN\).svg "wikilink")

| 채널 | 중심 주파수    | 주파수 델타 | 채널 폭            | 오버랩 채널     |
| -- | --------- | ------ | --------------- | ---------- |
...
## 외부 링크
  ...
  - [IEEE 802.11b-1999 표준 다운로드](http://standards.ieee.org/getieee802/download/802.11b-1999.pdf)
