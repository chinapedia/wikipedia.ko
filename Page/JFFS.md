...
**저널링 플래시 파일 시스템**( 흔히들 **JFFS**라고 한다.)은 NOR [플래시 메모리](../Page/플래시_메모리.md "wikilink") 장치에 쓰이는 [리눅스](../Page/리눅스.md "wikilink") [로그 구조 파일 시스템이다](https://ko.wikipedia.org/wiki/로그_구조_파일_시스템 "wikilink"). 후속 버전으로는 [JFFS2](../Page/JFFS2.md "wikilink")가 있다.
