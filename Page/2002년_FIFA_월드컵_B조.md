...
|          |                        |                       |                        |                        |                           |                  |               |                   |                 |                |                 |          |                        |                       |                        |                                   |               |                 |              |                  |                 |               |                |
| -------- | ---------------------- | --------------------- | ---------------------- | ---------------------- | ------------------------- | ---------------- | ------------- | ----------------- | --------------- | -------------- | --------------- | -------- | ---------------------- | --------------------- | ---------------------- | --------------------------------- | ------------- | --------------- | ------------ | ---------------- | --------------- | ------------- | -------------- |
| {{축구 유니폼 | pattern_la = _par02H | pattern_b = _par02H | pattern_ra = _par02H | pattern_sh = _par02H | pattern_so = _whiteline | leftarm = FFFFFF | body = FFFFFF | rightarm = FFFFFF | shorts = FFFFFF | socks = 0000FF | title = 파라과이 }} | {{축구 유니폼 | pattern_la = _rsa02h | pattern_b = _rsa02h | pattern_ra = _rsa02h | pattern_sh = _adidasonwhite2002 | pattern_so = | leftarm = FFFFF | body = FFFFF | rightarm = FFFFF | shorts = FFFF00 | socks = FFFFF | title = 남아공 }} |
...
|          |                          |                         |                          |                          |               |                  |               |                   |                 |                |                |          |               |                       |               |                        |                        |                  |               |                   |                 |                |                  |
| -------- | ------------------------ | ----------------------- | ------------------------ | ------------------------ | ------------- | ---------------- | ------------- | ----------------- | --------------- | -------------- | -------------- | -------- | ------------- | --------------------- | ------------- | ---------------------- | ---------------------- | ---------------- | ------------- | ----------------- | --------------- | -------------- | ---------------- |
| {{축구 유니폼 | pattern_la = _esp0204h | pattern_b = _esp0204h | pattern_ra = _esp0204h | pattern_sh = _esp0204h | pattern_so = | leftarm = e80113 | body = e80113 | rightarm = e80113 | shorts = 0000FF | socks = 003060 | title = 스페인 }} | {{축구 유니폼 | pattern_la = | pattern_b = _slo01h | pattern_ra = | pattern_sh = _slo01h | pattern_so = _slo01h | leftarm = FFFFFF | body = FFFFFF | rightarm = FFFFFF | shorts = FFFFFF | socks = FFFFFF | title = 슬로베니아 }} |
...
|          |                          |                         |                          |                          |               |                  |               |                   |                 |                |                |          |                        |                       |                        |                        |                          |                  |               |                   |                 |                |                 |
| -------- | ------------------------ | ----------------------- | ------------------------ | ------------------------ | ------------- | ---------------- | ------------- | ----------------- | --------------- | -------------- | -------------- | -------- | ---------------------- | --------------------- | ---------------------- | ---------------------- | ------------------------ | ---------------- | ------------- | ----------------- | --------------- | -------------- | --------------- |
| {{축구 유니폼 | pattern_la = _esp0204h | pattern_b = _esp0204h | pattern_ra = _esp0204h | pattern_sh = _esp0204h | pattern_so = | leftarm = e80113 | body = e80113 | rightarm = e80113 | shorts = 0000FF | socks = 003060 | title = 스페인 }} | {{축구 유니폼 | pattern_la = _par02A | pattern_b = _par02A | pattern_ra = _par02A | pattern_sh = _par02A | pattern_so = _navyline | leftarm = FFFFFF | body = FFFFFF | rightarm = FFFFFF | shorts = FFFFFF | socks = FFFFFF | title = 파라과이 }} |
...
|          |                        |                       |                        |                                   |               |                 |              |                  |                 |               |                |          |               |                       |               |                            |                        |                  |               |                   |                 |                |                  |
| -------- | ---------------------- | --------------------- | ---------------------- | --------------------------------- | ------------- | --------------- | ------------ | ---------------- | --------------- | ------------- | -------------- | -------- | ------------- | --------------------- | ------------- | -------------------------- | ---------------------- | ---------------- | ------------- | ----------------- | --------------- | -------------- | ---------------- |
| {{축구 유니폼 | pattern_la = _rsa02h | pattern_b = _rsa02h | pattern_ra = _rsa02h | pattern_sh = _adidasonwhite2002 | pattern_so = | leftarm = FFFFF | body = FFFFF | rightarm = FFFFF | shorts = FFFF00 | socks = FFFFF | title = 남아공 }} | {{축구 유니폼 | pattern_la = | pattern_b = _slo01a | pattern_ra = | pattern_sh = _whitesides | pattern_so = _slo01a | leftarm = 006060 | body = FFFFFF | rightarm = 006060 | shorts = 006060 | socks = 006060 | title = 슬로베니아 }} |
...
|          |                        |                            |                             |                        |               |                  |               |                   |                 |                |                |          |                          |                         |                          |                          |               |                  |               |                   |                 |                |                |
| -------- | ---------------------- | -------------------------- | --------------------------- | ---------------------- | ------------- | ---------------- | ------------- | ----------------- | --------------- | -------------- | -------------- | -------- | ------------------------ | ----------------------- | ------------------------ | ------------------------ | ------------- | ---------------- | ------------- | ----------------- | --------------- | -------------- | -------------- |
| {{축구 유니폼 | pattern_la = _rsa08h | pattern_b = _rsa02_away | pattern_ra = _rsa02_away | pattern_sh = _rsa02a | pattern_so = | leftarm = F7EB29 | body = F7EB29 | rightarm = F7EB29 | shorts = FFFF00 | socks = FFFF00 | title = 남아공 }} | {{축구 유니폼 | pattern_la = _esp0204h | pattern_b = _esp0204h | pattern_ra = _esp0204h | pattern_sh = _esp0204h | pattern_so = | leftarm = e80113 | body = e80113 | rightarm = e80113 | shorts = 0000FF | socks = 003060 | title = 스페인 }} |
...
|          |               |                       |               |                        |                        |                  |               |                   |                 |                |                  |          |                        |                       |                        |                        |                           |                  |               |                   |                 |                |                 |
| -------- | ------------- | --------------------- | ------------- | ---------------------- | ---------------------- | ---------------- | ------------- | ----------------- | --------------- | -------------- | ---------------- | -------- | ---------------------- | --------------------- | ---------------------- | ---------------------- | ------------------------- | ---------------- | ------------- | ----------------- | --------------- | -------------- | --------------- |
| {{축구 유니폼 | pattern_la = | pattern_b = _slo01h | pattern_ra = | pattern_sh = _slo01h | pattern_so = _slo01h | leftarm = FFFFFF | body = FFFFFF | rightarm = FFFFFF | shorts = FFFFFF | socks = FFFFFF | title = 슬로베니아 }} | {{축구 유니폼 | pattern_la = _par02H | pattern_b = _par02H | pattern_ra = _par02H | pattern_sh = _par02H | pattern_so = _whiteline | leftarm = FFFFFF | body = FFFFFF | rightarm = FFFFFF | shorts = FFFFFF | socks = 0000FF | title = 파라과이 }} |
