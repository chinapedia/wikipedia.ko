...
만약 임의의 \(A,B\in\mathcal A\)에 대하여 다음 네 조건들을 모두 만족시키는 [연속 함수](https://ko.wikipedia.org/wiki/연속_함수 "wikilink")

\[F_{AB}\colon\mathbb R+\mathrm i[0,\beta]\to\mathbb C\] 가 존재한다면, \(\phi\)를 **\(\beta\)에서의 구보-마틴-슈윙거 상태**()라고 한다.\[1\]

  - \(F_{AB}\)의 [치역](https://ko.wikipedia.org/wiki/치역 "wikilink")은 [유계 집합이다](https://ko.wikipedia.org/wiki/유계_집합 "wikilink").
  - \(F_{AB}\restriction\left(\mathbb R+\mathrm i(0,\beta)\right)\)는 [정칙 함수이다](https://ko.wikipedia.org/wiki/정칙_함수 "wikilink").
...
다음 데이터가 주어졌다고 하자.
  ...
  - \(N\times N\) [에르미트 행렬](https://ko.wikipedia.org/wiki/에르미트_행렬 "wikilink") \(H\) (“[해밀토니언 연산자](https://ko.wikipedia.org/wiki/해밀토니언_연산자 "wikilink")”)
...
유일하게 자명하지 않은 것은 \(z\in\mathbb R+\mathrm i\beta\)에서의 경계 조건이다. 이는 [대각합](https://ko.wikipedia.org/wiki/대각합 "wikilink")의 순환 성질을 사용하면 쉽게 보일 수 있다.
...
[섬네일](https://ko.wikipedia.org/wiki/파일:Schwinger.jpg "wikilink")\]\] [구보 료고](../Page/구보_료고.md "wikilink")\[5\]와 폴 세실 마틴(, 1931\~2016)과 [줄리언 슈윙거](https://ko.wikipedia.org/wiki/줄리언_슈윙거 "wikilink")\[6\]가 1950년대에 도입하였다.
