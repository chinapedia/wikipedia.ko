...
[환론](../Page/환론.md "wikilink")에서, **클리퍼드 대수**(Clifford代數, )는 [이차 형식에](../Page/이차_형식.md "wikilink") 의하여 정의되는 [결합 대수의](../Page/결합_대수.md "wikilink") 한 종류이다.\[1\]\[2\] [복소수체](https://ko.wikipedia.org/wiki/복소수체 "wikilink")와 [사원수환](https://ko.wikipedia.org/wiki/사원수환 "wikilink")의 일반화이며, [외대수](https://ko.wikipedia.org/wiki/외대수 "wikilink")의 [양자화로](../Page/양자화_\(물리학\).md "wikilink") 여길 수 있다.
...
[가환환](https://ko.wikipedia.org/wiki/가환환 "wikilink") \(K\) 위의 [가군](../Page/가군.md "wikilink") \(V\) 위의 [이차 형식](../Page/이차_형식.md "wikilink") \(Q\colon V\to K\)가 주어졌다고 하자. 그렇다면 **클리퍼드 대수** \(\operatorname{Cliff}(V,Q)\)는 다음 공리를 만족시키는, \(V\)를 포함하는 가장 일반적인 \(K\)-[단위 결합 대수다](https://ko.wikipedia.org/wiki/단위_결합_대수 "wikilink").

\[v^2=Q(v)\qquad\forall v\in V\] 즉, [범주론](https://ko.wikipedia.org/wiki/범주론 "wikilink")적으로 클리퍼드 대수는 다음과 같은 [보편 성질을](../Page/보편_성질.md "wikilink") 만족시킨다. \(K\) 위의 [단위 결합 대수들의](https://ko.wikipedia.org/wiki/단위_결합_대수 "wikilink") 범주 \(\operatorname{uAssocAlg}_K\)에서, \(j(v)^2=Q(v)1_A\forall v\in V\)를 만족시키는 임의의 대수 \((A,j\colon V\to A)\)가 주어지면, 다음 그림을 가환시키는 유일한 대수 [준동형](../Page/준동형.md "wikilink") \(f\colon\operatorname{Cliff}(V,Q)\to A\)가 존재한다.
...
비록 [텐서 대수의](../Page/텐서_대수.md "wikilink") 자연수 등급은 등급으로서 살아남지 못하지만, 이는 클리퍼드 대수 위의 [자연수 오름 여과를](https://ko.wikipedia.org/wiki/여과_\(수학\) "wikilink") 정의한다. 구체적으로, [텐서 대수](../Page/텐서_대수.md "wikilink") \(\operatorname T(V;K)\)의 [등급으로](../Page/등급_대수.md "wikilink") 정의되는 오름 여과
...
이 여과로부터 정의되는 자연수 [등급 대수는](../Page/등급_대수.md "wikilink") [외대수](https://ko.wikipedia.org/wiki/외대수 "wikilink")와 표준적으로 동형이다.

\[\bigoplus_{n=0}^\infty\frac{F^n\operatorname{Cliff}(V,Q;K)}{F^{n-1}\operatorname{Cliff}(V,Q;K)}\cong\Lambda(V;K)\]

### 대합

[가환환](https://ko.wikipedia.org/wiki/가환환 "wikilink") \(K\) 위의 클리퍼드 대수 \(\operatorname{Cliff}(V,Q;K)\) 위에, 다음과 같은 [자기 동형이](https://ko.wikipedia.org/wiki/자기_동형 "wikilink") 존재한다.

\[\alpha\colon v_1v_2\cdots v_k\mapsto(-)^kv_1v_2\cdots v_k\qquad(\forall v_1,v_2,\dots,v_k\in V)\] (만약 [가환환](https://ko.wikipedia.org/wiki/가환환 "wikilink") \(K\)의 [표수가](https://ko.wikipedia.org/wiki/환의_표수 "wikilink") 2라면 이는 [항등 함수이다](https://ko.wikipedia.org/wiki/항등_함수 "wikilink").) \(\alpha^2\)는 [항등 함수이므로](https://ko.wikipedia.org/wiki/항등_함수 "wikilink") 이는 [대합을](https://ko.wikipedia.org/wiki/대합_\(수학\) "wikilink") 이룬다.
...
\[(-)^\top\colon v_1v_2\cdots v_k\mapsto v_k\cdots v_2v_1\qquad(\forall v_1,v_2,\dots,v_k\in V)\] (여기서 \((-)^{\operatorname{op}}\)는 [반대환](https://ko.wikipedia.org/wiki/반대환 "wikilink")을 뜻한다.) \(\alpha\)와 \((-)^\top\)는 서로 가환하며, 이 둘을 [합성하면](https://ko.wikipedia.org/wiki/함수의_합성 "wikilink") 다음과 같은 **클리퍼드 수반**()을 얻는다.
...
[가환환](https://ko.wikipedia.org/wiki/가환환 "wikilink") \(K\) 위의 클리퍼드 대수 \(\operatorname{Cliff}(V,Q;K)\) 위에 다음과 같은 [쌍선형 형식](../Page/쌍선형_형식.md "wikilink") 및 [이차 형식을](../Page/이차_형식.md "wikilink") 정의할 수 있다.
...
\[\operatorname{Cliff}(V,Q;K)\cong\Lambda(W;K)\hat\otimes_K\operatorname{Cliff}(U,Q;K)\] 가 된다. 따라서, 만약 \(V\)가 [반단순 가군이라면](../Page/반단순_가군.md "wikilink") \(V\cong(\operatorname{rad}Q)\oplus V/(\operatorname{rad}Q)\)이므로 위와 같은 분해를 사용할 수 있다. 따라서, \(V\)가 [반단순 가군일](../Page/반단순_가군.md "wikilink") 때 클리퍼드 대수의 분해는 \(Q\)가 [비특이 이차 형식인](https://ko.wikipedia.org/wiki/비특이_이차_형식 "wikilink") 경우로 귀결된다. 특히, \(K\)가 [체](https://ko.wikipedia.org/wiki/체_\(수학\) "wikilink")(또는 유한 개의 [체들의](https://ko.wikipedia.org/wiki/체_\(수학\) "wikilink") [직접곱](../Page/직접곱.md "wikilink"))라면, 모든 가군은 [반단순 가군이](../Page/반단순_가군.md "wikilink") 되므로 위와 같은 분해를 사용할 수 있다.

\(K\)가 [체이며](https://ko.wikipedia.org/wiki/체_\(수학\) "wikilink"), \(V\)가 그 위의 유한 차원 [벡터 공간이고](https://ko.wikipedia.org/wiki/벡터_공간 "wikilink"), 그 차원이 \(n\)이라고 하자. 그렇다면, 클리퍼드 대수 \(\operatorname{Cliff}(V,Q;K)\)는 \(2^n\)차원 [벡터 공간이다](https://ko.wikipedia.org/wiki/벡터_공간 "wikilink"). \(\{e_i\}_{i=1,\dots,n}\)이 \(V\)의 [기저라고](../Page/기저_\(선형대수학\).md "wikilink") 하자. 그렇다면 \(\operatorname{Cliff}(V,Q;K)\)의 [기저는](../Page/기저_\(선형대수학\).md "wikilink") 다음과 같이 주어진다.

\[\{e_{i_1}e_{i_2}\dotsb e_{i_k}|1\le i_1<i_2<\dotsb<i_k\le n\}\]

### 외대수와의 관계

[체](https://ko.wikipedia.org/wiki/체_\(수학\) "wikilink") \(K\) 위의 클리퍼드 대수 \(\operatorname{Cliff}(V,Q;K)\)는 \(K\)-가군으로서 [외대수](https://ko.wikipedia.org/wiki/외대수 "wikilink") \(\Lambda_K(V)\)와 동형이다. 만약 \(Q=0\)일 경우 \(\operatorname{Cliff}(V,0;K)\)는 [외대수](https://ko.wikipedia.org/wiki/외대수 "wikilink") \(\Lambda(V;K)\)와 대수로서 동형이지만, \(Q\ne0\)일 경우 외대수와 대수로서 다르다. 따라서, 클리퍼드 대수는 [외대수](https://ko.wikipedia.org/wiki/외대수 "wikilink")의 일종의 [양자화로](../Page/양자화_\(물리학\).md "wikilink") 생각할 수 있다.
...
특히, 만약 \(K\)가 표수가 2가 아닌 [체라면](https://ko.wikipedia.org/wiki/체_\(수학\) "wikilink"), \(\operatorname{Cliff}(V,Q;K)\)는 [등급 중심 단순 대수](https://ko.wikipedia.org/wiki/등급_중심_단순_대수 "wikilink")()이다.\[4\]
...
표수가 2가 아닌 체 \(K\) 위의 유한 차원 [벡터 공간](https://ko.wikipedia.org/wiki/벡터_공간 "wikilink") \(V=\operatorname{Span}_K\{e_1,e_2,\dots,e_n\}\) 위의 모든 [이차 형식은](../Page/이차_형식.md "wikilink") 대각화할 수 있다. 즉, 다음과 같은 꼴로 놓을 수 있다.

\[Q(a_1e_1+a_2e_2+\cdots+a_ne_n)=c_1a_1^2+c_2a_2^2+\cdots+c_na_n^2\qquad(a_1,\dots,a_n,c_1,\dots,c_n\in K)\] 이렇게 놓았을 때, 클리퍼드 대수 \(\operatorname{Cliff}(V,Q;K)\)는 (유한 차원 \(K\)-[벡터 공간이므로](https://ko.wikipedia.org/wiki/벡터_공간 "wikilink")) 항상 [아르틴 환이다](../Page/아르틴_환.md "wikilink"). 또한, 다음 두 조건이 서로 [동치](../Page/동치.md "wikilink")이다.\[5\]

  - \(\operatorname{Cliff}(V,Q;K)\)는 [반단순환](../Page/반단순환.md "wikilink")이다. 즉, [아르틴-웨더번 정리에](https://ko.wikipedia.org/wiki/아르틴-웨더번_정리 "wikilink") 따라 유한 개의 [나눗셈환](https://ko.wikipedia.org/wiki/나눗셈환 "wikilink") 위의 행렬환들의 [직접곱](../Page/직접곱.md "wikilink")이다.
...
[표수가](https://ko.wikipedia.org/wiki/체의_표수 "wikilink") 2가 아닌 체 \(K\) 위의 유한 차원 [벡터 공간](https://ko.wikipedia.org/wiki/벡터_공간 "wikilink") \(V=\operatorname{Span}_K\{e_1,e_2,\dots,e_n\}\) 위의 모든 [이차 형식은](../Page/이차_형식.md "wikilink") 대각화할 수 있다. 즉, 다음과 같은 꼴로 놓을 수 있다.
...
[가환환](https://ko.wikipedia.org/wiki/가환환 "wikilink") \(K\), \(\tilde K\)과 [환 준동형](https://ko.wikipedia.org/wiki/환_준동형 "wikilink") \(\phi\colon K\to\tilde K\) 및 \(K\)-[가군](../Page/가군.md "wikilink") \(M\) 및 그 위의 [이차 형식](../Page/이차_형식.md "wikilink") \(Q\)가 주어졌다고 하자. 그렇다면, \((M,Q)\)의 스칼라 확대 \((M\otimes_K\tilde K,Q\otimes_K1)\)의 클리퍼드 대수는 다음과 같은 \(\mathbb Z/2\)-[등급](../Page/등급_대수.md "wikilink") \(\tilde K\)-대수이다.\[7\]
...
[가환환](https://ko.wikipedia.org/wiki/가환환 "wikilink") \(K\) 및 임의의 두 \(\mathbb Z/2\)-[등급](../Page/등급_대수.md "wikilink") \(K\)-[단위 결합 대수](https://ko.wikipedia.org/wiki/단위_결합_대수 "wikilink") \(A\), \(A'\)가 주어졌다고 하자. 그렇다면,
...
[가환환](https://ko.wikipedia.org/wiki/가환환 "wikilink") \(K\) 위의 두 [이차 공간](https://ko.wikipedia.org/wiki/이차_공간 "wikilink") \((V,Q)\), \((V',Q')\)이 주어졌다고 하자. 그렇다면, 그 [직합](../Page/직합.md "wikilink") \((V\oplus V',Q\oplus Q')\) 위의 클리퍼드 대수는 \(\mathbb Z/2\)-[등급](../Page/등급_대수.md "wikilink") \(K\)-[단위 결합 대수로서](https://ko.wikipedia.org/wiki/단위_결합_대수 "wikilink") 다음과 동형이다.\[8\]
...
표수가 2가 아닌 체 \(K\) 위의 \(n\)차원 [벡터 공간](https://ko.wikipedia.org/wiki/벡터_공간 "wikilink") \(V\) 위의 [비퇴화 이차 형식](https://ko.wikipedia.org/wiki/비퇴화_이차_형식 "wikilink") \(Q\)로 정의되는 클리퍼드 대수 \(\operatorname{Cliff}(V,Q;K)\)는 [등급 중심 단순 대수](https://ko.wikipedia.org/wiki/등급_중심_단순_대수 "wikilink")()이며, 이에 대하여 완전한 분류가 존재한다. 이는 다음과 같다.\[9\]
...
[아르틴-웨더번 정리에](https://ko.wikipedia.org/wiki/아르틴-웨더번_정리 "wikilink") 의하여, 체 \(K\) 위의 \(2^n\)차원 [중심 단순 대수는](https://ko.wikipedia.org/wiki/중심_단순_대수 "wikilink") 어떤 \(K\)-[중심 단순 대수인](https://ko.wikipedia.org/wiki/중심_단순_대수 "wikilink") \(2^k\)차원 [나눗셈환](https://ko.wikipedia.org/wiki/나눗셈환 "wikilink") \(D\) 위의 행렬환 \(\operatorname{Mat}(2^{n-k};D)\)과 동형이다.

### 복소수 클리퍼드 대수

\(K=\mathbb C\)가 [복소수체](https://ko.wikipedia.org/wiki/복소수체 "wikilink")이며, \((V,Q)\)가 [비퇴화 이차 형식이](https://ko.wikipedia.org/wiki/비퇴화_이차_형식 "wikilink") 주어진 유한 차원 복소수 [벡터 공간이라고](https://ko.wikipedia.org/wiki/벡터_공간 "wikilink") 하자. 복소수의 경우, 부호수의 개념이 존재하지 않고, 오직 \(n=\dim_{\mathbb C}V\)만 고려하면 된다. 이에 대한 클리퍼드 대수를 \(\operatorname{Cliff}(n;\mathbb C)\)로 쓰면, 이는 \(\mathbb C\)-[단위 결합 대수로서](https://ko.wikipedia.org/wiki/단위_결합_대수 "wikilink") 다음과 같다.
...
\[\operatorname{Cliff}(2;\mathbb C)\cong\operatorname{Mat}(2;\mathbb C)\] (2×2 복소 [행렬](https://ko.wikipedia.org/wiki/행렬 "wikilink"))

### 실수 클리퍼드 대수

\(K=\mathbb R\)가 [실수체](https://ko.wikipedia.org/wiki/실수체 "wikilink")이며, \(V\)가 유한 차원 실수 [벡터 공간이고](https://ko.wikipedia.org/wiki/벡터_공간 "wikilink"), \(Q\)가 [부호수가](https://ko.wikipedia.org/wiki/계량_부호수 "wikilink") \((p,q)\)인 [비퇴화 이차 형식이라고](https://ko.wikipedia.org/wiki/비퇴화_이차_형식 "wikilink") 하자. 이 경우, 이에 대한 클리퍼드 대수를 \(\operatorname{Cliff}(p,q;\mathbb R)\)로 쓰자. 낮은 차원의 실수 클리퍼드 대수들은 다음과 같다.

\[\operatorname{Cliff}(0,0;\mathbb R)\cong\mathbb R\] ([실수](https://ko.wikipedia.org/wiki/실수 "wikilink"))

\[\operatorname{Cliff}(0,1;\mathbb R)\cong\mathbb C\] ([복소수](https://ko.wikipedia.org/wiki/복소수 "wikilink"))

\[\operatorname{Cliff}(1,0;\mathbb R)\cong\mathbb R\oplus\mathbb R\] ([분할복소수](https://ko.wikipedia.org/wiki/분할복소수 "wikilink"))

\[\operatorname{Cliff}(0,2;\mathbb R)\cong\mathbb H\] ([사원수](https://ko.wikipedia.org/wiki/사원수 "wikilink"))

\[\operatorname{Cliff}(2,0;\mathbb R)\cong\operatorname{Cliff}(1,1;\mathbb R)\cong\operatorname{Mat}(2;\mathbb R)\] (2×2 실수 [행렬](https://ko.wikipedia.org/wiki/행렬 "wikilink")) 또한, 다음과 같은 주기 8의 [보트 주기성이](https://ko.wikipedia.org/wiki/보트_주기성 "wikilink") 성립한다.
...
\end{cases}\] \(\operatorname{Cliff}(\operatorname{diag}(0,0,\dots,0,0);\mathbb F_{2^e})\) 및 \(\operatorname{Cliff}(\operatorname{diag}(0,0,\dots,0,1);\mathbb F_{2^e}\) 둘 다 [외대수](https://ko.wikipedia.org/wiki/외대수 "wikilink")와 동형이다. 후자의 경우, 구체적으로 클리퍼드 대수

\[\operatorname{Cliff}\left(\operatorname{diag}(1);K\right)=K[x]/(x^2+1)\] 에서 \(y=x+1\)로 놓으면 \(y^2=0\)이므로 이는 [단위 결합 대수로서](https://ko.wikipedia.org/wiki/단위_결합_대수 "wikilink") [외대수](https://ko.wikipedia.org/wiki/외대수 "wikilink") \(\Lambda(K)=K[y]/(y^2)\)와 동형이다.

## 예

[가환환](https://ko.wikipedia.org/wiki/가환환 "wikilink") \(K\) 위의 클리퍼드 대수 \(\operatorname{Cliff}(V,Q;K)\)는 특수한 경우 다음과 같다.

  - 만약 \(Q=0\)이라면 \(\operatorname{Cliff}(V,0;K)=\Lambda(V;K)\)는 [외대수](https://ko.wikipedia.org/wiki/외대수 "wikilink")이다.
...
[체](https://ko.wikipedia.org/wiki/체_\(수학\) "wikilink") \(K\) 위의 2차원 [벡터 공간](https://ko.wikipedia.org/wiki/벡터_공간 "wikilink") 위의 [비퇴화 이차 형식에](https://ko.wikipedia.org/wiki/비퇴화_이차_형식 "wikilink") 의하여 정의되는 클리퍼드 대수는 **사원수형 대수**(, )라고 한다.

체 위의 사원수형 대수는 [환으로서](https://ko.wikipedia.org/wiki/환_\(수학\) "wikilink") 항상 [나눗셈환](https://ko.wikipedia.org/wiki/나눗셈환 "wikilink")을 이루거나 또는 2×2 \(K\) 위의 [행렬환](https://ko.wikipedia.org/wiki/행렬환 "wikilink") \(\operatorname{Mat}(2;K)\)과 동형이다. 후자의 경우, **분할 사원수형 대수**(, )라고 한다.
...
=\frac{K\langle i,j\rangle}{(i^2-a,j^2-b,ij+ji)}\qquad(\deg i=\deg j=1)\] 보통 ([사원수](https://ko.wikipedia.org/wiki/사원수 "wikilink")와 마찬가지로) \(ij=-ji=k\)로 표기한다.
...
[사원수](https://ko.wikipedia.org/wiki/사원수 "wikilink")의 환 \(\mathbb H\)는 실수체 위의 사원수형 대수 \((\tfrac{-1,-1}K)\)이다.

## 클리퍼드 해석학

[복소해석학](https://ko.wikipedia.org/wiki/복소해석학 "wikilink")의 여러 성질들을 클리퍼드 대수 값을 갖는 함수에 대하여 일반화할 수 있다.\[10\]\[11\]\[12\]

### 디랙 연산자

[유클리드 공간](https://ko.wikipedia.org/wiki/유클리드_공간 "wikilink") \(\mathbb R^n\) 속의 [열린집합](../Page/열린집합.md "wikilink") \(U\subseteq\mathbb R^n\) 위의 \(\mathcal C^1\) 함수
...
클리퍼드 대수 값의 함수에 대하여 일종의 [코시의 적분 정리가](https://ko.wikipedia.org/wiki/코시의_적분_정리 "wikilink") 성립한다. 즉,
  ...
  - 두 [열린집합](../Page/열린집합.md "wikilink") \(V\subseteq \operatorname{cl}(V)\subseteq U\subseteq\mathbb R^n\)가 주어졌으며 (\(\operatorname{cl}(V)\)는 [위상수학적 폐포](https://ko.wikipedia.org/wiki/폐포_\(위상수학\) "wikilink"))
  - \(V\)는 [유계 집합이자](../Page/유계_집합.md "wikilink") [단일 연결 공간이며](https://ko.wikipedia.org/wiki/단일_연결_공간 "wikilink"),
...
\[\operatorname{vol}(\mathbb S^{n-1})=\frac{2\pi^{n/2}}{\Gamma(n/2)}\] 는 \(n-1\)차원 단위 [초구](https://ko.wikipedia.org/wiki/초구 "wikilink")의 넓이이다.

### 등각 변환

[리만 구](https://ko.wikipedia.org/wiki/리만_구 "wikilink") \(\hat{\mathbb C}\) 위의 [등각 변환은](https://ko.wikipedia.org/wiki/등각_변환 "wikilink") 복소수 계수의 [뫼비우스 변환](https://ko.wikipedia.org/wiki/뫼비우스_변환 "wikilink")

\[z\mapsto\frac{az+b}{cz+d}\qquad(a,b,c,d\in\mathbb C,\;ad-bc\ne0)\] 로 나타낼 수 있다. 마찬가지로, \(\mathbb S^n=\widehat{\mathbb R^n}\) 위의 [등각 변환은](https://ko.wikipedia.org/wiki/등각_변환 "wikilink") 클리퍼드 대수 \(\operatorname{Cliff}(0,n;\mathbb R)\) 계수의 [뫼비우스 변환](https://ko.wikipedia.org/wiki/뫼비우스_변환 "wikilink")
...
[위상 K이론은](../Page/위상_K이론.md "wikilink") 클리퍼드 대수와 깊은 관련이 있다. 구체적으로, KO-이론의 주기 8의 [보트 주기성은](https://ko.wikipedia.org/wiki/보트_주기성 "wikilink") [실수](https://ko.wikipedia.org/wiki/실수 "wikilink") 클리퍼드 대수의 주기 8의 [보트 주기성과](https://ko.wikipedia.org/wiki/보트_주기성 "wikilink") 관련되고, 마찬가지로 KU-이론의 주기 2의 [보트 주기성은](https://ko.wikipedia.org/wiki/보트_주기성 "wikilink") [복소수](https://ko.wikipedia.org/wiki/복소수 "wikilink") 클리퍼드 대수의 주기 2의 [보트 주기성과](https://ko.wikipedia.org/wiki/보트_주기성 "wikilink") 관련된다.\[15\]

### 물리학

[양자장론](https://ko.wikipedia.org/wiki/양자장론 "wikilink")에서, 4차원 [디랙 스피너를](https://ko.wikipedia.org/wiki/디랙_스피너 "wikilink") 다룰 때 등장하는 [디랙 행렬](https://ko.wikipedia.org/wiki/디랙_행렬 "wikilink") \(\gamma^\mu\) (\(\mu=0,1,2,3\))들의 곱은 복소수 클리퍼드 대수 \(\operatorname{Cliff}(4;\mathbb C)\cong\operatorname{Mat}(4;\mathbb C)\)를 생성한다. 마찬가지로, 3차원 [스피너](https://ko.wikipedia.org/wiki/스피너 "wikilink")를 다룰 때 등장하는 [파울리 행렬](https://ko.wikipedia.org/wiki/파울리_행렬 "wikilink") \(\sigma^1,\sigma^2,\sigma^3\)들은 \(\{\sigma^i,\sigma^j\}=2\delta^{ij}\sigma^i\)를 만족시키며, 클리퍼드 대수 \(\operatorname{Cliff}(3,0;\mathbb R)\cong\operatorname{Mat}(2;\mathbb C)\)를 이룬다. [스피너](https://ko.wikipedia.org/wiki/스피너 "wikilink")의 벡터 공간은 이와 같은 클리퍼드 대수 위의 [가군](../Page/가군.md "wikilink")을 이룬다.
...
알포르스-팔렌 행렬은 [오스트리아](https://ko.wikipedia.org/wiki/오스트리아 "wikilink")의 카를 테오도어 팔렌()\[21\]이 1902년에 도입하였고, 이후 [핀란드](https://ko.wikipedia.org/wiki/핀란드 "wikilink")의 [라르스 알포르스](https://ko.wikipedia.org/wiki/라르스_알포르스 "wikilink")\[22\]\[23\]\[24\]가 재발견하였다.

1964년에 [마이클 아티야](https://ko.wikipedia.org/wiki/마이클_아티야 "wikilink") · [라울 보트](https://ko.wikipedia.org/wiki/라울_보트 "wikilink") · 아놀드 새뮤얼 샤피로()는 클리퍼드 대수가 [위상 K이론과](../Page/위상_K이론.md "wikilink") 깊은 관련이 있음을 발견하였다.\[25\]
...
## 같이 보기
  ...
  - [디랙 행렬](https://ko.wikipedia.org/wiki/디랙_행렬 "wikilink")
  ...
  - [스핀 다양체](https://ko.wikipedia.org/wiki/스핀_다양체 "wikilink")
  - [외대수](https://ko.wikipedia.org/wiki/외대수 "wikilink")
  - [케일리-딕슨 구성](../Page/케일리-딕슨_구성.md "wikilink")
  - [팔원수](https://ko.wikipedia.org/wiki/팔원수 "wikilink")
