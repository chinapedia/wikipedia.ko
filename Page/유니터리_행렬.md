...
[선형대수학](https://ko.wikipedia.org/wiki/선형대수학 "wikilink")에서, **유니타리 행렬**()는 [켤레 전치가](https://ko.wikipedia.org/wiki/켤레_전치 "wikilink") [역행렬](https://ko.wikipedia.org/wiki/역행렬 "wikilink")과 같은 [복소수](https://ko.wikipedia.org/wiki/복소수 "wikilink") [행렬](https://ko.wikipedia.org/wiki/행렬 "wikilink")이다.

## 정의

[복소수](https://ko.wikipedia.org/wiki/복소수 "wikilink") \(n\times n\) 행렬 \(U\)에 대하여, 다음 조건들이 서로 동치이며, 이를 만족시키는 \(U\)를 **유니타리 행렬**이라고 한다.
  ...
  - \(U\)는 [정규 행렬이며](https://ko.wikipedia.org/wiki/정규_행렬 "wikilink"), 모든 [고윳값](https://ko.wikipedia.org/wiki/고윳값 "wikilink")의 [절댓값](https://ko.wikipedia.org/wiki/절댓값 "wikilink")은 1이다.
...
모든 \(n\times n\) 유니타리 행렬의 집합은 행렬 곱셈에 따라 [군을](https://ko.wikipedia.org/wiki/군_\(수학\) "wikilink") 이루며, 이를 [유니타리 군](../Page/유니터리_군.md "wikilink") \(\operatorname U(n)\)이라고 한다.
