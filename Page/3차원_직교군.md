...
**3차원 직교군**(三次元直交群, )은 3차원 [유클리드 공간의](../Page/유클리드_공간.md "wikilink") 회전 및 반사로 구성되는 [리 군이다](../Page/리_군.md "wikilink"). [수학](../Page/수학.md "wikilink")과 [물리학](../Page/물리학.md "wikilink")에서 널리 쓰인다.
