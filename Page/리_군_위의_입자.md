...
[물리학](https://ko.wikipedia.org/wiki/물리학 "wikilink")에서, **리 군 위의 입자**()는 [리 군의](https://ko.wikipedia.org/wiki/리_군 "wikilink") 구조를 가진 공간 속에서 움직이는 입자를 나타내는 물리학 모형이다.\[1\] 고전적으로 그 해([리 군의](https://ko.wikipedia.org/wiki/리_군 "wikilink") [측지선](https://ko.wikipedia.org/wiki/측지선 "wikilink"))는 간단하게 표현될 수 있으며, 대칭으로 인하여 쉽게 양자화될 수 있다.

## 정의

[콤팩트](https://ko.wikipedia.org/wiki/콤팩트_공간 "wikilink") [연결](https://ko.wikipedia.org/wiki/연결_공간 "wikilink") [리 군](https://ko.wikipedia.org/wiki/리_군 "wikilink") \(G\)가 주어졌다고 하자. \(G\)의 [리 대수](https://ko.wikipedia.org/wiki/리_대수 "wikilink") \(\mathfrak{lie}(G)\) 위의 [양의 정부호](https://ko.wikipedia.org/wiki/양의_정부호 "wikilink") 2차 대칭 [불변 다항식](../Page/불변_다항식.md "wikilink")

\[g(t,t') = g_{ab}t^a {t'}^b \qquad(t,t'\in\mathfrak{lie}(G))\] 은 \(G\) 위의 [리만 계량을](https://ko.wikipedia.org/wiki/리만_계량 "wikilink") 정의하며, 이는 \(G\)의 왼쪽 · 오른쪽 [작용에](https://ko.wikipedia.org/wiki/군의_작용 "wikilink") 대하여 불변이다. 즉, 군의 준동형

\[G \times G \to \operatorname{Isom}(G,g)\] 이 존재한다 (\(\operatorname{Isom}(-)\)은 [전단사](https://ko.wikipedia.org/wiki/전단사_함수 "wikilink") [등거리 변환의](https://ko.wikipedia.org/wiki/등거리_변환 "wikilink") 군).

이 경우, [라그랑지언](https://ko.wikipedia.org/wiki/라그랑지언 "wikilink")
...
\[\frac{\mathrm d}{\mathrm dt}g^{-1} = -g^{-1} \dot g g^{-1}\] 이다. 따라서, [대각합](https://ko.wikipedia.org/wiki/대각합 "wikilink")의 순환성 및 [부분 적분을](https://ko.wikipedia.org/wiki/부분_적분 "wikilink") 사용하여, 다음과 같이 계산할 수 있다.
...
+ 2\frac{\mathrm d}{\mathrm dt}\operatorname{tr} (g^{-1} \dot g g^{-1} \delta g)
\end{aligned}\] 이다. 여기서 둘째 항은 완전 적분이므로 [오일러-라그랑주 방정식을](https://ko.wikipedia.org/wiki/오일러-라그랑주_방정식 "wikilink") 구할 때 무시할 수 있다.

</div>

</div>

[오일러-라그랑주 방정식](https://ko.wikipedia.org/wiki/오일러-라그랑주_방정식 "wikilink")([측지선 방정식](https://ko.wikipedia.org/wiki/측지선_방정식 "wikilink"))은
...
[위상 공간은](https://ko.wikipedia.org/wiki/위상_공간_\(물리학\) "wikilink") [리 군의](https://ko.wikipedia.org/wiki/리_군 "wikilink") [공변접다발](https://ko.wikipedia.org/wiki/공변접다발 "wikilink") \(\mathrm T^*G\)이며, 그 위에는 표준적인 [심플렉틱 형식이](https://ko.wikipedia.org/wiki/심플렉틱_형식 "wikilink") 존재한다. 이 위의 심플렉틱 형식은 \((g_{\mathrm L},g_{\mathrm R},\lambda)\) 좌표계에서 다음과 같은 꼴로 두 성분으로 분해된다.
...
[콤팩트](https://ko.wikipedia.org/wiki/콤팩트_공간 "wikilink") [연결](https://ko.wikipedia.org/wiki/연결_공간 "wikilink") [리 군](https://ko.wikipedia.org/wiki/리_군 "wikilink") \(G\) 위의 입자의 [힐베르트 공간은](https://ko.wikipedia.org/wiki/힐베르트_공간 "wikilink") \(G\) 위의 복소수 2차 [르베그 공간](https://ko.wikipedia.org/wiki/르베그_공간 "wikilink")

\[\operatorname L^2(G;\mathbb C)\] 이다. 이 경우 사용한 [측도](https://ko.wikipedia.org/wiki/측도 "wikilink")는 [하르 측도이다](https://ko.wikipedia.org/wiki/하르_측도 "wikilink"). (콤팩트 리 군의 경우 [왼쪽 하르 측도와](https://ko.wikipedia.org/wiki/왼쪽_하르_측도 "wikilink") [오른쪽 하르 측도가](https://ko.wikipedia.org/wiki/오른쪽_하르_측도 "wikilink") 일치한다.) 이 위에는 \(G\times G\)의 [왼쪽 군 작용이](https://ko.wikipedia.org/wiki/왼쪽_군_작용 "wikilink") 다음과 같이 존재한다.

\[G \times G \times \operatorname L^2(G;\mathbb C) \to \operatorname L^2(G;\mathbb C)\]

\[((g_{\mathrm L},g_{\mathrm R}) \cdot \phi)(x) =
\phi(g_{\mathrm L}^{-1}xg_{\mathrm R})\] 이에 따라서, \(\operatorname L^2(G;\mathbb C)\)는 \(G\times G\)의 [표현들로](https://ko.wikipedia.org/wiki/군의_표현 "wikilink") 분해된다. 구체적으로, 이는 다음과 같다.
...
\[(g_{\mathrm L},g_{\mathrm R})\cdot(v \otimes \bar v) = (g_{\mathrm L} \cdot v) \otimes (g_{\mathrm R}\cdot v)\qquad(v\in V_R,\;\bar v\in V_{\bar R})\] 여기서
  ...
  - \(\operatorname{IrRep}(R)\)는 \(G\)의 모든 [복소수](https://ko.wikipedia.org/wiki/복소수 "wikilink") [기약 표현들의](https://ko.wikipedia.org/wiki/기약_표현 "wikilink") [동형류](https://ko.wikipedia.org/wiki/동형류 "wikilink")들의 [가산 집합이다](https://ko.wikipedia.org/wiki/가산_집합 "wikilink").
  - \(\textstyle\widehat{\bigoplus}\)는 가산 무한 개의 유한 차원 [내적 공간들의](https://ko.wikipedia.org/wiki/내적_공간 "wikilink") [직합](https://ko.wikipedia.org/wiki/직합 "wikilink")으로 구성되는 [분해 가능](https://ko.wikipedia.org/wiki/분해_가능_공간 "wikilink") [힐베르트 공간이다](https://ko.wikipedia.org/wiki/힐베르트_공간 "wikilink").
...
양자 모형과 고전 모형 사이의 관계는 [파인먼-카츠 공식으로](https://ko.wikipedia.org/wiki/파인먼-카츠_공식 "wikilink") 주어진다. 즉, 해밀토니언 \(H\)의 핵(즉, \(G\) 위의 [열핵](../Page/열핵.md "wikilink"))은 다음과 같이 주어진다.
...
\[\frac1{\operatorname{vol}G}\sum_{R\in\operatorname{IrRep}(G)}(\dim V_R)\exp(-\beta E_R) \operatorname{tr}_{V_R}(g_0g_1^{-1}) = K(g_0,g_1;\beta) = \int_{g \in \operatorname W(g_0,g_1)} \exp(-S[g]) \;\mathrm Dg\] 여기서
  ...
  - \(\operatorname W(g_0,g_1)\)은 \(g(0) = g_0\), \(g_\beta = g_\beta\)인 [연속 함수](https://ko.wikipedia.org/wiki/연속_함수 "wikilink") \(g\colon [0,\beta]\to G\)로 구성된 [위너 공간이다](../Page/위너_공간.md "wikilink").
  - \(\mathrm Dg\)는 이 [위너 공간](../Page/위너_공간.md "wikilink") 위의 [확률 측도이다](https://ko.wikipedia.org/wiki/확률_측도 "wikilink").
  - \(\textstyle S[g]= \frac12\int_0^\beta \langle g^{-1}\dot g,g^{-1}\dot g\rangle\,\mathrm dt\)는 고전 모형의 [작용이다](https://ko.wikipedia.org/wiki/작용_\(물리학\) "wikilink").
  - \(\operatorname{tr}_R(-)\)는 표현 \(R\)의 [지표이다](https://ko.wikipedia.org/wiki/군_표현의_지표 "wikilink").
...
\(G = \operatorname U(1)\)인 경우([원군](../Page/원군.md "wikilink"))를 생각하자. 이 경우 고전적으로 모든 상수 속도 곡선이 [측지선](https://ko.wikipedia.org/wiki/측지선 "wikilink")이다. 양자 모형에서, [힐베르트 공간은](https://ko.wikipedia.org/wiki/힐베르트_공간 "wikilink")
...
[원군](../Page/원군.md "wikilink")의 [기약 표현은](https://ko.wikipedia.org/wiki/기약_표현 "wikilink") ([아벨 군이므로](https://ko.wikipedia.org/wiki/아벨_군 "wikilink")) 모두 1차원이며,
...
\(G = \operatorname{SU}(2) \cong\mathbb S^3\)인 경우(3차원 [초구](https://ko.wikipedia.org/wiki/초구 "wikilink"))를 생각하자. 이 경우, [측지선](https://ko.wikipedia.org/wiki/측지선 "wikilink")은 [대원](https://ko.wikipedia.org/wiki/대원 "wikilink")이다. 양자 모형에서, [힐베르트 공간은](https://ko.wikipedia.org/wiki/힐베르트_공간 "wikilink")
