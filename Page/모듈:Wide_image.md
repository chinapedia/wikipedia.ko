> This article is converted from Wikipedia: [모듈:Wide image](https://ko.wikipedia.org/wiki/모듈:Wide_image).


\-- This module implements [template:wide image](https://ko.wikipedia.org/wiki/template:wide_image "wikilink") and [template:panorama](https://ko.wikipedia.org/wiki/template:panorama "wikilink") local p = {}
...
`               d:tag('div')`
`                   :addClass('magnify')`
`                   :wikitext('`[`File:'_.._image_.._'`](https://ko.wikipedia.org/wiki/:File:'_.._image_.._' "wikilink")`')`
`           end`
`           d:wikitext(caption)`
`       end`
`       return tostring(r)`
...
`   return wideimage(`
`           args['image'] or args['그림'] or args[1], args[2] or nil, -- width`
`           args['height'] or args['높이'] or nil, args['caption'] or args['그림설명'] or args[3], `
`           args['width'] or args['넓이'] or args['너비'] or args[4], args['align'] or args['정렬'] or args[5], `
`           args['alt'] or args['대체'], args['border'] or args['테두리'], args['align-cap'], args['dir'] or args['방향']`
`           )`
