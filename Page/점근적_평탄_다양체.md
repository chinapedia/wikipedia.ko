...
[리만 기하학과](https://ko.wikipedia.org/wiki/리만_기하학 "wikilink") [일반 상대성 이론에서](https://ko.wikipedia.org/wiki/일반_상대성_이론 "wikilink"), **점근적 평탄 다양체**(漸近的平坦多樣體, )는 어떤 [콤팩트 집합](https://ko.wikipedia.org/wiki/콤팩트_집합 "wikilink")("중심")을 제외하면, [유클리드 공간에](https://ko.wikipedia.org/wiki/유클리드_공간 "wikilink") 점근적으로 근접하는 [리만 계량을](https://ko.wikipedia.org/wiki/리만_계량 "wikilink") 갖는 조각들("끝")로 구성된 [리만 다양체이다](https://ko.wikipedia.org/wiki/리만_다양체 "wikilink").

## 정의

\(n\)차원 [리만 다양체](https://ko.wikipedia.org/wiki/리만_다양체 "wikilink") \((M,g)\)가 주어졌다고 하고, 또 어떤 양의 실수 \(\alpha\in\mathbb R^+\)가 주어졌다고 하자. \(M\)의 **점근적 평탄 끝**() \((\Sigma,\iota_\Sigma)\)는 다음과 같은 데이터로 주어진다.
...
\[M\setminus(\Sigma_1\cup\Sigma_2\cup\cdots\Sigma_m)\] 이 [콤팩트 공간이라면](https://ko.wikipedia.org/wiki/콤팩트_공간 "wikilink"), \(M\)을 **점근적 평탄 다양체**()라고 한다. 이 경우, 위의 \(m\)의 최솟값을 \(M\)의 **끝의 수**()라고 한다.
...
진공 [아인슈타인 방정식의](https://ko.wikipedia.org/wiki/아인슈타인_방정식 "wikilink") 해의 경우, \(n\ge3\)이라면 항상 \(\alpha=n-2\)로 잡을 수 있다.\[2\]

## 예

[콤팩트](https://ko.wikipedia.org/wiki/콤팩트_공간 "wikilink") [리만 다양체는](https://ko.wikipedia.org/wiki/리만_다양체 "wikilink") 자명하게 0개의 끝을 갖는 점근적 평탄 다양체이다. [유클리드 공간은](https://ko.wikipedia.org/wiki/유클리드_공간 "wikilink") 자명하게 하나의 끝을 갖는 점근적 평탄 다양체이다.
...
4차원 이상의 시공간에서, [슈바르츠실트 계량은](https://ko.wikipedia.org/wiki/슈바르츠실트_계량 "wikilink") (질량 중심 틀에서 \(t=0\) 조각을 생각한다면) 점근적 평탄 다양체를 이룬다.
