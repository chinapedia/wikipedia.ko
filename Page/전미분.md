...
[벡터 미적분학에서](https://ko.wikipedia.org/wiki/벡터_미적분학 "wikilink"), **전미분**()은 [다변수 함수의](https://ko.wikipedia.org/wiki/다변수_함수 "wikilink") 모든 변수의 변화에 따라 변화하는 행태를 근사하는 양이다. 즉, 전미분은 다변수 함수의 [증분](https://ko.wikipedia.org/wiki/증분 "wikilink")의 [주요 선형 부분이다](https://ko.wikipedia.org/wiki/주요_선형_부분 "wikilink"). 변수 하나의 변화만을 생각하는 [편미분](https://ko.wikipedia.org/wiki/편미분 "wikilink")과 달리, 모든 변수의 변화를 더불어 생각한다.

## 정의

[유클리드 공간의](https://ko.wikipedia.org/wiki/유클리드_공간 "wikilink") [연결](https://ko.wikipedia.org/wiki/연결_공간 "wikilink") [열린집합](https://ko.wikipedia.org/wiki/열린집합 "wikilink")에 정의된 실숫값 함수 \(f\colon D\subseteq\mathbb R^n\to\mathbb R\)의 점 \(\boldsymbol a\in D\)에서의 **전미분** \(\mathrm df\)는 다음과 같다.
...
전미분 가능 함수는 다음과 같은 성질을 갖는다.
  ...
  - 전미분 가능 함수는 항상 [연속 함수이다](https://ko.wikipedia.org/wiki/연속_함수 "wikilink").
  - 전미분 가능 함수는 항상 모든 변수에 대해 [편미분](https://ko.wikipedia.org/wiki/편미분 "wikilink") 가능하다.
