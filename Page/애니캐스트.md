...
애니캐스트(anycast)를 이용하여 멀티캐스트를 더욱 효율적으로 구현하여 고가용성 시스템 ( 트래픽의 전달 포인트의 장애 발생시 백업이 가능)을 구현할수 있다. 애니캐스트는 [인터넷 프로토콜과](../Page/인터넷_프로토콜.md "wikilink") 기타 네트워크 어드레싱 시스템이 지정한 [유니캐스트](../Page/유니캐스트.md "wikilink"), [멀티캐스트](../Page/멀티캐스트.md "wikilink"), [브로드캐스트](https://ko.wikipedia.org/wiki/브로드캐스트 "wikilink") [지오캐스트](https://ko.wikipedia.org/wiki/지오캐스트 "wikilink")를 포함, 5가지 인터넷 트래픽을 효율적으로 관리 전달 하기 위한 [어드레싱](../Page/주소_공간.md "wikilink") 또는 [라우팅](../Page/라우팅.md "wikilink") 방식 가운데 하나이다.
