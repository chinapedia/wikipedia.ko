...
H.261은 원래 데이터 레이트가 64 kbit/초인 [ISDN](https://ko.wikipedia.org/wiki/ISDN "wikilink") 망 전송을 위해 설계되었다. 부호화 알고리즘은 40kbit/s와 2Mbit/s 사이의 영상 비트레이트로 작동될 수 있도록 설계되었다.
