...
OMAP L-1x 계열은 카탈로그 채널을 통해서 유통되며, 다른 OMAP 제품군과는 다르게 비디오 지향 TI 다빈치 제품에서 발전하였다. 다빈치 프로세서에서 비디오 가속 관련 기능을 삭제하고, 다른 주변 장치를 개선한 형태이다. 고정 소수점 대신 [부동소수점](../Page/부동소수점.md "wikilink") DSP를 장착하였다.

  - OMAP-L137 - 300MHz ARM926EJ-S + C674x 부동소수점 DSP
  - OMAP-L138 - 300MHz ARM926EJ-S + C674x 부동소수점 DSP
