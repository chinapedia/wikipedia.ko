...
스마트폰과 같은 장치의 애플리케이션 프로세서로 사용되며, 이들 프로세서는 [리눅스](https://ko.wikipedia.org/wiki/리눅스 "wikilink"), [안드로이드](../Page/안드로이드_\(운영_체제\).md "wikilink"), [심비안](https://ko.wikipedia.org/wiki/심비안 "wikilink")과 같은 모바일 운영 체제를 실행시키고 다양한 멀티미디어를 구현할 수 있다.
...
휴대 전화 제조사를 대상으로 판매되며, 저가형 휴대폰에 장착하였다. TI가 모뎀 칩셋 시장에서 철수하면서 단종되었다.
  ...
  - OMAP850 - 200MHz ARM926EJ-S + [GSM](https://ko.wikipedia.org/wiki/GSM "wikilink")/[GPRS](https://ko.wikipedia.org/wiki/GPRS "wikilink") 디지털 베이스밴드 + 적층 [EDGE](https://ko.wikipedia.org/wiki/EDGE "wikilink") 보조 프로세서
