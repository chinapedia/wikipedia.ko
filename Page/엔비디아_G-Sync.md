...
## GPU 및 시스템 요구사항
  ...
  - GPU: G-SYNC이 기능하려면 엔비디아 지포스 GTX 650 Ti 부스트 GPU 이상이 필요하다.
  - 드라이버: R340.52 이상
  - 운영 체제: 윈도우 7, 8, 8.1, 10. 리눅스, FreeBSD, 솔라리스.\[3\]
  - 시스템 요구사항: GPU로부터 직접 디스플레이 1.2를 지원해야 한다.\[4\]

## G-Sync 지원 모니터 목록

| 브랜드       | 모델 번호        | 출시 연도 | 해상도       | 크기    | 네이티브 해상도의 화면 재생 빈도          | 패널 기술      |
| --------- | ------------ | ----- | --------- | ----- | --------------------------- | ---------- |
...
| 브랜드  | 모델 번호         | 해상도       | 크기  | 네이티브 해상도의 화면 재생 빈도 | HDR | 패널 기술 |
| ---- | ------------- | --------- | --- | ------------------ | --- | ----- |
...
## 같이 보기
  ...
  - [FreeSync](https://ko.wikipedia.org/wiki/FreeSync "wikilink")
...
## 외부 링크
  ...
  - [G-sync Monitors](http://www.geforce.com/hardware/technology/g-sync/where-to-buy-g-sync-monitors-and-modules)
  - [Video: How G-SYNC Works](http://www.geforce.com/hardware/technology/g-sync/videos)
  - [Nvidia G-Sync overview](http://www.geforce.com/hardware/technology/g-sync)

[분류:컴퓨터 디스플레이 표준](https://ko.wikipedia.org/wiki/분류:컴퓨터_디스플레이_표준 "wikilink") [분류:영상 기술](https://ko.wikipedia.org/wiki/분류:영상_기술 "wikilink") [분류:엔비디아](https://ko.wikipedia.org/wiki/분류:엔비디아 "wikilink")
