...
\[H_n(x)=\sum_{k=0}^n\binom nkh_n\] 이는 [아펠 다항식열의](https://ko.wikipedia.org/wiki/아펠_다항식열 "wikilink") [음계산법](https://ko.wikipedia.org/wiki/음계산법 "wikilink")으로 간편하게 나타낼 수 있다. 구체적으로, 음변수 \(\mathsf h\)에 대하여 선형 범함수
...
\[\sum_{n=0}^\infty h_nt^n/n!=L(t\mathsf h)=\exp(-t^2/2)\] 로부터 유도할 수 있다. [음계산법](https://ko.wikipedia.org/wiki/음계산법 "wikilink")을 사용하면,
...
에르미트 다항식은 [아펠 다항식열을](https://ko.wikipedia.org/wiki/아펠_다항식열 "wikilink") 이루므로, 이는 [음계산법](https://ko.wikipedia.org/wiki/음계산법 "wikilink")으로 다음과 같이 간단히 적을 수 있다.
