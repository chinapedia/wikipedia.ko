...
많은 휴대 전화들이 A-GPS 뿐만 아니라 AP를 통한 [와이파이 위치 획득 체계](../Page/와이파이_위치_획득_체계.md "wikilink"), 이동 전화 기지국을 통한 [위치 획득과](https://ko.wikipedia.org/wiki/위치_획득 "wikilink") 같은 다른 위치 획득 서비스를 조합하여 사용하며, [애플](../Page/애플.md "wikilink") [아이폰](../Page/아이폰.md "wikilink")의 경우 [하이브리드 위치 획득 시스템을](https://ko.wikipedia.org/wiki/:en:hybrid_positioning_system "wikilink") 사용하기도 한다.\[4\]
