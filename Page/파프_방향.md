...
[그래프 이론에서](https://ko.wikipedia.org/wiki/그래프_이론 "wikilink"), **파프 방향**(Pfaff方向, )은 그래프 위의 [완벽 부합의](https://ko.wikipedia.org/wiki/완벽_부합 "wikilink") 수를 쉽게 계산할 수 있게 하는 [유향 그래프](https://ko.wikipedia.org/wiki/유향_그래프 "wikilink") 구조이다.
...
\end{pmatrix}\in\{+1,-1\}\] 여기서 우변은 [순열](https://ko.wikipedia.org/wiki/순열 "wikilink")의 부호, 즉 [군 준동형](https://ko.wikipedia.org/wiki/군_준동형 "wikilink") \(\operatorname{sgn}\colon\operatorname{Sym}(n)\to\operatorname{Cyc}(2)=\{\pm1\}\)이다.
...
\[\operatorname Z_\Gamma(1,0)=\left|\sum_{i=1}^k\alpha_i\operatorname{Pf}\left(\operatorname{Inc}(\Gamma,D_i)\right)\right|\] 여기서
  ...
  - \(\operatorname{Pf}(-)\)은 짝수 크기 [반대칭 행렬의](../Page/반대칭_행렬.md "wikilink") [파피안](https://ko.wikipedia.org/wiki/파피안 "wikilink")이다.
...
다음이 주어졌다고 하자.
  ...
  - [콤팩트](https://ko.wikipedia.org/wiki/콤팩트_공간 "wikilink") [유향](https://ko.wikipedia.org/wiki/유향_다양체 "wikilink") [곡면](https://ko.wikipedia.org/wiki/곡면 "wikilink") \(\Sigma\cong(\mathbb T^2)^{\#g}\). 그 종수가 \(g\in\mathbb N\)라고 하자.
  - 매장 \(\Gamma\hookrightarrow \Sigma\). 이에 따라, \((\Sigma,\Gamma)\)는 유한 [CW 복합체를](https://ko.wikipedia.org/wiki/CW_복합체 "wikilink") 이룬다. (즉, \(\Gamma\setminus\Sigma\)는 유한 개의 2차원 [열린 공들의](https://ko.wikipedia.org/wiki/열린_공 "wikilink") [분리합집합](https://ko.wikipedia.org/wiki/분리합집합 "wikilink")이다.)
...
특히, \(g=0\)일 경우, 임의의 [평면 그래프](https://ko.wikipedia.org/wiki/평면_그래프 "wikilink") 위의 카스텔레인 방향은 (1-)파프 방향을 이룬다. 이에 따라, 모든 [평면 그래프는](https://ko.wikipedia.org/wiki/평면_그래프 "wikilink") 파프 방향을 갖는다.

## 역사

피터르 빌럼 카스텔레인(, 1924\~1996)이 도입하였다. “파프 방향”이라는 용어는 [요한 프리드리히 파프의](../Page/요한_프리드리히_파프.md "wikilink") 이름을 딴 것이다. 파프는 [파피안](https://ko.wikipedia.org/wiki/파피안 "wikilink")을 도입하였는데, 파프 방향의 부호 [인접 행렬의](https://ko.wikipedia.org/wiki/인접_행렬 "wikilink") [파피안](https://ko.wikipedia.org/wiki/파피안 "wikilink")으로 [완벽 부합의](https://ko.wikipedia.org/wiki/완벽_부합 "wikilink") 수를 계산할 수 있기 때문에 이와 같은 이름이 붙었다.
