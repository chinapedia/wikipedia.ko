...
[확률 공간](../Page/확률_공간.md "wikilink") \((\Omega,\mathcal F,\Pr)\) 위의 [사건들의](https://ko.wikipedia.org/wiki/확률공간 "wikilink") 집합 \(\mathcal S\subset\mathcal F\)에 대하여, 만약 모든 [유한 집합](https://ko.wikipedia.org/wiki/유한_집합 "wikilink") \(\{S_1,\dots,S_n\}\subset\mathcal S\)에 대하여
...
[확률 공간](../Page/확률_공간.md "wikilink") \((\Omega,\mathcal F,\Pr)\) 위의, \(\mathcal F\)의 부분 [시그마 대수들의](../Page/시그마_대수.md "wikilink") 집합 \(\mathfrak G\subset\mathcal P(\mathcal F)\)이 다음 성질을 만족시킬 경우, \(\mathfrak G\)가 서로 **독립**이라고 한다.
  ...
  - 모든 [유한 집합](https://ko.wikipedia.org/wiki/유한_집합 "wikilink") \(\{\mathcal G_1,\dots,\mathcal G_n\}\subset\mathfrak G\) 및 \(S_i\in\mathcal G_i\) (\(i=1,\dots,n\))에 대하여,
