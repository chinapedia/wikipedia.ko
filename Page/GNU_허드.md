...
## 덧붙임
  ...
  - Hurd는 HIRD of Unix-Replacing Daemons(유닉스를 대체하는 데몬들의 HIRD)의 약자이며 여기서 HIRD는 HURD of Interfaces Representing Depth(깊이를 나타내는 인터페이스들의 HURD)를 줄인 말로 [재귀 약자다](../Page/재귀_약자.md "wikilink").
