...
[군론](https://ko.wikipedia.org/wiki/군론 "wikilink")과 [대수적 위상수학에서](../Page/대수적_위상수학.md "wikilink"), **교차 가군**(交叉加群, )은 2-군의 데이터를 담고 있는 대수적 구조이다.\[1\] 구체적으로, 서로 [군 준동형](https://ko.wikipedia.org/wiki/군_준동형 "wikilink") 및 [작용을](https://ko.wikipedia.org/wiki/군의_작용 "wikilink") 갖는 두 [군으로](https://ko.wikipedia.org/wiki/군_\(수학\) "wikilink") 구성된다.
...
교차 가군은 다음과 같은 데이터로 주어진다.
  ...
  - [군](https://ko.wikipedia.org/wiki/군_\(수학\) "wikilink") \(H\)
...
이 개념은 사실 [군의](https://ko.wikipedia.org/wiki/군_\(수학\) "wikilink") 범주 속의 [내적 범주](../Page/내적_범주.md "wikilink") 또는 범주의 범주 속의 [군 대상과](../Page/군_대상.md "wikilink") 사실상 같다. 전자의 경우, 대상의 군은 \(G\)이며, 사상의 군은 \(H\rtimes G\)이다.\[2\] 이 경우
...
임의의 [군](https://ko.wikipedia.org/wiki/군_\(수학\) "wikilink") \(G\)의 [정규 부분군](https://ko.wikipedia.org/wiki/정규_부분군 "wikilink") \(N\)이 주어졌을 때,
...
다음 두 개념이 서로 [동치](https://ko.wikipedia.org/wiki/동치 "wikilink")이다.

  - 군 \(G\)의 [군환](https://ko.wikipedia.org/wiki/군환 "wikilink") \(\mathbb Z[G]\)의 [왼쪽 가군](https://ko.wikipedia.org/wiki/왼쪽_가군 "wikilink") \(_{\mathbb Z[G]}H\)
  - \(d=1_G\) ([치역](https://ko.wikipedia.org/wiki/치역 "wikilink")이 \(G\)의 항등원인 [상수 함수](https://ko.wikipedia.org/wiki/상수_함수 "wikilink"))인 교차 가군 \((G,H)\)
...
\(\mathbb Z[G]\)의 [왼쪽 가군](https://ko.wikipedia.org/wiki/왼쪽_가군 "wikilink") \(H\)가 주어졌다고 하자. 이제, \(d=1_G\)으로 놓으면, 이는 교차 가군의 데이터를 이룬다 (\(H\)의 군 연산은 가군의 덧셈). 만약 \(d=1_G\)일 때, 교차 가군의 두 조건 가운데 하나는 자명하며 다른 하나(파이퍼 항등식)는 \(H\)가 [아벨 군임을](https://ko.wikipedia.org/wiki/아벨_군 "wikilink") 의미한다.

반대로, \(d=1_G\)인 교차 가군 \((G,H)\)가 주어졌다고 하자. 그렇다면, 교차 가군의 조건(파이퍼 항등식)에 의하여 \(H\)는 [아벨 군이며](https://ko.wikipedia.org/wiki/아벨_군 "wikilink"), 작용 \(G\to\operatorname{Aut}(H)\)는 \(H\) 위에 \(\mathbb Z[G]\)-가군의 구조를 정의한다.

</div>

</div>

즉, \(\mathbb Z[G]\)-[왼쪽 가군의](https://ko.wikipedia.org/wiki/왼쪽_가군 "wikilink") 범주는 \(G\)에 대한 교차 가군의 [범주의](https://ko.wikipedia.org/wiki/범주_\(수학\) "wikilink") [부분 범주를](https://ko.wikipedia.org/wiki/부분_범주 "wikilink") 이룬다. 다시 말해, 교차 가군의 개념은 [군의 가군의](https://ko.wikipedia.org/wiki/군의_가군 "wikilink") 개념의 일반화이다.
...
[군의](https://ko.wikipedia.org/wiki/군_\(수학\) "wikilink") [짧은 완전열](https://ko.wikipedia.org/wiki/짧은_완전열 "wikilink")

\[1\to A\to H \,\xrightarrow d\,G \to 1\] 에서, \(A\)가 [아벨 군이라고](https://ko.wikipedia.org/wiki/아벨_군 "wikilink") 하자. 그렇다면,

\[g\cdot h = khk^{-1} \qquad\forall k \in d^{-1}(g) \subseteq H\] 을 정의하면, \((G,H,d,\cdot)\)는 교차 가군을 이룬다.

특히, 만약 \(G = 1\)이며 \(A=H\)가 임의의 [아벨 군일](https://ko.wikipedia.org/wiki/아벨_군 "wikilink") 경우, 이는 교차 가군을 이룬다.

마찬가지로, 만약 \(A=1\)이며 \(G=H\)가 임의의 [군일](https://ko.wikipedia.org/wiki/군_\(수학\) "wikilink") 경우, 이 역시 교차 가군을 이룬다. 이 경우
...
임의의 [군](https://ko.wikipedia.org/wiki/군_\(수학\) "wikilink") \(H\)가 주어졌다고 하자. 그렇다면, 표준적인 [군 준동형](https://ko.wikipedia.org/wiki/군_준동형 "wikilink")
...
\[G = \pi_1(A,x)\] ([기본군](https://ko.wikipedia.org/wiki/기본군 "wikilink"))
...
교차 가군 \((G,H)\)에서, 만약 \(G\)와 \(H\)가 [리 군이라고](https://ko.wikipedia.org/wiki/리_군 "wikilink") 하고, 또 모든 작용 및 군 준동형이 [매끄러운 함수라고](https://ko.wikipedia.org/wiki/매끄러운_함수 "wikilink") 하자. 이 경우, 교차 가군 \((G,H)\)의 구조를 그 [리 대수에](https://ko.wikipedia.org/wiki/리_대수 "wikilink") 제한할 수 있다. 구체적으로, \(\operatorname{Lie}(G)=\mathfrak g\), \(\operatorname{Lie}(H)=\mathfrak h\)라고 할 때, 교차 가군의 구조는 다음과 같이 제한된다.

  - 두 유한 차원 [실수 리 대수](https://ko.wikipedia.org/wiki/실수_리_대수 "wikilink") \(\mathfrak g\), \(\mathfrak h\)
  - [리 대수 준동형](https://ko.wikipedia.org/wiki/리_대수_준동형 "wikilink") \(\rho\colon\mathfrak g\to\mathfrak{der}(\mathfrak h)\) ([공역은](https://ko.wikipedia.org/wiki/공역_\(수학\) "wikilink") \(\mathfrak h\)의 [미분 리 대수](../Page/미분_리_대수.md "wikilink"))
