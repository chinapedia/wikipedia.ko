...
[선형 대수학에서](https://ko.wikipedia.org/wiki/선형_대수학 "wikilink") , 열 벡터(vector) 또는 열 [행렬](https://ko.wikipedia.org/wiki/행렬 "wikilink") m × 1 행렬은 , 즉 m 원소들의 단일 열행렬 이고,

\[\mathbf{x} = \begin{bmatrix} x_1 \\ x_2 \\ \vdots \\ x_m \end{bmatrix} \,\]

마찬가지로, 행 벡터 또는 행 [행렬](https://ko.wikipedia.org/wiki/행렬 "wikilink") 1 × m 행렬은 그 원소들 m의 단일 행 행렬 이다\[1\]
...
행(row)[벡터(vector)는](https://ko.wikipedia.org/wiki/벡터_공간 "wikilink")
...
## 함께보기
  ...
  - [그람-슈미트 과정](https://ko.wikipedia.org/wiki/그람-슈미트_과정 "wikilink")
  - [고윳값 행렬](https://ko.wikipedia.org/wiki/고윳값_행렬 "wikilink")(Eigenvalue Matrix)
