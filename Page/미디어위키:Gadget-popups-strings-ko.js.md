> This article is converted from Wikipedia: [:Gadget-popups-strings-ko.js](https://ko.wikipedia.org/wiki/:Gadget-popups-strings-ko.js).
...
//
    ...
    popupStrings = {
      ...
      'undo': '취소',
      'undoHint': '이 편집을 취소',
      'defaultpopupRedlinkSummary': '[[백:팝업|NavPop]]을 사용하여 비어있는 [[%s|%s]] 문서로 연결된 바로가기 제거',
      'defaultpopupFixDabsSummary': '[[백:팝업|NavPop]]을 사용하여 동음이의어 [[%s|%s]] 문서를 [[%s|%s]] 문서로 변경',
      'defaultpopupFixRedirsSummary': '[[백:팝업|NavPop]]을 사용하여 [[%s|%s]]에서 [[%s|%s]] 문서로 넘겨주기 정리',
      ...
      'defaultpopupRmDabLinkSummary': '[[백:팝업|NavPop]]을 사용하여 동음이의어 문서 [[%s|%s]]에 대한 링크 제거',
      ...
      'disambigHint': '링크를 동음이의어 [[%s|%s]]에 추가합니다',
