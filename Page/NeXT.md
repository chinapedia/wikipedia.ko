...
넥스트 큐브(NeXTcube)는 [1990년](../Page/1990년.md "wikilink")에 출시되었다. 전작인 넥스트 컴퓨터의 디자인인 큐브 모양을 계속해서 유지했다. 당시 [대한민국](../Page/대한민국.md "wikilink")에서 유행하던 개인용 PC조합의 하드디스크 용량이 50MB 수준이었던 것을 참고하면, 넥스트 큐브의 '기본 400MB, 1.4GB 옵션'의 하드디스크 용량은 파격적이었으며, 전작에 이어서 사운드 처리용 DSP를 내장하였다. 단, 전작에서 과감히 채용하였던 광자기디스크는 앞서 기술한 대용량의 하드디스크로 교체되었다. 운영체제(OS)는 '넥스트스텝(NeXTSTEP)'이 기본이었고, 후에 '오픈스텝' 및 'NetBSD'로도 가동되었다.

[팀 버너스 리가](https://ko.wikipedia.org/wiki/팀_버너스_리 "wikilink") 바로 이 넥스트 큐브로 세계 최초의 [월드와이드웹](../Page/월드와이드웹.md "wikilink")(WWW)과 세계 최초의 웹브라우저를 만들어 냈고, [존 카맥](../Page/존_카맥.md "wikilink") 또한 [울펜슈타인 3D와](../Page/울펜슈타인_3D.md "wikilink") [둠](https://ko.wikipedia.org/wiki/둠 "wikilink")을 이것으로 만들었다.

### 넥스트 스테이션

넥스트스테이션(NeXTStation)은 [1990년](../Page/1990년.md "wikilink")에 출시되었다. 전작인 넥스트 컴퓨터가 '넥스트가 지향하는 컴퓨터'를 보여준 것이고, '넥스트 큐브'가 그보다 조금 현실적인 형태의 고사양 워크스테이션이었다면, 넥스트 스테이션은 큐브보다는 저가형(이지만 엄연히 당시로서는 고사양) 트림으로서 출시되었다. CPU는 넥스트 큐브와 동일한 68040을 사용하였으나, 105MB의 기본 하드디스크 용량, 8MB의 기본 RAM 용량 등, 넥스트 큐브보다는 낮은 가격에 판매될 수 있도록 하였다. OS는 큐브와 마찬가지로 넥스트스텝을 기본으로 사용하였다. 넥스트 스테이션의 디자인은 큐브 형태가 아닌 납작한 형태여서, 일명 '피자 박스 (Pizza Box)'로 불리었다.
