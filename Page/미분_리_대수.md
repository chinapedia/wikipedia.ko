...
[리 대수](../Page/리_대수.md "wikilink") 이론에서, **미분 리 대수**(微分Lie代數, )는 어떤 쌍선형 [이항 연산에](https://ko.wikipedia.org/wiki/이항_연산 "wikilink") 대한, [곱의 법칙을](../Page/곱의_법칙_\(미적분학\).md "wikilink") 따르는 미분 연산들로 구성된 리 대수이다.\[1\]\[2\]\[3\] 대략, 이 [대수 구조의](../Page/대수_구조.md "wikilink") 무한소 [자기 동형을](../Page/자기_동형_사상.md "wikilink") 나타낸다.
