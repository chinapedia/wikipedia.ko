...
최초에는 라이가레나라는 프랑스 업체가 소규모로 [LAN Arena](http://www.lan-arena.com)이란 명칭으로 치뤄진 [LAN](https://ko.wikipedia.org/wiki/근거리_통신망 "wikilink") 행사였다가 2003년, 라이가레나가 좀 더 큰 규모로 확장하기로 결정하면서 ESWC가 탄생하였다. 2005년, 라이가레나는 사명을 게임스서비스로 변경하였다. 2009년 게임스솔루션이라는 다른 프랑스 업체가 인수하였다.
