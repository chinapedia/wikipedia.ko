...
윈도우 NT 운영 체제에서, PE는 현재 [IA-32](../Page/IA-32.md "wikilink"), [IA-64](https://ko.wikipedia.org/wiki/IA-64 "wikilink"), [x86-64](https://ko.wikipedia.org/wiki/x86-64 "wikilink") (AMD64/Intel64), 그리고 [ARM](../Page/ARM_아키텍처.md "wikilink") instruction set architectures (ISAs)를 지원한다. 윈도우 2000 이전에서, 윈도우 NT는 (그리고 PE) MIPS, Alpha, 그리고 [파워PC](../Page/파워PC.md "wikilink") ISAs를 지원했다. PE가 [윈도우 CE에서](https://ko.wikipedia.org/wiki/윈도우_CE "wikilink") 사용되므로 이것은 MIPS, ARM (Thumb 포함), 그리고 SuperH ISA의 변형들을 지원하고 있다.

PE와 비슷한 형식으로 ELF ([리눅스](../Page/리눅스.md "wikilink")와 대부분의 다른 [유닉스](../Page/유닉스.md "wikilink") 버전들) 와 Mach-O ([Mac OS X](https://ko.wikipedia.org/wiki/OS_X "wikilink"))가 있다.
...
[x86](https://ko.wikipedia.org/wiki/x86 "wikilink")의 [유닉스 계열](../Page/유닉스_계열.md "wikilink") 운영체제들에서 몇몇 윈도우 바이너리들은 [와인으로](../Page/와인_\(소프트웨어\).md "wikilink") 돌아갈 수 있다. [맥 OS X 10.5는](https://ko.wikipedia.org/wiki/맥_OS_X_10.5 "wikilink") PE 파일들을 로드하고 분석할 수 있는 기능을 갖지만 윈도우와 호환은 되지 않는다.\[4\]

## 같이 보기

  - [EXE](../Page/EXE.md "wikilink")
...
## 외부 링크
  ...
  - [Part I. An In-Depth Look into the Win32 Portable Executable File Format by Matt Pietrek ([MSDN](../Page/마이크로소프트_개발자_네트워크.md "wikilink") Magazine, February 2002)](https://web.archive.org/web/20071003062701/http://msdn.microsoft.com/msdnmag/issues/02/02/PE/default.aspx)
  - [Part II. An In-Depth Look into the Win32 Portable Executable File Format by Matt Pietrek ([MSDN](../Page/마이크로소프트_개발자_네트워크.md "wikilink") Magazine, March 2002)](https://web.archive.org/web/20070907211207/http://msdn.microsoft.com/msdnmag/issues/02/03/PE2/default.aspx)
...
### 관련 도구
  ...
  - [PEBrowse](https://web.archive.org/web/20190503075042/http://www.smidgeonsoft.com/) PE 파일 뷰어 유틸리티.
  ...
  - [GNU Binutils](../Page/GNU_바이너리_유틸리티.md "wikilink") --target=i386-pe, --target=mips-pe
  ...
  - [anal_pe](http://www.mikekohn.net/file_formats/anal_pe.php) 명령 줄 기반의 도구. [리눅스](../Page/리눅스.md "wikilink")와 윈도우에서 동작.
