...
[right](https://ko.wikipedia.org/wiki/파일:KleinInvariantJ.jpg "wikilink") [수학](https://ko.wikipedia.org/wiki/수학 "wikilink")에서, **\(j\)-불변량**(j-不變量, )은 [모듈러 함수의](https://ko.wikipedia.org/wiki/모듈러_함수 "wikilink") 하나다. \(j\)-불변량의 모든 [유리 함수](https://ko.wikipedia.org/wiki/유리_함수 "wikilink") 또한 [모듈러 함수이며](https://ko.wikipedia.org/wiki/모듈러_함수 "wikilink"), 모든 모듈러 함수는 \(j\)-불변량의 유리 함수로 나타낼 수 있다.
...
이 가운데, 7, 11, 19, 43, 67은 [헤그너 수이다](https://ko.wikipedia.org/wiki/헤그너_수 "wikilink").

### 헤그너 수와 라마누잔 상수

\(d\)가 [헤그너 수라면](https://ko.wikipedia.org/wiki/헤그너_수 "wikilink") \(j((1+i\sqrt d)/2)\)는 [정수](https://ko.wikipedia.org/wiki/정수 "wikilink")이다. 따라서, 그 [푸리에 급수에](https://ko.wikipedia.org/wiki/푸리에_급수 "wikilink") 따라서
...
\[\exp(\pi\sqrt d)+744\approx j((1+i\sqrt d)/2)\in\mathbb Z\] 즉, \(\exp(\pi\sqrt d)\)는 정수에 매우 가까운 [초월수](https://ko.wikipedia.org/wiki/초월수 "wikilink")이다. 가장 큰 헤그너 수 \(d=163\)을 사용하면

  -
    \(e^{\pi \sqrt{163}} = 262\,537\,412\,640\,768\,743.999\,999\,999\,999\,25\cdots\)

이다. 이는 [스리니바사 라마누잔이](https://ko.wikipedia.org/wiki/스리니바사_라마누잔 "wikilink") 발견하였고, [라마누잔 수](https://ko.wikipedia.org/wiki/라마누잔_상수 "wikilink")()라고 한다.
...
& {}\,\,\, \vdots
\end{align}\] 이 관계를 [가공할 헛소리](https://ko.wikipedia.org/wiki/가공할_헛소리 "wikilink")()라고 한다. 여기서 (가공할, 말도 안 되는)는 괴물 군()에 대한 말장난이다. 이 놀라운 관계는 원래 존 매케이(, 1939–)가 1970년대에 최초로 발견하였고, [존 호턴 콘웨이가](https://ko.wikipedia.org/wiki/존_호턴_콘웨이 "wikilink") 이러한 이름을 붙였다. 이 사실은 [리처드 보처즈가](https://ko.wikipedia.org/wiki/리처드_보처즈 "wikilink") [리치 격자](https://ko.wikipedia.org/wiki/리치_격자 "wikilink")(Leech lattice)에 [축소화](https://ko.wikipedia.org/wiki/축소화 "wikilink")한 [보손 끈 이론을](https://ko.wikipedia.org/wiki/보손_끈_이론 "wikilink") 사용해 설명하였고, 이 공로로 [필즈상](https://ko.wikipedia.org/wiki/필즈상 "wikilink")을 수상하였다.

## 함께보기

  - [바이어슈트라스 제타 함수](https://ko.wikipedia.org/wiki/바이어슈트라스_제타_함수 "wikilink")
  - [자기동형 형식](https://ko.wikipedia.org/wiki/보형_형식 "wikilink")
