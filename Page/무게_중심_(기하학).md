...
[기하학](https://ko.wikipedia.org/wiki/기하학 "wikilink")에서, **무게 중심**(-中心, )은 주어진 도형 속 모든 점의 [산술 평균이](../Page/산술_평균.md "wikilink") 되는 점이다. 이는 도형을 밀도가 균일한 물체로 보았을 때 [물리학](../Page/물리학.md "wikilink")에서의 [무게 중심과](../Page/질량_중심.md "wikilink") 일치한다.\[1\]

## 정의

### 유한 개의 점의 무게 중심

[체](https://ko.wikipedia.org/wiki/체_\(수학\) "wikilink") \(F\) 위의 [아핀 공간](../Page/아핀_공간.md "wikilink") \(A\)가 주어졌고, 양의 정수 \(n\)이 \(F\)의 [표수의](https://ko.wikipedia.org/wiki/환의_표수 "wikilink") [배수](../Page/배수.md "wikilink")가 아니라고 하자. (예를 들어 \(A\)가 [유클리드 공간이며](https://ko.wikipedia.org/wiki/유클리드_공간 "wikilink") \(n\)은 임의의 양의 정수라고 가정할 수 있다.) 그렇다면 \(n\)개의 점 \(a_1,\dots,a_n\in A\)의 **무게 중심**은 다음을 만족시키는 유일한 점 \(g\in A\)로 정의된다.

\[\frac 1n\sum_{k=1}^n\overrightarrow{ga_k}=\vec 0\] 즉, 임의의 \(a\in A\)에 대하여, 다음이 성립한다.

\[g=a+\frac 1n\sum_{k=1}^n\overrightarrow{aa_k}\] 특히, \(A\)가 [벡터 공간일](https://ko.wikipedia.org/wiki/벡터_공간 "wikilink") 경우 다음이 성립한다.\[2\]
...
아핀 공간 \(A\)와 \(B\) 사이의 함수 \(T\colon A\to B\)에 대하여, 다음 두 조건이 서로 동치이다.\[9\]
  ...
  - [아핀 변환이다](https://ko.wikipedia.org/wiki/아핀_변환 "wikilink").
...
[정삼각형](https://ko.wikipedia.org/wiki/정삼각형 "wikilink")이 아닌 삼각형의 무게 중심은 [외심](https://ko.wikipedia.org/wiki/외심 "wikilink"), [구점원](https://ko.wikipedia.org/wiki/구점원 "wikilink")의 중심, [수심과](https://ko.wikipedia.org/wiki/수심_\(기하학\) "wikilink") 함께 [오일러 직선](https://ko.wikipedia.org/wiki/오일러_직선 "wikilink") 위의 점이다. 정삼각형의 무게 중심은 내심, 외심, 구점원의 중심, 수심과 일치한다.
