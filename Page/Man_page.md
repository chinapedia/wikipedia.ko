...
**man 페이지**(<small>←매뉴얼 페이지(Manual pages)의 줄임말</small>)는 거의 모든 [유닉스](../Page/유닉스.md "wikilink") 및 [유닉스 계열의](../Page/유닉스_계열.md "wikilink") [운영 체제에](../Page/운영_체제.md "wikilink") 기본으로 설치되는 광범위의 문서들이다. `man`라는 유닉스 명령어를 이용하면 이 문서들을 볼 수 있다. 각 페이지는 개별 문서로 이루어져 있다.
...
실제 최초의 man page는 1971년 [더글러스 매클로이의](https://ko.wikipedia.org/wiki/더글러스_매클로이 "wikilink") 주장으로 [데니스 리치와](../Page/데니스_리치.md "wikilink") [켄 톰프슨이](../Page/켄_톰프슨.md "wikilink") 작성하였다. man page 외에 "프로그래머의 매뉴얼" 또한 짧은 문서들을 모아두었고, 그 중 일부는 [강좌](https://ko.wikipedia.org/wiki/강좌 "wikilink")였고 그 외에는 운영 체제 기능에 대한 더 자세한 설명이었다.

Man page는 일반적으로 영어로 작성되어 있지만, 시스템에서 다른 언어로의 번역 또한 가능하다.

## 사용

[셸](../Page/셸.md "wikilink") 프롬프트에서 다음과 같은 식을 이용하면 유닉스 명령어에 대한 매뉴얼 페이지를 볼 수 있다.
...
매뉴얼은 일반적으로 여덟 개의 단락으로 나뉘어 있는데, ([BSD](../Page/BSD.md "wikilink"), [유닉스](../Page/유닉스.md "wikilink"), [리눅스](../Page/리눅스.md "wikilink") 등에서의) 단락은 다음과 같이 구성된다.

| 단락 | 설명                                                                                                  |
| -- | --------------------------------------------------------------------------------------------------- |
| 1  | 일반 [명령어](../Page/명령어_\(컴퓨팅\).md "wikilink")                                                         |
...
| 7  | 기타                                                                                                  |
| 8  | 시스템 관리 [명령어와](../Page/명령어_\(컴퓨팅\).md "wikilink") [데몬](../Page/데몬_\(컴퓨팅\).md "wikilink")             |
...
| -- | --------------------------------------------------------------------------------------------------- |
| 1  | 일반 [명령어](../Page/명령어_\(컴퓨팅\).md "wikilink")                                                         |
| 1M | 시스템 관리 [명령어와](../Page/명령어_\(컴퓨팅\).md "wikilink") [데몬](../Page/데몬_\(컴퓨팅\).md "wikilink")             |
| 2  | [시스템 호출](../Page/시스템_호출.md "wikilink")                                                              |
| 3  | [C 표준 라이브러리](../Page/C_표준_라이브러리.md "wikilink") 함수들                                                  |
...
| 9  | [커널](../Page/커널_\(컴퓨팅\).md "wikilink") 루틴들                                              |
