...
펄의 전반적인 구조는 대체적으로 C에서 가져왔다. 펄은 [변수](https://ko.wikipedia.org/wiki/변수_\(컴퓨터_과학\) "wikilink"), [식](https://ko.wikipedia.org/wiki/식_\(프로그래밍\) "wikilink"), [대입문](https://ko.wikipedia.org/wiki/대입문 "wikilink"), [괄호](https://ko.wikipedia.org/wiki/괄호 "wikilink")로 구분되는 [블록](https://ko.wikipedia.org/wiki/블록_\(프로그래밍\) "wikilink"), [제어 구조](../Page/제어_흐름.md "wikilink"), [서브루틴을](../Page/함수.md "wikilink") 갖추고 있는 [절차적](../Page/절차적_프로그래밍.md "wikilink") 프로그래밍 언어이다.
