...
펄 5 역사에서 가장 중요한 사건들 가운데 하나로는 모듈 지원을 들 수 있다. 1995년 10월 26일, 펄과 [펄 모듈들을](../Page/펄_모듈.md "wikilink") 저장, 관리하는 저장소 [CPAN](../Page/CPAN.md "wikilink")이 개설되었다. 2015년 6월 기준으로 31,896개의 배포판의 150,775개 이상의 모듈이 있고, 이 모듈들은 12,219명 이상의 작성자들이 작성하여 전 세계 253곳 이상의 지역에서 미러링되고 있다.\[13\]
  ...
  - 펄 5.004는 1997년 5월 15일 공개되었다. 여러 기능들 가운데 유니버설 패키지 기능이 포함되었으며, 모든 [클래스들이](https://ko.wikipedia.org/wiki/클래스_\(컴퓨터_과학\) "wikilink") 자동으로 만들어져 펄에 필요한 버전별 모듈을 요청할 수 있다. 그 밖의 중요한 점으로는 [CGI.pm](https://ko.wikipedia.org/wiki/CGI.pm "wikilink") 모듈이 포함된 것을 들 수 있는데\[14\], 펄이 [CGI 스크립트 언어로서](../Page/공용_게이트웨이_인터페이스.md "wikilink") 인기를 끄는데 기여하였다.\[15\]

또한 펄은 [마이크로소프트 윈도와](https://ko.wikipedia.org/wiki/마이크로소프트_윈도 "wikilink") 그 밖의 여러 운영 체제들에서의 실행을 지원한다.\[16\]

  - 펄 5.005가 1998년 7월 22일 공개되었다. [regex](https://ko.wikipedia.org/wiki/정규_표현식 "wikilink") 엔진에 여러 기능이 강화되었고, `B::*` 모듈을 통한 백엔드로의 새로운 후킹, `qr//` 정규 표현식 인용 연산자, 기타 새롭게 선별된 수많은 코어 모듈들이 포함되었으며 [BeOS](https://ko.wikipedia.org/wiki/BeOS "wikilink")를 포함한 더 많은 운영 체제들을 지원하게 되었다.\[17\]
...
2000년에 래리 월은 커뮤니티로부터 새로운 버전의 펄에 대한 제안을 해 줄 것을 요청하였다. 이를 통해 361 RFC 문서들이 생성되었고 이 문서들은 펄 6의 개발을 이끌어가는데 사용되었다. 2001년에는\[34\] 변경 요청 사항들을 요약하고 다음 세대의 펄의 설계를 나타내는 일련의 문서들인 [펄 6의](../Page/펄_6.md "wikilink") 계시록을 위한 작업이 시작되었다. 이 시점에 펄 6는 언어의 설명으로만 존재하였다.
  ...
  - 펄 5.12.0이 2010년 4월 12일 공개되었다. 새로운 `package NAME VERSION` 문법, 야다 야다 연산자(구현되지 않은 코드임을 표시하기 위한 기능), 암묵적 제한(implicit stricture), 완전한 [2038년 문제](https://ko.wikipedia.org/wiki/2038년_문제 "wikilink") 대응, 정규 표현식 변환 오버로딩, [DTrace](../Page/DTrace.md "wikilink") 지원, [유니코드](../Page/유니코드.md "wikilink") 5.2 지원을 포함한다.\[38\]
...
이 언어를 가리킬 때 이름은 고유 명사로서 일반적으로 앞 글자가 대문자인 "Perl"로 표기한다. 인터프리터 프로그램 그 자체를 가리킬 때에는 모두 소문자인 *perl*로 부르기도 하는데 이는 대부분의 유닉스 계열 운영 체제들이 대소문자를 구분하기 때문이다. 서적 《프로그래밍 펄》의 첫 판이 출시되기 전에 이 언어를 *perl*로 부르는 것이 일반적이었다. 그러나 [랜들 L. 슈왈츠는](https://ko.wikipedia.org/wiki/랜들_L._슈왈츠 "wikilink") 이 책에서 언어의 이름을 대문자화하여 조판 시에 더 잘 눈에 띄게 하였다. 최종적으로 이러한 대소문자 구별은 정규화된 채로 문서화되었다.\[54\]
...
펄의 전반적인 구조는 대체적으로 C에서 가져왔다. 펄은 [변수](https://ko.wikipedia.org/wiki/변수_\(컴퓨터_과학\) "wikilink"), [식](https://ko.wikipedia.org/wiki/식_\(프로그래밍\) "wikilink"), [대입문](https://ko.wikipedia.org/wiki/대입문 "wikilink"), [괄호](https://ko.wikipedia.org/wiki/괄호 "wikilink")로 구분되는 [블록](https://ko.wikipedia.org/wiki/블록_\(프로그래밍\) "wikilink"), [제어 구조](../Page/제어_흐름.md "wikilink"), [서브루틴을](https://ko.wikipedia.org/wiki/함수 "wikilink") 갖추고 있는 [절차적](https://ko.wikipedia.org/wiki/절차적_프로그래밍 "wikilink") 프로그래밍 언어이다.
...
펄은 [리스프](../Page/리스프.md "wikilink")로부터 [리스트](../Page/리스트_\(컴퓨팅\).md "wikilink") 개념을, [AWK](https://ko.wikipedia.org/wiki/AWK "wikilink")로부터 [해시](https://ko.wikipedia.org/wiki/연관_배열 "wikilink")(연관 배열) 개념을, [sed로부터](https://ko.wikipedia.org/wiki/sed_\(유틸리티\) "wikilink") [정규 표현식](https://ko.wikipedia.org/wiki/정규_표현식 "wikilink") 개념을 가져왔다. 이를 통해 수많은 구문 분석, 문자열 처리, 데이터 관리 작업을 단순하게 만들어준다.

모든 버전의 펄은 자동 [데이터 타이핑](../Page/자료형_체계.md "wikilink") 및 자동 [메모리 관리](../Page/메모리_관리.md "wikilink") 기능을 수행한다. 인터프리터는 프로그램 안의 모든 데이터마다 지니고 있는 자료형과 필요한 [기억 공간을](https://ko.wikipedia.org/wiki/기억_장치 "wikilink") 알고 있다. [참조 횟수 계산 방식을](../Page/참조_횟수_계산_방식.md "wikilink") 이용하여 필요한 만큼 기억 공간을 할당하고 해제한다. (즉, 수동적인 개입 없이는 [원형 데이터 구조의](https://ko.wikipedia.org/wiki/원형_버퍼 "wikilink") 할당을 해제할 수 없다) 숫자에서 문자열로의 변환과 같은 유효한 [형 변환은](https://ko.wikipedia.org/wiki/형_변환 "wikilink") [런타임](../Page/런타임.md "wikilink") 도중에 자동으로 수행되며 잘못된 형 변환은 치명적인 오류로 간주한다.
...
펄은 특정한 [프로그래밍 패러다임](https://ko.wikipedia.org/wiki/프로그래밍_패러다임 "wikilink")([절차적](https://ko.wikipedia.org/wiki/절차적_프로그래밍 "wikilink"), [객체 지향](https://ko.wikipedia.org/wiki/객체_지향_프로그래밍 "wikilink"), [함수형](https://ko.wikipedia.org/wiki/함수형_프로그래밍 "wikilink") 등)을 강요하지 않으며 심지어는 프로그래머가 이들 중 선택하도록 요구하지도 않는다.

### 응용 프로그램

펄은 수많은 표준 및 타사 모듈의 이용과 더불어 수많은 다양한 응용 프로그램들이 있다.

펄은 [CGI](../Page/공용_게이트웨이_인터페이스.md "wikilink") 스크립트를 작성하는데 주로 사용된다: 펄로 작성된 대형 프로젝트로는 [시패널](https://ko.wikipedia.org/wiki/시패널 "wikilink")(cPanel), [슬래시](../Page/슬래시닷.md "wikilink"), [버그질라](../Page/버그질라.md "wikilink"), [RT](https://ko.wikipedia.org/wiki/리퀘스트_트래커 "wikilink"), [트위키](../Page/트위키.md "wikilink"), [무버블 타입](https://ko.wikipedia.org/wiki/무버블_타입 "wikilink") 등이 있다. 펄을 광범위하게 사용하면서도 트래픽이 많은 웹사이트로는 [Priceline.com](https://ko.wikipedia.org/wiki/Priceline.com "wikilink"), [크레이그리스트](../Page/크레이그리스트.md "wikilink")\[67\], [IMDb](https://ko.wikipedia.org/wiki/인터넷_영화_데이터베이스 "wikilink")\[68\], [라이브저널](../Page/라이브저널.md "wikilink"), [덕덕고](https://ko.wikipedia.org/wiki/덕덕고 "wikilink")\[69\]\[70\], [슬래시닷](../Page/슬래시닷.md "wikilink"), [티켓마스터](https://ko.wikipedia.org/wiki/티켓마스터 "wikilink") 등이 있다. [PHP](../Page/PHP.md "wikilink")나 [파이썬](../Page/파이썬.md "wikilink") 대신 [웹 개발을](../Page/웹_개발.md "wikilink") 위한 [LAMP](https://ko.wikipedia.org/wiki/LAMP "wikilink") 기술 스택 구성요소를 선택적으로 사용할 수 있다.
...
펄의 문자열 핸들링 기능은 [SQL](../Page/SQL.md "wikilink") 쿼리를 생성하는데 사용될 수 있다. 배열, 해시, 자동 메모리 관리 기능을 통해 반환된 데이터를 수집하고 처리하기 매우 쉽다. 이를테면 Tim Bunce의 [펄 DBI](../Page/펄_DBI.md "wikilink") [API](../Page/API.md "wikilink") 내에서 API에 대한 인수들은 SQL 쿼리의 텍스트로 지정할 수 있다. 그러므로 여러 언어로 구성된 프로그램을 동시에 이용할 수 있다. (예: [HTML](../Page/HTML.md "wikilink"), [자바스크립트](https://ko.wikipedia.org/wiki/자바스크립트 "wikilink"), SQL을 이용하는 [웹 페이지를](../Page/웹_페이지.md "wikilink") [히어 도큐먼트](https://ko.wikipedia.org/wiki/히어_도큐먼트 "wikilink") 안에 생성할 수 있음) 프로그래밍적으로 사용자가 SQL 쿼리 각각을 만들 수 있는 펄의 [변수 보간의](https://ko.wikipedia.org/wiki/문자열_보간 "wikilink") 이용, 그리고 각 SQL 쿼리로부터 결과 [데이터셋](https://ko.wikipedia.org/wiki/데이터셋 "wikilink")을 프로그래밍적으로 보관하기 위한 구조로서의 펄 배열 또는 해시의 사양은 펄의 하위 프로그램에 의해 후처리할 목적으로 많은 양의 데이터를 관리하기 위한 높은 수준의 매커니즘을 허용한다.\[72\] 초기 버전의 펄에서 데이터베이스 인터페이스들은 [클라이언트 사이드](../Page/클라이언트_사이드.md "wikilink") 데이터베이스 라이브러리로 인터프리터를 다시 연결함으로써 작성되었다. 이것은 매우 어려운 작업이었는데, 가장 중요하고 가장 널리 사용되는 데이터베이스들 중 일부에 한해서만 할 수 있었고, 결과물이 되는 `perl` 실행파일이 한 번에 하나의 데이터베이스 인터페이스만 사용할 수 있도록 제한되었기 때문이다.
...
[섬네일](https://ko.wikipedia.org/wiki/파일:Camelia.svg "wikilink") 2000년에 펄 콘퍼런스에서 존 오원트(Jon Orwant)는 새로운 주된 언어의 발의를 위한 케이스를 만들었다.\[74\] 이를 통해 펄 6이라는 이름의 언어 재설계에 착수하기로 결정되었다. 새로운 언어 기능들에 대한 제안들이 펄 커뮤니티로부터 제기되었는데 그 [RFC](https://ko.wikipedia.org/wiki/RFC "wikilink")의 수는 300개 이상이다.
