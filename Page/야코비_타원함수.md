...
[긴 반지름이](https://ko.wikipedia.org/wiki/긴_반지름 "wikilink") \(a\ge1\)이며 [짧은 반지름이](https://ko.wikipedia.org/wiki/짧은_반지름 "wikilink") 1인 [타원](https://ko.wikipedia.org/wiki/타원 "wikilink")을 생각하자. 이 타원은 [직교좌표계](https://ko.wikipedia.org/wiki/직교좌표계 "wikilink")에서 다음과 같은 방정식에 의하여 정의된다.

\[x^2/a^2+y^2=1\] 이들을 [극좌표계](https://ko.wikipedia.org/wiki/극좌표계 "wikilink") \((r,\theta)=(\sqrt{x^2+y^2},\arctan(x/y))\)로 변환하면, 다음과 같은 함수들을 얻는다.
...
\[f(u;m)=f(u+4K(m);m)=f(u+4iK'(m);m)\] 여기서 \(K(m)\)과 \(K'(m)\)은 각각 **실사분주기**()와 **허사분주기**()라는 [특수 함수이며](https://ko.wikipedia.org/wiki/특수_함수 "wikilink"), 다음과 같다.

\[K(m)=\int_0^{\pi/2}\frac{d\theta}{\sqrt{1-m\sin^2\theta}}\]

\[K'(m)=K(1-m)\] 즉, 야코비 타원함수는 [타원 곡선](https://ko.wikipedia.org/wiki/타원_곡선 "wikilink") \(\mathbb C/\operatorname{Span}_{\mathbb Z}\{4K(m),4iK'(m)\}\) 위에 정의된 [유리형 함수이다](https://ko.wikipedia.org/wiki/유리형_함수 "wikilink").

### 극점과 영점

sn, cn, dn 모두

\[u=iK'(m)\] 에서 [단순극](https://ko.wikipedia.org/wiki/단순극 "wikilink")을 가지며, 그 [유수는](https://ko.wikipedia.org/wiki/유수_\(복소해석학\) "wikilink") 1이다.

sn, cn, dn은 [타원곡선](https://ko.wikipedia.org/wiki/타원곡선 "wikilink") 위에서 각각 하나의 영점을 가지며, 영점에서의 도함수는 1이다. 영점의 위치는 다음과 같다.
...
\(m=0\)일 때, 야코비 타원함수는 [삼각함수](https://ko.wikipedia.org/wiki/삼각함수 "wikilink")가 된다.
...
야코비 타원함수들은 [삼각함수](https://ko.wikipedia.org/wiki/삼각함수 "wikilink")와 유사한, 다음과 같은 항등식들을 만족시킨다.
...
[카를 구스타프 야코프 야코비가](https://ko.wikipedia.org/wiki/카를_구스타프_야코프_야코비 "wikilink") 1829년 저서 《타원함수론의 새로운 기반》()에서 도입하였다.\[1\]

## 같이 보기

  - [세타 함수](https://ko.wikipedia.org/wiki/세타_함수 "wikilink")
  - [바이어슈트라스 타원함수](../Page/바이어슈트라스_타원함수.md "wikilink")
  - [타원 적분](https://ko.wikipedia.org/wiki/타원_적분 "wikilink")
