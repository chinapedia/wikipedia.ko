...
\[-\infty<a<\infty\] 가 된다. 이에 따라서 \(\bar{\mathbb R}\)는 [완비 격자를](https://ko.wikipedia.org/wiki/완비_격자 "wikilink") 이룬다. 즉, 모든 부분 집합은 [상한](https://ko.wikipedia.org/wiki/상한 "wikilink")과 [하한](https://ko.wikipedia.org/wiki/하한 "wikilink")을 갖는다.
...
덧셈이나 곱셈을 일반적으로 정의할 수 없기 때문에, \(\bar{\mathbb R}\)는 [군이나](https://ko.wikipedia.org/wiki/군_\(수학\) "wikilink") [환](https://ko.wikipedia.org/wiki/환_\(수학\) "wikilink"), 심지어 [모노이드](https://ko.wikipedia.org/wiki/모노이드 "wikilink")의 구조를 가지지 않는다. 다만, 다음이 성립한다.
  ...
  - 만약 \(0\cdot\infty=0\)으로 정의한다면, 음이 아닌 확장된 실수 \(\bar{\mathbb R}_{\ge0}=[0,\infty]\)는 가환 [반환을](https://ko.wikipedia.org/wiki/반환_\(수학\) "wikilink") 이룬다.
