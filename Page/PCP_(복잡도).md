...
복잡도 이론에서 **PCP** 체계는 [대화형 증명 체계로](https://ko.wikipedia.org/wiki/대화형_증명_체계 "wikilink") 볼 수 있다. 여기에서 증명자()는 무기억 신탁(, 주로 문자열)이고 검증자()는 다항 시간 [확률적 알고리즘이다](../Page/확률적_알고리즘.md "wikilink"). 언어에 속하는 입력('예'인 보기)에 대해서는 검증자가 확실성()을 갖고 받아들이는 신탁(즉, 증명)이 있다. '아니오'인 보기에 대해서는 신탁이 무엇이든 검증자가 적어도 1/2 확률로 거부한다. (이 설명을 **[co-RP](../Page/RP_\(복잡도\).md "wikilink")** 쪽과 비교해 보라.)
...
**PCP** 알고리즘은 대부분 정확하게 설명하기 어렵지만, [3-CNF-SAT](https://ko.wikipedia.org/wiki/3-CNF-SAT "wikilink")을 푸는 알고리즘에 대한 간단한 발상이 있다. 3-CNF-SAT은 [충족 가능성 문제](../Page/충족_가능성_문제.md "wikilink") 중 [논리곱 정규형에서](https://ko.wikipedia.org/wiki/논리곱_정규형 "wikilink") 각 절에 리터럴이 세 개씩 있는 경우이다.
...
간단하고도 특별한 예 (*다항*은 다항 양, *log*는 로그 양을 나타낸다.)
  ...
  - PCP(0, 0) =[P](../Page/P_\(복잡도\).md "wikilink")
  - PCP(다항, 0) = [co-RP](../Page/RP_\(복잡도\).md "wikilink")
...
이것은 [근사 알고리즘이](../Page/근사_알고리즘.md "wikilink") 얼마나 어려운지를 증명할 때 쓸 만하다.
