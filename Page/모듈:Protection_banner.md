...
`           '`[`%s`](https://ko.wikipedia.org/wiki/%s:%s "wikilink")`',`
...
`   return string.format(`
`       '`[`%s`](https://ko.wikipedia.org/wiki/%s:%s#%s "wikilink")`',`
