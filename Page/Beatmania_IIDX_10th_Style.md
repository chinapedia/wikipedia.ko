...
최고 난이도 표기가 7+에서 8로 변경되었다. 거기에 곡을 풀콤보로 클리어시 화면에 특수한 이펙트가 연출되게 되었다.

## e-Amusement

10th Style에선 e-Amusement를 통해 자신이 플레이한 기록을 기반으로 폴더 별로 따로 분류할 수 있게 되었다. Failed, Cleared, Easy Clear , Full Combo 폴더가 바로 그것이다.
...
|                     |                                  |                          |               |
| Hyper J-Pop         | DoLL                             | TËЯRA                    | SuperNova 수록곡 |
|                     |                                  |                          |               |
...
|                     |                                  |                          |               |
| J-Revival           | 一途な恋 (HYPER J-EURO MIX)          | TËЯRA                    |               |
|                     |                                  |                          |               |
...
|                     |                                  |                          |               |
| Progressive Baroque | No. 13                           | TAKA respects for J.S.B. | SuperNova 수록곡 |
|                     |                                  |                          |               |
...
|                     |                                  |                          |               |
| Happy Hardcore      | rainbow rainbow                  | Ryu☆                     | SuperNova 수록곡 |
|                     |                                  |                          |               |
...
|                     |                                  |                          |               |
| **お江戸テクノ**          | **1st Samurai**                  | **sampling master MEGA** | **엑스트라**      |
|                     |                                  |                          |               |
| **Happy**           | **One More Lovely**              | **Risk Junk**            | **원 모어 엑스트라** |
