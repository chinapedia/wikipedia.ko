...
주어진 [아벨 군](https://ko.wikipedia.org/wiki/아벨_군 "wikilink") \(G\)에 대하여, [고리 공간](../Page/고리_공간.md "wikilink") 함자 \(L\)을 통해
...
\[G\cong \langle I| (R_j)_{j\in J}\rangle\qquad(R_j\in F(I)\] 를 임의로 고르자. 여기서 \(F(I)\)는 \(n=1\)일 경우 [집합](https://ko.wikipedia.org/wiki/집합 "wikilink") \(I\) 위의 [자유군](../Page/자유군.md "wikilink")이며 \(n>1\)일 경우 [집합](https://ko.wikipedia.org/wiki/집합 "wikilink") \(I\) 위의 [자유 아벨 군이다](../Page/자유_아벨_군.md "wikilink"). 그렇다면, \(n\)차원 [초구](https://ko.wikipedia.org/wiki/초구 "wikilink")들의 [쐐기합](https://ko.wikipedia.org/wiki/쐐기합 "wikilink")
...
\[\operatorname H^2(X;\mathbb Z)\cong\hom_{\operatorname{hTop}_\bullet}\left(X,\mathbb{CP}^\infty\right)\] 이다.
  ...
  - 둘째 등식은 \(\mathbb{CP}^1\)이 [원군](../Page/원군.md "wikilink")의 [분류 공간](../Page/분류_공간.md "wikilink") \(\operatorname B\operatorname U(1)\)이므로, U(1)-[주다발](https://ko.wikipedia.org/wiki/주다발 "wikilink") (복소수 [선다발](https://ko.wikipedia.org/wiki/선다발 "wikilink"))은 2차 코호몰로지류 ([천 특성류](https://ko.wikipedia.org/wiki/천_특성류 "wikilink"))에 의하여 완전히 분류됨을 뜻한다. 구체적으로, \(f\colon X\to\mathbb{CP}^\infty\)에 대응하는 코호몰로지류는 \(\mathbb{CP}^\infty\)의 2차 코호몰로지 \(\operatorname H^2(\mathbb{CP}^\infty)\cong\mathbb Z\)의 생성원의 [당김이다](../Page/당김_\(범주론\).md "wikilink").
