...
**3-어드레스 코드**(Three-address code)는, [컴파일러](https://ko.wikipedia.org/wiki/컴파일러 "wikilink")에서 사용되는 [중간 언어의](https://ko.wikipedia.org/wiki/중간_언어 "wikilink") 한 종류로, [컴파일러 최적화를](https://ko.wikipedia.org/wiki/컴파일러_최적화 "wikilink") 실현하는데 사용된다. '3-어드레스'로 불리는 것은 2개의 입력용과 1개의 출력용 [메모리 주소](https://ko.wikipedia.org/wiki/메모리_주소 "wikilink") 혹은 [레지스터를](https://ko.wikipedia.org/wiki/프로세서_레지스터 "wikilink") 지정하는 형식이기 때문이다.

## 개요

3-어드레스 코드의 각 명령은 명령코드, 오퍼랜드1, 오퍼랜드2, 결과의 4-[튜플](https://ko.wikipedia.org/wiki/튜플 "wikilink") 형태로 표현된다. 이는 다음과 같은 일반 식으로 표현할 수 있다.
