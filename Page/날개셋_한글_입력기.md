...
**날개셋 한글 입력기**는 김용묵이 개발한 한글 입출력을 구현하기 위한 프레임워크와 이를 사용하여 만들어진 [IME](https://ko.wikipedia.org/wiki/IME "wikilink")/[TSF](https://ko.wikipedia.org/wiki/TSF "wikilink") 환경을 포함하는 윈도용 한글 입력 시스템이다.
...
임
  ...
  - 이안처진다 복잡하게 보여 날개셋을 처음 사용하는 이용자는 설정을 제대로 하지 못하여 원하는 작동이 되지 않는 경우가 있다.
