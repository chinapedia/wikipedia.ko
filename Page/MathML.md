...
**MathML**(Mathematical Markup Language)은 [XML](../Page/XML.md "wikilink") 응용 중 하나로 [수학](../Page/수학.md "wikilink") 수식을 표현하고, 그 구조와 내용을 파악하기 위한 [마크업 언어이다](../Page/마크업_언어.md "wikilink"). [월드 와이드 웹](../Page/월드_와이드_웹.md "wikilink") 페이지 및 다른 문서들에 수식을 통합하는 것을 목적으로 한다. [W3C](../Page/W3C.md "wikilink") 매스(math) [워킹 그룹의](https://ko.wikipedia.org/wiki/워킹_그룹 "wikilink") 권고이며 [HTML5](../Page/HTML5.md "wikilink")의 일부이다.

## 표현과 의미

MathML은 *표현*만을 다루지 않으며 수식의 *의미* 요소도 다룬다(후자를 "내용Content MathML”이라 한다). 수식의 의미는 표현과는 별개로 보존되므로, 내용이 어떻게 소통되는지는 사용자에게 맡겨진다. 예를 들어 MathML 내장 웹 페이지는 많은 브라우저들에서 정상 웹 페이지로 보이지만, 시각장애인 사용자는 [스크린 리더](https://ko.wikipedia.org/wiki/스크린_리더 "wikilink") ([인터넷 익스플로러용](../Page/인터넷_익스플로러.md "wikilink") [매스플레이어](https://ko.wikipedia.org/wiki/매스플레이어 "wikilink") [플러그인](../Page/플러그인.md "wikilink"), [오페라](../Page/오페라_\(웹_브라우저\).md "wikilink") 9.50 빌드 9656 이상, 파이어폭스용 [파이어 복스](https://ko.wikipedia.org/wiki/파이어_복스 "wikilink") 확장 등)를 이용하여 MathML 읽기를 제공받을 수 있다.
...
이들 토큰 엘리먼트들은 호스트 언어에서 마크업을 허용하는 확장점으로 쓰일 수도 있다는 것에 주의하라. [HTML5](../Page/HTML5.md "wikilink")에서의 MathML은 mtext에서 대부분의 HTML 마크업을 허용한다. 즉,
...
식별자나 숫자 같은 토큰들은 표현 MathML에서처럼 개별적으로 마크업된다. 다만 `ci`나 `cn` 같은 엘리먼트로 표현된다. 연산자들은 단순히 다른 종류의 토큰이 되는 게 아니라, 특수 엘리먼트로 표현되는데, 이들의 수학적 의미는 MathML에 의해 인지된다. `times`, `power` 등이 그 예이다. 100개가 넘는 함수 및 연산자에 대응되는 엘리먼트가 있다(\[[https://web.archive.org/web/20130927054854/http://www.w3.org/TR/MathML3/chapter4.html\#contm.opel\]를](https://web.archive.org/web/20130927054854/http://www.w3.org/TR/MathML3/chapter4.html#contm.opel%5D를) 보라.).
...
[이차 방정식의](../Page/이차_방정식.md "wikilink") 근의 공식

\[x = \frac{-b \pm \sqrt{b^2 - 4ac}}{2a}\] 은 [LaTeX](../Page/LaTeX.md "wikilink") 문법으로는 다음처럼 나타낸다.
...
[오픈오피스](../Page/오픈오피스.md "wikilink") 수식편집에서는 다음 두 가지 방법으로 나타낸다.
...
인라인 MathML 또한 [HTML5](../Page/HTML5.md "wikilink") 파일에서 지원된다. [WebKit](https://ko.wikipedia.org/wiki/WebKit "wikilink") ([Safari](../Page/사파리_\(웹_브라우저\).md "wikilink"), [Chrome](https://ko.wikipedia.org/wiki/Google_Chrome "wikilink")), [Gecko](../Page/게코_\(레이아웃_엔진\).md "wikilink") ([Firefox](https://ko.wikipedia.org/wiki/Firefox "wikilink")). xhtml에서처럼 네임스페이스를 지정할 필요가 없다.
...
최근에 발표된 [마이크로소프트 워드](../Page/마이크로소프트_워드.md "wikilink"), [오픈오피스](../Page/오픈오피스.md "wikilink") 워드프로세서, 아래한글 [HWP](https://ko.wikipedia.org/wiki/HWP "wikilink") 등의 여러 문서 편집기에서 MathML을 지원하고 있다.

수식 입력 및 편집 전문 소프트웨어인 [매스매직](../Page/매스매직.md "wikilink"), MathType, [매스매티카](../Page/매스매티카.md "wikilink"), [메이플](../Page/메이플_\(소프트웨어\).md "wikilink") 등에서도 입력된 수식을 MathML 포맷으로 저장하거나, MathML 수식을 읽어들여 편집할 수 있도록 지원한다.
...
따라서 [수식 편집기](../Page/수식_편집기.md "wikilink") 소프트웨어마다 저마다의 장점을 앞세운 인터페이스와 다양한 입력 방식이 제시되었고, 프로그램에 따라 다양한 파일 포맷이 만들어지게 되었다.

많은 수식 편집기가 내부적인 수식 저장 포맷으로 [TeX](../Page/TeX.md "wikilink")과 [LaTeX](../Page/LaTeX.md "wikilink") 표현을 차용하거나 이를 응용하여 사용하고 있기는 하지만, 용도에 따라 수식을 화면에 표시하기 위한 그림 포맷([GIF](../Page/GIF.md "wikilink"), [JPEG](../Page/JPEG.md "wikilink"), [PNG](../Page/PNG.md "wikilink") 등), 다른 응용 프로그램과 호환하기 위한 포맷([LaTeX](../Page/LaTeX.md "wikilink"), [TeX](../Page/TeX.md "wikilink"), MathML, WMF, PICT 등), 고품질 출력을 위한 포맷([EPS](https://ko.wikipedia.org/wiki/EPS "wikilink"), [PDF](../Page/PDF.md "wikilink"), [SVG](https://ko.wikipedia.org/wiki/SVG "wikilink"), [DVI](https://ko.wikipedia.org/wiki/DVI "wikilink")) 등 다양한 포맷으로 사용되고 있다.
...
주요 [웹 브라우저](../Page/웹_브라우저.md "wikilink") 중에서 최신 버전의 [게코](../Page/게코_\(레이아웃_엔진\).md "wikilink") 엔진을 사용하는 브라우저([파이어폭스](https://ko.wikipedia.org/wiki/파이어폭스 "wikilink")나 [카미노](../Page/카미노.md "wikilink") 등)와 [오페라](../Page/오페라_\(웹_브라우저\).md "wikilink") 9.5 이상에서 지원하고 있다.
...
## 외부 링크
  ...
  -
  - [MathML 지원 소프트웨어 목록](https://web.archive.org/web/20101030081507/http://www.w3.org/Math/Software/)
