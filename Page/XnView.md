...
제작자는 XnView 코드 기반을 사용하여 MS windows외에도 다양한 OS를 지원하는 다양한 제품들을 출시하였으며, 그 예는 다음과 같다:
  ...
  - XnConvert — GUI 일괄 변환 도구 ([리눅스](../Page/리눅스.md "wikilink"), [macOS](https://ko.wikipedia.org/wiki/macOS "wikilink"), [윈도우](../Page/마이크로소프트_윈도우.md "wikilink")) 실제 버전 1.73
  - Xn — [iOS](https://ko.wikipedia.org/wiki/iOS "wikilink")용 앱
  - XnShell — [파일 탐색기 / 윈도우 탐색기](../Page/파일_탐색기.md "wikilink") 셸 확장 (32비트, 64비트)
