...
[수리논리학](https://ko.wikipedia.org/wiki/수리논리학 "wikilink")에서, 공리계 등의 이론에 대하여 **무모순성**(無矛盾性, ) 또는 **일관성**(一貫性)이 성립한다 함은, 그 이론으로부터 [모순](https://ko.wikipedia.org/wiki/모순 "wikilink")을 추론할 수 없다는 의미이다.
...
[1차 논리](https://ko.wikipedia.org/wiki/1차_논리 "wikilink") 언어 \(\mathcal L\)이 주어졌다고 하자. 그렇다면, [1차 논리](https://ko.wikipedia.org/wiki/1차_논리 "wikilink") \(\mathcal L\)-문장(즉, 자유 변수가 없는 \(\mathcal L\)-[논리식](https://ko.wikipedia.org/wiki/논리식 "wikilink"))들의 집합 \(\operatorname{Sent}(\mathcal L)\)의 [멱집합](https://ko.wikipedia.org/wiki/멱집합 "wikilink") \(\mathcal P(\operatorname{Sent}(\mathcal L))\)을 생각하자. \(\mathcal L\)-문장들의 집합 \(T\in\mathcal P(\operatorname{Sent}(\mathcal L))\)을 \(\mathcal L\)-**이론**()이라고 한다.
...
[페아노 공리계](https://ko.wikipedia.org/wiki/페아노_공리계 "wikilink") \(\mathsf{PA}\)의 언어 \(\mathcal L_{\text{Peano}}\)는 하나의 상수 \(0\)과 하나의 1항 연산 \((-)^+\)을 포함한다.

\(\mathcal L\)의 기호들이 자연수의 [재귀 집합을](https://ko.wikipedia.org/wiki/재귀_집합 "wikilink") 이룬다고 하자 (특히, 오직 가산 개의 기호만이 존재한다). 그렇다면, \(\mathcal L\)-이론 \(T\in\mathcal P(\operatorname{Sent}(\mathcal L))\)이 무모순적인지 여부는 [페아노 공리계의](https://ko.wikipedia.org/wiki/페아노_공리계 "wikilink") 언어로 나타낼 수 있다. 이 \(\mathcal L_{\text{Peano}}\)-문장을 \(\operatorname{Con}(T)\)라고 한다.
...
\(\mathcal L_{\text{Peano}}\)를 \(\mathcal L\)로 해석할 수 있다고 하자. 그렇다면, **[괴델의 불완전성 정리](https://ko.wikipedia.org/wiki/괴델의_불완전성_정리 "wikilink")**에 따르면, 임의의 이론 \(T\subseteq\operatorname{Sent}(\mathcal L)\)에 대하여, 다음이 성립한다.
