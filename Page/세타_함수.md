...
[수학](https://ko.wikipedia.org/wiki/수학 "wikilink")에서 **세타 함수**()는 [타원 곡선](https://ko.wikipedia.org/wiki/타원_곡선 "wikilink") 또는 [아벨 다양체](../Page/아벨_다양체.md "wikilink") 위의 [선다발](https://ko.wikipedia.org/wiki/선다발 "wikilink")의 단면이다.
...
이 경우, \(\operatorname{Im}h\)는 \(V/\Gamma\) 위의 [2차 미분 형식이며](https://ko.wikipedia.org/wiki/2차_미분_형식 "wikilink"), [드람 코호몰로지를](https://ko.wikipedia.org/wiki/드람_코호몰로지 "wikilink") 통해 정수 계수 2차 코호몰로지 \(\operatorname H^2(V/\Gamma;\mathbb Z)\)의 원소를 정의한다. 이는 (1차 [천 특성류를](https://ko.wikipedia.org/wiki/천_특성류 "wikilink") 통해) 어떤 [정칙](../Page/정칙_벡터_다발.md "wikilink") [선다발](https://ko.wikipedia.org/wiki/선다발 "wikilink") \(L\)에 대응하며, 이는 항상 [풍성한 선다발이다](https://ko.wikipedia.org/wiki/풍성한_선다발 "wikilink"). 이 선다발의 **단면**을 **세타 함수**라고 한다.

보다 구체적으로, 사영 사상 \(\pi\colon V \twoheadrightarrow V/\Gamma\)을 통하여, \(L\)의 [당김](https://ko.wikipedia.org/wiki/당김 "wikilink") \(L^*V \twoheadrightarrow V\)을 정의할 수 있다. 이는 자명한 정칙 선다발이며, \(L\)의 단면은 \(V\) 위의 다음과 같은 **함수 방정식**(函數方程式, )을 따르는 [정칙 함수](https://ko.wikipedia.org/wiki/정칙_함수 "wikilink") \(f\colon V \to \mathbb C\)로 주어진다.
...
\[\alpha (\lambda + \lambda') = \exp\left(\mathrm i\pi \operatorname{Im}h(\lambda,\lambda')\right) \alpha(\lambda) \alpha(\lambda')\] 이는 군 준동형이 아니지만, 임의의 군 준동형 \(\phi \colon \Gamma \to \operatorname U(1)\)에 대하여 \(\alpha' = \phi \alpha\) 역시 위의 조건을 따른다. 즉, 이러한 \(\alpha\)들의 공간은 \(\hom(\Gamma,\operatorname U(1)) \cong \operatorname U(1)^{\dim V}\) 위의 [아핀 공간이다](https://ko.wikipedia.org/wiki/아핀_공간 "wikilink").

이러한 함수 방정식을 따르는 [정칙 함수를](https://ko.wikipedia.org/wiki/정칙_함수 "wikilink") **세타 함수**라고 한다.

## 예

### 야코비 세타 함수

**야코비 세타 함수**([카를 구스타프 야코프 야코비의](https://ko.wikipedia.org/wiki/카를_구스타프_야코프_야코비 "wikilink") 이름에서 비롯됨)는 \(z\)와 \(\tau\)를 변수로 갖는 2변수 복소함수로, \(z\)는 임의의 복소수가 될 수 있지만 \(\tau\)는 [상반평면](https://ko.wikipedia.org/wiki/상반평면 "wikilink")으로 제한되어 언제나 양의 허수부를 갖는다. 그 정의는 다음과 같다.
...
\[q=\exp(2\pi i\tau)\] 이는 [상반평면](https://ko.wikipedia.org/wiki/상반평면 "wikilink") \(\mathbb H\) 위의 [정칙함수](https://ko.wikipedia.org/wiki/정칙함수 "wikilink")이다. 만약 \(\Lambda\)가 \(n\)차원 짝 [유니모듈러 격자라면](../Page/유니모듈러_격자.md "wikilink"), 이는 무게가 \(n/2\)인 [모듈러 형식을](https://ko.wikipedia.org/wiki/모듈러_형식 "wikilink") 이룬다. 홀 유니모듈러 격자의 세타 함수는 다음과 같은 모듈러 항등식들을 만족시킨다.\[2\]
...
야코비 세타 함수는 [아벨 다양체](../Page/아벨_다양체.md "wikilink") 및 [모듈라이 공간](../Page/모듈라이_공간.md "wikilink") 및 [이차 형식의](https://ko.wikipedia.org/wiki/이차_형식 "wikilink") 연구에 중요하게 쓰이며, [솔리톤](https://ko.wikipedia.org/wiki/솔리톤 "wikilink") 이론에도 응용되었다. [그라스만 대수에](https://ko.wikipedia.org/wiki/그라스만_대수 "wikilink") 대해 일반화할 경우 [양자장론](https://ko.wikipedia.org/wiki/양자장론 "wikilink"), 특히 [끈 이론과](https://ko.wikipedia.org/wiki/끈_이론 "wikilink") [D-막](https://ko.wikipedia.org/wiki/D-막 "wikilink") 등에도 연관된다. 세타 함수의 대표적인 예는 [타원함수론](https://ko.wikipedia.org/wiki/타원함수론 "wikilink")에 나타난다.

세타 함수는 [기하학적 양자화에](../Page/기하학적_양자화.md "wikilink") 등장한다. [위상 공간이](../Page/위상_공간_\(물리학\).md "wikilink") [켈러 다양체인](https://ko.wikipedia.org/wiki/켈러_다양체 "wikilink") [해밀턴 계를](https://ko.wikipedia.org/wiki/해밀턴_계 "wikilink") 양자화할 경우, 양자역학적 상태들은 어떤 해석적 다발의 해석적 단면들의 [힐베르트 공간의](https://ko.wikipedia.org/wiki/힐베르트_공간 "wikilink") 원소가 된다. 특히, 위상 공간이 극성화가 주어진 [아벨 다양체인](../Page/아벨_다양체.md "wikilink") 경우, 상태들은 세타 함수가 된다.
