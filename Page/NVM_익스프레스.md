...
[섬네일의](https://ko.wikipedia.org/wiki/파일:IO_stack_of_the_Linux_kernel.svg "wikilink") 스토리지 스택의 다양한 계층 안에 있는 NVMe 데이터 경로와 다중 내부 큐의 위치.\[24\]\]\]
  ...
  - [iOS](https://ko.wikipedia.org/wiki/iOS "wikilink")
    [아이폰 6S](https://ko.wikipedia.org/wiki/아이폰_6S "wikilink"), [6S 플러스의](https://ko.wikipedia.org/wiki/아이폰_6S_플러스 "wikilink") 출시와 함께 [애플](../Page/애플.md "wikilink")은 \[스마트폰에 [PCIe를](../Page/PCI_익스프레스.md "wikilink") 통한 NVMe의 첫 모바일 기능을 도입하였다.\[32\]
  - 리눅스
