...
C++11 표준이 제정되기 이전에는 <cstdlib>을 인클루드 하여 [C언어의](https://ko.wikipedia.org/wiki/C_\(프로그래밍_언어\) "wikilink") rand함수를 그대로 사용하였으나, C++11 표준부터 새로운 방식의 난수생성이 표준으로 제정되어 random 헤더파일을 인클루드 하면 난수를 생성할 수 있다.
...
### [Python](https://ko.wikipedia.org/wiki/파이썬 "wikilink")
