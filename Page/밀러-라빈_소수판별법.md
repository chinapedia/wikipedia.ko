...
**밀러-라빈 소수판별법**(Miller-Rabin primality test)은 입력으로 주어진 수가 [소수인지](../Page/소수_\(수론\).md "wikilink") 아닌지 [판별하는](https://ko.wikipedia.org/wiki/소수판별법 "wikilink") [알고리즘](../Page/알고리즘.md "wikilink")이다. **라빈-밀러 소수판별법**(Rabin-Miller primality test)이라고도 한다. [개리 L. 밀러의](https://ko.wikipedia.org/wiki/개리_L._밀러 "wikilink") 원래 알고리즘은 [일반 리만 가설에](https://ko.wikipedia.org/wiki/일반_리만_가설 "wikilink") 기반한 [결정론적 알고리즘이었는데](../Page/결정론적_알고리즘.md "wikilink"), [미하엘 라빈이](https://ko.wikipedia.org/wiki/미하엘_라빈 "wikilink") [확률적 알고리즘으로](../Page/확률적_알고리즘.md "wikilink") 변경했다.
...
## 참고문헌
  ...
  - Thomas H. Cormen, Charles E. Leiserson, Ronald L. Rivest, and Clifford Stein. *[Introduction to Algorithms](https://ko.wikipedia.org/wiki/Introduction_to_Algorithms "wikilink")*, Second Edition. MIT Press and McGraw-Hill, 2001. . Pages 890–896 of section 31.8, Primality testing.
