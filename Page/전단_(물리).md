...
특히 [유체 역학에서는](https://ko.wikipedia.org/wiki/유체_역학 "wikilink") 쏠림현상 또는 층밀리기 [변형력](https://ko.wikipedia.org/wiki/변형력 "wikilink")이라고도 한다.
...
\[F =\] [작용](https://ko.wikipedia.org/wiki/작용_\(물리학\) "wikilink") [힘](https://ko.wikipedia.org/wiki/힘_\(물리\) "wikilink")
...
\frac 1 u & 0 \\
0 & \frac 1 u
\end{pmatrix}\] 일때, 점도는 유속에 의존하기 때문에 [비(非)뉴튼 유체](https://ko.wikipedia.org/wiki/비뉴턴_유체 "wikilink")(Nonnewtonian)이다. 이 비 뉴튼유체는 [등방성](https://ko.wikipedia.org/wiki/등방성 "wikilink") (행렬은 단위 행렬에 비례 함)이므로 점도는 단순히 스칼라이다.
