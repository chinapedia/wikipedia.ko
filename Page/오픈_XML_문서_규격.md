...
마이크로소프트는 XPS 규격은 [Ecma 인터내셔널에](../Page/Ecma_인터내셔널.md "wikilink") 제출하였다.\[2\]
...
TC46의 멤버는 다음과 같다:
  ...
  - [글로벌 그래픽스](https://ko.wikipedia.org/wiki/글로벌_그래픽스 "wikilink")
...
<!-- end list -->
  ...
  - [조란 코퍼레이션](https://ko.wikipedia.org/wiki/조란_코퍼레이션 "wikilink")

## 같이 보기

  - [XFDL](https://ko.wikipedia.org/wiki/XFDL "wikilink")
