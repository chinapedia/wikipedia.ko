...
**콜라츠 추측**(Collatz conjecture)은 1937년에 처음으로 이 추측을 제기한 [로타르 콜라츠의](https://ko.wikipedia.org/wiki/w:Lothar_Collatz "wikilink") 이름을 딴 것으로 **3n+1 추측**, **[울람](https://ko.wikipedia.org/wiki/스타니스와프_울람 "wikilink") 추측**, 혹은 **헤일스톤(우박) 수열** 등 여러 이름으로 불린다. 콜라츠 추측은 임의의 자연수가 다음 조작을 거쳐 항상 1이 된다는 추측이다.
