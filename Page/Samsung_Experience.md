...
2016년 12월 15일, [삼성](https://ko.wikipedia.org/wiki/삼성 "wikilink")은 "Samsung Experience"라는 이름의 상표를 로고와 함께 등록하였다.\[4\]
...
## 기능
  ...
  - [빅스비](https://ko.wikipedia.org/wiki/빅스비 "wikilink")
      - [빅스비](https://ko.wikipedia.org/wiki/빅스비 "wikilink") 보이스
      - [빅스비](https://ko.wikipedia.org/wiki/빅스비 "wikilink") 비전
      - [빅스비](https://ko.wikipedia.org/wiki/빅스비 "wikilink") 홈
      - 리마인더
  - S 펜 (갤럭시 노트 한정)
      - 에어 커맨드
      - 스마트 셀렉트
...
<tbody>
<tr class="odd">
<td><p>Samsung Experience 8 (업데이트된 버전의 그레이스 UX)</p></td>
...
<dl>
<dt>업데이트된 Always-On 디스플레이</dt>

</dl>
<ul>
<li>서드파티 앱 및 캘린더 알림.</li>
<li>사용자 지정 서명.</li>
<li>스크린 오프 메모.</li>
<li>추가 시계 스타일.</li>
</ul>
...
<ul>
<li>최대 120도 시야각의 셀카.</li>
</ul></td>
</tr>
<tr class="even">
<td><p>Samsung Experience 8.1 (갤럭시 S8과 함께 출시)</p></td>
...
<ul>
<li>데스크톱 경험을 위해 갤럭시 S8를 모니터, 키보드, 마우스에 연결.</li>
</ul>
<dl>
<dt>빅스비 (갤럭시 S8 한정)</dt>
...
<ul>
<li>사용자로부터 학습하는 인텔리전트 인터페이스. 이메일 및 메시지와 같은 앱을 선택할 수 있으며 통보 기능을 하거나 설정을 이해하고 삼성 기기를 설정할 수 있다.</li>
</ul>
<dl>
<dt>빅스비 비전 (갤럭시 S8 한정)</dt>

</dl>
<ul>
<li>카메라를 통해 외국어 번역, 명함 스캔, QR 코드 스캔</li>
</ul>
<dl>
<dt>삼성 커넥트 지원</dt>
...
<ul>
<li>앱 드로어(App Drawer)를 위해 위로 스와이프</li>
<li>설정 틀 재설계</li>
</ul></td>
</tr>
<tr class="odd">
<td><p>Samsung Experience 8.5 (갤럭시 노트 8과 함께 출시)</p></td>
...
<ul>
<li>멀티 윈도를 사용하여 2개의 앱을 한 번에 열기</li>
</ul>
<dl>
<dt>확장된 S 펜 기능</dt>
...
<tr class="even">
<td><p>Samsung Experience 9.0 (갤럭시 S9과 함께 출시)</p></td>
<td><p>2018년 2월 26일</p></td>
<td><dl>
<dt>Samsung 갤러리, Samsung 메시지 앱 아이콘, UI 변경.</dt>

</dl>
<ul>
<li>프레임 좀 더 안정화.</li>
<li>뒷면 지문인식 홈키를 이용해 상단바를 내리는 기능을 두 가지 더 추가.</li>
</ul>
<dl>
<dt>Always on display 밝기 조절</dt>

</dl>
<ul>
<li>신규 AOD 디자인</li>
<li>대기 화면 여러번 움직임. (번인 방지)</li>
</ul>
<dl>
<dt>적용된 디바이스에 최적화 됨.</dt>
...
## 지원 기기
  ...
  - Samsung Experience 9
      - Samsung Experience 9.0 기반
          ...
          - 삼성 [갤럭시 S7](https://ko.wikipedia.org/wiki/갤럭시_S7 "wikilink") 계열 단말기 오레오 업데이트로 적용
          - 삼성 갤럭시 A5 2017 5월 8일 업데이트
          - 삼성 갤럭시 A7 2017 5월 28일 업데이트
          - 삼성 [갤럭시 A8](https://ko.wikipedia.org/wiki/갤럭시_A8 "wikilink") 2018 7월 18일 업데이트
          - [삼성 갤럭시 A8 (2016)](../Page/삼성_갤럭시_A8_\(2016\).md "wikilink") 오레오 업데이트로 적용
          - [삼성 갤럭시 A7 (2018)](https://ko.wikipedia.org/wiki/삼성_갤럭시_A7_\(2018\) "wikilink") 오레오 기본 탑재
...
<!-- end list -->
  ...
  - Samsung Experience 8
      - Samsung Experience 8.0 기반
          - [삼성 갤럭시 S6](../Page/삼성_갤럭시_S6.md "wikilink") 누가 업데이트로 적용
          - [삼성 갤럭시 S6 엣지](../Page/삼성_갤럭시_S6_엣지.md "wikilink") 누가 업데이트로 적용
          - [삼성 갤럭시 S6 엣지 플러스](../Page/삼성_갤럭시_S6_엣지_플러스.md "wikilink") 누가 업데이트로 적용
...
<!-- end list -->
  ...
  -   - Samsung Experience 8.1 기반
          ...
          - [삼성 갤럭시 A5 (2017)](../Page/삼성_갤럭시_A5_\(2017\).md "wikilink") (누가업데이트후 2017.8.21)
          - [삼성 갤럭시 A7 (2017)](../Page/삼성_갤럭시_A7_\(2017\).md "wikilink") (글로벌 모델)
          - [삼성 갤럭시 On7(2016)](https://ko.wikipedia.org/wiki/삼성_갤럭시_on7\(2016\) "wikilink")(누가 업데이트 후)
          - [삼성 갤럭시 J7 (2016)](https://ko.wikipedia.org/wiki/삼성_갤럭시_j7_\(2016\) "wikilink") (누가 업데이트 후)
...
[분류:모바일 운영 체제](https://ko.wikipedia.org/wiki/분류:모바일_운영_체제 "wikilink") [분류:삼성전자](https://ko.wikipedia.org/wiki/분류:삼성전자 "wikilink") [분류:커스텀 안드로이드 펌웨어](https://ko.wikipedia.org/wiki/분류:커스텀_안드로이드_펌웨어 "wikilink") [분류:안드로이드 소프트웨어](https://ko.wikipedia.org/wiki/분류:안드로이드_소프트웨어 "wikilink")

1.
2.
3.   All top APPLE news, iPhone, iMac, iPad, Apple Watch|language=en-US|access-date=2017-01-29}}
4.