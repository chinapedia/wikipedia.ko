...
**오르가논**(Organon)은 [아리스토텔레스](https://ko.wikipedia.org/wiki/아리스토텔레스 "wikilink")의 논리학 저작 전체를 가리키는 명칭이다. 6세기부터 이 이름으로 불렀다. 학문의 실질적인 부분이 아니라 그 도구라는 뜻이다. 아리스토텔레스에게는 논리학(로기케)의 명칭이 없었으며, 분석론(아나류티카)이 주로 그것에 해당한다. '분석론'은 추론(推論)을 [삼단논법으로](https://ko.wikipedia.org/wiki/연역법 "wikilink") 분석, 여러 가지 형식과 정합성(整合性)과 진리와의 관계를 논한다. 이 밖에 통념에 의한 변증적 추론(디아렉티케)을 다루었던 '토피카', 판단과 명제를 논하는 '명제론', 주어와 술어의 개념에 관한 종류를 논하는 '범주론'이 포함되어 있다.
...
## 함께보기
  ...
  - [형이상학 (아리스토텔레스)](https://ko.wikipedia.org/wiki/형이상학_\(아리스토텔레스\) "wikilink")
  - [니코마코스 윤리학](../Page/니코마코스_윤리학.md "wikilink")
  - [시학 (아리스토텔레스)](https://ko.wikipedia.org/wiki/시학_\(아리스토텔레스\) "wikilink")
