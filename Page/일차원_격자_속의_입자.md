...
[양자역학](https://ko.wikipedia.org/wiki/양자역학 "wikilink")에서 **일차원 격자 속의 입자**(Particle in a one-dimensional lattice) 문제는 주기성을 가진 [결정 격자](https://ko.wikipedia.org/wiki/결정_격자 "wikilink")(crystal lattice)에서 입자의 파동함수를 모델링하면서 등장한다. 이 주기적 퍼텐셜은 [결정](https://ko.wikipedia.org/wiki/결정 "wikilink") 내에 주기적으로 존재하는 이온에 의해 생겨나는 전자기장에 의한 것이다. 결정 내의 전자들의 파동함수는 이 주기를 가진 퍼텐셜에 의해 결정된다. 이는 자유전자 모델을 확장하여 풀어낼 수 있다.
...
[블로흐 파에](https://ko.wikipedia.org/wiki/블로흐_파 "wikilink") 따라 \(u(x)=u(x+d)\)로 나타낼 수 있고 격자상수 \(d\)는 \(a+b\)이다.
...
## 같이 보기
  ...
  - [상자 속 입자](https://ko.wikipedia.org/wiki/상자_속_입자 "wikilink")
