> This article is converted from Wikipedia: [Example.com](https://ko.wikipedia.org/wiki/Example.com).
...
*username@example.com*과 같은 주소를 사용하여 웹사이트의 등록 프로세스를 시연할 때, 메일을 받게 되면 사용자에게 실제 [전자 우편 주소를](../Page/전자_우편_주소.md "wikilink") 입력하라는 지시를 하게 된다. *Example.com*은 포괄적이면서 벤더 중립적인 방식으로 사용된다.

이 도메인 이름들은 [ICANN](https://ko.wikipedia.org/wiki/ICANN "wikilink")이 관리하고 [DNSSEC](../Page/DNSSEC.md "wikilink")를 사용하여 디지털 서명된 [웹 서버의](../Page/웹_서버.md "wikilink") [IPv4](../Page/IPv4.md "wikilink"), [IPv6](../Page/IPv6.md "wikilink")에 대한 [인터넷 프로토콜](../Page/인터넷_프로토콜.md "wikilink")(IP) 주소를 처리한다.

## 같이 보기

  - [.example](https://ko.wikipedia.org/wiki/.example "wikilink") - 문서화 목적으로 예비된 [최상위 도메인](https://ko.wikipedia.org/wiki/최상위_도메인 "wikilink") 이름
  - [.local](https://ko.wikipedia.org/wiki/.local "wikilink") - [의사 TLD](https://ko.wikipedia.org/wiki/의사_상위_최상_도메인 "wikilink")
...
1.  RFC 2606, *Reserved Top Level DNS Names*, D. Eastlake, A. Panitz, The [Internet Society](../Page/인터넷_협회.md "wikilink") (June 1999)