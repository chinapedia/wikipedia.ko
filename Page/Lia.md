...
4세부터 클래식 발레를 시작. 8세부터 뮤지컬등의 무대에서 활약. 12세에 주연으로 발탁되어 이후 수많은 무대에 출연. 15세에 미국으로 건너감. 그 후 본격적으로 음악의 길로 나아간다고 결심. 미국 거주 중 클래식으로부터 재즈, 가스펠까지, 어떤 음악이라도 불러 해낼 수 있는 진정한 가수를 목표로 해 트레이닝을 계속한다. 조나단·버틀러의 백 보컬이나 Reverece Gospel Choir의 멤버로서 활동을 하면서, 여러가지 콘테스트, 페스티벌에서 수상. LA 거주 중에, Key 발매의 초히트작 「AIR」의 테마곡을 부르는 싱어로 발탁된다. 2003년 9월에는 [이나바 아키라의](https://ko.wikipedia.org/wiki/이나바_아키라 "wikilink") 앨범에서 듀엣 참가. 이탈리아어로 「VIVO PER LEI」의 커버를 불러, 싱어로서의 폭을 넓혔다. 한편으로 UK, USA의 HARDCORE 싱어로서 활동도 개시. 영국, 미국에서 발매된 HAPPY HARDCORE의 컴필레이션 CD에 참가, 그 후 UK에서 「LIA」이름으로 아날로그 레코드 발매를 했다. 그리고 2004년 6월 25일, queens label 첫 솔로 앨범을 발매했다.
...
## 노래
  ...
  - 〈([새의 시](https://ko.wikipedia.org/wiki/새의_시 "wikilink"))〉 - 게임 《[에어](../Page/에어_\(비디오_게임\).md "wikilink")》 오프닝 테마
  - 〈Farewell song〉 - 게임 《에어》 엔딩 테마
  - 〈(여름 그림자)〉 - 게임 《에어》 이미지 송
  - 〈(푸른 하늘)〉 - 게임 《에어》 삽입곡
  - 〈Ana〉 - 게임, 애니《[클라나드](https://ko.wikipedia.org/wiki/클라나드_\(비디오_게임\) "wikilink")》 삽입곡
  - 〈(약속)〉 - 극장 애니 《CLANNAD》 이미지 송
  - 〈Light colors〉 - 게임《[토모요 애프터](https://ko.wikipedia.org/wiki/토모요_애프터 "wikilink")》 오프닝 테마
  - 〈Life is like a Melody〉 - 게임《[토모요 애프터](https://ko.wikipedia.org/wiki/토모요_애프터 "wikilink")》 엔딩 테마
  - 〈The Force of Love〉 - 게임 《[RF 온라인](https://ko.wikipedia.org/wiki/RF_온라인 "wikilink")》 테마 송
  - 〈(내일을 향해) Get Dream\!〉 - 애니 《[폭구Hit\! 크래쉬 비드맨](https://ko.wikipedia.org/wiki/천하무적_크래쉬_비드맨 "wikilink")》 엔딩 테마
  ...
  - 〈〉(시간을 새기는 노래) - TV애니메이션 《[클라나드 \~애프터 스토리\~](https://ko.wikipedia.org/wiki/클라나드_\(비디오_게임\) "wikilink"))》 오프닝 테마
  - 〈TORCH〉- TV애니메이션 《[클라나드 \~애프터 스토리\~](https://ko.wikipedia.org/wiki/클라나드_\(비디오_게임\) "wikilink"))》 엔딩 테마
  - 〈Saya's Song〉- 게임 《[리틀 버스터즈\!](../Page/리틀_버스터즈!.md "wikilink")》 엔딩 테마
  - 〈〉- 게임 《[Fortune Arterial](https://ko.wikipedia.org/wiki/Fortune_Arterial "wikilink")》 엔딩테마 ("Veil"이라는 예명을 사용함)
  - 〈My Soul, Your Beats\!〉애니《[Angel Beats\!](https://ko.wikipedia.org/wiki/Angel_Beats! "wikilink")》 오프닝 테마
  - 〈인연의 색깔(絆-kizunairo-色)〉 애니 《[Fortune Arterial 붉은 약속](https://ko.wikipedia.org/wiki/Fortune_Arterial_붉은_약속 "wikilink")》 오프닝 테마
  - 〈I miss you〉 애니 《[Fortune Arterial 붉은 약속](https://ko.wikipedia.org/wiki/Fortune_Arterial_붉은_약속 "wikilink")》 엔딩 테마 ("Veil"이라는 예명을 사용함)
  - 〈メテオ〉- 동인음악 《[보컬로이드](../Page/보컬로이드.md "wikilink")》보컬로이드 프로듀서인 じょん의 meteor 수록곡 (IA 발매기념으로 [니코니코동화](https://ko.wikipedia.org/wiki/니코니코동화 "wikilink")에 투고됨)
