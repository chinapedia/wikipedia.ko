...
[선형대수학](https://ko.wikipedia.org/wiki/선형대수학 "wikilink")에서, **대칭 행렬**(對稱行列, )은 [전치 행렬이](https://ko.wikipedia.org/wiki/전치_행렬 "wikilink") 스스로와 같은 [행렬](https://ko.wikipedia.org/wiki/행렬 "wikilink")이다.
...
[유한 차원](https://ko.wikipedia.org/wiki/유한_차원 "wikilink") [벡터 공간의](https://ko.wikipedia.org/wiki/벡터_공간 "wikilink") [대칭 쌍선형 형식은](https://ko.wikipedia.org/wiki/대칭_쌍선형_형식 "wikilink") 대칭 행렬의 개념과 일치한다.
...
[체](https://ko.wikipedia.org/wiki/체_\(수학\) "wikilink") \(K\) 위의 \(n\times n\) 대칭 행렬의 집합은, 전체 행렬 [대수의](../Page/대수_\(환론\).md "wikilink") \(n(n+1)/2\)차원 [부분 대수를](https://ko.wikipedia.org/wiki/부분_대수 "wikilink") 이룬다. 또한, 만약 \(K\)의 [표수가](../Page/환의_표수.md "wikilink") 2가 아닐 경우, 전체 행렬 대수는 대칭 행렬과 [반대칭 행렬의](../Page/반대칭_행렬.md "wikilink") [벡터 공간의](https://ko.wikipedia.org/wiki/벡터_공간 "wikilink") [직합](../Page/직합.md "wikilink")이다. 즉, 다음이 성립한다.
