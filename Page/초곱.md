...
[모형 이론에서](https://ko.wikipedia.org/wiki/모형_이론 "wikilink"), **초곱**(超곱, )은 여러 [구조들의](../Page/구조_\(논리학\).md "wikilink") [곱집합](https://ko.wikipedia.org/wiki/곱집합 "wikilink")의 [동치류](https://ko.wikipedia.org/wiki/동치류 "wikilink") 집합 위에 정의된 더 큰 [구조이다](../Page/구조_\(논리학\).md "wikilink").

## 정의

형이 \(\sigma\)인 [구조들의](../Page/구조_\(논리학\).md "wikilink") 집합 \(\{M_i\}_{i\in I}\) 및 \(I\) 위의 [극대 필터](https://ko.wikipedia.org/wiki/극대_필터 "wikilink") \(\mathcal U\)가 주어졌다고 하자. \((\mathcal U,\subset)\)는 [부분 순서 집합이므로](https://ko.wikipedia.org/wiki/부분_순서_집합 "wikilink"), 이를 [범주로](https://ko.wikipedia.org/wiki/범주_\(수학\) "wikilink") 간주할 수 있다. 그렇다면 다음과 같은 [함자를](https://ko.wikipedia.org/wiki/함자_\(수학\) "wikilink") 정의하자.
