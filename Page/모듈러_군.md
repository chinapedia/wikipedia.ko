...
[수학](https://ko.wikipedia.org/wiki/수학 "wikilink")에서, **모듈러 군**() 또는 **보형군**(保型群)은 정수 계수의 [뫼비우스 변환의](../Page/뫼비우스_변환.md "wikilink") [군이다](https://ko.wikipedia.org/wiki/군_\(수학\) "wikilink"). 무한 [이산 군이며](https://ko.wikipedia.org/wiki/이산_군 "wikilink"), 두 개의 생성원 \(S\), \(T\)로 주어진다. 기호는 \(\operatorname{PSL}(2,\mathbb Z)\) 또는 \(\Gamma\).

## 정의

**모듈러 군** \(\Gamma\)는 다음과 같은 [표시를](../Page/군의_표시.md "wikilink") 갖는 군이다.

\[\Gamma=\langle \mathsf S,\mathsf T|\mathsf S^2=(\mathsf S\mathsf T)^3=1\rangle\] 즉, 이는 2차 [순환군](https://ko.wikipedia.org/wiki/순환군 "wikilink")과 3차 [순환군](https://ko.wikipedia.org/wiki/순환군 "wikilink")의 [자유곱](../Page/자유곱.md "wikilink")이다.

\[\Gamma=\operatorname{Cyc}(2) \star \operatorname{Cyc}(3)\]

## 성질

모듈러 군은 [가산 무한](https://ko.wikipedia.org/wiki/가산_무한 "wikilink") 개의 원소를 가지는 군이며, [아벨 군이](https://ko.wikipedia.org/wiki/아벨_군 "wikilink") 아니다. 그 [중심은](https://ko.wikipedia.org/wiki/군의_중심 "wikilink") [자명군](https://ko.wikipedia.org/wiki/자명군 "wikilink")이다.

### 상반평면 위의 작용

모듈러 군은 [상반평면](https://ko.wikipedia.org/wiki/상반평면 "wikilink") \(\mathbb H=\{\tau\in\mathbb C\colon\operatorname{Im}\tau>0\}\)에 [유리 함수로](https://ko.wikipedia.org/wiki/유리_함수 "wikilink") [작용한다](../Page/군의_작용.md "wikilink"). 이 경우 생성원 \(\mathsf S\), \(\mathsf T\)의 작용은 다음과 같다.
...
\[\{z\in\mathbb H\colon|\operatorname{Re}(z)|\le1/2,\;|z|\ge1\}\] [center](https://ko.wikipedia.org/wiki/파일:ModularGroup-FundamentalDomain-01.png "wikilink")

보다 일반적으로, 이 작용은 [리만 구의](https://ko.wikipedia.org/wiki/리만_구 "wikilink") 반구

\[\{\tau\in\mathbb C\colon \operatorname{Im}\tau \ge 0 \} \sqcup \{\infty\} = \mathbb H \sqcup \mathbb P^1_{\mathbb R}\] 위로 확장될 수 있다. 이 경우, 이는 실수 [사영 직선](https://ko.wikipedia.org/wiki/사영_직선 "wikilink") \(\mathbb P^1_{\mathbb R}=\mathbb R \sqcup\{\infty\}\) 위에 다음과 같이 따로 작용한다. 사실, 이 작용은 [대수적 수의](https://ko.wikipedia.org/wiki/대수적_수 "wikilink") 집합(+∞) 또는 [유리수체](https://ko.wikipedia.org/wiki/유리수체 "wikilink")(+∞)로 제한될 수 있다. 즉, 모듈러 군은 다음과 같은 부분 집합 위에 각각 작용한다.

  - \(\mathbb H\) (허수 성분이 양수인 복소수)
  - \(\mathbb R\setminus \bar{\mathbb Q}\) ([초월수](https://ko.wikipedia.org/wiki/초월수 "wikilink"))
  - \(\bar\mathbb Q \cap \mathbb R \setminus \mathbb Q\) ([대수적](https://ko.wikipedia.org/wiki/대수적_수 "wikilink") [무리수](https://ko.wikipedia.org/wiki/무리수 "wikilink"))
  - \(\mathbb Q \sqcup \{\infty\}\) (유리수 및 무한대)

### 유리수체 위의 작용

모듈러 군은 [유리수](https://ko.wikipedia.org/wiki/유리수 "wikilink") [사영 직선](https://ko.wikipedia.org/wiki/사영_직선 "wikilink") \(\mathbb P^1_{\mathbb Q} = \mathbb Q \sqcup \{\infty\}\) 위에 [작용한다](../Page/군의_작용.md "wikilink"). 구체적으로, 다음과 같은 집합을 생각하자.

\[X = \{(p,q)\in\mathbb Z^2\colon \gcd\{p,q\}=1,\; pq \ne 0\}\] 그렇다면, 그 위에 \(\operatorname{SL}(2;\mathbb Z)\)의 다음과 같은 작용을 정의할 수 있다.

\[\begin{pmatrix}a&b\\c&d\end{pmatrix} \cdot \frac pq = \frac{ap+bq}{cp+dq}\qquad\left(\begin{pmatrix}a&b\\c&d\end{pmatrix}\in\operatorname{SL}(2;\mathbb Z)\right)\] 이 경우, 위 행렬이 [특수 선형군에](https://ko.wikipedia.org/wiki/특수_선형군 "wikilink") 속하므로 그 [행렬식](https://ko.wikipedia.org/wiki/행렬식 "wikilink")이 1이다. 즉, \(ad-bc=1\)다. 따라서, \(\gcd\{p,q\}=1\)일 때
...
이제, 다음과 같은 [전사 함수를](https://ko.wikipedia.org/wiki/전사_함수 "wikilink") 생각하자.

\[X \to \mathbb P^1_{\mathbb Q} = \mathbb Q \sqcup\{\infty\}\]

\[(p,q) \mapsto \frac pq\qquad(q\ne0)\]

\[(\pm1,0) \mapsto \infty\] 즉, \((p,q)\)를 약분 불가능 분수 \(p/q\)로 간주하자. 물론 \(p/q=(-p)/(-q)\)이므로, 이는 \(\operatorname{SL}(2;\mathbb Z)\)의 [몫군](https://ko.wikipedia.org/wiki/몫군 "wikilink") \(\operatorname{PSL}(2;\mathbb Z)\)의, [유리수](https://ko.wikipedia.org/wiki/유리수 "wikilink") [사영 직선](https://ko.wikipedia.org/wiki/사영_직선 "wikilink") 위의 작용을 정의한다. 이 작용 역시 따라서 [추이적 작용이다](https://ko.wikipedia.org/wiki/추이적_작용 "wikilink").
...
\[\Gamma=\operatorname{PSL}(2;\mathbb Z)\to\operatorname{PSL}(2;\mathbb Z/N\mathbb Z)\] 이 [군 준동형의](https://ko.wikipedia.org/wiki/군_준동형 "wikilink") [핵을](https://ko.wikipedia.org/wiki/핵_\(수학\) "wikilink") **레벨 *N*의 주합동 부분군** \(\Gamma(N)\)이라고 한다. 즉, 다음과 같은 [짧은 완전열이](https://ko.wikipedia.org/wiki/짧은_완전열 "wikilink") 있다.
...
[분류:군론](https://ko.wikipedia.org/wiki/분류:군론 "wikilink") [분류:수론](https://ko.wikipedia.org/wiki/분류:수론 "wikilink") [분류:모듈러 형식](https://ko.wikipedia.org/wiki/분류:모듈러_형식 "wikilink")