...
[마이크로소프트](https://ko.wikipedia.org/wiki/마이크로소프트 "wikilink") **인터넷 정보 서비스**(Internet Information Services, IIS)는 [마이크로소프트 윈도우를](https://ko.wikipedia.org/wiki/마이크로소프트_윈도우 "wikilink") 사용하는 서버들을 위한 인터넷 기반 서비스들의 모임이다. 이전 이름은 **인터넷 정보 서버**(Internet Information Server)였다.

2017년 10월 기준으로 실질적으로 작동하는 웹 사이트(active site)들에서 쓰이는 [웹 서버 소프트웨어](https://ko.wikipedia.org/wiki/웹_서버_소프트웨어 "wikilink") 순위는 [아파치](https://ko.wikipedia.org/wiki/아파치 "wikilink")(44.89%), [엔진엑스](https://ko.wikipedia.org/wiki/엔진엑스 "wikilink")(20.65%), [구글 웹 서버](../Page/구글_웹_서버.md "wikilink")(7.86%), 마이크로소프트 [IIS](https://ko.wikipedia.org/wiki/IIS "wikilink")(7.32%)순이다.\[1\] 이 조사에서 생성은 되어있으나 정상적으로 작동하지 않는 웹 사이트들은 배제되었으며\[2\] 특히 MS의 [인터넷 정보 서비스](https://ko.wikipedia.org/wiki/인터넷_정보_서비스 "wikilink")([IIS](https://ko.wikipedia.org/wiki/IIS "wikilink"))를 설치한 웹 사이트들의 상당수가 비활성 사이트였다. 그런 사이트들도 포함하면 MS IIS가 1위이다.

서버는 현재 [FTP](https://ko.wikipedia.org/wiki/파일_전송_프로토콜 "wikilink"), [SMTP](https://ko.wikipedia.org/wiki/SMTP "wikilink"), [NNTP](https://ko.wikipedia.org/wiki/네트워크_뉴스_전송_프로토콜 "wikilink"), [HTTP](https://ko.wikipedia.org/wiki/HTTP "wikilink")/[HTTPS](https://ko.wikipedia.org/wiki/HTTPS "wikilink")를 포함하고 있다.

## IIS의 역사

IIS는 처음에 윈도우 NT 3.51용 인터넷 기반 서비스의 부가적인 기능으로 공개되었다. IIS 2.0은 윈도우 NT 4.0 운영 체제에 대한 지원을 추가하기에 이르렀으며, IIS 3.0은 [액티브 서버 페이지의](https://ko.wikipedia.org/wiki/액티브_서버_페이지 "wikilink") 동적인 스크립트 환경을 도입하였다.

IIS 4.0은 [고퍼 프로토콜에](https://ko.wikipedia.org/wiki/고퍼_프로토콜 "wikilink") 대한 지원을 끊고, 별도의 옵션 팩 CD-ROM으로 윈도우 NT에 번들로 추가하였다.

마지막에 나온 IIS 버전은 [윈도우 8.1을](../Page/윈도우_8.1.md "wikilink") 위한 8.5, [윈도우 8을](https://ko.wikipedia.org/wiki/윈도우_8 "wikilink") 위한 8.0, [윈도우 7을](https://ko.wikipedia.org/wiki/윈도우_7 "wikilink") 위한 7.5, [윈도우 비스타를](../Page/윈도우_비스타.md "wikilink") 위한 7.0, [윈도우 서버 2003을](../Page/윈도우_서버_2003.md "wikilink") 위한 6.0, [윈도우 XP 프로페셔널을](../Page/윈도우_XP.md "wikilink") 위한 IIS 5.1이다. 윈도우 XP는 10개의 동시 접속과 단일 웹사이트만 지원하는 제한된 버전의 IIS 5.1을 포함하고 있다. \[3\] IIS 6.0은 [IPv6](https://ko.wikipedia.org/wiki/IPv6 "wikilink")에 대한 지원을 추가하였다. [FastCGI](../Page/FastCGI.md "wikilink") 모듈도 IIS 5.1과\[4\] IIS7\[5\]에서 사용할 수 있다.
...
1.  [HTTP](https://ko.wikipedia.org/wiki/HTTP "wikilink") 모듈들
2.  [보안](../Page/컴퓨터_보안.md "wikilink") 모듈들
3.  콘텐트 모듈들
4.  [데이터 압축](https://ko.wikipedia.org/wiki/데이터_압축 "wikilink") 모듈들
5.  [캐싱](https://ko.wikipedia.org/wiki/캐시 "wikilink") 모듈들
6.  [로깅](https://ko.wikipedia.org/wiki/데이터_로깅 "wikilink") 및 [다이어그노스틱스](https://ko.wikipedia.org/wiki/다이어그노스틱_프로그램 "wikilink") 모듈들

## 버전

  - IIS 1.0, [윈도우 NT 3.51](https://ko.wikipedia.org/wiki/윈도우_NT_3.51 "wikilink") (추가 기능을 통해 무료로 사용할 수 있음)
  - IIS 2.0, [윈도우 NT 4.0](https://ko.wikipedia.org/wiki/윈도우_NT_4.0 "wikilink")
  - IIS 3.0, [윈도우 NT 4.0](https://ko.wikipedia.org/wiki/윈도우_NT_4.0 "wikilink") 서비스팩 3
  - IIS 4.0, [윈도우 NT 4.0](https://ko.wikipedia.org/wiki/윈도우_NT_4.0 "wikilink") 옵션 팩
  - IIS 5.0, [윈도우 2000](../Page/윈도우_2000.md "wikilink")
  - IIS 5.1, [윈도우 XP 프로페셔널](../Page/윈도우_XP.md "wikilink")\[7\]
  - IIS 6.0, [윈도우 서버 2003](../Page/윈도우_서버_2003.md "wikilink"), [윈도우 XP 프로페셔널 x64 에디션](https://ko.wikipedia.org/wiki/윈도우_XP_프로페셔널_x64_에디션 "wikilink")
  - IIS 7.0, [윈도우 비스타](../Page/윈도우_비스타.md "wikilink"), [윈도우 서버 2008](../Page/윈도우_서버_2008.md "wikilink")
  - IIS 7.5, [윈도우 7](https://ko.wikipedia.org/wiki/윈도우_7 "wikilink") , [윈도우 서버 2008 R2](https://ko.wikipedia.org/wiki/윈도우_서버_2008_R2 "wikilink")
  - IIS 8.0, [윈도우 8](https://ko.wikipedia.org/wiki/윈도우_8 "wikilink"), [윈도우 서버 2012](https://ko.wikipedia.org/wiki/윈도우_서버_2012 "wikilink")
...
[분류:웹 서버 소프트웨어](https://ko.wikipedia.org/wiki/분류:웹_서버_소프트웨어 "wikilink") [분류:메시지 전송 에이전트](https://ko.wikipedia.org/wiki/분류:메시지_전송_에이전트 "wikilink")
