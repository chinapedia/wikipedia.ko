...
[호몰로지 대수학에서](https://ko.wikipedia.org/wiki/호몰로지_대수학 "wikilink"), **순환 호몰로지**(循環homology, )와 **순환 코호몰로지**(循環cohomology, )는 비가환일 수 있는 [결합 대수에](../Page/결합_대수.md "wikilink") 대하여 정의되는 [호몰로지](https://ko.wikipedia.org/wiki/호몰로지 "wikilink") · [코호몰로지](https://ko.wikipedia.org/wiki/코호몰로지 "wikilink") 이론이다.\[1\]\[2\]\[3\]\[4\] [드람 코호몰로지의](https://ko.wikipedia.org/wiki/드람_코호몰로지 "wikilink") 일종의 비가환 일반화이며, [호흐실트 호몰로지](../Page/호흐실트_호몰로지.md "wikilink") · [호흐실트 코호몰로지와](https://ko.wikipedia.org/wiki/호흐실트_코호몰로지 "wikilink") 깊은 관계를 갖는다.
...
순환 (코)호몰로지는 다양한 방법으로 정의될 수 있다.
  ...
  - 보다 일반적으로, 임의의 [범주](https://ko.wikipedia.org/wiki/범주_\(수학\) "wikilink") 속에서, [단체 대상과](https://ko.wikipedia.org/wiki/단체_대상 "wikilink") 유사한 개념인 **[순환 대상](https://ko.wikipedia.org/wiki/순환_대상 "wikilink")**의 개념을 정의할 수 있다. 이 개념을 사용하여, 순환 호몰로지는 어떤 특별한 [Tor 함자로서](../Page/Tor_함자.md "wikilink") 정의될 수 있다. 마찬가지로, 순환 코호몰로지는 어떤 특별한 [Ext 함자로서](../Page/Ext_함자.md "wikilink") 정의될 수 있다.

### 순환 코호몰로지의 기초적 정의

[가환환](https://ko.wikipedia.org/wiki/가환환 "wikilink") \(K\) 위의 (항등원을 갖는) [결합 대수](../Page/결합_대수.md "wikilink") \(A\)가 주어졌다고 하자. \(A\)는 \((A,A)\)-[쌍가군](../Page/쌍가군.md "wikilink")을 이루며, 그 \(K\)-[쌍대 가군](../Page/쌍대_가군.md "wikilink") \(A^\vee=\hom_{\operatorname{Vect}_K}(A,K)\) 역시 \((A,A)\)-[쌍가군](../Page/쌍가군.md "wikilink")을 이룬다.
...
이제, 이 [공사슬 복합체](https://ko.wikipedia.org/wiki/공사슬_복합체 "wikilink") 위의, [정의역](https://ko.wikipedia.org/wiki/정의역 "wikilink")의 원소의 [순서쌍](https://ko.wikipedia.org/wiki/순서쌍 "wikilink") 성분들에 순환 [순열](https://ko.wikipedia.org/wiki/순열 "wikilink")을 가하는 [공사슬 복합체](https://ko.wikipedia.org/wiki/공사슬_복합체 "wikilink") [자기 동형 사상](https://ko.wikipedia.org/wiki/자기_동형_사상 "wikilink")

\[T\colon  C^\bullet(A;A^\vee) \to C^\bullet(A;A^\vee)\]

\[T\phi(a_0,\dotsc,a_n) = (-)^n \phi(a_n,a_0,\dotsc,a_{n-1})\] 을 생각하자.\[5\] 이 [자기 동형의](https://ko.wikipedia.org/wiki/자기_동형 "wikilink") [고정점](../Page/고정점.md "wikilink")으로 구성된 부분 [벡터 공간](https://ko.wikipedia.org/wiki/벡터_공간 "wikilink")
...
[가환환](https://ko.wikipedia.org/wiki/가환환 "wikilink") \(K\) 위의 (항등원을 갖는) [결합 대수](../Page/결합_대수.md "wikilink") \(A\)가 주어졌다고 하자. 그렇다면, [텐서곱](https://ko.wikipedia.org/wiki/텐서곱 "wikilink") \(A^{\otimes_Kn}\)을 정의할 수 있으며, 이는 \((A,A)\)-[쌍가군](../Page/쌍가군.md "wikilink")을 이룬다.
...
\[\partial^2 = 0\] 이므로\[9\] \((A^{\otimes_K\bullet}, \partial)\)은 \(K\)-[사슬 복합체](https://ko.wikipedia.org/wiki/사슬_복합체 "wikilink")

\[\dotsb\xrightarrow\partial A^{\otimes_K3}\xrightarrow\partial A^{\otimes_K2}\xrightarrow\partial A\] 를 이룬다. 이 사슬 복합체의 \(n\)차 대상은 \(A^{\otimes_K(n+1)}\)이다. 이를 **호흐실트 사슬 복합체**(Hochschild사슬複合體, )라고 하며,\[10\] 그 [호몰로지](https://ko.wikipedia.org/wiki/호몰로지 "wikilink")는 \(A\)의 \(A\)계수 [호흐실트 호몰로지](../Page/호흐실트_호몰로지.md "wikilink") \(\operatorname{HH}_\bullet(A;A)\)이다.
...
[가환환](https://ko.wikipedia.org/wiki/가환환 "wikilink") \(K\) 위의 [결합 대수](../Page/결합_대수.md "wikilink") \(A\)가 주어졌다고 하자. 그렇다면, [텐서곱](https://ko.wikipedia.org/wiki/텐서곱 "wikilink") \(A^{\otimes_Kn}\)을 정의할 수 있으며, 이는 \((A,A)\)-[쌍가군](../Page/쌍가군.md "wikilink")을 이룬다.
...
\[\partial' =  \sum_{i=0}^{n-1} (-)^i \partial^i\] 을 정의할 수 있다. 그렇다면, \((A^{\otimes_K (\bullet+2)}, \partial')\) 역시 [사슬 복합체](https://ko.wikipedia.org/wiki/사슬_복합체 "wikilink")

\[\dotsb\xleftarrow{\partial'}A^{\otimes_K4}\xleftarrow{\partial'}A^{\otimes_K3}\xleftarrow{\partial'}A^{\otimes_K2}\] 를 이룬다.

또한, \(A^{\otimes_Kn}\) 위에는 다음과 같은, [순환군](https://ko.wikipedia.org/wiki/순환군 "wikilink") \(\operatorname{Cyc}(n)=\langle t|t^n=1\rangle\)의 \(K\)-선형 [표현이](https://ko.wikipedia.org/wiki/군의_표현 "wikilink") 존재한다.
...
그렇다면, **순환 호몰로지**는 순환 이중 복합체의 전체 복합체의 [호몰로지](https://ko.wikipedia.org/wiki/호몰로지 "wikilink")이다.
...
\[\hom(\triangle_{\operatorname{Cyc}}^{\operatorname{op}},\operatorname{Mod}_K)\] 역시 [아벨 범주를](https://ko.wikipedia.org/wiki/아벨_범주 "wikilink") 이루므로 [Ext 함자를](../Page/Ext_함자.md "wikilink") 정의할 수 있으며, 또한 순환 가군의 [텐서곱](https://ko.wikipedia.org/wiki/텐서곱 "wikilink") 함자를 정의할 수 있으므로 그 [유도 함자로서](../Page/유도_함자.md "wikilink") [Tor 함자를](../Page/Tor_함자.md "wikilink") 정의할 수 있다.
...
\[\operatorname{HC}^n(M)=\operatorname{Ext}^n_{\hom(\triangle_{\operatorname{Cyc}}^{\operatorname{op}},\operatorname{Mod}_K)}(M,K)\] 이다.\[16\] (만약 [순환 범주](https://ko.wikipedia.org/wiki/순환_범주 "wikilink") \(\triangle_{\operatorname{Cyc}}\) 대신 [단체 범주](https://ko.wikipedia.org/wiki/단체_범주 "wikilink") \(\triangle\)를 사용하면, 대신 [호흐실트 호몰로지](../Page/호흐실트_호몰로지.md "wikilink")\[17\]와 [호흐실트 코호몰로지](https://ko.wikipedia.org/wiki/호흐실트_코호몰로지 "wikilink")\[18\]를 얻는다.
...
[가환환](https://ko.wikipedia.org/wiki/가환환 "wikilink") \(K\) 위의 [결합 대수](../Page/결합_대수.md "wikilink") \(A\)가 주어졌을 때, 호흐실트 사슬 복합체
...
콘 주기성을 사용하여, 순환 코호몰로지 군들의 [귀납적 극한](https://ko.wikipedia.org/wiki/귀납적_극한 "wikilink")

\[\operatorname{HP}^i(A)=\varinjlim\operatorname{HC}^{i+2\bullet}(A)\qquad(i\in\{0,1\})\] 을 정의할 수 있다. 이를 **주기 순환 코호몰로지**(週期循環cohomology, )라고 하며,\[25\] [복소수](https://ko.wikipedia.org/wiki/복소수 "wikilink") 계수 [위상 K군과](https://ko.wikipedia.org/wiki/위상_K군 "wikilink") 마찬가지로 두 개가 존재한다.

## 예

\(\operatorname{Spec}A\)가 [표수 0의](https://ko.wikipedia.org/wiki/체의_표수 "wikilink") [체](https://ko.wikipedia.org/wiki/체_\(수학\) "wikilink") \(K\) 위의 [매끄러운](https://ko.wikipedia.org/wiki/매끄러운_스킴 "wikilink") [아핀 스킴이라고](https://ko.wikipedia.org/wiki/아핀_스킴 "wikilink") 하자. 그렇다면, \(A\)의 순환 코호몰로지와 (그 [스펙트럼의](https://ko.wikipedia.org/wiki/환의_스펙트럼 "wikilink")) 대수적 드람 코호몰로지 사이의 관계는 다음과 같다.
...
\[\operatorname H_{\mathrm{dR}}^n(-) = \operatorname H^n(\Omega^\bullet(-))\] 는 [알렉산더 그로텐디크의](https://ko.wikipedia.org/wiki/알렉산더_그로텐디크 "wikilink") 대수적 드람 코호몰로지이다.

## 역사

[알랭 콘](https://ko.wikipedia.org/wiki/알랭_콘 "wikilink")\[26\]\[27\]과 보리스 치간(, , )\[28\]이 1980년대에 독자적으로 도입하였다. 콘의 이론은 원래 [코호몰로지](https://ko.wikipedia.org/wiki/코호몰로지 "wikilink")를 기반으로 하였지만, 치간의 이론은 원래 [호몰로지](https://ko.wikipedia.org/wiki/호몰로지 "wikilink")를 기반으로 하였다.

콘은 순환 코호몰로지의 이론을 1981년 독일에서 열린 학회에서 최초로 발표하였으며,\[29\] 1983년에 “순환 코호몰로지”()라는 용어를 최초로 사용하였다.\[30\] 콘의 원래 목적은 [알렉산더 그로텐디크가](https://ko.wikipedia.org/wiki/알렉산더_그로텐디크 "wikilink") 정의한 대수적 드람 코호몰로지를 비가환 [결합 대수에](../Page/결합_대수.md "wikilink") 대하여 일반화하기 위한 것이었으며, 콘의 원래 정의는 [호흐실트 호몰로지를](../Page/호흐실트_호몰로지.md "wikilink") 정의하는 [사슬 복합체의](https://ko.wikipedia.org/wiki/사슬_복합체 "wikilink") 변형을 통한 것이었다. 1983년에 [알랭 콘은](https://ko.wikipedia.org/wiki/알랭_콘 "wikilink") [순환 대상의](https://ko.wikipedia.org/wiki/순환_대상 "wikilink") 개념을 도입하였으며, 이를 사용하여 순환 (코)호몰로지를 추상적으로 정의하였다.\[31\]
