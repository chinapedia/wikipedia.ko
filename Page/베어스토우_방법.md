...
[수치 해석에서](https://ko.wikipedia.org/wiki/수치해석학 "wikilink"), **베어스토우(Bairstow)의 방법**은 임의의 차수의 실제 다항식의 근사해를 찾아내는 효율적인 알고리즘이다. 이 [근 찾기 알고리즘은](https://ko.wikipedia.org/wiki/근_찾기_알고리즘 "wikilink") 레오나드 베어스토우(Leonard Bairstow)의 1920년 'Applied Aerodynamics' 책 부록에 처음 등장했다. 알고리즘은 실수 계산만을 사용하여 [복소 공액](https://ko.wikipedia.org/wiki/켤레_복소수 "wikilink") 쌍의 근을 찾는다.
...
\[Q(x)= (x^2+ux+v)\left( \sum_{i=0}^{n-4}{f_i x^i} \right)+gx+h\] [변수](https://ko.wikipedia.org/wiki/변수 "wikilink")([계수](https://ko.wikipedia.org/wiki/계수 "wikilink")) \(c,d,g,h\) 그리고 \(u,v\)의 함수가 되는 \(b_i , f_i\)는 재귀적으로 다음과 같이 찾아진다.
...
\[c(u,v)= d(u,v)=0\]이므로 이것은 [편미분](https://ko.wikipedia.org/wiki/편미분 "wikilink")과 [행렬](https://ko.wikipedia.org/wiki/행렬 "wikilink")에서
...
## 함께보기
  ...
  - [이분법](https://ko.wikipedia.org/wiki/이분법_\(수학\) "wikilink")
  - [편미분](https://ko.wikipedia.org/wiki/편미분 "wikilink")
  - [2차 방정식](https://ko.wikipedia.org/wiki/이차방정식 "wikilink")

## 참고

  - [Applied Aerodynamics,Leonard Bairstow,1920](https://archive.org/details/appliedaerodynam00bairrich) [인터넷 아카이브](https://ko.wikipedia.org/wiki/인터넷_아카이브 "wikilink")
