> This article is converted from Wikipedia: [반복자](https://ko.wikipedia.org/wiki/반복자).


**반복자**(iterator)는 [객체 지향적 프로그래밍에서](https://ko.wikipedia.org/wiki/객체_지향적_프로그래밍 "wikilink") [배열](../Page/배열.md "wikilink")이나 그와 유사한 [자료 구조의](../Page/자료_구조.md "wikilink") 내부의 요소를 순회(traversing)하는 객체이다.
