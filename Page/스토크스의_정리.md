...
[미분기하학](https://ko.wikipedia.org/wiki/미분기하학 "wikilink")에서 **스토크스의 정리**()는 [매끄러운 다양체](https://ko.wikipedia.org/wiki/매끄러운_다양체 "wikilink") 위의 [미분 형식의](../Page/미분_형식.md "wikilink") 적분에 관한 정리다. 이에 따라, 미분 형식의 [외미분](https://ko.wikipedia.org/wiki/외미분 "wikilink")을 다양체에 적분한 값은, 그 미분 형식을 다양체의 [경계](https://ko.wikipedia.org/wiki/경계 "wikilink")에 대하여 적분한 값과 같다. [벡터 미적분학의](https://ko.wikipedia.org/wiki/벡터_미적분학 "wikilink") 몇몇 정리를 일반화한 것이다.

## 도입

[미적분학의 기본정리는](https://ko.wikipedia.org/wiki/미적분학의_기본정리 "wikilink") [구간](https://ko.wikipedia.org/wiki/구간 "wikilink") \([a, b]\)위의 함수 \(f\)의 적분은 \(f\)의 [부정적분](../Page/부정적분.md "wikilink")인 \(F\)를 찾는 것으로 계산할 수 있다는 정리이다.
...
[섬네일](https://ko.wikipedia.org/wiki/파일:Green's-theorem-simple-region.svg "wikilink") \(\Omega\)가 경계를 가진 *n*차원 [유향](https://ko.wikipedia.org/wiki/유향_다양체 "wikilink") [매끄러운 다양체라고](https://ko.wikipedia.org/wiki/매끄러운_다양체 "wikilink") 하고, \(\omega\)는 \(\Omega\) 위에 정의된 (n−1)차 [미분 형식이라고](../Page/미분_형식.md "wikilink") 하자. 또한, \(\omega\)가 [콤팩트 지지라고](https://ko.wikipedia.org/wiki/콤팩트_지지 "wikilink") 하자. \(\partial\Omega\)를 \(\Omega\)의 경계라고 하면, 다음 등식이 성립한다. 이 등식을 **스토크스의 정리**라고 한다.
...
[발산 정리도](https://ko.wikipedia.org/wiki/발산_정리 "wikilink") 유클리드 공간에서 부피 형식(volume form)에 대한 스토크스 정리의 특수한 형태가 된다.
