...
[섬네일의](https://ko.wikipedia.org/wiki/파일:Borromean_Seifert_surface.png "wikilink") 자이페르트 곡면\]\] [매듭 이론에서](https://ko.wikipedia.org/wiki/매듭_이론 "wikilink"), **자이페르트 곡면**(Seifert曲面, )은 3차원 [초구](https://ko.wikipedia.org/wiki/초구 "wikilink") 속의 [연결](https://ko.wikipedia.org/wiki/연결_공간 "wikilink") 2차원 [유향](https://ko.wikipedia.org/wiki/방향_\(다양체\) "wikilink") [경계다양체](../Page/경계다양체.md "wikilink")이다. 그 경계는 [연환](https://ko.wikipedia.org/wiki/연환 "wikilink")을 정의하며, 모든 연환은 이러한 꼴로 표현될 수 있다. 어떤 주어진 연환의 자이페르트 곡면이란 이 연환을 경계로 삼은 자이페르트 곡면을 뜻한다.

## 정의

차분한() [유향](https://ko.wikipedia.org/wiki/방향_\(다양체\) "wikilink") [연환](https://ko.wikipedia.org/wiki/연환 "wikilink") \(L \subsetneq \mathbb S^3\)의 **자이페르트 곡면**은 \(\partial\Sigma = L\)인 \(\mathbb S^3\) 속의 2차원 [유향](https://ko.wikipedia.org/wiki/방향_\(다양체\) "wikilink") [연결](https://ko.wikipedia.org/wiki/연결_공간 "wikilink") [경계다양체](../Page/경계다양체.md "wikilink") \(\Sigma \subsetneq \mathbb S^3\)이다.
...
\[g = (2 + d - f - m)/2\] 인 2차원 [경계다양체](../Page/경계다양체.md "wikilink")이다. 물론, 어떤 [연환](https://ko.wikipedia.org/wiki/연환 "wikilink") \(L\)의 자이페르트 곡면 \(\Sigma\)가 주어졌을 때, 임의의 [원환면](https://ko.wikipedia.org/wiki/원환면 "wikilink")과의 [연결합](../Page/연결합.md "wikilink") \(\Sigma \# \mathbb T^2\) 역시 \(L\)의 자이페르트 곡면이며, 그 종수는 원래 자이페르트 곡면의 종수 + 1이다. 주어진 연환의 자이페르트 곡면들의 최소 종수를 연환의 **종수**(種數, )라고 한다.
...
\oplus \dotsb \oplus \begin{pmatrix}0&-1\\1&0\end{pmatrix}\] 가 되게 하는 [기저](https://ko.wikipedia.org/wiki/기저_\(선형대수학\) "wikilink")
...
자이페르트 행렬의 다음과 같은 [행렬식](https://ko.wikipedia.org/wiki/행렬식 "wikilink")
...
[공집합](https://ko.wikipedia.org/wiki/공집합 "wikilink")은 0개의 연결 성분을 갖는 [연환](https://ko.wikipedia.org/wiki/연환 "wikilink")이다. 그 자이페르트 곡면은 경계를 갖지 않는 임의의 유향 곡면이며, 이 연환의 종수는 물론 0이다.
