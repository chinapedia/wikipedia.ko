...
애플 IIGS는 [CPU](https://ko.wikipedia.org/wiki/CPU "wikilink")를 [웨스턴 디자인 센터](https://ko.wikipedia.org/wiki/웨스턴_디자인_센터 "wikilink")(Western Design Center)의 65C816 16비트 [마이크로프로세서](../Page/마이크로프로세서.md "wikilink")를 사용하였으며 속도는 2.8 MHz 가량이었다. 다른 16비트 기종들이 6\~8 MHz 정도인 것에 비해 턱없이 낮은 속도였는데, 이것은 당시 애플에서 주력으로 밀던 매킨토시 때문에 IIGS의 성능을 제한하기 위한 것이라고 한다.\[1\] 그래서 대부분의 프로그램들 8비트 기반에 그래픽과 사운드만 향상한 버전들이 주류였다. 이 낮은 연산속도 문제는 애플 II와 매킨토시 사이의 어정쩡한 위치에 놓이게 되며 많은 소프트웨어 회사들이 IIGS 전용 소프트웨어 개발에 소극적인 경향을 보였다.

IIGS는 640x200 [해상도](../Page/해상도.md "wikilink")의 [2비트](https://ko.wikipedia.org/wiki/2비트 "wikilink") 색상과 함께 320x200 해상도의 [4비트](../Page/4비트.md "wikilink") 색상을 지원하며, 4096개 색상 팔레트에서 4개 또는 16개의 색을 정할 수 있다. 각 주사선의 팔레트를 변경하는 방법을 이용하여 256개의 색을 표현하기도 하며, 일부 프로그램은 한번에 3200개의 색상을 표시하기도 하였다.
...
[썸네일](https://ko.wikipedia.org/wiki/파일:Apple_IIGS_Woz.png "wikilink") 애플 IIGS는 애플 창립 10주년 기념으로 특별한 한정판을 출시하였는데, 초기 50,000대 생산분은 [스티브 워즈니악의](../Page/스티브_워즈니악.md "wikilink") 사인이 되어있다. 한정판을 소유한 자는 애플의 등록 카드를 보내면 스티브 워즈니악 외에 12명의 핵심 엔지니어의 서명이 된 정품 인증서와 스티브 워즈니악의 편지를 받을 수 있었다. 일반 제품과 한정판 제품의 성능 차이는 따로 없다.
...
### 오디오
  ...
  - Ensoniq 5503 디지털 발진기 칩
      ...
      - 8개의 독립적인 [스테레오](../Page/스테레오.md "wikilink") [스피커](../Page/스피커.md "wikilink") 채널에 대한 지원\[11\]
...
### 외부 커넥터
  ...
  - [NTSC](../Page/NTSC.md "wikilink") [콤포지트](https://ko.wikipedia.org/wiki/콤포지트 "wikilink") 비디오 출력 (RCA 커넥터)
  - [조이스틱](../Page/조이스틱.md "wikilink") (DE-9)
  - 오디오 출력 (-인치 모노 잭)\[12\]
  - [프린터](../Page/프린터.md "wikilink")-시리얼 1 (mini-DIN8)
  - [모뎀](../Page/모뎀.md "wikilink")-시리얼 2 (mini-DIN8)
