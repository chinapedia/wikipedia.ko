...
CiteSeerˣ는 [PostScript와](https://ko.wikipedia.org/wiki/포스트_스크립트 "wikilink") [PDF](https://ko.wikipedia.org/wiki/PDF "wikilink")로 제작된 논문을 자동 색인하기 위한 새로운 방법과 알고리즘을 개발해서 사용하고 있다. 현재 약 1,641,142건의 논문기사와 이들과 링크된 31,317,127건의 인용정보를 서비스 하고 있다(2010.6.9일자 기준)\[2\] CiteSeerˣ는 자동화된 인용색인 작성 및 이를 통해 인용문헌을 링크하는 디지털도서관이다. 주로 컴퓨터와 정보공학에 관한 자료를 중심으로 축적하고 있다. 리포지터리를 구축하기 위한 시스템으로는 자체개발 시스템을 사용하고 있다.\[3\]
...
CiteSeerˣ의 문서의 수집은 연구자의 직접제출과 cite-seerxbot이라 불리는 [크롤러가](https://ko.wikipedia.org/wiki/웹_크롤러 "wikilink") 담당한다. 연구자들은 CiteSeerˣ에 부합하는 주제 콘텐츠라면 무엇이든 제출 가능하다. 제출을 위해 지원하는 파일포맷은 [PDF](https://ko.wikipedia.org/wiki/PDF "wikilink"), PostScript, 압축파일(zip, gz, z)로 다양하지만 PDF파일을 권장하고 있다.\[13\]
