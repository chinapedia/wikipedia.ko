...
## 특징
  ...
  - 엘릭서 [컴파일러](../Page/컴파일러.md "wikilink")는 소스코드를 [얼랭](../Page/얼랭.md "wikilink") 가상 머신용 [바이트 코드로](https://ko.wikipedia.org/wiki/바이트_코드 "wikilink") [컴파일한다](../Page/컴파일러.md "wikilink"). (BEAM)\[6\]
  - 모든 것은 expression이다.side effect를 동반하는 statement와는 다르다.\[7\]
  - 얼랭 함수들은 [런타임](../Page/런타임.md "wikilink") 영향 없이 엘릭서에서 호출될 수 있다.
  ...
  - [Lazy와](../Page/느긋한_계산법.md "wikilink") [async collections을](https://ko.wikipedia.org/wiki/Futures_and_promises "wikilink") 지원한다.
  - 패턴매칭을 지원한다.\[12\]
  - [유니코드](../Page/유니코드.md "wikilink")를 지원하며 스트링들은 [UTF-8](../Page/UTF-8.md "wikilink")이다.
