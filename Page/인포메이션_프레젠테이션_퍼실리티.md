...
**인포메이션 프레젠테이션 퍼실리티**(, IPF)는 [IBM](https://ko.wikipedia.org/wiki/IBM "wikilink") [OS/2](https://ko.wikipedia.org/wiki/OS/2 "wikilink") 시스템에서 [온라인 도움말과](https://ko.wikipedia.org/wiki/온라인_도움말 "wikilink") [하이퍼텍스트](https://ko.wikipedia.org/wiki/하이퍼텍스트 "wikilink")를 표현하는 시스템이다. 또, IPF는 IPF의 내용을 만드는데 사용되는 [마크업 언어를](https://ko.wikipedia.org/wiki/마크업_언어 "wikilink") 참조한다. IPF 언어는 IBM이 개발한 [범용 생성 언어와](https://ko.wikipedia.org/wiki/IBM_범용_생성_언어 "wikilink") 북마스터에 기원을 두고 있다. IPF 언어는 여러 잠재성을 포함하여 잘 알려진 [HTML](https://ko.wikipedia.org/wiki/HTML "wikilink") 언어 버전 3.0과 매우 유사하다. 그러므로 IPF 문서를 만들 때 훈련된 사용자는 실질적으로 모든 워드 프로세서를 사용할 수 있다. IPF 언어는 45개 기본 명령으로 이루어져 있다.

IPF 파일들은 IPF 컴파일러(IPFC)를 사용함으로써 볼 수 있는 INF 또는 HLP 파일로 컴파일된다. IPF HLP 파일들은 [윈도우에](https://ko.wikipedia.org/wiki/마이크로소프트_윈도우 "wikilink") 알맞은 [WinHelp](https://ko.wikipedia.org/wiki/WinHelp "wikilink") HLP 파일과 구별된다.
...
IPF는 현재도 OS/2의 [eComStation](https://ko.wikipedia.org/wiki/eComStation "wikilink")의 일부로서 사용된다. IPF 파일을 읽고 쓸 수 있는 여러 도구들이 있지만 사용되는 일은 드문 편이다.
  ...
  - [프리 파스칼의](https://ko.wikipedia.org/wiki/프리_파스칼 "wikilink") 문서 생성기(fpdoc)는 OS/2의 IPF 출력물 또한 생성할 수 있다.
...
## 도움말 뷰어
  ...
  - [프리 파스칼의](https://ko.wikipedia.org/wiki/프리_파스칼 "wikilink") 텍스트 기반 IDE는 다양한 도움말 포맷을 지원한다. [OS/2](https://ko.wikipedia.org/wiki/OS/2 "wikilink")의 INF 포맷이 그 중 하나이다.
