...
[미분위상수학](../Page/미분위상수학.md "wikilink")에서, **스핀 다양체**(spin多樣體, )는 [스피너](https://ko.wikipedia.org/wiki/스피너 "wikilink")장을 정의할 수 있는 [다양체](https://ko.wikipedia.org/wiki/다양체 "wikilink")다.\[1\]\[2\] 즉, [직교 틀다발](https://ko.wikipedia.org/wiki/직교_틀다발 "wikilink") \(P_{\operatorname{SO}}M\to M\)을 이중 [피복 공간](https://ko.wikipedia.org/wiki/피복_공간 "wikilink") \(\operatorname{Spin}(n)\to\operatorname{SO}(n)\)에 대하여 적절히 [주다발](https://ko.wikipedia.org/wiki/주다발 "wikilink") \(P_\mathrm{Spin}M\to M\)으로 확장할 수 있는 [가향](https://ko.wikipedia.org/wiki/가향_다양체 "wikilink") ([준](../Page/준_리만_다양체.md "wikilink")) [리만 다양체다](https://ko.wikipedia.org/wiki/리만_다양체 "wikilink").

## 정의

임의의 두 자연수 \((p,q)\)에 대하여, [스핀 군에서](https://ko.wikipedia.org/wiki/스핀_군 "wikilink") [특수 직교군으로](https://ko.wikipedia.org/wiki/특수_직교군 "wikilink") 가는 표준적인 2겹 [전사](https://ko.wikipedia.org/wiki/전사_함수 "wikilink") [군 준동형](https://ko.wikipedia.org/wiki/군_준동형 "wikilink")

\[\rho\colon\operatorname{Spin}(p,q)\to\operatorname{SO}(p,q;\mathbb R)\] 이 존재한다.

[파라콤팩트 공간](../Page/파라콤팩트_공간.md "wikilink") \(M\) 위의 \(\operatorname{SO}(p,q)\)-[주다발](https://ko.wikipedia.org/wiki/주다발 "wikilink") \(\pi_{\operatorname{SO}}\colon P\twoheadrightarrow M\) 위의 **스핀 구조**(spin構造, )란 다음 데이터로 구성된다.

  - [Spin(*p,q*)](https://ko.wikipedia.org/wiki/스핀_군 "wikilink")-[주다발](https://ko.wikipedia.org/wiki/주다발 "wikilink") \(\pi_{\operatorname{Spin}}\colon P_{\mathrm{Spin}}(M)\to M\)
  - 이중 [피복 공간](https://ko.wikipedia.org/wiki/피복_공간 "wikilink") \(p\colon P_{\operatorname{Spin}}(M)\twoheadrightarrow P_{\operatorname{SO}}(M)\)

이 데이터는 다음 두 조건을 만족시켜야 한다.

  - \(\pi_{\operatorname{SO}}\circ p=\pi_{\operatorname{Spin}}\)
  - 임의의 \(x\in P_{\operatorname{Spin}}\), \(h\in\operatorname{Spin}(n)\)에 대하여 \(p(x\cdot h)=p(x)\cdot\rho(h)\)이다. (여기서 \(\cdot\)은 [주다발](https://ko.wikipedia.org/wiki/주다발 "wikilink") 위의 [군의 작용이다](../Page/군의_작용.md "wikilink").) 즉, [군의 작용은](../Page/군의_작용.md "wikilink") \(p\)와 가환한다.
...
[매끄러운 다양체](https://ko.wikipedia.org/wiki/매끄러운_다양체 "wikilink") \(M\) 위의 **스핀 구조**는 그 [접다발](../Page/접다발.md "wikilink") \(\mathrm TM\)(의 [틀다발](../Page/틀다발.md "wikilink")) 위의 스핀 구조이다. **스핀 다양체**는 스핀 구조를 지닌 [가향](https://ko.wikipedia.org/wiki/가향_다양체 "wikilink") [준 리만 다양체다](../Page/준_리만_다양체.md "wikilink").
...
만약 [매끄러운 다양체](https://ko.wikipedia.org/wiki/매끄러운_다양체 "wikilink") \(M\) 위에 스핀 구조가 존재한다면, 그 스핀 구조들의 집합은 [코호몰로지류](https://ko.wikipedia.org/wiki/코호몰로지류 "wikilink") \(\operatorname H^1(M,\mathbb Z/2)\)의 집합과 [일대일 대응한다](https://ko.wikipedia.org/wiki/일대일_대응 "wikilink").\[4\] 이 대응성은 표준적(canonical)이지 않으며, 구체적으로 스핀 구조들의 집합은 \(\operatorname H^1(M,\mathbb Z/2)\)에 대한 [아핀 공간이다](../Page/아핀_공간.md "wikilink").

직관적으로 해석하면, 축약 불가능 폐곡선들을 따라 [스피너](https://ko.wikipedia.org/wiki/스피너 "wikilink")를 [평행 운송하였을](../Page/평행_운송.md "wikilink") 때 그 부호가 ±인지 여부가 스핀 구조를 결정짓는다. 이는 [양자장론](https://ko.wikipedia.org/wiki/양자장론 "wikilink")에서 [페르미온](https://ko.wikipedia.org/wiki/페르미온 "wikilink")의 라몽 경계 조건(, +) 및 느뵈-슈워츠 경계 조건(, −)의 선택에 대응한다.

## 예

다음과 같은 다양체들은 적어도 하나의 스핀 구조를 갖는다.

  - 종수 *g*의 콤팩트 [리만 곡면은](https://ko.wikipedia.org/wiki/리만_곡면 "wikilink") 2<sup>2*g*</sup>개의 스핀 구조를 갖는다. 이들은 대수기하학에서 **[세타 지표](../Page/세타_지표.md "wikilink")**()라고 불린다.
  - 모든 3차원 이하 [콤팩트](../Page/콤팩트_공간.md "wikilink") [유향 다양체는](https://ko.wikipedia.org/wiki/유향_다양체 "wikilink") 스핀 구조를 갖는다.
  - [초구](https://ko.wikipedia.org/wiki/초구 "wikilink") *S<sup>n</sup>*는 모두 스핀 구조를 갖는다. \(n \ne 1\)일 때 이는 유일하며, 원 \(\mathbb S^1\)은 두 개의 스핀 구조를 갖는다.
  - 홀수 차원 [복소수 사영 공간](https://ko.wikipedia.org/wiki/복소수_사영_공간 "wikilink") \(\mathbb{CP}^{2k+1}\)은 스핀 구조를 갖는다.
  - 모든 [칼라비-야우 다양체는](https://ko.wikipedia.org/wiki/칼라비-야우_다양체 "wikilink") 스핀 구조를 갖는다.
...
## 같이 보기
  ...
  - [스핀 접속](https://ko.wikipedia.org/wiki/스핀_접속 "wikilink")
