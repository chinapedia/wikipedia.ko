...
표준 순서의 계산은 [페르미온](https://ko.wikipedia.org/wiki/페르미온 "wikilink")인 경우와 [보손](https://ko.wikipedia.org/wiki/보손 "wikilink")인 경우가 다르다. 보손의 경우는 더 간단한데, 다음과 같다. [생성 연산자를](https://ko.wikipedia.org/wiki/생성_연산자 "wikilink") \(a^\dagger\), [소멸 연산자를](https://ko.wikipedia.org/wiki/소멸_연산자 "wikilink") \(a\)로 쓰자. 그렇다면 둘의 곱을 표준 순서화하면 다음과 같다.
...
둘 이상의 연산자를 곱할 경우, 연산자를 교환한 수 만큼 (즉, [순열](https://ko.wikipedia.org/wiki/순열 "wikilink")의 [전반성](https://ko.wikipedia.org/wiki/전반성 "wikilink")에 따라) −1을 곱한다.
