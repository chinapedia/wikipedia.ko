...
**애플소프트 베이직**()은 [정수 베이직에](https://ko.wikipedia.org/wiki/정수_베이직 "wikilink") 이어 두 번째로 [애플 2](https://ko.wikipedia.org/wiki/애플_2 "wikilink") 컴퓨터에 내장된 [베이직](../Page/베이직.md "wikilink") [프로그래밍 언어로](../Page/프로그래밍_언어.md "wikilink") [마이크로소프트](../Page/마이크로소프트.md "wikilink")가 공급했다.

## 역사와 기능

애플은 48KB 램의 애플 2 컴퓨터에 적재할 새로운 베이직을 찾고 있었고 [알테어 베이직으로](https://ko.wikipedia.org/wiki/알테어_베이직 "wikilink") 성공한 마이크로소프트를 선택했다. 애플은 10KB [어셈블리어](../Page/어셈블리어.md "wikilink") 베이직을 "애플소프트"란 이름으로 계약하였다. [어셈블리어](../Page/어셈블리어.md "wikilink") 코드를 공유하였기 때문에 [코모도어 베이직과](https://ko.wikipedia.org/wiki/코모도어_베이직 "wikilink") 같은 다른 [6502](../Page/MOS_6502.md "wikilink") 기반 컴퓨터의 베이직 구현과 매우 흡사했다. 행 번호가 있었고 각 행은 [공백 기호가](https://ko.wikipedia.org/wiki/공백_기호 "wikilink") 필요하지 않았으며 반복문은 매우 느렸다. 그럼에도 애플소프트 베이직은 이전의 열악한 정수 베이직보다 더 많은 기능을 제공하였다.

  - 원자적인 문자열. 문자열은 더 이상 C언어와 같이 문자형의 배열이 아니었다. 대신에 [자바나](../Page/자바_\(프로그래밍_언어\).md "wikilink") [스킴과](https://ko.wikipedia.org/wiki/스킴_\(프로그래밍_언어\) "wikilink") 같이 [메모리 수거](https://ko.wikipedia.org/wiki/메모리_수거 "wikilink") 객체를 사용했다. 이것은 문자열 배열의 사용이 가능하게 했다. DIM A$(10)은 문자열 배열의 10개짜리 [동적 배열](https://ko.wikipedia.org/wiki/동적_배열 "wikilink") 자료 구조, 즉 벡터가 되었다.
  - 다차원 배열
...
그러나 몇 가지 이유로 애플소프트 베이직으로 만들어진 [액션 게임은](https://ko.wikipedia.org/wiki/액션_게임 "wikilink") 거의 없었다.
  ...
  - 프로그램의 각 행은 [연결 리스트에](../Page/연결_리스트.md "wikilink") 저장되어서 [Goto의](https://ko.wikipedia.org/wiki/Goto_\(명령어\) "wikilink") 계산에 [O(n) (선형) 시간이](https://ko.wikipedia.org/wiki/계산_복잡도_이론 "wikilink") 걸렸다.
  - 음향에 관한 기능을 제공하지 않았다.
...
## 같이 읽기
  ...
  - [정수 베이직](https://ko.wikipedia.org/wiki/정수_베이직 "wikilink"): 이전의 인티저 베이직
