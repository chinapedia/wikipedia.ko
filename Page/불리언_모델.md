...
수학적 형식의 관점에서 볼 때 불리언 모델은 간단하다. 그러나 실용적인 관점에서 보면, 자료 구조 및 알고리즘과 관련한 몇 가지 문제들이 존재한다. 이러한 문제들에는 단어 선택 방법(수동/자동 선택 또는 모두), [어간 추출](../Page/어간_추출.md "wikilink"), [해시 테이블](https://ko.wikipedia.org/wiki/해시_테이블 "wikilink"), [역색인](https://ko.wikipedia.org/wiki/역색인 "wikilink") 등이 있다.\[2\]
