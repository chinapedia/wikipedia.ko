...
UC 브라우저는 안드로이드, 블랙베리, iOS, 심비안, 윈도우, 윈도우 폰을 포함한 수많은 운영 체제와 호환된다.\[7\]
...
UC 브라우저 7.0(크롬55)이 현재 윈도우용으로 사용 가능하다.\[11\]

### 윈도우 폰

2012년 초에 UC 브라우저는 윈도우 폰용으로 출시되었으며 현재 해당 운영 체제에서 가장 많이 다운로드되는 서드파티 웹 브라우저이다.\[12\]\[13\] 다운로드, 시크릿 모드(Incognito Browsing), 와이파이 공유 기능이 포함되어 있다.\[14\]

## 각주

[분류:자바 플랫폼 소프트웨어](https://ko.wikipedia.org/wiki/분류:자바_플랫폼_소프트웨어 "wikilink") [분류:모바일 웹 브라우저](https://ko.wikipedia.org/wiki/분류:모바일_웹_브라우저 "wikilink") [분류:안드로이드용 웹 브라우저](https://ko.wikipedia.org/wiki/분류:안드로이드용_웹_브라우저 "wikilink") [분류:iOS용 웹 브라우저](https://ko.wikipedia.org/wiki/분류:iOS용_웹_브라우저 "wikilink") [분류:웹 브라우저](https://ko.wikipedia.org/wiki/분류:웹_브라우저 "wikilink") [분류:윈도우 폰 소프트웨어](https://ko.wikipedia.org/wiki/분류:윈도우_폰_소프트웨어 "wikilink") [분류:심비안 OS 소프트웨어](https://ko.wikipedia.org/wiki/분류:심비안_OS_소프트웨어 "wikilink") [분류:2004년 소프트웨어](https://ko.wikipedia.org/wiki/분류:2004년_소프트웨어 "wikilink")
