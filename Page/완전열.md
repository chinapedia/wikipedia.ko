...
[호몰로지 대수학에서](https://ko.wikipedia.org/wiki/호몰로지_대수학 "wikilink"), **완전열**(完全列, )은 한 사상의 [상이](../Page/상_\(수학\).md "wikilink") 다음 사상의 [핵과](https://ko.wikipedia.org/wiki/핵_\(수학\) "wikilink") 일치하는, [사상들과](../Page/사상_\(수학\).md "wikilink") 대상들로 구성된 열이다.

## 정의

[핵과](https://ko.wikipedia.org/wiki/핵_\(수학\) "wikilink") [여핵](../Page/여핵.md "wikilink")을 가지는 [범주에서](../Page/범주_\(수학\).md "wikilink"), **완전열**은 다음과 같은 꼴의 대상들과 사상들로 구성된다.
...
모든 [아벨 범주](../Page/아벨_범주.md "wikilink") ([아벨 군의](https://ko.wikipedia.org/wiki/아벨_군 "wikilink") 범주 등)에서는 핵과 여핵이 존재하므로, 완전열을 정의할 수 있다. [군의](https://ko.wikipedia.org/wiki/군_\(수학\) "wikilink") 범주 \(\operatorname{Grp}\)는 아벨 범주가 아니지만 핵과 여핵이 존재하므로, 이 범주에서도 역시 완전열을 정의할 수 있다.
...
[아벨 군의](https://ko.wikipedia.org/wiki/아벨_군 "wikilink") 범주에서, 다음과 같은 짧은 완전열을 생각하자.
...
\[0\to\mathbb Z\xrightarrow{2\cdot}\mathbb Z\xrightarrow{\mod2}\mathbb Z/2\mathbb Z\to 0\] 여기에서 0은 [자명군](https://ko.wikipedia.org/wiki/자명군 "wikilink")이고, \(\mathbb Z\)에서 \(\mathbb Z\)로 가는 사상은 2배를 곱하는 것이고, \(\mathbb Z\)에서 \(\mathbb Z/2\mathbb Z\simeq \{0,1\}\)은 정수를 modulo 2로 정의한 것이다. 인접한 사상을 각각 살펴보면 이것이 완전열임을 알 수 있다.
  ...
  - 사상 \(0\to \mathbb Z\) 의 상은 [자명군](https://ko.wikipedia.org/wiki/자명군 "wikilink")이고, \(\cdot2\colon\mathbb Z\to\mathbb Z\)에 대한 [핵](https://ko.wikipedia.org/wiki/핵_\(수학\) "wikilink")(두 배를 해서 0이 되는 수들의 부분집합) 또한 자명군이다. 따라서 첫 번째 \(\mathbb Z\)에서 열은 완전열이다.
  - \(\cdot2\colon\mathbb Z\to\mathbb Z\)의 상은 짝수의 부분군 \(2\mathbb Z\)이며, \(\bmod2\colon\mathbb Z\to\mathbb Z\)의 [핵](https://ko.wikipedia.org/wiki/핵_\(수학\) "wikilink") 또한 짝수의 부분군 \(2\mathbb Z\)이다. 따라서, 두 번째 \(\mathbb Z\)에 대해서도 완전열이다.
