...
[가환대수학](https://ko.wikipedia.org/wiki/가환대수학 "wikilink")에서, **실베스터 행렬**(Sylvester行列, )은 두 다항식의 공약 다항식에 대한 정보를 담고 있는 [정사각 행렬이다](https://ko.wikipedia.org/wiki/정사각_행렬 "wikilink").

## 정의

[가환환](https://ko.wikipedia.org/wiki/가환환 "wikilink") \(R\) 계수를 갖는 두 [다항식](https://ko.wikipedia.org/wiki/다항식 "wikilink") \(p,q\in R[x]\)의 **실베스터 행렬**은 \((\deg p+\deg q)\times(\deg p+\deg q)\) [정사각 행렬이다](https://ko.wikipedia.org/wiki/정사각_행렬 "wikilink"). 구체적으로, 만약
...
[가환환](https://ko.wikipedia.org/wiki/가환환 "wikilink") 계수를 갖는 두 다항식의 실베스터 행렬의 [행렬식](https://ko.wikipedia.org/wiki/행렬식 "wikilink")은 두 다항식의 [종결식](../Page/종결식.md "wikilink")과 같다. 두 다항식 \(p,q\in R[x]\)에 대하여,

\[\deg(\gcd(p,q)) = \deg p+\deg q-\operatorname{rank}S(p,q)\] 이다. 여기서 \(\operatorname{rank}\)는 [행렬의 계수이다](https://ko.wikipedia.org/wiki/계수_\(선형대수학\) "wikilink").

## 실베스터 행렬의 판별식 표현

\[a_n x^n + a_{n-1} x^{n-1}+......+a_1 x^1+a_0 x^0=0\]으로 계수를 가정했을때, [실베스터 행렬](https://ko.wikipedia.org/wiki/실베스터_행렬 "wikilink") \(M=(2n-1)\cdot(2n-1)\)
...
## [실베스터 행렬의](https://ko.wikipedia.org/wiki/실베스터_행렬 "wikilink") 소행렬식에 의한 [2차 방정식의](https://ko.wikipedia.org/wiki/2차_방정식 "wikilink") [판별식](https://ko.wikipedia.org/wiki/판별식 "wikilink") 유도
...
## 함께보기
  ...
  - [소행렬식](https://ko.wikipedia.org/wiki/소행렬식 "wikilink")
