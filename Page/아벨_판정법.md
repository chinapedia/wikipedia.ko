...
**아벨 판정법**()은 [닐스 헨리크 아벨의](https://ko.wikipedia.org/wiki/닐스_헨리크_아벨 "wikilink") 이름이 붙은 [무한급수](https://ko.wikipedia.org/wiki/무한급수 "wikilink")의 [수렴판정법](https://ko.wikipedia.org/wiki/수렴판정법 "wikilink")으로, 대략 수렴급수에게 단조 유계 '가중치'를 줘도 수렴한다고 서술한다.
...
\(\textstyle S_n = \sum_{k=1}^n b_k\)이라고 하자. \(\textstyle \left\{\sum_{n=1}^{\infty} a_nb_n \right\}\)이 [코시 수열임을](../Page/코시_수렴판정법.md "wikilink") 보이는 것으로 충분하다. [아벨 변환](../Page/아벨_변환.md "wikilink")
...
## 같이 보기
  ...
  - [디리클레 판정법](https://ko.wikipedia.org/wiki/디리클레_판정법 "wikilink")
