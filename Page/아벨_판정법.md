...
\(\textstyle S_n = \sum_{k=1}^n b_k\)이라고 하자. \(\textstyle \left\{\sum_{n=1}^{\infty} a_nb_n \right\}\)이 [코시 수열임을](https://ko.wikipedia.org/wiki/코시_수열 "wikilink") 보이는 것으로 충분하다. [아벨 변환](../Page/아벨_변환.md "wikilink")
