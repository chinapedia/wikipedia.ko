...
[그래프 이론에서](../Page/그래프_이론.md "wikilink") **완전 이분 그래프**(完全二分graph, )란 꼭짓점의 집합이 서로 겹치지 않는 두 집합 X와 Y의 [합집합](../Page/합집합.md "wikilink")이고 X의 모든 꼭짓점이 Y의 각각의 꼭짓점과 하나의 변으로 연결되어 있는 [이분 그래프이다](../Page/이분_그래프.md "wikilink").
