...
[섬네일](https://ko.wikipedia.org/wiki/파일:Harmonic_partials_on_strings.svg "wikilink"), [배음렬](https://ko.wikipedia.org/wiki/배음렬 "wikilink")중 기본적인 6가지의 [배음](https://ko.wikipedia.org/wiki/배음 "wikilink")\]\] **끈의 진동**은 [파동](https://ko.wikipedia.org/wiki/파동 "wikilink")의 한 형태 이다. 일정하게 진동하는 끈은 [소리](https://ko.wikipedia.org/wiki/소리 "wikilink")를 만든다. 특정 [음](https://ko.wikipedia.org/wiki/음 "wikilink")의 진동으로 부터 소리는 일정한 음을 만든다. 진동하는 끈은 [기타](https://ko.wikipedia.org/wiki/기타 "wikilink"), [피아노](https://ko.wikipedia.org/wiki/피아노 "wikilink"), [가야금](../Page/가야금.md "wikilink")등과 같은 [현악기](../Page/현악기.md "wikilink")가 소리를 내는 근본적인 원리이다.
...
[오른쪽](https://ko.wikipedia.org/wiki/파일:StringParameters.png "wikilink") 끈의 한지점 x으로부터 작은 \(\Delta x\)의 간격을 잡고, \(m\)을 [질량](https://ko.wikipedia.org/wiki/질량 "wikilink"), \(\mu\)를 [선형밀도](https://ko.wikipedia.org/wiki/선형밀도 "wikilink")라고 하자. 끈의 수평축 [장력](https://ko.wikipedia.org/wiki/장력 "wikilink")이 \(T\)(상수)로서 일정하다고 가정하면, 각 양끝 \(x\)와 \(x\)+\(\Delta x\) 가해지는 장력은 아래와 같이 \(T\)로서 근사할 수 있다.
...
여기서 처음에 \(\Delta x\)가 매우 작다고 가정하였음으로 0에 대하여 극한을 취하면 [미분](https://ko.wikipedia.org/wiki/미분 "wikilink")의 정의에 의해 \(y\)의 미분값의 미분 즉 \(y\) 에 대한 [이계미분](https://ko.wikipedia.org/wiki/이계미분 "wikilink")이 된다.
