...
[기하학](https://ko.wikipedia.org/wiki/기하학 "wikilink")에서, **사인 법칙**(-法則, ) 혹은 **라미의 정리**는 [삼각형](https://ko.wikipedia.org/wiki/삼각형 "wikilink")의 변의 길이와 각의 [사인](https://ko.wikipedia.org/wiki/삼각_함수 "wikilink") 사이의 관계를 나타내는 정리이다. 이에 따라 삼각형의 두 각의 크기와 한 변의 길이를 알 때 남은 두 변의 길이를 구할 수 있다.

## 정의

[삼각형](https://ko.wikipedia.org/wiki/삼각형 "wikilink") \(ABC\)의 각 \(A,B,C\)을 마주보는 변을 \(a,b,c\)라고 하자. **사인 법칙**에 따르면 다음이 성립한다.\[1\]

\[\frac{a}{\sin A}=\frac{b}{\sin B}=\frac{c}{\sin C}=2R\] 여기서 \(R\)은 삼각형 \(ABC\)의 [외접원](https://ko.wikipedia.org/wiki/외접원 "wikilink")의 [반지름](https://ko.wikipedia.org/wiki/반지름 "wikilink")이다.
...
삼각형 \(ABC\)의 [외접원](https://ko.wikipedia.org/wiki/외접원 "wikilink")을 그리자.\[3\] \(A\)를 지나는 지름을 \(AD\)라고 하자. 따라서 \(ABD\)는 직각 삼각형이며, 빗변은 \(AD=2R\)이다. 삼각법에 따라 다음이 성립한다.
