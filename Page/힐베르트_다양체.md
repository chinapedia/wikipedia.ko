...
기하학에서, **힐베르트 다양체**(Hilbert多樣體, )는 국소적으로 [힐베르트 공간과](https://ko.wikipedia.org/wiki/힐베르트_공간 "wikilink") 동형인 [위상 공간이다](https://ko.wikipedia.org/wiki/위상_공간_\(수학\) "wikilink").\[1\]

## 정의

**힐베르트 다양체**는 다음과 같은 데이터로 주어진다.

  - [분해 가능](https://ko.wikipedia.org/wiki/분해_가능_공간 "wikilink") [하우스도르프 공간](https://ko.wikipedia.org/wiki/하우스도르프_공간 "wikilink") \(X\)
  - [분해 가능](https://ko.wikipedia.org/wiki/분해_가능_공간 "wikilink") 무한 차원 [실수 힐베르트 공간](https://ko.wikipedia.org/wiki/실수_힐베르트_공간 "wikilink") \(\mathcal H\)
  - [열린 덮개](https://ko.wikipedia.org/wiki/열린_덮개 "wikilink") \((U_i)_{i\in I}\subseteq\operatorname{Open}(X)\)
  - 각 \(i\in I\)에 대하여, 단사 [연속 함수](https://ko.wikipedia.org/wiki/연속_함수 "wikilink") \(\phi_i\colon U_i\to\mathcal H\). 또한, 이는 \(U_i\)와 \(\phi_i(U_i)\) 사이의 [위상 동형을](https://ko.wikipedia.org/wiki/위상_동형 "wikilink") 정의한다.
...
두 힐베르트 다양체 \(X\), \(Y\)에 대하여, 다음 세 조건이 서로 동치이다.
  ...
  - 서로 [호모토피 동치이다](https://ko.wikipedia.org/wiki/호모토피_동치 "wikilink").
...
임의의 힐베르트 다양체 \(X\)는 \(\mathcal H\)의 [열린집합](https://ko.wikipedia.org/wiki/열린집합 "wikilink")과 [미분 동형이다](https://ko.wikipedia.org/wiki/미분_동형 "wikilink").

## 예

분해 가능 무한 차원 힐베르트 공간의 임의의 [열린집합](https://ko.wikipedia.org/wiki/열린집합 "wikilink") \(U\)는 힐베르트 다양체이다.

### 사상 공간

다음이 주어졌다고 하자.

  - (유한 차원) 콤팩트 [리만 다양체](https://ko.wikipedia.org/wiki/리만_다양체 "wikilink") \(M\)
  - (유한 차원) [매끄러운 다양체](https://ko.wikipedia.org/wiki/매끄러운_다양체 "wikilink") \(N\)
...
특히, 이 경우 만약 매끄러운 함수 \(f\in\mathcal C^\infty(M,N)\)에 대하여 \(f\)의 [접공간](https://ko.wikipedia.org/wiki/접공간 "wikilink")은 표준적으로 [힐베르트 공간인](https://ko.wikipedia.org/wiki/힐베르트_공간 "wikilink") [소볼레프 공간](../Page/소볼레프_공간.md "wikilink")
