...
[대수기하학](../Page/대수기하학.md "wikilink")에서, **스킴**(, )은 국소적으로 [가환환](https://ko.wikipedia.org/wiki/가환환 "wikilink")의 [스펙트럼과](../Page/환의_스펙트럼.md "wikilink") [동형](https://ko.wikipedia.org/wiki/동형 "wikilink")인 공간이다. [대수다양체](../Page/대수다양체.md "wikilink")와 [대수적 정수환들의](https://ko.wikipedia.org/wiki/대수적_정수환 "wikilink") 공통적인 일반화이다.
...
아핀 스킴의 범주 \(\operatorname{Aff}=\operatorname{CRing}^{\operatorname{op}}\) 위에, [자리스키 위상에](../Page/자리스키_위상.md "wikilink") 대한 [그로텐디크 위상을](https://ko.wikipedia.org/wiki/그로텐디크_위상 "wikilink") 주면 \(\operatorname{Aff}\)는 [위치를](https://ko.wikipedia.org/wiki/위치_\(수학\) "wikilink") 이룬다. 이 위치 위의 ([집합](../Page/집합.md "wikilink") 값을 갖는) [층의](https://ko.wikipedia.org/wiki/층_\(수학\) "wikilink") [범주](../Page/범주_\(수학\).md "wikilink") \(\operatorname{Sh}(\operatorname{Aff})\)를 생각하자. 이는 [토포스](../Page/토포스.md "wikilink")를 이룬다. 이 [그로텐디크 위상은](https://ko.wikipedia.org/wiki/그로텐디크_위상 "wikilink") [준표준 위상이다](https://ko.wikipedia.org/wiki/준표준_위상 "wikilink"). 즉, 임의의 가환환 \(R\)에 대하여, 준층
...
\[I\colon\operatorname{Aff}\to\operatorname{Sh}(\operatorname{Aff})\] 를 정의할 수 있으며, [가환환](https://ko.wikipedia.org/wiki/가환환 "wikilink")을 층으로 여길 수 있다.

[가환환](https://ko.wikipedia.org/wiki/가환환 "wikilink") \(R\)와 그 속의 [아이디얼](../Page/아이디얼.md "wikilink") \(\mathfrak a\subseteq R\)이 주어졌을 때, 층 \(I(R)\)의 다음과 같은 부분층을 정의할 수 있다.\[5\]
...
준층 \(F\colon\operatorname{Aff}^{\operatorname{op}}\to\operatorname{Set}\)의 **열린 부분층**은 다음 조건을 만족시키는 부분층 \(U\subseteq F\)이다.\[6\]
  ...
  - 임의의 [가환환](https://ko.wikipedia.org/wiki/가환환 "wikilink") \(R\) 및 층 사상 \(f\in\hom_{\operatorname{Sh}(\operatorname{Aff})}(I(R),F)\)에 대하여, \(I(R)\)의 부분층 \(f^{-1}(F)\subseteq I(R)\)는 \(f^{-1}(F)=I_{\mathfrak a}(R)\)가 되는 아이디얼 \(\mathfrak a\subseteq R\)가 존재한다.
...
스킴 \(S\)가 주어졌을 때, **\(S\) 위의 스킴의 범주** \(\operatorname{Sch}/S\)는 \(S\)에 대한 [조각 범주이며](https://ko.wikipedia.org/wiki/조각_범주 "wikilink"), **\(S\) 위의 스킴**( 또는 )은 그 대상이다. 즉, *S* 위의 스킴 \((X,f)\)은 스킴 \(X\)와 스킴 사상 \(f\colon X\to S\)의 순서쌍이다.\[8\] \(K\)가 [체나](../Page/체_\(수학\).md "wikilink") [가환환](https://ko.wikipedia.org/wiki/가환환 "wikilink")이라면, **\(K\) 위의 스킴**은 \(\operatorname{Spec}K\) 위의 스킴과 같다. \(\operatorname{Spec}\mathbb Z\)는 스킴의 범주의 [끝 대상이므로](https://ko.wikipedia.org/wiki/끝_대상 "wikilink"), "\(\mathbb Z\) 위의 스킴"은 "스킴"과 같은 뜻이다.
...
두 [국소환 달린 공간](https://ko.wikipedia.org/wiki/국소환_달린_공간 "wikilink") \((Y,\mathcal O_Y)\), \((X,\mathcal O_X)\) 사이의 사상 \(\iota\colon Y\to X\)가 다음 두 조건을 만족시킨다면, **[열린 몰입](https://ko.wikipedia.org/wiki/열린_몰입 "wikilink")**()이라고 한다.
  ...
  - \(\iota\)는 [위상 공간의](https://ko.wikipedia.org/wiki/위상_공간_\(수학\) "wikilink") 열린 [매장이다](../Page/매장_\(수학\).md "wikilink"). 즉, \(\iota\)는 [단사 함수이며](https://ko.wikipedia.org/wiki/단사_함수 "wikilink"), \(\iota(Y)\subset X\)는 [열린집합](../Page/열린집합.md "wikilink")이다.
...
두 [국소환 달린 공간](https://ko.wikipedia.org/wiki/국소환_달린_공간 "wikilink") \((Y,\mathcal O_Y)\), \((X,\mathcal O_X)\) 사이의 사상 \(\iota\colon Y\to X\)가 다음 두 조건을 만족시킨다면, **[닫힌 몰입](../Page/닫힌_몰입.md "wikilink")**()이라고 한다.
  ...
  - \(\iota\)는 [위상 공간의](https://ko.wikipedia.org/wiki/위상_공간_\(수학\) "wikilink") 닫힌 [매장이다](../Page/매장_\(수학\).md "wikilink"). 즉, \(\iota\)는 [단사 함수이며](https://ko.wikipedia.org/wiki/단사_함수 "wikilink"), \(\iota(Y)\subset X\)는 [닫힌집합](https://ko.wikipedia.org/wiki/닫힌집합 "wikilink")이다.
  - [층의](https://ko.wikipedia.org/wiki/층_\(수학\) "wikilink") 사상 \(\iota^\#\colon \mathcal O_X\to \iota_*\mathcal O_Y\)은 [전사 사상이다](../Page/전사_사상.md "wikilink").
...
하지만 스킴의 범주에서는 다음과 같은 (쌍대) 극한들이 존재하지 않는다.
  ...
  - 스킴들의 무한 [곱은](../Page/곱_\(범주론\).md "wikilink") 일반적으로 존재하지 않는다. (다만, [아핀 스킴들의](https://ko.wikipedia.org/wiki/아핀_스킴 "wikilink") 무한 곱은 [가환환](https://ko.wikipedia.org/wiki/가환환 "wikilink")의 무한 쌍대곱이므로 존재한다.)
...
[아핀 스킴의](https://ko.wikipedia.org/wiki/아핀_스킴 "wikilink") 범주 \(\operatorname{Aff}\)는 ([대수 구조 다양체의](../Page/대수_구조_다양체.md "wikilink") 범주인 [가환환](https://ko.wikipedia.org/wiki/가환환 "wikilink") 범주 \(\operatorname{CRing}\)의 [반대 범주이므로](https://ko.wikipedia.org/wiki/반대_범주 "wikilink")) [완비 범주이자](../Page/완비_범주.md "wikilink") [쌍대 완비 범주이다](https://ko.wikipedia.org/wiki/쌍대_완비_범주 "wikilink").
...
이 밖에도, 다음과 같은 위상들이 존재한다.
  ...
  - **[니스네비치 위상](../Page/니스네비치_위상.md "wikilink")**(Нисневич-, ). 이는 예브세이 니스네비치()가 도입하였으며, [대수적 K이론](../Page/대수적_K이론.md "wikilink") · \(\mathbb A^1\) 호모토피 이론 · [모티브](https://ko.wikipedia.org/wiki/모티브_\(수학\) "wikilink") 이론에서 쓰인다.
  - **신토믹 위상**().\[22\] 이는 일부 경우 평탄 위상보다 더 계산하기 쉬우며, 주로 [수론](https://ko.wikipedia.org/wiki/수론 "wikilink")에서 쓰인다.

이 위상들은 다음과 같이, 섬세함에 대하여 [전순서 집합을](https://ko.wikipedia.org/wiki/전순서_집합 "wikilink") 이룬다. (여기서 오른쪽으로 갈 수록 더 섬세한 위상이다.)
...
fpqc 위상은 흔히 사용되는 가장 섬세한 [그로텐디크 위상이므로](https://ko.wikipedia.org/wiki/그로텐디크_위상 "wikilink"), 흔히 사용되는 모든 [그로텐디크 위상들은](https://ko.wikipedia.org/wiki/그로텐디크_위상 "wikilink") 준표준 위상이다 (즉, [표현 가능](../Page/표현_가능_함자.md "wikilink") [준층](https://ko.wikipedia.org/wiki/준층 "wikilink")은 항상 [층을](https://ko.wikipedia.org/wiki/층_\(수학\) "wikilink") 이룬다).
...
이 밖에도, 다음과 같은 용어가 사용된다.
  ...
  - **[분리 스킴](https://ko.wikipedia.org/wiki/분리_스킴 "wikilink")**은 [위상 공간의](https://ko.wikipedia.org/wiki/위상_공간_\(수학\) "wikilink") [하우스도르프 조건과](https://ko.wikipedia.org/wiki/하우스도르프_공간 "wikilink") 유사한 조건을 만족시키는 스킴이다.
...
\[\mathbb A^1_K\times_K\mathbb A^1_K=\mathbb A^2_K=\operatorname{Spec}K[x,y]\] 이다. 이 경우, \(\operatorname{Spec}K[x,y]\)의 점들의 집합은 \(\mathbb A^1_K\)의 점들의 집합의 제곱과 일반적으로 다르다. 이는 아핀 평면 속에는 곱으로 나타낼 수 없는 [대수 곡선들이](https://ko.wikipedia.org/wiki/대수_곡선 "wikilink") 존재하기 때문이다. 다만, 닫힌 점들로 국한할 경우, \(\mathbb A^2_K\)의 닫힌 점들은 \(K^2\)와 표준적으로 대응하므로, \(\mathbb A^2_K\)의 닫힌 점들은 \(\mathbb A^1_K\)의 닫힌 점들의 집합의 제곱과 같다.

## 역사

대수기하학의 이탈리아 학파는 [대수다양체](../Page/대수다양체.md "wikilink")의 [일반점](../Page/일반점.md "wikilink")의 개념을 도입하였으며, [바르털 레인더르트 판데르바르던은](../Page/바르털_레인더르트_판데르바르던.md "wikilink") 1926년 책에서 일반점의 개념을 엄밀히 정의하였다.\[30\] 이후 [볼프강 크룰은](https://ko.wikipedia.org/wiki/볼프강_크룰 "wikilink") 파리에서의 강의에서 임의의 [가환환](https://ko.wikipedia.org/wiki/가환환 "wikilink")의 스펙트럼 및 그 위의 [자리스키 위상을](../Page/자리스키_위상.md "wikilink") 정의하였으나 관중들은 크룰의 정의를 비웃었고, 크룰은 이 이론을 출판하지 않았다.\[31\]
