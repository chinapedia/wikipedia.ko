...
## 개요
  ...
  - [미츠이 아이카](https://ko.wikipedia.org/wiki/미쓰이_아이카 "wikilink") 가입 후 첫 번째 정규 앨범이며, 또한 [요시자와 히토미가](../Page/요시자와_히토미.md "wikilink") 참가하는 마지막 앨범이기도 하다.
...
2.  **[歩いてる](https://ko.wikipedia.org/wiki/아루이테루 "wikilink") (ALBUM EDIT)**
      -
        작사, 작곡 : 층쿠 / 편곡 : 스즈키Daichi히데유키
3.  ****
      -
        작사, 작곡 : 층쿠 / 편곡 : 히라타 쇼이치로
4.  **[笑顔YESヌード](https://ko.wikipedia.org/wiki/에가오YES누드 "wikilink") (ALBUM MIX)**
      -
        작사, 작곡 : 층쿠 / 편곡 : 마쓰이 히로시
...
※괄호는 트랙 번호
  ...
  - 다케우치 히로아키 - 코러스 (1, 2, 3, 4, 6, 7, 10, 11)
  - 다케가미 요시나리 - 테너 색소폰 (2)
  - 층쿠♂ - 코러스 (2, 4, 6, 9, 10, 11)
  - 히라타 쇼이치로 - 프로그래밍 (3)
  - 마쓰이 히로시 - 프로그래밍 (4, 11), 키보드 (4)
  - 고레나가 고이치 - 기타 (4, 11)
  - 다카하시 유이치 - 프로그래밍, 기타 (5, 6)
  - CHINO - 코러스 (5, 9)
  - 유아사 고이치 - 프로그래밍 (7)
  - 고지 - 기타 (7, 9)
  - AKIRA - 프로그래밍 (8)
...
## 외부 링크
  ...
  - [UP-FRONT WORKS 음반 목록](https://web.archive.org/web/20070228101237/http://www.up-front-works.jp/discography/zetima/29/a_17/)

  - [헬로\! 프로젝트 공식 사이트 음반 목록](https://web.archive.org/web/20100909203107/http://www.helloproject.com/discography/musume/a_019.html)

  - [층쿠♂ 공식 사이트 코멘트](https://web.archive.org/web/20100704102945/http://www.tsunku.net/pw_Music.php?@PS@=none&@DB_ID@=369)

[분류:2007년 음반](https://ko.wikipedia.org/wiki/분류:2007년_음반 "wikilink") [분류:모닝구무스메의 음반](https://ko.wikipedia.org/wiki/분류:모닝구무스메의_음반 "wikilink")