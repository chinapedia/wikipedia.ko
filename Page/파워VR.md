...
이후 PowerVR은 노트북 컴퓨터를 대상으로 한 저전력 그래픽 카드인 [GPU(그래픽 처리 장치)로](../Page/그래픽_처리_장치.md "wikilink") 방향을 전환하였다. 시간이 지나면서 임베디드 시스템, 핸드헬드 장치, 스마트폰의 급격한 시장확장으로 여기에 사용되는 SoC에 사용될 수 있도록 변화하였다. PowerVR 가속기는 PowerVR에서 직접 제조하지 않으며, 회로 설계 및 특허권은 TI, 인텔, NEC, 삼성, ST마이크로일렉트로닉스, 프리스케일, 애플, NXP 등 반도체 제조 회사에 라이선스된다.
...
| ---------------------------- | ------------------------ | ---------------------------------------- | -------------------------------------- | -------------------------------------- | ---------------- | --------- | -------- | ---------------------- |
| MTriangles/s<sup>\[1\]</sup> | GPixel/s<sup>\[1\]</sup> | [DirectX](../Page/DirectX.md "wikilink") | [OpenGL](../Page/OpenGL.md "wikilink") | [OpenCL](../Page/OpenCL.md "wikilink") |                  |           |          |                        |
...
| ----------- | --------- | ---------- | ---------------------------------------- | -------------------------------------- | -------------------------------------------- | --------------- | --------- | -------- | --------------------- |
| MPolygons/s | 픽셀 (GP/s) | 텍스처 (GT/s) | [DirectX](../Page/DirectX.md "wikilink") | [OpenGL](../Page/OpenGL.md "wikilink") | [OpenGL ES](../Page/OpenGL_ES.md "wikilink") |                 |           |          |                       |
