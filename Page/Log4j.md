...
**log4j**는 프로그램을 작성하는 도중에 로그를 남기기 위해 사용되는 [자바](../Page/자바_\(프로그래밍_언어\).md "wikilink") 기반 [로깅](https://ko.wikipedia.org/wiki/데이터_로깅 "wikilink") 유틸리티이다. [디버그](../Page/디버그.md "wikilink")용 도구로 주로 사용되고 있다.
...
## 포팅
  ...
  - [Log4c](http://log4c.sourceforge.net/) - [C용](../Page/C_\(프로그래밍_언어\).md "wikilink") 이식
  - [Log4perl](http://log4perl.sourceforge.net/) - [펄](../Page/펄.md "wikilink")용 이식
