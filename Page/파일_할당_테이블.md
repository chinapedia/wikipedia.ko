...
FAT 파일 시스템은 [마이크로소프트 독립형 디스크 베이직의](https://ko.wikipedia.org/wiki/마이크로소프트_베이직 "wikilink") 디스크 관리를 위해 만들어졌다. 1980년 8월에 [팀 패터슨](https://ko.wikipedia.org/wiki/팀_패터슨 "wikilink")(Tim Paterson)은 FAT를 [S-100](../Page/S-100_버스.md "wikilink") [8086](https://ko.wikipedia.org/wiki/8086 "wikilink") CPU 기판을 위한 [86-DOS](https://ko.wikipedia.org/wiki/86-DOS "wikilink") 운영 체제로 도입하였다.\[6\] 이 파일 시스템은 86-DOS와, 86-DOS 이전에 쓰였던 [CP/M](https://ko.wikipedia.org/wiki/CP/M "wikilink") 사이의 주된 차이였다.
