...
**URL**(Uniform Resource Locator, )은 네트워크 상에서 자원이 어디 있는지를 알려주기 위한 규약이다. 즉, [컴퓨터 네트워크와](https://ko.wikipedia.org/wiki/컴퓨터_네트워크 "wikilink") 검색 [메커니즘](https://ko.wikipedia.org/wiki/메커니즘 "wikilink")에서의 위치를 지정하는, [웹 리소스에](https://ko.wikipedia.org/wiki/리소스_\(웹\) "wikilink") 대한 참조이다. 흔히 웹 사이트 주소로 알고 있지만, URL은 웹 사이트 주소뿐만 아니라 컴퓨터 네트워크상의 자원을 모두 나타낼 수 있다. 그 주소에 접속하려면 해당 URL에 맞는 [프로토콜을](https://ko.wikipedia.org/wiki/통신_프로토콜 "wikilink") 알아야 하고, 그와 동일한 프로토콜로 접속해야 한다.
...
URL은 1994년 [월드 와이드 웹의](../Page/월드_와이드_웹.md "wikilink") 창시자 [팀 버너스 리와](https://ko.wikipedia.org/wiki/팀_버너스_리 "wikilink") [IETF](https://ko.wikipedia.org/wiki/IETF "wikilink")의 URI 워킹 그룹에 의해 1992년 IETF Live Documents [Birds of a feather에서](https://ko.wikipedia.org/wiki/Birds_of_a_feather "wikilink") 시작한 협업의 산물로서 [RFC](https://ko.wikipedia.org/wiki/RFC "wikilink") 1738에 정의되었다.
...
```
  ...
  - URL은 제일 앞에 자원에 접근할 방법을 정의해 둔 프로토콜 이름을 적는다. [gopher](../Page/고퍼_\(프로토콜\).md "wikilink"), [telnet](../Page/텔넷.md "wikilink"), [ftp](https://ko.wikipedia.org/wiki/파일_전송_프로토콜 "wikilink"), [http](../Page/HTTP.md "wikilink"), [usenet](https://ko.wikipedia.org/wiki/유즈넷 "wikilink") 등이다.
