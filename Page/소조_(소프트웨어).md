...
**소조**(Xojo)는 [OS X](https://ko.wikipedia.org/wiki/OS_X "wikilink"), [마이크로소프트 윈도](https://ko.wikipedia.org/wiki/마이크로소프트_윈도 "wikilink"), 32비트 x86 [리눅스](../Page/리눅스.md "wikilink"), [웹](https://ko.wikipedia.org/wiki/웹 "wikilink")을 대상의 [소프트웨어 개발을](https://ko.wikipedia.org/wiki/소프트웨어_개발 "wikilink") 위해 텍사스 주 [오스틴의](https://ko.wikipedia.org/wiki/오스틴_\(텍사스_주\) "wikilink") 소조(Xojo)사에서 상용화되고 개발되는 [프로그래밍 환경이다](https://ko.wikipedia.org/wiki/프로그래밍_환경 "wikilink"). 소조는 소조(Xojo)라 불리는 [사유](https://ko.wikipedia.org/wiki/사유_소프트웨어 "wikilink") [객체 지향](https://ko.wikipedia.org/wiki/객체_지향 "wikilink") [프로그래밍 언어를](../Page/프로그래밍_언어.md "wikilink") 사용한다. 소조는 모바일 앱들의 개발을 지원할 것임을 발표하였다.\[1\]\[2\]
