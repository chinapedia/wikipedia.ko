...
**클래스**(class)는 [객체 지향 프로그래밍](https://ko.wikipedia.org/wiki/객체_지향_프로그래밍 "wikilink")(OOP)에서 특정 객체를 생성하기 위해 [변수와](https://ko.wikipedia.org/wiki/변수_\(컴퓨터_과학\) "wikilink") 메소드를 정의하는 일종의 틀이다. 객체를 정의 하기 위한 상태(멤버변수)와 메서드(함수)로 구성된다.
...
## 같이 보기
  ...
  - [표준 템플릿 라이브러리](https://ko.wikipedia.org/wiki/표준_템플릿_라이브러리 "wikilink")(STL)
