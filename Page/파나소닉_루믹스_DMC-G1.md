...
이 카메라는 [DSLR](https://ko.wikipedia.org/wiki/DSLR "wikilink") 카메라들과 비교하여 작은 카메라 본체와 렌즈를 가지고 있다. 렌즈 교환시 먼지 유입을 막기 위해 먼지 제거 시스템을 가지고 있으며 다른 컴팩트 [디지털 카메라](../Page/디지털_카메라.md "wikilink") 보다 더 좋은 이미지를 보여주는 전자 뷰파인더를 장착하고 있다. 이 카메라의 [컨트라스트 검출 AF](https://ko.wikipedia.org/wiki/컨트라스트_검출_AF "wikilink") 능력은 [위상차 검출 AF](https://ko.wikipedia.org/wiki/위상차_검출_AF "wikilink") 기술을 쓰는 일반적인 DSLR 카메라들에 필적할만한 성능이다.
