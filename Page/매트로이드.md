...
유한 매트로이드와 강사상의 [작은 범주를](../Page/작은_범주.md "wikilink") \(\operatorname{finMatr}\)라고 하자. 또한, [유한 집합과](https://ko.wikipedia.org/wiki/유한_집합 "wikilink") [함수](https://ko.wikipedia.org/wiki/함수 "wikilink")의 [작은 범주를](../Page/작은_범주.md "wikilink") \(\operatorname{finSet}\)라고 하자.
...
크기 1의 매트로이드 동형류들은 다음 두 가지이다.
  ...
  - \(\operatorname{Unif}(1,0)\) (계수 0). 이는 하나의 꼭짓점과 하나의 변을 갖는 [다중 그래프의](../Page/다중_그래프.md "wikilink") [순환 매트로이드이다](https://ko.wikipedia.org/wiki/순환_매트로이드 "wikilink").
...
이는 다음과 같은 [다중 그래프에](../Page/다중_그래프.md "wikilink") 대응하는 [순환 매트로이드이다](https://ko.wikipedia.org/wiki/순환_매트로이드 "wikilink").
...
이후 [윌리엄 토머스 텃이](../Page/윌리엄_토머스_텃.md "wikilink") 매트로이드 이론을 발달시켰고, [텃 다항식과](https://ko.wikipedia.org/wiki/텃_다항식 "wikilink") 같은 중요한 개념들을 발견하였다.\[26\]
