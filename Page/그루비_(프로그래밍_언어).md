...
**그루비**(Groovy)는 [자바에](https://ko.wikipedia.org/wiki/자바_\(프로그래밍_언어\) "wikilink") [파이썬](https://ko.wikipedia.org/wiki/파이썬 "wikilink"), [루비](https://ko.wikipedia.org/wiki/루비_\(프로그래밍_언어\) "wikilink"), [스몰토크](https://ko.wikipedia.org/wiki/스몰토크 "wikilink")등의 특징을 더한 [동적](../Page/동적_프로그래밍_언어.md "wikilink") [객체 지향](https://ko.wikipedia.org/wiki/객체_지향_프로그래밍_언어 "wikilink") [프로그래밍 언어이다](https://ko.wikipedia.org/wiki/프로그래밍_언어 "wikilink").

## 특징

  - [자바 가상 머신에서](https://ko.wikipedia.org/wiki/자바_가상_머신 "wikilink") 작동하는 동적 타이핑 프로그래밍 언어이다.
  - [자바의](https://ko.wikipedia.org/wiki/자바_\(프로그래밍_언어\) "wikilink") 강점 위에 [파이썬](https://ko.wikipedia.org/wiki/파이썬 "wikilink"), [루비](https://ko.wikipedia.org/wiki/루비_\(프로그래밍_언어\) "wikilink"), [스몰토크](https://ko.wikipedia.org/wiki/스몰토크 "wikilink")등의 프로그래밍 언어에 영향을 받은 특장점을 더하였다.
  - [자바](https://ko.wikipedia.org/wiki/자바_\(프로그래밍_언어\) "wikilink") 프로그래머들이 많은 학습을 하지 않고도 최신 프로그래밍 기법을 사용할 수 있다.
  - 도메인 전문 언어와 단순화된 문법을 지원하여 코드가 읽고 유지 보수하기 편해진다.

## 역사

2002년 [영국](https://ko.wikipedia.org/wiki/영국 "wikilink") 출신의 프로그래머인 [제임스 스트라칸에](https://ko.wikipedia.org/wiki/제임스_스트라칸 "wikilink") 의해 창시되었으며 현재 [아파치 사용 허가서 2.0](http://www.apache.org/licenses/LICENSE-2.0) 아래에 소스와 바이너리가 배포, 공개되어 있다. 2012년 6월 2일 2.0버전이 출시되었다.
