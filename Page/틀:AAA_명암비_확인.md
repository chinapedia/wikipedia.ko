...
<includeonly>{{\#if:}}}|{{\#ifexpr:{{\#invoke:Color contrast|ratio|}}}|}}}|error=21}} \< 7 OR {{\#invoke:Color contrast|ratio|}}}|black|error=0}} \< 7 AND {{\#invoke:Color contrast|ratio|}}}|white|error=0}} \< 7|}}}}}}}</includeonly><noinclude>
  ...
  - {{\#invoke:DemoTemplate||색상=navy|기타=|분류=Test}}
  - {{\#invoke:DemoTemplate||색상=navy|기타=navy|분류=Test}}
  - {{\#invoke:DemoTemplate||색상=red|분류=Test}}
  - {{\#invoke:DemoTemplate||색상=\#CC5500|분류=Test}}
  - {{\#invoke:DemoTemplate||색상=asdf|분류=Test}}

## 같이 보기

  -
}} [분류:색 변환 틀](https://ko.wikipedia.org/wiki/분류:색_변환_틀 "wikilink")</noinclude>