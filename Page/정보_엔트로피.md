...
일반적으로 엔트로피는 무질서도 또는 불확실성을 가리킨다. 섀넌 엔트로피의 개념은 [클로드 섀넌이](https://ko.wikipedia.org/wiki/클로드_섀넌 "wikilink") 자신의 1948년 논문 "[수학적 통신 이론](https://ko.wikipedia.org/wiki/:en:A_Mathematical_Theory_of_Communication "wikilink")"에서 도입하였다.\[1\] 섀넌 엔트로피는 정보 소스(source)를 [무손실](https://ko.wikipedia.org/wiki/비손실_압축 "wikilink") 인코딩 또는 [압축할](https://ko.wikipedia.org/wiki/데이터_압축 "wikilink") 때 가능한 최상의 평균 길이의 절대적 한계치를 제공해준다. [레니 엔트로피는](https://ko.wikipedia.org/wiki/:en:Rényi_entropy "wikilink") 섀넌 엔트로피를 일반화한 것이다.
...
\[E=\{x_1,\ldots,x_n\}\] 이라면, [르베그 적분은](https://ko.wikipedia.org/wiki/르베그_적분 "wikilink") 합이 되며, 따라서 정보 엔트로피는 다음과 같다.

\[H(X)=-\sum_if_i\ln f_i\]

간혹, 위 정의에서 [자연로그](https://ko.wikipedia.org/wiki/자연로그 "wikilink") 대신 이진로그 \(\log_2\)를 사용하는 경우가 있다. 이 경우 정보 엔트로피의 단위는 [비트이고](https://ko.wikipedia.org/wiki/비트_\(단위\) "wikilink"), 자연로그의 경우에는 단위 [내트](https://ko.wikipedia.org/wiki/내트 "wikilink")(nat)를 사용한다.
...
정보 엔트로피의 정의를 이해하기 위해서, [이산균등분포](https://ko.wikipedia.org/wiki/이산균등분포 "wikilink")의 엔트로피를 계산해 보자. [표본 공간이](https://ko.wikipedia.org/wiki/표본_공간 "wikilink") 총 *n*개의 서로 다른 값들로 이루어진다면, [확률 질량 함수는](https://ko.wikipedia.org/wiki/확률_질량_함수 "wikilink")
...
[정보이론](https://ko.wikipedia.org/wiki/정보이론 "wikilink")에서 ‘엔트로피’라는 단어를 사용하게 된 이유는 섀넌의 공식이 열역학적 엔트로피의 공식과 상당부분 비슷하기 때문이다.\[3\] 열역학적 [엔트로피](https://ko.wikipedia.org/wiki/엔트로피 "wikilink") S로서 가장 많이 사용되는 통계열역학에서는 기브스의 엔트로피를 다음과 같이 정의한다.

\[S = - k_B \sum p_i \ln p_i \,\] 여기서 *k*<sub>B</sub>는 [볼츠만 상수를](https://ko.wikipedia.org/wiki/볼츠만_상수 "wikilink"), 그리고 p<sub>i</sub>는 미시적인 상태의 확률을 의미한다. 기브스엔트로피는 1872년 [볼츠만](https://ko.wikipedia.org/wiki/볼츠만 "wikilink")의 연구업적을 뒤이어 [조사이어 윌러드 기브스에](https://ko.wikipedia.org/wiki/조사이어_윌러드_기브스 "wikilink") 의하여 1878년에 정의되었다. 기브스 엔트로피는 또한 거의 변화 없이 [양자물리학](https://ko.wikipedia.org/wiki/양자물리학 "wikilink")에서의 노만 엔트로피로도 변형되는데 이는 1927년 [존 폰 노이만에의해](https://ko.wikipedia.org/wiki/존_폰_노이만 "wikilink") 정의 소개되었으며 다음과 같이 정의된다

\[S = - k_B \,\,{\rm Tr}(\rho \ln \rho) \,\] 여기서 ρ로 는 [양자역학](https://ko.wikipedia.org/wiki/양자역학 "wikilink") 시스템에서의 [밀도](https://ko.wikipedia.org/wiki/밀도 "wikilink") 행렬을 나타내며 Tr은 행적을 나타낸다.

일상생활의 실용적인 수준에서는 [정보이론](https://ko.wikipedia.org/wiki/정보이론 "wikilink")의 엔트로피와 [열역학](https://ko.wikipedia.org/wiki/열역학 "wikilink")적 [엔트로피](https://ko.wikipedia.org/wiki/엔트로피 "wikilink")의 관계가 그리 깊지는 않다. 물리학자나 화학자는 자발적으로 초기상태에서 멀어지는 시스템에서의 엔트로피 ‘변화’에 더욱 관심이 있다. 이는 [열역학 제2법칙에](https://ko.wikipedia.org/wiki/열역학_제2법칙 "wikilink") 부합하는 내용으로, 불변하는 [확률분포](https://ko.wikipedia.org/wiki/확률분포 "wikilink")에 집중하는 정보엔트로피와는 포커싱이 사뭇 다르다.

그러나 여러 학문분야에 걸쳐 종합적인 분석을 해보면, [열역학](https://ko.wikipedia.org/wiki/열역학 "wikilink")적 엔트로피와 정보 엔트로피 사이에서는 연결고리가 만들어질 수 있다. 사실 1957년 제인스()의 의견에 의하면, 열역학은 섀넌의 정보 이론의 ‘응용’으로 간주될 수 있다.\[4\] 열역학에서의 엔트로피는 시스템의 더욱 자세한 미시적인 상태를 정의하기 위해 더 필요한 섀넌 정보 양의 추정으로 해석될 수 있다. 이는 고전열역학의 미시변수란 개념으로는 설명될 수 없는 것이었다. 예를 들면 시스템에 열을 가하는 것은 열역학적 엔트로피를 증가하는 것이다. 왜냐하면 이것은 미세 상태의 가능한 가짓수를 증가시키기 때문이다. [제임스 클러크 맥스웰은](https://ko.wikipedia.org/wiki/제임스_클러크_맥스웰 "wikilink") 이론적으로 시스템의 열역학적 엔트로피를 개별적인 분자 상태에 대한 정보를 사용함으로써 감소시킬 수 있다고 주장하였다. 이는 [맥스웰의 도깨비란](https://ko.wikipedia.org/wiki/맥스웰의_도깨비 "wikilink") 이름으로 널리 알려져 있다. 그러나 란다우어(Landauer)와 그의 동료들은 총 엔트로피는 줄지 않는다는 것을 보이며 이 역설을 해결하였다.

## 다양한 분야에서 활용된 엔트로피 개념

  - [아이작 아시모프의](https://ko.wikipedia.org/wiki/아이작_아시모프 "wikilink") 단편 소설 《마지막 질문》.
  - 헨리 애덤스의 책 《엔트로피와 생명》. 19세기 미국 역사가 헨리 애덤스는 기계의 힘인 동력과 힘의 쇠퇴인 [엔트로피](https://ko.wikipedia.org/wiki/엔트로피 "wikilink") 개념을 포함한 정교한 역사 이론을 주창하였다. 애덤스는 인간 사회가 진보하는 것이 아니라 어쩔 수 없이 쇠퇴하는 것을 자연 상태에서 엔트로피가 커지는 것에 결합하여 설명하였다.
