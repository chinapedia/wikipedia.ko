...
[수학적 형태학에서](https://ko.wikipedia.org/wiki/수학적_형태학 "wikilink"), **구조적 요소**는 이 형태가 이미지에 맞는지, 맞지 않는지를 결론을 내기 위해 주어진 이미지를 탐색하거나 작용하는데 사용되는 형태이다. 이것은 특히 [팽창](../Page/팽창_\(형태학\).md "wikilink"), [침식](../Page/침식_\(형태학\).md "wikilink"), [열기](../Page/열기_\(형태학\).md "wikilink"), 그리고 [닫기](../Page/닫기_\(형태학\).md "wikilink") 및 [적중과 비적중 변환과](https://ko.wikipedia.org/wiki/적중과_비적중_변환 "wikilink") 같은 형태학적 연산에 사용된다.
...
구조적 요소는 이진 이미지의 특정한 경우이며, 보통 작고 단순하다. 수학적 형태학에서, [이진 이미지는](https://ko.wikipedia.org/wiki/이진_이미지 "wikilink") 어떤 *d* 차원의 [유클리드 공간](https://ko.wikipedia.org/wiki/유클리드_공간 "wikilink") *R*<sup>*d*</sup> 또는 정수 격자 *Z*<sup>*d*</sup>의 [부분집합](https://ko.wikipedia.org/wiki/부분집합 "wikilink")이다. 여기에 넓게 사용되는 (*B*로 표기된) 구조적 요소의 일부 예시가 있다:
