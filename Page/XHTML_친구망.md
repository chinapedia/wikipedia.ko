> This article is converted from Wikipedia: [XHTML 친구망](https://ko.wikipedia.org/wiki/XHTML_친구망).
...
## 외부 링크
  ...
  - [XFN - 글로벌 멀티미디어 프로토콜 그룹](http://gmpg.org/xfn/)
  - [XFN 생성기](http://gmpg.org/xfn/creator) XFN 하이퍼링크 생성 페이지
  - [마이크로포맷 위키](http://microformats.org/wiki/xfn)

[분류:마이크로포맷](https://ko.wikipedia.org/wiki/분류:마이크로포맷 "wikilink") [분류:소셜 네트워크 서비스](https://ko.wikipedia.org/wiki/분류:소셜_네트워크_서비스 "wikilink") [분류:XML 기반 표준](https://ko.wikipedia.org/wiki/분류:XML_기반_표준 "wikilink")