...
[군](https://ko.wikipedia.org/wiki/군_\(수학\) "wikilink") \(G\)의 원소 \(g\in G\)의 **켤레류**는 다음과 같다.\[2\]
...
[유한군](https://ko.wikipedia.org/wiki/유한군 "wikilink") \(G\)의 원소 \(g\in G\)의 켤레류의 [집합의 크기는](https://ko.wikipedia.org/wiki/집합의_크기 "wikilink") [궤도-안정자군 정리에](https://ko.wikipedia.org/wiki/궤도-안정자군_정리 "wikilink") 따라 다음과 같다.
...
\[1 = \sum_{\operatorname{Cl}(g)\in\operatorname{Cl}(G)} \frac1{|{\operatorname C}_G(g)|}\] 이므로, 이는 1의 [이집트 분수](../Page/이집트_분수.md "wikilink") 분해를 이룬다. 1을 주어진 개수의 이집트 분수들로 분해하는 방법은 유한하므로, 따라서 주어진 수의 켤레류를 갖는 유한군의 수는 유한하다. 예를 들어, [아벨 군의](https://ko.wikipedia.org/wiki/아벨_군 "wikilink") 경우 이러한 이집트 분수 분해는

\[1 = \underbrace{\frac1{|G|}+\frac1{|G|}+\dotsb+\frac1{|G|}}_{|G|}\] 이다.

### 콤팩트 리 군

\(G\)가 [콤팩트](../Page/콤팩트_공간.md "wikilink") [리 군이라고](https://ko.wikipedia.org/wiki/리_군 "wikilink") 하자. 이 경우, \(G\)는 항상 [극대 원환면](../Page/극대_원환면.md "wikilink") \(T \le G\)을 가지며, 모든 원소 \(g\in G\)는 \(T\)의 어떤 원소와 켤레 동치이다. 또한, 임의의 \(g\in G\)의 켤레류와 \(T\)의 [교집합](https://ko.wikipedia.org/wiki/교집합 "wikilink")은 \(T\)의 어떤 원소 \(t\in T\)의 [바일 군](https://ko.wikipedia.org/wiki/바일_군 "wikilink") [궤도와](https://ko.wikipedia.org/wiki/군의_작용의_궤도 "wikilink") 같다.
...
특히, 항등원 근처의 ‘무한소 원소’(즉, 그 [리 대수의](https://ko.wikipedia.org/wiki/리_대수 "wikilink") 원소)의 ‘켤레류’는 [카르탕 부분 대수의](https://ko.wikipedia.org/wiki/카르탕_부분_대수 "wikilink") 바일 군 궤도, 즉 [바일 방의](https://ko.wikipedia.org/wiki/바일_방 "wikilink") 원소가 된다.

## 예

### 아벨 군

[아벨 군](https://ko.wikipedia.org/wiki/아벨_군 "wikilink") \(G\)의 경우, 켤레류는 (자명하게) [한원소 집합이며](../Page/한원소_집합.md "wikilink"), 따라서

\[\operatorname{Cl}(G) \cong G\] 이다.

### 대칭군

\(n\)차 [대칭군](https://ko.wikipedia.org/wiki/대칭군_\(군론\) "wikilink") \(\operatorname{Sym}(n)\)을 생각하자. 그 원소가 다음과 같은 꼴의 순환 분해를 갖는다고 하자.
...
[리 군](https://ko.wikipedia.org/wiki/리_군 "wikilink") \(\operatorname{SU}(2)\)를 생각하자. 기하학적으로, 이는 [3차원 초구](../Page/3차원_초구.md "wikilink") \(\mathbb S^3\)와 [미분 동형이다](https://ko.wikipedia.org/wiki/미분_동형 "wikilink"). 이 경우, [극대 원환면은](../Page/극대_원환면.md "wikilink") (1차원) [원군](../Page/원군.md "wikilink") \(T=\operatorname U(1)\)이며, 이는 2×2 대각 행렬의 부분군

\[T = \left\{\begin{pmatrix}
\exp(\mathrm i\theta) & 0 \\
0& \exp(-\mathrm i\theta)
\end{pmatrix}\colon \theta \in \mathbb R\right\} \le \left\{
M\in\operatorname{GL}(2;\mathbb C) \colon \det M = 1,\;M^\dagger M = 1_{2\times2}\right\} = \operatorname{SU}(2)\] 으로 여길 수 있다. 이 경우, [바일 군은](https://ko.wikipedia.org/wiki/바일_군 "wikilink") 2차 [대칭군이며](https://ko.wikipedia.org/wiki/대칭군_\(군론\) "wikilink"), 그 두 원소 가운데 항등원이 아닌 것은 원군 위에 다음과 같이 작용한다.

\[\theta \mapsto -\theta\] 즉, SU(2)의 켤레류들의 공간은 [반원](https://ko.wikipedia.org/wiki/반원 "wikilink") \(\theta\in[0,\pi]\)에 해당한다. 구체적으로, 행렬군 위에서 [대각합](../Page/대각합.md "wikilink")과 [행렬식](https://ko.wikipedia.org/wiki/행렬식 "wikilink")은 [유함수](https://ko.wikipedia.org/wiki/유함수 "wikilink")이다. SU(2)의 경우 행렬식은 물론 [상수 함수](../Page/상수_함수.md "wikilink") 1이지만, 그 [대각합](../Page/대각합.md "wikilink")은 자명하지 않으며, 사실 켤레류는 대각합으로 완전히 결정된다. 즉,
...
| 2                                                                                                  | 2차 [대칭군](https://ko.wikipedia.org/wiki/대칭군_\(군론\) "wikilink") \(\operatorname{Sym}(2)\) | \(\tfrac12+\tfrac12\)                            |
| 3                                                                                                  | 3차 [교대군](../Page/교대군.md "wikilink")                                                     | \(\tfrac13+\tfrac13+\tfrac13\)                   |
| 3차 [대칭군](https://ko.wikipedia.org/wiki/대칭군_\(군론\) "wikilink") \(\operatorname{Sym}(3)\)            | \(\tfrac16+\tfrac13+\tfrac12\)                                                          |                                                  |
| 4                                                                                                  | 4차 [교대군](../Page/교대군.md "wikilink") \(\operatorname{Alt}(4)\)                           | \(\tfrac1{12}+\tfrac14+\tfrac13+\tfrac13\)       |
| 5차 [정이면체군](https://ko.wikipedia.org/wiki/정이면체군 "wikilink") \(\operatorname{Dih}(5)\)               | \(\tfrac1{10}+\tfrac15+\tfrac15+\tfrac12\)                                              |                                                  |
| 4차 [순환군](https://ko.wikipedia.org/wiki/순환군 "wikilink") \(\operatorname{Cyc}(4)\)                   | \(\tfrac14+\tfrac14+\tfrac14+\tfrac14\)                                                 |                                                  |
| [클라인 4원군](../Page/클라인_4원군.md "wikilink") \(\operatorname{Cyc}(2)^2\)                               |                                                                                         |                                                  |
| 5                                                                                                  | 5차 [순환군](https://ko.wikipedia.org/wiki/순환군 "wikilink") \(\operatorname{Cyc}(5)\)        | \(\tfrac15+\tfrac15+\tfrac15+\tfrac15+\tfrac15\) |
| 4차 [정이면체군](https://ko.wikipedia.org/wiki/정이면체군 "wikilink") \(\operatorname{Dih}(4)\)               | \(\tfrac18+\tfrac18+\tfrac14+\tfrac14+\tfrac14\)                                        |                                                  |
| [사원수군](../Page/사원수군.md "wikilink") \(Q_8\)                                                         |                                                                                         |                                                  |
| 5차 [교대군](../Page/교대군.md "wikilink") \(\operatorname{Alt}(5)\)                                      | \(\tfrac1{60}+\tfrac15+\tfrac15+\tfrac14+\tfrac13\)                                     |                                                  |
| 4차 [대칭군](https://ko.wikipedia.org/wiki/대칭군_\(군론\) "wikilink") \(\operatorname{Sym}(4)\)            | \(\tfrac1{24}+\tfrac18+\tfrac14+\tfrac14+\tfrac13\)                                     |                                                  |
| 7차 [정이면체군](https://ko.wikipedia.org/wiki/정이면체군 "wikilink") \(\operatorname{Dih}(7)\)               | \(\tfrac1{14} + \tfrac17+\tfrac17+\tfrac17+\tfrac12\)                                   |                                                  |
