...
[범주론](https://ko.wikipedia.org/wiki/범주론 "wikilink")에서, **초자연 변환**(超自然變換, )은 [자연 변환의](https://ko.wikipedia.org/wiki/자연_변환 "wikilink") 개념의 일반화이다.\[1\]\[2\] [자연 변환과](https://ko.wikipedia.org/wiki/자연_변환 "wikilink") 달리, 초자연 변환은 정의역이 서로 다른 두 [함자](https://ko.wikipedia.org/wiki/함자_\(수학\) "wikilink") 사이에도 정의될 수 있다.
...
이 데이터는 다음 조건을 만족시켜야 한다.
  ...
  - (\(\mathcal A\)에서의 자연성) 각 \((B,C)\in\mathcal B\times\mathcal C\)에 대하여, \(\eta_{-,B,C} \colon F(-,B,B)\Rightarrow F(-,C,C)\)는 [자연 변환이다](https://ko.wikipedia.org/wiki/자연_변환 "wikilink"). 즉, 임의의 사상 \(f\in\hom_{\mathcal A}(A,A')\)에 대하여 다음 그림이 가환 그림이다.
    :<math>\\begin{matrix}
...
예를 들어, 만약 \((\mathcal C,\otimes)\)가 [체](https://ko.wikipedia.org/wiki/체_\(수학\) "wikilink") \(K\) 위의 유한 차원 [벡터 공간의](https://ko.wikipedia.org/wiki/벡터_공간 "wikilink") 범주 \(\operatorname{fgMod}_K\)이며, \(X = K\)일 때, 이는 벡터 공간과 그 [쌍대 공간](https://ko.wikipedia.org/wiki/쌍대_공간 "wikilink") 사이의 [내적](https://ko.wikipedia.org/wiki/내적 "wikilink")
