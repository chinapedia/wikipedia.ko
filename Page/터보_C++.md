...
볼랜드는 최근에 "터보" 제품을 다음의 제품으로 구성하였다.:
  ...
  - 새로운 모든 버전의 터보 C++
  - [터보 델파이](../Page/터보_델파이.md "wikilink") ([닷넷](https://ko.wikipedia.org/wiki/마이크로소프트_닷넷 "wikilink") 호환 버전 포함)
...
지금은 터보 C++에 이어 [C++빌더](../Page/C++빌더.md "wikilink") 라는 이름으로 새로운 버전이 나오고 있다.
