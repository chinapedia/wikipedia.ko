...
[선형대수학](https://ko.wikipedia.org/wiki/선형대수학 "wikilink")에서, **대각행렬**(對角行列, )은 [주대각선](../Page/주대각선.md "wikilink")을 제외한 곳의 원소가 모두 0인 [정사각행렬](https://ko.wikipedia.org/wiki/정사각행렬 "wikilink")이다. 대각행렬은 0일 수도, 아닐 수도 있는 대각원소들에 의해 결정된다. *n* × *n* 행렬 \(D = [d_{i,j}]\)가 대각행렬일 [필요충분조건](../Page/필요충분조건.md "wikilink")은
...
[단위행렬](https://ko.wikipedia.org/wiki/단위행렬 "wikilink")은 특수한 대각행렬의 일종이다.
...
## 함께보기
  ...
  - [사다리꼴행렬](https://ko.wikipedia.org/wiki/가우스_소거법 "wikilink")
