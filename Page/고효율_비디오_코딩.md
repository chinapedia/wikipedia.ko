...
**고효율 비디오 코딩(HEVC/H265)**()는 [H.264/MPEG-4 AVC의](https://ko.wikipedia.org/wiki/H.264/MPEG-4_AVC "wikilink") 성공에 힘입어 개발에 착수한 차세대 동영상 부호화 기술이다. 기존에 H.264/MPEG-4 AVC를 개발했던 [ISO/IEC](https://ko.wikipedia.org/wiki/ISO/IEC "wikilink") [MPEG](https://ko.wikipedia.org/wiki/MPEG "wikilink")과 [ITU-T](../Page/ITU-T.md "wikilink")의 [영상 부호화 전문가 그룹](https://ko.wikipedia.org/wiki/영상_부호화_전문가_그룹 "wikilink")(Video Coding Experts Group)이 Joint Collaborative Team on Video Coding (JCT-VC)\[2\]으로서 2010년 1월 팀을 결성하여 표준화 작업을 진행하였다.
...
화면 내 예측의 경우 35개의 모드 중 선택 할 수 있도록 하여 기존에 비하여 크게 늘렸다. 화면간 예측에서는 예상 움직임 벡터를 최대 5개 중에 선택할 수 있도록 하였다. 또한, 소수점 단위 [움직임 예측에](https://ko.wikipedia.org/wiki/움직임_보상 "wikilink") 필요한 보간필터도 [1/4 픽셀 단위까지](https://ko.wikipedia.org/wiki/쿼터_픽셀 "wikilink") 정의되었다(기존 H.264에서는 1/4 픽셀 단위에서는 선형보간을 사용했다.).

#### 차영상 부호화

32x32부터 4x4까지 다양한 사이즈의 부호화를 지원한다. 화면내 부호화의 경우, 모드에 따라 4x4 단위에서는 [DCT대신에](https://ko.wikipedia.org/wiki/이산_코사인_변환 "wikilink") DST를 사용하도록 하였다.
...
[분류:ISO 표준](https://ko.wikipedia.org/wiki/분류:ISO_표준 "wikilink") [분류:MPEG](https://ko.wikipedia.org/wiki/분류:MPEG "wikilink") [분류:손실 압축 알고리즘](https://ko.wikipedia.org/wiki/분류:손실_압축_알고리즘 "wikilink") [분류:영상 압축](https://ko.wikipedia.org/wiki/분류:영상_압축 "wikilink")
