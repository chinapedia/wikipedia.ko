...
\[\operatorname H_1=\operatorname{Ann}_R(x)=\{r\in R\colon rx=0\}\] 이다 (\(\operatorname{Ann}\)은 [소멸자](https://ko.wikipedia.org/wiki/소멸자 "wikilink")).
...
[장루이 코쥘이](../Page/장루이_코쥘.md "wikilink") 1950년에 [리 대수 코호몰로지를](https://ko.wikipedia.org/wiki/리_대수_코호몰로지 "wikilink") 정의하기 위해 도입하였다.\[1\]
