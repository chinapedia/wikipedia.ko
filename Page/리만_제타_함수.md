...
[섬네일이](https://ko.wikipedia.org/wiki/파일:Complex_zeta.jpg "wikilink") 작으며, 옅을수록 [절댓값](https://ko.wikipedia.org/wiki/절댓값 "wikilink")이 크다. [색상](https://ko.wikipedia.org/wiki/색상 "wikilink")은 [편각을](https://ko.wikipedia.org/wiki/편각_\(수학\) "wikilink") 나타내며, 적색은 양의 실수, 연두색은 양의 허수, 옥색은 음의 실수, 남색은 음의 허수를 나타낸다.\]\]

[수론](https://ko.wikipedia.org/wiki/수론 "wikilink")에서, **리만 제타 함수**() \(\zeta(s)\)는 [소수들의](https://ko.wikipedia.org/wiki/소수_\(수론\) "wikilink") [정수론](https://ko.wikipedia.org/wiki/정수론 "wikilink")적 성질을 [해석적으로](https://ko.wikipedia.org/wiki/해석학_\(수학\) "wikilink") 내포하는 [유리형 함수이다](../Page/유리형_함수.md "wikilink"). [해석적 수론에서](https://ko.wikipedia.org/wiki/해석적_수론 "wikilink") [소수의](https://ko.wikipedia.org/wiki/소수_\(수론\) "wikilink") 분포를 연구할 때 핵심적인 역할을 하며, 또한 [L-함수](../Page/L-함수.md "wikilink") 이론의 모태이다.

## 정의

[섬네일](https://ko.wikipedia.org/wiki/파일:Zeta.svg "wikilink") 리만 제타 함수는 실수부가 1보다 큰 임의의 [복소수](https://ko.wikipedia.org/wiki/복소수 "wikilink") \(s (\in \mathbb C)\)에 대해, 다음과 같은 [디리클레 수열로](https://ko.wikipedia.org/wiki/디리클레_수열 "wikilink") 정의된다.

\[\zeta(s) = \sum_{n=1}^\infin \frac{1}{n^s}\] 이 [무한급수](https://ko.wikipedia.org/wiki/무한급수 "wikilink")는 \(\Re(s) > 1\)의 영역에서 수렴하고, 위 식은 [정칙함수](https://ko.wikipedia.org/wiki/정칙함수 "wikilink")를 정의한다. 리만은 제타 함수가 *s* ≠ 1인 모든 점에서 정의된 [유리형 함수로](../Page/유리형_함수.md "wikilink") 유일하게 [해석적 연속이](../Page/해석적_연속.md "wikilink") 가능하다는 것을 알았으며, [리만 가설에](https://ko.wikipedia.org/wiki/리만_가설 "wikilink") 등장하는 제타 함수는 확장된 리만 제타 함수를 뜻한다.
...
\[\zeta\left(\frac32\right) \approx 2.612;\] ; () [보스-아인슈타인 응축에서](https://ko.wikipedia.org/wiki/보스-아인슈타인_응축 "wikilink") 임계 온도를 계산하는데 사용된다.
...
[레온하르트 오일러는](https://ko.wikipedia.org/wiki/레온하르트_오일러 "wikilink") 리만 제타 함수가 [소수와](https://ko.wikipedia.org/wiki/소수_\(수론\) "wikilink") 다음과 같은 관계가 있다는 것을 알아냈다.

\[\zeta(s) = \prod_{p} \frac{1}{1-p^{-s}}\]

\[\zeta(s) \left(1-\frac 1{2^s}\right) \left(1-\frac 1{3^s}\right) \left(1-\frac 1{5^s}\right) \cdots =1\] 위와 같은 절차를 거쳐서 우변의 모든 소수의 배수를 없애주면 특정 합성수는 항상 소수의 곱으로써 나타낼 수 있다는 [산술의 기본 정리에](https://ko.wikipedia.org/wiki/산술의_기본_정리 "wikilink") 따라서 분모가 합성수 또는 소수인 수가 모두 사라지고 마지막에는 1만이 남는다. 즉
...
즉 리만 제타 함수는 모든 소수 \(p\)에 대해 위와 같은 무한 곱으로 나타낼 수 있다. 위 식은 [오일러의 곱셈 공식이라](../Page/오일러의_곱셈_공식.md "wikilink") 불리며, [등비급수](https://ko.wikipedia.org/wiki/등비급수 "wikilink")의 식과 [산술의 기본 정리로부터](https://ko.wikipedia.org/wiki/산술의_기본_정리 "wikilink") 유도해낼 수 있다.↵그 간단한 증명은 다음과 같다.
...
\[\{s\in\mathbb C\colon\operatorname{Re}s=1/2\}\] 임계 직선 위에는 무한히 많은 영점들이 존재한다는 사실이 알려져 있다. 현재까지 계산된 모든 비자명 영점들은 임계 직선 위에 존재하고 있지만, 모든 영점들이 실제로 임계 직선 위에 있는지 여부는 아직 증명되거나 반증되지 못했다. 이는 **[리만 가설](https://ko.wikipedia.org/wiki/리만_가설 "wikilink")**로 일컬어지는 문제로, 현대 수학의 주요 난제로 꼽힌다.

리만 제타 함수의 영점들은 [해석적 수론에서](https://ko.wikipedia.org/wiki/해석적_수론 "wikilink") [소수의](https://ko.wikipedia.org/wiki/소수_\(수론\) "wikilink") 분포에 대한 연구에 대해 매우 중요한 역할을 한다. 예를 들어, [소수 정리는](https://ko.wikipedia.org/wiki/소수_정리 "wikilink") 리만 제타 함수의 영점들에 대한 동치인 명제로 바뀌어 증명될 수 있다.
