...
**LU 감소**(LU reduction) 또는 **LU 감소 알고리즘**은 [LU 분해와](../Page/LU_분해.md "wikilink") 관련된 [알고리즘](https://ko.wikipedia.org/wiki/알고리즘 "wikilink")이다. 이 용어는 대개 [슈퍼 컴퓨터](https://ko.wikipedia.org/wiki/슈퍼_컴퓨터 "wikilink") 및 고도의 [병렬 컴퓨팅의](https://ko.wikipedia.org/wiki/병렬_컴퓨팅 "wikilink") 맥락에서 사용된다. 이는 [벤치마킹](https://ko.wikipedia.org/wiki/벤치마킹 "wikilink") 알고리즘으로도 사용된다. 즉, 서로 다른 컴퓨터의 속도를 비교 측정하는데 유용하다. LU 분해 알고리즘 예제는 Java Grande 2000 Special Issue(2001)에서 찾을 수 있다.\[1\]\[2\] 병렬화 된 버전은 일반적으로 [행렬](https://ko.wikipedia.org/wiki/행렬 "wikilink") 행에 대한 작업을 하위 노드의 단일 프로세서에 배포하고 결과를 메인 프로세서상에서 전체 행렬과 동기화한다.\[3\]

## 함께 보기

  - [LU 분해](../Page/LU_분해.md "wikilink")
  - [베오울프 클러스터](https://ko.wikipedia.org/wiki/베오울프_클러스터 "wikilink")
