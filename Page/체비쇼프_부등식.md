...
[확률론](https://ko.wikipedia.org/wiki/확률론 "wikilink")에서 [파프누티 체비쇼프의](../Page/파프누티_체비쇼프.md "wikilink") 이름을 딴 **체비쇼프 부등식**(**체비세프 부등식**, **체비쇼프 정리**, **비에나메-체비쇼프 부등식**이라고도 한다)은 [확률 분포에서](https://ko.wikipedia.org/wiki/확률_분포 "wikilink") 그 어떠한 데이터 샘플 혹은 확률 분포에서 거의 모든 값이 평균값 (mean value)에 근접하며 "거의 모든" 과 "근접하는"의 양적 설명을 제공한다.
...
[기댓값](../Page/기댓값.md "wikilink")이 μ이고 분산이 σ<sup>2</sup>인 [확률 변수](https://ko.wikipedia.org/wiki/확률_변수 "wikilink") *X*가 있다고 하자. (이때, 분산은 유한한 값이다) 그러면 어떠한 [실수](https://ko.wikipedia.org/wiki/실수 "wikilink") *k* \> 0에 대해서도 다음 부등식이 성립한다.
