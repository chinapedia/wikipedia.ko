...
깔끔 URL과 그렇지 않은 URL을 비교해보면 다음과 같다.
...
깔끔 URL은 주로 검색 엔진에 최적화하기 위해 사용된다. 그러면서도 사용성과 접근성도 높아진다. 불필요한 부분이 제거되어 URL을 입력하거나 기억하기 쉽게 된다.
...
## 같이 보기
  ...
  - [다시쓰기 엔진](https://ko.wikipedia.org/wiki/다시쓰기_엔진 "wikilink")(rewrite engine)
  - [URL 단축](https://ko.wikipedia.org/wiki/URL_단축 "wikilink")

[분류:URL](https://ko.wikipedia.org/wiki/분류:URL "wikilink") [분류:검색 엔진 최적화](https://ko.wikipedia.org/wiki/분류:검색_엔진_최적화 "wikilink")