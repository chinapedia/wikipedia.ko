...
`   if not map then`
`       error('사용할 위치지도 정의의 이름을 지정해야 합니다', 2)`
`   end`
...
`           error('레거시 위치 지도를 사용할 때에는 프레임을 지정해야 합니다')`
`       end`
`       return function(name, params)`
`           if params then`
...
`       end`
`   else`
`       error('지정된 위치 지도 정의를 찾을 수 없습니다. "Module:Location map/data/' .. map .. '" 또는 "틀:위치 지도 ' .. map .. '"이(가) 존재하지 않습니다', 2)`
`   end`
...
\-- Finds a parameter in a transclusion of . local function coord2text(para,coord) -- this should be changed for languages which do not use Arabic numerals or the degree sign

`   local result = mw.text.split(mw.ustring.match(coord,'%-?[%.%d]+°[NS] %-?[%.%d]+°[EW]') or '', '[ °]')`
`   if para == 'longitude' then result = {result[3], result[4]} end`
`   if not tonumber(result[1]) or not result[2] then return error('잘못 만들어진 좌표값', 2) end`
...
<div style="position:relative;width:' .. width .. 'px' .. (args.border ~= 'none' and ';border:1px solid lightgray">
...
`       '%s`[`%spx`](https://ko.wikipedia.org/wiki/File:%s "fig:%spx")`',`
`       retval,`
`       image,`
`       width,`
...
[' .. width .. 'px](https://ko.wikipedia.org/wiki/File:'_.._args.overlay_image_.._' "fig:' .. width .. 'px")
...
[File:'_.._getContainerImage(args,_map)_.._'](https://ko.wikipedia.org/wiki/:File:'_.._getContainerImage\(args,_map\)_.._' "wikilink")
...
`           '`[`%dx%dpx`](https://ko.wikipedia.org/wiki/File:%s "fig:%dx%dpx")`',`
`           mark,`
`           marksize,`
`           marksize,`
`           label,`
...
\-- Temporarily removed to facilitate infobox conversion. See [Wikipedia:Coordinates in infoboxes](https://ko.wikipedia.org/wiki/Wikipedia:Coordinates_in_infoboxes "wikilink")

\-- if longitude or latitude then -- error('Coordinates from [Module:Coordinates](https://ko.wikipedia.org/wiki/Module:Coordinates "wikilink") and individual coordinates cannot both be provided') -- end
...
[Category:Pages_using_location_map_with_a_double_number_sign_in_the_caption](https://ko.wikipedia.org/wiki/Category:Pages_using_location_map_with_a_double_number_sign_in_the_caption "wikilink") [Category:Location_maps_with_removed_parameters](https://ko.wikipedia.org/wiki/Category:Location_maps_with_removed_parameters "wikilink") [Category:Location_maps_with_removed_parameters](https://ko.wikipedia.org/wiki/Category:Location_maps_with_removed_parameters "wikilink") [Category:Location_maps_with_a_name_containing_a_pipe](https://ko.wikipedia.org/wiki/Category:Location_maps_with_a_name_containing_a_pipe "wikilink") [Category:Location_maps_with_different_longitude_and_latitude_precisions](https://ko.wikipedia.org/wiki/Category:Location_maps_with_different_longitude_and_latitude_precisions "wikilink") [Category:Location_maps_with_different_longitude_and_latitude_precisions](https://ko.wikipedia.org/wiki/Category:Location_maps_with_different_longitude_and_latitude_precisions "wikilink") [Category:Location_maps_with_different_longitude_and_latitude_precisions](https://ko.wikipedia.org/wiki/Category:Location_maps_with_different_longitude_and_latitude_precisions "wikilink") [Category:Location_maps_with_different_longitude_and_latitude_precisions](https://ko.wikipedia.org/wiki/Category:Location_maps_with_different_longitude_and_latitude_precisions "wikilink") [Category:Location_maps_with_different_longitude_and_latitude_precisions](https://ko.wikipedia.org/wiki/Category:Location_maps_with_different_longitude_and_latitude_precisions "wikilink") [Category:Location_maps_with_removed_parameters](https://ko.wikipedia.org/wiki/Category:Location_maps_with_removed_parameters "wikilink") [Category:Location_maps_with_marks_outside_map_and_outside_parameter_not_set](https://ko.wikipedia.org/wiki/Category:Location_maps_with_marks_outside_map_and_outside_parameter_not_set "wikilink")