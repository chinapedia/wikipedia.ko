...
[thumb](https://ko.wikipedia.org/wiki/파일:DTL_NAND_Gate.svg "wikilink") **다이오드–트랜지스터 논리** (Diode–transistor logic, **DTL**)는 [접합형 트랜지스터](https://ko.wikipedia.org/wiki/접합형_트랜지스터 "wikilink") (BJT), [다이오드](https://ko.wikipedia.org/wiki/다이오드 "wikilink")와 [저항기](https://ko.wikipedia.org/wiki/저항기 "wikilink")로 구성된 [디지털 회로의](../Page/디지털_회로.md "wikilink") 한 종류이다; 다이오드-트랜지스터 논리는 [트랜지스터-트랜지스터 논리의](../Page/트랜지스터-트랜지스터_논리.md "wikilink") 바로 이전 모델이다. 논리 게이트 기능 (예로 논리곱)은 다이오드 회로망으로 구현하고 증폭 기능은 트랜지스터로 구현하기 때문에 *다이오드-트랜지스터 논리*라고 불린다.
