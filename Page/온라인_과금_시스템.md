...
이벤트 기반의 과금 기능(Event Based Charging Function, EBCF)은 이벤트 안에서 사용된 시간이나 볼륨보다 발생에 기반한 이벤트를 과금하는데 사용된다. 일반적인 이벤트로는 SMS, MMS, 콘텐츠 구매 (응용 프로그램, 게임, 음악, [주문형 비디오](https://ko.wikipedia.org/wiki/주문형_비디오 "wikilink") 등)가 있다.
