...
을 사용함으로서 여러 방식의 실제 메모리 할당 매커니즘을 실행할 수 있다. 퍼포먼스 방식에 따라 실행 시간이나 필요한 메모리 공간 또한 다양하다.

## 각주

<references />

[분류:메모리 관리](https://ko.wikipedia.org/wiki/분류:메모리_관리 "wikilink") [분류:C 표준 라이브러리](https://ko.wikipedia.org/wiki/분류:C_표준_라이브러리 "wikilink")
