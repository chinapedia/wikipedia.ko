...
[논리학](https://ko.wikipedia.org/wiki/논리학 "wikilink")에선, [CNF](https://ko.wikipedia.org/wiki/CNF "wikilink")를 결정하는 절차를 재작성을 통해 표현할 수 있다.
...
\[(A \land B) \lor C \to (A \lor C) \land (B \lor C)\] ([분배법칙](https://ko.wikipedia.org/wiki/분배법칙 "wikilink"))
