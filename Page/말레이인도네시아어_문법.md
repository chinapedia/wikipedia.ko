...
마인어의 수 체계는 [십진법](../Page/십진법.md "wikilink")을 따라서 규칙적으로 열 자리씩 끊는다. 이때 기본 수사에서 앞에 붙은 '1'을 의미하는 'se-' 등은 자릿수가 1이 아니라면 뗀다.('se-'는 1000까지만 자릿수가 1일 때 붙여 준다) 예외적으로 11부터 19까지는 1부터 9까지의 수 뒤에 'belas'를 붙여서 만든다.(예로 lima belas = 15. 11은 'sebelas'로 붙인다)
