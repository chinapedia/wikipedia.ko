...
[섬네일](https://ko.wikipedia.org/wiki/파일:Dedekind_Eta.jpg "wikilink") [수학](https://ko.wikipedia.org/wiki/수학 "wikilink")에서, **데데킨트 에타 함수**()은 [복소평면](../Page/복소평면.md "wikilink")의 열린 [상반평면](https://ko.wikipedia.org/wiki/상반평면 "wikilink") 위에 정의된, [원환면의](https://ko.wikipedia.org/wiki/원환체 "wikilink") [모듈러 군](https://ko.wikipedia.org/wiki/모듈러_군 "wikilink") 대칭을 따르는 [정칙함수](https://ko.wikipedia.org/wiki/정칙함수 "wikilink")다. [리하르트 데데킨트의](https://ko.wikipedia.org/wiki/리하르트_데데킨트 "wikilink") 이름을 땄다. 기호는 그리스 소문자 에타\(\;\; \eta(\tau)\)
...
데데킨트 에타 함수는 열린 상반평면 위에서 [정칙함수](https://ko.wikipedia.org/wiki/정칙함수 "wikilink")이나, 복소 평면 전체로 [해석적 연속할](https://ko.wikipedia.org/wiki/해석적_연속 "wikilink") 수 없다.

### 함수 방정식

데데킨트 에타 함수는 무게(weight)가 ½이고 준위(level)가 1인 [모듈러 형식이다](../Page/모듈러_형식.md "wikilink"). 즉, [모듈러 군](https://ko.wikipedia.org/wiki/모듈러_군 "wikilink") \(\Gamma_0(1)\)에 대하여 무게 ½로 변환한다. 즉, 데데킨트 에타 함수는 구체적으로 다음과 같은 항등식을 만족한다.\[1\]
...
여기서 \(\Gamma(1/4)\approx3.626\)는 [감마 함수이다](https://ko.wikipedia.org/wiki/감마_함수 "wikilink").
