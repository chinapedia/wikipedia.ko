...
**조합관측법**(angle measurement in all combination)은 수평각 관측법 중 가장 정밀한 방법이다. 1등 [삼각측량](https://ko.wikipedia.org/wiki/삼각측량 "wikilink")에 쓰인다. 간단히 말해 방향각법을 여러번 사용하는 것이다. [최확값](https://ko.wikipedia.org/wiki/최확값 "wikilink")은 [최소제곱법](https://ko.wikipedia.org/wiki/최소제곱법 "wikilink")으로 구한다.
...
## 같이 보기
  ...
  - [측정](https://ko.wikipedia.org/wiki/측정 "wikilink")
  ...
  - [거리측량](https://ko.wikipedia.org/wiki/거리측량 "wikilink")
