...
**netstat**(***net**work **stat**istics*)는 [전송 제어 프로토콜](https://ko.wikipedia.org/wiki/전송_제어_프로토콜 "wikilink"), [라우팅 테이블](https://ko.wikipedia.org/wiki/라우팅_테이블 "wikilink"), 수많은 네트워크 인터페이스([네트워크 인터페이스 컨트롤러](https://ko.wikipedia.org/wiki/네트워크_인터페이스_컨트롤러 "wikilink") 또는 [소프트웨어 정의 네트워크 인터페이스](https://ko.wikipedia.org/wiki/가상_네트워크_인터페이스 "wikilink")), 네트워크 프로토콜 통계를 위한 네트워크 연결을 보여주는 명령 줄 도구이다. [OS X](https://ko.wikipedia.org/wiki/OS_X "wikilink"), [리눅스](https://ko.wikipedia.org/wiki/리눅스 "wikilink"), [솔라리스](https://ko.wikipedia.org/wiki/솔라리스_\(운영_체제\) "wikilink"), [BSD](https://ko.wikipedia.org/wiki/BSD "wikilink")를 포함한 [유닉스 계열](https://ko.wikipedia.org/wiki/유닉스_계열 "wikilink") [운영 체제와](https://ko.wikipedia.org/wiki/운영_체제 "wikilink") [윈도우 XP](https://ko.wikipedia.org/wiki/윈도우_XP "wikilink"), [윈도우 비스타](https://ko.wikipedia.org/wiki/윈도우_비스타 "wikilink"), [윈도우 7](https://ko.wikipedia.org/wiki/윈도우_7 "wikilink"), [윈도우 8](https://ko.wikipedia.org/wiki/윈도우_8 "wikilink"), [윈도우 10을](../Page/윈도우_10.md "wikilink") 포함한 [윈도우 NT](https://ko.wikipedia.org/wiki/윈도우_NT "wikilink") 기반 운영 체제에서 이용이 가능하다.
