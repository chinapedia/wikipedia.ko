...
Stata는 [통계학](https://ko.wikipedia.org/wiki/통계학 "wikilink")의 전 분야에서 사용될 수 있도록 만들어졌으며, 이것이 단지 통계 패키지가 아닌 통계적 능력을 갖춘 완전한 데이터 관리 시스템으로서 다음과 같은 장점을 바탕으로 현재 129개국에서 사용 중에 있다.
