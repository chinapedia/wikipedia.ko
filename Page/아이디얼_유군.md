...
[대수적 수론과](../Page/대수적_수론.md "wikilink") [가환대수학](../Page/가환대수학.md "wikilink")에서, **아이디얼 유군**(ideal類群, ) 또는 **유군**(類群, )은 [데데킨트 정역에서](../Page/데데킨트_정역.md "wikilink") 유일 인수 분해가 실패하는 정도를 측정하는 [아벨 군이다](https://ko.wikipedia.org/wiki/아벨_군 "wikilink"). 아이디얼 유군이 [자명군](https://ko.wikipedia.org/wiki/자명군 "wikilink")이 아니라면 유일 인수 분해가 성립하지 않는다.
...
\(R\)의 [분수체](../Page/분수체.md "wikilink") \(\operatorname{Frac}R\)가 [형식적 실체라고](../Page/형식적_실체.md "wikilink") 하자. \(R\)의 원소 \(r\in R\) 가운데 다음 조건을 만족시키는 것을 **완전히 양의 원소**()라고 한다.
  ...
  - 임의의 [순서체](https://ko.wikipedia.org/wiki/순서체 "wikilink") \((K,\le)\)로의 매장 \(\iota\colon\operatorname{Frac}R\hookrightarrow K\)에 대하여, \(\iota(r)>0\)이다.

그렇다면, 다음과 같은 추가 [아벨 군을](https://ko.wikipedia.org/wiki/아벨_군 "wikilink") 정의할 수 있다.

  - \(R\)의 완전히 양의 주 분수 아이디얼()의 [아벨 군](https://ko.wikipedia.org/wiki/아벨_군 "wikilink") \(\operatorname{PrFracIdeal}_+(K)\subseteq\operatorname{PrFracIdeal}(K)^\times\). 이는 완전히 양의 원소로 생성되는 주 아이디얼들의 곱셈에 대한 [아벨 군이다](https://ko.wikipedia.org/wiki/아벨_군 "wikilink").
...
[대수적 수체의](https://ko.wikipedia.org/wiki/대수적_수체 "wikilink") [대수적 정수환의](https://ko.wikipedia.org/wiki/대수적_정수환 "wikilink") 아이디얼 유군은 유한 [아벨 군이다](https://ko.wikipedia.org/wiki/아벨_군 "wikilink"). (대수적 정수환이 아닌 [데데킨트 정역의](../Page/데데킨트_정역.md "wikilink") 경우, 아이디얼 유군이 무한 아벨 군일 수 있다.)

아이디얼 유군은 [데데킨트 정역에서](../Page/데데킨트_정역.md "wikilink") [유일 인수 분해가](https://ko.wikipedia.org/wiki/유일_인수_분해_정역 "wikilink") 실패하는 정도를 측정한다. 즉, [데데킨트 정역](../Page/데데킨트_정역.md "wikilink") \(R\)의 경우, 다음 조건들이 서로 [동치](../Page/동치.md "wikilink")이다.
...
[제곱 인수가 없는 정수](../Page/제곱_인수가_없는_정수.md "wikilink") \(d<0\)에 대하여, 다음 두 [집합](https://ko.wikipedia.org/wiki/집합 "wikilink") 사이의 표준적인 [전단사 함수가](https://ko.wikipedia.org/wiki/전단사_함수 "wikilink") 존재한다.
...
따라서, 이 경우 정수 계수 2항 [이차 형식들의](../Page/이차_형식.md "wikilink") 집합은 자연스럽게 [아벨 군의](https://ko.wikipedia.org/wiki/아벨_군 "wikilink") 구조를 가진다.
...
\[\operatorname N(\mathfrak a/r)=\frac{|\mathcal O_{\mathbb Q(\sqrt d)}/\mathfrak a|}{|\operatorname N_{\mathbb Q(\sqrt d)/\mathbb Q}(r)|}\in\mathbb Q^+\qquad(\mathfrak a\subseteq R,\;r\in R)\] (여기서 분자는 [몫환](https://ko.wikipedia.org/wiki/몫환 "wikilink")의 [크기이며](https://ko.wikipedia.org/wiki/집합의_크기 "wikilink"), 분모는 [체 노름의](https://ko.wikipedia.org/wiki/체_노름 "wikilink") [절댓값](https://ko.wikipedia.org/wiki/절댓값 "wikilink")이다.)
...
이 수들을 [헤그너 수라고](../Page/헤그너_수.md "wikilink") 한다. 이들은 [카를 프리드리히 가우스가](https://ko.wikipedia.org/wiki/카를_프리드리히_가우스 "wikilink") 처음 나열하였고, [쿠르트 헤그너](../Page/쿠르트_헤그너.md "wikilink")(Kurt Heegner)가 이 목록이 전부라는 것을 증명하였다.
...
## 같이 보기
  ...
  - [피카르 군](../Page/피카르_군.md "wikilink"): [대수기하학](https://ko.wikipedia.org/wiki/대수기하학 "wikilink")에 나타나는 유군의 일반화
