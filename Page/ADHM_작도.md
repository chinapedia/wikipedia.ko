...
SU(*N*) [양-밀스 이론에서](../Page/양-밀스_이론.md "wikilink"), 순간자수가 \(k\)인 상태를 작도한다고 하자. 그렇다면 **ADHM 작도**는 다음과 같은 데이터로 주어진다.
...
\[W_{\dot\alpha}(W_{\dot\beta})^\dagger=iC\epsilon_{\dot\alpha\dot\beta}+i\epsilon^{\alpha\beta}X_{\alpha\dot\alpha}(X_{\beta\dot\beta})^\dagger\] 여기서 \(C\in\mathfrak{u}(k)\)는 임의의 \(k\times k\) [에르미트 행렬이다](../Page/에르미트_행렬.md "wikilink").
...
\[x_{\alpha\dot\alpha}=x_\mu \sigma^\mu_{\alpha\dot\alpha}\] 로 적을 수 있다. 여기서 \(\sigma^\mu\)는 [파울리 행렬이다](../Page/파울리_행렬.md "wikilink").
...
\[U^\dagger(x)U(x)=I_{N\times N}\] 그렇다면 [순간자](../Page/순간자.md "wikilink") [게이지 퍼텐셜](https://ko.wikipedia.org/wiki/게이지_퍼텐셜 "wikilink") \(A_\mu\)는 다음과 같다.
...
ADHM 작도는 [끈 이론으로](../Page/끈_이론.md "wikilink") 자연스럽게 해석할 수 있다.\[1\] 이 경우, *N*개의 겹친 [D3-막에](../Page/D-막.md "wikilink") 녹아 있는 *k*개의 [D(−1)-막들을](../Page/D-막.md "wikilink") 고려한다. 이 경우 D(−1)-막에 존재하는 \(\mathcal N=2\) (16개 초전하) [초대칭 게이지 이론을](../Page/초대칭_게이지_이론.md "wikilink") 고려한다. 이 게이지 이론은 쿨롱 상과 힉스 상 두 가지의 [상이](../Page/상_\(물리학\).md "wikilink") 존재한다.

  - 쿨롱 상에서는 D(−1)-막들이 D3-막에서 분리돼 각각 자유롭게 움직인다.
  - 힉스 상에서는 D(−1)-막들이 D3-막 속에 녹아, D3-막 위에 존재하는 [초대칭 게이지 이론의](../Page/초대칭_게이지_이론.md "wikilink") [순간자](../Page/순간자.md "wikilink")를 이룬다.
...
| \(W_{\dot\alpha}\) |                   | D3-막과 D(−1)-막을 잇는 [끈으로](../Page/끈_\(물리학\).md "wikilink") 발생하는 스칼라장                      |
| \(X_\mu\)          |                   | D(−1)-막의 (비가환) 위치                                                                       |
|                    | 순간자 모듈러스 공간       | D(−1)-막 세계부피 이론의 힉스 가지 [모듈러스 공간](https://ko.wikipedia.org/wiki/모듈러스_\(물리학\) "wikilink") |

## 역사

[마이클 아티야](../Page/마이클_아티야.md "wikilink"), [블라디미르 드린펠트](../Page/블라디미르_드린펠트.md "wikilink"), [나이절 히친](../Page/나이절_히친.md "wikilink"), [유리 마닌이](../Page/유리_마닌.md "wikilink") 발표하였다.\[2\] 이름은 발견자들의 성의 머릿자를 딴 것이다.
