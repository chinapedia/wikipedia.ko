...
**Xshell**은 [(주)넷사랑컴퓨터의](https://ko.wikipedia.org/wiki/넷사랑컴퓨터 "wikilink") [SSH](https://ko.wikipedia.org/wiki/SSH "wikilink"), [텔넷](https://ko.wikipedia.org/wiki/텔넷 "wikilink"), [Rlogin](../Page/Rlogin.md "wikilink")을 위한 [단말 에뮬레이터](https://ko.wikipedia.org/wiki/단말_에뮬레이터 "wikilink") [클라이언트](https://ko.wikipedia.org/wiki/클라이언트 "wikilink")이다.\[1\]\[2\] 호스트별로 개별 세션 파일을 만들 수 있으며 세션별 보기 방식을 탭 형식으로 제공하여 동시간의 호스트 운영 및 관리에 용이한 특성이 있다.
...
Xshell은 사유 소프트웨어로서 개인 사용자에 한해 무료이며 기업은 유료 라이선스가 필요하다. Xshell 단일 라이선스 및 Xmanager, [Xftp](https://ko.wikipedia.org/wiki/Xftp "wikilink"), Xlpd가 포함된 기업용 엔터프라이즈 라이선스가 있다.\[3\]
...
기능은 다음과 같다.\[5\]
  ...
  - 터미널 다중 세션 동시 키 입력
  - 스크립트 지원 ([VB](https://ko.wikipedia.org/wiki/VB "wikilink"), [Javascript](https://ko.wikipedia.org/wiki/Javascript "wikilink"), [Python](https://ko.wikipedia.org/wiki/Python "wikilink"))
  - 사용자 키 및 호스트 키 관리
  - [Zmodem](https://ko.wikipedia.org/wiki/ZMODEM "wikilink"), [Xmodem](https://ko.wikipedia.org/wiki/XMODEM "wikilink"), [Ymodem](https://ko.wikipedia.org/wiki/YMODEM "wikilink"), [SFTP](https://ko.wikipedia.org/wiki/SFTP "wikilink") 등의 파일 전송 유틸리티
  - Xftp 및 Xmanager 와의 연동
  - [X11](https://ko.wikipedia.org/wiki/X_윈도_시스템 "wikilink") 포워딩
  - SOCKS 4/5 프록시
  - SSH 터널링
  - 터미널 하이라이트 편집
  - 작성 창, 빠른 명령 창
...
## 보안
  ...
  - GSSAPI ([MIT Kerberos](https://ko.wikipedia.org/wiki/커베로스 "wikilink"), Microsoft SSPI)
  - SSH PKCS 11 인증
