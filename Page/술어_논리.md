...
**술어 논리**(述語論理, ) 또는 **함수 논리**(函數論理) 또는 **양화 논리**(量化論理)는 명제에 존재하는 '주어'와 '술어'의 구조로부터 '주어'가 될 수 있는 대상에 대해 한정 기호를 사용하는 논리이다. 따라서 [명제 논리와는](../Page/명제_논리.md "wikilink") 달리 명제의 내부 구조 분석에 의한 [추론 규칙을](../Page/추론_규칙.md "wikilink") 다룰수있다.
