...
**술어 논리**(述語論理, ) 또는 **함수 논리**(函數論理) 또는 **양화 논리**(量化論理)는 명제에 존재하는 '주어'와 '술어'의 구조로부터 '주어'가 될 수 있는 대상에 대해 한정 기호를 사용하는 논리이다. 따라서 [명제 논리와는](https://ko.wikipedia.org/wiki/명제_논리 "wikilink") 달리 명제의 내부 구조 분석에 의한 [추론 규칙을](https://ko.wikipedia.org/wiki/추론_규칙 "wikilink") 다룰수있다.

[1차 논리](../Page/1차_논리.md "wikilink") · [2차 논리](../Page/2차_논리.md "wikilink") · [고차 논리](https://ko.wikipedia.org/wiki/고차_논리 "wikilink") 따위가 있으며, 특히 수학의 기초를 이루는 1차 논리에서는 [완전성](https://ko.wikipedia.org/wiki/완전성 "wikilink"), [건전성](https://ko.wikipedia.org/wiki/건전성 "wikilink")과 같은 여러 주요한 성질들이 성립한다.

술어 논리는 유럽의 [고틀로프 프레게와](https://ko.wikipedia.org/wiki/고틀로프_프레게 "wikilink") 미국의 [찰스 샌더스 퍼스에](https://ko.wikipedia.org/wiki/찰스_샌더스_퍼스 "wikilink") 의해 각각 독자적으로 창안되었다. 프레게의 초기 술어 논리는 여러 논리학자들에게 큰 영향을 주어 이후 20세기에 철저한 논리주의의 발전 속에 술어 계산(predicate calculus)으로서 형식화되었다.
...
## 같이 보기
  ...
  - [명제 논리](https://ko.wikipedia.org/wiki/명제_논리 "wikilink")
