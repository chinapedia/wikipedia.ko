...
**다이렉트3D**()는 [마이크로소프트](../Page/마이크로소프트.md "wikilink")의 [DirectX](../Page/DirectX.md "wikilink") [API](../Page/API.md "wikilink")에서 [3차원 그래픽스](../Page/3차원_컴퓨터_그래픽스.md "wikilink") 연산과 출력을 담당하는 부분이다. 마이크로소프트의 [윈도](https://ko.wikipedia.org/wiki/마이크로소프트_윈도 "wikilink") 운영 체제([윈도 95](https://ko.wikipedia.org/wiki/윈도_95 "wikilink") 이상)에서만 작동하며, [엑스박스](../Page/엑스박스.md "wikilink")와 [엑스박스 360](../Page/엑스박스_360.md "wikilink") 게임 콘솔의 그래픽 API로 사용되고 있다. 다이렉트3D와 비슷한 역할을 하는 API로는 [OpenGL](../Page/OpenGL.md "wikilink")이 있으며 역할은 같지만 각자가 서로 다른 장단점을 가지고 있다.

## 역사

[1992년](../Page/1992년.md "wikilink") 렌더모픽스(RenderMorphics)라는 회사에서 리얼리티 랩(Reality Lab)이라는 3차원 그래픽스 [API](../Page/API.md "wikilink")를 만들기 시작했다. [1995년](../Page/1995년.md "wikilink") 2월에 [마이크로소프트](../Page/마이크로소프트.md "wikilink")는 [윈도 95에](https://ko.wikipedia.org/wiki/윈도_95 "wikilink") 쓰일 3차원 그래픽스 API를 위하여 렌더모픽스 사를 인수했고, DirectX의 2.0 버전에서 처음 다이렉트3D가 도입되었다.
...
Direct3D 6.0 버전에서는 당시 최신 하드웨어를 지원할 수 있도록 많은 기능이 추가되었다. x86, [SSE](../Page/스트리밍_SIMD_확장.md "wikilink"), [3DNow](https://ko.wikipedia.org/wiki/3DNow "wikilink")를 위해 지오메트리 파이프라인이 최적화되었고, 간단한 [텍스처](https://ko.wikipedia.org/wiki/텍스처 "wikilink") 관리 기능이 추가되었으며, [범프 매핑](../Page/범프_매핑.md "wikilink") 등과 같은 고급 그래픽 효과를 사용할 수 있게 되었다.
...
Direct3D 8에서는 [다이렉트드로](../Page/다이렉트드로.md "wikilink")를 독립적인 API로 분리시켰다. [버텍스 셰이더와](https://ko.wikipedia.org/wiki/버텍스_셰이더 "wikilink") [픽셀 셰이더가](../Page/픽셀_셰이더.md "wikilink") 지원되기 시작하였으며, 셰이더를 프로그래머가 직접 프로그래밍할 수 있게 되었지만 정해진 가이드라인이 없어서 그래픽 하드웨어 제조사가 제공하는 셰이딩 어셈블리어를 통해 구현해야 하는 단점이 있다.

Direct3D 9에서는 C언어와 유사한 모습의 고수준 셰이더 언어(HLSL)를 통해 가이드라인을 지원하기 시작하였다. 이로 인해서 [HDR](../Page/하이_다이내믹_레인지_렌더링.md "wikilink"), 정점 버퍼 인덱싱과 같은 기능을 사용할 수 있게 되었다.
...
다이렉트3D는 다음의 두 가지 화면 방식을 제공한다:
  ...
  - **창 모드**: 결과물은 창 영역 안 쪽에 보인다. 다이렉트3D는 [GDI와](../Page/그래픽_장치_인터페이스.md "wikilink") 데이터를 주고 받으며 디스플레이의 그래픽 출력을 만들어 낸다. 드라이버 지원에 따라 창 모드는 전체 화면과 동일하게 수행할 수 있다.
...
4.  **스트림 출력**
5.  **레스터라이저**
6.  **[픽셀 셰이더](../Page/픽셀_셰이더.md "wikilink")**
7.  **출력 병합**
