> This article is converted from Wikipedia: [BSD](https://ko.wikipedia.org/wiki/BSD).


[섬네일](https://ko.wikipedia.org/wiki/파일:Unix_timeline.ko.png "wikilink") **BSD**()는 1977년부터 1995년까지 [미국](../Page/미국.md "wikilink") [캘리포니아 대학교 버클리](../Page/캘리포니아_대학교_버클리.md "wikilink")()의 [CSRG](https://ko.wikipedia.org/wiki/CSRG "wikilink")(Computer Systems Research Group)에서 개발한 [유닉스](../Page/유닉스.md "wikilink") [운영 체제이다](../Page/운영_체제.md "wikilink"). 오늘날 BSD라는 용어는 [유닉스 계열](../Page/유닉스_계열.md "wikilink") 운영 체제 계열에서 분기되어 형성된 BSD 파생판을 두루 가리키는 용어로 자리잡혀 있다. 오리지널 BSD 코드로부터 파생된 운영 체제들은 현재까지도 활발히 개발되고 널리 사용되고 있다.
...
1970년대 벨 연구소의 유닉스 초기 배포판들은 운영 체제에 대한 소스 코드를 포함했으며 대학교의 연구원들이 유닉스를 수정하고 확장할 수 있게 했다. 버클리의 최초의 유닉스 시스템은 1974년 설치된 [PDP-11](../Page/PDP-11.md "wikilink")이며 [컴퓨터 과학부는](../Page/컴퓨터_과학.md "wikilink") 그 뒤 대형의 연구를 위해 이를 사용하였다.
...
### 4.3BSD
  ...
  - 4.3BSD는 1986년 6월 출시되었다. 4.2BS의 새로운 기여분들 가운데 상당수 성능이 개선된 것이 주요 변경 사항이다. 이전 판들과 달리 BSD의 TCP/IP 구현은 BBN의 공식 구현과 상당히 다르다.
  - 4.3BSD-Reno는 1990년 초에 출시되었다. 4.4BSD의 초기 개발 동안의 중간 릴리즈이다.

### 4.4BSD 및 파생

  - 1994년 6월 4.4BSD가 두 가지 형태로 출시되었다.: 4.4BSD-Lite (AT\&T 소스 미포함), 4.4BSD-Encumbered (AT\&T 라이선스에만 적용)
  - 4.4BSD-Lite 릴리즈 2 (버클리판)

애플의 [OS X의](https://ko.wikipedia.org/wiki/OS_X "wikilink") 기반이 되는 [다윈](../Page/다윈_\(운영_체제\).md "wikilink") 시스템은 4.4BSD-Lite2와 FreeBSD의 파생이다. [솔라리스와](../Page/솔라리스_\(운영_체제\).md "wikilink") 같은 다양한 상용 유닉스 운영 체제들은 상당한 양의 BSD 코드를 포함하고 있다.

## 주요 BSD 파생 운영 체제들

  - [FreeBSD](../Page/FreeBSD.md "wikilink")
      - [애플 다윈](https://ko.wikipedia.org/wiki/애플_다윈 "wikilink")
      - [TrueOS](../Page/TrueOS.md "wikilink")(구 [PC-BSD](https://ko.wikipedia.org/wiki/PC-BSD "wikilink"))
...
## 같이 보기
  ...
  - [BSD 데몬](../Page/BSD_데몬.md "wikilink")
  - [BSD 사용 허가서](https://ko.wikipedia.org/wiki/BSD_사용_허가서 "wikilink")
