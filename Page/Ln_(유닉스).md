...
**`ln`** 명령어는 기존 파일에 대한 [하드 링크나](../Page/하드_링크.md "wikilink") [심볼릭 링크를](../Page/심볼릭_링크.md "wikilink") 생성하기 위해 사용되는 표준 [유닉스 명령](../Page/유닉스_명령어_목록.md "wikilink") 유틸리티이다.\[1\] 하드 링크를 사용하면 여러 개의 [파일 이름을](https://ko.wikipedia.org/wiki/파일_이름 "wikilink") 동일한 [파일에](https://ko.wikipedia.org/wiki/컴퓨터_파일 "wikilink") 연결할 수 있으며, 하드 링크는 지정된 파일의 [아이노드](https://ko.wikipedia.org/wiki/아이노드 "wikilink")를 가리키게 되며 데이터는 [디스크에](https://ko.wikipedia.org/wiki/하드_디스크_드라이브 "wikilink") 저장된다. 한편, 심볼릭 링크는 [이름을](https://ko.wikipedia.org/wiki/파일_이름 "wikilink") 통해 다른 파일들을 가리키는 특수한 파일들이다.\[2\]

`ln` 명령어는 기본적으로 하드 링크를 생성하며 [명령 줄](https://ko.wikipedia.org/wiki/명령_줄_인터페이스 "wikilink") [변수](https://ko.wikipedia.org/wiki/명령_줄_인터페이스 "wikilink") `ln '-s'`로 호출할 때 심볼릭 링크를 생성한다.\[3\] 대부분의 [운영 체제는](https://ko.wikipedia.org/wiki/운영_체제 "wikilink") [디렉터리](https://ko.wikipedia.org/wiki/디렉터리 "wikilink")에 대한 하드 링크 생성을 금지하는데, 이러한 기능은 [파일 시스템의](https://ko.wikipedia.org/wiki/파일_시스템 "wikilink") 구조를 파괴하여 다른 유틸리티의 동작에 간섭을 줄 수 있기 때문이다.\[4\] 그러나 `ln` 명령어는 기존에 존재하지 않는 파일에 대한 심볼릭 링크를 생성하기 위해 사용할 수 있다.\[5\]

## 사양

[단일 유닉스 규격을](https://ko.wikipedia.org/wiki/단일_유닉스_규격 "wikilink") 준수하는 시스템 상의 `ln` 유틸리티는 SUS의 일부를 형성하는 셸과 유틸리티(XCU) 문서에 명시되어 있다.\[6\]\[7\]
