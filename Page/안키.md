...
**안키**(Anki)는 [간격 반복](https://ko.wikipedia.org/wiki/간격_반복 "wikilink") 이론에 기초한 지능형 [플래시카드](https://ko.wikipedia.org/wiki/플래시카드 "wikilink") 암기 프로그램이다. Damien Elmes에 의해 제작되었다.
...
이 [알고리즘](https://ko.wikipedia.org/wiki/알고리즘 "wikilink")의 안키 구현체는 카드에 대한 우선 순위 조정을 허용하고 긴급한 순서에 따라 카드를 보여줄 수 있도록 수정되었다.
...
카드들은 [HTML](https://ko.wikipedia.org/wiki/HTML "wikilink")을 이용하여 표현되며, 텍스트, 그림, 소리, 비디오,\[4\] [LaTeX](https://ko.wikipedia.org/wiki/LaTeX "wikilink") 등식을 포함할 수 있다. 사용자 통계와 더불어 카드의 데크들은 오픈 [SQLite](https://ko.wikipedia.org/wiki/SQLite "wikilink") 포맷으로 저장된다.
