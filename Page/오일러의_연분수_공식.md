...
**오일러의 연분수 공식**(-連分數 公式, Euler's continued fraction formula)은 [스위스](https://ko.wikipedia.org/wiki/스위스 "wikilink")의 [수학자](https://ko.wikipedia.org/wiki/수학자 "wikilink") [레온하르트 오일러의](https://ko.wikipedia.org/wiki/레온하르트_오일러 "wikilink") 이름이 붙은 [해석학의](https://ko.wikipedia.org/wiki/해석학_\(수학\) "wikilink") 공식이다. 기본적으로 어떠한 [급수를](https://ko.wikipedia.org/wiki/급수_\(수학\) "wikilink") [연분수](https://ko.wikipedia.org/wiki/연분수 "wikilink")로 전개하는 방법을 정리한 것이다. 이 공식을 이용하여 [멱급수](https://ko.wikipedia.org/wiki/멱급수 "wikilink")로 전개 가능한 [함수](https://ko.wikipedia.org/wiki/함수 "wikilink")를 연분수 꼴로 표현하는 것도 가능하다.

## 공식화

유한 [복소수](https://ko.wikipedia.org/wiki/복소수 "wikilink")항 급수에 대해 오일러의 연분수 공식은 다음과 같다. 이 형태는 오일러가 입안한 초기의 형태이다.
...
이것은 단순히 [자연수](https://ko.wikipedia.org/wiki/자연수 "wikilink")에 대한 [수학적 귀납법으로](../Page/수학적_귀납법.md "wikilink") 증명할 수 있는 [항등식](https://ko.wikipedia.org/wiki/항등식 "wikilink")이다. 이러한 공식은 무한 항까지 자연스럽게 확장될 수 있는데, 만약 좌변이 수렴하는 [무한급수](https://ko.wikipedia.org/wiki/무한급수 "wikilink")라면 우변도 역시 수렴하는 [무한 연분수가](https://ko.wikipedia.org/wiki/무한_연분수 "wikilink") 된다.
...
복소 지수 함수는 [전해석 함수이고](https://ko.wikipedia.org/wiki/전해석_함수 "wikilink"), [테일러 급수로](https://ko.wikipedia.org/wiki/테일러_급수 "wikilink") 다음과 같이 나타낼 수 있다.
...
오일러의 연분수 공식을 응용하여 유명한 [초월수](https://ko.wikipedia.org/wiki/초월수 "wikilink")인 [상수](https://ko.wikipedia.org/wiki/상수 "wikilink") π를 연분수 꼴로 쓸 수 있다. 먼저 |z|\<1에 대하여 테일러 급수를 이용하면 다음 식을 얻는다.
...
또 여기서 급수 표현이 수렴하므로 [아벨 극한 정리에](https://ko.wikipedia.org/wiki/아벨_극한_정리 "wikilink") 의해 급수 표현과 이 값은 같고, π를 남기고 연분수로 표현하여 이항하면 바로 π의 연분수 표현을 얻는다.
