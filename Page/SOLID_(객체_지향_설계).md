...
[컴퓨터 프로그래밍에서](https://ko.wikipedia.org/wiki/컴퓨터_프로그래밍 "wikilink") **SOLID**란 [로버트 마틴](https://ko.wikipedia.org/wiki/로버트_마틴 "wikilink")\[1\]\[2\]이 2000년대 초반\[3\]에 명명한 [객체 지향 프로그래밍](https://ko.wikipedia.org/wiki/객체_지향_프로그래밍 "wikilink") 및 [설계의](https://ko.wikipedia.org/wiki/객체_지향_설계 "wikilink") 다섯 가지 기본 원칙을 마이클 페더스가 [두문자어](https://ko.wikipedia.org/wiki/두문자어 "wikilink") [기억술](https://ko.wikipedia.org/wiki/기억술 "wikilink")로 소개한 것이다. 프로그래머가 시간이 지나도 [유지 보수와](https://ko.wikipedia.org/wiki/소프트웨어_유지_보수 "wikilink") 확장이 쉬운 시스템을 만들고자 할 때 이 원칙들을 함께 적용할 수 있다.\[4\] SOLID 원칙들은 소프트웨어 작업에서 프로그래머가 [소스 코드가](https://ko.wikipedia.org/wiki/소스_코드 "wikilink") 읽기 쉽고 확장하기 쉽게 될 때까지 소프트웨어 소스 코드를 [리팩터링](https://ko.wikipedia.org/wiki/리팩터링 "wikilink")하여 [코드 냄새를](https://ko.wikipedia.org/wiki/코드_냄새 "wikilink") 제거하기 위해 적용할 수 있는 지침이다. 이 원칙들은 [애자일 소프트웨어 개발과](https://ko.wikipedia.org/wiki/애자일_소프트웨어_개발 "wikilink") [적응적 소프트웨어 개발의](https://ko.wikipedia.org/wiki/적응적_소프트웨어_개발 "wikilink") 전반적 전략의 일부다.\[5\]
...
<tr class="even">
<td><p>O</p></td>
<td><p><a href="https://ko.wikipedia.org/wiki/개방-폐쇄_원칙" title="wikilink">OCP</a></p></td>
<td><dl>
<dt><a href="https://ko.wikipedia.org/wiki/개방-폐쇄_원칙" title="wikilink">개방-폐쇄 원칙 (Open/closed principle)</a></dt>
...
3.  [“SOLID Object-Oriented Design”](http://www.confreaks.com/videos/240-goruco2009-solid-object-oriented-design) , Sandi Metz (Duke University), 2009년 5월에 2009 고담 [루비](https://ko.wikipedia.org/wiki/루비_\(프로그래밍_언어\) "wikilink") 컨퍼런스에서 발표함.
4.
5.
