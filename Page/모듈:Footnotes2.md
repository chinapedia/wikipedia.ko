> This article is converted from Wikipedia: [모듈:Footnotes2](https://ko.wikipedia.org/wiki/모듈:Footnotes2).
...
function f.sfn( frame ) local function strip_url (pages) local escaped_uri;
...
`   args.postscript = pframe.args.postscript or pframe.args.ps or pframe.args.quote or ".";`
`   if 'none' == args.postscript then`
`       args.postscript = '';`
`   end`
`   args.page = pframe.args.p or pframe.args.page or "";`
