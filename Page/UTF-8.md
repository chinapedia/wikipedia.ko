...
예를 들어서, 문자 "위"([`U+C704`](http://www.unicode.org/charts/PDF/UAC00.pdf))는 다음과 같은 방법으로 UTF-8로 인코딩된다.
  ...
  - PHP 를 할떄 이것을 쓰지않으면 한국어가 깨지는 경우가 많이 일어난다
...
[자바는](../Page/자바_\(프로그래밍_언어\).md "wikilink") 내부적으로 문자열을 [UTF-16](https://ko.wikipedia.org/wiki/UTF-16 "wikilink") 인코딩으로 저장하며, 문자열 직렬화를 위하여 UTF-8을 변형하여 사용하고 있다. 이를 [변형된 UTF-8](http://java.sun.com/j2se/1.5.0/docs/api/java/io/DataInput.html#modified-utf-8)이라 부른다.
...
### [UTF-7](https://ko.wikipedia.org/wiki/UTF-7 "wikilink")과 비교했을 때
...
### [UTF-16](https://ko.wikipedia.org/wiki/UTF-16 "wikilink")과 비교했을 때
...
## 같이 보기
  ...
  - [UTF-16](https://ko.wikipedia.org/wiki/UTF-16 "wikilink")
...
1.  [발음 구별 기호가](../Page/발음_구별_기호.md "wikilink") 붙은 [라틴 문자](https://ko.wikipedia.org/wiki/라틴_문자 "wikilink"), [그리스 문자](../Page/그리스_문자.md "wikilink"), [키릴 문자](../Page/키릴_문자.md "wikilink"), [콥트 문자](../Page/콥트_문자.md "wikilink"), [아르메니아 문자](https://ko.wikipedia.org/wiki/아르메니아_문자 "wikilink"), [히브리 문자](../Page/히브리_문자.md "wikilink"), [아랍 문자](https://ko.wikipedia.org/wiki/아랍_문자 "wikilink")