...
2가 [가역원](../Page/가역원.md "wikilink")인 [가환환](https://ko.wikipedia.org/wiki/가환환 "wikilink") \(K\) 위의 **요르단 대수** \(A\)는 다음과 같은 데이터로 주어진다.
...
단순 요르단 대수들의 목록은 다음과 같다.
  ...
  - \(3\times 3\) [팔원수](https://ko.wikipedia.org/wiki/팔원수 "wikilink") 에르미트 행렬들의 대수. 이 경우 곱셈은 \(M\bullet N=(MN+NM)/2\)이다. 이를 **예외 요르단 대수**() 또는 **앨버트 대수**()라고 한다. 이는 미국의 수학자 [에이브러햄 에이드리언 앨버트의](../Page/에이브러햄_에이드리언_앨버트.md "wikilink") 이름을 딴 것이다.
...
[표수가](https://ko.wikipedia.org/wiki/체의_표수 "wikilink") 2가 아닌 [체](https://ko.wikipedia.org/wiki/체_\(수학\) "wikilink") \(K\) 위의 임의의 [결합 대수](../Page/결합_대수.md "wikilink") \(A\)가 주어졌을 때,
...
이는 \(K\)-[결합 대수의](../Page/결합_대수.md "wikilink") [범주에서](https://ko.wikipedia.org/wiki/범주_\(수학\) "wikilink") \(K\)-요르단 대수의 [범주로](https://ko.wikipedia.org/wiki/범주_\(수학\) "wikilink") 가는 [함자](https://ko.wikipedia.org/wiki/함자_\(수학\) "wikilink")

\[(-)^+\colon\operatorname{Assoc}_K \to \operatorname{Jord}_K\] 를 정의한다.

### 자유 요르단 대수

주어진 [체](https://ko.wikipedia.org/wiki/체_\(수학\) "wikilink") \(K\)위의 요르단 대수의 개념은 [대수 구조 다양체를](../Page/대수_구조_다양체.md "wikilink") 이루며, 따라서 **[자유](../Page/자유_대상.md "wikilink") 요르단 대수**()의 개념이 존재한다. 즉, 망각 함자
