...
**GAP**([군](https://ko.wikipedia.org/wiki/군_\(수학\) "wikilink"), [알고리즘](https://ko.wikipedia.org/wiki/알고리즘 "wikilink") 그리고 [프로그래밍](https://ko.wikipedia.org/wiki/컴퓨터_프로그래밍 "wikilink"))은 특히 [계산군론](https://ko.wikipedia.org/wiki/계산군론 "wikilink")에 중점을 둔 계산 이산 대수학을 위한 [컴퓨터 대수학 시스템이다](https://ko.wikipedia.org/wiki/컴퓨터_대수학_시스템 "wikilink").

## 역사

GAP는 독일의 [아헨 공과대학교의](https://ko.wikipedia.org/wiki/아헨_공과대학교 "wikilink") Lehrstuhl D für Mathematik (LDFM)에서 1986년부터 1997년까지 개발되었다. J. Neubüser가 LDFM의 의장에서 은퇴한 뒤, GAP의 개발과 유지는 [스코틀랜드](https://ko.wikipedia.org/wiki/스코틀랜드 "wikilink")의 [세인트앤드루스 대학교의](https://ko.wikipedia.org/wiki/세인트앤드루스_대학교 "wikilink") 수리과학과와 계산과학과와 연합하였다. 2005년 여름의 연합은 [세인트앤드루스 대학교](https://ko.wikipedia.org/wiki/세인트앤드루스_대학교 "wikilink"), [아헨 공과대학교](https://ko.wikipedia.org/wiki/아헨_공과대학교 "wikilink"), [브라운슈바이크 공과대학](https://ko.wikipedia.org/wiki/브라운슈바이크_공과대학 "wikilink"), 그리고 [포트콜린스](https://ko.wikipedia.org/wiki/포트콜린스 "wikilink")의 [콜로라도 주립 대학교에](https://ko.wikipedia.org/wiki/콜로라도_주립_대학교 "wikilink") 위치한 네 'GAP Centres'의 공동 조합으로 이전되었다.

## 배포

패키지(사용자 기여 프로그램의 모음), 데이터 라이브러리([작은 군의 목록을](https://ko.wikipedia.org/wiki/작은_군의_목록 "wikilink") 포함) 그리고 매뉴얼을 포함하는 GAP와 그 소스는 "[카피레프트](https://ko.wikipedia.org/wiki/카피레프트 "wikilink")" 조건에 종속되어 무료로 배포 되었다. GAP는 [윈도우에서](https://ko.wikipedia.org/wiki/마이크로소프트_윈도우 "wikilink") 어떤 [유닉스](https://ko.wikipedia.org/wiki/유닉스 "wikilink") 시스템과, [매킨토시](https://ko.wikipedia.org/wiki/매킨토시 "wikilink") 시스템에서 작동한다. 표준 배포는 300 MB (패키지를 로드 할 경우에는 약 400 MB)가 필요하다. GAP를 실행시키기 위해서, RAM 128 MB면 충분하다.
