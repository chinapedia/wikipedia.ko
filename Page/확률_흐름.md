...
**확률 흐름**()은 [양자역학](https://ko.wikipedia.org/wiki/양자역학 "wikilink")에서 [확률 밀도의](https://ko.wikipedia.org/wiki/확률_밀도 "wikilink") 흐름의 정도를 나타내는 값이다.
...
여기에 [슈뢰딩거 방정식을](https://ko.wikipedia.org/wiki/슈뢰딩거_방정식 "wikilink") 대입하면
