> This article is converted from Wikipedia: [FMOD](https://ko.wikipedia.org/wiki/FMOD).


**FMOD**는 오스트레일리아 멜버른에 위치한 파이어라이트 테크놀로지스에서 만든 음향 [미들웨어](../Page/미들웨어.md "wikilink")이다.

버전 3.75 이후로 FMOD는 아래와 같이 3가지 라이브러리와 프로그램으로 구성되어 있다.

  - , 저수준 사운드 엔진이다.

  - FMOD 이벤트 시스템(), FMOD 디자이너로 만들어진 추상적인 사운드 컨텐츠를 이용하여 데이터 기반 프로그래밍을 간단하게 할 수 있도록 도와준다.

  - FMOD 디자이너(), 사운드 디자이너를 위한 툴로 음악의 재생과 복잡한 사운드 이벤트를 만들어 낼 수 있다.
...
아래와 같이 다른 회사의 엔진에 서드파트너십 계약으로 통합, 탑재되어 제공되고 있다.

  - [개러지게임스](https://ko.wikipedia.org/wiki/개러지게임스 "wikilink") - [토크 게임 엔진](https://ko.wikipedia.org/wiki/토크_게임_엔진 "wikilink")
  - [밸브 코퍼레이션](../Page/밸브_코퍼레이션.md "wikilink") - [소스 엔진](https://ko.wikipedia.org/wiki/소스_엔진 "wikilink")\[2\]
  - [빅월드](https://ko.wikipedia.org/wiki/빅월드 "wikilink") - [빅월드 테크놀로지](https://ko.wikipedia.org/wiki/빅월드_테크놀로지 "wikilink")\[3\]
...
[분류:미들웨어](https://ko.wikipedia.org/wiki/분류:미들웨어 "wikilink") [분류:비디오 게임 음악](https://ko.wikipedia.org/wiki/분류:비디오_게임_음악 "wikilink")
