...
[대수기하학](https://ko.wikipedia.org/wiki/대수기하학 "wikilink")에서, **호지 구조**(Hodge構造, )는 [켈러 다양체](https://ko.wikipedia.org/wiki/켈러_다양체 "wikilink") 위에 [호지 이론으로](https://ko.wikipedia.org/wiki/호지_이론 "wikilink") 주어지는 코호몰로지의 분해와 같은 성질들을 만족시키는 벡터 공간의 분해이다.
...
무게가 \(n\)인 **순수 호지 구조**(純粹Hodge構造, ) \((H,F^\bullet)\)는 다음과 같은 데이터로 구성된다.\[1\]
  ...
  - 복소수 벡터 공간의 유한 감소 [여과](https://ko.wikipedia.org/wiki/여과_\(수학\) "wikilink") \(H\otimes_{\mathbb Z}\mathbb C=F^0\supseteq F^1\supseteq\cdots\supseteq F^n\)
...
순수 호지 구조는 복소수 벡터 공간 \(H\otimes_{\mathbb Z}\mathbb C\) 위의, 복소수 곱셈군 \(\mathbb S(\mathbb R)=\mathbb C^\times\)의 [표현으로도](https://ko.wikipedia.org/wiki/군의_표현 "wikilink") 정의할 수 있다. 이 경우, \(H^{p,q}\)는 \(\mathbb C^\times\)의 작용이 \(z\colon v\mapsto z^p\bar z^qv\)의 꼴인 성분이다.
...
무게 \(k\)의 두 개의 순수 호지 구조 \(H\), \(H'\)이 주어졌을 때, [직합](https://ko.wikipedia.org/wiki/직합 "wikilink") \(H\oplus H'\) 역시 무게 \(k\)의 순수 호지 구조를 이룬다.

무게 \(k\)의 순수 호지 구조 \(H\)와 무게 \(k'\)의 순수 호지 구조 \(H'\)이 주어졌을 때, [텐서곱](https://ko.wikipedia.org/wiki/텐서곱 "wikilink") \(H\otimes H'\)은 무게 \(kk'\)의 순수 호지 구조를 이룬다.

무게 \(k\)의 순수 호지 구조 \(H\) 위의 **극성화**(極性化, ) \(Q\)는 다음 조건들을 만족시키는, \(H\) 위의 정수 [이차 형식이다](https://ko.wikipedia.org/wiki/이차_형식 "wikilink").
...
**혼합 호지 구조**(混合Hodge構造, ) \((H,F^\bullet,W_\bullet)\)는 다음과 같은 데이터로 구성된다.\[2\]
  ...
  - [아벨 군](https://ko.wikipedia.org/wiki/아벨_군 "wikilink") \(H\)
  - \(H\otimes\mathbb C\) 위의, 복소수 벡터 공간들의 유한 감소 [여과](https://ko.wikipedia.org/wiki/여과_\(수학\) "wikilink") \(H\otimes\mathbb C=F^0\supseteq F^1\supseteq\cdots\supseteq F^k\). 이를 **호지 여과**(Hodge濾過, )라고 한다.
  - \(H\otimes\mathbb Q\) 위의, 유리수 벡터 공간들의 유한 증가 [여과](https://ko.wikipedia.org/wiki/여과_\(수학\) "wikilink") \(W_0\subseteq W_1\subseteq\cdots\subseteq W_m=H\otimes\mathbb Q\). 이를 **무게 여과**(-濾過, )라고 한다.
...
두 혼합 호지 구조 \((H,F,W)\), \((H',F',W')\) 사이의 **사상**(寫像, ) \(f\colon H\to H'\)은 다음과 같은 성질을 만족시키는, [아벨 군의](https://ko.wikipedia.org/wiki/아벨_군 "wikilink") [준동형이다](https://ko.wikipedia.org/wiki/군_준동형 "wikilink").

  - \(f(F^p)\subseteq F'^p\)
  - \(f(W_kH)\subseteq W'_k\)

혼합 호지 구조와 그 사상들의 [범주는](https://ko.wikipedia.org/wiki/범주_\(수학\) "wikilink") [아벨 범주를](https://ko.wikipedia.org/wiki/아벨_범주 "wikilink") 이룬다. 이 범주에서의 [핵과](https://ko.wikipedia.org/wiki/핵_\(수학\) "wikilink") [여핵](https://ko.wikipedia.org/wiki/여핵 "wikilink")은 (망각 함자를 통해) 복소수 [벡터 공간에서의](https://ko.wikipedia.org/wiki/벡터_공간 "wikilink") 핵 · 여핵과 일치한다. 또한, 이 범주는 텐서곱을 가지며, 텐서곱을 통하여 [단나카 범주](https://ko.wikipedia.org/wiki/단나카_범주 "wikilink")()를 이룬다.

## 다양체의 호지 구조

### 켈러 다양체

[콤팩트](https://ko.wikipedia.org/wiki/콤팩트_공간 "wikilink") [켈러 다양체](https://ko.wikipedia.org/wiki/켈러_다양체 "wikilink") (또는 복소수체 위의 [비특이](https://ko.wikipedia.org/wiki/비특이_대수다양체 "wikilink") [완비](https://ko.wikipedia.org/wiki/완비_대수다양체 "wikilink") [사영 대수다양체](https://ko.wikipedia.org/wiki/사영_대수다양체 "wikilink")) \(X\)의 복소수 계수 [특이 코호몰로지](https://ko.wikipedia.org/wiki/특이_코호몰로지 "wikilink") \(H^k(X;\mathbb C)=H^k(X;\mathbb Z)\otimes\mathbb C\)는 [호지 이론에](https://ko.wikipedia.org/wiki/호지_이론 "wikilink") 의하여 다음과 같이 분해된다.

\[H^k(X;\mathbb Z)\otimes\mathbb C=\bigoplus_{p+q=k} H^{p,q}(X)\qquad\forall k=0,1,\dots,n\] 이는 무게 \(n\)의 순수 호지 구조를 이룬다. 또한, 모든 차수의 코호몰로지들의 [직합](https://ko.wikipedia.org/wiki/직합 "wikilink")
...
\[\operatorname{gr}^W_nH^k(X;\mathbb Q)\ne 0\implies k\le n\le\min\{2\dim_{\mathbb C}U,2k\}\] 또한, 이는 [함자적이다](https://ko.wikipedia.org/wiki/함자_\(수학\) "wikilink"). 즉, 이는 복소수 비특이 대수다양체의 범주의 [반대 범주에서](https://ko.wikipedia.org/wiki/반대_범주 "wikilink"), 혼합 호지 구조의 범주로 가는 [함자를](https://ko.wikipedia.org/wiki/함자_\(수학\) "wikilink") 이룬다.

비특이 [사영 대수다양체](https://ko.wikipedia.org/wiki/사영_대수다양체 "wikilink") \(X\)의 닫힌 비특이 부분다양체 \(Y\hookrightarrow X\)가 주어진다면, [대수적 위상수학에](../Page/대수적_위상수학.md "wikilink") 따라서 다음과 같은 ([상대](https://ko.wikipedia.org/wiki/상대_코호몰로지 "wikilink")) [특이 코호몰로지의](https://ko.wikipedia.org/wiki/특이_코호몰로지 "wikilink") ([아벨 군으로서의](https://ko.wikipedia.org/wiki/아벨_군 "wikilink")) [긴 완전열이](https://ko.wikipedia.org/wiki/긴_완전열 "wikilink") 존재한다.
...
보다 일반적으로, (특이점을 가질 수 있는) 임의의 복소수 [준사영 대수다양체에](https://ko.wikipedia.org/wiki/준사영_대수다양체 "wikilink") 대해서도 혼합 호지 구조를 자연스럽게 정의할 수 있다.\[9\] 일부 경우 이는 [미분 형식으로](https://ko.wikipedia.org/wiki/미분_형식 "wikilink") 계산할 수 있다.\[10\]

## 관련 개념

**호지 구조의 변동**(Hodge構造의變動, )은 대략 어떤 [복소다양체](https://ko.wikipedia.org/wiki/복소다양체 "wikilink")로 매개변수화된 호지 구조들의 족이다. [필립 오거스터스 그리피스가](https://ko.wikipedia.org/wiki/필립_오거스터스_그리피스 "wikilink") 도입하였다.\[11\]\[12\]\[13\]

**호지 가군**(Hodge加群, )은 대략 "호지 구조들의 [층](https://ko.wikipedia.org/wiki/층_\(수학\) "wikilink")"으로 생각할 수 있다. 사이토 모리히코()가 도입하였다.\[14\]

## 예

### 무게 0 또는 1의 호지 구조

임의의 [아벨 군](https://ko.wikipedia.org/wiki/아벨_군 "wikilink") \(H\)에, 다음과 같이 자명하게 무게 0의 순수 호지 구조를 줄 수 있다.
...
아벨 군 \(H\) 위의, 무게 1의 순수 호지 구조는 (만약 차수 \((p,q)\)가 모두 음이 아닌 정수라면) 실수 [벡터 공간](https://ko.wikipedia.org/wiki/벡터_공간 "wikilink")\(H\otimes_{\mathbb Z}\mathbb R\) 위의 [복소구조](https://ko.wikipedia.org/wiki/복소구조 "wikilink")
...
대수다양체 \(X\)가 두 개의 비특이 [사영 대수다양체](https://ko.wikipedia.org/wiki/사영_대수다양체 "wikilink") \(X_1\)과 \(X_2\)의 [합집합](https://ko.wikipedia.org/wiki/합집합 "wikilink")이며, \(X_1\)과 \(X_2\)는 횡단적으로 교차한다면, 그 호지 구조를 다음과 같이 계산할 수 있다.\[19\] [대수적 위상수학에](../Page/대수적_위상수학.md "wikilink") 따르면, [특이 코호몰로지](https://ko.wikipedia.org/wiki/특이_코호몰로지 "wikilink") 위에 [마이어-피토리스 완전열이](https://ko.wikipedia.org/wiki/마이어-피토리스_완전열 "wikilink") 존재한다.
...
## 같이 보기
  ...
  - [모티브 (수학)](https://ko.wikipedia.org/wiki/모티브_\(수학\) "wikilink")
