...
**호지 구조의 변동**(Hodge構造의變動, )은 대략 어떤 [복소다양체](https://ko.wikipedia.org/wiki/복소다양체 "wikilink")로 매개변수화된 호지 구조들의 족이다. [필립 오거스터스 그리피스가](../Page/필립_오거스터스_그리피스.md "wikilink") 도입하였다.\[11\]\[12\]\[13\]
