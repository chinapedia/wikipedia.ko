...
[수론](https://ko.wikipedia.org/wiki/수론 "wikilink")에서, **약수**(約數, ) 또는 **인수**(因數, , 전 용어: 승자)는 어떤 수로 정수가 나누어떨어지는것을 대하여 이르는 말이다. [다항식](../Page/다항식.md "wikilink")의 약수나 [가환환](../Page/가환환.md "wikilink")의 원소의 약수를 정의할 수도 있다.
