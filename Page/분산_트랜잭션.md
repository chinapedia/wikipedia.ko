...
데이터베이스는 흔한 트랜잭션 자원이며 트랜잭션은 이러한 데이터베이스들을 통과한다. 이 경우 분산 트랜잭션은 여러 참여 [데이터베이스](https://ko.wikipedia.org/wiki/데이터베이스 "wikilink") 간에 [동기화](https://ko.wikipedia.org/wiki/동기화 "wikilink")([ACID](../Page/ACID.md "wikilink") 속성을 제공)해야 하는 [데이터베이스 트랜잭션으로](../Page/데이터베이스_트랜잭션.md "wikilink") 볼 수 있다.

분산 트랜잭션의 [정당성](https://ko.wikipedia.org/wiki/정당성 "wikilink")을 보증하기 위한 일반적인 [알고리즘](https://ko.wikipedia.org/wiki/알고리즘 "wikilink")은 [2단계 커밋](../Page/2단계_커밋_프로토콜.md "wikilink")(2PC)이다. 이 알고리즘은 일반적으로 수 밀리초에서 수 분 사이의 짧은 시간 내에 [커밋](https://ko.wikipedia.org/wiki/커밋 "wikilink")할 수 있는 업데이트를 위해 적용된다.
