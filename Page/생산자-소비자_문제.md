> This article is converted from Wikipedia: [생산자-소비자 문제](https://ko.wikipedia.org/wiki/생산자-소비자_문제).
...
이 문제를 해결하는 것을 **생산자-소비자 협동**이라 하며, [버퍼가](../Page/버퍼_\(컴퓨터_과학\).md "wikilink") [동기화](../Page/동기화.md "wikilink")되어 정상적으로 동작하는 상태를 뜻한다. 문제를 해결하기 위해 [세마포어](../Page/세마포어.md "wikilink")를 활용할 수 있다.
...
## 같이 보기
  ...
  - [흡연자 문제](https://ko.wikipedia.org/wiki/흡연자_문제 "wikilink")
