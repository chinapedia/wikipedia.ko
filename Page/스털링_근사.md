...
[섬네일로](https://ko.wikipedia.org/wiki/파일:Stirling's_Approximation.svg "wikilink") 수렴한다.\]\]  [수학](https://ko.wikipedia.org/wiki/수학 "wikilink")에서, **스털링 근사**() 또는 **스털링 공식**()은 큰 [계승](https://ko.wikipedia.org/wiki/계승 "wikilink")을 구하는 근사법이다.
...
[아브라암 드무아브르는](../Page/아브라암_드무아브르.md "wikilink") 《해석학 잡론》(, 1판 1730년, 2판 1733년)의 2판\[1\] 에 추가된 부록에서 [정규 분포를](https://ko.wikipedia.org/wiki/정규_분포 "wikilink") 다루기 위하여 [계승](https://ko.wikipedia.org/wiki/계승 "wikilink")을
...
\[\ln n! = \ln 1 + \ln 2 + \ln 3 + \cdots + \ln n = \sum^{n}_{k=1} \ln k\] \(n\)이 크다면, [리만 합과](https://ko.wikipedia.org/wiki/리만_합 "wikilink") 유사한 논리에 의해 합을 적분으로 근사할 수 있다.
...
증명을 하기 위해, 계승의 좀 더 일반적인 표현인 [감마 함수를](https://ko.wikipedia.org/wiki/감마_함수 "wikilink") 사용하자. \(n\)이 자연수일 때, 다음이 성립한다.

\[n! = \Gamma (n+1) = \int^\infty_0 x^n e^{-x} dx\] 피적분 함수의 형태를 보면, [감마분포](https://ko.wikipedia.org/wiki/감마분포 "wikilink")를 따르고 있음을 알 수 있는데, 감마 분포의 경우 \(n\)이 매우 클 경우, [중심 극한 정리에](../Page/중심_극한_정리.md "wikilink") 의해 [정규 분포로](https://ko.wikipedia.org/wiki/정규_분포 "wikilink") 근사할 수 있다. 따라서, 위를 정규 분포의 형태로 근사시켜 보자. 먼저 피적분 함수의 형태를 조금 바꾸면
...
스털링 근사는 [통계역학](https://ko.wikipedia.org/wiki/통계역학 "wikilink")에서 흔히 등장하는 매우 큰 [계승](https://ko.wikipedia.org/wiki/계승 "wikilink")을 근사할 때 쓰인다. 거시적인 크기의 계에서의 입자 수는 보통 [아보가드로 수](https://ko.wikipedia.org/wiki/아보가드로_수 "wikilink")(≈6)에 견줄 만하므로, 스털링 근사가 효과적이다.
