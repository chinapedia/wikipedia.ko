...
**합병 정렬** 또는 **병합 정렬**(merge sort)은 *[O](https://ko.wikipedia.org/wiki/대문자_O_표기법 "wikilink")*(*n* log *n*) [비교 기반](https://ko.wikipedia.org/wiki/비교_정렬 "wikilink") [정렬 알고리즘이다](https://ko.wikipedia.org/wiki/정렬_알고리즘 "wikilink"). 일반적인 방법으로 구현했을 때 이 정렬은 [안정 정렬에](https://ko.wikipedia.org/wiki/안정_정렬 "wikilink") 속하며, [분할 정복 알고리즘의](https://ko.wikipedia.org/wiki/분할_정복_알고리즘 "wikilink") 하나이다. [존 폰 노이만이](https://ko.wikipedia.org/wiki/존_폰_노이만 "wikilink") [1945년](https://ko.wikipedia.org/wiki/1945년 "wikilink")에 개발했다.\[1\] 하향식 합병 정렬에 대한 자세한 설명과 분석은 1948년 초 [헤르만 골드스타인과](https://ko.wikipedia.org/wiki/헤르만_골드스타인 "wikilink") [폰 노이만의](https://ko.wikipedia.org/wiki/폰_노이만 "wikilink") 보고서에 등장하였다.\[2\]
