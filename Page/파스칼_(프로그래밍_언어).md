...
**파스칼**(Pascal)은 [1969년](../Page/1969년.md "wikilink")에 [스위스](https://ko.wikipedia.org/wiki/스위스 "wikilink") [ETH 취리히의](https://ko.wikipedia.org/wiki/취리히_연방_공과대학교 "wikilink") [컴퓨터 과학자](../Page/컴퓨터_과학.md "wikilink") [니클라우스 비르트가](../Page/니클라우스_비르트.md "wikilink") 개발한 [프로그래밍 언어로](../Page/프로그래밍_언어.md "wikilink"), 당대의 가장 인기있는 교육용 언어 중 하나였으며, 1980년대와 1990년대 초반에 걸쳐 널리 사용되었다.

파스칼은 발표 당시에는 아주 기본적인 컴퓨터 언어의 요소만을 가지고 있었으므로 시스템을 직접 다루기에는 부족하였다. 파스칼이라는 이름은 [프랑스](../Page/프랑스.md "wikilink")의 수학자이자 철학자 [블레즈 파스칼의](https://ko.wikipedia.org/wiki/블레즈_파스칼 "wikilink") 이름을 딴 것이다. [포인터를](https://ko.wikipedia.org/wiki/포인터_\(프로그래밍\) "wikilink") 사용한 [구조적 프로그래밍을](https://ko.wikipedia.org/wiki/구조적_프로그래밍 "wikilink") 그 특징으로 한다.
...
현재는 초기의 파스칼에 비해 많은 부분이 추가, 개선되고 다른언어의 장점들을 따와 상용 파스칼 컴파일러인 [델파이](https://ko.wikipedia.org/wiki/델파이 "wikilink")는 C++과 거의 기능 차이가 없다.

## 컴파일러

많은 변종들이 존재하며, [객체 지향 프로그래밍을](https://ko.wikipedia.org/wiki/객체_지향_프로그래밍 "wikilink") 위해 기능을 추가한 변종들도 다수 존재한다. [엠바카데로](https://ko.wikipedia.org/wiki/엠바카데로 "wikilink") 사의 [델파이](https://ko.wikipedia.org/wiki/델파이 "wikilink")와 [카일릭스](../Page/카일릭스.md "wikilink")는 파스칼의 직계 후손이라 할 수 있는 [오브젝트 파스칼](https://ko.wikipedia.org/wiki/오브젝트_파스칼 "wikilink") 을 사용한다. [델파이](https://ko.wikipedia.org/wiki/델파이 "wikilink") 7 버전부터는 델파이라는 말을 사용하기도 한다.
...
파스칼은 [포인터](https://ko.wikipedia.org/wiki/포인터_\(프로그래밍\) "wikilink") 사용을 지원한다:
