...
### 영화, 비디오, 음악
  ...
  - [BitTorrent Inc.](https://ko.wikipedia.org/wiki/BitTorrent_Inc. "wikilink") 는 할리우드 스튜디오로부터 라이선스를 몇 개 받아 놓은 상태이다. 이 회사 웹사이트에서 인기있는 콘텐트들을 배포하기 위함이다.
...
### 개인 자료
  ...
  - [Amazon S3](https://ko.wikipedia.org/wiki/Amazon_S3 "wikilink") **심플 스토리지 서비스**는 스케일러블한 인터넷-기반 저장공간 서비스이며, 간단한 [웹 서비스](https://ko.wikipedia.org/wiki/웹_서비스 "wikilink") 인터페이스를 채택하고 있다. 또한 비트토렌트 지원 기능을 내장하였다.
...
### 게임
  ...
  - [워게이밍넷](https://ko.wikipedia.org/wiki/워게이밍넷 "wikilink") [월드 오브 탱크](../Page/월드_오브_탱크.md "wikilink"), [월드 오브 워플레인](https://ko.wikipedia.org/wiki/월드_오브_워플레인 "wikilink") 는 비트토렌트 프로토콜을 이용하여 업데이트를 배포한다.
