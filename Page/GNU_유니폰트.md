...
[오른쪽](https://ko.wikipedia.org/wiki/파일:GNUUnifontDemonstration.png "wikilink") 로만 치보라(Roman Czyborra)\[1\]가 디자인한 GNU 유니폰트(GNU Unifont)는 중간 비트맵 글꼴 형식을 사용하여 전체 [유니코드](https://ko.wikipedia.org/wiki/유니코드 "wikilink") BMP ( Basic Multilingual Plane)을 다루는 무료 [비트맵](https://ko.wikipedia.org/wiki/비트맵 "wikilink") 글꼴이다.

[Linux](https://ko.wikipedia.org/wiki/Linux "wikilink") , [XFree86](https://ko.wikipedia.org/wiki/XFree86 "wikilink") 또는 X.org Server 와 같은 대부분의 공개 무료 운영 체제 및 윈도우 시스템 및 RockBox 와 같은 일부 내장 [펌웨어](https://ko.wikipedia.org/wiki/펌웨어 "wikilink")에 있다. 글꼴은 [GNU](https://ko.wikipedia.org/wiki/GNU "wikilink") [GPL](https://ko.wikipedia.org/wiki/GPL "wikilink")(General Public License) 버전 2+에서 글꼴 포함 예외 (문서에 글꼴 포함시 동일한 라이센스하에 문서를 배치할 필요가 없음)와 함께 릴리스된다.

2013 년 10 월에 [GNU](https://ko.wikipedia.org/wiki/GNU "wikilink") 패키지가 되었다.

## .hex 글꼴 형식

GNU 유니폰트(GNU Unifont) .hex 형식은 폭이 8 또는 16 픽셀, 높이가 16 픽셀인 [글리프를](https://ko.wikipedia.org/wiki/자체 "wikilink") 정의한다. 대부분의 서구권 스크립트 글리프는 8 픽셀 너비로 정의 할 수 있지만 다른 글리프 (특히 중국어 - 일본어 - 한국어 또는 [CJK](https://ko.wikipedia.org/wiki/CJK "wikilink") 세트라고 잘 알려진)는 일반적으로 16 픽셀 너비로 정의된다.
...
글꼴은 [X11](https://ko.wikipedia.org/wiki/X_윈도_시스템 "wikilink") 에서 사용하기 위해 BDF 파일로 변환된다.
...
2008 년 Luis Alejandro González Miranda는이 글꼴을 TrueType 글꼴로 변환하는 프로그램을 작성했다. Paul Hardy는 나중에 [트루타입](https://ko.wikipedia.org/wiki/트루타입 "wikilink")(TrueType) 버전의 문자 조합을 지원하도록 수정했다.

마지막으로 [리차드 스톨만Richard](https://ko.wikipedia.org/wiki/리차드_스톨만 "wikilink") Stallman 은 2013 년 10 월 유니폰트(Unifont)라는 GNU 패키지를 폴 하디(Paul Hardy)의 메인 테이너로 지칭했다.
