...
[수학](https://ko.wikipedia.org/wiki/수학 "wikilink")에서, **불완전 감마 함수**(不完全Γ函數, )는 [감마 함수를](https://ko.wikipedia.org/wiki/감마_함수 "wikilink") 확장한 [특수 함수로](../Page/특수_함수.md "wikilink"), 원래 감마함수의 정의에서 적분 구간을 변경한 것이다.
