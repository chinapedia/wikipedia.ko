...
[트랜잭션 처리](https://ko.wikipedia.org/wiki/트랜잭션_처리 "wikilink"), [데이터베이스](https://ko.wikipedia.org/wiki/데이터베이스 "wikilink"), [컴퓨터 네트워크에서](https://ko.wikipedia.org/wiki/컴퓨터_네트워크 "wikilink") **2단계 커밋 프로토콜**()은 [원자적 커밋 프로토콜](https://ko.wikipedia.org/wiki/원자적_커밋 "wikilink")(ACP)의 일종이다. 트랜잭션을 [커밋](https://ko.wikipedia.org/wiki/커밋 "wikilink")할지, 아니면 롤백할지에 대해 [분산 원자적 트랜잭션에](https://ko.wikipedia.org/wiki/분산_트랜잭션 "wikilink") 관여하는 [분산 알고리즘의](https://ko.wikipedia.org/wiki/분산_알고리즘 "wikilink") 하나이다. (특별한 종류의 [일치 프로토콜](https://ko.wikipedia.org/wiki/일치_프로토콜 "wikilink")) 이 프로토콜은 수많은 종류의 일시적 시스템 문제(프로세스, 네트워크 노드, 통신 등)에도 목표를 수행하므로 널리 이용된다.\[1\]\[2\]\[3\] 그러나 잠재적인 모든 문제 구성을 복구할 수 있는 것은 아니며, 드문 경우 문제 해결을 위해 사용자(시스템의 관리자)의 간섭이 요구된다.
