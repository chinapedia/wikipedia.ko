...
[선형대수학](../Page/선형대수학.md "wikilink")에서, **텐서 대수**(tensor代數, )는 어떤 [벡터 공간](../Page/벡터_공간.md "wikilink") 또는 [가군](../Page/가군.md "wikilink") 위의 원소들로부터 생성되는 비가환 다항식들로 구성되는 [등급](https://ko.wikipedia.org/wiki/등급환 "wikilink") [단위 결합 대수이다](https://ko.wikipedia.org/wiki/단위_결합_대수 "wikilink").
