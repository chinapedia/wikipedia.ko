...
## 대표적으로 사용하는 곳
  ...
  - 구성요소 개체 방식([Component Object Model(COM)](https://ko.wikipedia.org/wiki/컴포넌트_오브젝트_모델 "wikilink"))
  - [마이크로소프트](https://ko.wikipedia.org/wiki/마이크로소프트 "wikilink")의 IUnknown, ATL
  - [스크립트 언어](https://ko.wikipedia.org/wiki/스크립팅_언어 "wikilink"): [펄](https://ko.wikipedia.org/wiki/펄 "wikilink"), [파이썬](https://ko.wikipedia.org/wiki/파이썬 "wikilink"), [스퀴럴](../Page/스퀴럴_\(프로그래밍_언어\).md "wikilink")
