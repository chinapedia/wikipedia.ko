...
**직렬 회선 인터넷 프로토콜** 또는 **시리얼 라인 인터넷 프로토콜**(, **SLIP**)은 대부분의 컴퓨터에 내장된 [직렬 포트에서](https://ko.wikipedia.org/wiki/직렬_포트 "wikilink") 인터넷 등의 [TCP/IP](https://ko.wikipedia.org/wiki/인터넷_프로토콜_스위트 "wikilink") 네트워크에 전화선 등 직렬 통신 회선의 저속 회선을 통해 일시적으로 접속하기 위한 [프로토콜](https://ko.wikipedia.org/wiki/프로토콜 "wikilink")이다. SLIP는 대부분 [점대점 프로토콜](https://ko.wikipedia.org/wiki/점대점_프로토콜 "wikilink")(PPP)로 대체되었다.
