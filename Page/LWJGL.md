...
**LWJGL**(Light Weight Java Game Library)는 [자바를](https://ko.wikipedia.org/wiki/자바_\(프로그래밍_언어\) "wikilink") 위한 오픈 소스 게임 개발 라이브러리이다.
...
| 바인딩                                                                               | 설명                                                                                         | 참고                                                |
| --------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------ | ------------------------------------------------- |
| [EGL](https://ko.wikipedia.org/wiki/EGL_\(API\) "wikilink")                       | 크로노스 렌더링 API와, 기반이 되는 네이티브 플랫폼 윈도 시스템 간의 인터페이스.                                            |                                                   |
| [OpenCL](https://ko.wikipedia.org/wiki/OpenCL "wikilink")                         | 크로스 플랫폼 [병렬 컴퓨팅용](https://ko.wikipedia.org/wiki/병렬_컴퓨팅 "wikilink") API.                    |                                                   |
| [OpenGL](https://ko.wikipedia.org/wiki/OpenGL "wikilink")                         | 대부분의 [GPU](https://ko.wikipedia.org/wiki/그래픽_처리_장치 "wikilink") 벤더들이 구현한 3D 그래픽스 구현체.       | 대부분의 확장 기능들이 지원되지만 요청에 따라 덜 유명한 확장 기능들이 추가될 수 있다. |
| [OpenGL ES](https://ko.wikipedia.org/wiki/OpenGL_ES "wikilink")                   | 휴대 전화, 태블릿, 콘솔 등 [임베디드 시스템을](https://ko.wikipedia.org/wiki/임베디드_시스템 "wikilink") 위한 OpenGL. |                                                   |
| [벌컨](https://ko.wikipedia.org/wiki/벌컨_\(API\) "wikilink")                         | 차기 크로스 플랫폼 3D 그래픽스 API.                                                                    |                                                   |
...
| [OpenAL](https://ko.wikipedia.org/wiki/OpenAL "wikilink")                         | 3차원 오디오 API.                                                                               | ALC 및 기타 확장 지원함.                                  |
...
| [Nuklear](https://ko.wikipedia.org/wiki/Nuklear "wikilink")                       | 단순 [GUI](https://ko.wikipedia.org/wiki/그래픽_사용자_인터페이스 "wikilink") 라이브러리.                    |                                                   |
...
| [C 동적 메모리 할당](https://ko.wikipedia.org/wiki/C_동적_메모리_할당 "wikilink")               | 저급(Low-level) 메모리 관리.                                                                      |                                                   |
| [LMDB](https://ko.wikipedia.org/wiki/Lightning_Memory-Mapped_Database "wikilink") | [메모리 맵 파일을](https://ko.wikipedia.org/wiki/메모리_맵_파일 "wikilink") 이용한 고속 데이터베이스 라이브러리.        |                                                   |
| [xxHash](https://ko.wikipedia.org/wiki/xxHash "wikilink")                         | 고속 [해시 알고리즘](https://ko.wikipedia.org/wiki/해시_함수 "wikilink").                              |                                                   |
...
## 저명한 사용
  ...
  - [마인크래프트](https://ko.wikipedia.org/wiki/마인크래프트 "wikilink")\[3\]

## 같이 보기

  - [JMonkeyEngine](https://ko.wikipedia.org/wiki/JMonkeyEngine "wikilink"), LWJGL 로 제작한 게임 엔진
  - [마인크래프트](https://ko.wikipedia.org/wiki/마인크래프트 "wikilink"), LWJGL 로 제작한 유명한 게임
