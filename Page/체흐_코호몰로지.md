...
다음이 주어졌다고 하자.
  ...
  - \(X\) 위의 [아벨 군](https://ko.wikipedia.org/wiki/아벨_군 "wikilink") [준층](https://ko.wikipedia.org/wiki/준층 "wikilink") \(\mathcal F\in\operatorname{PSh}(X;\operatorname{Ab})\)

그렇다면, 각 자연수 \(n\in\mathbb N\)에 대하여, \((X,\mathcal U)\)의 \(\mathcal F\)계수 \(n\)차 **체흐 코호몰로지** \(\operatorname{\check H}^n(X;\mathcal F)\)는 [아벨 군이다](https://ko.wikipedia.org/wiki/아벨_군 "wikilink"). 이는 구체적으로 [공사슬 복합체를](https://ko.wikipedia.org/wiki/공사슬_복합체 "wikilink") 통해 정의될 수 있으며, 추상적으로 [오른쪽 유도 함자로서](https://ko.wikipedia.org/wiki/오른쪽_유도_함자 "wikilink") 정의될 수도 있다. 이 두 정의는 서로 [동치](../Page/동치.md "wikilink")이다.
...
\(n\)차 **체흐 단체**(Čech單體, ) \(\sigma\)는 그 교집합이 0이 아닌, \(n+1\)개의 \(\mathcal U\)의 원소의 [순서쌍](https://ko.wikipedia.org/wiki/순서쌍 "wikilink") \((U_0,\dots,U_n)\)이다. 단체의 **지지 집합**() \(|\sigma|\)은 다음과 같은, 모든 성분들의 [교집합](https://ko.wikipedia.org/wiki/교집합 "wikilink")이다.

\[|\sigma|\bigcap_{k=0}^nU_n\]

\(n\)차 체흐 단체를 [기저로](../Page/기저_\(선형대수학\).md "wikilink") 하는 자유 [아벨 군을](https://ko.wikipedia.org/wiki/아벨_군 "wikilink") \(\check C^n\)이라고 하자. \(\check C^n\)의 원소를 \(n\)차 **체흐 사슬**()이라고 한다.
...
\(n\)차 **체흐 공사슬**(Čech共-, ) \(\phi\)는 \(n\)차 단체 \(\sigma\)를 [아벨 군](https://ko.wikipedia.org/wiki/아벨_군 "wikilink") 원소 \(\phi(\sigma)\in\mathcal F(|\sigma|)\)와 대응시키는 [함수](https://ko.wikipedia.org/wiki/함수 "wikilink")이다. \(n\)차 공사슬의 집합을 \(\check C^n(X,\mathcal U;\mathcal F)\)라고 하자. 이는 점별 덧셈에 대하여 [아벨 군을](https://ko.wikipedia.org/wiki/아벨_군 "wikilink") 이룬다.
...
\right\}\] 여기서 \(\check C^0\)는 0차 체흐 공사슬, 즉 각 \(U\in\mathcal U\)에 대하여 \(\mathcal F(U)\)의 원소 \(\phi_U\in\mathcal F_U\)를 대응시키는 대상들의 집합이다. 만약 \(\mathcal F\)가 [층이라면](https://ko.wikipedia.org/wiki/층_\(수학\) "wikilink") 이는 대역 단면 \(\Gamma_X(\mathcal F)\)과 같지만, [준층](https://ko.wikipedia.org/wiki/준층 "wikilink")이라면 같을 필요가 없다.
...
임의의 [아벨 군](https://ko.wikipedia.org/wiki/아벨_군 "wikilink") \(G\)에 대하여, 그 [상수층](../Page/상수층.md "wikilink") \(\underline G\)을 생각하자. 만약 위상 공간 \(X\)가 [CW 복합체와](../Page/CW_복합체.md "wikilink") [호모토피 동치라면](../Page/호모토피_동치.md "wikilink"), 그 \(\underline G\) 계수 체흐 코호몰로지는 \(G\) 계수 [특이 코호몰로지와](https://ko.wikipedia.org/wiki/특이_코호몰로지 "wikilink") 표준적으로 동형이다.
...
구체적으로, [위상 공간](https://ko.wikipedia.org/wiki/위상_공간_\(수학\) "wikilink") \(X\) 위의 [아벨 군](https://ko.wikipedia.org/wiki/아벨_군 "wikilink") 값의 [층](https://ko.wikipedia.org/wiki/층_\(수학\) "wikilink") \(\mathcal F\) 및 [열린 덮개](https://ko.wikipedia.org/wiki/열린_덮개 "wikilink") \(\mathcal U\)가 주어졌다고 하자. \(\mathcal H^q(X;\mathcal F)\)가 다음과 같은 [준층](https://ko.wikipedia.org/wiki/준층 "wikilink")이라고 하자.
...
\[\operatorname{Sh}(X;\operatorname{Ab})\hookrightarrow\operatorname{PSh}(X;\operatorname{Ab})\xrightarrow{\operatorname{\check H}^0(X,\mathcal U;-)}\operatorname{Ab}\] 여기서 \(\operatorname{Sh}\)는 [층](https://ko.wikipedia.org/wiki/층_\(수학\) "wikilink") 범주, \(\operatorname{PSh}\)는 [준층](https://ko.wikipedia.org/wiki/준층 "wikilink") 범주를 뜻한다.
...
\[T = \left\{ \left(x, \sin(1/x) \right) \colon x \in (0,1] \right\} \cup \{(0,0)\}\] 의 [폐포](https://ko.wikipedia.org/wiki/폐포_\(위상수학\) "wikilink")
...
[분리 스킴](https://ko.wikipedia.org/wiki/분리_스킴 "wikilink") 위의 [연접층](../Page/연접층.md "wikilink")에 대하여, 열린 [아핀](https://ko.wikipedia.org/wiki/아핀_스킴 "wikilink") 부분 스킴들로 구성된 덮개는 항상 르레 덮개이다. 여기서 분리성 및 연접성은 다음과 같이 필요하다.
  ...
  - [분리 스킴의](https://ko.wikipedia.org/wiki/분리_스킴 "wikilink") 조건에 의하여 열린 아핀 부분 스킴들의 [교집합](https://ko.wikipedia.org/wiki/교집합 "wikilink") 역시 열린 아핀 부분 스킴이다.
  - [연접층](../Page/연접층.md "wikilink")의 조건에 의하여, 아핀 스킴 위의 연접층은 항상 [비순환층](https://ko.wikipedia.org/wiki/비순환층 "wikilink")이다.

## 역사

[러시아](../Page/러시아.md "wikilink")의 [파벨 알렉산드로프](https://ko.wikipedia.org/wiki/파벨_알렉산드로프 "wikilink")\[4\] 와 [체코](https://ko.wikipedia.org/wiki/체코 "wikilink")의 [에두아르트 체흐](https://ko.wikipedia.org/wiki/에두아르트_체흐 "wikilink")\[5\] 가 도입하였다. 르레 정리는 [장 르레가](../Page/장_르레.md "wikilink") 1950년에 도입하였다.\[6\]
