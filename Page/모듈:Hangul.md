...
\-- Helper Functions --[Helper Function to interpret boolean strings. From Module:String --](https://ko.wikipedia.org/wiki/Helper_Function_to_interpret_boolean_strings._From_Module:String_-- "wikilink")
