...
[섬네일에서](https://ko.wikipedia.org/wiki/파일:VirtualBox_screenshot.png "wikilink") 버추얼박스로 [쿠분투](https://ko.wikipedia.org/wiki/쿠분투 "wikilink") 라이브 CD를 실행한 모습\]\] **버추얼박스**()는 본래 이노테크(InnoTek)가 개발한 뒤, 현재는 [오라클이](../Page/오라클_\(기업\).md "wikilink") 개발 중인 [상용](https://ko.wikipedia.org/wiki/상용_소프트웨어 "wikilink"), [사유 소프트웨어](https://ko.wikipedia.org/wiki/사유_소프트웨어 "wikilink")(제한된 GPL 버전)로, [리눅스](../Page/리눅스.md "wikilink"), [macOS](https://ko.wikipedia.org/wiki/macOS "wikilink"), [솔라리스](../Page/솔라리스_\(운영_체제\).md "wikilink"), [윈도를](https://ko.wikipedia.org/wiki/마이크로소프트_윈도 "wikilink") 게스트 운영 체제로 가상화하는 [x86 가상화 소프트웨어이다](https://ko.wikipedia.org/wiki/x86_가상화 "wikilink").\[1\]\[2\] 개발된 지 몇 해가 지나, 제한된 오픈 소스 버전인 버추얼박스 OSE가 [GPL](https://ko.wikipedia.org/wiki/GPL "wikilink") 하에 2007년 1월에 공개되었다.
