...
[분산 컴퓨팅과](https://ko.wikipedia.org/wiki/분산_컴퓨팅 "wikilink") 다중 에이전트 시스템에서 프로세스들이 사용할 값을 하나로 결정하는 문제를 **합의 문제 (Consensus Problem)**라고 한다. 합의 적용의 사례는 데이터 베이스로의 트랜젝션 전송, 리더 식별자 일치화, [상태 기계 접근법](https://ko.wikipedia.org/wiki/상태_기계_접근법 "wikilink") , 아토믹 브로드캐스트가 있다. 실생활에서의 사례로는 [시간 동기화](https://ko.wikipedia.org/wiki/동기화#컴퓨터_과학 "wikilink"), 의사 결정, [페이지랭크](https://ko.wikipedia.org/wiki/페이지랭크 "wikilink"), [스마트 그리드](https://ko.wikipedia.org/wiki/스마트_그리드 "wikilink"), 상태 추정, [무인 항공기의](https://ko.wikipedia.org/wiki/무인_항공기 "wikilink") 제어, [부하분산](https://ko.wikipedia.org/wiki/부하분산 "wikilink") 등이 있다.
...
많은 P2P 온라인 [실시간 전략 게임은](https://ko.wikipedia.org/wiki/실시간_전략_게임 "wikilink") 유저들 간에 게임 상태를 관리하기 위해 변형된 Lockstep 프로토콜을 합의 프로토콜로 사용한다.

## 같이 보기

  - Uniform consensus
  - Quantum Byzantine agreement
  - [비잔티움 장애 허용](https://ko.wikipedia.org/wiki/비잔티움_장애_허용 "wikilink")
