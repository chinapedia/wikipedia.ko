...
<ins>[문서가 보호되어 있어 고칠 수 없거나](https://ko.wikipedia.org/wiki/위키백과:보호_정책 "wikilink"), 시스템 메시지에서 오류가 발생할 때에는</ins> [위키백과:관리자 알림판에](../Page/위키백과:관리자_알림판.md "wikilink") 글을 올리십시오.

## 개발자에게 알리세요

위키백과는 [미디어위키](https://ko.wikipedia.org/wiki/미디어위키 "wikilink")라는 프로그램을 써서 돌아갑니다. <ins>미디어위키 프로그램 자체의 버그나 개선점을 알리는 일</ins>은 [파브리케이터에서](https://ko.wikipedia.org/wiki/phabricator: "wikilink") 이루어집니다.
