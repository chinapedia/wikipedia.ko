...
WebM 파일은 [VP8](../Page/VP8.md "wikilink") 비디오와 [Vorbis](../Page/Vorbis.md "wikilink") 오디오 스트림으로 이루어져 있으며, 2013년에  VP9 비디오와 Opus 오디오를 수용하는 것으로 갱신되었다. WebM 컨테이너는 [마트료시카](https://ko.wikipedia.org/wiki/마트료시카_\(포맷\) "wikilink") 프로파일에 기반을 둔다.\[2\]\[3\]\[4\]

이 프로젝트는 [BSD 라이선스](https://ko.wikipedia.org/wiki/BSD_라이선스 "wikilink") 하에서 WebM 관련 소프트웨어를 출시하며 모든 사용자는 아무런 비용 없이 이를 이용할 수 있다.
...
3.  [The WebM Project : about : Frequently Asked Questions](http://www.webmproject.org/about/faq/)
4.  [May 19, 2010: Xiph.Org announces support for the WebM open media project](http://www.xiph.org/press/2010/webm/)