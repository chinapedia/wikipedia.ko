...
[영어 숫자](https://ko.wikipedia.org/wiki/영어_숫자 "wikilink") 코드는 **6EQUJ5**이라고 나와 있는데, 신호의 [강약을](https://ko.wikipedia.org/wiki/세기_\(물리\) "wikilink") 나타낸다. 0과 1은 [띄어쓰기](../Page/띄어쓰기.md "wikilink")의 차이를 나타내며, 숫자 1에서 9는 상응하는 번호 강도를 나타낸다(1에서 10까지), 그리고 10 이상은 알파벳에 대응해서 표시된다(예시:'A'는 10에서 11까지, 'B'는 11에서 12까지.). 값은 'U'가 검출되었고 (30에서 31 사이), 이는 그때까지 전파망원경에서 관측된 수치 중에 제일 높은 것으로, 정상 신호보다 무려 30배 더 컸다.\[3\] 이 경우의 강도는 [단위가 없고](https://ko.wikipedia.org/wiki/무단위_신호 "wikilink"), [신호 대 잡음으로](https://ko.wikipedia.org/wiki/신호_대_잡음 "wikilink") 표시되었다. 잡음은 신호 전 몇 분간 왔던 잡음을 기준으로 해서 계산했다.\[4\]

이 신호의 주파수는 1420.356[MHz](https://ko.wikipedia.org/wiki/MHz "wikilink")(J. D. 크라우스)와 1420.4556MHz(J. R. 에만)이라는 서로 다른 두개로 발견했다. 와우 신호의 주파수는 [수소선](https://ko.wikipedia.org/wiki/수소선 "wikilink")의 주파수인 1420.40575177MHz와 매우 밀접하게 비슷하다. SETI 탐색에서, 수소는 우주에서 가장 흔한 원소이고 수소는 1420.40575177MHz에서 공진하기 때문에 [외계 지능체가](https://ko.wikipedia.org/wiki/외계_지능체 "wikilink") 강한 신호를 보낼 때 이용할 수있는 주파수라서 중요한 신호로 추론되었다.\[5\] 와우 신호에서 보내진 서로 다른 두개의 주파수(1420.356MHz 및 1420.4556MHz)는 수소선에서 동일한 거리만큼 떨어져 있다. 첫 번째 신호는 수소선에서 0.0498MHz(49.75177kHz)만큼 적으며, 두 번째 신호는 수소선에서 0.0498MHz(49.84823kHz)만큼 크다. 이 신호의 [대역폭](https://ko.wikipedia.org/wiki/대역폭 "wikilink")은 10kHz 미만이다(출력 신호는 10kHz 폭의 채널로 들어왔으며, 그 중 신호는 1개의 열에만 들어왔다).

[섬네일](https://ko.wikipedia.org/wiki/파일:Wow_signal_location.jpg "wikilink") 방향 [궁수자리 성군](https://ko.wikipedia.org/wiki/궁수자리_키 "wikilink")(星群) 근처이다. 신호가 온 위치는 그림의 붉은 영역 둘 중 하나로 추측되며(이는 실험 방법 때문이다), 적위값(수직축)은 매우 불확실하여 위아래로 길게 표시되어 있다. 다만 붉은 영역 좌우 폭은 과장되었으며 실제로는 이보다 좁다.\]\]

제리 에만이 쓴 "Wow\!"라고 적은 유명한 쪽지는 현재 [오하이오 역사 학회에서](https://ko.wikipedia.org/wiki/오하이오_역사_학회 "wikilink") 보유하고 있다.\[6\]
...
[적위](../Page/적위.md "wikilink")는 꽤 정확하게 −27°03′ ± 20′로 측정되었다. 위의 값은 모두 [B1950.0](https://ko.wikipedia.org/wiki/역기점 "wikilink") [주야 평분시를](https://ko.wikipedia.org/wiki/주야_평분시_\(천구_좌표계\) "wikilink") 기준으로 표현했다.\[7\]
...
[섬네일](https://ko.wikipedia.org/wiki/파일: