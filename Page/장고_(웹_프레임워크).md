...
**장고**(Django, FAQ 발음으로는 "쟁고"()\[1\])는 [파이썬](../Page/파이썬.md "wikilink")으로 작성된 [오픈 소스](../Page/오픈_소스.md "wikilink") [웹 애플리케이션 프레임워크로](https://ko.wikipedia.org/wiki/웹_애플리케이션_프레임워크 "wikilink"), [모델-뷰-컨트롤러](../Page/모델-뷰-컨트롤러.md "wikilink")(MVC) 패턴을 따르고 있다. 현재는 [장고 소프트웨어 재단에](https://ko.wikipedia.org/wiki/장고_소프트웨어_재단 "wikilink") 의해 관리되고 있다.
...
[인스타그램](../Page/인스타그램.md "wikilink")\[2\], [NASA](../Page/미국_항공우주국.md "wikilink")\[3\], 빗버켓\[4\], Disqus\[5\] , [모질라](../Page/모질라_파이어폭스.md "wikilink")\[6\]에서 장고를 사용하는 것으로 알려져있다.
