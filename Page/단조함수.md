...
[섬네일](https://ko.wikipedia.org/wiki/파일:Monotonicity_example1.png "wikilink") [수학](https://ko.wikipedia.org/wiki/수학 "wikilink")에서, **단조 함수**(單調函數, )는 주어진 순서를 보존하는 [함수](https://ko.wikipedia.org/wiki/함수 "wikilink")이다. [기하학](https://ko.wikipedia.org/wiki/기하학 "wikilink")적으로, [실수](https://ko.wikipedia.org/wiki/실수 "wikilink") 단조 함수의 [그래프는](https://ko.wikipedia.org/wiki/함수의_그래프 "wikilink") 왼쪽에서 오른쪽으로 줄곧 상승하거나 줄곧 하강한다. [대수학](https://ko.wikipedia.org/wiki/대수학 "wikilink")적으로, 단조 함수는 두 순서 집합 사이의 [준동형](../Page/준동형.md "wikilink")이다.

## 정의

실수 [구간](https://ko.wikipedia.org/wiki/구간 "wikilink") \(I\)를 [정의역](https://ko.wikipedia.org/wiki/정의역 "wikilink"), 실수 집합 \(\R\)을 [공역으로](https://ko.wikipedia.org/wiki/공역_\(수학\) "wikilink") 하는 함수 \(f\colon I\to\R\)이 다음 두 조건 중 하나를 만족시키면, **단조 함수**라고 한다.
...
[미분](https://ko.wikipedia.org/wiki/미분 "wikilink")은 함수의 단조성을 판별하는 좋은 도구이다.
...
구간 \(I\)에 정의된 실수 단조 함수 \(f\colon I\to\R\)에 대하여, 다음 성질들이 성립한다.
  ...
  - \(f\)의 불연속점은 많아야 [가산](https://ko.wikipedia.org/wiki/가산_집합 "wikilink") 개이다.\[4\]
...
이에 따라, [연속 함수가](https://ko.wikipedia.org/wiki/연속_함수 "wikilink") 아니거나 미분 불가능한 단조 함수의 성질은 상당히 제한된다.
