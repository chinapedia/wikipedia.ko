...
**투수계수**는 [다르시의 법칙에](https://ko.wikipedia.org/wiki/다르시의_법칙 "wikilink") 사용되는 계수로, 유체가 얼마나 잘 다공성 매질을 통과하는지 나타낸다.
...
[섬네일](https://ko.wikipedia.org/wiki/파일:정수위_투수시험.png "wikilink") 투수성이 비교적 큰 [조립토](https://ko.wikipedia.org/wiki/조립토 "wikilink")에 적당하다. 흙 시료에 유입되는 수조와 유출되어 나오는 수조의 수위를 일정하게 하여 물을 시료에 통과시킴으로써 [다르시의 법칙에](https://ko.wikipedia.org/wiki/다르시의_법칙 "wikilink") 의해 투수계수를 구할 수 있다. 시험기구는 정압수두 투수계라고 부른다.
...
자연계 토질은 대부분 [비등방](https://ko.wikipedia.org/wiki/비등방 "wikilink")성이다. 연직방향 투수계수가 수평방향 투수계수보다 작다(\(k_z < k_x\)) [연속방정식](https://ko.wikipedia.org/wiki/연속방정식 "wikilink")을 [라플라스 방정식으로](https://ko.wikipedia.org/wiki/라플라스_방정식 "wikilink") 바꾸면 x방향으로 축소된 유선망을 그릴 수 있다. 즉 축소된 좌표는 다음과 같이 변환된다.
...
## 같이 보기
  ...
  - [유선망](https://ko.wikipedia.org/wiki/유선망 "wikilink")
