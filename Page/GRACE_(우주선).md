...
KBR:중력의 변동을 측정하는 것이 목적인 페이로드로, 두 위성 사이간 거리를 측정해 지구의 중력 변화를 측정하는 것이 목적이다.\[21\]

USO:탐사선 간 통신을 하고 지구와 통신을 하는 것이 목적이다.\[22\]\[23\]

ACC:위성의 [중력가속도](https://ko.wikipedia.org/wiki/중력가속도 "wikilink")를 측정해 지구의 중력 변화를 측정하는 것이 목적이다.\[24\]\[25\]

SCA:두 위성의 위치를 별의 위치를 기준으로 두 위성의 방향을 정확히 측정하고 각 지역에 따른 지구의 중력 변화를 아는 것이 목적이다.\[26\]\[27\]

CES:지구와 태양의 위치를 추적해 지구의 궤도를 정확히 측정하는 것이 목적이다.\[28\]\[29\]

MTA:일종의 반작용 휠 역할로 위성의 각도, 위치 등을 조정하는 것이 목적이다.\[30\]\[31\]

GPS:별자리와의 거리를 측정하는 것이 목적이다.\[32\]\[33\]

GSA:전력분배를 하는 것이 목적이다.\[34\]\[35\]
...
2017년 9월 GRACE-2에서 배터리 문제, 전력분배장치 고장과 부품 간 전력교류가\[39\] 이루어진다는 것을 발견한 연구원들은 GRACE-1과 GRACE-2를 2017년 10월 중순에 퇴역시키기로 결정했다.\[40\] 이후 GRACE-2는 고장난 상태로 지구를 돌다가 2017년 12월 24일 지구에 추락했고,\[41\]() GRACE-1은 2018년 3월 10일 추락했다.()\[42\]
...
37.
38.
39. 정말 전력이 없을 때, 생산 방법도 없을 때 최후의 수단으로 사용하는 방법이다. 각 부품에 필요한 전력이 여러 곳으로 배분되어 부족해지니 부품 동작에 지장을 준다.
40.
41.
42.