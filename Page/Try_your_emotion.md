...
[w-inds.](https://ko.wikipedia.org/wiki/w-inds. "wikilink")로서는 처음으로 [올림픽](https://ko.wikipedia.org/wiki/올림픽 "wikilink") 방송에 타이업된 곡이다. 이 싱글의 커플링곡(C/W)은 졸업 노래를 수록하고 있다.
...
**초회한정반 특전**
  ...
  - w-inds. 오리지널 책갈피 (6종류 중 1종)

<!-- end list -->

  -
    ※보통의 3종류와 금색으로 가공한 레어 3종류가 존재한다. 나올 확률은 1/100이다.
    세 번째 싱글까지 한정반 특전의 종류를 뚫려있는 구멍을 통해 보면서 고를 수 있었으나, 이 싱글부터는 완전 랜덤으로 봉입되어 있다.
...
4.  try your emotion ([Instrumental](https://ko.wikipedia.org/wiki/Instrumental "wikilink"))
