...
[조합론](https://ko.wikipedia.org/wiki/조합론 "wikilink")에서, **존슨 결합 도식**(Johnson結合圖式, )은 주어진 [해밍 무게의](https://ko.wikipedia.org/wiki/해밍_무게 "wikilink") 벡터들로 구성된, 2진 [해밍 결합 도식의](../Page/해밍_결합_도식.md "wikilink") 부분 결합 도식이다.
...
다음이 주어졌다고 하자.
  ...
  - 크기 \(n\)의 [유한 집합](https://ko.wikipedia.org/wiki/유한_집합 "wikilink") \(S\)
  - [자연수](https://ko.wikipedia.org/wiki/자연수 "wikilink") \(k\le n\)

그렇다면, 다음을 정의하자.

  - \(X=\operatorname{Pow}_k(S)\)는 \(S\)의, 크기 \(k\)의 [부분 집합들의](https://ko.wikipedia.org/wiki/부분_집합 "wikilink") [집합족](https://ko.wikipedia.org/wiki/집합족 "wikilink")이다.
  - 각 \(i\in\{0,1\dotsc,n\}\) 및 \(u,v\in X\)에 대하여, [이항 관계](https://ko.wikipedia.org/wiki/이항_관계 "wikilink") \(u\sim_iv\iff \operatorname{d_H}(u,v)=2i\) (여기서 \(\operatorname{d_H}\)는 [해밍 거리](https://ko.wikipedia.org/wiki/해밍_거리 "wikilink"))
...
다음이 주어졌다고 하자.
  ...
  - [유한](https://ko.wikipedia.org/wiki/유한_집합 "wikilink") [점을 가진 집합](https://ko.wikipedia.org/wiki/점을_가진_집합 "wikilink") \((\Sigma,\bullet)\) (\(|\Sigma|\ge2\)). 이에 따라, \(\bullet\)에 대하여 [해밍 무게를](https://ko.wikipedia.org/wiki/해밍_무게 "wikilink") 정의할 수 있다.
  - 두 양의 정수 \(0<k\le n\)
...
\(q\)진 존슨 결합 도식 \(\operatorname J_q(k,n)\)은 대칭 결합 도식이며, 그 [집합의 크기는](https://ko.wikipedia.org/wiki/집합의_크기 "wikilink") 다음과 같다.
