...
[섬네일](https://ko.wikipedia.org/wiki/파일:KB_Dubeolsik_for_Old_Hangul_\(NG3\).svg "wikilink") **문자 인코딩**(文字―, ) 또는 줄여서 **인코딩**은 [문자](https://ko.wikipedia.org/wiki/문자 "wikilink")나 [기호](https://ko.wikipedia.org/wiki/기호 "wikilink")들의 집합을 [컴퓨터](../Page/컴퓨터.md "wikilink")에서 표현하는 방법이며 [복호화](../Page/복호화.md "wikilink")가 지닌 본래의 문자나 기호를 뜻하게 되는 [부호를](https://ko.wikipedia.org/wiki/부호_\(정보\) "wikilink") **문자 코드**(文字―, )라고 한다.

문자 인코딩의 대표적인 예로 [전건](https://ko.wikipedia.org/wiki/전건 "wikilink")을 길게, 또는 짧게 두드려서 [라틴 알파벳을](https://ko.wikipedia.org/wiki/라틴_알파벳 "wikilink") 나타내는 [모스 부호가](../Page/모스_부호.md "wikilink") 있으며, 라틴 알파벳, 숫자, 특수 문자 등을 [정수](https://ko.wikipedia.org/wiki/정수 "wikilink")와 그에 대응되는 7[비트](https://ko.wikipedia.org/wiki/비트_\(단위\) "wikilink") [이진수로](https://ko.wikipedia.org/wiki/이진법 "wikilink") 표현하는 방법인 [아스키](https://ko.wikipedia.org/wiki/미국_정보_교환_표준_부호 "wikilink")(ASCII)가 있다.

컴퓨팅 초기에는, [아스키](https://ko.wikipedia.org/wiki/미국_정보_교환_표준_부호 "wikilink")(ASCII, 1963년), [EBCDIC](https://ko.wikipedia.org/wiki/EBCDIC "wikilink")(1964년)과 같은 문자열 세트가 표준으로 자리잡았다. 이러한 문자열 세트의 제한은 명백했으며 수많은 [애드혹](https://ko.wikipedia.org/wiki/Ad_hoc "wikilink")(ad hoc) 방식이 개발되었다. [한중일](https://ko.wikipedia.org/wiki/CJK "wikilink") 계열의 동아시아 스크립트를 포함하여 다중 [문자](https://ko.wikipedia.org/wiki/문자 "wikilink")(언어) 지원이 시급했다.

## 문자 인코딩의 구성

**문자 집합**(character set, charset) 또는 **문자셋**은 정보를 표현하기 위한 글자들의 집합을 정의한 것으로, 직접적으로 사용되지 않을 수도 있고 한 문자 집합을 여러 문자 인코딩에서 쓸 수도 있다. 특히 집합 안의 문자들에 음수가 아닌 정수들을 배정한 것을 **부호화된 문자 집합**(coded character set, CCS)이라 한다. 문자 집합은 ASCII와 같이 더 이상의 문자가 추가될 수 없기도 하고, [유니코드](https://ko.wikipedia.org/wiki/유니코드 "wikilink")와 같이 문자가 계속 추가될 수 있기도 하다.

일반적으로 문자 집합과 문자 인코딩은 어떤 문자를 사용할 수 있으며 어떤 식으로 표현되는지를 나타낸다는 데서 동의어로 취급되기도 한다. 역사적인 이유로 [MIME](https://ko.wikipedia.org/wiki/MIME "wikilink")이나 그에 기반한 시스템은 문자 집합("charset")을 문자 인코딩을 나타내는 데 사용한다.

**문자 인코딩 형태**(character encoding form, CEF)는 특정한 문자 집합 안의 문자들을 컴퓨터 시스템에서 사용할 목적으로 일정한 범위 안의 정수(코드값)들로 변환하는 방법이다. 여기에는 유니코드 코드 포인트를 8비트 숫자의 집합으로 나타내는 [UTF-8](https://ko.wikipedia.org/wiki/UTF-8 "wikilink")이나, 16비트 숫자의 집합으로 나타내는 [UTF-16](https://ko.wikipedia.org/wiki/UTF-16 "wikilink"), 그리고 대부분의 일반적인 문자 인코딩들이 포함된다.
...
## 잘 알려진 문자 인코딩
  ...
  - [JIS X 0208](https://ko.wikipedia.org/wiki/JIS_X_0208 "wikilink") 일본어
      - [Shift JIS](https://ko.wikipedia.org/wiki/Shift_JIS "wikilink") (마이크로소프트 [코드 페이지 932는](https://ko.wikipedia.org/wiki/코드_페이지_932 "wikilink") Shift_JIS의 파생)
  ...
  - [JIS X 0213는](https://ko.wikipedia.org/wiki/JIS_X_0213 "wikilink") JIS X 0208의 확장판.
      - [Shift_JIS](https://ko.wikipedia.org/wiki/Shift_JIS "wikilink")-2004
  ...
  - 한국어
      - [KS X 1001은](https://ko.wikipedia.org/wiki/KS_X_1001 "wikilink") 2바이트 한국어 문자 인코딩 표준이다.
      - [EUC-KR](https://ko.wikipedia.org/wiki/EUC-KR "wikilink")
      - [ISO-2022-KR](https://ko.wikipedia.org/wiki/ISO/IEC_2022 "wikilink")
  - [유니코드](https://ko.wikipedia.org/wiki/유니코드 "wikilink") ([UTF-8](https://ko.wikipedia.org/wiki/UTF-8 "wikilink")도 참조)
