...
푸앵카레-벤딕손 정리는 1차원에서도 (자명하게) 성립한다.\[2\] 즉, \(\mathbb R\)의 [열린집합](https://ko.wikipedia.org/wiki/열린집합 "wikilink") 위에서의 연속 시간 \(\mathcal C^1\) 동역학계에서, 공집합이 아닌, 유한 개의 고정점을 포함하는 콤팩트 연결 \(\omega_+\)-[극한 집합은](../Page/극한_집합.md "wikilink") 다음 두 가지 가운데 하나이다.
...
푸앵카레-벤딕손 정리는 평면의 부분 집합에서만 성립한다. 예를 들어, [원환면](https://ko.wikipedia.org/wiki/원환면 "wikilink") 위에서는 콤팩트 [조밀](https://ko.wikipedia.org/wiki/조밀_집합 "wikilink") 비주기 궤도가 존재할 수 있다. 이 경우, \(\omega_+\)-[극한 집합은](../Page/극한_집합.md "wikilink") 원환면 전체가 된다.
