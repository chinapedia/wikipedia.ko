...
**시스템 아키텍처**(system Architecture)는 [시스템](https://ko.wikipedia.org/wiki/시스템 "wikilink")의 [구조](https://ko.wikipedia.org/wiki/구조 "wikilink"), [행위](https://ko.wikipedia.org/wiki/행동 "wikilink"), 더 많은 [뷰를](https://ko.wikipedia.org/wiki/뷰_모델 "wikilink") 정의하는 [개념적 모형이다](../Page/개념적_모형.md "wikilink").\[1\] 시스템 목적을 달성하기 위해 시스템의 각 [컴포넌트](https://ko.wikipedia.org/wiki/컴포넌트 "wikilink")가 무엇이며 어떻게 [상호작용](https://ko.wikipedia.org/wiki/상호작용 "wikilink")하는지, [정보](https://ko.wikipedia.org/wiki/정보 "wikilink")가 어떻게 교환되는지를 설명한다.
...
디지털 컴퓨터의 발명 이전부터 전자 공학 등 공학에서는 [시스템](https://ko.wikipedia.org/wiki/시스템 "wikilink")이라는 용어를 일반적으로 사용하였다. 그러나 디지털 컴퓨터가 등장하면서 [소프트웨어 공학이](../Page/소프트웨어_공학.md "wikilink") 새로운 분야로 발전하였고 [하드웨어](https://ko.wikipedia.org/wiki/하드웨어 "wikilink")와 [소프트웨어](https://ko.wikipedia.org/wiki/소프트웨어 "wikilink")를 구분하여 다루게 되었다. 프로그램 가능한 하드웨어, 즉 컴퓨터의 하드웨어는 소프트웨어가 없으면 아무것도 할 수 없고 소프트웨어를 하드웨어가 없으면 아무것도 할 수 없다. 하지만 하드웨어와 소프트웨어를 잘 조합하면 다양한 작업을 수행할 수 있다. 따라서 컴퓨터와 소프트웨어를 취급하는 공학 분야에서는 "시스템"이라는 용어가 "유용한 기능을 수행하는 데 필요한 모든 요소(즉 하드웨어와 소프트웨어 모두)을 포함하는 것"이라고 다시 정의되었다.
