...
**몰바이데의 공식**(, Mollweide's formula, -公式)은 [삼각법](https://ko.wikipedia.org/wiki/삼각법 "wikilink")과 [유클리드](https://ko.wikipedia.org/wiki/유클리드_공간 "wikilink") 평면 기하학의 [정리](https://ko.wikipedia.org/wiki/정리 "wikilink")로, 임의의 [삼각형](https://ko.wikipedia.org/wiki/삼각형 "wikilink")에서 두 변의 길이 합 또는 차와 다른 변의 길이를 연관시키는 공식이다. [독일](https://ko.wikipedia.org/wiki/독일 "wikilink") 수학자 [카를 몰바이데](https://ko.wikipedia.org/wiki/카를_몰바이데 "wikilink")(Karl Mollweide)의 이름이 붙어 있다.
...
첫 번째 식만 증명한다. [사인 법칙과](https://ko.wikipedia.org/wiki/사인_법칙 "wikilink") [삼각함수의 합을 곱으로 바꾸는 공식, 배각 공식을](https://ko.wikipedia.org/wiki/삼각함수_항등식 "wikilink") 이용하면
...
## 같이 보기
  ...
  - [사인 법칙](https://ko.wikipedia.org/wiki/사인_법칙 "wikilink")
  - [코사인 법칙](https://ko.wikipedia.org/wiki/코사인_법칙 "wikilink")
