> This article is converted from Wikipedia: [미디어위키:Gadget-navpop.css](https://ko.wikipedia.org/wiki/미디어위키:Gadget-navpop.css).
...
/\* menu magic - many thanks to [User:Zocky](https://ko.wikipedia.org/wiki/User:Zocky "wikilink")\! \*/
...
.popup_drop a, .popup_drop a:visited {
...
/\* other colours, styles and so on \*/ .popup_menu a:hover {
