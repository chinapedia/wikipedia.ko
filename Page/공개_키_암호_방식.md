...
1874년 [윌리엄 스탠리 제본스는](https://ko.wikipedia.org/wiki/윌리엄_스탠리_제본스 "wikilink") 자신의 책에서 단방향 함수와 암호화의 관계에 대해 설명하고 이어 [RSA](https://ko.wikipedia.org/wiki/RSA "wikilink") 시스템 내 [트랩도어 함수](https://ko.wikipedia.org/wiki/트랩도어_함수 "wikilink") 생성에 사용된 [인수 분해](https://ko.wikipedia.org/wiki/인수_분해 "wikilink") 문제를 거론했다.
...
[로널드 라이베스트](../Page/로널드_라이베스트.md "wikilink"), [아디 샤미르](../Page/아디_샤미르.md "wikilink"), [레너드 에이들먼](https://ko.wikipedia.org/wiki/레너드_에이들먼 "wikilink") 세 명은 [MIT](https://ko.wikipedia.org/wiki/MIT "wikilink")에서 콕스가 제안했던 것과 거의 같은 암호방식을 재발견하고 이것을 1978년에 논문으로 썼다. 이들은 자신들의 머리글자를 따서 이 암호방식을 [RSA라고](../Page/RSA_암호.md "wikilink") 이름 지었다. RSA는 두 개의 큰 [소수를](../Page/소수_\(수론\).md "wikilink") 곱한 값 *n*을 이용하여 [모듈로](https://ko.wikipedia.org/wiki/모듈로 "wikilink") 지수승 연산한 것을 각각 암호화와 복호화에 이용하여 공개 키 암호와 공개 키 서명을 수행하는 방식이며, 이 방식을 사용할 경우 보안 수준은 큰 정수의 인수 분해처럼 극도로 어려워 일반적인 기법 중에는 알려진 효과적인 (실용적으로 빠른) 방법이 없다고 가정했다. 1979년, [미하엘 라빈이](https://ko.wikipedia.org/wiki/미하엘_라빈 "wikilink") 공개 키의 인수 분해가 어려울 경우 보안이 검증된 [라빈 암호체계를](../Page/라빈_암호체계.md "wikilink") 발표했는데 RSA의 보안 수준도 동등한 것으로 간주되고 있다.
