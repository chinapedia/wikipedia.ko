...
[군론](https://ko.wikipedia.org/wiki/군론 "wikilink")과 [컴퓨터 과학에서](https://ko.wikipedia.org/wiki/컴퓨터_과학 "wikilink"), **이진 골레 부호**(二進Golay符號, )는 [마티외 군을](../Page/마티외_군.md "wikilink") [자기 동형군으로](https://ko.wikipedia.org/wiki/자기_동형군 "wikilink") 갖는 [이진 선형 부호이다](https://ko.wikipedia.org/wiki/이진_선형_부호 "wikilink").\[1\]\[2\] 매우 높은 최소 거리를 가져, 널리 응용된다.

## 정의

[유한체](https://ko.wikipedia.org/wiki/유한체 "wikilink") \(\mathbb F_2\) 위의 24차원 [벡터 공간](https://ko.wikipedia.org/wiki/벡터_공간 "wikilink") \(\mathbb F_2^{24}\)의 원소를 [사전식 순서로](https://ko.wikipedia.org/wiki/사전식_순서 "wikilink") 배열하자. 즉, 0에서 2<sup>24</sup>−1까지의 [자연수](https://ko.wikipedia.org/wiki/자연수 "wikilink")들의 [이진법](https://ko.wikipedia.org/wiki/이진법 "wikilink") 표기로 여기자. 이제, 다음과 같은 벡터열을 재귀적으로 정의한다.
...
\[w_i=\min\left\{v\in\mathbb F_2^{24}\colon\operatorname{d_H}(v,c)\ge8\forall c\in\operatorname{Span}_{\mathbb F_2}\{w_1,\dotsc,w_{i-1}\}\right\}\qquad(1\le i\le12)\] 여기서
  ...
  - \(\operatorname{d_H}\colon\mathbb F_2^{24}\times\mathbb F_2^{24}\to\{0,1,\dotsc,24\}\)는 [해밍 거리이다](https://ko.wikipedia.org/wiki/해밍_거리 "wikilink").
  - \(\min\)은 [사전식 순서에서의](https://ko.wikipedia.org/wiki/사전식_순서 "wikilink") [최소 원소이다](https://ko.wikipedia.org/wiki/최소_원소 "wikilink").
  - \(\operatorname{Span}_{\mathbb F_2}\varnothing=\{(0,0,\dotsc,0)\}\)

이렇게 얻는 수열은 (벡터를 [이진법](https://ko.wikipedia.org/wiki/이진법 "wikilink") 표기 자연수로 여겼을 때) 다음과 같다.

  -
    255, 3855, 13107, 21845, 38505, 197462, 329059, 591418, 1118584, 2167325, 4265038, 8460068

그렇다면, 이들을 [기저로](https://ko.wikipedia.org/wiki/기저_\(선형대수학\) "wikilink") 하는 12차원 부분 벡터 공간
...
| ------------------------------------------------------- | ------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------- | ------- | ----------- |
| 0                                                       | 1                         | [대칭군](https://ko.wikipedia.org/wiki/대칭군_\(군론\) "wikilink") \(\operatorname{Sym}(24)\)                                                                                                                               | 24\!                                                      | 영벡터     |             |
| 8                                                       | 759=3×11×23               | \(\operatorname{IGL}(4;\mathbb F_2)\cong\mathbb F_2^4\rtimes\operatorname{GL}(4;\mathbb F_2)\) (\(\operatorname{GL}(4;\mathbb F_2)\cong\operatorname{Alt}(8)\) [교대군](https://ko.wikipedia.org/wiki/교대군 "wikilink")) | 32560                                                     | 옥타드()   |             |
...
\[\operatorname{Aut}(G_{23})=\{\sigma\in\operatorname{Sym}(24)\colon \sigma\cdot G_{23}=G_23\}\cong M_{23}\] 여기서
  ...
  - \(\operatorname{Sym}(n)\)은 \(n\)차 [대칭군이다](https://ko.wikipedia.org/wiki/대칭군_\(군론\) "wikilink").
  - [순열](https://ko.wikipedia.org/wiki/순열 "wikilink") \(\sigma\in\operatorname{Sym}(n)\)의 \(\mathbb F_2^n\) 위의 [작용은](https://ko.wikipedia.org/wiki/군의_작용 "wikilink") \(\sigma\cdot(s_0,s_1,\dotsc,s_{n-1})=(\sigma(s_0),\sigma(s_1),\dotsc,\sigma(s_{n-1}))\)이다.

\(M_{24}\)의, 옥타드 집합 위의 [작용은](https://ko.wikipedia.org/wiki/군의_작용 "wikilink") [추이적 작용이다](https://ko.wikipedia.org/wiki/추이적_작용 "wikilink"). 마찬가지로, \(M_{24}\)의, 도데카드 집합 위의 [작용](https://ko.wikipedia.org/wiki/군의_작용 "wikilink") 역시 [추이적 작용이다](https://ko.wikipedia.org/wiki/추이적_작용 "wikilink").
...
이진 골레 부호의 옥타드의 집합은 비트 설계는 1931년에 [로버트 대니얼 카마이클이](https://ko.wikipedia.org/wiki/로버트_대니얼_카마이클 "wikilink") 최초로 발견하였으며,\[4\] [에른스트 비트가](../Page/에른스트_비트.md "wikilink") 1938년에 [마티외 군을](../Page/마티외_군.md "wikilink") 연구하던 도중 재발견하였다.\[5\]

이후 스위스의 수학자 마르셀 쥘 에두아르 골레(, 1902\~1989)가 1949년에 1쪽도 채 되지 않는 “논문”에서 이진 골레 부호를 ([삼진 골레 부호와](https://ko.wikipedia.org/wiki/삼진_골레_부호 "wikilink") 함께) 도입하였다.\[6\]

1979\~1981년에 [보이저 1호와](https://ko.wikipedia.org/wiki/보이저_1호 "wikilink") [보이저 2호는](https://ko.wikipedia.org/wiki/보이저_2호 "wikilink") [목성](https://ko.wikipedia.org/wiki/목성 "wikilink")과 [토성](https://ko.wikipedia.org/wiki/토성 "wikilink")의 천연색 사진을 전송하기 위하여 확장 이진 골레 부호를 사용하였다. (흑백 사진은 [아다마르 부호를](https://ko.wikipedia.org/wiki/아다마르_부호 "wikilink") 사용하여 전송되었다.)
