...
[:틀:문자표-표형식](https://ko.wikipedia.org/wiki/:틀:문자표-표형식 "wikilink")과 함께 사용해 **[제어 문자](https://ko.wikipedia.org/wiki/제어_문자 "wikilink")**나 인쇄되지 않는 **[구두점](https://ko.wikipedia.org/wiki/구두점 "wikilink")**을 담은 칸을 나타내기 위해 사용한다.

  - 매개변수 1: *hhhh*, 4자리 16진 유니코드 값 (예: *0020*)
  - 매개변수 2: *XX*, 문자 이름(예: *SP*). 적절한 문헌으로의 링크를 포함할 수 있다.
  - 매개변수 3: *dd*, 1 - 3자리의 십진 문자 코드(예: *32*)

예를 들어, [ASCII](https://ko.wikipedia.org/wiki/ASCII "wikilink")의 첫 네 제어 문자([유니코드](https://ko.wikipedia.org/wiki/유니코드 "wikilink") U+0000에서 U+0003, 십진수로 0에서 3)는 다음과 같이 행들로 표시될 수 있다.
