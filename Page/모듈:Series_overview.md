...
\-- Sorting function function SeriesOverview.series_sort(op1, op2)
...
`               :wikitext(entry.link and '`[`'``   ``..``   ``(entry.linkT``   ``or``   ``season)``   ``..``   ``'`](https://ko.wikipedia.org/wiki/'_.._entry.link_.._' "wikilink")`' or (entry.linkT or season))`
`       `
`           -- Aux cells`
`           for i = string.byte('A'), string.byte('Z') do`
`               local param = 'aux' .. string.char(i)`
...
[Category:Articles_using_Template:Series_overview_with_only_one_row](https://ko.wikipedia.org/wiki/Category:Articles_using_Template:Series_overview_with_only_one_row "wikilink") [Category:Articles_using_Template:Series_overview_with_empty_start_date](https://ko.wikipedia.org/wiki/Category:Articles_using_Template:Series_overview_with_empty_start_date "wikilink")