...
[섬네일](https://ko.wikipedia.org/wiki/파일:OpenBoot_on_UltraSparc5.png "wikilink") **오픈 펌웨어**(Open Firmware) 또는 **오픈부트**(OpenBoot)는 하드웨어에 의존하지 않는 [펌웨어](https://ko.wikipedia.org/wiki/펌웨어 "wikilink")([운영 체제를](https://ko.wikipedia.org/wiki/운영_체제 "wikilink") 불러 내는 [소프트웨어](https://ko.wikipedia.org/wiki/소프트웨어 "wikilink"))이며, [썬마이크로시스템](https://ko.wikipedia.org/wiki/썬마이크로시스템 "wikilink")의 Mitch Bradley가 개발하였다. 이 소프트웨어는 애플의 [NuBus](https://ko.wikipedia.org/wiki/NuBus "wikilink") 이후의 [파워피시](https://ko.wikipedia.org/wiki/파워피시 "wikilink") 기반의 매킨토시, 썬마이크로시스템의 SPARC 기반의 워크스테이션과 서버, [IBM](https://ko.wikipedia.org/wiki/IBM "wikilink")의 [파워](https://ko.wikipedia.org/wiki/IBM_파워 "wikilink") 아키텍처의 계산기 시스템, [Pegasos](https://ko.wikipedia.org/wiki/Pegasos "wikilink")의 계산기 시스템, 그리고 [OLPC](https://ko.wikipedia.org/wiki/OLPC "wikilink")가 설계한 노트북 등, 여러 기종에 채택되어 쓰였다. 이 소프트웨어는 [BSD](https://ko.wikipedia.org/wiki/BSD "wikilink") 라이선스 하에서 이용할 수 있다. 공개되어 있는 파워 아키텍처 플랫폼 레퍼런스(Power Architecture Platform Reference)에서도 오픈 펌웨어 기반의 플랫폼이다. 이러한 플랫폼에서 오픈 펌웨어는 [개인용 컴퓨터의](https://ko.wikipedia.org/wiki/개인용_컴퓨터 "wikilink") [바이오스](https://ko.wikipedia.org/wiki/바이오스 "wikilink") 동작과 완전히 같다고 볼 수 있다.
...
오픈 펌웨어의 Forth 코드는 [FCode](https://ko.wikipedia.org/wiki/FCode "wikilink")(어떤 바이트코드)로 컴파일되며 특정의 [컴퓨터 아키텍처에](https://ko.wikipedia.org/wiki/컴퓨터_아키텍처 "wikilink") 의존한 [기계어](https://ko.wikipedia.org/wiki/기계어 "wikilink")로는 변환되지 않는다. 다시 말해, 어느 입출력 카드용 코드를 포함하고 있는 오픈 펌웨어는 다른 오픈 펌웨어를 사용하는 어떤 시스템 위에서도 동작한다. 이 방법에 따라 어느 입출력 카드를 시동하면, 진단, 설정 코드, 그리고 장치 드라이버는 다른 오픈 펌웨어가 동작하는 시스템 위에서도 사용할 수 있다. 따라서, 많은 입출력 카드가 썬의 머신과 매킨토시 두 군데 모두 동작한다.
...
## 함께 보기
  ...
  - [바이오스](https://ko.wikipedia.org/wiki/바이오스 "wikilink")
