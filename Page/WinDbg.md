...
**WinDbg**는 [마이크로소프트 윈도우의](../Page/마이크로소프트_윈도우.md "wikilink") 다용도 [디버거](../Page/디버거.md "wikilink")이다.\[1\] [디버깅은](../Page/디버그.md "wikilink") 시스템의 오류들을 찾고 분석하는 과정으로서, 또한 개발을 돕는 용도로서 소프트웨어의 내부 동작을 탐색하는 것도 포함한다. 이것은 [유저 모드](../Page/사용자_공간.md "wikilink") 애플리케이션, [장치 드라이버](../Page/장치_드라이버.md "wikilink"), 그리고 [커널 모드에서](../Page/보호_링.md "wikilink") 운영체제 자체를 디버깅하는 데 사용될 수 있다. [비주얼 스튜디오 디버거](https://ko.wikipedia.org/wiki/비주얼_스튜디오_디버거 "wikilink") 처럼 [그래픽 사용자 인터페이스](../Page/그래픽_사용자_인터페이스.md "wikilink") (GUI)를 가지지만 더 강력하다.

WinDbg는 버그 체크 시 발생하는 [블루 스크린](https://ko.wikipedia.org/wiki/블루_스크린 "wikilink") 이후 생성되는 커널 모드 [메모리 덤프를](../Page/코어_덤프.md "wikilink") 디버깅할 때 사용될 수 있다.\[2\] 또한 유저 모드 충돌 덤프를 디버깅하는데도 사용될 수 있는데, 이것은 [사후 분석 디버깅이라고](../Page/디버그.md "wikilink") 알려져 있다.\[3\]
...
Wow6432exts는 WinDbg와 함께 출시되는 표준 윈도우 디버거 확장으로서, [WOW64](../Page/WOW64.md "wikilink") 내에서 실행중인 프로세스들을 디버깅할 때 사용된다.\[8\]
...
WinDbg는 [VM웨어](../Page/VM웨어.md "wikilink"), [윈도우 가상 PC](../Page/윈도우_가상_PC.md "wikilink")(VPC) 또는 [페러럴즈](https://ko.wikipedia.org/wiki/페러럴즈 "wikilink") 같은 [명명된 파이프를](../Page/명명된_파이프.md "wikilink") 사용하는 [가상 머신](../Page/가상_머신.md "wikilink") 위에 돌아가는 윈도우 커널을 디버깅할 수 있다. 이것은 가상 COM port를 사용함으로써 가능해 진다.\[12\] [윈도우 8](../Page/윈도우_8.md "wikilink") 이후로는 특별한 설정 없이 빠른 [커널 디버깅을](../Page/커널_디버거.md "wikilink") 가능케 하면서, 네트워크를 통한 커널 디버깅이 허용된다.\[13\]
