...
[계산 이론에서](https://ko.wikipedia.org/wiki/계산_이론 "wikilink"), **재귀적 열거 가능 집합**(Recursively enumberable set), **귀납적 가산 집합**(歸納的可算集合)은 다음 조건을 만족하는 집합 S를 말한다.
  ...
  - 집합 S의 모든 원소에 대해서만 진리값 참을 내놓는 [알고리즘](https://ko.wikipedia.org/wiki/알고리즘 "wikilink")이 존재한다. (**r.e.**)
...
[계산 복잡도 이론에서](https://ko.wikipedia.org/wiki/계산_복잡도_이론 "wikilink") 이와 같은 집합을 모임 [RE (복잡도)로](https://ko.wikipedia.org/wiki/RE_\(복잡도\) "wikilink") 분류한다. (**c.e.**)
...
## 예시
  ...
  - [재귀적으로 열거가능한 언어는](../Page/재귀_열거_언어.md "wikilink") [형식 언어의](https://ko.wikipedia.org/wiki/형식_언어 "wikilink") 재귀적으로 열거가능한 부분집합이다.
