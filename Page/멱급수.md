...
[수학](https://ko.wikipedia.org/wiki/수학 "wikilink")에서, **멱급수**(冪級數, ) 또는 **거듭제곱 급수**는 주어진 [변수](https://ko.wikipedia.org/wiki/변수 "wikilink")를 거듭제곱한 항들의 [무한급수](https://ko.wikipedia.org/wiki/무한급수 "wikilink")(무한차 [다항식](https://ko.wikipedia.org/wiki/다항식 "wikilink"))이자 중심이 같은 일련의 [멱함수](../Page/멱함수.md "wikilink")들을 항으로 하는 [무한 급수이다](https://ko.wikipedia.org/wiki/무한_급수 "wikilink").

## 정의

[체](https://ko.wikipedia.org/wiki/체_\(수학\) "wikilink") \(\mathbb K\in\{\mathbb R,\mathbb C\}\)가 [실수체](https://ko.wikipedia.org/wiki/실수체 "wikilink") 또는 [복소수체](https://ko.wikipedia.org/wiki/복소수체 "wikilink")라고 하자.
...
\[\sum_{n=0}^\infty a_n(x-x_0)^n\qquad(x_0,a_0,a_1,a_2,\dots\in\mathbb K)\] 의 수렴 반지름이 \(0<r<\infty\)이고, 이 멱급수가 수렴 영역의 경계점 \(\xi\in\partial\operatorname{ball}_{\mathbb K}(x_0,r)\)에서 수렴한다고 하자. **[아벨 극한 정리](https://ko.wikipedia.org/wiki/아벨_극한_정리 "wikilink")**에 따르면, 임의의 \(0<K<\infty\)에 대하여,

\[\lim_{{x\to\xi}\atop{{|x-x_0|<r}\atop{|\xi-x|\le K(|\xi-x_0|-|x-x_0|)}}}\sum_{n=0}^\infty a_n(x-x_0)^n=\sum_{n=0}^\infty a_n(\xi-x_0)^n\] 이다.\[9\] 특히,

\[\lim_{t\to 1^-}\sum_{n=0}^\infty a_n(t(\xi-x_0))^n=\sum_{n=0}^\infty a_n(\xi-x_0)^n\] 이 성립한다. 이에 따라, [실수](https://ko.wikipedia.org/wiki/실수 "wikilink") 멱급수는 (수렴하는 경계점을 포함한) 수렴 영역 전체에서 [연속 함수이며](https://ko.wikipedia.org/wiki/연속_함수 "wikilink"), [복소수](https://ko.wikipedia.org/wiki/복소수 "wikilink") 멱급수는 수렴하는 경계점 수렴 영역 [내부의](https://ko.wikipedia.org/wiki/내부_\(위상수학\) "wikilink") 다른 두 점을 꼭짓점으로 하는 임의의 [닫힌](https://ko.wikipedia.org/wiki/닫힌집합 "wikilink") 삼각형에서 연속 함수이다.

### 해석 함수와의 관계

[열린집합](../Page/열린집합.md "wikilink")의 모든 열린원판에서 중심이 열린원판의 중심인 수렴하는 멱급수로 전개되는 함수를 [해석 함수라고](https://ko.wikipedia.org/wiki/해석_함수 "wikilink") 한다. 특히, 모든 멱급수는 수렴 영역의 내부에서 해석 함수이다. 만약 \(\mathbb K=\mathbb C\)일 경우, 해석 함수와 [미분 가능 함수의](https://ko.wikipedia.org/wiki/미분_가능_함수 "wikilink") 개념은 일치하며, 이를 다른 말로 [정칙 함수라고도](../Page/정칙_함수.md "wikilink") 한다. 그러나 만약 \(\mathbb K=\mathbb R\)일 경우, 모든 계의 도함수를 갖는 함수는 해석 함수보다 약한 개념이다.

[연결](../Page/연결_공간.md "wikilink") 열린집합 \(D\subseteq\mathbb K\)에 정의된 해석 함수 \(f\colon D\to\mathbb K\)의 열린원판 \(\operatorname{ball}_{\mathbb K}(x_0,r)\subseteq D\)에서의 멱급수 전개는 [테일러 급수](https://ko.wikipedia.org/wiki/테일러_급수 "wikilink")
...
\[\inf_{x\in\partial D}|x-x_0|<r''<r'\] 이 존재한다면, \(f\)는 \(x_0\)에서의 멱급수 전개를 통해 \(D\)를 포함하는 더 큰 연결 열린집합 \(D\cup\operatorname{ball}_{\mathbb K}(x_0,r'')\) 위의 해석 함수로 [확장될](https://ko.wikipedia.org/wiki/해석적_연속 "wikilink") 수 있다. 즉, \(D\cup\operatorname{ball}_{\mathbb K}(x_0,r'')\) 위에서 \(f\)의 [해석적 연속이](https://ko.wikipedia.org/wiki/해석적_연속 "wikilink") 존재한다. 주어진 해석 함수가 주어진 더 큰 정의역 위에서 해석적 연속을 갖는다면 이는 유일하다. 그러나 만약 \(\mathbb K=\mathbb C\)일 경우, 위와 같은 확장 과정을 어떤 [닫힌 곡선을](https://ko.wikipedia.org/wiki/닫힌_곡선 "wikilink") 따라 반복하면 일반적으로 [다가 함수를](../Page/다가_함수.md "wikilink") 얻는다. (이 과정을 닫힌 곡선을 따라 반복하려면, \(D\cup\operatorname{ball}_{\mathbb K}(x_0,r'')\)에 정의된 함수를 확장하는 것이 아니라, \(\operatorname{ball}_{\mathbb K}(x_0,r'')\)에 정의된 함수를 확장하여야 하며, 다음 단계들도 마찬가지다.) 일가 함수를 얻을 한 가지 충분 조건은 [모노드로미 정리에서](https://ko.wikipedia.org/wiki/모노드로미_정리 "wikilink") 제시된다.

### 특이점

[복소수](https://ko.wikipedia.org/wiki/복소수 "wikilink") 멱급수
