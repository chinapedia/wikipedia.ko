> This article is converted from Wikipedia: [LG G  8.0](https://ko.wikipedia.org/wiki/LG_G__8.0).


**LG G패드 8.0** (LG G pad 8.0)은 [LG전자](https://ko.wikipedia.org/wiki/LG전자 "wikilink")가 [2014년](https://ko.wikipedia.org/wiki/2014년 "wikilink") [5월 12일](https://ko.wikipedia.org/wiki/5월_12일 "wikilink") 공개된 [안드로이드](https://ko.wikipedia.org/wiki/안드로이드_\(운영_체제\) "wikilink") [태블릿으로](https://ko.wikipedia.org/wiki/태블릿_컴퓨터 "wikilink"), **[LG G 패드 8.3](../Page/LG_G_패드_8.3.md "wikilink")**의 후속 기종이다. 와이파이 전용 모델과 LTE 모델이 존재한다.

## 운영체제/소프트웨어

  - [롤리팝이](https://ko.wikipedia.org/wiki/안드로이드_버전_역사 "wikilink") 3월 3일 업데이트 되었다.
...
## 경쟁 기종
  ...
  - [삼성전자](https://ko.wikipedia.org/wiki/삼성전자 "wikilink")의 [갤럭시 탭 S2](https://ko.wikipedia.org/wiki/갤럭시_탭_S2 "wikilink")
