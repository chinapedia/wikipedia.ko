...
[역제어](https://ko.wikipedia.org/wiki/제어_반전 "wikilink")(IoC)는 DI보다 더 일반적이다. 간단하게 말하자면 IoC는 호출을 요구하는 대신 다른 코드가 호출할 수 있게 함을 의미한다. DI가 없는 IoC의 한 예로 [템플릿 메소드 패턴이](https://ko.wikipedia.org/wiki/템플릿_메소드_패턴 "wikilink") 있다. 여기서 [다형성은](../Page/다형성_\(컴퓨터_과학\).md "wikilink") [서브클래싱](https://ko.wikipedia.org/wiki/상속_\(객체_지향_프로그래밍\)#%EC%84%9C%EB%B8%8C%ED%81%B4%EB%9E%98%EC%8A%A4%EC%99%80_%EC%88%98%ED%8D%BC%ED%81%B4%EB%9E%98%EC%8A%A4 "wikilink"), 즉, [상속을](../Page/상속_\(객체_지향_프로그래밍\).md "wikilink") 통해 달성된다.\[10\]
...
[CDI](http://cdi-spec.org/)와 그 구현물인 [Weld](http://weld.cdi-spec.org/), [Spring](../Page/스프링_프레임워크.md "wikilink"), [Guice](https://ko.wikipedia.org/wiki/:en:Guice "wikilink"), [Play framework](https://ko.wikipedia.org/wiki/플레이_프레임워크 "wikilink"), [Salta](https://ruediste.github.io/salta/), [Glassfish HK2](https://ko.wikipedia.org/wiki/:en:HK2_DI_Kernel "wikilink"), [Dagger](https://google.github.io/dagger/), [Managed Extensibility Framework](https://ko.wikipedia.org/wiki/:en:Managed_Extensibility_Framework "wikilink")(MEF)와 같은 [애플리케이션 프레임워크는](https://ko.wikipedia.org/wiki/애플리케이션_프레임워크 "wikilink") 의존성 주입을 지원하지만 필수는 아니다.\[12\]\[13\]
...
### 장점
  ...
  - 의존성 주입은 코드의 동작에서의 어떠한 변경도 요구하지 않으므로 [리팩터링](../Page/리팩터링.md "wikilink")으로써 레거시 코드에도 적용할 수 있다. 클라이언트는 더 독립적이며 테스트에 속하지 않은 다른 객체를 가장하는 [stubs](../Page/메소드_스텁.md "wikilink") 또는 [모의 객체를](https://ko.wikipedia.org/wiki/모의_객체 "wikilink") 사용해 독립된 [유닛 테스트가](../Page/유닛_테스트.md "wikilink") 더 쉬워지는 결과를 얻는다.
...
## 의존성 주입의 이점
  ...
  - [모의 객체](https://ko.wikipedia.org/wiki/모의_객체 "wikilink") 등을 이용한 [단위 테스트의](../Page/유닛_테스트.md "wikilink") 편의성을 높여준다.
