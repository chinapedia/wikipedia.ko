...
이전 [파일 할당 테이블](../Page/파일_할당_테이블.md "wikilink") (FAT) 파일 시스템 버전과 견주어 나아진 점은 다음과 같다:
  ...
  - [UTC](../Page/협정_세계시.md "wikilink") 시간표 지원 ([비스타 SP2부터](../Page/윈도우_비스타.md "wikilink") 지원)\[12\]
...
## 외부 링크
  ...
  - [Personal Storage: Opportunities and challenges for pocket-sized storage devices in the Windows world](http://download.microsoft.com/download/5/b/9/5b97017b-e28a-4bae-ba48-174cf47d23cd/STO072_WH06.ppt) ([마이크로소프트 파워포인트](../Page/마이크로소프트_파워포인트.md "wikilink") 프레젠테이션)
