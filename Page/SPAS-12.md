...
화기는 성능을 높이기 위해 개조를 거쳐 좀 더 좋게 변형시키는 작업을 거친다. SPAS-12 또한 마찬가지로 [접철식 개머리판이](https://ko.wikipedia.org/wiki/접철식_개머리판 "wikilink") 있으며, 일반 개머리가 존재한다. 그리고 전등 또는 레이저 조준기를 달수도 있는데, 때때로 SPAS-12의 변형 중의 일부는 5발들이 탄창을 쓰기도 한다.

  - **SPAS-12** : 개머리판이 없는 기본형이다.
  - **SPAS-12S** : 접철식 개머리판을 장착한 모델이다.

## 같이 보기

  - [산탄총 목록](https://ko.wikipedia.org/wiki/산탄총_목록 "wikilink")
  - [SPAS-15](https://ko.wikipedia.org/wiki/SPAS-15 "wikilink")

## 외부 링크

  - [현대화기](https://web.archive.org/web/20081104034805/http://world.guns.ru/shotgun/sh14-e.htm)
