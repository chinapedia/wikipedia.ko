...
스킴 \(X\) 및 [아벨 군](https://ko.wikipedia.org/wiki/아벨_군 "wikilink") \(G\)가 주어졌을 때, \(X\)의 \(G\) 계수를 갖는 **에탈 코호몰로지 군** \(H^i_{\operatorname{\acute et}}(X,G)\)는 [상수층](../Page/상수층.md "wikilink") \(\underline G\)의 에탈 코호몰로지 군 \(H^i_{\operatorname{\acute et}}(X;\underline G)\)이다. (다만, \(G=\mathbb Z_\ell\)일 때, 통상적으로 \(H^i(X;\mathbb Z_\ell)\)은 \(H^i_{\operatorname{\acute et}}(X;\underline{\mathbb Z_\ell})\)과 다른, ℓ진 코호몰로지를 나타낸다.)
...
[알렉산더 그로텐디크가](https://ko.wikipedia.org/wiki/알렉산더_그로텐디크 "wikilink"), [유한체](https://ko.wikipedia.org/wiki/유한체 "wikilink")에 대한 [대수다양체](https://ko.wikipedia.org/wiki/대수다양체 "wikilink")에 대한 일련의 추측들인 [베유 추측을](../Page/베유_추측.md "wikilink") 증명하기 위하여 1960년에 도입하였다.\[7\]
