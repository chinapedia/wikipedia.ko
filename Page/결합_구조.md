...
[thumb](https://ko.wikipedia.org/wiki/파일:Incidencestructure.svg "wikilink") [기하학](https://ko.wikipedia.org/wiki/기하학 "wikilink")에서, **결합 구조**(結合構造, )는 두 [집합](https://ko.wikipedia.org/wiki/집합 "wikilink") 및 그 사이의 어떤 [이항 관계로](https://ko.wikipedia.org/wiki/이항_관계 "wikilink") 구성된 수학적 구조이다. 일부 경우, 이는 각각 점과 직선으로 이루어진 기하계로 해석될 수 있다.
...
결합 구조 \((X,L,\vartriangleleft)\)가 주어졌으며, \(X\)와 \(L\)이 둘 다 [유한 집합이라고](https://ko.wikipedia.org/wiki/유한_집합 "wikilink") 하자. \(X\)와 \(L\) 위에 각각 임의의 [전순서](https://ko.wikipedia.org/wiki/전순서 "wikilink")를 부여하여

\[X=\{x_1,x_2,\dotsc,x_m\}\]

\[L=\{l_1,l_2,\dotsc,l_n\}\] 로 적자. 그렇다면, 다음과 같은 \(m\times n\) [행렬](https://ko.wikipedia.org/wiki/행렬 "wikilink")을 정의할 수 있으며, 이를 결합 구조 \((X,L,\vartriangleleft)\)의 **결합 행렬**(結合行列, )이라고 한다.
...
결합 구조 \((X,L,\vartriangleleft)\)가 주어졌을 때, 다음과 같은, 검은색 및 흰색의 [그래프 색칠을](https://ko.wikipedia.org/wiki/그래프_색칠 "wikilink") 갖는 [이분 그래프를](https://ko.wikipedia.org/wiki/이분_그래프 "wikilink") 정의할 수 있다.
...
임의의 [리만 다양체](https://ko.wikipedia.org/wiki/리만_다양체 "wikilink") \((X,g)\)가 주어졌을 때,

  - 점을 \(X\)의 원소로 삼으며,
  - 직선을 \((X,g)\)의 (확장 불가능) [측지선](https://ko.wikipedia.org/wiki/측지선 "wikilink")으로 삼으며,
...
**[일반화 다각형](https://ko.wikipedia.org/wiki/일반화_다각형 "wikilink")**은 [사영 평면의](../Page/사영_평면.md "wikilink") 일반화이며, 특별한 종류의 준선형 공간이다.
