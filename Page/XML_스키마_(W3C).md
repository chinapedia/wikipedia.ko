...
다른 더 특수화된 구성요소들로 주석(annotations), [표명](https://ko.wikipedia.org/wiki/표명 "wikilink")(assertions), 표기법(notations), 스키마 전체에 대한 정보를 포함하는 **스키마 구성요소(schema component)**가 있다.
