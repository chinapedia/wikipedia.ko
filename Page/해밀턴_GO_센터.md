...
해밀턴 GO 센터에 정차하는 버스는 아래와 같으며 GO 트랜싯 버스나 통근 열차에서 HSR 버스로 갈아타는 경우 환승 할인이 적용되어 HSR 요금은 1달러 70센트만 지불하면 된다. 한편 HSR에서 벌링턴 교통국 버스로는 무료 환승이 가능하다.
...
<td><p> 해밀턴 GO 센터</br>    <a href="../Page/앨더샷역_(온타리오주).md" title="wikilink">앨더샷역</a></br>  벌링턴역</br>   <a href="../Page/오크빌역.md" title="wikilink">오크빌역</a></br>   <a href="../Page/클락슨역_(온타리오주).md" title="wikilink">클락슨역</a></br>  <a href="../Page/포트크레딧역.md" title="wikilink">포트크레딧역</a></br>       <a href="../Page/유니언역_버스_터미널.md" title="wikilink">유니언역 버스 터미널</a> </p></td>
</tr>
<tr class="even">
<td><p>18E</p></td>
...
<td><p>  해밀턴 GO 센터</br>    <a href="https://ko.wikipedia.org/wiki/스퀘어원_버스_터미널" title="wikilink">스퀘어원 버스 터미널</a></br> </p></td>
</tr>
<tr class="even">
<td><p>47</p></td>
<td><p>407 웨스트</p></td>
...
| 노선 | 종점    | 경유 도로      | 경유역        | 비고                                     |
| -- | ----- | ---------- | ---------- | -------------------------------------- |
| 1  | 킹     | King       | 해밀턴 GO 센터  | <span style="font-size:140%;">↔</span> |
| 2  | 바튼    | Barton     | 해밀턴 GO 센터  | <span style="font-size:140%;">↔</span> |
| 3  | 캐논    | Cannon     | 해밀턴 GO 센터  | <span style="font-size:140%;">↔</span> |
| 51 | 유니버시티 | University | 웨스트 해밀턴 루프 | <span style="font-size:140%;">↔</span> |
...
## 외부 링크
  ...
  -
  - [GO 트랜싯 해밀턴 GO 센터 홈페이지](https://www.gotransit.com/en/stations-stops-parking/find-a-station-or-stop?station=HMGO)

[분류:GO 트랜싯](https://ko.wikipedia.org/wiki/분류:GO_트랜싯 "wikilink") [분류:온타리오주의 철도역](https://ko.wikipedia.org/wiki/분류:온타리오주의_철도역 "wikilink") [분류:1933년 개업한 철도역](https://ko.wikipedia.org/wiki/분류:1933년_개업한_철도역 "wikilink")