> This article is converted from Wikipedia: [모듈:EditAtWikidata](https://ko.wikipedia.org/wiki/모듈:EditAtWikidata).
...
`       return`
`           space .. "[[파일:OOjs UI icon edit-ltr-progressive.svg |frameless |text-top |10px |alt=" ..`
`           i18n.message ..`
