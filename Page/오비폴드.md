...
오비폴드 \(M/G\)가, [매끄러운 다양체](../Page/매끄러운_다양체.md "wikilink") \(M\) 위의 어떤 [이산군](https://ko.wikipedia.org/wiki/이산군 "wikilink") \(G\)의 [매끄럽고](../Page/매끄러운_함수.md "wikilink") [충실한 작용에](https://ko.wikipedia.org/wiki/충실한_작용 "wikilink") 의한 [몫공간](../Page/몫공간.md "wikilink")이라고 하자. 이 경우, \(M/G\)의 **(끈 이론) [오일러 지표](../Page/오일러_지표.md "wikilink")**는 다음과 같다.\[2\]
...
2차원 연결 콤팩트 오비폴드는 [곡면](https://ko.wikipedia.org/wiki/곡면 "wikilink")과 마찬가지로 오일러 지표의 부호에 따라서 다음과 같이 세 종류로 분류된다.
  ...
  - 오일러 지표가 양수인 2차원 오비폴드 가운데, 축소 오비폴드로 나타낼 수 있는 것들은 **타원형 오비폴드**()라고 한다. 이들은 [구의](../Page/구_\(기하학\).md "wikilink") [쪽매맞춤](https://ko.wikipedia.org/wiki/쪽매맞춤 "wikilink")에 대응한다. 7개의 무한한 족 및 족에 속하지 않는 10개가 있다.
...
사타케 이치로()가 1956년에 ‘*V*-다양체’()라는 이름으로 정의하였다.\[10\] [윌리엄 서스턴이](../Page/윌리엄_서스턴.md "wikilink") 1980년 재발견하였고, ‘오비폴드’()라는 이름을 붙였다.\[11\]
