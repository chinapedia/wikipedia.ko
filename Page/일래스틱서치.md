...
**일래스틱서치**(Elasticsearch)는 [루씬](../Page/루씬.md "wikilink") 기반의 [검색 엔진이다](https://ko.wikipedia.org/wiki/검색_엔진_\(컴퓨팅\) "wikilink"). [HTTP](https://ko.wikipedia.org/wiki/HTTP "wikilink") 웹 인터페이스와 스키마에서 자유로운 [JSON](https://ko.wikipedia.org/wiki/JSON "wikilink") 문서와 함께 분산 [멀티테넌트](../Page/멀티테넌시.md "wikilink") 지원 전문 검색 엔진을 제공한다. 일래스틱서치는 [자바로](https://ko.wikipedia.org/wiki/자바_\(프로그래밍_언어\) "wikilink") 개발되어 있으며 [아파치 라이선스](https://ko.wikipedia.org/wiki/아파치_라이선스 "wikilink") 조항에 의거하여 [오픈 소스로](https://ko.wikipedia.org/wiki/오픈_소스_소프트웨어 "wikilink") 출시되어 있다. 공식 클라이언트들은 [자바](https://ko.wikipedia.org/wiki/자바_\(프로그래밍_언어\) "wikilink"), [닷넷](https://ko.wikipedia.org/wiki/닷넷_프레임워크 "wikilink")([C\#](https://ko.wikipedia.org/wiki/C_샤프 "wikilink")), [PHP](https://ko.wikipedia.org/wiki/PHP "wikilink"), [파이썬](https://ko.wikipedia.org/wiki/파이썬 "wikilink"), [그루비](https://ko.wikipedia.org/wiki/그루비 "wikilink") 등 수많은 언어로 이용이 가능하다.\[1\] 일래스틱서치는 가장 대중적인 엔터프라이즈 검색 엔진으로 그 뒤를 루씬 기반의 [Apache Solr가](https://ko.wikipedia.org/wiki/Apache_Solr "wikilink") 잇는다.\[2\]
...
그 밖의 기능으로 "게이트웨이"가 있으며 장기간의 인덱스 지속성을 관리한다.\[76\] 이를테면 인덱스는 서버 충돌 시에 게이트웨이로부터 복구할 수 있다. 일래스틱서치는 실시간 [GET 요청을](https://ko.wikipedia.org/wiki/GET_요청 "wikilink") 지원하므로 [NoSQL](../Page/NoSQL.md "wikilink") 데이터스토어의 역할에 적합하지만\[77\] [분산 트랜잭션](https://ko.wikipedia.org/wiki/분산_트랜잭션 "wikilink") 면에서는 부족하다.\[78\]
...
일래스틱의 사용처로는 대표적으로 다음과 같다.\[79\]:
  ...
  - [페이스북](https://ko.wikipedia.org/wiki/페이스북 "wikilink")\[84\]
  - [FDA](https://ko.wikipedia.org/wiki/미국_식품의약국 "wikilink")\[85\]
  - [포스퀘어](https://ko.wikipedia.org/wiki/포스퀘어 "wikilink")\[86\]
  - [깃허브](https://ko.wikipedia.org/wiki/깃허브 "wikilink")\[87\]
  - [Lichess](https://ko.wikipedia.org/wiki/Lichess "wikilink")\[88\]
  - [모질라](https://ko.wikipedia.org/wiki/모질라 "wikilink")\[89\]
  - [넷플릭스](../Page/넷플릭스.md "wikilink")\[90\]
  - [Pixabay](https://ko.wikipedia.org/wiki/Pixabay "wikilink")\[91\]
  ...
  - [사운드클라우드](https://ko.wikipedia.org/wiki/사운드클라우드 "wikilink")\[95\]
  - [스택 익스체인지](https://ko.wikipedia.org/wiki/스택_익스체인지 "wikilink")\[96\]
  - [스텀블어폰](https://ko.wikipedia.org/wiki/스텀블어폰 "wikilink")\[97\]
  - [팀 파운데이션 서버](../Page/팀_파운데이션_서버.md "wikilink")\[98\]
  - [위키미디어 재단](https://ko.wikipedia.org/wiki/위키미디어_재단 "wikilink")\[99\]
