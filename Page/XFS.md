...
## 같이 보기
  ...
  - [파일 시스템 목록](https://ko.wikipedia.org/wiki/파일_시스템_목록 "wikilink")
...
## 외부 링크
  ...
  - [XFS.org](http://xfs.org/) - 커뮤니티 위키

  - [SGI.com](https://web.archive.org/web/20160203194451/http://oss.sgi.com/projects/xfs/) - 고성능 저널링 파일시스템

  -
  - [crossmeta.org](http://www.crossmeta.org/) - 윈도 상의 XFS 커뮤니티 포팅

[분류:1994년 소프트웨어](https://ko.wikipedia.org/wiki/분류:1994년_소프트웨어 "wikilink") [분류:파일 시스템](https://ko.wikipedia.org/wiki/분류:파일_시스템 "wikilink")

1.  ["*xFS: the extension of EFS - "x" for to-be-determined (but the name stuck)*"](http://xfs.org/docs/xfsdocs-xml-dev/XFS_User_Guide/tmp/en-US/html/ch01s02.html), xfs.org
2.
3.
4.
5.