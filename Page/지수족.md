...
**지수족**(exponential family)은 [지수함수](https://ko.wikipedia.org/wiki/지수함수 "wikilink")와 연관되어 있는 특정 [확률분포](https://ko.wikipedia.org/wiki/확률분포 "wikilink") 종류를 가리키는 말로, [정규 분포나](https://ko.wikipedia.org/wiki/정규_분포 "wikilink") [감마 분포](../Page/감마_분포.md "wikilink"), [다항 분포](../Page/다항_분포.md "wikilink") 등 일반적으로 널리 사용되는 분포들이 다수 포함되어 있다.
