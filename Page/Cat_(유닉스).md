...
**`cat`** 명령어는 파일들을 [연결하고](https://ko.wikipedia.org/wiki/연결어 "wikilink") 표시하기 위해 사용되는 표준 [유닉스](https://ko.wikipedia.org/wiki/유닉스 "wikilink") 프로그램이다. 이름은 concatenate(연결하다)의 동의어인 *[catenate](https://ko.wikipedia.org/wiki/:en:wikt:catenate "wikilink")*에서 유래하였다.
...
`cat`의 BSD 버전([OpenBSD](https://ko.wikipedia.org/wiki/OpenBSD "wikilink") 메뉴페이지에 따라서)과 `cat`의 GNU [coreutils](https://ko.wikipedia.org/wiki/coreutils "wikilink") 버전은 다음과 같은 옵션들을 지정한다:
...
1995년 이래로 UUOC에 대한 정기적인 상이 수여되었고, 이는 일반적으로 [펄](https://ko.wikipedia.org/wiki/펄 "wikilink") 권위자인 [Randal L. Schwartz에](https://ko.wikipedia.org/wiki/Randal_L._Schwartz "wikilink") 의해서 주어진다. 이 상과 다른 비슷한 상들에 대한 웹 페이지가 있다. [영국인](../Page/영국인.md "wikilink") [해커](https://ko.wikipedia.org/wiki/해커 "wikilink")들 사이에서는 UUCO의 정형화된 예들의 활동이 때때로 *[demoggification](https://ko.wikipedia.org/wiki/moggy "wikilink")*으로 불린다.
...
1.  [유즈넷](https://ko.wikipedia.org/wiki/유즈넷 "wikilink")의 *comp.unix.shell*에서 나온 말
