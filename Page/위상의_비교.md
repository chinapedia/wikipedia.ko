...
[일반위상수학](https://ko.wikipedia.org/wiki/일반위상수학 "wikilink")과 [범주론](https://ko.wikipedia.org/wiki/범주론 "wikilink")에서, [위상 함자를](../Page/위상_함자.md "wikilink") 통해 주어진 [집합](https://ko.wikipedia.org/wiki/집합 "wikilink") 위에 여러 위상수학적 구조를 부여할 수 있으며, 이러한 구조들은 [완비 격자를](../Page/완비_격자.md "wikilink") 이룬다. 이 경우 한 구조가 다른 구조에 대하여 더 **섬세한 구조**(纖細-構造, ) 또는 더 **엉성한 구조**(-構造, )라고 한다.
...
위상 공간과 [연속 함수의](https://ko.wikipedia.org/wiki/연속_함수 "wikilink") 범주에서 [집합](https://ko.wikipedia.org/wiki/집합 "wikilink")과 [함수](https://ko.wikipedia.org/wiki/함수 "wikilink")의 범주로 가는 망각 함자
...
집합 \(X\) 위의 두 위상 ([열린집합](../Page/열린집합.md "wikilink")의 족) \(\mathcal U,\mathcal U'\subseteq\mathcal P(X)\)에 대하여 다음 두 조건이 서로 [동치](../Page/동치.md "wikilink")이다.\[2\]
  ...
  - \(\mathcal U'\)이 \(\mathcal U\)보다 더 엉성하다. 즉, 항등 함수 \((X,\mathcal U)\to(X,\mathcal U')\)이 [연속 함수이다](https://ko.wikipedia.org/wiki/연속_함수 "wikilink").
...
흔히, 위상수학에서는 엉성한/섬세한 위상 대신 "약한/강한 위상"()이라는 용어를 사용하며, 반대로 [해석학에서는](https://ko.wikipedia.org/wiki/해석학_\(수학\) "wikilink") "강한/약한 위상"()이라는 용어를 사용한다.

#### 기저

보다 일반적으로, 다음과 같은 [구체적 범주](../Page/구체적_범주.md "wikilink") \(\operatorname{TopBase}\)를 생각하자.

  - \(\operatorname{TopBase}\)의 원소 \((X,\mathcal B)\)는 [집합](https://ko.wikipedia.org/wiki/집합 "wikilink") \(X\)와 그 위의 [기저](https://ko.wikipedia.org/wiki/기저_\(위상수학\) "wikilink") \(\mathcal B\)의 순서쌍이다.
  - \(\operatorname{TopBase}\)의 사상 \(f\colon(X,\mathcal B_X)\to(Y,\mathcal B_Y)\)는 다음 조건을 만족시키는 [함수](https://ko.wikipedia.org/wiki/함수 "wikilink")이다.
...
그렇다면, 위와 같이 섬세한/엉성한 [기저를](https://ko.wikipedia.org/wiki/기저_\(위상수학\) "wikilink") 정의할 수 있다. 집합 \(X\) 위의 두 [기저](https://ko.wikipedia.org/wiki/기저_\(위상수학\) "wikilink") \(\mathcal B,\mathcal B'\subseteq\mathcal P(X)\)에 대하여 다음 세 조건이 서로 [동치](../Page/동치.md "wikilink")이다.
...
주어진 [집합](https://ko.wikipedia.org/wiki/집합 "wikilink") 위의 [기저들은](https://ko.wikipedia.org/wiki/기저_\(위상수학\) "wikilink") [완비 원격자를](../Page/완비_격자.md "wikilink") 이룬다.

#### 부분 기저

보다 일반적으로, 다음과 같은 [구체적 범주](../Page/구체적_범주.md "wikilink") \(\operatorname{TopSubbase}\)를 생각하자.

  - \(\operatorname{TopSubbase}\)의 원소 \((X,\mathcal B)\)는 [집합](https://ko.wikipedia.org/wiki/집합 "wikilink") \(X\)와 그 위의 임의의 [집합족](https://ko.wikipedia.org/wiki/집합족 "wikilink") \(\mathcal B\subseteq\mathcal P(X)\)의 순서쌍이다. (이는 \(X\)의 위상을 생성하는 부분 기저로 생각한다.)
  - \(\operatorname{TopSubbase}\)의 사상 \(f\colon(X,\mathcal B_X)\to(Y,\mathcal B_Y)\)는 다음 조건을 만족시키는 [함수](https://ko.wikipedia.org/wiki/함수 "wikilink")이다.
...
주어진 [집합](https://ko.wikipedia.org/wiki/집합 "wikilink") 위의 부분 기저들은 [완비 원격자를](../Page/완비_격자.md "wikilink") 이룬다.

### 덮개와 유계형 집합

다음과 같은 [구체적 범주](../Page/구체적_범주.md "wikilink") \(\operatorname{Cover}\)를 생각하자.

  - \(\operatorname{Cover}\)의 대상 \((X,\mathcal C)\)은 집합 \(X\)와 그 위의 [덮개](https://ko.wikipedia.org/wiki/덮개_\(위상수학\) "wikilink") \(\mathcal C\subseteq\mathcal P(X)\)의 [순서쌍](https://ko.wikipedia.org/wiki/순서쌍 "wikilink")이다.
  - \(\operatorname{Cover}\)의 사상 \(f\colon(X,\mathcal C_X)\to(Y,\mathcal C_Y)\)은 다음 조건을 만족시키는 [함수](https://ko.wikipedia.org/wiki/함수 "wikilink")이다.
...
다음과 같은 범주 \(\operatorname{FilterBase}\)를 생각하자.
  ...
  - \(\operatorname{FilterBase}\)의 대상 \((X,\mathcal F)\)는 [집합](https://ko.wikipedia.org/wiki/집합 "wikilink") \(X\)와 \(\mathcal P(X)\) 위의 [필터 기저](https://ko.wikipedia.org/wiki/필터_기저 "wikilink") \(\mathcal F\subseteq\mathcal P(X)\)이다.
  - \(\operatorname{FilterBase}\)의 사상 \(f\colon (X,\mathcal F_X)\to(Y,\mathcal F_Y)\)은 다음 조건을 만족시키는 [함수](https://ko.wikipedia.org/wiki/함수 "wikilink")이다.
...
그렇다면, 집합 \(X\) 위의 두 [필터 기저](https://ko.wikipedia.org/wiki/필터_기저 "wikilink") \(\mathcal F,\mathcal F'\subseteq\mathcal P(X)\)에 대하여 다음 두 조건이 서로 [동치](../Page/동치.md "wikilink")이다.
  ...
  - \(\uparrow\mathcal F'\subseteq\uparrow\mathcal F\)이다. 여기서 \(\uparrow\)는 [필터 기저로](https://ko.wikipedia.org/wiki/필터_기저 "wikilink") 생성되는 [필터](https://ko.wikipedia.org/wiki/필터_\(수학\) "wikilink")(즉, [상폐포](../Page/상집합.md "wikilink"))를 뜻한다.

### 가측 공간

[가측 공간과](../Page/가측_공간.md "wikilink") [가측 함수의](https://ko.wikipedia.org/wiki/가측_함수 "wikilink") 범주에서 [집합](https://ko.wikipedia.org/wiki/집합 "wikilink")과 [함수](https://ko.wikipedia.org/wiki/함수 "wikilink")의 범주로 가는 망각 함자
