> This article is converted from Wikipedia: [퍼셉트론](https://ko.wikipedia.org/wiki/퍼셉트론).


**퍼셉트론**(perceptron)은 인공신경망의 한 종류로서, [1957년](../Page/1957년.md "wikilink")에 코넬 항공 연구소(Cornell Aeronautical Lab)의 [프랑크 로젠블라트](https://ko.wikipedia.org/wiki/프랑크_로젠블라트 "wikilink") (Frank Rosenblatt)에 의해 고안되었다. 이것은 가장 간단한 형태의 피드포워드(Feedforward) 네트워크 - 선형분류기- 로도 볼 수 있다.
...
[마빈 민스키와](../Page/마빈_민스키.md "wikilink") [시모어 페퍼트는](../Page/시모어_페퍼트.md "wikilink") 저서 "퍼셉트론"에서 단층 퍼셉트론은 [XOR](https://ko.wikipedia.org/wiki/XOR "wikilink") 연산이 불가능하지만, [다층 퍼셉트론으로는](https://ko.wikipedia.org/wiki/다층_퍼셉트론 "wikilink") XOR 연산이 가능함을 보였다.
