...
2016년 NASA는 [플래그쉽 프로그램으로](https://ko.wikipedia.org/wiki/플래그쉽_프로그램 "wikilink") [HabEx](../Page/HabEx.md "wikilink"), [LUVOIR](../Page/LUVOIR.md "wikilink"), 리닉스 X선 관측선, [OST를](../Page/OST_\(우주망원경\).md "wikilink") 최종후보로 택했다.\[7\] 그 후 이름이 Lynx(살쾡이)로 정해졌다. 현재 설계 중에 있으며, 플래그쉽 프로그램에 편입되어 본격적인 설계가 진행되고 있다. 예산배정은 일부 배정되었고, 앞으로 더 배정할 예정이다.
