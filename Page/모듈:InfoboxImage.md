...
`       return "";`
`   end`
`   if mw.ustring.lower(mw.ustring.sub(image,1,7)) == "`[`%s*thumb%s*[|%`](https://ko.wikipedia.org/wiki/http:"_then_return_"";_end_if_mw.ustring.lower\(mw.ustring.sub\(image,1,6\)\)_==_"https:"_then_return_"";_end_if_mw.ustring.lower\(mw.ustring.sub\(image,1,7\)\)_==_"[https:"_then_return_"";_end_if_mw.ustring.lower\(mw.ustring.sub\(image,1,8\)\)_==_"[[https:"_then_return_"";_end_if_mw.ustring.sub\(image,1,2\)_==_"[["_then_--_search_for_thumbnail_images_and_add_to_tracking_cat_if_found_if_mw.title.getCurrentTitle\(\).namespace_==_0_and_\(mw.ustring.find\(image,_" "wikilink")`") or mw.ustring.find(image, "|%s*thumbnail%s*[|%]]")) then`
`           return image .. "`[`분류:섬네일``   ``그림이``   ``있는``   ``정보``   ``상자를``   ``사용하는``   ``문서`](https://ko.wikipedia.org/wiki/분류:섬네일_그림이_있는_정보_상자를_사용하는_문서 "wikilink")`";`
...
`           return image .. "`[`분류:오래된``   ``그림``   ``구조를``   ``사용하고``   ``있는``   ``문서`](https://ko.wikipedia.org/wiki/분류:오래된_그림_구조를_사용하고_있는_문서 "wikilink")`";`
`       else`
`           return image;`
`       end`
