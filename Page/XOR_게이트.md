...
[thumb](https://ko.wikipedia.org/wiki/파일:CMOS_XOR_Gate.svg "wikilink") **XOR 게이트**, **EOR 게이트**, **EXOR 게이트**는 참 입력의 개수가 홀수일 때 참 (1/HIGH) 출력을 내보내는 디지털 [논리 게이트이다](https://ko.wikipedia.org/wiki/논리_게이트 "wikilink"). [배타적 논리합을](https://ko.wikipedia.org/wiki/배타적_논리합 "wikilink") 구현하며 게이트의 입력 중 하나만이 오직 참이라면 그 결과는 참이 된다.
...
[논리 기호](https://ko.wikipedia.org/wiki/논리_기호_목록 "wikilink") ⊕, [J*pq*](https://ko.wikipedia.org/wiki/배타적_논리합 "wikilink"), 그리고 ⊻는 대수식에서 XOR을 가리키는데 사용할 수 있다.
...
XOR 게이트는 [MOSFET](https://ko.wikipedia.org/wiki/MOSFET "wikilink")을 사용하여 구성할 수 있다. XOR 게이트의 [패스 트랜지스터 로직](https://ko.wikipedia.org/wiki/패스_트랜지스터_로직 "wikilink") 구현 도표는 아래와 같다.\[1\]\[2\]\[3\]\[4\]\[5\]\[6\]
