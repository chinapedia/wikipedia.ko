...
[섬네일](https://ko.wikipedia.org/wiki/파일:Quadrokopter-X-H-Konfiguration.gif "wikilink") **쿼드콥터**(quadcopter) 혹은 **쿼드로터**(quadrotor)는 [로터](https://ko.wikipedia.org/wiki/로터 "wikilink")(회전날개)가 네 개를 이용해 뜨고 추진하는 [멀티콥터](https://ko.wikipedia.org/wiki/멀티콥터 "wikilink")이다.
...
| 프로펠러(모터및변속기포함), [배터리](https://ko.wikipedia.org/wiki/축전지 "wikilink"), 프레임, FC(flight controler), [센서](https://ko.wikipedia.org/wiki/센서 "wikilink")([자이로센서](https://ko.wikipedia.org/wiki/자이로스코프 "wikilink"), [GPS](https://ko.wikipedia.org/wiki/GPS "wikilink"), [와이파이](https://ko.wikipedia.org/wiki/와이파이 "wikilink"), [블루투스](https://ko.wikipedia.org/wiki/블루투스 "wikilink"), 초음파감지기 등 ) |

이들 주요 구성에서 FC [회로기판](https://ko.wikipedia.org/wiki/회로기판 "wikilink")은 통신 및 연산 그리고 각각의 모터 파워([BEC포함](https://ko.wikipedia.org/wiki/전력분배기 "wikilink")), 변속기 제어등 모든 부품의 기능이 모여서 컨트롤되므로 비행기능유지에 중요한 역할을 담당하는 핵심 부품이다. 대중적인 FC로는 [아트멜 AVR](https://ko.wikipedia.org/wiki/아트멜_AVR "wikilink") MCU칩을 장착한 아두이노계열 또는 [ARM](https://ko.wikipedia.org/wiki/ARM "wikilink") [Cortex](https://ko.wikipedia.org/wiki/ARM_아키텍처 "wikilink")-MX칩을 장착한 [아두파일럿](https://ko.wikipedia.org/wiki/아두파일럿 "wikilink") 계열이있다.\[1\]
...
| 볼트(V) | [전류](https://ko.wikipedia.org/wiki/전류 "wikilink")(A) | 추력(G) | [전력](https://ko.wikipedia.org/wiki/전력 "wikilink")(W) | 효율(G/W) | 스피드(RPM) | 비고 |
| ----- | ---------------------------------------------------- | ----- | ---------------------------------------------------- | ------- | -------- | -- |
...
교육적인 프로그래밍으로는 [아두이노 보드를](https://ko.wikipedia.org/wiki/아두이노_보드 "wikilink") 위한 [아두이노](https://ko.wikipedia.org/wiki/아두이노 "wikilink") IDE 환경이 사용되며 통신 API로는 역시 오픈소스인 [멀티위 시리얼 프로토콜](https://ko.wikipedia.org/wiki/멀티위 "wikilink")(MSP)이 주로 사용된다. 특히 블루투스나 와이파이를 통한 멀티위 확장 프로토콜인 MSP(Multiwii Serial Protocol)는 아두이노 보드인 FC와 무선조정장치(RC)를 서로 연동하는 무선 메시지를 주고받는 교환 프로토콜로 자주 사용된다.\[7\]\[8\]

산업용 및 연구용으로는 [리눅스재단](https://ko.wikipedia.org/wiki/리눅스재단 "wikilink")이 관여하고 있는 오픈소스인 [아두파일럿](https://ko.wikipedia.org/wiki/아두파일럿 "wikilink")의 [드론코드](https://ko.wikipedia.org/wiki/드론코드 "wikilink")(Drone Code)프로젝트가 있으며 이의 계열인 [아두콥터](https://ko.wikipedia.org/wiki/아두콥터 "wikilink")(arducopter)나 [픽스호크](https://ko.wikipedia.org/wiki/픽스호크 "wikilink")(pixhawk)하드웨어가 주로 사용되고 있다. \[9\] 통신 프로토콜로는 [마브링크](https://ko.wikipedia.org/wiki/마브링크 "wikilink")(MAVLink)를 사용한다. \[10\]\[11\]\[12\]

[IDE로는](https://ko.wikipedia.org/wiki/통합_개발_환경 "wikilink") [이클립스 (소프트웨어)가](https://ko.wikipedia.org/wiki/이클립스_\(소프트웨어\) "wikilink") 있으며 터미널에서 [기트](https://ko.wikipedia.org/wiki/기트 "wikilink")가 [WAF](https://ko.wikipedia.org/wiki/Waf "wikilink") 빌드를 지원하고 있다. 한편 펌웨어 로딩에는 빌드도구외에도 원격조정 프로그램인 큐그라운드컨트롤도 지원한다.\[13\]\[14\]\[15\]
...
## 참고
  ...
  - ([ARM](https://ko.wikipedia.org/wiki/ARM_아키텍처 "wikilink") Cortex-M4 Processor)STM32F4 MCU(F303K8)
  - (Quadcopter FC)http://www.brokking.net/ymfc-32_auto_main.html

[분류:항공기](https://ko.wikipedia.org/wiki/분류:항공기 "wikilink")

1.  ([아두이노](https://ko.wikipedia.org/wiki/아두이노 "wikilink"))https://www.arduino.cc/en/Guide/ArduinoYunLin
...
6.  ([카네기 멜런 대학교](https://ko.wikipedia.org/wiki/카네기_멜런_대학교 "wikilink") PID 시뮬레이션 데이타 시트 - K<sub>p</sub> =3,K<sub>i</sub>=0.8 ,K<sub>d</sub>=0.7 :K<sub>p</sub> =0,K<sub>i</sub>=0 ,K<sub>d</sub>=0)https://www.cs.cmu.edu/afs/cs/academic/class/15883-f15/lectures/cerebellum-controller/pid.xls
...
14. (Building ArduPilot - [WAF](https://ko.wikipedia.org/wiki/Waf "wikilink") ) <https://github.com/ArduPilot/ardupilot/blob/master/BUILD.md>
