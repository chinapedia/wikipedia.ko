...
[IDE로는](../Page/통합_개발_환경.md "wikilink") [이클립스 (소프트웨어)가](../Page/이클립스_\(소프트웨어\).md "wikilink") 있으며 터미널에서 [기트](https://ko.wikipedia.org/wiki/기트 "wikilink")가 [WAF](https://ko.wikipedia.org/wiki/Waf "wikilink") 빌드를 지원하고 있다. 한편 펌웨어 로딩에는 빌드도구외에도 원격조정 프로그램인 큐그라운드컨트롤도 지원한다.\[13\]\[14\]\[15\]
