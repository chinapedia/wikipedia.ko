...
[응용수학](https://ko.wikipedia.org/wiki/응용수학 "wikilink")과 [전산학](https://ko.wikipedia.org/wiki/전산학 "wikilink")에서 **조합최적화**는 [최적화 문제의](https://ko.wikipedia.org/wiki/최적화_문제 "wikilink") 일종으로서, [운용 과학](https://ko.wikipedia.org/wiki/운용_과학 "wikilink"), [알고리즘](https://ko.wikipedia.org/wiki/알고리즘 "wikilink") 이론, [계산 복잡도 이론과](https://ko.wikipedia.org/wiki/계산_복잡도_이론 "wikilink") 관련되어 있고, [인공지능](../Page/인공지능.md "wikilink"), [수학](https://ko.wikipedia.org/wiki/수학 "wikilink"), [소프트웨어 공학과](https://ko.wikipedia.org/wiki/소프트웨어_공학 "wikilink") 영역이 겹친다. 조합최적화에서는 일반적으로 어렵다고 보는 문제를 풀려고 한다. 어려운 문제들은 보통 문제 공간이 크기 때문에 조합최적화 알고리즘은 문제 공간을 좁히거나 탐색 효율을 높이는 데 중점을 둔다.

계산 복잡도 이론의 연구 결과가 조합 최적화에서 쓸모있는 경우가 많다. 조합 최적화 알고리즘은 보통 [NP-완전](https://ko.wikipedia.org/wiki/NP-완전 "wikilink")인 문제를 다루는데, 일반적으로 NP-완전 문제는 쉽게 풀 수 없다고 보고 있다. 그러나 복잡도 이론의 여러 근사에 따르면 몇몇 특수한 경우에는 효율적으로 풀 수 있다. 조합최적화에서는 바로 이러한 경우에 대해 관심을 갖는다. 이런 경우는 중요하고 실용적인 응용을 할 수 있을 때가 많다.
...
조합 최적화 문제의 [인스턴스](https://ko.wikipedia.org/wiki/인스턴스 "wikilink")는 [튜플](https://ko.wikipedia.org/wiki/튜플 "wikilink") 로 쓸 수 있다. 여기서 각 기호는 아래와 같은 뜻이다.
...
## 대표적인 문제
  ...
  - [외판원 문제](https://ko.wikipedia.org/wiki/외판원_문제 "wikilink")
