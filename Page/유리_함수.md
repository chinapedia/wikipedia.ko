...
[대수학](https://ko.wikipedia.org/wiki/대수학 "wikilink")과 [해석학에서](https://ko.wikipedia.org/wiki/해석학_\(수학\) "wikilink"), **유리 함수**(有理函數, )란 두 [다항함수의](https://ko.wikipedia.org/wiki/다항식 "wikilink") 비로 나타낼 수 있는 함수다.

## 정의

[체](https://ko.wikipedia.org/wiki/체_\(수학\) "wikilink") \(K\)가 주어졌다고 하자. 그렇다면, \(n\)변수의 **유리 함수체** \(K(x_1,\dots,x_n)\)는 [다항식환](../Page/다항식환.md "wikilink")의 [분수체](../Page/분수체.md "wikilink")이다.
...
체의 계수를 갖는 유리 함수들은 [체를](https://ko.wikipedia.org/wiki/체_\(수학\) "wikilink") 이룬다. 즉, [교환법칙](https://ko.wikipedia.org/wiki/교환법칙 "wikilink"), [결합법칙](https://ko.wikipedia.org/wiki/결합법칙 "wikilink"), [분배법칙](https://ko.wikipedia.org/wiki/분배법칙 "wikilink")이 성립한다.
...
유리 함수를 [테일러 급수로](https://ko.wikipedia.org/wiki/테일러_급수 "wikilink") 표현했을 때, 그 계수를 [동류항](https://ko.wikipedia.org/wiki/동류항 "wikilink") 정리를 통해 일차 [점화식](https://ko.wikipedia.org/wiki/점화식 "wikilink")으로 나타낼 수 있다.

예를 들어, 다음 유리 함수의 [테일러 급수를](https://ko.wikipedia.org/wiki/테일러_급수 "wikilink") 생각하자.
