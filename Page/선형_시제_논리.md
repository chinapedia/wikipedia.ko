...
[논리학](https://ko.wikipedia.org/wiki/논리학 "wikilink")에서, **선형 시제 논리**(線型時制論理, , 약자 LTL)는 선형 이산 시간에 대한 여러 가지 [양상을](https://ko.wikipedia.org/wiki/양상_논리 "wikilink") 갖춘, [시제 논리의](https://ko.wikipedia.org/wiki/시제_논리 "wikilink") 하나이다. PTL(Propositional temporal logic)이라고도 한다.\[1\]
...
선형 시제 논리의 논리식은 [원자 명제의](https://ko.wikipedia.org/wiki/원자_명제 "wikilink") 유한 집합 \(\operatorname{AP}\sqcup\{\top,\bot\}\) 및 다음과 같은 논리 연산 기호들로부터 재귀적으로 정의된다.
  ...
  - ([명제 논리의](https://ko.wikipedia.org/wiki/명제_논리 "wikilink") 기호) [\(\land\)](https://ko.wikipedia.org/wiki/논리곱 "wikilink"), [\(\lor\)](https://ko.wikipedia.org/wiki/논리합 "wikilink"), [\(\lnot\)](https://ko.wikipedia.org/wiki/부정 "wikilink"), [\(\implies\)](https://ko.wikipedia.org/wiki/실질적_함의 "wikilink") 등등
  - (다음, ) \(\bigcirc\)
  - (결국, ) \(\Diamond\)
  - (항상, ) \(\Box\)
  - (언틸, ) \(\mathsf U\)
...
원자 명제 집합의 [멱집합](https://ko.wikipedia.org/wiki/멱집합 "wikilink") 위의 무한 열
