...
[선형대수학](../Page/선형대수학.md "wikilink")에서, **대각화 가능 행렬**(對角化可能行列, )은 적절한 [가역 행렬로의](https://ko.wikipedia.org/wiki/가역_행렬 "wikilink") 켤레를 취하여 [대각 행렬로](https://ko.wikipedia.org/wiki/대각_행렬 "wikilink") 만들 수 있는 [정사각 행렬이다](https://ko.wikipedia.org/wiki/정사각_행렬 "wikilink").
