...
**이모션 엔진**(Emotion Engine)은 [소니 컴퓨터 엔터테인먼트와](https://ko.wikipedia.org/wiki/소니_컴퓨터_엔터테인먼트 "wikilink") [도시바](../Page/도시바.md "wikilink")가 개발한 [중앙 처리 장치이다](https://ko.wikipedia.org/wiki/중앙_처리_장치 "wikilink"). [플레이스테이션 2에](https://ko.wikipedia.org/wiki/플레이스테이션_2 "wikilink") 사용되었으며, 이후 [플레이스테이션 3의](https://ko.wikipedia.org/wiki/플레이스테이션_3 "wikilink") 초기 모델에도 플레이스테이션 2와의 [하위 호환을](https://ko.wikipedia.org/wiki/하위_호환 "wikilink") 위해 탑재되었다.
...
## 이론적인 성능
  ...
  - [퍼스펙티브](https://ko.wikipedia.org/wiki/원근법 "wikilink")(Perspective) 변환 : 초당 66백만 폴리곤
      - 조명, 안개 효과 적용시 초당 36백만 폴리곤
      - [베지에](https://ko.wikipedia.org/wiki/베지에_곡선 "wikilink")(Bézier) 표면 적용시 초당 16백만 폴리곤
