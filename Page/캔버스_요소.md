...
캔버스는 [애플이](https://ko.wikipedia.org/wiki/애플_\(기업\) "wikilink") 자사의 [macOS](https://ko.wikipedia.org/wiki/macOS "wikilink") [웹킷](../Page/웹킷.md "wikilink") 구성 요소 안에 사용할 목적으로 2004년에 처음 도입하였으며,\[1\] [대시보드](https://ko.wikipedia.org/wiki/대시보드 "wikilink") 위젯과 [사파리](../Page/사파리_\(웹_브라우저\).md "wikilink") 브라우저와 같은 응용 프로그램들의 기능을 강화하는데 사용되었다. 나중에 2005년에 버전 1.8의 [게코](https://ko.wikipedia.org/wiki/게코 "wikilink") 브라우저에 채택되었으며,\[2\] [오페라에는](../Page/오페라_\(웹_브라우저\).md "wikilink") 2006년 채택되었고,\[3\] 차세대 웹 기술의 신규 제안 사양으로 [WHATWG](../Page/WHATWG.md "wikilink")에 의해 표준화되었다.
