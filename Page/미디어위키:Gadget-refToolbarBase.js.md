...
// Object for cite templates window.citeTemplate = function (templatename, shortform, basicfields, expandedfields) {
...
<td class="cite-form-td" style="width:30%" />
...
<div class='cite-form-container' />

");

`   var form1 = $('`

<table style="width:100%; background-color:transparent;" class="cite-basic-fields" />
...
<table style="width:100%; background-color:transparent; display:none" class="cite-extra-fields">
...
<table style="width:100%; background-color:transparent;padding-top:1em" class="cite-other-fields">
...
<td class="cite-form-td" style="text-align:right; width:20%" />
...
<td class="cite-form-td" style="text-align:right; padding-left:1em; width:20%">
...
<div class="cite-ref-preview" style="padding:0.5em; font-size:110%" />
...
<div class="cite-preview-parsed" style="padding-bottom:0.5em; font-size:110%" />
