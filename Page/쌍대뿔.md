...
[섬네일](https://ko.wikipedia.org/wiki/파일:Dual_cone_illustration.svg "wikilink") [기하학](https://ko.wikipedia.org/wiki/기하학 "wikilink")에서, **쌍대뿔**(雙對뿔, )은 주어진 벡터 [집합](https://ko.wikipedia.org/wiki/집합 "wikilink")의 모든 원소와의 [내적](https://ko.wikipedia.org/wiki/내적 "wikilink")이 음수가 아닌 벡터들로 구성된 [부분 집합이다](https://ko.wikipedia.org/wiki/부분_집합 "wikilink").
...
[실수 벡터 공간](https://ko.wikipedia.org/wiki/실수_벡터_공간 "wikilink") \(V\) 속의 **뿔**은 다음 두 연산에 대하여 닫혀 있는 부분 집합 \(C\subseteq V\)이다.
  ...
  - \(C\)는 덧셈에 대한 [모노이드](https://ko.wikipedia.org/wiki/모노이드 "wikilink")이다. 즉, 임의의 \(u,v\in C\)에 대하여, \(u+v\in C\)이다. (\(0\in C\)인 것은 첫째 조건에 대하여 항상 성립한다.)
...
[실수 내적 공간](https://ko.wikipedia.org/wiki/실수_내적_공간 "wikilink") \(V\)가 주어졌다고 하자.
  ...
  - 보다 일반적으로, 임의의 부분 벡터 공간 \(W\subseteq V\)의 쌍대뿔은 \(W^\vee = \operatorname{cl}W\) ([폐포](https://ko.wikipedia.org/wiki/폐포_\(위상수학\) "wikilink"))이다.
