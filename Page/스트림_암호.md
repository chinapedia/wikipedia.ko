...
[섬네일](https://ko.wikipedia.org/wiki/파일:RC4.svg "wikilink") 스트림 암호의 구조\]\] **스트림 암호**(stream cipher)는 [대칭 키 암호의](../Page/대칭_키_암호.md "wikilink") 구조 중 하나로, [유사난수](https://ko.wikipedia.org/wiki/유사난수 "wikilink")를 연속적(스트림)으로 생성하여 암호화하려는 자료와 결합하는 구조를 가진다.\[1\] 일반적인 스트림 암호는 유사난수를 1비트 단위로 생성하고, 생성된 값과 암호화하려는 각 값을 [XOR](https://ko.wikipedia.org/wiki/XOR "wikilink")하여 1비트의 암호화된 자료를 얻는다.

스트림 암호는 [일회용 난수표](https://ko.wikipedia.org/wiki/일회용_난수표 "wikilink")(OTP)를 유사난수로 대체한 것으로 볼 수 있다.

스트림 암호는 하드웨어 구현이 간편하며 속도가 빠르기 때문에 [무선 통신](https://ko.wikipedia.org/wiki/무선_통신 "wikilink") 등의 환경에 주로 사용된다. 대표적으로 [RC4](https://ko.wikipedia.org/wiki/RC4 "wikilink")가 널리 사용되며, 이외에도 [A5/1](https://ko.wikipedia.org/wiki/A5/1 "wikilink"), [A5/2](https://ko.wikipedia.org/wiki/A5/2 "wikilink") 등의 알고리즘이 존재한다.
