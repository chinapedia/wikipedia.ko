...
[수학](https://ko.wikipedia.org/wiki/수학 "wikilink")에서, **변수 변환**(變數變換, )은 어떤 변수(들)로 나타낸 식을 다른 변수(들)로 바꿔 나타내는 기법이다.

## 다항식에 대한 변수 변환

[다항식](https://ko.wikipedia.org/wiki/다항식 "wikilink")의 변수를 다른 변수로 대신하는 기법은 다항 방정식의 근을 구하거나 다항식의 성질을 연구할 때 유용하다.
...
\[\sqrt{x+1}=t\] 를 사용할 수 있다. 이를 대입하여 식을 다시 정리하면 [이차 방정식](https://ko.wikipedia.org/wiki/이차_방정식 "wikilink")
...
또 한 가지 응용은 [다항식](https://ko.wikipedia.org/wiki/다항식 "wikilink")
...
\[\int_a^bf(x)dx\] 의 계산에서, 직접적인 계산보다 [치환 적분을](https://ko.wikipedia.org/wiki/치환_적분 "wikilink") 통한 계산이 더 간편할 때가 많다. 이 경우에 변수 변환
...
그 밖에도 [삼각 치환](https://ko.wikipedia.org/wiki/삼각_치환 "wikilink") · [쌍곡 치환](https://ko.wikipedia.org/wiki/쌍곡_치환 "wikilink") · [바이어슈트라스 치환](../Page/바이어슈트라스_치환.md "wikilink") · [오일러 치환이](../Page/오일러_치환.md "wikilink") 사용된다.
