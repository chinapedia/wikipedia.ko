...
컴퓨터의 초창기에, 정렬 알고리즘은 연구하기에 대단히 매력적인 주제였다. 간단하고 익숙하지만, 그것을 효율적으로 풀어내기는 복잡하기 때문일지도 모른다. 예를 들어, [거품 정렬은](../Page/거품_정렬.md "wikilink") [1956년](../Page/1956년.md "wikilink")에 분석되었다\[1\]. 수없이 많은 논의를 거쳐왔지만, 쓸만한 새로운 정렬 알고리즘들은 현재도 계속 발명되고 있다(예를 들어, [라이브러리 정렬은](https://ko.wikipedia.org/wiki/라이브러리_정렬 "wikilink") [2004년](../Page/2004년.md "wikilink")에 발표되었다). 정렬 알고리즘은 다양한 핵심 알고리즘 개념 — [점근 표기법](../Page/점근_표기법.md "wikilink"), [분할 정복 알고리즘](https://ko.wikipedia.org/wiki/분할_정복_알고리즘 "wikilink"), [자료 구조](https://ko.wikipedia.org/wiki/자료_구조 "wikilink"), [최악의 경우](https://ko.wikipedia.org/wiki/최악의_경우 "wikilink"), [평균적인 경우](https://ko.wikipedia.org/wiki/평균적인_경우 "wikilink"), [최선의 경우](https://ko.wikipedia.org/wiki/최선의_경우 "wikilink") 등 — 을 소개하는 데 적당하기 때문에, 컴퓨터 과학 강의에서 입문 과정으로 유행하고 있다.
...
정렬 알고리즘은 [컴퓨터 과학](../Page/컴퓨터_과학.md "wikilink") 소개 수업에서 일반적이며 여기서 문제를 위한 풍부한 알고리즘들은 [점근 표기법](../Page/점근_표기법.md "wikilink"), [분할 정복 알고리즘](https://ko.wikipedia.org/wiki/분할_정복_알고리즘 "wikilink") 등의 다양한 핵심 알고리즘 개념, 그리고 [힙과](../Page/힙_\(자료_구조\).md "wikilink") [이진 트리](../Page/이진_트리.md "wikilink") 등의 [자료 구조](https://ko.wikipedia.org/wiki/자료_구조 "wikilink"), [확률적 알고리즘](https://ko.wikipedia.org/wiki/확률적_알고리즘 "wikilink"), [최선, 최악, 그리고 평균의 경우](../Page/최선,_최악,_그리고_평균의_경우.md "wikilink") 분석, [타임스페이스 트레이드오프](https://ko.wikipedia.org/wiki/타임스페이스_트레이드오프 "wikilink"), [하한 및 상한을](https://ko.wikipedia.org/wiki/하한_및_상한 "wikilink") 소개한다.

## 분류

정렬 알고리즘은 다음과 같은 기준으로 분류된다:

  - 원소들의 크기 비교에 따른 [계산 복잡도](https://ko.wikipedia.org/wiki/계산_복잡도_이론 "wikilink") ([최선, 최악, 평균](../Page/최선,_최악,_그리고_평균의_경우.md "wikilink") 동작). 직렬 정렬 알고리즘의 경우 최선 동작은 O(*n* log *n*), 최선 동작 중 병렬 정렬은 O(log<sup>2</sup> *n*), 최악 동작은 O(*n*<sup>2</sup>)이다. ([점근 표기법](../Page/점근_표기법.md "wikilink") 참고.) 직렬 정렬의 이상적인 동작은 O(*n*)이지만 평균 케이스에는 가능치 않다. 최적의 병렬 정렬은 O(log *n*)이다. [비교 기반 정렬 알고리즘은](https://ko.wikipedia.org/wiki/비교_정렬 "wikilink") 대부분의 입력에 대해 최소 Ω(*n* log *n*)개의 비교가 필요하다.
  - 원소들의 교환 횟수에 따른 [계산 복잡도](https://ko.wikipedia.org/wiki/계산_복잡도_이론 "wikilink").
...
<td><p>—</p></td>
<td><p><br />
See above, for hybrid, that is </p></td>
<td></td>
<td><p>예</p></td>
<td><p>합병</p></td>
</tr>
...
<tr class="odd">
<td><p><a href="https://ko.wikipedia.org/wiki/선택_정렬" title="wikilink">선택 정렬</a></p></td>
<td></td>
<td></td>
<td></td>
<td></td>
...
비교 정렬 알고리즘들은 아무리 빨라도 최악의 경우 \(\Omega\left( n \log n \right)\) 시간을 필요로 한다. 이는 이 알고리즘들을 [결정 트리의](../Page/결정_트리.md "wikilink") 형태로 기술할 수 있다는 점에서 증명할 수 있는데, \(n\)개의 원소들의 [순열](https://ko.wikipedia.org/wiki/순열 "wikilink")은 \(n!\)가지로 이들을 잎 노드로 가지는 결정 트리의 깊이는 [스털링 근사에](../Page/스털링_근사.md "wikilink") 따라 적어도 \(\lceil \log n! \rceil \approx n \log n\)이어야 하기 때문이다.
...
## 같이 보기
  ...
  - [검색 알고리즘](https://ko.wikipedia.org/wiki/검색_알고리즘 "wikilink")
