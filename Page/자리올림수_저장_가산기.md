...
**자리올림수 저장 가산기**는 [이진법](https://ko.wikipedia.org/wiki/이진법 "wikilink")에서 3개 그이상의 *n* 비트수 덧셈을 계산하기위한 컴퓨터 기본설계에 사용하는 [가산기](../Page/가산기.md "wikilink")의 한 종류이다. 입력과 같은 크기의 두개의 수를 출력하는 것이 다른 디지털 가산기와 다르다. 하나는 부분적인 덧셈 비트의 반복이고, 다른하나는 [자리올림수](https://ko.wikipedia.org/wiki/자리올림수 "wikilink") 비트의 반복이다.
