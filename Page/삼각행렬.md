...
## 성질
  ...
  - 상삼각행렬이면서 하삼각행렬인 행렬은 [대각행렬](https://ko.wikipedia.org/wiki/대각행렬 "wikilink")이다.
  - 삼각행렬이면서 [정규행렬](https://ko.wikipedia.org/wiki/정규행렬 "wikilink")인 행렬은 [대각행렬](https://ko.wikipedia.org/wiki/대각행렬 "wikilink")이다.
  - 상삼각행렬은 덧셈, 곱셈, 역행렬에 대해 닫혀 있다. 즉, 상삼각행렬간의 덧셈, 곱셈, 역행렬 연산을 통해 나오는 [행렬](https://ko.wikipedia.org/wiki/행렬 "wikilink")은 상삼각행렬이다. 이 성질은 하삼각행렬에 대해서도 성립한다.
      - 단, 순삼각행렬 등과 같이 행렬식이 0 의 값을 가질 경우 역행렬이 존재하지 않으므로, 역행렬에 대해 닫혀있기 위해서는 삼각행렬이 가역행렬이어야 한다는 추가 조건이 있다.
  - 삼각행렬의 [행렬식](https://ko.wikipedia.org/wiki/행렬식 "wikilink")은 대각항들의 곱과 같다.
  - [대각행렬](https://ko.wikipedia.org/wiki/대각행렬 "wikilink")과 [사다리꼴행렬은](https://ko.wikipedia.org/wiki/행사다리꼴행렬 "wikilink") 삼각행렬의 특수한 형태이다.
...
<!-- end list -->
  ...
  - [단위](https://ko.wikipedia.org/wiki/단위행렬 "wikilink") 하삼각행렬
