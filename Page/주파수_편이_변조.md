...
**주파수 편이 변조**(Frequency-shift keying, FSK)란 [반송파](https://ko.wikipedia.org/wiki/반송파 "wikilink")(carrier wave)의 이산 주파수(discrete frequencies) 변화를 통해 디지털 정보가 전송되는 [주파수 변조](https://ko.wikipedia.org/wiki/주파수_변조 "wikilink") 체계이다.\[1\] 가장 간단한 FSK는 [이진](https://ko.wikipedia.org/wiki/이진법 "wikilink") FSK(BFSK)이다. BFSK는 이진수 정보(0과 1로 구성)를 전송하기 위해 한 쌍의 이산 주파수를 사용한다.\[2\] BFSK에서 "1"은 mark 주파수, 그리고 "0"은 space 주파수라 불린다.
