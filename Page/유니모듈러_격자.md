...
**격자**() \((L,\langle\cdot,\cdot\rangle)\)는 다음과 같은 데이터로 주어진다.
  ...
  - \(L\)은 [자유](https://ko.wikipedia.org/wiki/자유_아벨_군 "wikilink") [유한 생성 아벨 군이다](https://ko.wikipedia.org/wiki/유한_생성_아벨_군 "wikilink").
  - \(\langle\cdot,\cdot\rangle\colon L\times L\to\mathbb Z\)는 [정수](https://ko.wikipedia.org/wiki/정수 "wikilink") 값을 갖는 대칭 [쌍선형 형식이다](https://ko.wikipedia.org/wiki/쌍선형_형식 "wikilink").
