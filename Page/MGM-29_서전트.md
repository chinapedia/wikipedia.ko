...
2011년 기준으로는 랜스 미사일을 대체하여 [에이태킴스 미사일을](https://ko.wikipedia.org/wiki/에이태킴스_미사일 "wikilink") 한국과 미국에서 사용한다. 랜스와 에이태킴스는 모두 M74 자탄을 사용하는 집속탄을 장착할 수 있는데, 사거리, 자탄수를 비교하면 다음과 같다.

  - MGM-52 랜스, 무게 1.52톤, 사거리 70 km, 484 kg (M74 822발)
  - MGM-140A ATACMS, 무게 1.67톤, 사거리 128 km, 560 kg (M74 950발)

언론에서는 이와 관련해서, 오보가 좀 있는데, M74 950발은 33000평방미터를 초토화 한다. 그러나 한국 언론은 오보를 하여서, 에이태킴스 1발에는 자탄 300여 개가 들어 있어 축구장 3∼4개 넓이를 초토화할 수 있다고 한다.\[1\] 반면에, 다른 보도에서는 현재 군에 배치된 에이태킴스는 950개의 자탄이 들어있어 축구장 3\~4개 크기 지역을 초토화할 수 있다고 한다.\[2\] 즉, 언론 보도를 보면 300발 버전과 950발 버전 모두 축구장 3-4개라고 보도해서, 정확하지 않다.

정확한 팩트는, M74 950발은 33000평방미터를 초토화 하며, 일반적인 축구장의 넓이는 4,000\~11,000평방미터이다. 한국군은 에이태킴스 M74 300발 버전을 구매했다. 사거리가 128 km에서 300 km로 늘어난 대신, 자탄수는 1/3만 장착한 버전이다.

## 북한

2011년 기준으로, 북한은 [KN-02 미사일을](https://ko.wikipedia.org/wiki/KN-02_미사일 "wikilink") 실전배치했다. 코퍼럴, 서전트, 랜스, 에이태킴스와 북한의 KN-02는 같은 용도, 같은 사거리의 미사일이다.

## 스카웃 로켓

[스카웃 로켓은](https://ko.wikipedia.org/wiki/스카웃_로켓 "wikilink") 미국의 소형 인공위성 [우주발사체](../Page/우주발사체.md "wikilink")이다. 4단 엔진 모두가 고체로켓으로서, 미국 최초의 완전한 고체연료 우주 발사체이다. 1단 엔진은 쥬피터 시니어와 [미국 해군의](../Page/미국_해군.md "wikilink") [UGM-27 폴라리스](../Page/UGM-27_폴라리스.md "wikilink") 엔진을 조합한 것이고, 2단 엔진은 [미국 육군의](../Page/미국_육군.md "wikilink") MGM-29 서전트 엔진이며, 3단과 4단 엔진은 [미국 해군의](../Page/미국_해군.md "wikilink") [뱅가드 로켓](https://ko.wikipedia.org/wiki/뱅가드_로켓 "wikilink") 엔진을 개조한 것이다.\[3\]
...
1.  "美, 北 ICBM 쏘자 김정은 텐트까지 거리 계산해 미사일 날려", 한국경제, 2020.09.14.
2.  北, 신형 지대지 전술미사일 개발한 듯…에이태킴스와 닮은 꼴(종합2보), 연합뉴스, 2019.08.11.
3.