...
**시스템 아키텍처 에볼루션**(System Architecture Evolution, SAE)는 [3GPP](https://ko.wikipedia.org/wiki/3GPP "wikilink") [EPC](https://ko.wikipedia.org/wiki/EPC "wikilink")망 내에서 호처리 기능을 수행하는 네트워크 구성요소이다. SAE의 대표적인 기능은 다음과 같다.
