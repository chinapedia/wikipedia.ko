...
**Botan**은 [BSD 사용 허가서로](https://ko.wikipedia.org/wiki/BSD_사용_허가서 "wikilink") 라이선스된 [암호화](../Page/암호화.md "wikilink") 라이브러리이다.
...
Botan은 [리눅스](../Page/리눅스.md "wikilink"), FreeBSD, NetBSD, [솔라리스](../Page/솔라리스_\(운영_체제\).md "wikilink"), Mac OS X, 마이크로소프트 윈도 용으로 나와 있다. 1.10 버전까지는 [C++98](https://ko.wikipedia.org/wiki/C++98 "wikilink") 스탠다드에 맞춰 구현되어 있으며, 이후버전은 [C++11](../Page/C++11.md "wikilink") 스탠다드 컴파일러가 필요하다. STL 및 ISO 표준 라이브러리 외에 다른 디펜던시가 없다.
