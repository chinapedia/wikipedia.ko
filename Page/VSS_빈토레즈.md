...
빈토레즈의 전체적인 작동 원리와 소음억제는 [AS Val에서](../Page/AS_Val.md "wikilink") 시작되었다고 볼 수 있으며, 빈토레즈는 가스 작동식에 발사 방식을 변경할 수 있는 저격소총이며, 총열안에 있는 길다란 주름이 달린 가스 피스톤안에서 가스 활대가 움직이는 구조로 되어 있다. 또한 빈토레즈는 [회전 노리쇠 방식을](../Page/회전_노리쇠_방식.md "wikilink") 사용하며, 공이를 사용하여 발사한다. 빈토레즈는 방아쇠 뒤에 크로스 볼트 형태의 발사 방식 변경 스위치가 있으며, 방아쇠 안전장치가 있다. 이들 안전 레버와 장전 핸들은 AK형의 소총과 공통점이 있다.
