...
<small>수록된 시간은 영국에서 발매된 LP 음반을 기준으로 하였다.
앨범의 모든 가사는 로저 워터스가 작사했다.</small>
...
5.  "The Great Gig in the Sky" (라이트, 클레어 토리\[3\])

### B면

1.  "Money" (워터스) - 6:30
2.  "Us and Them" (워터스, 라이트) - 7:34
3.  "Any Colour You Like (길모어, 메이슨, 라이트) - 3:24
4.  "Brain Damage" (워터스) - 3:50
5.  "Eclipse" (워터스) - 1:45
...
<!-- end list -->
  ...
  - 보컬 - 클레어 토리
  - 백보컬 - 배리 세인트 존, 도리스 트로이, 레슬리 던컨, 리자 스트라이크
  - 색소폰 - 딕 패리
  - 엔지니어 - 알런 파슨스
  - 보조 엔지니어 - 피터 제임스
  - 믹싱 수퍼바이저 - 크리스 토마스
...
## 관련 자료
  ...
  - 핑크 플로이드, *Classic Albums: Pink Floyd - The Making of The Dark Side of the Moon*(DVD), 2003.

## 외부 링크

  - [핑크 플로이드 webpage](http://www.pinkfloyd.com/)

[분류:1973년 음반](https://ko.wikipedia.org/wiki/분류:1973년_음반 "wikilink") [분류:핑크 플로이드의 음반](https://ko.wikipedia.org/wiki/분류:핑크_플로이드의_음반 "wikilink") [분류:콘셉트 음반](https://ko.wikipedia.org/wiki/분류:콘셉트_음반 "wikilink")

1.
2.  이 곡을 "Time"과 "Breathe Reprise"의 두 곡으로 분류할 수도 있다. 1994년 EMI 리마스터링 CD 부클릿의 경우, 곡 목록에는 "Time" 한 곡으로 기록해 놓고 있지만, 가사는 "Breathe Reprise"를 따로 떼어놓았다.
3.  음반 크레딧에서는 클레어 토리가 포함되어 있지 않다. 하지만 법적 공방 끝에 [Pulse](https://ko.wikipedia.org/wiki/Pulse "wikilink") DVD 크레딧에 그녀의 이름이 올라갔다.