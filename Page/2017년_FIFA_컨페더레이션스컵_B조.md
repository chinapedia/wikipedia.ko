...
|          |                               |                              |                               |                             |                               |                  |               |                   |                 |                |                     |          |                        |                       |                        |                                   |                        |                  |               |                   |                 |                |                    |
| -------- | ----------------------------- | ---------------------------- | ----------------------------- | --------------------------- | ----------------------------- | ---------------- | ------------- | ----------------- | --------------- | -------------- | ------------------- | -------- | ---------------------- | --------------------- | ---------------------- | --------------------------------- | ---------------------- | ---------------- | ------------- | ----------------- | --------------- | -------------- | ------------------ |
| {{축구 유니폼 | pattern_la = _cameroun1617h | pattern_b = _cameroun1617h | pattern_ra = _cameroun1617h | pattern_sh = _kameroen17h | pattern_so = _cameroun1617h | leftarm = 17603E | body = 17603E | rightarm = 17603E | shorts = FF0000 | socks = FFF200 | title = 카메룬\[2\] }} | {{축구 유니폼 | pattern_la = _chi16a | pattern_b = _chi16A | pattern_ra = _chi16a | pattern_sh = _darkblue_stripes | pattern_so = _chi16t | leftarm = FFFFFF | body = FFFFFF | rightarm = FFFFFF | shorts = FFFFFF | socks = FFFFFF | title = 칠레\[3\] }} |
...
<tr class="even">
<td><p><a href="https://ko.wikipedia.org/wiki/위고_브루" title="wikilink">위고 브루</a></p></td>
<td></td>
</tr>
</tbody>
</table></td>
<td><p><a href="https://ko.wikipedia.org/wiki/파일:CMR-CHI_2017-06-18.svg" title="wikilink">300px</a></p></td>
<td><table>
<tbody>
<tr class="odd">
<td><p>GK</p></td>
...
<a href="https://ko.wikipedia.org/wiki/말랑_디에디우" title="wikilink">말랑 디에디우</a> (<a href="https://ko.wikipedia.org/wiki/세네갈_축구_협회" title="wikilink">세네갈</a>)</p></td>
</tr>
</tbody>
</table>
...
|          |                                |                               |                                |                                |                                |                  |               |                   |                 |                |                         |          |               |                         |               |                        |                          |                  |               |                   |                 |                |                    |
| -------- | ------------------------------ | ----------------------------- | ------------------------------ | ------------------------------ | ------------------------------ | ---------------- | ------------- | ----------------- | --------------- | -------------- | ----------------------- | -------- | ------------- | ----------------------- | ------------- | ---------------------- | ------------------------ | ---------------- | ------------- | ----------------- | --------------- | -------------- | ------------------ |
| {{축구 유니폼 | pattern_la = _australia1617h | pattern_b = _australia1617h | pattern_ra = _australia1617h | pattern_sh = _australia1617h | pattern_so = _australia1617h | leftarm = FFFFFF | body = FFFFFF | rightarm = FFFFFF | shorts = FFD801 | socks = 004A1E | title = 오스트레일리아\[5\] }} | {{축구 유니폼 | pattern_la = | pattern_b = _ger1617H | pattern_ra = | pattern_sh = _ger16h | pattern_so = _ger1617h | leftarm = FFFFFF | body = FFFFFF | rightarm = FFFFFF | shorts = 000000 | socks = FFFFFF | title = 독일\[6\] }} |
...
<td><p><a href="https://ko.wikipedia.org/wiki/파일:AUS-GER_2017-06-19.svg" title="wikilink">300px</a></p></td>
<td><table>
<tbody>
<tr class="odd">
<td><p>GK</p></td>
...
|          |                               |                              |                               |                             |                               |                  |               |                   |                 |                |                     |          |                                |                               |                                |                                |                                |                  |               |                   |                 |                |                         |
| -------- | ----------------------------- | ---------------------------- | ----------------------------- | --------------------------- | ----------------------------- | ---------------- | ------------- | ----------------- | --------------- | -------------- | ------------------- | -------- | ------------------------------ | ----------------------------- | ------------------------------ | ------------------------------ | ------------------------------ | ---------------- | ------------- | ----------------- | --------------- | -------------- | ----------------------- |
| {{축구 유니폼 | pattern_la = _cameroun1617h | pattern_b = _cameroun1617h | pattern_ra = _cameroun1617h | pattern_sh = _kameroen17h | pattern_so = _cameroun1617h | leftarm = 17603E | body = 17603E | rightarm = 17603E | shorts = FF0000 | socks = FFF200 | title = 카메룬\[8\] }} | {{축구 유니폼 | pattern_la = _australia1617h | pattern_b = _australia1617h | pattern_ra = _australia1617h | pattern_sh = _australia1617h | pattern_so = _australia1617h | leftarm = FFFFFF | body = FFFFFF | rightarm = FFFFFF | shorts = FFD801 | socks = 004A1E | title = 오스트레일리아\[9\] }} |
...
<td><p><a href="https://ko.wikipedia.org/wiki/파일:CMR-AUS_2017-06-22.svg" title="wikilink">300px</a></p></td>
<td><table>
<tbody>
<tr class="odd">
<td><p>GK</p></td>
...
<tr class="odd">
<td><p><strong>최우수 선수:</strong><br />
<a href="https://ko.wikipedia.org/wiki/앙드레프랑크_잠보_앙기사" title="wikilink">앙드레프랑크 잠보 앙기사</a> (카메룬)[10]</p>
<p><strong>부심:</strong><br />
<a href="https://ko.wikipedia.org/wiki/밀로반_리스티치" title="wikilink">밀로반 리스티치</a> (<a href="https://ko.wikipedia.org/wiki/세르비아_축구_협회" title="wikilink">세르비아</a>)<br />
...
|          |               |                         |               |                        |                          |                  |               |                   |                 |                |                     |          |                        |                       |                        |                                   |                        |                  |               |                   |                 |                |                     |
| -------- | ------------- | ----------------------- | ------------- | ---------------------- | ------------------------ | ---------------- | ------------- | ----------------- | --------------- | -------------- | ------------------- | -------- | ---------------------- | --------------------- | ---------------------- | --------------------------------- | ---------------------- | ---------------- | ------------- | ----------------- | --------------- | -------------- | ------------------- |
| {{축구 유니폼 | pattern_la = | pattern_b = _ger1617H | pattern_ra = | pattern_sh = _ger16h | pattern_so = _ger1617h | leftarm = FFFFFF | body = FFFFFF | rightarm = FFFFFF | shorts = 000000 | socks = FFFFFF | title = 독일\[11\] }} | {{축구 유니폼 | pattern_la = _chi16h | pattern_b = _chi16H | pattern_ra = _chi16h | pattern_sh = _darkblue_stripes | pattern_so = _chi16h | leftarm = FF0000 | body = FF0000 | rightarm = FF0000 | shorts = FF0000 | socks = 0000E8 | title = 칠레\[12\] }} |
...
<td><p><a href="https://ko.wikipedia.org/wiki/파일:GER-CHI_2017-06-22.svg" title="wikilink">300px</a></p></td>
<td><table>
<tbody>
<tr class="odd">
<td><p>GK</p></td>
...
<strong>대기심:</strong><br />
<a href="../Page/마크_가이거.md" title="wikilink">마크 가이거</a> (<a href="https://ko.wikipedia.org/wiki/미국_축구_협회" title="wikilink">미국</a>)<br />
<strong>비디오 판독심:</strong><br />
...
|          |               |                         |               |                        |                          |                  |               |                   |                 |                |                     |          |                               |                              |                               |                             |                               |                  |               |                   |                 |                |                      |
| -------- | ------------- | ----------------------- | ------------- | ---------------------- | ------------------------ | ---------------- | ------------- | ----------------- | --------------- | -------------- | ------------------- | -------- | ----------------------------- | ---------------------------- | ----------------------------- | --------------------------- | ----------------------------- | ---------------- | ------------- | ----------------- | --------------- | -------------- | -------------------- |
| {{축구 유니폼 | pattern_la = | pattern_b = _ger1617H | pattern_ra = | pattern_sh = _ger16h | pattern_so = _ger1617h | leftarm = FFFFFF | body = FFFFFF | rightarm = FFFFFF | shorts = 000000 | socks = FFFFFF | title = 독일\[14\] }} | {{축구 유니폼 | pattern_la = _cameroun1617h | pattern_b = _cameroun1617h | pattern_ra = _cameroun1617h | pattern_sh = _kameroen17h | pattern_so = _cameroun1617h | leftarm = 17603E | body = 17603E | rightarm = 17603E | shorts = FF0000 | socks = FFF200 | title = 카메룬\[15\] }} |
...
<tr class="odd">
<td><p><a href="https://ko.wikipedia.org/wiki/요아힘_뢰브" title="wikilink">요아힘 뢰브</a></p></td>
<td></td>
</tr>
</tbody>
</table></td>
<td><p><a href="https://ko.wikipedia.org/wiki/파일:GER-CMR_2017-06-25.svg" title="wikilink">300px</a></p></td>
<td><table>
<tbody>
<tr class="odd">
<td><p>GK</p></td>
...
<tr class="odd">
<td><p><strong>최우수 선수:</strong><br />
<a href="../Page/티모_베르너.md" title="wikilink">티모 베르너</a> (독일)[16]</p>
<p><strong>부심:</strong><br />
<a href="https://ko.wikipedia.org/wiki/알렉산데르_구스만" title="wikilink">알렉산데르 구스만</a> (<a href="https://ko.wikipedia.org/wiki/콜롬비아_축구_협회" title="wikilink">콜롬비아</a>)<br />
...
|          |                        |                       |                        |                                   |                        |                  |               |                   |                 |                |               |          |                                |                               |                                |                                |                                |                  |               |                   |                 |                |                    |
| -------- | ---------------------- | --------------------- | ---------------------- | --------------------------------- | ---------------------- | ---------------- | ------------- | ----------------- | --------------- | -------------- | ------------- | -------- | ------------------------------ | ----------------------------- | ------------------------------ | ------------------------------ | ------------------------------ | ---------------- | ------------- | ----------------- | --------------- | -------------- | ------------------ |
| {{축구 유니폼 | pattern_la = _chi16h | pattern_b = _chi16H | pattern_ra = _chi16h | pattern_sh = _darkblue_stripes | pattern_so = _chi16h | leftarm = FF0000 | body = FF0000 | rightarm = FF0000 | shorts = FF0000 | socks = 0000E8 | title = 칠레 }} | {{축구 유니폼 | pattern_la = _australia1617a | pattern_b = _australia1617A | pattern_ra = _australia1617a | pattern_sh = _australia1617a | pattern_so = _australia1617a | leftarm = 2D324B | body = 2D324B | rightarm = 2D324B | shorts = 2D324B | socks = FFD008 | title = 오스트레일리아 }} |
...
<td><p><a href="https://ko.wikipedia.org/wiki/파일:CHI-AUS_2017-06-25.svg" title="wikilink">300px</a></p></td>
<td><table>
<tbody>
<tr class="odd">
<td><p>GK</p></td>
...
<tr class="odd">
<td><p><strong>최우수 선수:</strong><br />
<a href="../Page/제임스_트로이시.md" title="wikilink">제임스 트로이시</a> (오스트레일리아)[17]</p>
<p><strong>부심:</strong><br />
...
<strong>보조 비디오 판독심:</strong><br />
<a href="https://ko.wikipedia.org/wiki/클레망_튀르팽" title="wikilink">클레망 튀르팽</a> (<a href="https://ko.wikipedia.org/wiki/프랑스_축구협회" title="wikilink">프랑스</a>)</p></td>
</tr>
</tbody>
</table>
