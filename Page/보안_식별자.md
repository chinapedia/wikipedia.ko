...
**보안 식별자**(保安識別子, Security Identifier, SID)는 [마이크로소프트](https://ko.wikipedia.org/wiki/마이크로소프트 "wikilink") [윈도 NT](https://ko.wikipedia.org/wiki/윈도_NT "wikilink") 계열의 [운영 체제](https://ko.wikipedia.org/wiki/운영_체제 "wikilink") 환경에서 NT/2000 시스템의 네트워크 안의 사용자 그룹이나 사용자와 같은 주체를 식별할 목적으로, 로그온을 하는 동안 윈도 [도메인 컨트롤러가](https://ko.wikipedia.org/wiki/도메인_컨트롤러 "wikilink") 할당하는 고유 이름이다.
