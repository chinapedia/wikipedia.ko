...
`       return "`[`"``   ``..``   ``target``   ``..``   ``"`](https://ko.wikipedia.org/wiki/"_.._target_.._" "wikilink")`"`
`   else`
`       return "`[`"``   ``..``   ``label``   ``..``   ``"`](https://ko.wikipedia.org/wiki/"_.._target_.._" "wikilink")`"`
`   end`
...
`               elseif not raw then`
`                   return "`[`File:"``   ``..``   ``datavalue``   ``..``   ``"`](https://ko.wikipedia.org/wiki/File:"_.._datavalue_.._" "fig:File:\" .. datavalue .. \"")`"`
`               else`
`                   return datavalue`
`               end`
...
`           end`
`           `
`           latValue = latDirection .. " " .. latValue `
`           lonValue = lonDirection .. " " .. lonValue`
`           `
