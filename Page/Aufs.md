...
**aufs** (**advanced multi-layered unification filesystem**)는 [리눅스](https://ko.wikipedia.org/wiki/리눅스 "wikilink") [파일 시스템을](https://ko.wikipedia.org/wiki/파일_시스템 "wikilink") 위한 [유니언 마운트를](https://ko.wikipedia.org/wiki/유니언_마운트 "wikilink") 구현한다. 이 이름은 원래 버전 2까지 **AnotherUnionFS**를 의미하였다.
...
Aufs는 [데비안](https://ko.wikipedia.org/wiki/데비안 "wikilink") "jessie"와 [우분투](https://ko.wikipedia.org/wiki/우분투_\(운영_체제\) "wikilink") 16.04에 별도로 포함되어 있다. 데비안의 "stretch"는 aufs를 더 이상 포함하지 않지만 [델](https://ko.wikipedia.org/wiki/델 "wikilink")의 [dkms를](https://ko.wikipedia.org/wiki/동적_커널_모듈_지원 "wikilink") 사용하여 aufs 커널 모듈을 자동으로 컴파일하는 aufs-dkms 패키지를 제공한다.

[도커는](../Page/도커_\(소프트웨어\).md "wikilink") 원래 컨테이너 파일시스템 계층을 위해 aufs를 사용하였다. 지원되는 스토리지 백엔드들 중 하나로 여전히 이용이 가능하다.

일부 [리눅스 배포판들은](https://ko.wikipedia.org/wiki/리눅스_배포판 "wikilink") UnionFS 대신 aufs를 채택하고 있는데, 이를테면 다음과 같다:

  - [크노픽스](https://ko.wikipedia.org/wiki/크노픽스 "wikilink") [라이브 CD](https://ko.wikipedia.org/wiki/라이브_CD "wikilink") [리눅스 배포판](https://ko.wikipedia.org/wiki/리눅스_배포판 "wikilink") - 2006년 말 이후, "더 나은 안정성과 성능을 위해"\[7\]
  ...
  - [SLAX](https://ko.wikipedia.org/wiki/SLAX "wikilink") (및 Linux-Live 스크립트) 버전 6 이후\[8\]
  - [잰드로스](../Page/잰드로스.md "wikilink") 리눅스 배포판, ASUS [Eee PC](https://ko.wikipedia.org/wiki/Eee_PC "wikilink") 모델 901에서 사용 가능
  - [우분투](https://ko.wikipedia.org/wiki/우분투_\(운영_체제\) "wikilink") 10.04 LTS Live CD
  - [데비안](https://ko.wikipedia.org/wiki/데비안 "wikilink") 6.0 라이브 미디어
  - [젠투 리눅스](https://ko.wikipedia.org/wiki/젠투_리눅스 "wikilink") LiveDVD 11.0\[9\]
  - [젠투 리눅스](https://ko.wikipedia.org/wiki/젠투_리눅스 "wikilink") LiveDVD 11.2\[10\]
  - [젠투 리눅스](https://ko.wikipedia.org/wiki/젠투_리눅스 "wikilink") LiveDVD 12.0\[11\]
