...
2차원 공간 위에서, 복소 좌표 \(z=x+iy\)를 사용하자. 2차원에서 [에너지-운동량 텐서는](https://ko.wikipedia.org/wiki/에너지-운동량_텐서 "wikilink") 대칭성에 의해 세 개의 독립된 성분을 가지는데, 이를 각각

\[T_{zz}(z,\bar z)=T(z,\bar z)\]

\[\bar T_{zz}(z,\bar z)=\bar T(z,\bar z)\]

\[T_{z\bar z}(z,\bar z)=\Theta(z,\bar z)\] 로 적자. [등각 장론의](https://ko.wikipedia.org/wiki/등각_장론 "wikilink") 경우 후자는 0이 된다.

양자장론은 일련의 [결합 상수](https://ko.wikipedia.org/wiki/결합_상수 "wikilink") \(g^i\in\mathcal G\) 및 [재규격화](https://ko.wikipedia.org/wiki/재규격화 "wikilink") 에너지 눈금 \(\Lambda\in\mathbb R^+\)에 의존하는 국소 라그랑지언 밀도 \(\mathcal L(g,\Lambda,z,\bar z)\)에 의해 정의된다. 양자장론이 [재규격화](https://ko.wikipedia.org/wiki/재규격화 "wikilink") 가능하다는 것은 다음 세 조건들을 의미한다.
...
<!-- end list -->
  ...
  - [에너지-운동량 텐서의](https://ko.wikipedia.org/wiki/에너지-운동량_텐서 "wikilink") 대각합 \(\Theta(z,\bar z)\)는 다음과 같다.
...
\[G(g)=\beta^i(g)\beta^j(g)G_{ij}(g)\] 라고 놓으면, \(G_{ij}\)는 [양의 정부호인](https://ko.wikipedia.org/wiki/양의_정부호 "wikilink") 대칭 행렬이다. 이 구조에 따라서 \((\mathcal G,G_{ij})\)는 [리만 다양체를](https://ko.wikipedia.org/wiki/리만_다양체 "wikilink") 이루며, 또한 항상 \(G(g)=\beta(g)^2\ge 0\)이 된다.
...
[존 카디는](../Page/존_카디.md "wikilink") 중심 원소 *c*가 계의 [자유도](https://ko.wikipedia.org/wiki/자유도 "wikilink")의 수를 나타내는 것을 보였다. 이후, [알렉산드르 자몰롯치코프가](../Page/알렉산드르_자몰롯치코프.md "wikilink") 1986년 〈2차원 장론의 [재규격화군](https://ko.wikipedia.org/wiki/재규격화군 "wikilink")의 "비가역성"〉이라는 제목의 논문\[1\]\[2\] 에서 c-정리를 증명하였다.\[3\]\[4\]

## 고차원에서의 c-정리

*c*-정리는 2차원의 경우에는 증명되었으나, 아직 고차원에서 성립하는지 알려지지 않았고, 특수한 경우에는 고차원에서의 반례도 발견되었다. 짝수 차원의 시공간에서, [존 카디는](../Page/존_카디.md "wikilink") *c*에 해당하는 값을 정의하였고,\[5\], 이는 *a*라고 불리게 되었다.\[6\] 카디는 *a*가 [재규격화군](https://ko.wikipedia.org/wiki/재규격화군 "wikilink") 흐름에 따라 항상 감소한다는 가설을 세웠다. 이를 ***a*-정리**()라고 한다. 4차원의 경우, *a*-정리는 2011년에 증명되었다.\[7\]\[8\]\[9\] 6차원의 경우는 아직 증명되지 않았다.\[10\]

2010년에는 3차원 등각 장론에 대하여 *F*라는 값이 정의되었다.\[11\]\[12\] 이는 3차원에서 *c* 또는 *a*에 대응하는 값으로 추측된다.

2010년에는 [홀로그래피 원리를](https://ko.wikipedia.org/wiki/홀로그래피_원리 "wikilink") 사용하여, 임의의 차원에서의 *c*-정리들이 제안되었다.\[13\] 이는 3차원에서 이미 정의된 *F*와 일치한다는 사실이 증명되었다.\[14\]
