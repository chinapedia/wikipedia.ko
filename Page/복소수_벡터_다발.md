...
[미분기하학](https://ko.wikipedia.org/wiki/미분기하학 "wikilink")에서, **복소수 벡터 다발**(複素數vector다발, )은 올이 [복소수 벡터 공간의](https://ko.wikipedia.org/wiki/복소수_벡터_공간 "wikilink") 구조를 갖추는 [매끄러운 벡터 다발이다](https://ko.wikipedia.org/wiki/매끄러운_벡터_다발 "wikilink").

## 정의

[매끄러운 다양체](https://ko.wikipedia.org/wiki/매끄러운_다양체 "wikilink") \(M\) 위의 (실수) [매끄러운 벡터 다발](https://ko.wikipedia.org/wiki/매끄러운_벡터_다발 "wikilink") \(E \twoheadrightarrow M\) 위의 **복소구조**는 다음과 같은 [벡터 다발 사상이다](https://ko.wikipedia.org/wiki/벡터_다발_사상 "wikilink").
...
[매끄러운 다양체](https://ko.wikipedia.org/wiki/매끄러운_다양체 "wikilink") \(M\) 위의 복소수 벡터 다발 \((E,J)\)이 주어졌을 때, \((E,-J)\) 역시 복소수 벡터 다발이다. 이를 \((E,J)\)의 **켤레 복소수 벡터 다발**()이라고 하며, 보통 \(\bar E\)로 표기한다.

켤레 복소수 벡터 다발의 [천 특성류는](https://ko.wikipedia.org/wiki/천_특성류 "wikilink") 다음과 같다.

\[\operatorname c_k(\bar E) = (-)^k \operatorname c_k(E)\]

### 복소화

[매끄러운 다양체](https://ko.wikipedia.org/wiki/매끄러운_다양체 "wikilink") \(M\) 위의 (실수) [매끄러운 벡터 다발](https://ko.wikipedia.org/wiki/매끄러운_벡터_다발 "wikilink") \(E\)가 주어졌다고 하자. 그렇다면,
...
다양체는 정의에 따라 [파라콤팩트 공간이므로](https://ko.wikipedia.org/wiki/파라콤팩트_공간 "wikilink"), 모든 복소수 벡터 다발은 (하나 이상의) 에르미트 접속을 갖는다. (물론, 이는 일반적으로 유일하지 않다.)

## 성질

접다발이 복소수 벡터 다발의 구조를 갖춘 [매끄러운 다양체를](https://ko.wikipedia.org/wiki/매끄러운_다양체 "wikilink") **[개복소다양체](../Page/개복소다양체.md "wikilink")**라고 한다.
...
복소수 벡터 다발에 대하여 [천 특성류와](https://ko.wikipedia.org/wiki/천_특성류 "wikilink") [오일러 특성류를](../Page/오일러_특성류.md "wikilink") 정의할 수 있다.
