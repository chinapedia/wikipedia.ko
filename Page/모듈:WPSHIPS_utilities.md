...
\--[--------------------------\< N A V S O U R C E \>------------------------------------------------------------ This version of the template {{navsource}} was added as a test vehicle for do_ship_name_format().](https://ko.wikipedia.org/wiki/--------------------------\<_N_A_V_S_O_U_R_C_E_\>------------------------------------------------------------_This_version_of_the_template_{{navsource}}_was_added_as_a_test_vehicle_for_do_ship_name_format\(\). "wikilink")
...
\--[--------------------------\< _ S H I P \>-------------------------------------------------------------------- This is a possible replacement for the template {{ship}}. It has better error detection and handling.](https://ko.wikipedia.org/wiki/--------------------------\<_S_H_I_P_\>--------------------------------------------------------------------_This_is_a_possible_replacement_for_the_template_{{ship}}._It_has_better_error_detection_and_handling. "wikilink")
...
`   `[`Flag_of_the_United_States.svg`](https://ko.wikipedia.org/wiki/File:Flag_of_the_United_States.svg "fig:Flag_of_the_United_States.svg")
`   `

Image syntax:

`   `[`Type`](https://ko.wikipedia.org/wiki/File:Name "fig:Type")
...
Here, we extract the various parts, italicize the ship name and reassemble for use by the cite danfs |title= parameter. To call this function:

`   |title={{#invoke:WPSHIPS utilities|cite_danfs_title|``}}`
...
[Category:WPSHIPS:Infobox_list_errors](https://ko.wikipedia.org/wiki/Category:WPSHIPS:Infobox_list_errors "wikilink")