...
[컴퓨팅](https://ko.wikipedia.org/wiki/컴퓨팅 "wikilink") 및 [전자통신](https://ko.wikipedia.org/wiki/전자통신 "wikilink") 환경에서 **제어 문자** 또는 **비인쇄 문자**는 [문자 집합의](https://ko.wikipedia.org/wiki/문자_집합 "wikilink") 특별한 문자이다.

## 아스키에서의 제어 문자

  - 0 ([널](https://ko.wikipedia.org/wiki/널_문자 "wikilink"), `NUL`, `\0`, `^@`)
