...
[셰이더](../Page/셰이더.md "wikilink")는 3개의 [SIMD](https://ko.wikipedia.org/wiki/SIMD "wikilink") 엔진으로 되어 있으며 각각 16개의 유닛으로 총 48개로 구성되어 있다. 또 각 셰이더 유닛은 2개의 [ALU](https://ko.wikipedia.org/wiki/ALU "wikilink")(쿨럭당 1개의 연산 가능)를 가지며 클럭당 2개의 [부동소수점](../Page/부동소수점.md "wikilink") 연산이 가능하다.
