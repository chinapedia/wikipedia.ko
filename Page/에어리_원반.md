...
[thumb](https://ko.wikipedia.org/wiki/파일:Airy_disk_created_by_laser_beam_through_pinhole.jpg "wikilink") **에어리 원반**(Airy disk)이란 [광학](https://ko.wikipedia.org/wiki/광학 "wikilink")에서 원형의 [구경을](https://ko.wikipedia.org/wiki/조리개 "wikilink") 통과한 점광이 빛의 [회절](https://ko.wikipedia.org/wiki/회절 "wikilink") 한계까지 만들 수 있는 최적의 상을 말한다.

원형 구경(사진기, 망원경 등)을 통과한 빛은 [회절](https://ko.wikipedia.org/wiki/회절 "wikilink")되어 중심에 밝은 부분을 만드는데 이를 **에어리 원반**이라 하고, 그 주위로 밝고 어두운 고리가 교대로 나타나는 것을 **에어리 무늬**(Airy pattern)라고 한다. 둘 다 [조지 비델 에어리의](https://ko.wikipedia.org/wiki/조지_비델_에어리 "wikilink") 이름이 붙은 것이다. 이 현상 자체는 에어리 이전에 [존 허셜이](https://ko.wikipedia.org/wiki/존_허셜 "wikilink") 먼저 발견했지만, 에어리가 1835년에 처음으로 완전한 이론적 설명을 제시하였다.\[1\]

회절 때문에 아무리 완벽한 환경에서 아무리 완벽한 렌즈를 사용해도 사진기 또는 망원경에 맺힌 상은 에어리 원반 이상으로 [분해될](https://ko.wikipedia.org/wiki/분해능 "wikilink") 수 없다. 이를 [회절한계](https://ko.wikipedia.org/wiki/회절한계 "wikilink")라고 한다. 에어리 원반은 [물리학](https://ko.wikipedia.org/wiki/물리학 "wikilink"), [광학](https://ko.wikipedia.org/wiki/광학 "wikilink"), [천문학](https://ko.wikipedia.org/wiki/천문학 "wikilink")에서 중요하다.
...
원형 구경에서 발생하는 [프라운호퍼 회절](../Page/프라운호퍼_회절.md "wikilink") 무늬(에어리 무늬)의 [세기는](https://ko.wikipedia.org/wiki/세기_\(물리학\) "wikilink") 원형 개구의 [푸리에 변환의](https://ko.wikipedia.org/wiki/푸리에_변환 "wikilink") 제곱 계수로 주어진다.

\[I(\theta) = I_0 \left ( \frac{2 J_1(ka \sin \theta)}{ka \sin \theta} \right )^2 = I_0 \left ( \frac{2 J_1(x)}{x} \right )^2\]

이때 \(I_0\)는 에어리 원반 중심의 최대 세기, \(J_1\)는 [베셀 함수](https://ko.wikipedia.org/wiki/베셀_함수 "wikilink"), \(k = {{2 \pi} \over {\lambda}}\)는 [파수](https://ko.wikipedia.org/wiki/파수 "wikilink"), \(a\)는 구경의 반경, \(\theta\)는 관찰 각도이다. i.e. 원형 구경의 축과 구경 중심과 관찰 지점을 이은 직선이 이루는 각도 \(x = ka \sin \theta = \frac{2 \pi a}{\lambda} \frac{q}{R} = \frac{\pi q}{\lambda N}\)로 나타낼 수 있다. 이때 q는 관찰평면(또는 초점평면)상에서 광학축에서 떨어진 방사상 거리이고 \(N =R/d\) (d=2a는 구경의 반경, R은 관찰 거리)는 이 시스템의 [F 값이다](https://ko.wikipedia.org/wiki/F_값 "wikilink").
...
첫 번째 어두운 무늬의 반지름 \(q_1\)은 \(\theta\) 및 [F 값에](https://ko.wikipedia.org/wiki/F_값 "wikilink") 다음과 같이 유관하다.
...
이때 \(J_0\)와 \(J_1\)은 [베셀 함수이다](https://ko.wikipedia.org/wiki/베셀_함수 "wikilink"). 이에 따라 첫 번째, 두 번째, 세 번째 어두운 고리(where \(J_1(ka \sin \theta)=0\)) 안에 포함되는 회절무늬의 일률은 각각 83.8%, 91.0%, and 93.8%이다.\[4\]
