...
:\* 기타 : [김세황](../Page/김세황.md "wikilink"), 배지환
...
## 참여 스텝
  ...
  - Executive Producer 김부영
  - Album & Music Produced By 김경호
  - Recording Studio : Velvet Sound Recording Studio
  - Recording Engineer 최종호
  - Mixing Engineer 박근준, 최종호
  - Assistant Engineer : 노광균, 이강민, 신용식, 최자옥
  - Mastering Studio : SONIC KOREA
  - Mastering Engineer : 최효영
  - Local A\&R : 황정현, 이현주
  - Photographer : 로빈킴
  - Jacket Design : Tugable
  - Stylist : 이호성 김형
  - Hair & Make Up : 이호성
  - 의상 협찬 : LOTOCO
  - Management : 남동우, 이민재
