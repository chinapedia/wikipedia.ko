...
코드 인젝션은 해킹이나 크래킹에서 정보를 얻거나 [권한 확대](../Page/권한_확대.md "wikilink") 또는 비인가 접근을 위한 인기있는 개념이다. 코드 인젝션은 아래와 같은 많은 악의적인 목적으로 사용될 수 있다.
  ...
  - 유닉스의 \[\[setuid|setuid\]\] root 바이너리의 셸 삽입 취약점을 이용하여 [root](https://ko.wikipedia.org/wiki/슈퍼_유저 "wikilink") 권한을 얻거나, 윈도우에서 돌아가는 서비스의 취약점을 이용해 [Local System을](https://ko.wikipedia.org/wiki/슈퍼_유저 "wikilink") 얻는 방식으로 [권한 확대를](../Page/권한_확대.md "wikilink") 한다.
...
코드 인젝션 문제를 예방하기 위하여, 아래와 같은 [안전한 입출력 처리를](../Page/안전한_입출력_처리.md "wikilink") 활용한다.
