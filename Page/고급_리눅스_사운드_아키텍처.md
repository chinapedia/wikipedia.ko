...
ALSA가 초기에 프로젝트로 시작될 당시에 내세워졌던 목적은, 사운드 카드 하드웨어의 자동 구성 및 리눅스 시스템 안에 들어가는 복수개의 사운드 장치의 원활한 제어였다. 자로슬라브 키셀라(Jaroslav Kysela([en](https://ko.wikipedia.org/wiki/:en:Jaroslav_Kysela "wikilink")))가 주도하는 ALSA 프로젝트는 1998년의 [그레비스 울트라사운드](../Page/그레비스_울트라사운드.md "wikilink") 사운드 드라이버용 리눅스 장치 드라이버로 처음 시작하였으며 2002년에 2.5 개발 버전(2.5.4-2.5.5)\[1\] 이후부터 리눅스 커널로부터 갈라져 나온 뒤에 계속 개발되고 있다. 2.6 버전부터 이전 시스템인 [오픈 사운드 시스템](https://ko.wikipedia.org/wiki/오픈_사운드_시스템 "wikilink")(OSS)을 기본으로 대체하고 있다. [펄스 오디오](https://ko.wikipedia.org/wiki/펄스_오디오 "wikilink") 및 [JACK](https://ko.wikipedia.org/wiki/JACK_오디오_사운드_키트 "wikilink") 등의 사운드 서버, OpenAL, SDL Audio 등의 고수준 추상화 API가 ALSA를 바탕으로 작동되어 사운드 카드의 장치 드라이버를 구현한다.

ALSA는 [GPL](https://ko.wikipedia.org/wiki/GNU_일반_공중_사용_허가서 "wikilink") 및 [LGPL](../Page/GNU_약소_일반_공중_사용_허가서.md "wikilink") 라이선스 하에 배포된다.

## 기능

ALSA는 [오픈 사운드 시스템](https://ko.wikipedia.org/wiki/오픈_사운드_시스템 "wikilink")(OSS)에서 고안 당시 지원하지 못했던 몇가지 다음 기능들을 포함하여 설계되었다.
...
## 같이 보기
  ...
  - [오픈 사운드 시스템](https://ko.wikipedia.org/wiki/오픈_사운드_시스템 "wikilink")
...
## 외부 링크
  ...
  - <https://web.archive.org/web/20120213025616/http://alsa.opensrc.org/Main_Page> (대형 ALSA [위키](https://ko.wikipedia.org/wiki/위키 "wikilink"))
