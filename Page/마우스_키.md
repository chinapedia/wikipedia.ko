...
**마우스 키**(mouse keys)는 자판(특히 [숫자 키패드](https://ko.wikipedia.org/wiki/숫자_키패드 "wikilink"))을 [포인팅 장치](https://ko.wikipedia.org/wiki/포인팅_장치 "wikilink")(일반적으로 [마우스](https://ko.wikipedia.org/wiki/마우스 "wikilink")를 대체)로 사용하는 일부 [그래픽 사용자 인터페이스의](https://ko.wikipedia.org/wiki/그래픽_사용자_인터페이스 "wikilink") 기능이다. 줄과 열의 탐색이 [방향키](https://ko.wikipedia.org/wiki/방향키_\(컴퓨터_자판\) "wikilink")(예: [hjkl](https://ko.wikipedia.org/wiki/방향키_\(컴퓨터_자판\) "wikilink"), [ctl-esdx](https://ko.wikipedia.org/wiki/ESDX "wikilink"))로 제어되었던 초창기 [시각 편집기](https://ko.wikipedia.org/wiki/시각_편집기 "wikilink") 시절에서 비롯되었다. 오늘날 마우스 키는 1984년 [X 윈도 시스템의](https://ko.wikipedia.org/wiki/X_윈도_시스템 "wikilink") 도입과 함께 표준화된 [숫자 키패드](https://ko.wikipedia.org/wiki/숫자_키패드 "wikilink") 레이아웃을 가리킨다.\[1\]\[2\]
...
| \+       | [double click selected button](https://ko.wikipedia.org/wiki/더블_클릭 "wikilink")                                 |
...
역사적으로, 수많은 [단말기](https://ko.wikipedia.org/wiki/단말기 "wikilink")가 전용 [포인팅 장치가](https://ko.wikipedia.org/wiki/포인팅_장치 "wikilink") 없을 경우 마우스 키는 GUI 프로그램을 지원하였다. 포인팅 장치를 어디서든 볼 수 있게 됨에 따라 마우스 키는 포인팅 장치가 없거나 사용할 수 없거나 불편한 상황에 사용되었다. 이러한 상황은 다음의 경우에 발생할 수 있다:

  - 정확성 요건 (예: [제도 (설계)](https://ko.wikipedia.org/wiki/제도_\(설계\) "wikilink"))
  - [장애인](https://ko.wikipedia.org/wiki/접근성 "wikilink") 또는 인간공학적 문제
  - 환경적 제한 (예: 차나 비행기의 떨림)
  - 장치 고장
