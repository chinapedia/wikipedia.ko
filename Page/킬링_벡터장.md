...
[리만 기하학에서](../Page/리만_기하학.md "wikilink"), **킬링 벡터장**(Killing vector場, )은 주어진 [리만 다양체의](https://ko.wikipedia.org/wiki/리만_다양체 "wikilink") [등거리 변환의](https://ko.wikipedia.org/wiki/등거리_변환 "wikilink") 무한소 생성원인 [벡터장](../Page/벡터장.md "wikilink")이다.\[1\] 즉, 리만 다양체의 대칭을 나타낸다. 킬링 벡터들은 [리 대수를](https://ko.wikipedia.org/wiki/리_대수 "wikilink") 이루며, 이는 다양체의 등거리 변환군의 리 대수로 생각할 수 있다.
...
\[\mathcal L_Xg\] 을 정의할 수 있다. 이는 (0,2)-텐서장들의 [벡터 공간](https://ko.wikipedia.org/wiki/벡터_공간 "wikilink") 위의 [선형 변환을](https://ko.wikipedia.org/wiki/선형_변환 "wikilink") 정의한다.

만약

\[\mathcal L_Xg=0\] 이 성립한다면, \(X\)를 \((M,g)\)의 **킬링 벡터장** \(X\in\Gamma(\mathrm TM)\)이라고 한다. 보다 추상적으로, 킬링 벡터장들의 [벡터 공간은](https://ko.wikipedia.org/wiki/벡터_공간 "wikilink") [선형 변환](https://ko.wikipedia.org/wiki/선형_변환 "wikilink")

\[X\mapsto \mathcal L_Xg\] 의 [핵이다](https://ko.wikipedia.org/wiki/핵_\(수학\) "wikilink"). 즉, 두 킬링 벡터장들의 합은 킬링 벡터장이며, 킬링 벡터장들의 상수 스칼라와의 곱 역시 킬링 벡터장이다.
...
\((M,g)\)의 [등거리 변환들은](https://ko.wikipedia.org/wiki/등거리_변환 "wikilink") (유한 차원) [리 군](https://ko.wikipedia.org/wiki/리_군 "wikilink")

\[\operatorname{Isom}(M,g)=\{f\in\mathcal C^\infty(M;M)\colon f^*g=g\}\] 을 이루며, 킬링 벡터장들은 등거리 변환군의 [리 대수](https://ko.wikipedia.org/wiki/리_대수 "wikilink") \(\mathfrak{isom}(M,g)\)를 이룬다.

### 킬링 지평선

[일반화 리만 다양체](../Page/일반화_리만_다양체.md "wikilink") \((M,g)\)의 킬링 벡터장 \(X\)가 주어졌을 때, 부분 집합 \(\{x\in M\colon g(X,X)|_x=0\}\)을 \(X\)의 **킬링 지평선**(Killing地平線, )이라고 한다.\[3\] 이는 일반적으로 특이점을 가져 [다양체](https://ko.wikipedia.org/wiki/다양체 "wikilink")가 아닐 수 있다.
...
[일반화 리만 다양체](../Page/일반화_리만_다양체.md "wikilink") \((M,g)\)의 킬링 벡터장들의 벡터 공간은 [리 대수를](https://ko.wikipedia.org/wiki/리_대수 "wikilink") 이룬다. 즉, 두 킬링 벡터장의 [리 괄호](../Page/리_미분.md "wikilink") 역시 킬링 벡터장이다. 같은 차원과 부호수를 갖는 두 [일반화 리만 다양체](../Page/일반화_리만_다양체.md "wikilink") \((M,g)\), \((M',g')\)에 대하여, 표준적으로

\[\mathfrak{isom}(M\sqcup M',g\sqcup g')\cong\mathfrak{isom}(M,g)\oplus\mathfrak{isom}(M',g')\] 이다.

\(k\)개의 [연결 성분을](https://ko.wikipedia.org/wiki/연결_성분 "wikilink") 갖는, \(n\)차원의 [일반화 리만 다양체의](../Page/일반화_리만_다양체.md "wikilink") 킬링 리 대수의 차원은 \(kn(n+1)/2\) 이하이다.\[4\] (이 상한은 예를 들어 [유클리드 공간](https://ko.wikipedia.org/wiki/유클리드_공간 "wikilink")·[초구](https://ko.wikipedia.org/wiki/초구 "wikilink")·[쌍곡 공간](https://ko.wikipedia.org/wiki/쌍곡_공간 "wikilink")·[민코프스키 공간](https://ko.wikipedia.org/wiki/민코프스키_공간 "wikilink")·[더 시터르 공간](../Page/더_시터르_공간.md "wikilink")·[반 더 시터르 공간](../Page/반_더_시터르_공간.md "wikilink") 및 이들의 [분리합집합](https://ko.wikipedia.org/wiki/분리합집합 "wikilink")에 의하여 포화된다.)

### 위상 수학적 성질

[콤팩트](../Page/콤팩트_공간.md "wikilink") [리만 다양체](https://ko.wikipedia.org/wiki/리만_다양체 "wikilink") \((M,g)\)에 대하여, 다음이 성립한다.
...
[일반화 리만 다양체](../Page/일반화_리만_다양체.md "wikilink") \((M,g)\)의 킬링 벡터장 \(X\)의 [발산은](https://ko.wikipedia.org/wiki/발산_\(벡터\) "wikilink") 0이다.
...
\(X\)의 2차 공변 미분은 다음과 같이 [리만 곡률 텐서에](https://ko.wikipedia.org/wiki/리만_곡률_텐서 "wikilink") 비례한다.\[5\]
...
[리만 곡률 텐서의](https://ko.wikipedia.org/wiki/리만_곡률_텐서 "wikilink") 정의에 따라
...
\[\nabla^2 X_\mu=-R_{\mu\nu}X^\nu\] 특히, [아인슈타인 방정식의](https://ko.wikipedia.org/wiki/아인슈타인_방정식 "wikilink") 진공해의 경우 \(R_{\mu\nu}=0\)이며, \(X_\mu\)의 [라플라스-벨트라미 연산자는](https://ko.wikipedia.org/wiki/라플라스-벨트라미_연산자 "wikilink") 0이다. 물리학적으로, 이는 \(X_\mu\)가 진공 [맥스웰 방정식을](https://ko.wikipedia.org/wiki/맥스웰_방정식 "wikilink") 만족시키는 것을 의미하며, 또한 \(X_\mu\)는 [로렌츠 게이지 조건](https://ko.wikipedia.org/wiki/로렌츠_게이지_조건 "wikilink") \(\nabla\cdot X=0\) 역시 자동적으로 만족시킨다. 이 사실을 통해 아인슈타인-맥스웰 계의 일부 해를 구할 수 있다.\[7\]
...
\[Y|_{\gamma(t)}=\dot\gamma(t)\in\mathrm T_{\gamma(t)}M\qquad\forall t\in\mathbb R\] 인 임의의 벡터장이라고 하자. (만약 \(\gamma\)가 [단사 함수가](https://ko.wikipedia.org/wiki/단사_함수 "wikilink") 아니라면, 이는 조각별로 정의하면 된다.)
...
마찬가지로, [일반 상대성 이론에서는](https://ko.wikipedia.org/wiki/일반_상대성_이론 "wikilink") [뇌터 정리에](../Page/뇌터_정리.md "wikilink") 따라 각 킬링 벡터장에 대응하는 [보존 법칙이](https://ko.wikipedia.org/wiki/보존_법칙 "wikilink") 존재한다. 구체적으로, [에너지-운동량 텐서](https://ko.wikipedia.org/wiki/에너지-운동량_텐서 "wikilink") \(T_{\mu\nu}=(R_{\mu\nu}-Rg_{\mu\nu}/2)/(8\pi G)\)를 생각할 때,
...
유사하게 킬링 [텐서](https://ko.wikipedia.org/wiki/텐서 "wikilink") 및 킬링 [스피너](https://ko.wikipedia.org/wiki/스피너 "wikilink")장을 정의할 수 있다. 예를 들어, 킬링 2-텐서장 \(T\)는 다음을 만족한다.
...
2차원 [민코프스키 공간](https://ko.wikipedia.org/wiki/민코프스키_공간 "wikilink")
