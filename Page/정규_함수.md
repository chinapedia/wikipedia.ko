...
[집합론](https://ko.wikipedia.org/wiki/집합론 "wikilink")에서, **정규 함수**(正規函數, )는 그 도함수를 취할 수 있는, [정의역](https://ko.wikipedia.org/wiki/정의역 "wikilink")과 [공역이](https://ko.wikipedia.org/wiki/공역_\(수학\) "wikilink") [순서수](https://ko.wikipedia.org/wiki/순서수 "wikilink")의 [모임인](https://ko.wikipedia.org/wiki/모임_\(수학\) "wikilink") [연속](https://ko.wikipedia.org/wiki/연속_함수 "wikilink") [증가 함수이다](https://ko.wikipedia.org/wiki/증가_함수 "wikilink"). 이를 사용하여 매우 큰 [가산](https://ko.wikipedia.org/wiki/가산_집합 "wikilink") [순서수](https://ko.wikipedia.org/wiki/순서수 "wikilink")들을 나타낼 수 있다.

## 정의

집합론적 문제를 피하기 위하여, [비가산](https://ko.wikipedia.org/wiki/비가산 "wikilink") [도달 불가능한 기수](https://ko.wikipedia.org/wiki/도달_불가능한_기수 "wikilink") \(\kappa\)를 고르자. (만약 [모임](https://ko.wikipedia.org/wiki/모임_\(수학\) "wikilink") 이론을 사용한다면 \(\kappa=\operatorname{Ord}\)로 놓을 수 있다. 여기서 \(\operatorname{Ord}\)는 모든 [순서수](https://ko.wikipedia.org/wiki/순서수 "wikilink")들의 [모임이다](https://ko.wikipedia.org/wiki/모임_\(수학\) "wikilink").)

[자기 함수](https://ko.wikipedia.org/wiki/자기_함수 "wikilink")

\[f\colon\kappa\to\kappa\] 가 다음 조건을 만족시킨다면 **정규 함수**라고 한다.

  - [순증가 함수이다](https://ko.wikipedia.org/wiki/순증가_함수 "wikilink"). 즉, 임의의 두 [순서수](https://ko.wikipedia.org/wiki/순서수 "wikilink") \(\alpha<\beta<\kappa\)에 대하여, \(f(\alpha)<f(\beta)\)이다.
  - [순서 위상에](https://ko.wikipedia.org/wiki/순서_위상 "wikilink") 대하여 [연속 함수이다](https://ko.wikipedia.org/wiki/연속_함수 "wikilink"). 즉, [극한 순서수](https://ko.wikipedia.org/wiki/극한_순서수 "wikilink") \(\alpha<\kappa\)에 대하여, \(f(\alpha)=\textstyle\sup_{\beta<\alpha}f(\beta)\)이다.
...
[귀류법](https://ko.wikipedia.org/wiki/귀류법 "wikilink")을 사용하자.
...
\[\alpha=\min\{\beta<\kappa\colon\beta>f(\beta)\}\] 라면 \(\alpha>f(\alpha)>f(f(\alpha))\)이자 \(f(\alpha)\in\{\beta<\kappa\colon\beta>f(\beta)\}\)이므로 모순이다.
  ...
  - 임의의 순서수들의 [집합](https://ko.wikipedia.org/wiki/집합 "wikilink") \(S\subseteq\kappa\)에 대하여, \(\textstyle f(\sup S)=\sup_{s\in S}f(s)\)
...
**베블런 고정점 정리**(Veblen固定點定理, )에 따르면, \(f\)의 [고정점](../Page/고정점.md "wikilink")들의 [모임의](https://ko.wikipedia.org/wiki/모임_\(수학\) "wikilink") 상한은 \(\kappa\)이다.
...
다음과 같은 함수들은 정규 함수이다.
  ...
  - [알레프 수](https://ko.wikipedia.org/wiki/알레프_수 "wikilink") \(\alpha\mapsto\aleph_\alpha\)
  - [베트 수](../Page/베트_수.md "wikilink") \(\alpha\mapsto\beth_\alpha\)

(마지막 두 예는 [도달 불가능한 기수는](https://ko.wikipedia.org/wiki/도달_불가능한_기수 "wikilink") 알레프 함수와 베트 함수의 [고정점](../Page/고정점.md "wikilink")이기 때문이다.\[1\]\[2\])
