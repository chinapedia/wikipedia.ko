...
[섬네일](https://ko.wikipedia.org/wiki/파일:StartUp-Manager.png "wikilink")\]\] **GNU GRUB**(대개 GRUB)은 [GNU](https://ko.wikipedia.org/wiki/GNU "wikilink") 프로젝트의 [부트로더](https://ko.wikipedia.org/wiki/부트로더 "wikilink")이다. 대부분 운영 체제의 커널을 불러올 수 있으며, 인자를 넘겨 줄 수도 있다. GNU GRUB의 이전 이름은 **GRand Unified Bootloader**이었고 이는 [대통일 이론의](https://ko.wikipedia.org/wiki/대통일_이론 "wikilink") 영문 이름의 패러디이다. 대부분 [리눅스 배포판에서](https://ko.wikipedia.org/wiki/리눅스_배포판 "wikilink") 부트로더로 사용한다.
...
## 기능
  ...
  - 사용자 정의 부팅 기능
  - [파일 시스템](https://ko.wikipedia.org/wiki/파일_시스템 "wikilink") 직접 접근 기능
  ...
  - 자동으로 압축 해제 지원
  - 지오메트리 정보 독립
  - 모든 [RAM을](https://ko.wikipedia.org/wiki/랜덤_액세스_메모리 "wikilink") [바이오스](https://ko.wikipedia.org/wiki/바이오스 "wikilink")와 관계없이 인식
  - [LBA](../Page/논리_블록_주소_지정.md "wikilink") 및 [네트워크](https://ko.wikipedia.org/wiki/통신_네트워크 "wikilink") 지원
  - 디스크 없는 시스템 지원

## 설치

GRUB은 [LILO](https://ko.wikipedia.org/wiki/LILO "wikilink")와 달리 설정 변경 후에 재설치가 필요 없다. GRUB은 스테이지 단위로 부팅 과정이 구성되어 있으며, GRUB의 스테이지 1은 MBR에 존재한다. GRUB 설정 파일은 대개 스테이지 2에서 불리며 이들은 GRUB이 읽을 수 있는 파티션에 존재한다. 만약 설정 파일이 없으면 명령줄로 간다. 이들 설정 파일은 /boot/grub에 있으며 배포판마다 파일 이름이 다르다. 이러한 구조 때문에 GRUB 설정 파일이 있던 파티션만 지웠다면 평소 보던 메뉴가 사라지므로, 초보자들은 부팅이 되지 않는다는 것으로 착각할 수 있다.

[CD](https://ko.wikipedia.org/wiki/콤팩트_디스크 "wikilink"), [DVD](https://ko.wikipedia.org/wiki/DVD "wikilink") 같은 다양한 장치에서의 부팅도 지원한다.
...
이 자료는 2005년 현재 자료이다.
  ...
  - [IBM](https://ko.wikipedia.org/wiki/IBM "wikilink") [JFS](https://ko.wikipedia.org/wiki/JFS "wikilink")
  ...
  - [UFS](https://ko.wikipedia.org/wiki/유닉스_파일_시스템 "wikilink")/[UFS2](https://ko.wikipedia.org/wiki/UFS2 "wikilink")
  - [FAT](https://ko.wikipedia.org/wiki/파일_할당_테이블 "wikilink") 계열 파일시스템
  - [NTFS](https://ko.wikipedia.org/wiki/NTFS "wikilink")

## 지원하는 운영 체제

[300px나](https://ko.wikipedia.org/wiki/파일:Gnu_grub_config_file.png "wikilink") [우분투를](https://ko.wikipedia.org/wiki/우분투_\(운영_체제\) "wikilink") 불러올 수 있게 한다.\]\]
