...
[QR 분해에서](https://ko.wikipedia.org/wiki/QR_분해 "wikilink") 하우스홀더 리플렉터를 이용하여 한 열씩을 상삼각행렬로 접근해 바꾸어감으로써 \(Q\)와 \(R\)을 구할 수 있는데,

이 방법은 \(Q\)행렬을 하우스홀더 행렬의 곱으로 구해주기 때문에, 직접 \(Q\)를 구할 수 없을 때 유용하다.

또한 부동소수점 연산에서도 오차가 누적되지 않는 성질이 있다.

또, [그람-슈미트 방법과](https://ko.wikipedia.org/wiki/그람-슈미트_방법 "wikilink") [기븐스 회전](https://ko.wikipedia.org/wiki/기븐스_회전 "wikilink") 방법과 함께 [QR 분해에서](https://ko.wikipedia.org/wiki/QR_분해 "wikilink") 고유한 방법을 제공한다.
...
\[sgn()\]는 [부호함수](https://ko.wikipedia.org/wiki/부호함수 "wikilink")
...
이것의 최종 결과는 원래의 것과 유사한 형태인 \(3 \times 3 matrix\)의 [3중대각행렬](../Page/3중대각행렬.md "wikilink")이다.

## 함께보기

  - [하우스홀더 행렬](https://ko.wikipedia.org/wiki/하우스홀더_행렬 "wikilink")
  - [5중대각행렬](https://ko.wikipedia.org/wiki/5중대각행렬 "wikilink")
  - [케일리 변환](https://ko.wikipedia.org/wiki/케일리_변환 "wikilink")(Cayley transform)
