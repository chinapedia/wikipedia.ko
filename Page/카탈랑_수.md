...
[조합론](../Page/조합론.md "wikilink")에서, *' 카탈랑 수*'(Catalan數, )는 [이진 트리의](https://ko.wikipedia.org/wiki/이진_트리 "wikilink") 수 따위를 셀 때 등장하는 [수열](https://ko.wikipedia.org/wiki/수열 "wikilink")이다.
...
\[C_n = \frac1{n+1}\binom{2n}n = \frac{(2n)!}{n!(n+1)!} = \prod_{i=2}^n\frac{n+i}i\] 여기서 \((-)!\)는 [계승](https://ko.wikipedia.org/wiki/계승 "wikilink")이며, \(\textstyle\binom{-}{-}\)은 [이항 계수이다](https://ko.wikipedia.org/wiki/이항_계수 "wikilink").

### 점화식

카탈랑 수는 다음과 같은 [점화식](https://ko.wikipedia.org/wiki/점화식 "wikilink")으로 재귀적으로 정의될 수 있다.
...
\[C(z) = \sum_{n=0}^\infty C_nz^n\] 라고 정의하자. [점화식](https://ko.wikipedia.org/wiki/점화식 "wikilink")에 의하여 \(C(z) = 1 + zC(z)^2\)이므로,

\[C(z) = \frac{1-\sqrt{1-4z}}{2z}\] 이다. 그 [테일러 급수는](https://ko.wikipedia.org/wiki/테일러_급수 "wikilink") ([뉴턴의 이항정리를](https://ko.wikipedia.org/wiki/뉴턴의_이항정리 "wikilink") 이용하면)
...
<big> XXXYYY     XYXXYY     XYXYXY     XXYYXY     XXYXYY.</big>
...
\(((ab)c)d \quad (a(bc))d \quad(ab)(cd) \quad a((bc)d) \quad a(b(cd))\)
  ...
  - 이항 연산의 적용 순서는 [이진 트리로도](https://ko.wikipedia.org/wiki/이진_트리 "wikilink") 나타낼 수 있다. 따라서 *C*<sub>*n*</sub>은 *n* + 1개의 단말 노드를 갖는 이진 순서 트리의 개수임을 알 수 있다.
...
유럽 수학에서는 [레온하르트 오일러가](../Page/레온하르트_오일러.md "wikilink") "(*n*+2)-각형을 *n*개의 삼각형으로 나눌 수 있는 경우의 수"를 세는 문제를 제안하면서 처음 나타났다. [벨기에](../Page/벨기에.md "wikilink")의 수학자 [외젠 샤를 카탈랑이](../Page/외젠_샤를_카탈랑.md "wikilink") [하노이의 탑](https://ko.wikipedia.org/wiki/하노이의_탑 "wikilink") 문제를 고려하면서 1838년에 재발견하였다.\[7\]\[8\]
