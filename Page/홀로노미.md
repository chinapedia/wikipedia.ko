...
[리만 다양체는](../Page/리만_다양체.md "wikilink") 그 [접다발](../Page/접다발.md "wikilink")과 [레비치비타 접속을](https://ko.wikipedia.org/wiki/레비치비타_접속 "wikilink") 지니므로, 이에 대한 홀로노미를 정의할 수 있다. 다른 수식어 없이 "리만 다양체의 홀로노미"라 하면 이를 지칭한다. \(n\)차원 리만 다양체의 홀로노미는 \(O(n)\)의 닫힌 [리 부분군이다](../Page/리_군.md "wikilink") (Borel & Lichnerowitz). 가향(可向) 리만 다양체의 홀로노미는 \(SO(n)\)의 부분군이다. 대체로 더 대칭적이고 규칙적일 수록 홀로노미가 작아진다.
...
(국소) [대칭 공간은](../Page/대칭_공간.md "wikilink") 정의상 국소적으로 *G*/*H*의 꼴로 나타낼 수 있다. 여기서 *G*는 [리 군](../Page/리_군.md "wikilink"), *H*는 특정한 성질을 지닌 부분군이다. 이 때, 국소적 홀로노미는 *H*다.
