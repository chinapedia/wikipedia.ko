...
## 돌연변이
  ...
  - recA1 돌연변이는 RecA 폴리펩티드의 글리신 160을 아스파르트 산 잔기로 대체하는 단일점 돌연변이이며\[3\] 재조합효소의 활성을 억제하고 상동 재조합을 불활성화시킨다.
  - endA1 돌연변이는 세포 내 엔도뉴클레아제(endonuclease)를 불활성화하여 플라스미드 정제 과정(Miniprep)에서 이 효소가 플라스미드를 분해하지 못하도록 한다.\[4\]

## 각주

[분류:대장균](https://ko.wikipedia.org/wiki/분류:대장균 "wikilink")
