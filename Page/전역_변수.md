...
어떤 스코프에서도 참조하고, 변경할 수 있기 때문에 지역성이 없다. 이것 때문에 될 수 있으면 피해야 하는 것으로 인식하는 경우가 많다. 여러 [스레드](https://ko.wikipedia.org/wiki/스레드 "wikilink")에서 같은 전역 변수에 접근할 경우에 변수를 제대로 잠그지 않으면 [스레드는 안전하지](https://ko.wikipedia.org/wiki/스레드_안전 "wikilink") 않다.
...
### [ActionScript 3.0](https://ko.wikipedia.org/wiki/액션스크립트 "wikilink")
