...
[오른쪽](https://ko.wikipedia.org/wiki/파일:sine_cosine_integral.svg "wikilink") **삼각 적분 함수**()은 [삼각 함수의](https://ko.wikipedia.org/wiki/삼각_함수 "wikilink") 변형의 적분들을 묶어서 말하는 것이다. 일반적인 삼각 함수의 적분은 [적분표](https://ko.wikipedia.org/wiki/적분표 "wikilink")에서 볼 수 있으나 약간만 변형해도 비[초등함수](https://ko.wikipedia.org/wiki/초등함수 "wikilink")가 됨이 알려져 있다.
...
그리고 이 함수의 [테일러 급수는](https://ko.wikipedia.org/wiki/테일러_급수 "wikilink") 다음과 같다.
...
여기서 \(\gamma\)는 [오일러-마스케로니 상수이다](https://ko.wikipedia.org/wiki/오일러-마스케로니_상수 "wikilink").
