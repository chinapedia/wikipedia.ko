> This article is converted from Wikipedia: [9P \(\)](https://ko.wikipedia.org/wiki/9P_\(\)).


**9P**(플랜 9 파일 시스템 프로토콜 또는 Styx)는 [플랜 9](https://ko.wikipedia.org/wiki/플랜_9_\(운영_체제\) "wikilink") [운영 체제용으로](https://ko.wikipedia.org/wiki/운영_체제 "wikilink") 개발된 [네트워크 프로토콜로](https://ko.wikipedia.org/wiki/통신_프로토콜 "wikilink"), 플랜 9 시스템의 구성 요소들을 연결해 준다. 파일들은 플랜 9의 중요한 객체들이다. 이들은 [창](../Page/창_\(컴퓨팅\).md "wikilink"), [네트워크](https://ko.wikipedia.org/wiki/컴퓨터_네트워크 "wikilink") 연결, [프로세스](../Page/프로세스.md "wikilink") 등 운영 체제에서 이용할 수 있는 모든 것을 표현한다. [NFS과는](https://ko.wikipedia.org/wiki/네트워크_파일_시스템 "wikilink") 달리 9P는 [캐시 처리를](https://ko.wikipedia.org/wiki/캐시 "wikilink") 강화하고 [합성 파일도](https://ko.wikipedia.org/wiki/합성_파일_시스템 "wikilink") 제공한다. (이를테면 프로세스를 표현하는 [/proc](https://ko.wikipedia.org/wiki/procfs "wikilink"))

9P는 플랜 9의 4번째 판을 위해 **9P2000**라는 이름으로 개정되었으며 다양하고도 중요한 개선 사항이 포함되었다. [인페르노 운영 체제의](https://ko.wikipedia.org/wiki/인페르노_\(운영_체제\) "wikilink") 최신 버전도 9P2000을 이용한다. 인페르노 파일 프로토콜은 원래 Styx로 불렸으나 기술적으로 늘 9P의 변종으로 취급되어왔다.

다른 변종인 **9p2000.u**는 [유닉스](https://ko.wikipedia.org/wiki/유닉스 "wikilink") 환경을 더 잘 지원하는 개정판이며 자세한 사항을 보려면 [v9fs 9p2000.u](http://v9fs.sourceforge.net/rfc/9p2000.u.html)를 참고하라. 유닉스용 9P의 서버 기능은 [u9fs](https://ko.wikipedia.org/wiki/u9fs "wikilink")라고 부르며 플랜 9 배포판에 포함되어 있다. [리눅스](https://ko.wikipedia.org/wiki/리눅스 "wikilink")용 커널 클라이언트 드라이버는 [v9fs](https://ko.wikipedia.org/wiki/v9fs "wikilink") 프로젝트의 일부이다. 9P와 파생판들은 [Styx on a Brick project](https://web.archive.org/web/20091124094119/http://www.vitanuova.com/inferno/rcx_paper.html)와 같은 임베디드 환경에 응용하여 쓰이는 것을 볼 수 있다.
...
수많은 플랜 9 응용 프로그램들은 9P 서버의 형태를 지닌다. 눈에 띄는 예는 다음과 같다:
  ...
  - [wikifs](https://ko.wikipedia.org/wiki/wikifs "wikilink"): [위키](https://ko.wikipedia.org/wiki/위키 "wikilink")
...
## 외부 링크
  ...
  - [배포판 운영 체제를 위한 Styx 구조](http://doc.cat-v.org/inferno/4th_edition/styx) - [롭 파이크와](../Page/롭_파이크.md "wikilink") [데니스 리치](https://ko.wikipedia.org/wiki/데니스_리치 "wikilink") 씀.
