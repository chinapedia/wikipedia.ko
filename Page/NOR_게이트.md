...
**NOR 게이트**는 [부정논리합](../Page/부정논리합.md "wikilink")을 구현하는 디지털 [논리 회로이며](../Page/논리_회로.md "wikilink") 진리표에 따라 동작한다. 게이트에 대한 두 개의 입력이 LOW(0)이면 HIGH(1) 출력이 발생하며, 두 입력 중 하나가 HIGH(1)이면 LOW 출력(0)이 발생한다. NOR은 [OR](../Page/OR_게이트.md "wikilink") 연산자의 [부정](https://ko.wikipedia.org/wiki/부정 "wikilink")의 결과이다. AND 게이트에서 모든 입력이 반전된 것으로 간주할 수도 있다.
...
NOR 게이트에는 3개의 기호가 있다: ANSI(미국식) 기호, IEC(유럽식) 기호, 사용이 권장되지 않는 [DIN](https://ko.wikipedia.org/wiki/독일_공업_규격_위원회 "wikilink") 기호. 더 자세한 정보는 [논리 회로](../Page/논리_회로.md "wikilink") 문서 참조. NOR 게이트의 ANSI 기호는 도치 버블(inversion bubble)이 연결된 표준 OR 게이트이다.
...
NOR 게이트는 기본적인 논리 게이트이므로 이들은 [TTL과](../Page/트랜지스터-트랜지스터_논리.md "wikilink") [CMOS](../Page/CMOS.md "wikilink") [IC에서](../Page/집적_회로.md "wikilink") 인식된다. 표준 4000 시리즈인 CMOS IC는 4001이며 4개의 독립적인 2개의 입력, NOR 게이트를 포함한다. 핀 그림은 다음과 같다:
...
아래의 장치들은 [페어차일드 반도체](../Page/페어차일드_반도체.md "wikilink"), [필립스](../Page/필립스.md "wikilink"), [텍사스 인스트루먼트와](../Page/텍사스_인스트루먼트.md "wikilink") 같은 대부분의 반도체 제조업체들로부터 이용이 가능하다. 이들은 보통 스루홀 [DIP](https://ko.wikipedia.org/wiki/이중_직렬_패키지 "wikilink") 및 [SOIC](https://ko.wikipedia.org/wiki/SOIC "wikilink") 포맷으로 이용할 수 있다. 대부분의 [데이터시트 데이터베이스를](https://ko.wikipedia.org/wiki/데이터시트 "wikilink") 통해 데이터시트를 쉽게 이용할 수 있다.
...
유명한 CMOS 및 TTL 논리 계열에서 최대 8개의 입력을 갖춘 NOR 게이트를 사용할 수 있다:
  ...
  - [TTL](../Page/트랜지스터-트랜지스터_논리.md "wikilink")
...
오래된 [RTL](../Page/저항-트랜지스터_논리.md "wikilink") 및 [ECL](https://ko.wikipedia.org/wiki/ECL "wikilink") 계열에서 NOR 게이트는 효율적이었으며 매우 흔히 사용되었다.
...
아래의 그림은 [CMOS](../Page/CMOS.md "wikilink") 기술을 사용하는 2-input NOR 게이트를 보여준다. [섬네일](https://ko.wikipedia.org/wiki/파일:Cmosunbuff.png "wikilink")
