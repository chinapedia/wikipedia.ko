...
**단체 집합**은 집합과 함수의 범주 \(\operatorname{Set}\) 속의 [단체 대상](https://ko.wikipedia.org/wiki/단체_대상 "wikilink"), 즉 [함자](https://ko.wikipedia.org/wiki/함자_\(수학\) "wikilink")
...
단체 집합의 범주는 [토포스](../Page/토포스.md "wikilink")이므로, 이 속에서 정의되는 모든 연산을 취할 수 있다. 특히, [곱](https://ko.wikipedia.org/wiki/곱_\(범주론\) "wikilink") · [쌍대곱](https://ko.wikipedia.org/wiki/쌍대곱 "wikilink") · [밂](../Page/밂_\(범주론\).md "wikilink") 등이 모두 존재한다.

단체 집합의 범주에서, [시작 대상은](https://ko.wikipedia.org/wiki/시작_대상 "wikilink") [공집합](https://ko.wikipedia.org/wiki/공집합 "wikilink")
...
단체 집합의 범주 \(\operatorname s(\operatorname{Set})\)와 [위상 공간의](https://ko.wikipedia.org/wiki/위상_공간_\(수학\) "wikilink") 범주 \(\operatorname{Top}\) 사이에 다음과 같은 두 개의 함자들이 존재하며, 이들은 [수반 함자를](https://ko.wikipedia.org/wiki/수반_함자 "wikilink") 이룬다.
...
\[\operatorname{Sing}(Y)_n=\hom_{\operatorname{top}}(\triangle^n,Y)\] 여기서 \(\triangle^n\)은 \(n\)차원 [단체이다](https://ko.wikipedia.org/wiki/단체_\(수학\) "wikilink"). 즉, 함자 \(\operatorname{Sing}(Y)\)의 \(n\)차 성분은 \(Y\)의 \(n\)차원 특이 단체들의 집합이다. 이는 [특이 호몰로지에서](https://ko.wikipedia.org/wiki/특이_호몰로지 "wikilink") 사용되는 특이 단체와 같다.

#### 기하학적 실현

단체 집합 \(X\)에 대응하는 **기하학적 실현** \(|X|\)는 다음과 같은 [위상 공간이다](https://ko.wikipedia.org/wiki/위상_공간_\(수학\) "wikilink").

\[|X|=\left(\bigsqcup_nX_n\times\triangle^n\right)/{\sim}\] 여기서 \(\triangle^n\)은 \(n\)차원 표준 [단체이며](https://ko.wikipedia.org/wiki/단체_\(수학\) "wikilink"), \(\sim\)은
...
\[d_i\colon\{0,1,\dots,n-1\}\to\{0,1,\dots,n\}\] 는 상이 \(\{0,1,\dots,n\}\setminus\{i\}\)인 유일한 증가 [단사 함수이며](https://ko.wikipedia.org/wiki/단사_함수 "wikilink"),

\[s_i\colon\{0,1,\dots,n\}\to\{0,1,\dots,n-1\}\] 는 \(i\in\{0,1,\dots,n\}\)를 제외하고는 단사 함수인 유일한 증가 [전사 함수이다](https://ko.wikipedia.org/wiki/전사_함수 "wikilink"). \(D_i\colon\triangle^n\to\triangle^{n+1}\) 및 \(S_i\colon\triangle^n\to\triangle^{n-1}\)는 이와 유사하지만, 표준 단체에 작용하는 [연속 함수들이다](https://ko.wikipedia.org/wiki/연속_함수 "wikilink").

### 단체 호몰로지

단체 집합 \(X_\bullet\)이 주어졌을 때, 각 차수에 대하여 [자유 아벨 군을](../Page/자유_아벨_군.md "wikilink") 취하자.

\[C_n = \mathbb Z^{\oplus X_n}\] 그렇다면, 이 위에 \(\partial_{n,i}\) 및 \(s_{n,i}\)를 선형으로 연장할 수 있다. 그렇다면, \(C_n\)은 [단체 아벨 군을](https://ko.wikipedia.org/wiki/단체_아벨_군 "wikilink") 이룬다. 그 표준 [사슬 복합체](https://ko.wikipedia.org/wiki/사슬_복합체 "wikilink")

\[\partial_n \colon C_n \to C_{n-1}\]

\[\partial_n = \sum_{i=0}^n \partial_{n,i}\] 의 [호몰로지](https://ko.wikipedia.org/wiki/호몰로지 "wikilink")를 단체 집합 \(X\)의 **단체 호몰로지**(單體homology, )라고 한다. 이는 그 기하학적 실현의 [특이 호몰로지와](https://ko.wikipedia.org/wiki/특이_호몰로지 "wikilink") 같다. (단체 호몰로지의 계산에서, 퇴화 사상은 사용되지 않는다.)

### 유리수 계수 다항식 미분 형식

[표준 단체](https://ko.wikipedia.org/wiki/단체_\(수학\) "wikilink")

\[\triangle^n=\left\{\vec t\in\mathbb R^{n+1}\colon\sum_{i=0}^nt_i=1\right\}\] 위의 **유리수 계수 다항식 미분 형식**()은 다음과 같은 꼴의 항들의 (유한, [유리수](https://ko.wikipedia.org/wiki/유리수 "wikilink") 계수) [선형 결합이다](https://ko.wikipedia.org/wiki/선형_결합 "wikilink").

\[\phi_{i_0,i_1,\dotsc,i_n}\mathrm dt_{i_0}\wedge\mathrm dt_{i_1}\wedge\dotsb\wedge\mathrm dt_{i_n}\qquad(\phi_{i_0,i_1,\dotsc,i_n}\in\mathbb Q[t_0,\dotsc,t_n],\;i_0<i_1<\dotsb<i_n)\] 이들의 유리수 [벡터 공간을](https://ko.wikipedia.org/wiki/벡터_공간 "wikilink") \(\Omega_{\text{PL}}(n)\)으로 표기하자. 이는 [외미분](https://ko.wikipedia.org/wiki/외미분 "wikilink") 및 [쐐기곱](https://ko.wikipedia.org/wiki/쐐기곱 "wikilink")을 통해 자연수 등급 [가환 미분 등급 대수를](https://ko.wikipedia.org/wiki/가환_미분_등급_대수 "wikilink") 이룬다.

이제, [함자](https://ko.wikipedia.org/wiki/함자_\(수학\) "wikilink")
...
기하학적 실현 함자 \(|\cdot|:\operatorname s(\operatorname{Set})\to \operatorname{Top}\)는 오른쪽 [수반 함자를](https://ko.wikipedia.org/wiki/수반_함자 "wikilink") 가지므로 [쌍대 극한을](https://ko.wikipedia.org/wiki/쌍대_극한 "wikilink") 보존하지만 유한 [극한은](https://ko.wikipedia.org/wiki/극한_\(범주론\) "wikilink") 보존하지 않는다. 이때, 기하학적 실현 함자의 공역을 [콤팩트 생성](../Page/콤팩트_생성_공간.md "wikilink") [하우스도르프 공간의](https://ko.wikipedia.org/wiki/하우스도르프_공간 "wikilink") 범주 \(\operatorname{CGHaus}\) 따위의 범주로 바꾸면 이 함자는 유한 [극한을](https://ko.wikipedia.org/wiki/극한_\(범주론\) "wikilink") 보존하게 된다.\[6\]

또한, 단체 집합 \(X\)의 기하학적 실현 \(|X|\)는 언제나 [CW 복합체이며](https://ko.wikipedia.org/wiki/CW_복합체 "wikilink"), 특히 [하우스도르프 공간이다](https://ko.wikipedia.org/wiki/하우스도르프_공간 "wikilink").\[7\]
...
자연수 \(n\in\mathbb N\)에 대하여, 단체 집합의 범주에서 **표준 \(n\)차원 단체**() \(\triangle^n\)는 \(\hom_{\triangle}(-,\Delta_n)\)로 정의되며, [요네다 보조정리에](https://ko.wikipedia.org/wiki/요네다_보조정리 "wikilink") 의해
...
다음과 같은 데이터가 주어졌다고 하자.
  ...
  - (추상적) [단체 복합체](../Page/단체_복합체.md "wikilink") \((\Sigma_n)_{n\in\mathbb N}\). 여기서 \(\Sigma_0\)은 [꼭짓점](https://ko.wikipedia.org/wiki/꼭짓점 "wikilink")들의 집합이며, \(\Sigma_i\subseteq\mathcal P(\Sigma_0)\)는 \(i+1\)개의 서로 다른 [꼭짓점](https://ko.wikipedia.org/wiki/꼭짓점 "wikilink")들의 집합이다.
  - [꼭짓점](https://ko.wikipedia.org/wiki/꼭짓점 "wikilink") 집합 \(\Sigma_0\) 위의 [전순서](https://ko.wikipedia.org/wiki/전순서 "wikilink") \(\le\)

그렇다면, 다음을 정의하자.

  - 양의 정수 \(n\in\mathbb N\)에 대하여, [집합](https://ko.wikipedia.org/wiki/집합 "wikilink") \(\Delta_n\)의 원소 \(M\)은 \(\Sigma_0\)의 원소들로 구성된, 크기 \(n+1\)의 [중복집합](https://ko.wikipedia.org/wiki/중복집합 "wikilink") \(M\) 가운데, 중복 원소를 제거한 [집합](https://ko.wikipedia.org/wiki/집합 "wikilink") \(|M|\)이 \(\textstyle\bigsqcup_{n=0}^\infty\Sigma_n\)에 속하는 것이다.
...
단체 집합은 [특이 코호몰로지](https://ko.wikipedia.org/wiki/특이_코호몰로지 "wikilink") 등을 정의하기 위하여 오랫동안 알려져 있었으나, [대니얼 퀼런이](https://ko.wikipedia.org/wiki/대니얼_퀼런 "wikilink") 이를 사용하여 [대수적 K이론을](../Page/대수적_K이론.md "wikilink") 정의하면서 그 중요함이 알려졌다. 칸 올뭉치는 [다니얼 칸이](../Page/다니얼_칸.md "wikilink") 도입하였다.
