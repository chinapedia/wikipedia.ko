...
`  textcolor:blue`
`  pos:(0,13)`
`  text:`[`Rømer`](https://ko.wikipedia.org/wiki/뢰머도 "wikilink")` °Rø`
...
`  textcolor:blue`
`  pos:(0,13)`
`  text:`[`Newton`](https://ko.wikipedia.org/wiki/뉴턴도 "wikilink")` °N`
...
`  textcolor:blue`
`  pos:(0,13)`
`  text:`[`Delisle`](https://ko.wikipedia.org/wiki/드릴도 "wikilink")` °De`
...
`  textcolor:blue`
`  pos:(0,60)`
`  text:`[`Réaumur`](https://ko.wikipedia.org/wiki/열씨 "wikilink")` °Ré`
`  fontsize:12`
`  textcolor:red`
`  pos:(110,20)`
`  text:313.15 K   =   40 °C   =   104 °F   =   563.67 °R   =   28.5 °Rø   =   13.2 °N   =   90 °De   =   32 °Ré`

</timeline><noinclude> [분류:도표 시간선 틀](https://ko.wikipedia.org/wiki/분류:도표_시간선_틀 "wikilink")
