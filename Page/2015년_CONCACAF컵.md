...
|          |                           |                          |                           |                           |                           |                  |               |                   |                 |                |                |          |                          |                         |                          |                          |               |                  |               |                   |                 |                |               |
| -------- | ------------------------- | ------------------------ | ------------------------- | ------------------------- | ------------------------- | ---------------- | ------------- | ----------------- | --------------- | -------------- | -------------- | -------- | ------------------------ | ----------------------- | ------------------------ | ------------------------ | ------------- | ---------------- | ------------- | ----------------- | --------------- | -------------- | ------------- |
| {{축구 유니폼 | pattern_la = _mexico15h | pattern_b = _mexico15h | pattern_ra = _mexico15h | pattern_sh = _mexico15h | pattern_so = _mexico15h | leftarm = 000000 | body = 000000 | rightarm = 000000 | shorts = 000000 | socks = 000000 | title = 멕시코 }} | {{축구 유니폼 | pattern_la = _usa1415h | pattern_b = _usa1415h | pattern_ra = _usa1415h | pattern_sh = _usa1415h | pattern_so = | leftarm = FFFFFF | body = FFFFFF | rightarm = FFFFFF | shorts = FFFFFF | socks = FFFFFF | title = 미국 }} |
...
<tr class="even">
<td><p><a href="https://ko.wikipedia.org/wiki/히카르두_페헤치" title="wikilink">히카르두 페헤치</a></p></td>
<td></td>
</tr>
</tbody>
</table></td>
<td><p><a href="https://ko.wikipedia.org/wiki/파일:Mexico_vs_US_Play_off.svg" title="wikilink">300px</a></p></td>
<td><table>
<tbody>
<tr class="odd">
<td><p>GK</p></td>
