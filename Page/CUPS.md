...
**CUPS**(, 공식 명칭으로 CUPS가 더 자주 쓰임)는 컴퓨터를 인쇄 서버로 기능하도록 해주는 [유닉스 계열](../Page/유닉스_계열.md "wikilink") 운영 체제를 위한 모듈 방식의 프린팅 시스템이다. CUPS는 [유닉스](https://ko.wikipedia.org/wiki/유닉스 "wikilink") 계열의 운영 체제에서 프린터 형식과 형태마다 독자적으로 써야 했던 장치 드라이버의 작성을 용이하게 해 주었는데, 과거 유닉스 계열 운영 체제가 지원하던 특수 라인 프린터와 포스트 스크립트 프린터 뿐만 아니라, [매킨토시](https://ko.wikipedia.org/wiki/매킨토시 "wikilink"), [윈도용으로](https://ko.wikipedia.org/wiki/마이크로소프트_윈도 "wikilink") 시판되는 프린터의 대부분을 유닉스 계열 운영 체제에서 사용할 수 있게 하였다.
...
컵스(CUPS)는 [애플](https://ko.wikipedia.org/wiki/애플 "wikilink")에서 개발한 오픈소스형태의 프린터관련 소프트웨어이다.\[1\]
...
## 외부 링크
  ...
  - [유니버셜 플러그 앤 플레이 – 프린터 디바이스 V 1.0와 프린터 베이직 서비스 V 1.0](http://www.upnp.org/standardizeddcps/printer.asp)
