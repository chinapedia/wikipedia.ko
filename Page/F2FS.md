...
**F2FS**(Flash-Friendly File System)는 [삼성전자](https://ko.wikipedia.org/wiki/삼성전자 "wikilink")가 [리눅스 커널을](../Page/리눅스_커널.md "wikilink") 위해 개발한 [플래시 파일 시스템이다](https://ko.wikipedia.org/wiki/플래시_파일_시스템 "wikilink").\[1\]
