...
현재 발표되어 있는 최신 버전은 솔라리스 11.4 ([2018년](../Page/2015년.md "wikilink") [8월 28일](../Page/10월_26일.md "wikilink"))이다.

## 지원하는 아키텍처

솔라리스는 [SPARC](https://ko.wikipedia.org/wiki/SPARC "wikilink"), [x86](https://ko.wikipedia.org/wiki/x86 "wikilink"), [AMD64](https://ko.wikipedia.org/wiki/AMD64 "wikilink"), [IA-32](https://ko.wikipedia.org/wiki/IA-32 "wikilink"), [EM64T](https://ko.wikipedia.org/wiki/EM64T "wikilink") 아키텍처를 지원하며 이들에 대해서 공통 코드 기반(Common Code Base)를 사용한다. 과거 솔라리스 2.5.1은 [파워PC](../Page/파워PC.md "wikilink")로 포팅하려고 했으나, 취소된 바 있다. 솔라리스는 다중 프로세서 환경에서 잘 작동하며, 솔라리스 10은 [리눅스](../Page/리눅스.md "wikilink") ABI를 구현할 예정이다. (opensolaris 빌드 49버전에 구현되어 있다.)
...
## 외부 링크
  ...
  -
[분류:오픈솔라리스](https://ko.wikipedia.org/wiki/분류:오픈솔라리스 "wikilink") [분류:유닉스 시스템 V](https://ko.wikipedia.org/wiki/분류:유닉스_시스템_V "wikilink") [분류:X86 운영 체제](https://ko.wikipedia.org/wiki/분류:X86_운영_체제 "wikilink") [분류:오라클 소프트웨어](https://ko.wikipedia.org/wiki/분류:오라클_소프트웨어 "wikilink")
