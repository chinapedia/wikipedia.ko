...
항력은 [마찰력](https://ko.wikipedia.org/wiki/마찰력 "wikilink")과 [압력](https://ko.wikipedia.org/wiki/압력 "wikilink")으로 구분된다. 마찰력은 물체의 표면에 평행한 방향으로 작용하며, 압력은 물체의 표면에 수직한 방향으로 작용한다.

유체 내에서 움직이는 고체 물체의 경우, 항력은 ‘유체의 유동과 동일한 방향으로 작용하는 모든 [유체역학](../Page/유체역학.md "wikilink")적 힘의 합’이다. 따라서 항력은 물체의 움직임을 방해하는 힘이다. [항공기](https://ko.wikipedia.org/wiki/항공기 "wikilink")에서 [추력](https://ko.wikipedia.org/wiki/추력 "wikilink")이 필요한 것은 바로 이 항력이라는 힘을 극복하고 나아가기 위해서이다. 유체 유동의 방향에 수직으로 작용하는 힘은 [양력](https://ko.wikipedia.org/wiki/양력 "wikilink")(lift)이라고 한다.
...
\[{\mathbf F}_d = - {1 \over 2} \rho v^2 A C_d {\hat \mathbf v}\] 여기서, 우측의 - 부호는 항력이 물체의 동력과 반대 방향으로 작용하는 것을 나타낸다 (순수한 항력 계수를 나타낼 때는 - 부호를 쓰지 않는다)

여기서,

\[{\mathbf F}_d\]는 항력

\[\rho\]는 유체의 [밀도](https://ko.wikipedia.org/wiki/밀도 "wikilink")
...
## 같이 보기
  ...
  - [경계층](https://ko.wikipedia.org/wiki/경계층 "wikilink")
  - [낙하산](https://ko.wikipedia.org/wiki/낙하산 "wikilink")
  - [받음각](https://ko.wikipedia.org/wiki/받음각 "wikilink")
  - [부가 질량](https://ko.wikipedia.org/wiki/부가_질량 "wikilink")(Added mass)
  - [스톨](https://ko.wikipedia.org/wiki/스톨 "wikilink")
  - [종단속도](https://ko.wikipedia.org/wiki/종단속도 "wikilink")
  - 수
  ...
  - 효과
      - [마그누스 효과](https://ko.wikipedia.org/wiki/마그누스_효과 "wikilink")
  ...
  - 힘
      ...
      - [항력](https://ko.wikipedia.org/wiki/항력 "wikilink")
