...
집합 \(X\)의 **순열**은 [전단사 함수](https://ko.wikipedia.org/wiki/전단사_함수 "wikilink") \(X\to X\)이다. 특히, 유한 집합 \(\{1,2,\dots,n\}\)의 순열 \(\sigma\)를 다음과 같이 표기한다.
...
\[\binom n{n_1,n_2,\dots,n_k}=\frac{n!}{n_1!n_2!\cdots n_k!}\] 예를 들어, 영어 단어 "MISSISSIPPI"의 [어구전철](https://ko.wikipedia.org/wiki/어구전철 "wikilink")의 수는 다음과 같다.
...
집합 \(X\)의 순열의 집합 \(\operatorname{Sym}(X)\)는 [군을](../Page/군_\(수학\).md "wikilink") 이룬다. 즉, 다음이 성립한다.
  ...
  - [항등 함수](https://ko.wikipedia.org/wiki/항등_함수 "wikilink") \(\operatorname{id}_X\colon x\mapsto x\)는 \(X\)의 순열이다. (이는 군의 [항등원](https://ko.wikipedia.org/wiki/항등원 "wikilink")이다.)
  ...
  - 임의의 \(X\)의 순열 \(\sigma\)에 대하여, 그 [역](https://ko.wikipedia.org/wiki/역함수 "wikilink") \(\sigma^{-1}\colon\sigma(x)\mapsto x\) 역시 \(X\)의 순열이다. (이는 군의 [역원](https://ko.wikipedia.org/wiki/역원 "wikilink") 연산이다.)
