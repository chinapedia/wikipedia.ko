...
초기 EOS에서는 [캐논 FD 마운트를](https://ko.wikipedia.org/wiki/캐논_FD_마운트 "wikilink") 위해 개발된 A-TTL(Advanced through-the-lens) 시스템이 쓰였다. A-TTL 시스템은 E-TTL(Evaluative TTL)에 의해 대체되었다. 이후 E-TTL II가 나왔으며, E-TTL과 비교했을때 카메라 펌웨어에만 차이가 있다.

파일:Canon Speedlite 550EX flash.jpg|[스피드라이트 550EX](https://ko.wikipedia.org/wiki/스피드라이트_550EX "wikilink") 파일:Canon speedlite 430ex.jpg|[스피드라이트 430EX](https://ko.wikipedia.org/wiki/스피드라이트_430EX "wikilink")
...
## 외부 링크
  ...
  - [Canon White Papers: Beyond the Manual](http://www.usa.canon.com/dlc/controller?act=GetArticleAct&articleID=1787)

[분류:캐논 카메라](https://ko.wikipedia.org/wiki/분류:캐논_카메라 "wikilink")
