...
이는 오늘날의 널리 쓰이는 거의 모든 [운영 체제](../Page/운영_체제.md "wikilink") [커널이](../Page/커널_\(컴퓨팅\).md "wikilink") C를 이용해 구현된 이유이기도 하다. 이처럼 C는 [시스템 프로그램](https://ko.wikipedia.org/wiki/시스템_프로그램 "wikilink") 개발에 매우 적합하지만, 응용 프로그램 개발에도 많이 쓰이기도 한다.
