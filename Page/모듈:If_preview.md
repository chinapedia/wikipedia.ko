...
Usage: {{\#invoke:If preview|main|value_if_preview|value_if_not_preview}}
...
`   local result = ''`
`   Preview_mode = frame:preprocess('``');                          -- use magic word to get revision id`
...
Usage: {{\#invoke:If preview|boolean}}
