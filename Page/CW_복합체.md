...
[호모토피 이론에서](https://ko.wikipedia.org/wiki/호모토피_이론 "wikilink"), **CW 복합체**(CW復合體, )는 일련의 **세포**(細胞, )들을 이어붙여 구성할 수 있는 [위상 공간이다](https://ko.wikipedia.org/wiki/위상_공간_\(수학\) "wikilink").\[1\]\[2\] [단체 복합체의](../Page/단체_복합체.md "wikilink") 개념보다 더 자유롭고, [단체 집합의](../Page/단체_집합.md "wikilink") 개념보다 더 구체적이지만, 그 [범주](../Page/범주_\(수학\).md "wikilink") 속에서 [호모토피 이론을](https://ko.wikipedia.org/wiki/호모토피_이론 "wikilink") 용이하게 전개할 수 있으며, [단체 호몰로지와](https://ko.wikipedia.org/wiki/단체_호몰로지 "wikilink") 마찬가지로 CW 복합체 구조로부터 직접 그 [호몰로지](https://ko.wikipedia.org/wiki/호몰로지 "wikilink")와 [코호몰로지](https://ko.wikipedia.org/wiki/코호몰로지 "wikilink")를 계산할 수 있다. 이 계산법을 **세포 호몰로지**(細胞homology, ) 및 **세포 코호몰로지**(細胞cohomology, )라고 한다.

## 정의

### 직접적 정의

[하우스도르프 공간](https://ko.wikipedia.org/wiki/하우스도르프_공간 "wikilink") \(X\) 위의 **CW 복합체**는 다음과 같은 데이터로 주어진다.\[3\]

  - 각 \(n\in\mathbb N\)에 대하여, [연속 함수](https://ko.wikipedia.org/wiki/연속_함수 "wikilink") \(\mathbb D^n\to X\)들의 집합 \(\Phi_n\). \(\Phi_n\)의 원소를 \(n\)차원 **세포**()라고 한다.

이들은 다음 네 조건들을 만족시켜야 한다.

  - 각 \(n\)차원 세포 \(\phi\in\Phi_n\)에 대하여, \(\phi|_{\operatorname{int}\mathbb D^n}\)은 그 [치역](https://ko.wikipedia.org/wiki/치역 "wikilink")과의 [위상 동형이다](https://ko.wikipedia.org/wiki/위상_동형 "wikilink").
...
위 정의에서 \(\operatorname{int}\mathbb D^n=\mathbb D^n\setminus\partial\mathbb D^n\)은 \(n\)차원 닫힌 공의 [내부](https://ko.wikipedia.org/wiki/내부_\(위상수학\) "wikilink"), 즉 \(n\)차원 열린 공이다.
...
1.  −1차원 뼈대는 [공집합](https://ko.wikipedia.org/wiki/공집합 "wikilink")이다.
2.  \(n-1\)차원 뼈대가 주어졌을 때, \(n\)차원 뼈대를 구성하기 위하여, 임의의 [기수](../Page/기수_\(수학\).md "wikilink") \(\kappa_n\) 및 [연속 함수](https://ko.wikipedia.org/wiki/연속_함수 "wikilink") \(\phi_n \colon (\mathbb S^{n-1})^{\sqcup \kappa_n} \to X\)에 대하여, [붙임 공간](../Page/붙임_공간.md "wikilink") \(X_n = X_{n-1} \cup_{\phi_n}(\mathbb D^n){\sqcup \kappa_n}\)을 취한다.

위 정의에서, \(\mathbb S^n\)은 \(n\)차원 [초구](https://ko.wikipedia.org/wiki/초구 "wikilink")이며 \(\mathbb D^n \supsetneq \mathbb S^{n-1}\)은 \(n\)차원 [닫힌 공이다](https://ko.wikipedia.org/wiki/닫힌_공 "wikilink"). 특히 \(\mathbb S^{-1} = \varnothing\)이며 \(\mathbb D^0 = \{\bullet\}\)이다 ([한원소 공간](https://ko.wikipedia.org/wiki/한원소_공간 "wikilink")).

\(n\)차원 뼈대 \(X_n\)이 주어졌다면, 낮은 차원의 뼈대에 대한 포함 사상

\[X_0\hookrightarrow X_1\hookrightarrow X_2\hookrightarrow\cdots\] 이 존재한다. **CW 복합체**는 유한 차원 뼈대들의 [귀납적 극한이다](https://ko.wikipedia.org/wiki/귀납적_극한 "wikilink"). 즉, 뼈대들의 포함 관계

\[X_0\hookrightarrow X_1\hookrightarrow\cdots\] 의 [귀납적 극한](https://ko.wikipedia.org/wiki/귀납적_극한 "wikilink")

\[X_\infty=\varinjlim_{n\to\infty}X_n\] 이다.

이 귀납적 정의에서, 직접적 정의의 C 조건은 자동적으로 성립한다. 이는 세포의 폐포가 [콤팩트 공간이기](../Page/콤팩트_공간.md "wikilink") 때문에, 무한 개의 세포들을 포함할 수 없기 때문이다. W 조건은 [귀납적 극한의](https://ko.wikipedia.org/wiki/귀납적_극한 "wikilink") 정의에 포함돼 있다.
...
다음이 주어졌다고 하자.
  ...
  - \(\mathcal C\) 속의 사상들의 [집합](https://ko.wikipedia.org/wiki/집합 "wikilink") \(\mathfrak M\subseteq \operatorname{Mor}(\mathcal C)\)
  - \(\mathcal C\) 속의 대상 \(X_0\)

그렇다면, \(\mathcal C\) 속의, \(X_0\) 위의 **세포 복합체**(細胞複合體, )는 다음과 같은 데이터로 주어진다.

  - [순서수](https://ko.wikipedia.org/wiki/순서수 "wikilink") \(\eta \in\operatorname{Ord}\)
...
S_\\beta & \\overset{\\iota_\\beta}\\to & D_\\beta \\\\ {\\scriptstyle\\phi_\\beta} \\downarrow {\\color{White}\\scriptstyle\\phi_\\beta} && \\downarrow \\\\ X_\\beta & \\underset{f_{\\beta+1}}\\to & X_{\\beta+1} \\end{matrix} </math>
  ...
  - 만약 \(\alpha\)가 [극한 순서수라면](https://ko.wikipedia.org/wiki/극한_순서수 "wikilink"), \(X_\alpha\)는 다음과 같은 (\((f_\beta)_{\beta<\alpha}\)들에 대한) [귀납적 극한](https://ko.wikipedia.org/wiki/귀납적_극한 "wikilink")(즉, [쌍대극한](https://ko.wikipedia.org/wiki/쌍대극한 "wikilink"))이다.
      -
...
\[\iota_n \colon (\mathbb S^{n-1})^{\sqcup \kappa_n} \to (\mathbb D^n)^{\sqcup \kappa_n}\] 가 되는 상대 세포 복합체를 **CW 복합체**라고 한다. 여기서
  ...
  - \((\kappa_n)_{n<\omega}\)는 임의의 (0 또는 유한 또는 무한) [기수들의](../Page/기수_\(수학\).md "wikilink") [수열](https://ko.wikipedia.org/wiki/수열 "wikilink")이다.
  - \(\phi_n \colon (\mathbb D^n)^{\sqcup\kappa_n} \to X_n\)은 임의의 [연속 함수이다](https://ko.wikipedia.org/wiki/연속_함수 "wikilink").
...
CW 복합체들의 모임은 다음과 같은 연산에 대하여 닫혀 있다.
  ...
  - 두 CW 복합체의 [콤팩트 생성 공간으로서의](../Page/콤팩트_생성_공간.md "wikilink") 곱은 CW 복합체이다. 집합으로서 이는 항상 [곱집합](https://ko.wikipedia.org/wiki/곱집합 "wikilink")이지만 그 위의 위상은 [곱위상](https://ko.wikipedia.org/wiki/곱위상 "wikilink")보다 더 섬세할 수 있다. 구체적으로, 곱공간이 비가산 개의 세포를 포함하고 또 원래의 두 CW 복합체가 모두 [국소 콤팩트 공간이](https://ko.wikipedia.org/wiki/국소_콤팩트_공간 "wikilink") 아닐 경우 이는 곱위상보다 더 섬세한 위상을 갖는다.
...
모든 CW 복합체는 다음 성질을 만족시킨다.
  ...
  - [하우스도르프 공간이며](https://ko.wikipedia.org/wiki/하우스도르프_공간 "wikilink") [정규 공간이다](https://ko.wikipedia.org/wiki/정규_공간 "wikilink").\[7\]
...
CW 복합체에서, 모든 세포의 [폐포는](https://ko.wikipedia.org/wiki/폐포_\(위상수학\) "wikilink") 오직 유한 개의 세포들과 [공집합](https://ko.wikipedia.org/wiki/공집합 "wikilink")이 아닌 [교집합](https://ko.wikipedia.org/wiki/교집합 "wikilink")을 갖는다. 즉, \(X\)의 세포로의 [분할이](../Page/집합의_분할.md "wikilink") \(\{e_\alpha\}_{\alpha\in I}\)라면,
...
[단체 복합체에](../Page/단체_복합체.md "wikilink") 대하여 [단체 호몰로지를](https://ko.wikipedia.org/wiki/단체_호몰로지 "wikilink") 정의할 수 있는 것처럼, CW 복합체에 대하여 그 CW 구조를 사용하여 **세포 호몰로지**(細胞homology, )라는 호몰로지 이론을 정의할 수 있다. CW 복합체에 대하여 이는 [특이 호몰로지와](https://ko.wikipedia.org/wiki/특이_호몰로지 "wikilink") 일치한다.

[CW 복합체](https://ko.wikipedia.org/wiki/CW_복합체 "wikilink") \(X\)의 \(n\)차원 뼈대가 \(X_n\)이라고 하자.

\[\varnothing=X_{-1}\subseteq X_0\subseteq X_1\subseteq X_2\subseteq\cdots\subseteq X_\infty=X\] 임의의 \(n\)에 대하여, [상대 호몰로지](https://ko.wikipedia.org/wiki/상대_호몰로지 "wikilink")
...
\[\partial_n\colon e_\alpha^n\mapsto\sum_\beta(\deg \chi_n^{\alpha\beta})e^{n-1}_\beta\] 여기서 \(\deg\)는 [브라우어르 차수이며](https://ko.wikipedia.org/wiki/브라우어르_차수 "wikilink"), \(\chi_n^{\alpha\beta}\)는 다음과 같다.

\[\chi_{n}^{\alpha \beta}\colon\partial e_\alpha^n \hookrightarrow X_{n - 1}  \twoheadrightarrow X_{n - 1} /( X_{n - 1} \setminus e^{n - 1}_\beta)\] 이 경우 \(\partial e_\alpha^n\cong\mathbb S^{n-1}\cong X_{n - 1} /( X_{n - 1} \setminus e^{n - 1}_\beta)\)이므로, [브라우어르 차수가](https://ko.wikipedia.org/wiki/브라우어르_차수 "wikilink") 잘 정의된다.

이 CW 복합체에 대하여 취한 [호몰로지](https://ko.wikipedia.org/wiki/호몰로지 "wikilink")를 \(X\)의 **세포 호몰로지**(細胞homology, )라고 한다. 세포 복합체를 쌍대화하여, **세포 코호몰로지**(細胞cohomology, ) 역시 정의할 수 있다.

CW 복합체의 세포 호몰로지는 그 [특이 호몰로지와](https://ko.wikipedia.org/wiki/특이_호몰로지 "wikilink") 일치한다. CW 복합체 \(X\)에서, \(n\)차원 세포의 수가 [기수](../Page/기수_\(수학\).md "wikilink") \(c_n\in\operatorname{Card}\)라면, 세포 호몰로지의 정의에 따라 \(c_n\)은 \(X\)의 \(n\)차 [베티 수의](../Page/베티_수.md "wikilink") [상계이다](https://ko.wikipedia.org/wiki/상계_\(수학\) "wikilink").

\[\dim_{\mathbb Q}\operatorname H(X;\mathbb Q) \le c_n\]

세포의 수가 유한한 CW 복합체 \(X\)에서, \(n\)차원 세포의 수가 \(c_n\)이라고 하자. 그렇다면, 세포 호몰로지의 정의에 따라 그 [오일러 지표는](https://ko.wikipedia.org/wiki/오일러_지표 "wikilink") 다음과 같다.

\[\chi(X)=\sum_{n=0}^\infty(-1)^nc_n\]

#### 화이트헤드 정리

**화이트헤드 정리**(Whitehead定理, )\[10\]\[11\]\[12\] 에 따르면, 두 CW 복합체 사이의 [연속 함수가](https://ko.wikipedia.org/wiki/연속_함수 "wikilink") [호모토피 동치가](../Page/호모토피_동치.md "wikilink") 될 필요충분조건은 이 함수가 [약한 호모토피 동치](https://ko.wikipedia.org/wiki/약한_호모토피_동치 "wikilink")(모든 [호모토피 군의](../Page/호모토피_군.md "wikilink") [동형](https://ko.wikipedia.org/wiki/동형 "wikilink")을 유도하는 [연속 함수](https://ko.wikipedia.org/wiki/연속_함수 "wikilink"))를 이루는 것이다. 따라서, CW 복합체의 경우 [호모토피 동치와](../Page/호모토피_동치.md "wikilink") [약한 호모토피 동치를](https://ko.wikipedia.org/wiki/약한_호모토피_동치 "wikilink") 구별할 필요가 없다.

#### 세포 근사 정리

두 CW 복합체 사이의 **세포 함수**(細胞函數, )는 다음 조건을 만족시키는 [연속 함수](https://ko.wikipedia.org/wiki/연속_함수 "wikilink") \(f\colon X\to Y\)이다.

  - \(f\)는 \(n\)차원 뼈대를 \(n\)차원 뼈대로 대응시킨다. 즉, 다음이 성립한다.
      -
        \(f(X_n)\subseteq Y_n\qquad\forall n\in\mathbb N\)

**세포 근사 정리**(細胞近似定理, )에 따르면, 두 CW 복합체 사이의 임의의 [연속 함수](https://ko.wikipedia.org/wiki/연속_함수 "wikilink") \(f\colon X\to Y\)는 세포 함수와 [호모토픽](https://ko.wikipedia.org/wiki/호모토픽 "wikilink")하다. 또한, 만약 부분 CW 복합체 \(A\subseteq X\)에 대하여 \(f|_A\colon A\to Y\)가 세포 함수라면, 이 호모토피는 \(A\)에 대하여 고정되게 잡을 수 있다. 따라서, 호모토피 이론에서는 CW 복합체 사이의 모든 [연속 함수를](https://ko.wikipedia.org/wiki/연속_함수 "wikilink") 세포 함수로 가정할 수 있다.
...
이 경우, [그래프 이론과](https://ko.wikipedia.org/wiki/그래프_이론 "wikilink") [위상수학](https://ko.wikipedia.org/wiki/위상수학 "wikilink")의 개념이 다음과 같이 대응된다.

  -
    {| class=wikitable

\! 다중 그래프 \(\Gamma\) \!\! CW 복합체 \(X\) |- | 꼭짓점 집합 \(\operatorname V(\Gamma)\) || 0차원 뼈대 \(X_0\) |- | 변 \(e\in \operatorname E(\Gamma)\) || \(X_0\)에 연결된 1차원 세포 \(e_a\cong[0,1]\) |- | 변 \(e\)의 양끝점 \(u,v\in \operatorname V(\Gamma)\) (\(u=v\)일 수 있음) || \(e_a\)의 접착 사상 \(\phi_a \colon \{0,1\} \to X_0\)의 [치역](https://ko.wikipedia.org/wiki/치역 "wikilink") |- | [연결 다중 그래프](../Page/연결_그래프.md "wikilink") || [연결 공간](../Page/연결_공간.md "wikilink") |}
...
[유클리드 공간](https://ko.wikipedia.org/wiki/유클리드_공간 "wikilink") \(\mathbb R^n\) 위에는 다음과 같은 CW 구조를 줄 수 있다.
...
\(n\ge1\)차원 [초구](https://ko.wikipedia.org/wiki/초구 "wikilink") \(\mathbb S^n\) 위에는 다음과 같은, 두 개의 세포만을 갖는 CW 구조를 줄 수 있다.
...
[다양체](https://ko.wikipedia.org/wiki/다양체 "wikilink")는 모두 CW 복합체의 [호모토피 유형을](https://ko.wikipedia.org/wiki/호모토피_유형 "wikilink") 갖는다.
...
2차원 원판 \(\mathbb D^2\) 위에 다음과 같은 화이트헤드 복합체 구조를 정의하자.\[16\]
  ...
  - 2차원 세포 \(\mathbb D^2\to\mathbb D^2\) ([항등 함수](https://ko.wikipedia.org/wiki/항등_함수 "wikilink"))
...
모든 CW 복합체는 [하우스도르프 공간이며](https://ko.wikipedia.org/wiki/하우스도르프_공간 "wikilink"), 따라서 [하우스도르프 공간이](https://ko.wikipedia.org/wiki/하우스도르프_공간 "wikilink") 아닌 위상 공간은 CW 복합체와 [위상 동형일](https://ko.wikipedia.org/wiki/위상_동형 "wikilink") 수 없다.

무한 차원 [힐베르트 공간은](https://ko.wikipedia.org/wiki/힐베르트_공간 "wikilink") [하우스도르프 공간이지만](https://ko.wikipedia.org/wiki/하우스도르프_공간 "wikilink") CW 복합체와 [위상 동형이지](https://ko.wikipedia.org/wiki/위상_동형 "wikilink") 않다. 무한 차원 힐베르트 공간은 [베르 공간이므로](../Page/베르_공간.md "wikilink"), 유한 차원의 뼈대들의 [귀납적 극한으로](https://ko.wikipedia.org/wiki/귀납적_극한 "wikilink") 나타낼 수 없다. 그러나 이는 [축약 가능 공간이므로](../Page/축약_가능_공간.md "wikilink"), CW 복합체와 [호모토피 동치이다](../Page/호모토피_동치.md "wikilink").
...
임의의 범주 \(\mathcal C\)에서, 만약 사용되는 세포 \(\iota_\alpha\colon S_\alpha \to D_\alpha\)에서 정의역들이 모두 [시작 대상](https://ko.wikipedia.org/wiki/시작_대상 "wikilink") \(S_\alpha = \varnothing\)이라면, 얻는 세포 복합체 \(X_\eta\)는 단순히 [쌍대곱](https://ko.wikipedia.org/wiki/쌍대곱 "wikilink")

\[X_\eta = \bigsqcup_{\alpha<\eta} D_\alpha\] 이다.

#### 설리번 대수

[표수 0의](https://ko.wikipedia.org/wiki/표수_0 "wikilink") [체](https://ko.wikipedia.org/wiki/체_\(수학\) "wikilink") \(K\)가 주어졌다고 하고, \(K\)-[가환 미분 등급 대수의](https://ko.wikipedia.org/wiki/가환_미분_등급_대수 "wikilink") 범주 \(\operatorname{CDGA}_K\)를 생각하자.
...
[존 헨리 콘스턴틴 화이트헤드가](../Page/존_헨리_콘스턴틴_화이트헤드.md "wikilink") 1949년에 화이트헤드 정리를 증명하기 위하여 정의하였다.\[18\]\[19\] "CW 복합체"라는 이름에서, C는 "[폐포](https://ko.wikipedia.org/wiki/폐포_\(위상수학\) "wikilink") 유한"()을 뜻하고, W는 [약한 위상](https://ko.wikipedia.org/wiki/약한_위상 "wikilink")()을 뜻한다.\[20\]

  - “폐포 유한성”이란 \(n\)차원 세포 \(c_n\)의 [폐포는](https://ko.wikipedia.org/wiki/폐포_\(위상수학\) "wikilink") 오직 유한 개의 다른 세포들과 교차한다는 것이다.\[21\]
  - “약한 위상”이란 CW 복합체가 그 뼈대들의 [귀납적 극한](https://ko.wikipedia.org/wiki/귀납적_극한 "wikilink") \(\textstyle X=\varinjlim_{n\to\infty}X_n\)임을 뜻한다.\[22\]
