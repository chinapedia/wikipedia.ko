...
| ------------ | ------------ | ------------ | ------- | --------- | ---- |
| JIBS         | DMB 1        | 비디오 채널 (DMB) | 512kbps | 자체        | JIBS |
| DMB 2        | 비디오 채널 (DMB) | 512kbps      | 자체      | JIBS+mYTN |      |
...
<!-- end list -->
  ...
  -
    대부분의 시간대에 자사 TV 방송을 재전송하며, 일부 시간대에 SBS의 DMB 채널인 SBS u TV 프로그램을 방영한다.
...
<!-- end list -->
  ...
  -
    일부 시간대에 자사 TV 방송을 재전송하며, 대부분의 시간대에 YTN의 DMB 채널인 mYTN 프로그램을 재전송한다.
...
<!-- end list -->
  ...
  -
    현대홈쇼핑채널로 JIBS의 플랫폼을 임대하여 송출중이다.
...
| 송신소     | 주파수                 | 출력                  | 송신소 위치            |
| ------- | ------------------- | ------------------- | ----------------- |
| 견월악 송신소 | CH 13C (214.736MHz) | 1kW                 | 제주 제주시 봉개동 산78-1  |
| 금악 중계소  | 90W                 | 제주 제주시 한림읍 금악리 산1-2 |                   |
| 광해악 중계소 | 90W                 | 제주 서귀포시 안덕면 서광리 937 |                   |
| 삼매봉 중계소 | CH 8C (184.736MHz)  | 1kW                 | 제주 서귀포시 서홍동 822-1 |
