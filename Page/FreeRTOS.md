...
## 지원 아키텍처
  ...
  - [ARM 아키텍처](../Page/ARM_아키텍처.md "wikilink")
      ...
      - [ARM Cortex-A](https://ko.wikipedia.org/wiki/ARM_Cortex-A8 "wikilink")
  - [Atmel](https://ko.wikipedia.org/wiki/Atmel "wikilink")
      - [Atmel AVR](https://ko.wikipedia.org/wiki/Atmel_AVR "wikilink")
      - [AVR32](https://ko.wikipedia.org/wiki/AVR32 "wikilink")
      - SAM3 / SAM4
      - SAM7 / SAM9
      - SAMD20 / SAML21
  - [Cortus](https://ko.wikipedia.org/wiki/Cortus "wikilink")
      - APS1
      - APS3
      - APS3R
      - APS5
      - FPS6
      - FPS8
  - [Cypress](https://ko.wikipedia.org/wiki/Cypress "wikilink")
      - [PSoC](https://ko.wikipedia.org/wiki/PSoC "wikilink")
  - [에너지 마이크로](https://ko.wikipedia.org/wiki/에너지_마이크로 "wikilink")
      - [EFM32](https://ko.wikipedia.org/wiki/EFM32 "wikilink")
  - [후지쯔](../Page/후지쯔.md "wikilink")
      - FM3
      - MB91460
      - MB96340
  - [프리스케일](https://ko.wikipedia.org/wiki/프리스케일 "wikilink")
  ...
  - [PIC 마이크로컨트롤러](https://ko.wikipedia.org/wiki/PIC_마이크로컨트롤러 "wikilink")
      - PIC18 / PIC24 / dsPIC
      - PIC32
  - [마이크로세미](https://ko.wikipedia.org/wiki/마이크로세미 "wikilink")
      - [스마트퓨전](https://ko.wikipedia.org/wiki/스마트퓨전 "wikilink")
  - [Multiclet](https://ko.wikipedia.org/wiki/Multiclet "wikilink")
      - [Multiclet P1](https://ko.wikipedia.org/wiki/Multiclet "wikilink")
  - [NXP](https://ko.wikipedia.org/wiki/NXP "wikilink")
      - [LPC1000](https://ko.wikipedia.org/wiki/NXP_LPC "wikilink")
      - [LPC2000](https://ko.wikipedia.org/wiki/NXP_LPC "wikilink")
      - [LPC4300](https://ko.wikipedia.org/wiki/NXP_LPC "wikilink")
  - [르네사스](../Page/르네사스_테크놀로지.md "wikilink")
      - 78K0R
      - RL78
      - [H8/S](https://ko.wikipedia.org/wiki/H8_패밀리 "wikilink")
      - RX600
      - RX200
  ...
  - [텍사스 인스트루먼츠](https://ko.wikipedia.org/wiki/텍사스_인스트루먼츠 "wikilink")
      ...
      - Stellaris
      - [허큘리스](https://ko.wikipedia.org/wiki/허큘리스_\(프로세서\) "wikilink") (TMS570LS04 & RM42)
  - [Xilinx](https://ko.wikipedia.org/wiki/Xilinx "wikilink")
      - [마이크로블레이즈](https://ko.wikipedia.org/wiki/마이크로블레이즈 "wikilink")
      - [Zynq-7000](https://ko.wikipedia.org/wiki/Xilinx "wikilink")
  - [Espressif](https://ko.wikipedia.org/wiki/Espressif "wikilink")
      - [ESP8266](https://ko.wikipedia.org/wiki/ESP8266 "wikilink")ex
      - [ESP32](https://ko.wikipedia.org/wiki/ESP32 "wikilink")
