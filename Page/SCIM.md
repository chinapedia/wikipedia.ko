...
[섬네일](https://ko.wikipedia.org/wiki/파일:Scim_logo.jpg "wikilink") **SCIM**(Smart Common Input Method)은 30개 이상의 언어([CJK](https://ko.wikipedia.org/wiki/CJK "wikilink")와 각종 [유럽어](https://ko.wikipedia.org/wiki/유럽어 "wikilink"))를 지원하는 [POSIX](https://ko.wikipedia.org/wiki/POSIX "wikilink") 스타일 [운영 체제](https://ko.wikipedia.org/wiki/운영_체제 "wikilink")([리눅스](https://ko.wikipedia.org/wiki/리눅스 "wikilink")나 [BSD](https://ko.wikipedia.org/wiki/BSD "wikilink")를 포함)를 위한 [입력기](https://ko.wikipedia.org/wiki/입력기 "wikilink") 플랫폼이다.
...
SCIM은 XIM이나 IIIMF보다 높은 계층에 있는 라이브러러지만, 인터페이스는 더 간단하다. 그리고 XIM이나 심지어 IIIMF하고도 같이 동작할 수 있다. SCIM은 [GTK+](https://ko.wikipedia.org/wiki/GTK+ "wikilink")2 immodule이나[Qt immodule](https://web.archive.org/web/20051122094536/http://immodule-qt.freedesktop.org/wiki/Software_2fimmodule_2dqt)처럼 특정 클라이언트에 특화한 입력기 인터페이스를 지원할 수 있다.

SCIM을 [KDE](https://ko.wikipedia.org/wiki/KDE "wikilink")에 최적화하는 것을 목표로 개발되는 프로젝트인 **SKIM**도 있다.
...
## SCIM의 주요 특징
  ...
  - 수많은 기능을 포함한 [그래픽 사용자 인터페이스](https://ko.wikipedia.org/wiki/그래픽_사용자_인터페이스 "wikilink") 패널.
  - 통합된 환경 설정 프레임워크.
...
## 같이 보기
  ...
  - [입력기](https://ko.wikipedia.org/wiki/입력기 "wikilink")
  - [유닉스 플랫폼 입력기 목록](https://ko.wikipedia.org/wiki/유닉스_플랫폼_입력기_목록 "wikilink")
