...
[데이터 압축에서](https://ko.wikipedia.org/wiki/데이터_압축 "wikilink") **범용 부호**()는 양의 [정수](https://ko.wikipedia.org/wiki/정수 "wikilink")를 구분자 없이 서로 구별되는 이진 부호로 대응시키는 [접두 부호이며](https://ko.wikipedia.org/wiki/접두_부호 "wikilink"), 그 중 정수의 실제 [확률 분포와](https://ko.wikipedia.org/wiki/확률_분포 "wikilink") 상관 없이 분포가 단조적이면 (즉 모든 정수 \(i\)에 대해 \(p(i) \ge p(i+1)\)이 성립) 부호 길이의 [기댓값](https://ko.wikipedia.org/wiki/기댓값 "wikilink")이 [최적 부호](https://ko.wikipedia.org/wiki/최적_부호 "wikilink") 길이의 기댓값보다 최대 상수배보다 작은 것을 가리킨다. 특히 두 기댓값의 비율의 한계가 부호의 [정보 엔트로피의](https://ko.wikipedia.org/wiki/정보_엔트로피 "wikilink") 함수로 주어지며, 엔트로피가 무한대로 접근하면 함수값이 1이 될 때 그 부호를 점근적으로 최적이라고 한다.
...
다음은 잘 알려진 범용 부호의 목록이다. 별표(\*)로 표시한 것은 점근적으로 최적인 부호이다.
  ...
  - [지수 골롬 부호](https://ko.wikipedia.org/wiki/지수_골롬_부호 "wikilink") (엘리어스 감마 부호를 포함함, [MPEG-4](https://ko.wikipedia.org/wiki/MPEG-4 "wikilink")에서 쓰임)
  - [피보나치 부호](https://ko.wikipedia.org/wiki/피보나치_부호 "wikilink") \*
  - [레벤시테인 부호](https://ko.wikipedia.org/wiki/레벤시테인_부호 "wikilink") \* ([블라디미르 레벤시테인이](https://ko.wikipedia.org/wiki/블라디미르_레벤시테인 "wikilink") 1968년 논문\[[http://www.compression.ru/download/articles/int/levenstein_1968_on_the_redundancy_and_delay.pdf\]에서](http://www.compression.ru/download/articles/int/levenstein_1968_on_the_redundancy_and_delay.pdf%5D에서) 범용 부호를 소개하면서 함께 언급한 부호.)
...
다음은 범용 부호는 아니지만 모든 정수를 대응시키는 부호들의 목록이다.
  ...
  - [라이스 부호](https://ko.wikipedia.org/wiki/라이스_부호 "wikilink") (일진 부호를 포함함. [FLAC](https://ko.wikipedia.org/wiki/FLAC "wikilink") 코덱에서 사용됨)
