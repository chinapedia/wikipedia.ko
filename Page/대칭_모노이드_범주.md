...
[범주론](https://ko.wikipedia.org/wiki/범주론 "wikilink")에서, **대칭 모노이드 범주**(對稱monoid範疇, )는 [동형 사상](https://ko.wikipedia.org/wiki/동형_사상 "wikilink") 아래 [결합 법칙과](https://ko.wikipedia.org/wiki/결합_법칙 "wikilink") [교환 법칙이](https://ko.wikipedia.org/wiki/교환_법칙 "wikilink") 성립하고, [동형 사상](https://ko.wikipedia.org/wiki/동형_사상 "wikilink") 아래 항등원이 존재하는 [이항 연산을](https://ko.wikipedia.org/wiki/이항_연산 "wikilink") 갖는 [범주이다](https://ko.wikipedia.org/wiki/범주_\(수학\) "wikilink"). ([교환 법칙이](https://ko.wikipedia.org/wiki/교환_법칙 "wikilink") 성립하지 못할 수 있는) [모노이드 범주의](../Page/모노이드_범주.md "wikilink") 개념의 특수한 경우이다.
...
([끝 대상을](https://ko.wikipedia.org/wiki/끝_대상 "wikilink") 포함한) 유한 [곱이](https://ko.wikipedia.org/wiki/곱_\(범주론\) "wikilink") 존재하는 범주는 곱을 통해 대칭 모노이드 범주를 이룬다. 이러한 대칭 모노이드 범주를 **데카르트 모노이드 범주**()라고 한다. 마찬가지로, ([시작 대상을](https://ko.wikipedia.org/wiki/시작_대상 "wikilink") 포함한) 유한 [쌍대곱](https://ko.wikipedia.org/wiki/쌍대곱 "wikilink")이 존재하는 범주는 쌍대곱을 통해 대칭 모노이드 범주를 이루며, 이러한 대칭 모노이드 범주를 **쌍대 데카르트 모노이드 범주**()라고 한다.
