...
[일반위상수학](https://ko.wikipedia.org/wiki/일반위상수학 "wikilink")에서 필터의 개념은 [점렬](https://ko.wikipedia.org/wiki/점렬 "wikilink")의 일반화로 사용되며, [수리논리학](https://ko.wikipedia.org/wiki/수리논리학 "wikilink")에서 필터는 [초곱](../Page/초곱.md "wikilink")을 정의하는 데 쓰인다. 예를 들어, [초실수](https://ko.wikipedia.org/wiki/초실수 "wikilink")의 집합은 자연수 집합 위의 극대 필터를 사용하여 정의된다.
...
(\(X\) 자체를 제외하는 것은 [환론](../Page/환론.md "wikilink")에서 [극대 아이디얼을](https://ko.wikipedia.org/wiki/극대_아이디얼 "wikilink") 정의할 때 [환](https://ko.wikipedia.org/wiki/환_\(수학\) "wikilink") 자체를 제외하는 것과 유사하다.)

## 성질

### 합집합과 교집합

같은 [원순서 집합](../Page/원순서_집합.md "wikilink") 속의 두 필터의 [합집합](https://ko.wikipedia.org/wiki/합집합 "wikilink")이나 [교집합](https://ko.wikipedia.org/wiki/교집합 "wikilink")은 일반적으로 필터가 아니며, 순서 아이디얼의 경우도 마찬가지다. 다만, [원순서 집합](../Page/원순서_집합.md "wikilink") \((X,\lesssim)\) 속의 필터들의 [사슬](https://ko.wikipedia.org/wiki/사슬_\(순서론\) "wikilink") \(\mathcal C\subseteq\operatorname{Filter}(X,\lesssim)\)에 대하여, [합집합](https://ko.wikipedia.org/wiki/합집합 "wikilink") \(\textstyle\bigcup\mathcal C\)은 필터를 이룬다. 그러나 [교집합](https://ko.wikipedia.org/wiki/교집합 "wikilink") \(\bigcap\mathcal C\)는 여전히 필터가 아닐 수 있다. 마찬가지로, 순서 아이디얼들의 [사슬의](https://ko.wikipedia.org/wiki/사슬_\(순서론\) "wikilink") [합집합](https://ko.wikipedia.org/wiki/합집합 "wikilink")은 순서 아이디얼이지만, [교집합](https://ko.wikipedia.org/wiki/교집합 "wikilink")은 순서 아이디얼이 아닐 수 있다.

예를 들어, [자연수](https://ko.wikipedia.org/wiki/자연수 "wikilink") 집합 \(\mathbb N\)에 서로 비교 불가능한 두 개의 무한대 \(\infty\), \(\infty'\)를 추가하였을 때,
...
**극대 필터 정리**(極大filter定理, )에 따르면, \(F\)를 포함하는 극대 필터가 항상 적어도 하나 이상 존재한다. 이는 [초른의 보조정리로](https://ko.wikipedia.org/wiki/초른의_보조정리 "wikilink") 쉽게 증명된다.
...
\[\mathcal R=\left\{F'\in\operatorname{Filter}(X,\lesssim)\colon F\subseteq F'\ne X\right\}\] 를 생각하자. [초른의 보조정리에](https://ko.wikipedia.org/wiki/초른의_보조정리 "wikilink") 따라, \(\mathcal R\) 속의 모든 [사슬이](https://ko.wikipedia.org/wiki/사슬_\(순서론\) "wikilink") [상계를](https://ko.wikipedia.org/wiki/상계_\(수학\) "wikilink") 가지는 것을 보이면 족하다.
...
[귀류법](https://ko.wikipedia.org/wiki/귀류법 "wikilink")을 사용하여, \(\textstyle\bigcup\mathcal C=X\)라고 가정하자. 그렇다면
...
[불 대수](../Page/불_대수.md "wikilink") \((B,\lor,\land,\lnot)\)는 다음과 같이 표준적으로 [가환환](https://ko.wikipedia.org/wiki/가환환 "wikilink")으로 여길 수 있다.
...
\[x\le y\iff x=x\land y\iff y=x\lor y\] 그렇다면, \(B\)의 순서 아이디얼의 개념은 [가환환](https://ko.wikipedia.org/wiki/가환환 "wikilink")으로서의 [아이디얼](../Page/아이디얼.md "wikilink")의 개념과 일치한다.
...
[집합](https://ko.wikipedia.org/wiki/집합 "wikilink") \(X\)와 [상향 원순서 집합](../Page/상향_원순서_집합.md "wikilink") \((I,\lesssim)\) 및 [그물](https://ko.wikipedia.org/wiki/그물_\(수학\) "wikilink") \(x_\bullet\colon I\to X\)가 주어졌다고 하자. 그렇다면, \((x_i)_{i\in I}\)의 꼬리들의 집합
...
마찬가지로, [집합](https://ko.wikipedia.org/wiki/집합 "wikilink") \(Y\)와 [하향 원순서 집합](https://ko.wikipedia.org/wiki/하향_원순서_집합 "wikilink") \((J,\lesssim)\) 및 함수 \(y_\bullet\colon J\to Y\)가 주어졌다고 하자. 그렇다면, \((y_j)_{j\in J}\)의 머리들의 집합
...
[수열](https://ko.wikipedia.org/wiki/수열 "wikilink")은 [그물의](https://ko.wikipedia.org/wiki/그물_\(수학\) "wikilink") 특수한 경우이므로, 마찬가지로 유도 필터를 정의할 수 있다.

### 필터에 대응되는 그물

모든 [그물에](https://ko.wikipedia.org/wiki/그물_\(수학\) "wikilink") 필터가 대응되는 것처럼, 모든 필터에도 [그물을](https://ko.wikipedia.org/wiki/그물_\(수학\) "wikilink") 대응시킬 수 있다. 따라서, 위상 수학에서 그물 이론과 필터 이론은 사실상 동치이다.\[1\]
...
\[n\colon (x,A)\mapsto x\] 는 [그물을](https://ko.wikipedia.org/wiki/그물_\(수학\) "wikilink") 이룬다. 반대로, \(\mathcal F\)가 [하향 원순서 집합이며](https://ko.wikipedia.org/wiki/하향_원순서_집합 "wikilink") \(\mathcal F\ne\mathcal P(X)\)라면 \(I\) 역시 [하향 원순서 집합이며](https://ko.wikipedia.org/wiki/하향_원순서_집합 "wikilink"),

\[n\colon I^{\operatorname{op}}\to X\]

\[n\colon (x,A)\mapsto x\] 는 [그물을](https://ko.wikipedia.org/wiki/그물_\(수학\) "wikilink") 이룬다.
...
\[\uparrow\{x\}=\{S\subseteq X\colon x\in S\}\] 는 극대 필터이다. [유한 집합의](https://ko.wikipedia.org/wiki/유한_집합 "wikilink") [멱집합](../Page/멱집합.md "wikilink") 위의 극대 필터는 모두 위와 같은 꼴이다.
...
순서 아이디얼의 개념은 [불 대수에](../Page/불_대수.md "wikilink") 대하여 1934년에 [마셜 하비 스톤이](../Page/마셜_하비_스톤.md "wikilink") 도입하였다.\[2\] "순서 아이디얼"이라는 이름은 [불 대수의](../Page/불_대수.md "wikilink") 순서 아이디얼은 [가환환](https://ko.wikipedia.org/wiki/가환환 "wikilink")으로서의 [아이디얼](../Page/아이디얼.md "wikilink")과 일치하기 때문에 사용되었다. 1937년에 스톤은 순서 아이디얼을 [격자에](../Page/격자_\(순서론\).md "wikilink") 대하여 "μ-아이디얼"()이라는 이름으로 일반화하였다.\[3\] 마찬가지로, 스톤은 [격자](../Page/격자_\(순서론\).md "wikilink") 속의 필터를 "α-아이디얼"()이라고 명명하였다.\[4\]

이와 독자적으로, [앙리 카르탕은](https://ko.wikipedia.org/wiki/앙리_카르탕 "wikilink") 1937년에 [점렬](https://ko.wikipedia.org/wiki/점렬 "wikilink")의 개념을 일반화하여 "필터"()와 "초필터"()라는 용어를 도입하였다.\[5\]\[6\] 이후 [니콜라 부르바키가](../Page/니콜라_부르바키.md "wikilink") 이 개념을 널리 사용하여 대중화하였다.
