...
D2X의 후속으로 D2Xs가 출시되었다. 개선사항은 다음과 같다.
  ...
  - LCD 시야각 확장
  - [감도](https://ko.wikipedia.org/wiki/감도 "wikilink")([ISO](https://ko.wikipedia.org/wiki/ISO_카메라 "wikilink"))조절의 세분화
  - 조작 편의성 향상(외부적으로 새로운 버튼이나 기타 조작체가 추가된것이 아님)
  - 카메라 모든 설정을 파일화하여 저장가능
  - 트리밍 기능, 흑백 색공간 추가, 클리닝 미러업 기능을 배터리로 구동하고 있을때도 사용 가능, 커브 슬롯이 3개로 늘어남
...
크롭 연사 기능은 이미지 센서의 중앙부를 사용하여 약 680만 화소로 초당 8연사를 가능케 하는 기능이며 이 경우 35mm 필름 대비 초점거리는 2배가 된다. 센서 면적 전체를 사용하면 약 1,280만 화소로 초당 5연사가 가능하다. 이들을 포함한 여러 장점들(경쟁 제품과 비교했을때)은 다음과 같다.

  - 방진방적(防塵防滴;방적은 '물방울로부터 보호'이다. 따라서 방습보다 한 단계 높은 안정성을 제공한다. 그렇지만 방수는 불가능하다)를 지원하는 무겁고 튼튼한 [다이캐스팅](https://ko.wikipedia.org/wiki/다이캐스팅 "wikilink") [마그네슘](https://ko.wikipedia.org/wiki/마그네슘 "wikilink") [합금](https://ko.wikipedia.org/wiki/합금 "wikilink") 본체
  - 크롭 연사 기능(8fps)
  - 유효화소 약 1,280만 화소
  - 빠른 화상 처리와 리뷰 속도
  - 우수한 LCD 성능
  - 저감도에서의 우수한 [노이즈](https://ko.wikipedia.org/wiki/노이즈 "wikilink") 억제력, 니콘 DSLR중 가장 적은 감도수치 제공(기존 D1X가 125를 지원했음. D2X(s)는 100을 지원)
  - 뛰어난 AF 성능([CAM 2000](https://ko.wikipedia.org/wiki/CAM_2000 "wikilink") AF 모듈 탑재, 9개의 [크로스 측거점](https://ko.wikipedia.org/wiki/크로스_측거점 "wikilink") 제공)
...
## 외부 링크
  ...
  - [팝코넷의 리뷰](http://www.popco.net/zboard/view.php?id=dica_review&page=2&sn1=&divpage=1&category=11&sn=off&ss=on&sc=on&select_arrange=reg_date&desc=desc&no=85)

  - [dcinside.com D2X 리뷰](https://web.archive.org/web/20071212140027/http://dica.dcinside.com/review.php?pid=2116)

  - [dcinside.com D2Xs 리뷰](https://web.archive.org/web/20071212140250/http://dica.dcinside.com/review.php?pid=6074)

  - [dpreview.com의 리뷰](http://www.dpreview.com/reviews/nikond2x/)

[분류:니콘 DSLR 카메라](https://ko.wikipedia.org/wiki/분류:니콘_DSLR_카메라 "wikilink")

1.
2.  <http://dc.watch.impress.co.jp/cda/other/2004/10/01/181.html>