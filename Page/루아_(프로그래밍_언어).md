...
루아는 [확장 언어와](https://ko.wikipedia.org/wiki/확장_언어 "wikilink") [스크립트 언어를](../Page/스크립트_언어.md "wikilink") 지향하고 있으며, 충분히 작기 때문에 많은 플랫폼에서 사용할 수 있다. 루아는 [불 값](https://ko.wikipedia.org/wiki/불_값 "wikilink"), [숫자](../Page/숫자.md "wikilink")(기본적으로 배정도 [실수형](https://ko.wikipedia.org/wiki/실수형 "wikilink")), 그리고 [문자열](https://ko.wikipedia.org/wiki/문자열 "wikilink")과 같은 적은 수의 기본 데이터형만을 지원하며, [배열](../Page/배열.md "wikilink"), [집합](https://ko.wikipedia.org/wiki/집합_\(전산학\) "wikilink"), [해시 테이블](../Page/해시_테이블.md "wikilink"), [리스트](../Page/리스트_\(컴퓨팅\).md "wikilink"), [레코드와](../Page/레코드_\(컴퓨터_과학\).md "wikilink") 같은 전형적인 데이터 구조는 모두 [연관 배열과](https://ko.wikipedia.org/wiki/연관_배열 "wikilink") 유사한 루아의 테이블 자료형으로 구현하고 있다. 이름 공간과 객체들 역시 이 테이블을 사용하여 표현할 수 있다. 최소한의 자료형을 사용함으로써 루아는 성능과 크기 사이의 균형을 맞추려는 시도를 하였다.
