...
[루커스아츠](https://ko.wikipedia.org/wiki/루커스아츠 "wikilink")의 [원숭이 섬으로부터의 탈출](https://ko.wikipedia.org/wiki/원숭이_섬으로부터의_탈출 "wikilink") [어드벤처 게임과](../Page/어드벤처_게임.md "wikilink") 같은 많은 상업적 응용 프로그램과, [앵그리 버드와](https://ko.wikipedia.org/wiki/앵그리_버드 "wikilink") 그 변형들과 같은 비상업적 응용 프로그램들이 루아를 사용하고 있다. 루아는 디자인 면에서는 [아이콘과](https://ko.wikipedia.org/wiki/아이콘_프로그래밍_언어 "wikilink") 유사하고, 프로그래머가 아닌 사람들이 사용하기 쉽다는 면에서 [파이썬](../Page/파이썬.md "wikilink")과 유사하다.

## 기능

루아는 [확장 언어와](https://ko.wikipedia.org/wiki/확장_언어 "wikilink") [스크립트 언어를](../Page/스크립트_언어.md "wikilink") 지향하고 있으며, 충분히 작기 때문에 많은 플랫폼에서 사용할 수 있다. 루아는 [불 값](https://ko.wikipedia.org/wiki/불_값 "wikilink"), [숫자](../Page/숫자.md "wikilink")(기본적으로 배정도 [실수형](https://ko.wikipedia.org/wiki/실수형 "wikilink")), 그리고 [문자열](https://ko.wikipedia.org/wiki/문자열 "wikilink")과 같은 적은 수의 기본 데이터형만을 지원하며, [배열](../Page/배열.md "wikilink"), [집합](https://ko.wikipedia.org/wiki/집합_\(전산학\) "wikilink"), [해시 테이블](../Page/해시_테이블.md "wikilink"), [리스트](../Page/리스트_\(컴퓨팅\).md "wikilink"), [레코드와](https://ko.wikipedia.org/wiki/레코드_\(컴퓨터_과학\) "wikilink") 같은 전형적인 데이터 구조는 모두 [연관 배열과](https://ko.wikipedia.org/wiki/연관_배열 "wikilink") 유사한 루아의 테이블 자료형으로 구현하고 있다. 이름 공간과 객체들 역시 이 테이블을 사용하여 표현할 수 있다. 최소한의 자료형을 사용함으로써 루아는 성능과 크기 사이의 균형을 맞추려는 시도를 하였다.
