> This article is converted from Wikipedia: [사회인격학](https://ko.wikipedia.org/wiki/사회인격학).
...
### 이중성 관계(Duality), 이원 관계 오역

번역할 때, 맞춤법이 틀려서 이원 관계라고도 불린다. 이중성 관계는 사회인격학에서 기본이 되는 개념이다. 이중성 관계는 서로 지지하고 이익이 되는 관계라고 설명할 수 있으며, 보통 우정, 친밀함, 결혼 등에서 최적의 관계로 평가된다(물론 사회인격학 타입이 이 관계에 영향을 미치는 유일한 요소는 아니다).
...
소멸 관계, 대척 관계, 반대 관계 등 다양한 이름으로 불리며 상쇄 관계는 두 사람이 같은 영역에서 자신이 있지만 서로 다른 기능에 중점을 두는 경우에 생긴다. 이 관계에서는 종종 생활 양식이 비슷하지만 생각하는 과정은 다른 것을 볼 수 있다. 파트너는 비슷한 분야에 흥미를 보이고 전문적인 지식을 보유하며 서로 의사소통하는데 문제를 느끼지 않는다.
...
예를 들자면, 사회인격학 유형은 맨 끝글자인 j가 소문자로 되어있고, MBTI유형은 맨 끝글자인 J가 대문자로 되어있다. 그래서 사회인격학 유형은 INTj 라고 표시되며, MBTI유형은 INTP라고 표시된다. 사람들은 이러한 유형 속에 내재된 소문자와 대문자의 차이와 진실을 알지 못했다. 그리고 소시오닉스 유형에 대해 제대로 알지 못한채 접근하고 제 생각에 따라 해석하고 왜곡했다.

사람들은 사회인격학 유형과 MBTI유형이 겉모습만 흡사할뿐, 실제로는 전혀 다른 유형이라는 사실을 알지 못하고 문자 그대로 사회인격학 유형을 해석해서 관계론을 인터넷에 알렸으며 이는 왜곡되게 해석한 것과 같다. 그래서 인터넷에는 오류난 사회인격학 관계론이 알려지게 된 것이다.

### 잘못된 유형 궁합 정보

MBTI ISFP 유형(성인군자형)의 연애와 궁합:<https://m.blog.naver.com/colorcurator/221718015597>

MBTI INFJ 유형(예언자형)의 연애와 궁합:<https://m.blog.naver.com/colorcurator/221718276320>

MBTI INFP 유형(잔다르크형)의 연애와 궁합:<https://m.blog.naver.com/colorcurator/221718029747>

MBTI ESTJ(사업가형)의 연애와 궁합:<https://m.blog.naver.com/colorcurator/221717847497>

MBTI INTJ 유형(과학자형)의 연애와 궁합:<https://m.blog.naver.com/colorcurator/221718264267>

MBTI ENFP 유형(스파크형)의 연애와 궁합:<https://m.blog.naver.com/colorcurator/221718252141>

MBTI ENTP 유형(발명가형)의 연애와 궁합:<https://m.blog.naver.com/colorcurator/221718238971>

MBTI ISFJ 유형(임금 뒷편의 권력형)의 연애와 궁합:<https://m.blog.naver.com/colorcurator/221718193481>

MBTI ISTJ 유형(세상의 소금형)의 연애와 궁합:<https://m.blog.naver.com/colorcurator/221718181672>

MBTI ESFP 유형(연예인형)의 연애와 궁합:<https://m.blog.naver.com/colorcurator/221718170546>

MBTI ESTP 유형(수완좋은 활동가형)의 연애와 궁합:<https://m.blog.naver.com/colorcurator/221718159193>

MBTI ENFJ 유형(언변능숙형)의 연애와 궁합:<https://m.blog.naver.com/colorcurator/221718003247>

MBTI ESFJ 유형(친선도모형)의 연애와 궁합:<https://m.blog.naver.com/colorcurator/221717988838>

MBTI INTP 유형(아이디어뱅크형)의 연애와 궁합:<https://m.blog.naver.com/colorcurator/221717890301>

MBTI ISTP(백과사전형)의 연애와 궁합:<https://m.blog.naver.com/colorcurator/221717876943>

MBTI ENTJ(지도자형)의 연애와 궁합:<https://m.blog.naver.com/colorcurator/221717861558>
