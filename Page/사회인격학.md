...
예를 들자면, 사회인격학 유형은 맨 끝글자인 j가 소문자로 되어있고,

MBTI유형은 맨 끝글자인 J가 대문자로 되어있다. 그래서 사회인격학 유형은 INTj 라고 표시되며, MBTI유형은 INTP라고 표시된다. 사람들은 이러한 유형 속에 내재된 소문자와 대문자의 차이와 진실을 알지 못했다. 그리고 소시오닉스 유형에 대해 제대로 알지 못한채 접근하고 제 생각에 따라 해석하고 왜곡했다.
