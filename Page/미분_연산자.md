...
[수학](https://ko.wikipedia.org/wiki/수학 "wikilink")에서, **미분 연산자**(微分演算子, )는 [미분](https://ko.wikipedia.org/wiki/미분 "wikilink") 연산을 포함할 수 있는, [함수](https://ko.wikipedia.org/wiki/함수 "wikilink") 또는 [단면](https://ko.wikipedia.org/wiki/단면_\(올다발\) "wikilink") 공간 위의 국소적 [선형 변환이다](https://ko.wikipedia.org/wiki/선형_변환 "wikilink").
...
\[s\nabla_{X_1}\nabla_{X_2}\cdots\nabla_{X_k}\colon\Gamma^\infty(E)\to\Gamma^\infty(F)\] 여기서
  ...
  - \(k\in\mathbb N\)는 [자연수](https://ko.wikipedia.org/wiki/자연수 "wikilink")(음이 아닌 정수)이다.
...
[콤팩트](../Page/콤팩트_공간.md "wikilink") [매끄러운 다양체](https://ko.wikipedia.org/wiki/매끄러운_다양체 "wikilink") \(M\) 위의 두 [벡터 다발](../Page/벡터_다발.md "wikilink") \(E,F\)가 주어졌다고 하자. \(E\to F\) 미분 연산자의 공간을 \(\mathcal D(E,F)\)로 표기하자.

그렇다면, 모든 미분 연산자 \(\Gamma^\infty(E)\to\Gamma^\infty(F)\)는 유한한 차수를 가지며, 따라서 차수에 따라 자연스러운 [오름 여과](https://ko.wikipedia.org/wiki/여과_\(수학\) "wikilink")
...
[콤팩트](../Page/콤팩트_공간.md "wikilink") [매끄러운 다양체](https://ko.wikipedia.org/wiki/매끄러운_다양체 "wikilink") \(M\) 위의 [벡터 다발](../Page/벡터_다발.md "wikilink") \(E\)이 주어졌다고 하자. 편의상 \(\mathcal D(E)=\mathcal D(E,E)\)와 같이 표기하자.
...
\[\Gamma^\infty\left(\operatorname{Sym}(\mathrm TM)\otimes\operatorname{End}(E)\right)\cong\operatorname{gr}\mathcal D(E)\] 여기서
  ...
  - \(\operatorname{End}(E)=E\otimes E^*\)는 \(E\) 위의 [자기](https://ko.wikipedia.org/wiki/자기_사상 "wikilink") 벡터 다발 사상으로 구성된 [벡터 다발이다](../Page/벡터_다발.md "wikilink").
...
구체적으로, [매끄러운 다양체](https://ko.wikipedia.org/wiki/매끄러운_다양체 "wikilink") \(M\) 위의 두 [매끄러운 벡터 다발](https://ko.wikipedia.org/wiki/매끄러운_벡터_다발 "wikilink") \(E,F\to X\) 사이의 미분 연산자 \(D\colon\Gamma^\infty(E)\to\Gamma^\infty(F)\)를 생각하자. 임의의 [매끄러운 단면](https://ko.wikipedia.org/wiki/매끄러운_단면 "wikilink") \(u\in\Gamma^\infty(E)\)에 대하여, 국소 좌표계에서 \(D\)가

\[D\colon u(x)\mapsto\sum_IP^I(x)\partial_Iu\] 의 꼴이라고 하자. 여기서 \(I\)는 [다중지표](../Page/다중지표.md "wikilink")이고, \(D^I\colon E\to F\)는 [다발 사상이다](https://ko.wikipedia.org/wiki/다발_사상 "wikilink"). 여기서 \(D^I\)는 다중지표의 성분들의 [순열](https://ko.wikipedia.org/wiki/순열 "wikilink")에 무관하다.
...
유클리드 공간 \(\mathbb R^n\) 위의 실수 값 [매끄러운 함수는](https://ko.wikipedia.org/wiki/매끄러운_함수 "wikilink") 자명한 [벡터 다발](../Page/벡터_다발.md "wikilink") \(\mathbb R\times\mathbb R^n\)의 [매끄러운 단면이며](https://ko.wikipedia.org/wiki/매끄러운_단면 "wikilink"), [벡터장](../Page/벡터장.md "wikilink")은 자명한 벡터 다발 \(\mathbb R^n\times\mathbb R^n=\operatorname T\mathbb R^n\)의 [매끄러운 단면이다](https://ko.wikipedia.org/wiki/매끄러운_단면 "wikilink"). 이 경우, 매끄러운 함수의 [기울기](../Page/기울기_\(벡터\).md "wikilink")

\[\operatorname{grad}\colon\mathcal C^\infty(\mathbb R^n,\mathbb R)\to\mathcal C^\infty(\mathbb R^n,\mathbb R^n)\] 와 [발산](https://ko.wikipedia.org/wiki/발산_\(벡터\) "wikilink")

\[\operatorname{div}\colon\mathcal C^\infty(\mathbb R^n,\mathbb R^n)\to\mathcal C^\infty(\mathbb R^n,\mathbb R)\] 및 [회전](https://ko.wikipedia.org/wiki/회전_\(벡터\) "wikilink")
...
\[\sigma_\Delta(\xi)=g^{-1}(\xi,\xi)\] 이다. 만약 \(M\)이 [리만 다양체라면](https://ko.wikipedia.org/wiki/리만_다양체 "wikilink") 이는 타원형 미분 연산자이다.

### 디랙 연산자

[스핀 다양체](https://ko.wikipedia.org/wiki/스핀_다양체 "wikilink") \(M\) 위의 1차 미분 연산자인 [디랙 연산자](../Page/디랙_연산자.md "wikilink")

\[D=\gamma^i\nabla_i\colon SM\to SM\] 의 주표상은

\[\sigma_D(\xi)=\gamma^i\xi_i\] 이다. 여기서 \(SM\)은 \(M\)의 [스피너 다발이고](https://ko.wikipedia.org/wiki/스피너_다발 "wikilink"), \(\gamma^i\)는 [디랙 행렬이다](https://ko.wikipedia.org/wiki/디랙_행렬 "wikilink"). 이는 항상 약타원형 미분 연산자이다.
