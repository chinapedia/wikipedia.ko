...
**C POSIX 라이브러리**는 [C 표준 라이브러리](https://ko.wikipedia.org/wiki/C_표준_라이브러리 "wikilink") [POSIX](https://ko.wikipedia.org/wiki/POSIX "wikilink")에 대한 시스템 사양이다. 이것은 [ANSI C의](https://ko.wikipedia.org/wiki/ANSI_C "wikilink") 표준으로 동시에 개발되었다. POSIX는 추가적인 기능을 표준 C를 사용하는 사람들에게 소개를 했고, 이러한 노력으로 POSIX와 [표준 C를](https://ko.wikipedia.org/wiki/표준_C "wikilink") 호환되도록 만들 수 있었다.
...
| *' \<[fcntl.h](https://ko.wikipedia.org/wiki/fcntl.h "wikilink")\>*'             | 파일을 열고, [잠금](https://ko.wikipedia.org/wiki/파일_잠금 "wikilink") 및 다른 작업을 할 수 있음.                                                                     |
| *' \<grp.h\>*'                                                                   | 사용자 [그룹](https://ko.wikipedia.org/wiki/그룹_식별자_\(유닉스\) "wikilink") 정보를 제어함.                                                                        |
| *' \<[pthread.h](https://ko.wikipedia.org/wiki/pthread.h "wikilink")\>*'         | [POSIX](https://ko.wikipedia.org/wiki/POSIX "wikilink") 스레드를 생성하고 조작하기 위한 API를 정의함.                                                               |
...
| *' \<[sys/ipc.h](https://ko.wikipedia.org/wiki/sys/ipc.h "wikilink")\>*'         | [프로세스 간 통신](https://ko.wikipedia.org/wiki/프로세스_간_통신 "wikilink") IPC.                                                                              |
...
| *' \<[termios.h](https://ko.wikipedia.org/wiki/termios.h "wikilink")\>*'         | [터미널 입출력(I/O)](https://ko.wikipedia.org/wiki/직렬_포트 "wikilink") 인트페이스를 허용함.                                                                        |
| *' \<[unistd.h](https://ko.wikipedia.org/wiki/unistd.h "wikilink")\>*'           | 다양한 필수 POSIX 함수와 상수.                                                                                                                              |
| *' \<[utime.h](https://ko.wikipedia.org/wiki/utime.h "wikilink")\>*'             | [아이노드](https://ko.wikipedia.org/wiki/아이노드 "wikilink")(inode) 접근과 수정시간.                                                                            |
