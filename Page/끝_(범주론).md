...
[범주론](https://ko.wikipedia.org/wiki/범주론 "wikilink")에서, **끝**()과 **쌍대끝**(雙對-, )은 어떤 데이터들을 범주론적으로 “이어붙이는” 연산이다.

## 정의

다음이 주어졌다고 하자.

  - [범주](https://ko.wikipedia.org/wiki/범주_\(수학\) "wikilink") \(\mathcal C,\mathcal D\)
  - [함자](https://ko.wikipedia.org/wiki/함자_\(수학\) "wikilink") \(F\colon \mathcal C^{\operatorname{op}}\times\mathcal C\to \mathcal D\)
...
이는 보편 성질에 의하여 정의되므로, 유일한 [동형 사상](https://ko.wikipedia.org/wiki/동형_사상 "wikilink") 아래 유일하다. 이를
...
\[\int_{Y\in\mathcal D}\int_{X\in\mathcal C}F(X,Y,X,Y)\] 가 존재한다면, 이 세 대상은 모두 표준적으로 동형이다.\[1\] (이 이름은 [측도론](https://ko.wikipedia.org/wiki/측도론 "wikilink")의 [푸비니 정리에](https://ko.wikipedia.org/wiki/푸비니_정리 "wikilink") 빗댄 것이다.)
...
다음이 주어졌다고 하자.
  ...
  - [함자](https://ko.wikipedia.org/wiki/함자_\(수학\) "wikilink") \(F,G\colon X\to\mathcal D\)

그렇다면, 다음과 같은 함자를 정의할 수 있다.

\[\hom_{\mathcal D}(F(-),G(-)) \colon \mathcal C^{\operatorname{op}} \times\mathcal C\to \operatorname{Set}\] 이 함자의 끝

\[\int_{X\in\mathcal C}\hom_{\mathcal D}(F(X),G(X))=\operatorname{Nat}(F,G)\] 은 두 함자 \(F\)와 \(G\) 사이의 [자연 변환들의](https://ko.wikipedia.org/wiki/자연_변환 "wikilink") 집합과 같으며, 그 성분
...
\[X\colon \triangle^{\operatorname{op}}\to\operatorname{Top}\] 과, [단체의](https://ko.wikipedia.org/wiki/단체_\(수학\) "wikilink") 위상 공간 모형 함자
