...
[수학](../Page/수학.md "wikilink")에서, **유리수**(有理數, )는 두 [정수](https://ko.wikipedia.org/wiki/정수 "wikilink")의 [비율](https://ko.wikipedia.org/wiki/비율 "wikilink")로 나타낼 수 있는 수이다. 단, [분모](https://ko.wikipedia.org/wiki/분모 "wikilink")가 0이 아니어야 한다. 특히, 분모가 1일 수 있으므로 모든 [정수](https://ko.wikipedia.org/wiki/정수 "wikilink")는 유리수이다. 유리수체의 기호는 [볼드체](https://ko.wikipedia.org/wiki/볼드체 "wikilink") \(\mathbf Q\)나 [칠판 볼드체](../Page/칠판_볼드체.md "wikilink") \(\mathbb Q\)이며, '[몫](https://ko.wikipedia.org/wiki/몫 "wikilink")'을 뜻하는 영어 **quotient**에서 따왔다.
...
엄밀히 말해, 유리수체 \(\mathbb Q\)는 다음과 같은 공리를 만족시키는 ([동형](https://ko.wikipedia.org/wiki/동형 "wikilink") 아래 유일한) [체이다](https://ko.wikipedia.org/wiki/체_\(수학\) "wikilink").

  - \(\mathbb Q\)의 [표수는](../Page/환의_표수.md "wikilink") 0이다.
  - 만약 [환](https://ko.wikipedia.org/wiki/환_\(수학\) "wikilink") \(R\)의 표수가 0이라면, 유일한 [환 준동형](https://ko.wikipedia.org/wiki/환_준동형 "wikilink") \(\mathbb Q\to R\)이 존재한다.
...
\[[(m,n)]_\sim\cdot[(m',n')]_\sim=[(mm',nn')]_\sim\] 체가 만족시켜야 하는 조건인 각종 연산 법칙과 덧셈 항등원 \([(0,1)]_\sim\) 및 각 유리수 \([(m,n)]_\sim\)의 덧셈 역원 \([(-m,n)]_\sim\) 및 곱셈 항등원 \([(1,1)]_\sim\) 및 0이 아닌 각 유리수 \([(m,n)]_\sim\ne[(0,0)]_\sim\)의 곱셈 역원 \([(n,m)]_\sim\)의 존재가 성립하므로, 이는 체를 이룬다. 정수환과 유리수체 사이의 표준적인 [단사](https://ko.wikipedia.org/wiki/단사_함수 "wikilink") [환 준동형은](https://ko.wikipedia.org/wiki/환_준동형 "wikilink") 다음과 같다.
...
유리수는 유한 [연분수](https://ko.wikipedia.org/wiki/연분수 "wikilink") 표현이 가능하다. 예를 들어, 다음과 같다.

\[\frac{11}9=[1;4,2]=1+\frac1{4+\dfrac12}\]

\[\frac{15}{11}=[1;2,1,3]=1+\frac1{2+\dfrac1{1+\dfrac13}}\]

\[\frac{734}{367}=[2;5,3,7,3]=2+\frac1{5+\dfrac1{3+\dfrac1{7+\dfrac13}}}\] 분수를 연분수로 나타내려면, 분자와 분모에 [유클리드 호제법을](https://ko.wikipedia.org/wiki/유클리드_호제법 "wikilink") 응용하면 된다.
...
집합 \(\mathbb Q\)는 정수의 집합 \(\mathbb Z\)으로 만든 [분수체](../Page/분수체.md "wikilink")이며, 따라서 \(\mathbb Q\)는 사칙연산이 자유로운 [체이다](https://ko.wikipedia.org/wiki/체_\(수학\) "wikilink").

집합 \(\mathbb Q\)는 [표수가](../Page/환의_표수.md "wikilink") 0인 가장 작은 [체이다](https://ko.wikipedia.org/wiki/체_\(수학\) "wikilink"). 즉, [표수가](../Page/환의_표수.md "wikilink") 0인 체는 \(\mathbb Q\)와 [동형](https://ko.wikipedia.org/wiki/동형 "wikilink")인 체를 반드시 포함한다.
...
유리수체에는 표준적인 [절댓값](https://ko.wikipedia.org/wiki/절댓값 "wikilink")과 [p진 절댓값을](https://ko.wikipedia.org/wiki/p진_절댓값 "wikilink") 줄 수 있으며, 이들에 의한 [완비화](https://ko.wikipedia.org/wiki/완비화 "wikilink")는 각각 [실수체](https://ko.wikipedia.org/wiki/실수체 "wikilink")와 [p진수체](https://ko.wikipedia.org/wiki/p진수체 "wikilink")이다.
