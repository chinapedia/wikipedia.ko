...
**OLE DB**(Object Linking and Embedding, Database) 또는 **객체 연결 삽입 데이터베이스**는 [마이크로소프트](https://ko.wikipedia.org/wiki/마이크로소프트 "wikilink")사가 개발한 [API](../Page/API.md "wikilink")로, 통일된 방식으로 저장된 여러 종류의 [데이터](https://ko.wikipedia.org/wiki/데이터 "wikilink")에 접근하기 위해 만들어졌다. [컴포넌트 오브젝트 모델](https://ko.wikipedia.org/wiki/컴포넌트_오브젝트_모델 "wikilink") (COM)을 사용하여 추가된 인터페이스 집합이며 [객체 연결 삽입과는](../Page/객체_연결_삽입.md "wikilink") 관련이 없다. [ODBC](../Page/ODBC.md "wikilink")를 높은 수준으로 대체하면서도 그 뒤를 잇도록 설계되었으며 [오브젝트 데이터베이스와](https://ko.wikipedia.org/wiki/오브젝트_데이터베이스 "wikilink") [SQL](../Page/SQL.md "wikilink") 추가가 필수적이지 않은 [스프레드시트](https://ko.wikipedia.org/wiki/스프레드시트 "wikilink") 같이 더 다양한 범위의 비[관계형 데이터베이스를](https://ko.wikipedia.org/wiki/관계형_데이터베이스 "wikilink") 지원하기 위해 기능을 확장하였다.
