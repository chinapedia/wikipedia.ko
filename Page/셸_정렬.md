...
[섬네일](https://ko.wikipedia.org/wiki/파일:Shell_sorting_algorithm_color_bars.svg "wikilink") **셸 정렬**()은 가장 오래된 [정렬 알고리즘의](https://ko.wikipedia.org/wiki/정렬_알고리즘 "wikilink") 하나이다. 이름은 [1959년](https://ko.wikipedia.org/wiki/1959년 "wikilink") 이 방법을 발표한 창안자 [도널드 셸의](https://ko.wikipedia.org/wiki/도널드_셸 "wikilink") 이름을 따서 붙여졌다. 셸 정렬은 개념을 이해하고 구현하기는 쉬우나 시간복잡도 분석은 조금 복잡하다.
...
### [자바](https://ko.wikipedia.org/wiki/자바_\(프로그래밍_언어\) "wikilink")(Java)
