...
1.  **[BLOOD on FIRE](https://ko.wikipedia.org/wiki/BLOOD_on_FIRE "wikilink")** \[4:29\]
    ...
    <!-- end list -->
      -
        첫 번째 싱글.
2.  **[DRAGON FIRE](../Page/DRAGON_FIRE.md "wikilink")** \[4:32\]
      - 작사 · 작곡 · 편곡: [시미즈 아키오](https://ko.wikipedia.org/wiki/시미즈_아키오 "wikilink")
    <!-- end list -->
      -
        네 번째 싱글.
3.  **Welcome to This World** \[4:19\]
      - 작사 · 작곡: SOTARO\&KEN / 편곡: [h-wonder](https://ko.wikipedia.org/wiki/h-wonder "wikilink")
    <!-- end list -->
      -
        신곡.
        스트리트 시대부터 불려왔던 곡
4.  **태양**() \[4:46\]
      - 작사 · 작곡: 카와이 타케시 / 편곡: 타나베 케이지
    <!-- end list -->
      -
        신곡
5.  **[아름다운 하늘](../Page/아름다운_하늘.md "wikilink")**() \[4:40\]
      - 작사 · 작곡: 하라 히로아키 / 편곡: 마츠바라 켄
    <!-- end list -->
      -
        세 번째 싱글
6.  **최강 Babe**() \[4:02\]
      - 작사: [motsu](https://ko.wikipedia.org/wiki/motsu "wikilink") / 작곡 · 편곡: face 2 fAKE
    <!-- end list -->
      -
        신곡.
        5명의 남성 멤버에 의한 곡. 각각의 솔로 파트가 나뉘어 있다.
7.  **Get or Lose** \[4:55\]
      - 작사: 모리 히로미 / 작곡: [하야시다 켄지](https://ko.wikipedia.org/wiki/하야시다_켄지 "wikilink") / 편곡: 타나베 케이지
    <!-- end list -->
      -
        신곡
...
8.  **[만남의 힘](https://ko.wikipedia.org/wiki/만남의_힘 "wikilink")**() \[5:00\]
    ...
    <!-- end list -->
      -
        신곡
        니시지마, 우노에 의한 곡
9.  **[Friday Party](../Page/Friday_Party.md "wikilink")** \[3:56\]
      - 작사: m.c.A・T / 작곡 · 편곡: 토가시 아키오
    <!-- end list -->
      -
        두 번째 싱글. 남성 멤버 5명과 우노의 총 6명으로 부르는 버전도 존재했다.
10. **VIRGIN F** \[4:25\]
      - 작사: motsu / 작곡 · 편곡: 고토 츠구토시
    <!-- end list -->
      -
        신곡
        스트리트 시대부터 불려왔던 곡
11. **지구에 안겨서**() \[4:22\]
      - 작사: 판타 / 작곡 · 편곡: [소가와 토모지](https://ko.wikipedia.org/wiki/소가와_토모지 "wikilink")
    <!-- end list -->
      -
        신곡
12. **우리들의 손**() \[4:30\]
      - 작사 · 작곡: [이시다 타쿠미](https://ko.wikipedia.org/wiki/Ricken's "wikilink") / 편곡: [REO](https://ko.wikipedia.org/wiki/REO "wikilink")
    <!-- end list -->
      -
        신곡
        라이브 마지막에 불린 적이 많은 곡
...
영상은 2005년 11월 3일에 행해진 프리미엄 이벤트 ‘**내일은 Friday Party**’()에서.
...
1.  BLOOD on FIRE
2.  DRAGON FIRE
3.  Welcome to this wored
4.  아름다운 하늘
5.  Friday Party
6.  지구에 안겨서

[분류:2006년 음반](https://ko.wikipedia.org/wiki/분류:2006년_음반 "wikilink") [분류:AAA의 음반](https://ko.wikipedia.org/wiki/분류:AAA의_음반 "wikilink") [분류:2006년 데뷔 음반](https://ko.wikipedia.org/wiki/분류:2006년_데뷔_음반 "wikilink")