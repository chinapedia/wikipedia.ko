...
**ICMP**(Internet Control Message Protocol, [인터넷](../Page/인터넷.md "wikilink") 제어 메시지 [프로토콜](https://ko.wikipedia.org/wiki/프로토콜 "wikilink"))는 [인터넷 프로토콜 스위트에](https://ko.wikipedia.org/wiki/인터넷_프로토콜_스위트 "wikilink") 기록된 주요 프로토콜 가운데 하나이다. 네트워크 컴퓨터 위에서 돌아가는 운영체제에서 오류 메시지(Requested service is not available 등)를 전송받는 데 주로 쓰이며 [인터넷 프로토콜의](https://ko.wikipedia.org/wiki/인터넷_프로토콜 "wikilink") 주요 구성원 중 하나로 인터넷 프로토콜에 의존하여 작업을 수행한다. 프로토콜 번호 1로 할당되고 시스템 사이에 데이터를 교환하지 않거나 최종 사용자에 적용되지 않는다는 점에서 [TCP와](https://ko.wikipedia.org/wiki/전송_제어_프로토콜 "wikilink") [UDP와는](../Page/사용자_데이터그램_프로토콜.md "wikilink") 다르다.(ping 이나 traceroute 같은 몇몇 진단 프로그램 제외) [인터넷 프로토콜 버전 4](https://ko.wikipedia.org/wiki/IPv4 "wikilink")(IPv4) 용 ICMP는 [ICMPv4](https://ko.wikipedia.org/wiki/ICMPv4 "wikilink")로 알려져 있고, 유사하게 [IPv6](https://ko.wikipedia.org/wiki/IPv6 "wikilink")은 [ICMPv6](../Page/ICMPv6.md "wikilink")이다.

## 상세 기술 정보

인터넷 제어 메시지 프로토콜은 [RFC 792에서](https://ko.wikipedia.org/wiki/RFC_792 "wikilink") 정의한 [인터넷 프로토콜 모음](https://ko.wikipedia.org/wiki/인터넷_프로토콜_스위트 "wikilink") 중의 하나이다. ICMP 메시지들은 일반적으로 IP 동작([RFC 1122에](https://ko.wikipedia.org/wiki/RFC_1122 "wikilink") 규정)에서 진단이나 제어로 사용되거나 오류에 대한 응답으로 만들어진다. ICMP 오류들은 원래 패킷의 소스 IP 주소로 보내지게 된다.
...
| *옵셋*                                                      | [옥텟](https://ko.wikipedia.org/wiki/옥텟_\(컴퓨팅\) "wikilink") | 0                                                               | 1                                                           | 2                                                                  | 3 |
| --------------------------------------------------------- | --------------------------------------------------------- | --------------------------------------------------------------- | ----------------------------------------------------------- | ------------------------------------------------------------------ | - |
| [옥텟](https://ko.wikipedia.org/wiki/옥텟_\(컴퓨팅\) "wikilink") | [비트](https://ko.wikipedia.org/wiki/비트_\(단위\) "wikilink")  | 0                                                               | 1                                                           | 2                                                                  | 3 |
