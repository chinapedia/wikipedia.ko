...
[수학](https://ko.wikipedia.org/wiki/수학 "wikilink")에서, **드무아브르의 공식**()은 임의의 [복소수](https://ko.wikipedia.org/wiki/복소수 "wikilink")를 [극형식으로](https://ko.wikipedia.org/wiki/극좌표계 "wikilink") 나타내었을 때 성립하는 다음 등식을 의미한다. 이 식에서 *i*는 [허수 단위를](https://ko.wikipedia.org/wiki/허수_단위 "wikilink") 뜻한다.
...
[지수 함수의](https://ko.wikipedia.org/wiki/지수_함수 "wikilink") 성질에 의하여 다음 식을 얻을 수 있다.
...
\(\scriptstyle \cos{nx}\)에 대한 등식의 우변은, 실제로는 [체비쇼프 다항식](https://ko.wikipedia.org/wiki/체비쇼프_다항식 "wikilink") \(\scriptstyle T_n (\cos x)\)의 값이다.
...
## 같이 보기
  ...
  - [오일러 공식](https://ko.wikipedia.org/wiki/오일러_공식 "wikilink")
