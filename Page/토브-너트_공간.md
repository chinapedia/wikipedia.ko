...
[일반 상대성이론에서](../Page/일반_상대성이론.md "wikilink"), **토브-너트 공간**(-空間,  )은 [아인슈타인 방정식의](../Page/아인슈타인_방정식.md "wikilink") 4차원 진공해이며, 특히 4차원 [초켈러 다양체이자](../Page/초켈러_다양체.md "wikilink") [점근 국소 평탄 공간이다](https://ko.wikipedia.org/wiki/점근_국소_평탄_공간 "wikilink"). 이 해는 여러 매우 특이한 성질들을 가진다.\[1\]
...
\[\mathbb R^4 \times \mathbb R^3 \times \frac{\mathbb R}{\beta\mathbb Z}\] 위에서 [U(1)](https://ko.wikipedia.org/wiki/U\(1\) "wikilink")의 작용을 생각하자. 구체적으로, 평탄한 [유클리드 공간](../Page/유클리드_공간.md "wikilink") \(\mathbb R^4\) 위의 적절한 좌표계 \((\vec r=(r_1,r_2,r_3),\,\psi)\)에서 평탄한 리만 계량은 [기번스-호킹 가설 풀이로](https://ko.wikipedia.org/wiki/기번스-호킹_가설_풀이 "wikilink") 다음과 같다.
