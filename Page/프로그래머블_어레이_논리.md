...
프로그래머블 어레이 논리로 생성된 설계사업은 [존 버크너](https://ko.wikipedia.org/wiki/존_버크너 "wikilink") ()가 관리하였고 실제 PAL 회로는 [H. T. Chua가](https://ko.wikipedia.org/wiki/H._T._Chua "wikilink") 설계하였다. 버크너 씨의 이전 직업은 80 표준 논리 소자를 사용한 16 비트 프로세서 개발자였다. 그의 표준 논리를 사용한 경험은 사용자 프로그래머블 소자가 표준 논리를 대체하는 설계하면 설계자에게 더 매력적일거라고 믿게되었다. 이것은 패키지 크기가 좀 더 일반적으로 존재하는 소자이고 속도가 향상되었음을 의미한다. 이런 요구가 맞는 프로그래머블 어레이 논리는 크게 성공했고 [내셔널 세미컨덕터](https://ko.wikipedia.org/wiki/내셔널_세미컨덕터 "wikilink"), [텍사스 인스트루먼트](https://ko.wikipedia.org/wiki/텍사스_인스트루먼트 "wikilink"), [AMD가](https://ko.wikipedia.org/wiki/어드밴스트_마이크로_디바이시스 "wikilink") [2차 공급하게](https://ko.wikipedia.org/wiki/2차_공급사 "wikilink") 되었다.

## 제조 기술

초기의 PAL은 실리콘을 사용하여 한번만 프로그램되는 (OTP) 니크롬 프로그램 퓨즈를 갖는 접합형 트랜지스터 기술로 제조된 20 핀 [딥](https://ko.wikipedia.org/wiki/이중_직렬_패키지 "wikilink") 소자였다. 이후의 소자는 NMOS 기술을 사용하여 [래티스 세미컨덕터와](https://ko.wikipedia.org/wiki/래티스_세미컨덕터 "wikilink") [내셔널 세미컨덕터에서](https://ko.wikipedia.org/wiki/내셔널_세미컨덕터 "wikilink") 제조하였다. 1980년대 초에는 [지택스](https://ko.wikipedia.org/wiki/지택스 "wikilink") ()는 저온공정 시모스 기술을 사용하여 만들어진 프로그래머블 어레이 논리는 초기 [애플](https://ko.wikipedia.org/wiki/애플_\(기업\) "wikilink") 매킨토시에 사용되었고 대류 냉각에 의지하여 조용히 동작하였다.
...
[로지컬 디바이스가](https://ko.wikipedia.org/wiki/로지컬_디바이스 "wikilink") 프로그래머블 논리의 범용 컴파일러 ([CUPL](https://ko.wikipedia.org/wiki/CUPL "wikilink"))를 발표하였고 IBM 개인용 컴퓨터의 [MS-DOS](https://ko.wikipedia.org/wiki/MS-DOS "wikilink")에서 실행되었다.
...
MMI의 20핀 PAL 소자 성공 이후에 는 추가적 기능이 있는 24핀 22V10 PAL을 발표하였다. AMD로부터 분리된 MMI(약 1987년)가 매각된 후 밴티스처럼 병합되었고 사업은 1999년에 [래티스 세미컨덕터에게](https://ko.wikipedia.org/wiki/래티스_세미컨덕터 "wikilink") 인수되었다.
...
큰 규모 프로그래머블 논리 소자는 [아트멜](https://ko.wikipedia.org/wiki/아트멜 "wikilink"), [래티스 세미컨덕터](https://ko.wikipedia.org/wiki/래티스_세미컨덕터 "wikilink") 등에 의해서 발표되었다. 이런 소자들은 논리 평판내부에 논리 매크로셀을 내장한 다중의 논리 평판 논리곱/논리합 소자를 포함하여 PAL 구조를 확장되었다. "[복합 프로그래머블 논리 소자](../Page/복합_프로그래머블_논리_소자.md "wikilink")" ([CPLD](https://ko.wikipedia.org/wiki/CPLD "wikilink"))라는 용어는 구식의 PAL과 GAL로부터 분화되어 발표되었으며, 어떤 경우에는 "단순 프로그래머블 논리 소자" (SPLD)로 통하였다.

큰 CPLD의 종류는 종종 "[현장 프로그래머블 게이트 어레이](https://ko.wikipedia.org/wiki/현장_프로그래머블_게이트_어레이 "wikilink")" ([FPGA](../Page/FPGA.md "wikilink"))를 뜻하였다. 이 용어는 [알테라](https://ko.wikipedia.org/wiki/알테라 "wikilink")와 [자이링스](https://ko.wikipedia.org/wiki/자이링스 "wikilink")가 현재 제조되는 소자를 기술하는 데 자주 사용하였다.
...
프로그래머블 논리 소자의 현재와 이전 제조사:
  ...
  - [AMD](https://ko.wikipedia.org/wiki/어드밴스트_마이크로_디바이시스 "wikilink") (PAL, PALCE)
  - [알테라](https://ko.wikipedia.org/wiki/알테라 "wikilink") (Cyclone, Max)
  - [아트멜](https://ko.wikipedia.org/wiki/아트멜 "wikilink")
  - [인텔](https://ko.wikipedia.org/wiki/인텔 "wikilink")
  - [래티스 세미컨덕터](https://ko.wikipedia.org/wiki/래티스_세미컨덕터 "wikilink") (GAL)
  - [내셔널 세미컨덕터](https://ko.wikipedia.org/wiki/내셔널_세미컨덕터 "wikilink") (GAL)
  - [시그네틱스](https://ko.wikipedia.org/wiki/시그네틱스 "wikilink") (FPLA)
  - [텍사스 인스트루먼트](https://ko.wikipedia.org/wiki/텍사스_인스트루먼트 "wikilink")
  - [자일링스](https://ko.wikipedia.org/wiki/자일링스 "wikilink")
