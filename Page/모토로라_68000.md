> This article is converted from Wikipedia: [ 68000](https://ko.wikipedia.org/wiki/_68000).


**모토로라 68000**(**MC68000**)은 [모토로라](https://ko.wikipedia.org/wiki/모토로라 "wikilink")(현재 [반도체](https://ko.wikipedia.org/wiki/반도체 "wikilink") 사업 부분은 [프리스케일 세미컨덕터로](../Page/프리스케일_세미컨덕터.md "wikilink") 독립)가 개발한 16/32비트\[1\] [CISC](https://ko.wikipedia.org/wiki/CISC "wikilink") [마이크로프로세서](https://ko.wikipedia.org/wiki/마이크로프로세서 "wikilink")로 [1979년](https://ko.wikipedia.org/wiki/1979년 "wikilink") HMOS 공정을 사용한 첫 제품이 출시된 이후 여러 방면에서 널리 사용되었다.

## 역사

68000은 1976년 MACSS(Motorola Advanced Computer System on Silicon) 프로젝터에서 시작되어 고성능을 위해 기존의 [6800과의](https://ko.wikipedia.org/wiki/모토로라_6800 "wikilink") 호환성을 고려하지 않고 완전히 새로운 [아키텍처](https://ko.wikipedia.org/wiki/아키텍처 "wikilink")로 개발되었다. 그 결과 6800의 주변 장치들을 사용하기 위한 버스 프로토콜 호환 모드만이 남게 되었다. 설계자들은 앞으로의 32비트 명령어 아키텍처에 중점을 두었는데 [CPU](https://ko.wikipedia.org/wiki/중앙_처리_장치 "wikilink") [레지스터](https://ko.wikipedia.org/wiki/레지스터 "wikilink")가 32비트로 구성되어있는 것이 그 증거이다. MACSS 팀은 [PDP-11](../Page/PDP-11.md "wikilink")과 [VAX 시스템같은](https://ko.wikipedia.org/wiki/VAX_시스템 "wikilink") [미니컴퓨터](https://ko.wikipedia.org/wiki/미니컴퓨터 "wikilink") 프로세서의 설계에 영향을 받아 비슷한 구조로 설계하게 되었다.

1960년대 중반 8비트 프로세서 제조사들은 16비트 제품을 개발하느라 경쟁하고 있었다. [내셔널 세미컨덕터는](../Page/내셔널_세미컨덕터.md "wikilink") 1973-1975년 [IMP-16](https://ko.wikipedia.org/wiki/IMP-16 "wikilink")과 [PACE](https://ko.wikipedia.org/wiki/PACE "wikilink") 프로세서를 개발하였지만 성능에 문제가 있었는데 1977년 [인텔 8086이](https://ko.wikipedia.org/wiki/인텔_8086 "wikilink") 출시되어 인기를 얻었다. 경쟁자들이 엎치락뒤치락하는 동안 16비트 전쟁에 늦게 뛰어든 모토로라는 만회할 무기로 더 많은 [트랜지스터](https://ko.wikipedia.org/wiki/트랜지스터 "wikilink") 집적과 32비트 매크로 명령어를 도입해 갈채를 받았다.

오리지널 MC68000는 HMOS 3.5[µm](https://ko.wikipedia.org/wiki/마이크로미터 "wikilink") 공정으로 제조되었는데 초기 엔지니어링 샘플은 1979말 출시되었으며 1980년 양산되기 시작하여 초기 제품의 속도는 4, 6, 8MHz였다. 1981년 10 MHz, 1982년 12.5 MHz 제품이 출시되었으며 오리지널 HMOS 칩 중 가장 빠른 16.67 MHz "12F" 버전은 1980년대 말까지 출시되지 못했다.

68000은 고성능 설계로 말미암아 [썬 워크스테이션과](https://ko.wikipedia.org/wiki/썬_워크스테이션 "wikilink") [아폴로/도메인 워크스테이션을](https://ko.wikipedia.org/wiki/아폴로/도메인_워크스테이션 "wikilink") 포함한 [유닉스 계열](../Page/유닉스_계열.md "wikilink") [워크스테이션](https://ko.wikipedia.org/wiki/워크스테이션 "wikilink")의 주요 CPU로 사용되었다. 또한 [아미가](https://ko.wikipedia.org/wiki/아미가 "wikilink")나 [아타리 ST](../Page/아타리_ST.md "wikilink"), [애플 리사](../Page/애플_리사.md "wikilink")(Lisa)와 [매킨토시](https://ko.wikipedia.org/wiki/매킨토시 "wikilink")같은 초창기 컴퓨터에서도 찾아볼 수 있으며 애플 레이저라이터(LaserWriter) [데스크톱](../Page/데스크톱_컴퓨터.md "wikilink") [레이저 프린터에도](../Page/레이저_프린터.md "wikilink") 사용되었다.

1982년에는 [가상 메모리](https://ko.wikipedia.org/wiki/가상_메모리 "wikilink") 지원을 포함해 Popek과 Goldberg 가상화를 추가한 68010을 출시하였으며 32비트 어드레스 버스를 가진 더 확장된 버전의 68012도 출시하였다. 또한 저가형으로 8비트 데이터 버스와 20비트 어드레스 버스를 가진 68008도 출시하였다. 1982년이후 모토로라는 68020과 88000 개발에 힘을 기울였다.

### 세컨드 소스

[히타치](https://ko.wikipedia.org/wiki/히타치_제작소 "wikilink") (HD68000), [모스텍](https://ko.wikipedia.org/wiki/모스텍 "wikilink") (MK68000), [락웰](https://ko.wikipedia.org/wiki/락웰 "wikilink") (R68000), [시그네틱스](https://ko.wikipedia.org/wiki/시그네틱스 "wikilink") (SCN68000), 톰슨/[SGS-톰슨](../Page/ST마이크로일렉트로닉스.md "wikilink") (EF68000 나중에 TS68000로 변경), [도시바](../Page/도시바.md "wikilink") (TMP68000) 같은 다른 회사들도 세컨드 소스로 HMOS 68000을 제조하였다. 도시바는 CMOS 68HC000 (TMP68HC000)의 세컨드 소스 제조사이기도 하다.

### CMOS 버전

68HC000은 68000의 CMOS 버전으로 히다치가 설계하여 1985년 공동으로 출시하였는데\[2\] 모토로라 버전은 MC68HC000, 히다치는 HD68HC000로 표기했다. 68HC000은 8 \~ 20 MHz 속도로 출시되었으며 CMOS 회로를 사용했음에도 HMOS MC68000과 동일했지만 소모 전력은 크게 줄어들었다. 오리지널 HMOS MC68000은 25 °C의 온도에서 사용시 클럭 속도에 상관없이 1.35[와트](https://ko.wikipedia.org/wiki/와트 "wikilink")의 전력을 소비하는 반면 MC68HC000는 8 MHz 제품은 0.13와트, 20 MHz 제품은 0.38와트의 전력만을 소비한다. (CMOS 회로와 다르게 HMOS는 아이들시에도 전류가 흐르기 때문에 클럭 속도에 따라 전력 소모의 차이가 적다.)
...
[1980년대](https://ko.wikipedia.org/wiki/1980년대 "wikilink") 중반에는 [개인용 컴퓨터와](https://ko.wikipedia.org/wiki/개인용_컴퓨터 "wikilink") [가정용 컴퓨터에](../Page/가정용_컴퓨터.md "wikilink") 사용되었는데 [애플의](https://ko.wikipedia.org/wiki/애플_\(기업\) "wikilink") [리사](../Page/애플_리사.md "wikilink")(Lisa)와 [매킨토시](https://ko.wikipedia.org/wiki/매킨토시 "wikilink")를 시작으로 [코모도어](https://ko.wikipedia.org/wiki/코모도어 "wikilink") [아미가](https://ko.wikipedia.org/wiki/아미가 "wikilink"), [아타리 ST](../Page/아타리_ST.md "wikilink"), [샤프 X68000](https://ko.wikipedia.org/wiki/샤프_X68000 "wikilink") 등에 사용되었다. 68008을 사용한 컴퓨터로는 Sinclair QL과 그 자매품인 ICL One Per Desk이 있다.

68000은 컨트롤러로도 널리 사용되었는데 1981년초 Imagen Imprint-10 레이저 프린터는 68000이 내장된 외부 컨트롤러로 작동되었다. 최초의 [HP 레이저젯](https://ko.wikipedia.org/wiki/HP_레이저젯 "wikilink")(LaserJet)은 1984년 출시되었는데 8 MHz 68000이 내장된 컨트롤러를 사용하였다. 이와 유사한 68000 기반의 통합 컨트롤러는 1985년 출시된 최초의 [포스트스크립트](https://ko.wikipedia.org/wiki/포스트스크립트 "wikilink") 레이저 프린터인 [애플 레이저라이터](https://ko.wikipedia.org/wiki/애플_레이저라이터 "wikilink")(LaserWriter)를 비롯해 많은 레이저 프린터에서 사용되었다. 68000은 1980년대 말까지 레이저 프린터에 폭넓게 사용되었고 1990년대에도 저가형 프린터에는 계속 사용되었다.
...
68000은 1980년대 말 \~ 1990년대 초반의 가정용 게임 콘솔에 핵심 프로세서로 사용되었는데 세가의 [메가 드라이브와](https://ko.wikipedia.org/wiki/메가_드라이브 "wikilink") [메가 CD](https://ko.wikipedia.org/wiki/메가_CD "wikilink"), 가정용 게임기 버전의 [네오지오](https://ko.wikipedia.org/wiki/네오_지오_\(콘솔\) "wikilink") 등이 있다. 최근의 게임 콘솔에서는 메인 CPU 외에 다른 용도로 사용되는 경우가 있는데 [세가 새턴에서는](https://ko.wikipedia.org/wiki/세가_새턴 "wikilink") 사운드 제어용으로, [아타리 재규어에서는](https://ko.wikipedia.org/wiki/아타리_재규어 "wikilink") 그래픽과 사운드 칩 제어용으로 사용된다.

68000 기반의 683XX 마이크로컨트롤러는 네트워크/전화 설비, 텔레비전 셋탑 박스, 실험실과 의료 기기 등 다용도로 널리 사용되었다. MC68302는 Cisco, 3com, Ascend, Marconi, Cyclades등의 통신 기기에서 사용되었으며 드래곤볼 시리즈는 [팜 컴퓨팅의](https://ko.wikipedia.org/wiki/팜_컴퓨팅 "wikilink") [팜(Palm)](https://ko.wikipedia.org/wiki/팜_파일럿 "wikilink") [PDA](https://ko.wikipedia.org/wiki/PDA "wikilink")와 [핸드스프링 바이저](https://ko.wikipedia.org/wiki/핸드스프링_바이저 "wikilink") 시리즈에서 사용되었으나 팜은 점차 [ARM](https://ko.wikipedia.org/wiki/ARM_아키텍처 "wikilink") 프로세서로 바뀌게 된다. 휴대형 [워드프로세서](https://ko.wikipedia.org/wiki/워드프로세서 "wikilink")인 [알파스마트](https://ko.wikipedia.org/wiki/알파스마트 "wikilink")(AlphaSmart)의 후기 모델도 드래곤볼을 사용했다.
...
설계자들은 [어셈블리어](https://ko.wikipedia.org/wiki/어셈블리어 "wikilink")가 직교성(orthogonal)을 가지도록 시도하였다. 명령어는 오퍼랜드과 어드레스 모드로 구별되며 대부분의 어드레스 모드는 모든 명령어를 사용할 수 있다. 비트 레벨에서 어셈블러로 작성된 명령어가 어떤 오프코드(op-code)로 변환되는지 명확히 알 수 있는데 이것은 직교성 있는 머신으로의 편의성과 CPU 설계자들이 오프코드 표를 자유롭게 작성하는데 좋은 타협점이 되었다.

56개의 명령어만이 최소 크기의 명령어로 당시에는 거대한 16비트 크기였다. 더군다나 많은 명령어와 어드레스 모드에는 어드레스와 어드레스 모드 비트등을 담은 여분의 워드(word)를 추가로 사용한다. 많은 설계자들은 MC68000 아키텍처가 비용에 걸맞은 컴팩트한 코드를 생성한다고 믿고 있었는데(특히 [컴파일러](https://ko.wikipedia.org/wiki/컴파일러 "wikilink")로 코드를 생성할 경우) 이 컴팩트한 코드에 대한 믿음은 아키텍처가 널리 오랫동안 사용하게 되는데 도움이 되었다. 이러한 믿음 혹은 특징은 ARM 아키텍처의 썸(Thumb) 명령어 셋이 발표될 때까지 계속 이어졌다.
...
<!-- end list -->
  ...
  - [멀티프로세서](https://ko.wikipedia.org/wiki/멀티프로세서 "wikilink") 제어: TAS([test-and-set](../Page/검사와_지정.md "wikilink")), 하나의 메모리를 공유하는 다수의 프로세서를 일치시키는 [세마포어](https://ko.wikipedia.org/wiki/세마포어 "wikilink")(semaphore)를 실행하는 분할할 수 없는(indivisible) 버스 연산
...
68EC000는 오디오 기기의 컨트롤러로 널리 사용되었는데 [엔소닉](../Page/엔소닉.md "wikilink")(Ensoniq) 전자 악기와 [사운드카드](https://ko.wikipedia.org/wiki/사운드카드 "wikilink")에 [미디](https://ko.wikipedia.org/wiki/미디 "wikilink") [신시사이저](../Page/신시사이저.md "wikilink")의 한 부분으로 사용되었다.\[8\] 엔소닉 사운드 카드는 CPU를 사용하지 않은 경쟁자들의 제품과 비교해 몇가지 장점이 있었다. CPU는 사용한 카드는 [TRS 프로그램을](https://ko.wikipedia.org/wiki/종료_후_상주_프로그램 "wikilink") 사용하지 않고도 [MPU-401](../Page/MPU-401.md "wikilink") 미디 신서사이즈나 [MT-32](https://ko.wikipedia.org/wiki/MT-32 "wikilink") 에뮬레이션 같은 여러 가지 오디오 작업을 구성, 실행할 수 있었다. 이것은 소프트웨어 호환성이 높고 CPU 사용률이 적으며 컴퓨터의 메모리 사용량도 무시할 수 있었다.

모토로라 68EC000 코어는 모토로라/프리스케일에서 출시한 [드래곤볼에](https://ko.wikipedia.org/wiki/모토로라_드래곤볼 "wikilink") 사용되었다.

세가 새턴 게임 콘솔과 90년대 중반 휴렛 팩커드의 레이저젯 프린터용 [젯다이렉트](https://ko.wikipedia.org/wiki/HP_젯다이렉트 "wikilink")(JetDirect) [이더넷](https://ko.wikipedia.org/wiki/이더넷 "wikilink") 컨트롤러에도 사용되었다.
...
## 외부 링크
  ...
  - [CAST, Inc. (68000 IP provider)](http://www.cast-inc.com/cores/c68000/index.shtml)
