...
\== 𝒩=1 초등각 대수 == 2차원 \(\mathcal N=1\) 초등각 대수의 생성원은 다음과 같다.
  ...
  - \(L_n\). 이는 \(h=2\) [비라소로 대수](../Page/비라소로_대수.md "wikilink") 준1차장인 **[에너지-운동량 텐서](https://ko.wikipedia.org/wiki/에너지-운동량_텐서 "wikilink")** \(T(z)\)의 모드 전개이며, \(n\in\mathbb Z\)이다.
...
[비라소로 대수의](../Page/비라소로_대수.md "wikilink") 경우와 마찬가지로, \(\mathcal N=1\) 초등각 대수의 기약 표현은 **초1차장**(超一次場, ) 위에 [사다리 연산자들의](https://ko.wikipedia.org/wiki/사다리_연산자 "wikilink") 작용으로 구성된다.\[1\]\[2\] 초1차장은 다음을 만족시키는 상태이다.
