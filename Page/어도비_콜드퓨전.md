...
콜드퓨전 MX 7 엔터프라이즈 에디션부터는 게이트웨이 인터페이스를 통해 [SMS나](https://ko.wikipedia.org/wiki/단문_메시지_서비스 "wikilink") [인스턴트 메신저와](https://ko.wikipedia.org/wiki/인스턴트_메신저 "wikilink") 같은 비동기 이벤트처리가 다룰 수 있는 기능이 추가되었다.

콜드퓨전은 주로 [웹사이트](https://ko.wikipedia.org/wiki/웹사이트 "wikilink")나 [인트라넷](https://ko.wikipedia.org/wiki/인트라넷 "wikilink")에서 데이터처리를 위해 사용되며 [SOAP](../Page/SOAP.md "wikilink")이나 [웹 서비스](https://ko.wikipedia.org/wiki/웹_서비스 "wikilink"), [플래시](../Page/어도비_플래시.md "wikilink") 리모팅과 같은 원격 서비스를 생성하기 위해 사용되기도 한다. 특히 클라이언트에서 사용하는 [플렉스기술과](https://ko.wikipedia.org/wiki/어도비_플렉스 "wikilink") 잘 어울리는 서버 쪽 기술이다.
...
다음과 같은 기능을 제공한다.
  ...
  - [HTML](https://ko.wikipedia.org/wiki/HTML "wikilink")을 [PDF](https://ko.wikipedia.org/wiki/PDF "wikilink")나 FlashPaper로 쉽게 변환
  - [액티브 디렉터리나](../Page/액티브_디렉터리.md "wikilink") [LDAP](../Page/LDAP.md "wikilink"), [SMTP](https://ko.wikipedia.org/wiki/SMTP "wikilink"), [POP](https://ko.wikipedia.org/wiki/POP3 "wikilink"), [HTTP](https://ko.wikipedia.org/wiki/HTTP "wikilink"), [FTP](https://ko.wikipedia.org/wiki/파일_전송_프로토콜 "wikilink"), [마이크로소프트 익스체인지 서버와](../Page/마이크로소프트_익스체인지_서버.md "wikilink") 같은 기업용 시스템 데이터나 [RSS](https://ko.wikipedia.org/wiki/RSS "wikilink")나 [Atom과](https://ko.wikipedia.org/wiki/애텀 "wikilink") 같은 일반적인 데이터 형식을 다룬다.
  - 베리티(Verity)의 검색엔진 K2를 기반으로 파일 [인덱스처리나](../Page/인덱스_\(데이터베이스\).md "wikilink") 검색 서비스 제공
  - [GUI](https://ko.wikipedia.org/wiki/그래픽_사용자_인터페이스 "wikilink") 관리자 화면
  - Server, application, client, session, request에 대한 변수의 유효범위를 가진다.
  - [XML](https://ko.wikipedia.org/wiki/XML "wikilink") 해석, [질의(XPath,XML Path Language)](../Page/XPath.md "wikilink"), 데이터 검증, [변환(XSLT,Extensible Stylesheet Language Transformations)](../Page/XSLT.md "wikilink")
  ...
  - 간단한 [웹 서비스](https://ko.wikipedia.org/wiki/웹_서비스 "wikilink") 구현(서비스를 생성하고 처리하기 위해 [WSDL](../Page/WSDL.md "wikilink") 생성과 [SOAP](../Page/SOAP.md "wikilink") 변환이 자동으로 지원된다.)
      -
...
콜드퓨전의 특징적인 기능 중 하나가 스크립트 언어인 CFML(ColdFusion Markup Language)이다. CFML은 [ASP나](../Page/액티브_서버_페이지.md "wikilink") [JSP](https://ko.wikipedia.org/wiki/자바_서버_페이지 "wikilink"),[PHP](https://ko.wikipedia.org/wiki/PHP "wikilink")와 기능적으로 비교되곤 하는데, 문법적인 측면에서는 [HTML](https://ko.wikipedia.org/wiki/HTML "wikilink")에 가까운 언어이다. "콜드퓨전"은 "CFML"을 같은 의미로 인식되곤 하지만 콜드퓨전 외에도 [추가적인 CFML 애플리케이션 서버가](https://ko.wikipedia.org/wiki/#대체할_수_있는_서버_환경 "wikilink") 제공되고 있다. CFML의 다른 기능은 [닷넷 프레임워크](../Page/닷넷_프레임워크.md "wikilink") 환경이나 이미지 처리에서 유사하거나 좀 더 강력하게 동작한다.
...
콜드퓨전은 CFML뿐 아니라 [액션스크립트](https://ko.wikipedia.org/wiki/액션스크립트 "wikilink")나 [자바스크립트](https://ko.wikipedia.org/wiki/자바스크립트 "wikilink")처럼 사용할 수 있는 내장된 스크립트 언어인 CFScript도 사용할 수 있다.
...
버전 3.1에서는 [솔라리스](https://ko.wikipedia.org/wiki/솔라리스_\(운영_체제\) "wikilink") 운영체제도 지원되기 시작했다. 콜드 퓨전 스튜디오는 화면미리보기 기능과 HTML문법검사기능이 추가되었다.
...
2000년 이전부터 앨라이어는 코드네임 "Neo"를 시작했다. 이 프로젝트는 콜드퓨전 서버를 [자바](https://ko.wikipedia.org/wiki/자바_\(프로그래밍_언어\) "wikilink") 기반으로 다시 작성하는 것이었다. 자바 런타임 환경에서 동작하기 때문에 이식성과 서버상 보안을 강화할 수 있었다. 지금은 어도비 라이브사이클 개발팀에 있고 당시 소프트웨어 개발책임자였던 Damon Cooper(http://www.dcooper.org)가 프로젝트 초기 책임을 맡았다.
...
콜드퓨전 MX의 출시와 함께 CFML도 [객체 지향 프로그래밍](https://ko.wikipedia.org/wiki/객체_지향_프로그래밍 "wikilink") 기반으로 변모하게 되었다.

### 콜드퓨전 MX 7

2005년 2월 7일 콜드퓨전 7.0이 출시되면서 제품명을 "매크로미디어 콜드퓨전 MX 7"으로 바꾸었다. CFMX 7에는 플래시 기반과 XForm 기반, 웹폼과 리포트 빌더가 추가되어 [PDF](https://ko.wikipedia.org/wiki/PDF "wikilink")뿐 아니라 FlashPaper, RTF, [Excel로](https://ko.wikipedia.org/wiki/마이크로소프트_엑셀 "wikilink") 변환을 지원하였다. 어도비 PDF 출력기능을 바탕으로 어떤 HTML 페이지라도 프린트에 적합하게 변환하는 기능을 제공하게 되었다. 엔터프라이즈 에디션에는 [게이트웨이](../Page/게이트웨이.md "wikilink")가 추가되어 IM, SMS, 파일변경검사(Directory Watcher), 비동기 실행 등 HTTP 요청 외의 서비스에 대해 인터랙션이 가능하게 되었다. XML에 대한 지원을 바탕으로 네이티브 스키마 검사 기능을 포함할 수 있게 되었다.
...
추가된 기능으로 [어도비 어크로뱃](https://ko.wikipedia.org/wiki/어도비_어크로뱃 "wikilink") 폼과 통합된 기능을 제공하는 CFPDFFORM 태그를 비롯해 이미지를 조작하는 기능과 [닷넷 프레임워크와](../Page/닷넷_프레임워크.md "wikilink") 통합된 기능, 이전에 매크로미디어 브리즈로 알려졌던 웹 기반 협업 솔루션인 Adobe Acrobat Connect를 이용해 동적인 프레젠테이션을 만들어낼 수 있는 CFPRESENTATION 태그가 추가되었다. 그리고 엔터프라이즈 에디션 버전에서는 서버 모니터링 기능이 내장된 콜드퓨전 관리자가 추가되었다. 콜드퓨전 8은 [리눅스](https://ko.wikipedia.org/wiki/리눅스 "wikilink"), [OS X](https://ko.wikipedia.org/wiki/OS_X "wikilink"), [윈도 서버 2003등](https://ko.wikipedia.org/wiki/윈도_서버_2003 "wikilink") 다양한 [운영 체제에서](https://ko.wikipedia.org/wiki/운영_체제 "wikilink") 사용할 수 있었다.

콜드퓨전 8에 추가된 다른 기능으로는 [Ajax](https://ko.wikipedia.org/wiki/Ajax "wikilink") 위젯, 파일 압축 조작(CFZIP), [마이크로소프트 익스체인지](https://ko.wikipedia.org/wiki/마이크로소프트_익스체인지 "wikilink") 서버 통합기능(CFEXCHANGE), [자동가입방지(CAPTCHA)](../Page/CAPTCHA.md "wikilink") 생성기능을 포함한 이미지 조작(CFIMAGE), 멀티 쓰레딩, 개별 애플리케이션 설정, [Atom이나](https://ko.wikipedia.org/wiki/애텀 "wikilink") [RSS](https://ko.wikipedia.org/wiki/RSS "wikilink") 피드에 대한 지원, 리포팅 기능 강화, 강력한 암호화 라이브러리, 배열 및 구조 향상, 향상된 데이터베이스 인터랙션, 성능 향상, PDF 조작 및 병합 기능(CFPDF), 디버깅, [아파치 더비와](https://ko.wikipedia.org/wiki/아파치_더비 "wikilink") 같은 내장 데이터베이스 지원, [ECMA스크립트](https://ko.wikipedia.org/wiki/ECMA스크립트 "wikilink")에 좀 더 충실해진 CFSCRIPT와 같은 것들이 포함되었다.
