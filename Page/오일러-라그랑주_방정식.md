...
**오일러-라그랑주 방정식**(Euler-Lagrange方程式, )은, 어떤 [함수](https://ko.wikipedia.org/wiki/함수 "wikilink")와 그 [도함수](https://ko.wikipedia.org/wiki/도함수 "wikilink")에 의존하는 [범함수](https://ko.wikipedia.org/wiki/범함수 "wikilink")의 극대화 및 정류화 문제를 다루는 [미분 방정식이다](https://ko.wikipedia.org/wiki/미분_방정식 "wikilink"). [변분법](../Page/변분법.md "wikilink")의 기본 정리의 하나이자, [라그랑주 역학에서](../Page/라그랑주_역학.md "wikilink") 근본적인 역할을 한다.

직관적으로, 오일러-라그랑주 방정식은 범함수의 정류점 근처에는 아주 약간 곡선의 모양을 바꾸면 범함수의 값이 바뀌지 않는다는 점을 이용한다. 이는 초급 [미적분학](https://ko.wikipedia.org/wiki/미적분학 "wikilink")에서 미분가능한 함수가 최대, 최소점에서 기울기가 0이라는 정리를 확장한 것이다.
...
[레온하르트 오일러와](https://ko.wikipedia.org/wiki/레온하르트_오일러 "wikilink") [조제프루이 라그랑주가](https://ko.wikipedia.org/wiki/조제프루이_라그랑주 "wikilink") [1750년](https://ko.wikipedia.org/wiki/1750년 "wikilink")에 도입하였다.
...
## 같이 보기
  ...
  - [슈윙거-다이슨 방정식](../Page/슈윙거-다이슨_방정식.md "wikilink") (오일러-라그랑주 방정식의 [양자역학](https://ko.wikipedia.org/wiki/양자역학 "wikilink")적 보정)
