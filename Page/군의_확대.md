...
[군론](https://ko.wikipedia.org/wiki/군론 "wikilink")에서, **군의 확대**(群-擴大, )는 [군을](https://ko.wikipedia.org/wiki/군_\(수학\) "wikilink") [정규 부분군과](https://ko.wikipedia.org/wiki/정규_부분군 "wikilink") [몫군](https://ko.wikipedia.org/wiki/몫군 "wikilink")으로 나타내는 방법이다.
...
\(N\)과 \(Q\)가 아벨 군이며, 확대된 군 \(G\) 역시 아벨 군이라고 하자. 이러한 군의 확대는 [Ext 함자에](../Page/Ext_함자.md "wikilink") 의하여 분류된다. 구체적으로, 이러한 [아벨 군의](https://ko.wikipedia.org/wiki/아벨_군 "wikilink") 범주 속에서의 확대들의 동형류들은
...
특히, \(Q\)의 [아벨 군](https://ko.wikipedia.org/wiki/아벨_군 "wikilink") \(N\)에 대한 중심 확대는 자명한 작용 \(q\cdot n=n\;\forall q\in Q,n\in N\)에 대응하며, 중심 확대는 자명한 [\(Q\)-가군](https://ko.wikipedia.org/wiki/군의_가군 "wikilink") 계수의 2차 [군 코호몰로지](../Page/군_코호몰로지.md "wikilink") \(\operatorname H^2(Q,N)\)와 표준적으로 [일대일 대응한다](https://ko.wikipedia.org/wiki/일대일_대응 "wikilink").
...
\end{matrix}\] 에서, \(\phi^*\colon G\to\operatorname{Aut}N\)이 \(\phi\colon Q\to\operatorname{Out}N\)으로부터 완전히 결정되기 때문이다. 특히, \(N\)이 자명한 중심을 갖고, 또한 [외부자기동형군](../Page/외부자기동형군.md "wikilink") 역시 자명하다면, \(N\)의 모든 확대는 [직접곱](https://ko.wikipedia.org/wiki/직접곱 "wikilink")이다. 이러한 조건을 만족시키는 군을 **완비군**(完備群, )이라고 한다.

### 외부 자기 동형을 갖지 않는 정칙 부분군의 경우

만약 \(\operatorname{Out}N\)이 [자명군](https://ko.wikipedia.org/wiki/자명군 "wikilink")이라면, 준동형 \(Q\to\operatorname{Out}N\)은 자명한 준동형밖에 없다. 이 경우, 모든 확대들은 2차 군 코호몰로지 \(\operatorname H^2(Q,\operatorname Z(N))\)와 표준적으로 일대일 대응하며, \(0\in\operatorname H^2(Q,\operatorname Z(N))\)은 [직접곱](https://ko.wikipedia.org/wiki/직접곱 "wikilink") \(N\times Q\)에 대응한다.
...
\[Q\to\operatorname{Out}N=\operatorname{Aut}N/\operatorname{Inn}N\] 이 존재한다. 임의의 준동형 \(\phi\colon Q\to\operatorname{Out}N\)에 대하여, 다음 두 조건이 서로 [동치](https://ko.wikipedia.org/wiki/동치 "wikilink")이다.\[2\]
...
구체적으로, 이 걸림돌 \(\theta(Q,\operatorname Z(N),\phi)\)는 다음과 같다.\[4\] [완전열](https://ko.wikipedia.org/wiki/완전열 "wikilink")
...
## 같이 보기
  ...
  - [체의 확대](https://ko.wikipedia.org/wiki/체의_확대 "wikilink")
