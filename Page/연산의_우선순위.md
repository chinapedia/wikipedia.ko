...
[수학](https://ko.wikipedia.org/wiki/수학 "wikilink") 및 [컴퓨터 프로그래밍에서](https://ko.wikipedia.org/wiki/컴퓨터_프로그래밍 "wikilink") **연산의 우선순위**는 모호하게 해석가능한 수식에서 어느 연산을 먼저 계산할 것인가를 결정하는 규칙이다.
...
프로그래밍 언어는 각 언어마다 규율이 있다. 일반적인 [C 언어의](https://ko.wikipedia.org/wiki/C_\(프로그래밍_언어\) "wikilink") 경우 다음과 같은 우선순위를 따른다.
