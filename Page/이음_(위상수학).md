...
두 위상 공간 \(X\), \(Y\)의 **이음**은 다음과 같은 [곱공간](https://ko.wikipedia.org/wiki/곱공간 "wikilink")의 [몫공간](https://ko.wikipedia.org/wiki/몫공간 "wikilink")이다.
...
\[X * Y = \frac{X \star Y}{X \star\{\bullet_Y\} \cup \{\bullet_X\} \star Y}\] 이는 사실 [분쇄곱](../Page/분쇄곱.md "wikilink") \(X \wedge Y\)의 [축소 현수와](https://ko.wikipedia.org/wiki/축소_현수 "wikilink") [위상 동형이다](https://ko.wikipedia.org/wiki/위상_동형 "wikilink"). 이음과 축소 이음은 서로 [호모토피 동치이다](https://ko.wikipedia.org/wiki/호모토피_동치 "wikilink").

## 예

[초구](https://ko.wikipedia.org/wiki/초구 "wikilink")의 이음은 다음과 같이 [초구](https://ko.wikipedia.org/wiki/초구 "wikilink")이다.
