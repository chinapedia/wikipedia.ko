...
우선, \(f'/f\)는 \(\operatorname{im}\gamma\)에서 영점이나 극점을 갖지 않으므로, \(\gamma\) 위의 경로 적분이 존재한다. 임의의 \(\operatorname{im}\gamma\) 내부의 점 \(z_0\)에 대하여, 다음과 같은 [유리형 함수](https://ko.wikipedia.org/wiki/유리형_함수 "wikilink") \(g\colon D\to\widehat{\mathbb C}\)를 정의하자.

\[g(z)=\frac{f(z)}{(z-z_0)^{N(f;z_0)}}\qquad\forall z\in D\] 그렇다면, \(N(f;z_0)\)의 정의에 의하여, \(g\)는 어떤 열린 근방 \(D\supseteq N\ni z_0\)에서 영점이나 극점을 갖지 않는다. 따라서 \(g'/g\)는 \(N\)에서 극점을 갖지 않는다. 이제 \(0<r<d(z_0,\partial N)\)을 취하자. 그렇다면 [코시 적분 정리에](https://ko.wikipedia.org/wiki/코시_적분_정리 "wikilink") 의하여
...
\[f(z)=z-z_0\qquad\forall z\in D\] 를 취하면 [코시 적분 공식을](https://ko.wikipedia.org/wiki/코시_적분_공식 "wikilink") 얻는다. 이 정리는 [아벨-플라나 공식을](https://ko.wikipedia.org/wiki/아벨-플라나_공식 "wikilink") 증명하는 데 쓰인다.
...
## 같이 보기
  ...
  - [루셰 정리](https://ko.wikipedia.org/wiki/루셰_정리 "wikilink")
