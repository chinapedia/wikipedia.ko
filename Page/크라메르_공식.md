...
[선형대수학](https://ko.wikipedia.org/wiki/선형대수학 "wikilink")에서, **크라메르 공식**(Cramer公式, ) 또는 **크래머 공식**은 유일한 해를 가지며 변수와 방정식의 수가 같은 [연립 일차 방정식의](../Page/연립_일차_방정식.md "wikilink") 해를 구하는 공식이다. [계수 행렬과](https://ko.wikipedia.org/wiki/계수_행렬 "wikilink") 그 한 열을 상수항으로 대신하여 얻는 행렬들의 [행렬식](https://ko.wikipedia.org/wiki/행렬식 "wikilink")의 비를 통해 해를 나타낸다. 둘 또는 셋 이상의 방정식으로 이루어진 연립 일차 방정식의 경우, 크라메르 공식에 의한 알고리즘은 [가우스 소거법에](https://ko.wikipedia.org/wiki/가우스_소거법 "wikilink") 의한 알고리즘보다 훨씬 비효율적이다.

## 정의

[연립 일차 방정식](../Page/연립_일차_방정식.md "wikilink")

\[Ax=B\] 에서, \(A\)가 [정사각 행렬이며](https://ko.wikipedia.org/wiki/정사각_행렬 "wikilink"), [행렬식](https://ko.wikipedia.org/wiki/행렬식 "wikilink")이 0이 아니라고 하자. 그렇다면, 그 유일한 해는 다음과 같이 나타낼 수 있으며, 이를 **크라메르 공식**이라고 한다.
...
크라메르 공식은 [미분기하학](https://ko.wikipedia.org/wiki/미분기하학 "wikilink")에서 매우 유용하다. 두 개의 방정식 \(F(x, y, u, v) = 0\,\), \(G(x, y, u, v) = 0\,\)이라 가정한다. 여기서, u와 v는 독립 변수이고, \(x = X(u, v)\), \(y = Y(u, v)\)라 정의한다.
...
[스위스](https://ko.wikipedia.org/wiki/스위스 "wikilink") [수학자](https://ko.wikipedia.org/wiki/수학자 "wikilink") [가브리엘 크라메르](../Page/가브리엘_크라메르.md "wikilink")(Gabriel Cramer, [1704년](https://ko.wikipedia.org/wiki/1704년 "wikilink") - [1752년](https://ko.wikipedia.org/wiki/1752년 "wikilink"))에게서 유래한다.
