...
[복소해석학](https://ko.wikipedia.org/wiki/복소해석학 "wikilink")에서, **코시 부등식**(-不等式, ) 또는 **코시 추정**(-推定, )은 [정칙 함수의](../Page/정칙_함수.md "wikilink") [테일러 급수](https://ko.wikipedia.org/wiki/테일러_급수 "wikilink") 계수의 상계를 제시하는 부등식이다.
...
코시 부등식은 [코시 적분 공식으로부터](https://ko.wikipedia.org/wiki/코시_적분_공식 "wikilink") 다음과 같이 간단히 유도된다.
...
[리우빌 정리에](https://ko.wikipedia.org/wiki/리우빌_정리_\(복소해석학\) "wikilink") 따르면, 모든 [유계](../Page/유계_함수.md "wikilink") [전해석 함수는](https://ko.wikipedia.org/wiki/전해석_함수 "wikilink") [상수 함수이다](../Page/상수_함수.md "wikilink").
...
[프랑스](../Page/프랑스.md "wikilink")의 수학자 [오귀스탱 루이 코시가](https://ko.wikipedia.org/wiki/오귀스탱_루이_코시 "wikilink") 증명하였다.
