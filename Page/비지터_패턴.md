...
[객체 지향 프로그래밍과](https://ko.wikipedia.org/wiki/객체_지향_프로그래밍 "wikilink") [소프트웨어 공학에서](../Page/소프트웨어_공학.md "wikilink") **비지터** 패턴(visitor pattern; 방문자 패턴)은 [알고리즘](https://ko.wikipedia.org/wiki/알고리즘 "wikilink")을 객체 구조에서 분리시키는 [디자인 패턴이다](https://ko.wikipedia.org/wiki/디자인_패턴 "wikilink"). 이렇게 분리를 하면 구조를 수정하지 않고도 실질적으로 새로운 동작을 기존의 객체 구조에 추가할 수 있게 된다. [개방-폐쇄 원칙을](../Page/개방-폐쇄_원칙.md "wikilink") 적용하는 방법의 하나이다.
