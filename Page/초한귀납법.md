...
[집합론](../Page/집합론.md "wikilink")에서, **초한 귀납법**(超限歸納法, )은 [수학적 귀납법을](https://ko.wikipedia.org/wiki/수학적_귀납법 "wikilink") [순서수](https://ko.wikipedia.org/wiki/순서수 "wikilink")나 [기수를](../Page/기수_\(수학\).md "wikilink") 비롯한 [정렬 집합으로](https://ko.wikipedia.org/wiki/정렬_집합 "wikilink") 확장한 것이다.

## 정의

\(P\)가 [순서수](https://ko.wikipedia.org/wiki/순서수 "wikilink")에 대한 성질이고, 다음이 임의의 순서수 \(\alpha\)에 대해 성립한다고 하자.
...
초한 귀납법을 [정렬 집합에](https://ko.wikipedia.org/wiki/정렬_집합 "wikilink") 적용시킬 때는 [선택 공리가](https://ko.wikipedia.org/wiki/선택_공리 "wikilink") 필요하지 않다. 그러나 초한 귀납법이 응용되는 여러 경우, [정렬 정리를](https://ko.wikipedia.org/wiki/정렬_정리 "wikilink") 사용하여 집합에 정렬 순서를 부여하여야 하는데, 이 경우 [선택 공리가](https://ko.wikipedia.org/wiki/선택_공리 "wikilink") 필요하게 된다.
