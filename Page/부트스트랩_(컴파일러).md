...
**부트스트래핑**(bootstrapping)은 [컴퓨터 과학에서](https://ko.wikipedia.org/wiki/컴퓨터_과학 "wikilink") [컴파일러](https://ko.wikipedia.org/wiki/컴파일러 "wikilink") (또는 어셈블러)를 컴파일 하고자하는 [프로그래밍 언어로](https://ko.wikipedia.org/wiki/프로그래밍_언어 "wikilink") 작성하는 과정이다. 이 기술의 적용은 [셀프 호스팅 컴파일러로](https://ko.wikipedia.org/wiki/셀프_호스팅_컴파일러 "wikilink") 이어진다.

[BASIC](https://ko.wikipedia.org/wiki/BASIC "wikilink"), [ALGOL](https://ko.wikipedia.org/wiki/ALGOL "wikilink"), [C](https://ko.wikipedia.org/wiki/C_\(프로그래밍_언어\) "wikilink"), [Pascal](https://ko.wikipedia.org/wiki/파스칼_\(프로그래밍_언어\) "wikilink"), [PL/I](https://ko.wikipedia.org/wiki/PL/I "wikilink"), [팩터](https://ko.wikipedia.org/wiki/팩터_\(프로그래밍_언어\) "wikilink"), [하스켈](https://ko.wikipedia.org/wiki/하스켈_\(프로그래밍_언어\) "wikilink"), [Modula-2](https://ko.wikipedia.org/wiki/Modula-2 "wikilink"), [오베론](https://ko.wikipedia.org/wiki/오베론_\(프로그래밍_언어\) "wikilink"), [OCaml](https://ko.wikipedia.org/wiki/OCaml "wikilink"), [Common Lisp](https://ko.wikipedia.org/wiki/Common_Lisp "wikilink"), [스킴](https://ko.wikipedia.org/wiki/스킴_\(프로그래밍_언어\) "wikilink"), [자바](https://ko.wikipedia.org/wiki/자바_\(프로그래밍_언어\) "wikilink"), [파이썬](https://ko.wikipedia.org/wiki/파이썬 "wikilink"), [스칼라](https://ko.wikipedia.org/wiki/스칼라_\(프로그래밍_언어\) "wikilink"), [님로드](https://ko.wikipedia.org/wiki/님로드_\(프로그래밍_언어\) "wikilink"), [Eiffel](https://ko.wikipedia.org/wiki/Eiffel_\(프로그래밍_언어\) "wikilink") 등 수많은 프로그래밍 언어들의 컴파일러들이 부트스트래핑 되었다
...
만약 X 언어(X 언어로 작성될)를 위한 컴파일러를 얻을 필요가 있을때 '어떻게 첫번째 컴파일러가 작성될 수 있는가' 에 대한 문제가 생긴다. 이 [닭이 먼저냐, 달걀이 먼저냐](https://ko.wikipedia.org/wiki/닭이_먼저냐,_달걀이_먼저냐 "wikilink") 문제 를 해결하기 위해 현장에서 사용되는 각기 다른 방법들은 다음을 포함한다:
  ...
  - [인터프리터](https://ko.wikipedia.org/wiki/인터프리터 "wikilink") 또는 Y 언어를 사용하여 X언어를 위한 [컴파일러](https://ko.wikipedia.org/wiki/컴파일러 "wikilink")를 작성한다. [니클라우스 워스](https://ko.wikipedia.org/wiki/니클라우스_워스 "wikilink")(Niklaus Wirth)는 그가 첫 번째 [파스칼](https://ko.wikipedia.org/wiki/파스칼_\(프로그래밍_언어\) "wikilink") 컴파일러를 [포트란](https://ko.wikipedia.org/wiki/포트란 "wikilink") 으로 작성했다고 밝혔다.
  - X 언어를 위한 또다른 인터프리터 또는 컴파일러가 Y 언어로 작성되었다; 이는 [스킴](https://ko.wikipedia.org/wiki/스킴_\(프로그래밍_언어\) "wikilink") 이 종종 부트스트랩 되는 방법이다.
  - X 언어를 위한 컴파일러의 초창기 버전들은 컴파일러가 존재하는 X 언어의 일부만을 사용해서 작성되었다. 이는 [JAVA](https://ko.wikipedia.org/wiki/JAVA_\(프로그래밍_언어\) "wikilink"), [하스켈](https://ko.wikipedia.org/wiki/하스켈_\(프로그래밍_언어\) "wikilink"), 초기 [프리 파스칼을](https://ko.wikipedia.org/wiki/프리_파스칼 "wikilink") 포함하는 언어들의 컴파일러가 종종 부트스트랩되는 방법이다.
...
아래 프로그래밍 언어들은 셀프호스팅 컴파일러를 가지고 있다:
  ...
  - [펄 6](https://ko.wikipedia.org/wiki/펄_6 "wikilink") (컴파일러: [Rakudo Perl과](https://ko.wikipedia.org/wiki/Rakudo_Perl "wikilink") [Niecza Perl 6](https://ko.wikipedia.org/wiki/Niecza_Perl_6 "wikilink") 모두 자기 호스팅)
