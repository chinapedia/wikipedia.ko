...
[섬네일](https://ko.wikipedia.org/wiki/파일:Histogram_of_arrivals_per_minute.svg "wikilink") **히스토그램**()은 표로 되어 있는 [도수](https://ko.wikipedia.org/wiki/도수_\(통계학\) "wikilink") 분포를 [정보 그림으로](https://ko.wikipedia.org/wiki/정보_그림 "wikilink") 나타낸 것이다. 더 간단하게 말하면, [도수분포표](https://ko.wikipedia.org/wiki/도수분포표 "wikilink")를 [그래프로](https://ko.wikipedia.org/wiki/함수의_그래프 "wikilink") 나타낸 것이다. 보통 히스토그램에서는 가로축이 [계급](https://ko.wikipedia.org/wiki/계급_\(통계학\) "wikilink"), 세로축이 도수를 뜻하는데, 때때로 반대로 그리기도 한다. 계급은 보통 변수의 [구간](https://ko.wikipedia.org/wiki/구간 "wikilink")이고, 서로 겹치지 않는다. 그림에서 계급(막대기)끼리는 서로 붙어 있어야 한다. 히스토그램은 일반 [막대그래프](https://ko.wikipedia.org/wiki/막대그래프 "wikilink")와는 다르다. [막대그래프](https://ko.wikipedia.org/wiki/막대그래프 "wikilink")는 계급 즉 가로를 생각하지 않고 세로의 높이로만 나타내지만 히스토그램은 가로와 세로를 함께 생각해야 한다.

공업 분야에서 히스토그램은 품질 관리()를 위한 일곱 가지 도구 중 하나이기도 하다. 여기에는 히스토그램, [파레토도](https://ko.wikipedia.org/wiki/파레토도 "wikilink"), [체크시트](https://ko.wikipedia.org/wiki/체크시트 "wikilink"), [관리도](../Page/관리도.md "wikilink"), [특성요인도](https://ko.wikipedia.org/wiki/특성요인도 "wikilink"), [순서도](https://ko.wikipedia.org/wiki/순서도 "wikilink"), [산포도](https://ko.wikipedia.org/wiki/산포도 "wikilink")가 들어간다. 이에 대한 세부 내용은 [품질 관리를](https://ko.wikipedia.org/wiki/품질_관리 "wikilink") 참고하라.
