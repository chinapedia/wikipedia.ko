...
[벡터 미적분학에서](https://ko.wikipedia.org/wiki/벡터_미적분학 "wikilink"), **야코비 행렬**()은 [다변수](https://ko.wikipedia.org/wiki/다변수_함수 "wikilink") [벡터 함수의](https://ko.wikipedia.org/wiki/벡터_함수 "wikilink") [도함수](https://ko.wikipedia.org/wiki/도함수 "wikilink") [행렬](https://ko.wikipedia.org/wiki/행렬 "wikilink")이다. **야코비 행렬식**()은 야코비 행렬의 [행렬식](https://ko.wikipedia.org/wiki/행렬식 "wikilink")을 뜻한다.
...
만약 \(n=m\)일 경우, 야코비 행렬은 정사각행렬이므로, 그 [행렬식](https://ko.wikipedia.org/wiki/행렬식 "wikilink") \(\det J(\mathbf f)(\mathbf a)\)을 취할 수 있다. 이를 \(\mathbf f\)의 \(\mathbf a\)에서의 **야코비 행렬식**이라고 한다.
