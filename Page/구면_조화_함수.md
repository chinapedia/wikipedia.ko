...
[섬네일](https://ko.wikipedia.org/wiki/파일:Harmoniki.png "wikilink") [수학](https://ko.wikipedia.org/wiki/수학 "wikilink")과 [물리학](../Page/물리학.md "wikilink")에서, **구면 조화 함수**(球面調和函數, )는 [구면에서](https://ko.wikipedia.org/wiki/구_\(기하학\) "wikilink") [라플라스 방정식의](https://ko.wikipedia.org/wiki/라플라스_방정식 "wikilink") 해의 [정규 직교 기저다](../Page/정규_직교_기저.md "wikilink").\[1\] [전자기학](https://ko.wikipedia.org/wiki/전자기학 "wikilink")과 [양자역학](https://ko.wikipedia.org/wiki/양자역학 "wikilink") 등에서 구면 대칭인 [계를](https://ko.wikipedia.org/wiki/계_\(물리학\) "wikilink") 다룰 때 쓰인다. 기호는 \(Y_l^m\)이다.

## 정의

[구면 좌표계](https://ko.wikipedia.org/wiki/구면_좌표계 "wikilink") \((r,\theta,\phi)\)에서 [라플라스 방정식은](https://ko.wikipedia.org/wiki/라플라스_방정식 "wikilink") 다음과 같다.
...
\[\nabla^2 f = {1 \over r^2}{\partial \over \partial r}\left(r^2 {\partial f \over \partial r}\right)
  ...
  + {1 \over r^2\sin^2\theta}{\partial^2 f \over \partial \varphi^2} = 0\], [변수분리법](https://ko.wikipedia.org/wiki/변수분리법 "wikilink")을 써, 함수 *f*가 다음과 같이 표현된다고 가정하자.
...
\[Y_\ell^m (\theta, \varphi ) = N\exp(im\varphi)P_l^m (\cos{\theta} ),\] 이들 함수 \(Y_l^m\)를 **구면 조화 함수**라 부른다. 함수가 연속적이므로, \(l\)은 음이 아닌 [정수](https://ko.wikipedia.org/wiki/정수 "wikilink")이고, \(m\)은 \(-l\le m\le l\)을 만족하는 정수다. 여기서 \(P_\ell^m\) 은 [르장드르 연관 함수이고](https://ko.wikipedia.org/wiki/르장드르_연관_함수 "wikilink"), \(N\) 은 정규화 상수다. \(N\)은 임의적이나, 대개 편의상 \(\int_{4\pi}d\Omega\;|Y_l^m|^2=1\)이 되게 다음과 같이 정의한다.
...
유클리드 공간 \(\mathbb R^n\) 위의 [다항식](https://ko.wikipedia.org/wiki/다항식 "wikilink") 함수 가운데, [조화 함수인](https://ko.wikipedia.org/wiki/조화_함수 "wikilink") 것들을 생각하자.
...
이를 \(n-1\)차원 [초구](https://ko.wikipedia.org/wiki/초구 "wikilink")
...
\[p(x_1,\dotsc,x_n) = \sum_{i_1=1}^n\dotso\sum_{i_l=1}^np_{i_1\dotso i_l}x_{i_1}\dotsm x_{i_l}\] 에 대하여, \(p\)가 조화 함수일 조건은 텐서 \(p_{i_1\dotso i_l}\)이 대칭이며 완전 무(無)[대각합](https://ko.wikipedia.org/wiki/대각합 "wikilink")인 것이다. 즉, 이는 \(\operatorname{SO}(n)\)의 완전 무대각합 대칭 \(l\)차 텐서 표현에 대응한다. 이는 \(l\)개의 상자로 구성된 하나의 행만을 갖는 [영 타블로에](../Page/영_타블로.md "wikilink") 해당한다.
...
단위 [초구](https://ko.wikipedia.org/wiki/초구 "wikilink")는 유클리드 공간의 [부분 다양체이다](https://ko.wikipedia.org/wiki/부분_다양체 "wikilink"). 이에 따라 [초구](https://ko.wikipedia.org/wiki/초구 "wikilink")는 [리만 다양체를](https://ko.wikipedia.org/wiki/리만_다양체 "wikilink") 이루며, 이에 따라 [부피 형식](../Page/부피_형식.md "wikilink") 및 [르베그 공간](https://ko.wikipedia.org/wiki/르베그_공간 "wikilink")

\[\operatorname L^2(\mathbb S^{n-1};\mathbb C)\] 을 정의할 수 있다. 이는 [분해 가능](https://ko.wikipedia.org/wiki/분해_가능_공간 "wikilink") 무한 차원 [복소수 힐베르트 공간이다](https://ko.wikipedia.org/wiki/복소수_힐베르트_공간 "wikilink") (\(n\ge2\)). 그렇다면, \(Y_l^{m_1,\dotsc,m_{n-2}}\)는 그 위의 [정규 직교 기저를](../Page/정규_직교_기저.md "wikilink") 이룬다.
...
단위 [초구](https://ko.wikipedia.org/wiki/초구 "wikilink")는 유클리드 공간의 [부분 다양체이다](https://ko.wikipedia.org/wiki/부분_다양체 "wikilink"). 이에 따라 [초구](https://ko.wikipedia.org/wiki/초구 "wikilink")는 [리만 다양체를](https://ko.wikipedia.org/wiki/리만_다양체 "wikilink") 이루며, 그 위의 매끄러운 함수에 대하여 [라플라스-벨트라미 연산자](https://ko.wikipedia.org/wiki/라플라스-벨트라미_연산자 "wikilink")
...
구면 조화 함수의 매개변수 \(l\)과 \(m\)을 이렇게 부르는 까닭은 [양자역학](https://ko.wikipedia.org/wiki/양자역학 "wikilink")에서 이 함수를 구형 대칭의 [파동 함수로](../Page/파동_함수.md "wikilink") 해석하면 \(l\)과 \(m\) 궤도 [각운동량](https://ko.wikipedia.org/wiki/각운동량 "wikilink") [양자수](../Page/양자수.md "wikilink")에 해당하기 때문이다. 양자역학에서 궤도 각운동량() 연산자는 다음과 같다.
...
1차원 구는 [원](https://ko.wikipedia.org/wiki/원 "wikilink")이며, 이 경우 구면 조화 함수는 단순히 삼각 함수이다.
...
운죌트 정리는 [독일](https://ko.wikipedia.org/wiki/독일 "wikilink")의 천체물리학자 알브레히트 오토 요하네스 운죌트(, 1905〜1995)가 제시하였다.
...
## 같이 보기
  ...
  - [르장드르 연관 함수](https://ko.wikipedia.org/wiki/르장드르_연관_함수 "wikilink")
  - [극좌표계](https://ko.wikipedia.org/wiki/극좌표계 "wikilink")
  - [구면좌표계](https://ko.wikipedia.org/wiki/구면좌표계 "wikilink")
  - [부분파 방법](https://ko.wikipedia.org/wiki/부분파_방법 "wikilink")
