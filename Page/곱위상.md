...
\[\mathcal B=\mathcal B_{\aleph_0}\subsetneq\mathcal B_{\aleph_1}\subsetneq\cdots\subsetneq\mathcal B_{|I|}=\mathcal B_{\text{box}}\] 상자 위상을 포함한 \(\mathcal B_\kappa\)-위상은 만약 \(I\)가 [유한 집합이라면](../Page/유한_집합.md "wikilink") 곱위상과 일치한다.
