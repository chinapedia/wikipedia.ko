...
\[\mathcal B_\kappa=\left\{\prod_{i\in I}U_i\colon U_i\in\mathcal T(X_i),\;\kappa>|\{i\in I\colon U_i\ne X_i\}|\right\}\] 를 정의할 수 있으며, (\(X_i\)들이 [비이산 공간이](../Page/비이산_공간.md "wikilink") 아니라면) 각 [무한 기수](https://ko.wikipedia.org/wiki/무한_기수 "wikilink") \(\kappa\le|I|\)에 대하여 이는 서로 다른 위상을 정의한다. 만약 이 기수가 충분히 클 때 (즉, \(\kappa\ge|I|\)일 때), 추가 조건은 자명해진다.
