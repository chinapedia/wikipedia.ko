...
**줄리아**(Julia)는 고성능의 [수치 해석](https://ko.wikipedia.org/wiki/수치_해석 "wikilink") 및 [계산과학](https://ko.wikipedia.org/wiki/계산과학 "wikilink")의 필요사항을 만족시키면서 일반 목적 프로그래밍에도 효과적으로 사용될 수 있도록 설계된 [고급](https://ko.wikipedia.org/wiki/고급_프로그래밍_언어 "wikilink") [동적 프로그래밍 언어이다](../Page/동적_프로그래밍_언어.md "wikilink").\[1\]\[2\]\[3\]\[4\]
