...
[순서론](https://ko.wikipedia.org/wiki/순서론 "wikilink")에서, **직교 여원 격자**(直交餘元格子, )는 [불 대수와](https://ko.wikipedia.org/wiki/불_대수 "wikilink") 유사한 여원 연산을 갖는 [유계 격자이다](https://ko.wikipedia.org/wiki/유계_격자 "wikilink"). 그러나 [불 대수와](https://ko.wikipedia.org/wiki/불_대수 "wikilink") 달리 [분배 격자일](../Page/분배_격자.md "wikilink") 필요가 없으며, 심지어 [모듈러 격자도](../Page/모듈러_격자.md "wikilink") 아닐 수 있다.

## 정의

### 순서 반대 보존성의 동치 조건

[유계 격자](https://ko.wikipedia.org/wiki/유계_격자 "wikilink") \((L,\land,\lor,\top,\bot)\) 위의 함수 \(\lnot\colon L\to L\)에 대하여 다음 세 조건이 서로 [동치](https://ko.wikipedia.org/wiki/동치 "wikilink")이다.
...
[유계 격자](https://ko.wikipedia.org/wiki/유계_격자 "wikilink") \((L,\land,\lor,\top,\bot)\) 위의 **직교 여원**(直交餘元, ) \(\lnot\colon L\to L\)은 다음 네 조건들을 만족시키는 [함수](https://ko.wikipedia.org/wiki/함수 "wikilink")이다.\[1\]\[2\]

  - ([대합](https://ko.wikipedia.org/wiki/대합_\(수학\) "wikilink")) 임의의 \(x\in L\)에 대하여, \(\lnot\lnot x=x\)
  - (순서 반대 보존) 임의의 \(x,y\in L\)에 대하여, \(x\le y\)라면 \(\lnot x\ge\lnot y\)
  - ([배중률](https://ko.wikipedia.org/wiki/배중률 "wikilink")) 임의의 \(x\in L\)에 대하여, \(\lnot x\lor x=\top\)
  - ([비모순율](https://ko.wikipedia.org/wiki/비모순율 "wikilink")) 임의의 \(x\in L\)에 대하여, \(\lnot x\land x=\bot\)

**직교 여원 격자**()는 직교 여원이 부여된 격자이다. 이들의 모임은 [대수 구조 다양체를](../Page/대수_구조_다양체.md "wikilink") 이룬다. 두 직교여원 격자 사이의 **직교 여원 격자 사상**() \(f\colon L\to L'\)은 다음 조건들을 만족시키는 [함수](https://ko.wikipedia.org/wiki/함수 "wikilink")이다.
...
[thumb](https://ko.wikipedia.org/wiki/파일:Expanded_2-simplex.png "wikilink")\]\] 직교 여원 격자 \(L\)에 대하여 다음 조건들이 서로 [동치](https://ko.wikipedia.org/wiki/동치 "wikilink")이며, 이를 만족시키는 직교 여원 격자를 **직교모듈러 격자**()라고 한다.
...
모든 [불 대수는](https://ko.wikipedia.org/wiki/불_대수 "wikilink") 직교 여원 격자이다.

직교여원 격자가 [분배 격자일](../Page/분배_격자.md "wikilink") 필요는 없다.

직교 여원 격자 \(L\)에 대하여 다음 조건들이 서로 [동치](https://ko.wikipedia.org/wiki/동치 "wikilink")이다.

  - [불 대수이다](https://ko.wikipedia.org/wiki/불_대수 "wikilink").
...
직교 여원을 갖는 분배 격자를 **[불 대수](https://ko.wikipedia.org/wiki/불_대수 "wikilink")**라고 한다.
...
[힐베르트 공간](https://ko.wikipedia.org/wiki/힐베르트_공간 "wikilink") \(\mathcal H\)의 부분 벡터 공간들은 포함 관계에 대하여 [유계 격자를](https://ko.wikipedia.org/wiki/유계_격자 "wikilink") 이룬다. 이 경우, 직교여원

\[\lnot V=V^\perp=\{u\in\mathcal H\colon\forall v\in V\colon u\perp v\}\] 을 정의하면, 이는 직교모듈러 격자를 이룬다. "직교 여원"이라는 용어는 이에서 비롯하였다. 이 사실은 [양자 논리에서](https://ko.wikipedia.org/wiki/양자_논리 "wikilink") 중요한 역할을 한다.
