...
b의 질량은 목성의 1.32배이다. 이 행성의 궤도경사각이 밝혀진 상태이기 때문에 이 질량값은 정확하다. 항성으로부터 매우 가까운 곳을 돌고 있는데 그 거리는 최초로 발견된 뜨거운 목성 [페가수스자리 51 b와](../Page/페가수스자리_51_b.md "wikilink") 오시리스보다도 가깝다. 1.43일에 별을 한 바퀴 돈다. 항성으로부터 강렬한 열기를 받음에도 이 별의 반지름은 목성의 109퍼센트에 불과하다. 보통 목성과 비슷한 덩치의 가스 행성은 항성으로부터 매우 가깝게 붙어 있을 경우 열기 때문에 팽창하여 부피가 증가해 있다.\[3\]
