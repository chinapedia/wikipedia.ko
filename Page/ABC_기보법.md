...
**ABC 기보법**은 [기보법](https://ko.wikipedia.org/wiki/기보법 "wikilink")의 축약된 형태이다.
...
최신 [써드 파티](https://ko.wikipedia.org/wiki/서드_파티_개발자 "wikilink")(third-party) 소프트웨어 패키지는 TeX 타입 세터를 우회하여 직접 출력을 제공하고,\[3\] 다중 음성 및 다중 스태프 표기법,\[4\] 태블러쳐 ,\[5\]및 [MIDI](https://ko.wikipedia.org/wiki/MIDI "wikilink")와 일치하는 가사 를 지원하는 구문을 확장했다.\[6\]
...
\-협업 및 대규모 악보 편집을위한 ABC 기반 플랫폼-
  ...
  - [MediaWiki](https://ko.wikipedia.org/wiki/MediaWiki "wikilink") 용 악보 플러그인 : 이것은 기본 렌더링 엔진으로 [GNU LilyPond](https://ko.wikipedia.org/wiki/릴리폰드 "wikilink")(릴리폰드) 를 사용한다. 릴리폰드(LilyPond)에는 ABC 표기법을 릴리폰드로 변환하는 스크립트인 abc2ly가 함께 제공된다. 확장 프로그램은 abc2ly와 LilyPond를 호출한다.
  - [MusicWiki](https://ko.wikipedia.org/wiki/MusicWiki "wikilink") : [MoinMoin](https://ko.wikipedia.org/wiki/모인모인 "wikilink") 위키 용 [Python](https://ko.wikipedia.org/wiki/Python "wikilink") [플러그인](https://ko.wikipedia.org/wiki/플러그인 "wikilink")
  ...
  - [DokuWiki](https://ko.wikipedia.org/wiki/도쿠위키 "wikilink") 에서 ABC 표기법을 표시하기위한 ABC 플러그인. 이 플러그인은 제프 모인(Jef Moine)의 abcm2ps 패키지를 렌더링 엔진으로 사용한다. ABC Plus Project를 사용하여 MIDI 오디오 출력을 생성한다.
...
<!-- end list -->
  ...
  - 멀티 플레이어 게임 [The Lord of the Rings Online은](https://ko.wikipedia.org/wiki/반지의_제왕_온라인:_어둠의_제국_앙그마르 "wikilink") 이제 ABC 표기법을 사용하여 플레이어가 게임 내 모든 MIDI 음악 파일을 변환하고 재생할 수있게한다. 플레이어는 캐릭터가 해당 악기를 연주하도록하여 음악을 재생한다.
  - PC 게임 [스타바운드](https://ko.wikipedia.org/wiki/스타바운드 "wikilink")(Starbound)를 통해 플레이어는 자신의 악기를 사용하여 사용자 지정 음악을 재생할 수 있다.
  - [musicXML](https://ko.wikipedia.org/wiki/musicXML "wikilink")에 특화되어 제작된 전용 [자바스크립트](https://ko.wikipedia.org/wiki/자바스크립트 "wikilink")파일은 [JQuery](https://ko.wikipedia.org/wiki/JQuery "wikilink")와 함께 스탠드얼론상태인 [PC환경에서도](https://ko.wikipedia.org/wiki/개인용_컴퓨터 "wikilink") ABC표기법에 기반해서 웹 브라우저 상에서 편집과 재생이 가능토록한다.\[8\]
...
1.
2.  ([W3C](https://ko.wikipedia.org/wiki/W3C "wikilink") 공식웹사이트)https://www.w3.org/community/music-notation/
3.
4.
5.
6.
