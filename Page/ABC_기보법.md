...
\-협업 및 대규모 악보 편집을위한 ABC 기반 플랫폼-
  ...
  - [MusicWiki](https://ko.wikipedia.org/wiki/MusicWiki "wikilink") : [MoinMoin](https://ko.wikipedia.org/wiki/모인모인 "wikilink") 위키 용 [Python](https://ko.wikipedia.org/wiki/Python "wikilink") [플러그인](../Page/플러그인.md "wikilink")
