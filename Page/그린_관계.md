...
여기서 굵은 글씨체로 표기된 원소는 [멱등원](https://ko.wikipedia.org/wiki/멱등원 "wikilink")이며, 이를 포함하는 칸(\(\mathcal H\)-동치류)은 [멱등원](https://ko.wikipedia.org/wiki/멱등원 "wikilink")을 항등원으로 하는 [군을](https://ko.wikipedia.org/wiki/군_\(수학\) "wikilink") 이룬다.
