...
[수학](https://ko.wikipedia.org/wiki/수학 "wikilink")에서 **사영 공간**(射影空間, )은 [벡터 공간의](https://ko.wikipedia.org/wiki/벡터_공간 "wikilink") 원점을 지나는 직선들의 집합이다. [평행선](https://ko.wikipedia.org/wiki/평행선 "wikilink")들이 만나는 장소인 [무한원직선](https://ko.wikipedia.org/wiki/무한원직선 "wikilink")이나 [무한원평면](https://ko.wikipedia.org/wiki/무한원평면 "wikilink") 등의 개념을 엄밀히 다루기 위해 만들어진 개념이다. 사영 공간의 기하학을 다루는 학문인 [사영기하학](https://ko.wikipedia.org/wiki/사영기하학 "wikilink")은 현대 [대수기하학](https://ko.wikipedia.org/wiki/대수기하학 "wikilink")의 기초가 되었으며, 사영 공간 및 이를 확장한 개념인 [그라스만 다양체와](../Page/그라스만_다양체.md "wikilink") [깃발 다양체는](https://ko.wikipedia.org/wiki/깃발_다양체 "wikilink") [위상수학](https://ko.wikipedia.org/wiki/위상수학 "wikilink"), [리 군론](https://ko.wikipedia.org/wiki/리_군론 "wikilink"), [대수군론](https://ko.wikipedia.org/wiki/대수군론 "wikilink") 및 이 대상들의 [표현론에서](https://ko.wikipedia.org/wiki/표현론_\(수학\) "wikilink") 중요한 역할을 한다.
...
임의의 [스킴](https://ko.wikipedia.org/wiki/스킴_\(수학\) "wikilink") \(X\)에 대하여, \(X\) 좌표의 \(n\)차원 **사영 공간** \(\mathbb P_X^n\)은 다음과 같다.

\[\mathbb P^n_X=\mathbb P^n_{\mathbb Z}\times X\] 여기서 \(\times\)는 스킴의 범주의 [곱을](https://ko.wikipedia.org/wiki/곱_\(범주론\) "wikilink") 뜻한다.

만약 \(R\)가 [가환환](https://ko.wikipedia.org/wiki/가환환 "wikilink")이라면, 다음이 성립한다.
...
1차원 복소수 사영 공간 \(\mathbb P^1_{\mathbb C}\)은 [복소다양체](https://ko.wikipedia.org/wiki/복소다양체 "wikilink")로 여겼을 때 [리만 구가](https://ko.wikipedia.org/wiki/리만_구 "wikilink") 된다.
...
## 같이 보기
  ...
  - [아핀 공간](https://ko.wikipedia.org/wiki/아핀_공간 "wikilink")
  - [사영 대수다양체](https://ko.wikipedia.org/wiki/사영_대수다양체 "wikilink")
  - [유리 다양체](https://ko.wikipedia.org/wiki/유리_다양체 "wikilink")
