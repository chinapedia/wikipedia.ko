...
## 외부 링크
  ...
  - [J스크립트 문서](http://msdn2.microsoft.com/en-us/library/hbxc2t98.aspx) (MSDN 라이브러리)
  - [J스크립트 5.7 출시 정보](http://download.microsoft.com/download/f/f/e/ffea3abf-b55f-4924-b5a5-bde0805ad67c/Windows%20Script%20Release%20Notes.rtf)
  - [J스크립트 블로그](http://blogs.msdn.com/jscript)

[분류:자바스크립트](https://ko.wikipedia.org/wiki/분류:자바스크립트 "wikilink") [분류:프로토타입 기반 프로그래밍 언어](https://ko.wikipedia.org/wiki/분류:프로토타입_기반_프로그래밍_언어 "wikilink") [분류:스크립트 언어](https://ko.wikipedia.org/wiki/분류:스크립트_언어 "wikilink") [분류:인터넷 익스플로러](https://ko.wikipedia.org/wiki/분류:인터넷_익스플로러 "wikilink") [분류:자바스크립트 프로그래밍 언어 계열](https://ko.wikipedia.org/wiki/분류:자바스크립트_프로그래밍_언어_계열 "wikilink")