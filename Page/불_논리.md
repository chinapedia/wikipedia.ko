...
**불 논리**()는 [논리적](https://ko.wikipedia.org/wiki/논리학 "wikilink") [산법](https://ko.wikipedia.org/wiki/산법 "wikilink")의 완전한 체계이다.

불 논리라는 이름은 [19세기](https://ko.wikipedia.org/wiki/19세기 "wikilink") 중순에 논리의 [대수계](https://ko.wikipedia.org/wiki/대수계 "wikilink")를 처음으로 정의한 [조지 불에서](https://ko.wikipedia.org/wiki/조지_불 "wikilink") 따온 것이다. 불 논리는 전자 공학, 컴퓨터 하드웨어 및 소프트웨어 등으로 넓게 응용되고 있다. [1938년](https://ko.wikipedia.org/wiki/1938년 "wikilink") [클로드 섀넌](https://ko.wikipedia.org/wiki/클로드_섀넌 "wikilink")(Shannon, Claude)는 불 논리를 릴레이에 의한 전기 회로 장착 방법을 나타냈다. 이 사실은 머지 않아 전자식 [컴퓨터](../Page/컴퓨터.md "wikilink")를 만드는 데에 없어서는 안 될 존재임이 밝혀졌다.

여기서는 [집합 대수를](https://ko.wikipedia.org/wiki/집합_대수 "wikilink") 이용하고, [집합](https://ko.wikipedia.org/wiki/집합 "wikilink"), 불 연산, [진리값 표](https://ko.wikipedia.org/wiki/진리값_표 "wikilink") 등의 기본 해설과 불 논리의 응용에 대해 풀이한다. [불 대수](../Page/불_대수.md "wikilink") 글에는 불 논리의 공리를 만족하는 [대수 구조의](../Page/대수_구조.md "wikilink") 형태를 설명하고 있다. [이진수에서는](https://ko.wikipedia.org/wiki/이진법 "wikilink") [컴퓨터](../Page/컴퓨터.md "wikilink")에서 쓰이는 이진수를 풀이하고 있다.
...
불 논리는 [전기 공학](https://ko.wikipedia.org/wiki/전기_공학 "wikilink") 회로 설계에도 사용된다. 이 때, 0, 1 은[디지털 회로로의](../Page/디지털_회로.md "wikilink") [비트가](https://ko.wikipedia.org/wiki/비트_\(단위\) "wikilink") 다른 2개 상태를 나타내, [전압](https://ko.wikipedia.org/wiki/전압 "wikilink")의 높낮이를 따른다. 회로는 변수를 포함한 식에서 표시된다. 입출력이 완전하면, 이를 불 논리식에서 표현할 수 있다.
...
[관계 데이터베이스에서는](https://ko.wikipedia.org/wiki/관계_데이터베이스 "wikilink") [쿼리](https://ko.wikipedia.org/wiki/쿼리 "wikilink")를 위해 [SQL](https://ko.wikipedia.org/wiki/SQL "wikilink") 등의 데이터베이스 고유 언어를 사용하지만, 이것들은 불 논리를 포함하고 있다. 이 경우, 표 안의 레코드(record)는 「집합」안의 「원」에 가깝다. 이를테면, SQL의 [SELECT문은](https://ko.wikipedia.org/wiki/SELECT_\(SQL\) "wikilink") 데이터베이스 안의 바깥(표)으로부터 데이터를 다음과 같이 추출한다.
...
이 경우, 인터넷의 각 웹페이지가 「집합」의 「원」에 가깝다. 검색 엔진에 따라 [쿼리](https://ko.wikipedia.org/wiki/쿼리 "wikilink")의 문법은 여러 가지이다. 여기에서는 [구글](https://ko.wikipedia.org/wiki/구글 "wikilink")의 문법을 설명한다.
...
## 같이 보기
  ...
  - [수리 논리학](https://ko.wikipedia.org/wiki/수리_논리학 "wikilink") (기호 논리학)
