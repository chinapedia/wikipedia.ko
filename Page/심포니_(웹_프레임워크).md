...
\]\] | operating system = [크로스 플랫폼](https://ko.wikipedia.org/wiki/크로스_플랫폼 "wikilink") | platform = | language = | genre = [웹 프레임워크](https://ko.wikipedia.org/wiki/웹_프레임워크 "wikilink") | license = [id=Q1322933}}](https://ko.wikipedia.org/wiki/{{#property:P275 "wikilink") | website =  }}

**심포니**(Symfony)는 [PHP](https://ko.wikipedia.org/wiki/PHP "wikilink") [웹 프레임워크의](https://ko.wikipedia.org/wiki/웹_프레임워크 "wikilink") 하나로서 재사용 가능한 PHP 구성 요소/라이브러리들의 모임이다. 심포니는 2005년 10월 18일 [자유 소프트웨어로](https://ko.wikipedia.org/wiki/자유_소프트웨어 "wikilink") 출시되었으며 [MIT 허가서에](https://ko.wikipedia.org/wiki/MIT_허가서 "wikilink") 의거하여 출시된다.

## 기술적 설명

심포니는 [스프링 프레임워크에](https://ko.wikipedia.org/wiki/스프링_프레임워크 "wikilink") 큰 영향을 받았다.\[1\]
...
심포니는 기존의 PHP 오픈 소스 프로젝트들을 프레임워크의 일부로 사용하며, 다음을 포함한다:
  ...
  - [PDO](https://ko.wikipedia.org/wiki/PHP "wikilink") [데이터베이스 추상화 계층](https://ko.wikipedia.org/wiki/데이터베이스_추상화_계층 "wikilink") (1.1 + [독트린](https://ko.wikipedia.org/wiki/독트린_\(PHP\) "wikilink") 및 [프로펠 1.3](https://ko.wikipedia.org/wiki/프로펠_\(PHP\) "wikilink"))
  - [PHPUnit](https://ko.wikipedia.org/wiki/PHPUnit "wikilink"): 유닛 테스팅 프레임워크
...
심포니는 또한 자신만의 구성요소들을 이용하는데, 이것들은 그 밖의 다양한 프로젝트를 위해 심포니 컴포넌츠 상에서 자유롭게 이용이 가능하다:
  ...
  - 심포니 이벤트 디스패처
  - 심포니 디팬던시 인젝터: [의존성 주입기](https://ko.wikipedia.org/wiki/의존성_주입 "wikilink")
  - 심포니 태플릿팅: 탬플릿팅 엔진
...
## 같이 보기
  ...
  - [라임](https://ko.wikipedia.org/wiki/라임_\(소프트웨어\) "wikilink")
