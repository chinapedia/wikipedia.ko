...
잘 알려진 알고리즘 교과서 *[Introduction to Algorithms](https://ko.wikipedia.org/wiki/Introduction_to_Algorithms "wikilink")*의 4.3절과 4.4절, **4.5절**에 설명되어 유명해졌으나, 이 방법이 모든 재귀 관계식을 풀 수 있는 건 아니다.
