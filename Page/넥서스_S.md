...
또한 루팅을 통하여 수백가지의 커스텀 롬을 마음대로 선택하여 이용할 수 있다.

## [4.1 젤리빈](https://ko.wikipedia.org/wiki/안드로이드_버전_역사 "wikilink") 업그레이드

넥서스S용 [젤리빈의](https://ko.wikipedia.org/wiki/안드로이드_버전_역사 "wikilink") 제작 및 검증이 완료되었으며, 이는 동급의 갤럭시S에 비해 2세대나 뛰어넘은 것으로, 레퍼런스 스마트폰의 장점을 보여준다. OTA 를 통한 공식 업그레이드도 받을 수 있지만, 구글 USB드라이버를 다운받고 CWM(ClockWorkMod) Recovery 모드를 통하여 수백가지가 나와있는 커스텀 롬을 이용할 수도 있다. 화면에 터치하는 동시에 CPU와 GPU가 손가락의 움직임에 집중하게 한다는 프로젝트 버터를 통하여 훨씬 부드러워졌고 각종 버그도 고쳐졌다고 한다.

2012년 7월 30일 넥서스 S 용의 4.1.1 버전의 젤리빈이 T-모바일을 통해 OTA로 공개되었으며, 이후 2012년 10월 13일 4.1.2 버전의 젤리빈 이 T-모바일을 통해 OTA 업데이트가 공개되었다.

그러나 4.1.2를 최종으로 OS 업그레이드가 중단되었다.

향후 업데이트 계획은 없다.

## 변종

주파수 또는 통신방법, 기저대역의 차이로 기기명과 지원 주파수가 다르다.
...
## 외부 링크
  ...
  - [Google Nexus S - Google.com](https://www.google.com/nexus/s/)
  - [Nexus S - Samsung.com](https://web.archive.org/web/20120902074232/http://www.samsung.com/us/mobile/cell-phones/GT-I9020FSTTMB)
  - [공식 구글 넥서스 S 규격](https://www.google.com/phone/detail/nexus-s)

[분류:2010년 출시](https://ko.wikipedia.org/wiki/분류:2010년_출시 "wikilink") [분류:안드로이드 장치](https://ko.wikipedia.org/wiki/분류:안드로이드_장치 "wikilink") [분류:구글 넥서스](https://ko.wikipedia.org/wiki/분류:구글_넥서스 "wikilink")

1.  [Pictures of the Samsung Nexus S leaked to XDA Developers (XDA 개발자들에게 유출된 삼성 넥서스 S의 사진들)".](http://www.xda-developers.com/android/xda-exclusive-gingerbread-2-3-nexus-s-pictures/)
2.
3.
4.
5.  [삼성전자-구글 \`넥서스2 폰\` 11월 말 공개](http://www.hankyung.com/news/app/newsview.php?aid=2010110168421) 《한국경제》, 2010년 11월 1일