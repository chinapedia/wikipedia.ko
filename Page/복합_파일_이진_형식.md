...
**복합 파일 이진 형식**(Compound File Binary Format, CFBF, Compound File, Compound Document format\[1\], Composite Document File V2 Document\[2\])은 여러 [파일](https://ko.wikipedia.org/wiki/파일 "wikilink")과 [디렉터리](https://ko.wikipedia.org/wiki/디렉터리 "wikilink")를 하나의 파일에 저장하는 [마이크로소프트](https://ko.wikipedia.org/wiki/마이크로소프트 "wikilink")의 [파일 형식이다](https://ko.wikipedia.org/wiki/파일_형식 "wikilink").
...
마이크로소프트 [워드 97](https://ko.wikipedia.org/wiki/마이크로소프트_워드 "wikilink") 이후의 .doc 파일 형식과 한글과컴퓨터의 [한/글 워디안](https://ko.wikipedia.org/wiki/한/글_워디안 "wikilink") 이후의 .hwp 파일 형식 등이 복합 파일 이진 형식을 쓰고 있다. [이진 파일](../Page/이진_파일.md "wikilink") 형식은 다른 운영 체제나 기종에서 사용하기가 까다롭기 때문에 최근에는 [오피스 오픈 XML](../Page/오피스_오픈_XML.md "wikilink"), [오픈도큐먼트](../Page/오픈도큐먼트.md "wikilink"), [HWPML](https://ko.wikipedia.org/wiki/HWPML "wikilink")처럼 [XML](https://ko.wikipedia.org/wiki/XML "wikilink")을 이용하는 추세이다.
...
## 관련 API
  ...
  - [libgsf](http://ftp.gnome.org/pub/gnome/sources/libgsf/): [그놈](https://ko.wikipedia.org/wiki/그놈 "wikilink")의 복합 파일 라이브러리
