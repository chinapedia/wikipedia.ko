...
응력 증가량을 계산하는 방법은 두 가지가 있다. 간이법(2:1법)과 평균법이 그것이다. 만약 지표면 위에 [기초](../Page/기초.md "wikilink")가 있는 게 아니라 지표면을 굴착해서 기초가 설치되었다면 굴착된 부분만큼의 응력감소와, [지하수](https://ko.wikipedia.org/wiki/지하수 "wikilink")의 [부력](../Page/부력.md "wikilink")에 의한 응력감소분을 P에서 빼주어야 한다.
