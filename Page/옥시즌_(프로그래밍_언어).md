...
**옥시즌**(, <small>이전 이름: 크롬</small>)은 [렘오브젝트](https://ko.wikipedia.org/wiki/렘오브젝트 "wikilink")에서 개발한 [공통 언어 기반의](../Page/공통_언어_기반.md "wikilink") [프로그래밍 언어이다](https://ko.wikipedia.org/wiki/프로그래밍_언어 "wikilink"). [코드기어](../Page/코드기어.md "wikilink")의 [델파이닷넷](https://ko.wikipedia.org/wiki/델파이닷넷 "wikilink")과 비교하면, 옥시즌은 [하위 호환성을](../Page/하위_호환성.md "wikilink") 지니지 않는다.

## 특징

  - [공통 언어 기반](../Page/공통_언어_기반.md "wikilink")
  - [오브젝트 파스칼에](https://ko.wikipedia.org/wiki/오브젝트_파스칼 "wikilink") 기반을 두었지만 많은 새로운 기능이 추가
  - 인라인 변수 선언
  - 익명 자료형, 익명 대리자
  - 비동기 메소드
...
## 외부 링크
  ...
  - [옥시즌 크롬 위키](http://wiki.remobjects.com/wiki/Oxygene)
