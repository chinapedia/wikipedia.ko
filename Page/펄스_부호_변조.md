...
**펄스 부호 변조**(Pulse-code modulation, 줄여서 **PCM**)는 아날로그 [신호](https://ko.wikipedia.org/wiki/신호 "wikilink")의 [디지털](https://ko.wikipedia.org/wiki/디지털 "wikilink") 표현으로, 신호 등급을 균일한 주기로 [표본화](https://ko.wikipedia.org/wiki/표본화 "wikilink")한 다음 디지털 ([이진](https://ko.wikipedia.org/wiki/이진법 "wikilink")) 코드로 [양자화](https://ko.wikipedia.org/wiki/양자화_\(정보_이론\) "wikilink") 처리한다. PCM은 디지털 [전화](../Page/전화.md "wikilink") 시스템에 쓰이며, [컴퓨터](../Page/컴퓨터.md "wikilink")와 [CD](https://ko.wikipedia.org/wiki/콤팩트_디스크 "wikilink") [레드북에서](https://ko.wikipedia.org/wiki/CD-DA "wikilink") [디지털 오디오의](https://ko.wikipedia.org/wiki/디지털_오디오 "wikilink") 표준이기도 하다. 또, 이를테면 [ITU-R](https://ko.wikipedia.org/wiki/ITU-R "wikilink") [BT.601을](https://ko.wikipedia.org/wiki/Rec._601 "wikilink") 사용할 때 [디지털 비디오의](https://ko.wikipedia.org/wiki/디지털_비디오 "wikilink") 표준이기도 하다. 그러나 직접적인 PCM은 [DVD](https://ko.wikipedia.org/wiki/DVD "wikilink"), [디지털 비디오 레코더와](https://ko.wikipedia.org/wiki/디지털_비디오_레코더 "wikilink") 같은 소비자 수준의 [SD](https://ko.wikipedia.org/wiki/디지털_표준_텔레비전 "wikilink") 비디오에서 쓰이지 않는다. (왜냐하면 요구되는 비트 속도가 너무 높기 때문이다.) 일반적으로 PCM 인코딩은 [직렬](https://ko.wikipedia.org/wiki/직렬_통신 "wikilink") 형태의 디지털 전송에 자주 쓰인다.
...
**ADPCM**(Adaptive Differential Pulse Code Modulation)은 [데이터 압축](https://ko.wikipedia.org/wiki/데이터_압축 "wikilink") 방법중 예측방법에 속하며 예측값을 상수로서 사용하지 않고, 표본으로 삼은 신호의 짧은 구간에 따라 예측값을 동적으로 결정하여 그값을 사용하고 그 값과의 차이를 부호화하는 방식이다. 따라서 적합한 추정치를 사용하며, 실제값을 부호화하거나 저장하기 전에 [양자화](https://ko.wikipedia.org/wiki/양자화_\(정보_이론\) "wikilink") 과정을 거친다.
