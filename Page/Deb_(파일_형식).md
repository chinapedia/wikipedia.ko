...
**.deb**은 [데비안](https://ko.wikipedia.org/wiki/데비안 "wikilink")의 [소프트웨어 패키지](https://ko.wikipedia.org/wiki/소프트웨어_패키지 "wikilink") 포맷의 확장자이며 데비안 소프트웨어 포맷의 [바이너리 패키지에서](https://ko.wikipedia.org/wiki/바이너리_파일 "wikilink") 가장 자주 사용되는 파일 이름이다.
...
데비안 버전 0.93 이후부터, deb 파일은 ar 보존 형식으로 적용되었다. [캐노니컬](https://ko.wikipedia.org/wiki/캐노니컬 "wikilink")의 아카이브 형식 적용은 다음과 같다:
...
데비안 패키지는 데비안 기반의 GNU/리눅스 배포판 ([우분투](https://ko.wikipedia.org/wiki/우분투_\(운영_체제\) "wikilink") 등)에서 동작한다. 기본 설치 프로그램은 [dpkg](https://ko.wikipedia.org/wiki/dpkg "wikilink")이다.
