...
<!-- end list -->
  ...
  -
    유저는 라노스 왕국, 시라스 제국 중의 한 곳을 선택하게 된다.
    상대 진영 유저와 실시간 RvR를 통해 명예점수를 높일 수 있다.
...
<!-- end list -->
  ...
  -
    레기온(파벌)에 의해 전투가 발생.
    서로간의 영역을 차지하기 위해 레기온(파벌)을 만든다.

<!-- end list -->

  - [길드 워2](https://ko.wikipedia.org/wiki/길드_워2 "wikilink")
...
<!-- end list -->
  ...
  -
    호드와 얼라이언스 진영의 싸움.
    시작부터 반드시 자신의 진영을 선택해야 한다.

<!-- end list -->

  - [RF 온라인](https://ko.wikipedia.org/wiki/RF_온라인 "wikilink")
...
<!-- end list -->
  ...
  - [에이카 온라인](https://ko.wikipedia.org/wiki/에이카_온라인 "wikilink")

<!-- end list -->

  -
    전쟁을 컨셉으로 내놓은 게임으로 대규모 필드 전투를 컨셉으로 만들어졌다.
...
<!-- end list -->
  ...
  -
    천족과 마족의 대립이라는 컨셉으로 세력간 전쟁을 기반으로 한다.
...
<!-- end list -->
  ...
  -
    5개의 국가로 이루어졌으며 성물을 갖고 전쟁을 함

` 성물의 종류는 스킬공격력 , 물리공격력, 마법공격력 등. 쟁과 사냥 모두 필요한 성물이 있다`

그외 국내의 대부분 게임들이 RVR을 지향하고 있으며. [월드 오브 워 크래프트](https://ko.wikipedia.org/wiki/월드_오브_워_크래프트 "wikilink") 이후에 출시된 대부분의 [MMORPG](https://ko.wikipedia.org/wiki/MMORPG "wikilink")들이 RVR시스템을 채용하고 있다.
