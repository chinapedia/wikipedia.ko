...
**MySQL**(마이에스큐엘, )\[1\]은 세계에서 가장 많이 쓰이는\[2\] 오픈 소스의 [관계형 데이터베이스 관리 시스템](../Page/관계형_데이터베이스_관리_시스템.md "wikilink")(RDBMS)이다.\[3\] 다중 스레드, 다중 사용자 형식의 구조질의어 형식의 데이터베이스 관리 시스템으로서 [오라클이](../Page/오라클_\(기업\).md "wikilink") 관리 및 지원하고 있으며, [Qt처럼](https://ko.wikipedia.org/wiki/Qt_\(프레임워크\) "wikilink") 이중 라이선스가 적용된다. 하나의 옵션은 [GPL](https://ko.wikipedia.org/wiki/GPL "wikilink")이며, GPL 이외의 라이선스로 적용시키려는 경우 전통적인 지적재산권 라이선스의 적용을 받는다.
...
응용 프로그램에서 MySQL [데이터베이스](https://ko.wikipedia.org/wiki/데이터베이스 "wikilink")에 접근하기 위해 다수의 [프로그래밍 언어로](https://ko.wikipedia.org/wiki/프로그래밍_언어 "wikilink") 된 [API](../Page/API.md "wikilink")를 사용할 수 있다. 이들 API는 언어에 종속적이다.

MySQL은 공식적으로 아래의 프로그래밍 언어를 지원한다.

  - C/C++
  - C\#/F\#
  - 볼랜드 [델파이](https://ko.wikipedia.org/wiki/델파이 "wikilink") (dbExpress를 통한)
  - [자바](https://ko.wikipedia.org/wiki/자바_\(프로그래밍_언어\) "wikilink") (네이티브 자바 드라이버를 통한)
  - [파이썬](https://ko.wikipedia.org/wiki/파이썬 "wikilink")
  - [루비](https://ko.wikipedia.org/wiki/루비_\(프로그래밍_언어\) "wikilink")
  - REALbasic ([매킨토시](https://ko.wikipedia.org/wiki/매킨토시 "wikilink") 계열)
  ...
  - [PHP](https://ko.wikipedia.org/wiki/PHP "wikilink") {{·}}[PHP](https://ko.wikipedia.org/wiki/PHP "wikilink")4 {{·}}[PHP](https://ko.wikipedia.org/wiki/PHP "wikilink")5 {{·}}[PHP](https://ko.wikipedia.org/wiki/PHP "wikilink")6
  - [델파이](https://ko.wikipedia.org/wiki/델파이 "wikilink")1 {{·}} 델파이2 {{·}} 델파이3 {{·}}델파이4 {{·}}델파이5{{·}}델파이6{{·}}델파이7{{·}}델파이8
...
MySQL은 [미디어위키](https://ko.wikipedia.org/wiki/미디어위키 "wikilink")와 [드루팔](https://ko.wikipedia.org/wiki/드루팔 "wikilink")과 같은 인기있는 웹 애플리케이션에 사용된다. 그리고 LAMP, MAMP, WAMP (리눅스/매킨토시/윈도-아파치-MySQL-PHP/펄/파이썬) 플랫폼의 데이터베이스 구성체로서 작동하며 버그질라와 같은 오픈소스 버그 추적 도구에도 사용된다.

웹 애플리케이션으로서의 MySQL의 인기는 [PHP](https://ko.wikipedia.org/wiki/PHP "wikilink")의 인기도와 맞물려 있다. PHP는 종종 MySQL과 결합되며, 다이내믹 듀오(Dynamic Duo)라는 별칭이 붙었다. 인터넷 상의 여러 웹사이트, 혹은 서적을 통해서 MySQL과 PHP의 연동에 대한 정보를 쉽게 찾을 수 있다. 최근의 플랫폼에서는 이들의 연동을 자동으로 해 주는 경우가 있다.
...
버전 별 두드러진 특징은 다음과 같다.
  ...
  - [1994년](https://ko.wikipedia.org/wiki/1994년 "wikilink") MySQL의 원 개발(마이클 위데니우스와 데이빗 액스마크에 의한)\[30\]
  - [1995년](https://ko.wikipedia.org/wiki/1995년 "wikilink") 5월 최초의 국제화판
  - 3.19 판: 1996년 말, www.tcx.se에서
  - 3.20 판: 1997년 1월
  - [1998년](https://ko.wikipedia.org/wiki/1998년 "wikilink") 1월 8일 윈도 판(Windows 95와 NT) 출시
  ...
  - **4.1 판**: [2004년](https://ko.wikipedia.org/wiki/2004년 "wikilink") 6월 베타판으로부터, 2004년 10월 제품 출시 ([R 트리와](https://ko.wikipedia.org/wiki/R_트리 "wikilink") [B 트리](https://ko.wikipedia.org/wiki/B_트리 "wikilink"), [서브쿼리](https://ko.wikipedia.org/wiki/서브쿼리 "wikilink"), prepared statements 지원)
