...
[미적분학](https://ko.wikipedia.org/wiki/미적분학 "wikilink")에서, **테일러 정리**(-定理, )는 함수를 한 점 주변에서 [다항식](https://ko.wikipedia.org/wiki/다항식 "wikilink")으로 근사하는 정리이다.
...
\[f(x)=f(a)+f'(a)(x-a)+\frac{f''(a)}{2!}(x-a)^2+\cdots+\frac{f^{(n)}(a)}{n!}(x-a)^n+\frac{f^{(n+1)}(\xi)}{(n+1)!}(x-a)^{n+1}\] 여기서 \(\xi\in\{a+\theta(x-a)\colon 0<\theta<1\}\)이다. 이와 같은 나머지항을 **라그랑주 나머지항**(-項, )이라고 한다. 이는 [평균값 정리의](https://ko.wikipedia.org/wiki/평균값_정리 "wikilink") 일반화이다.
...
## 같이 보기
  ...
  - [로랑 급수](https://ko.wikipedia.org/wiki/로랑_급수 "wikilink")
