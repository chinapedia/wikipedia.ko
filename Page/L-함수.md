...
*L*-함수 이론은 본질적이지만, 여전히 주로 [추측](https://ko.wikipedia.org/wiki/추측 "wikilink")에 의존하는 현대 [해석적 수론의](https://ko.wikipedia.org/wiki/해석적_수론 "wikilink") 일부이다. 이것에는 [리만 제타 함수](../Page/리만_제타_함수.md "wikilink") 및 [디리클레 지표에](../Page/디리클레_지표.md "wikilink") 대한 *L*-시리즈의 일반화가 포함되어 있다. 그들의 일반적인 속성이 대부분 증명되지 않았고, 체계적으로 정리되지도 않았다.

## 구성

우선 [무한 급수 표현](../Page/무한_집합.md "wikilink")(예를 들어, [리만 제타 함수에](../Page/리만_제타_함수.md "wikilink") 대한 [디리클레 급수](../Page/디리클레_급수.md "wikilink"))인, L-시리즈와 그 복소 평면에서의 해석 확장인 *L*-함수를 구별한다. [디리클레 급수에서](../Page/디리클레_급수.md "wikilink") 정의된 *L*-시리즈로 시작한다. 다음에 소수들 위에서의 [오일러 곱을](../Page/오일러의_곱셈_공식.md "wikilink") 만든다. 이것이 복소 상반평면의 오른쪽 일부에서 수렴하는 것을 증명할 수 있는지 확인한다. 그리고 복소 평면의 나머지 영역에서도 해석적 확장을 통해 정의될 수 있는지 확인한다 (몇몇 [극점이](https://ko.wikipedia.org/wiki/극점_\(복소해석학\) "wikilink") 있을 수 있다).

이것이 ***L*-함수라 불리는** 복소 평면으로의 [유리형 함수](../Page/유리형_함수.md "wikilink") (meromorphic)확장이다. 고전적인 경우에, 그 값들과 급수 표현이 수렴하지 않는 점 근처에서의 *L*-함수의 특성이 유용하다는 것이 알려져 있다. *L*-함수는 여기에 많은 알려진 형태의 제타-함수를 포함한다. [셀베르그 클래스](../Page/셀베르그_클래스.md "wikilink")(Selberg class)는 *L*-함수의 핵심 특성을 공리화하여, 개별 함수를 넘어서는 특성들을 얻기 위해 고안되었다.
...
[버치-스위너턴다이어 추측은](../Page/버치-스위너턴다이어_추측.md "wikilink") 버치-스위너턴다이어(Bryan Birch , Peter Swinnerton-Dyer)가 1960 년대 초에 추측했으며. [타원 곡선](../Page/타원곡선.md "wikilink") *E의 유리체* (또는 다른 [대역체](../Page/대역체.md "wikilink")) 위에서의 해의 개수 즉 그 군의 자유 생성자(Generator)의 개수에 대한 것이다. 훨씬 이전에 *L*-함수를 이해하기 위한 통합 노력이 있었다.
...
## 같이 보기
  ...
  - [자기동형 L-함수](https://ko.wikipedia.org/wiki/자기동형_L-함수 "wikilink")
  - [모듈러성 정리](../Page/모듈러성_정리.md "wikilink")
  - [알틴 상수](../Page/알틴_상수.md "wikilink")
  - [L-함수의 특별한 값](../Page/L-함수의_특별한_값.md "wikilink")
  - [시미즈(Shimizu) L-함수](../Page/시미즈_L-함수.md "wikilink")
  - [표준 L-함수](https://ko.wikipedia.org/wiki/표준_L-함수 "wikilink")
...
## 외부 링크
  ...
  - [LMFDB](http://www.lmfdb.org),의 데이터베이스 L-함수,모듈 형태와 관련된 체

  - [흘끗해본 새로운(수학)세계](http://www.physorg.com/news124636003.html) L-함수의 돌파구 초월 L-함수 *Physorg.com* 3월 13,2008

  - [리만에 접근해보다](http://www.sciencenews.org/view/generic/id/9542/title/Math_Trek__Creeping_Up_on_Riemann),과학 뉴스,April2,2008

  - [사냥이 어려운 L-함수](http://www.physorg.com/news137248087.html)

  -
[분류:특수 함수](https://ko.wikipedia.org/wiki/분류:특수_함수 "wikilink") [분류:해석적 수론](https://ko.wikipedia.org/wiki/분류:해석적_수론 "wikilink") [분류:대수적 수론](https://ko.wikipedia.org/wiki/분류:대수적_수론 "wikilink")
