> This article is converted from Wikipedia: [LG 와인스마트](https://ko.wikipedia.org/wiki/LG_와인스마트).
...
와인스마트는 [4.4.2 킷캣을](https://ko.wikipedia.org/wiki/안드로이드_버전_역사 "wikilink") 기본 탑재하여 출시하였다.

## 특수 기능

### 이지홈

기존의 안드로이드 UI에서 아이콘 크기를 키우고 배열을 3 X 3으로 바꾸어서 폴더로 사용이 편하게 한 UI이다. 스마트폰 사용을 어려워하는 중장년층을 타겟으로 하였다.

### 전용키

키패드에 단축키로 삽입된 카카오톡 전용키를 누르면 카카오톡이 바로 실행된다. 필요에 따라 원하는 앱을 설정해 바로 실행할 수도 있다. SKT, LG U+ 버전은 카카오톡 전용키가 무색으로 처리되어 있지만 KT 버전은 카카오톡 로고 색상과 동일하게 처리되어 있다. 대만 내수용의 경우는 카카오톡 로고 대신에 ★모양의 핫 키가 별도로 설정되어 있다.
...
[분류:2014년 도입](https://ko.wikipedia.org/wiki/분류:2014년_도입 "wikilink") [분류:안드로이드 장치](https://ko.wikipedia.org/wiki/분류:안드로이드_장치 "wikilink") [와인스마트](https://ko.wikipedia.org/wiki/분류:LG_휴대_전화기 "wikilink")

1.  [LG '와인스마트' 출고가 39만9300원, 29일 판매 시작](http://view.asiae.co.kr/news/view.htm?idxno=2014092909270911684)
2.  [LG전자, 와인스마트 '천지인' 키패드 버전 출시](http://news.inews24.com/php/news_view.php?g_serial=859146&g_menu=020800&rrf=nv)
3.  [LG 폴더형 스마트폰, OS 업글 없다…좋은 건가?](http://www.zdnet.co.kr/news/news_view.asp?artice_id=20140929151145&type=det)