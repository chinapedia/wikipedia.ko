...
[함수해석학](../Page/함수해석학.md "wikilink")에서, **프레셰 공간**(Fréchet空間, )은 일련의 [반노름](https://ko.wikipedia.org/wiki/반노름 "wikilink")들로 위상을 정의할 수 있는 [위상 벡터 공간이다](../Page/위상_벡터_공간.md "wikilink"). [바나흐 공간의](https://ko.wikipedia.org/wiki/바나흐_공간 "wikilink") 일반화이다.\[1\]\[2\]
...
\[\|\cdot\|_i\colon X \to [0,\infty)\qquad(i\in I)\] 이 주어졌다고 하자. 그렇다면, 다음과 같은 [기저](https://ko.wikipedia.org/wiki/기저_\(위상수학\) "wikilink") \(\mathcal B\)로서 \(X\)를 [위상 벡터 공간으로](../Page/위상_벡터_공간.md "wikilink") 만들 수 있다.
...
\[\mathcal S = \left\{ \{x\in X\colon \|x-y\|_i < \epsilon\} \colon \epsilon \in \mathbb R^+,\; y\in X,\;i\in I\right\}\] 이 반노름 집합에 대하여 다음과 같은 세 조건들을 고려할 수 있다.
  ...
  - ㈎ \(I\)로 유도되는 위상 공간은 [하우스도르프 공간이다](https://ko.wikipedia.org/wiki/하우스도르프_공간 "wikilink"). 즉, 임의의 \(x\in X\)에 대하여, 만약 \(\forall i\in I\colon \|x\|_i = 0\)이라면, \(x = 0\)이다.
  - ㈏ \(I\)는 [가산 집합이다](https://ko.wikipedia.org/wiki/가산_집합 "wikilink").
...
만약 [위상 벡터 공간](../Page/위상_벡터_공간.md "wikilink") \(X\)의 위상이 ㈎를 만족시키는 반노름 집합으로 유도될 수 있다면, \(X\)는 [국소 볼록 공간이다](../Page/국소_볼록_공간.md "wikilink"). 만약 \(X\)의 위상이 ㈎·㈏·㈐를 모두 만족시키는 반노름 집합으로 유도될 수 있다면, \(X\)를 **프레셰 공간**이라고 한다.
...
프레셰 공간 \(X\)의 위상을 정의하는 [가산](https://ko.wikipedia.org/wiki/가산_집합 "wikilink") 개의 반노름의 열 \(\|-\|_{k\in\mathbb N}\)이 주어졌다고 하자. 그렇다면, \(X\) 위에 다음과 같은 평행 이동 불변 [완비](../Page/완비_거리_공간.md "wikilink") [거리 함수를](https://ko.wikipedia.org/wiki/거리_함수 "wikilink") 줄 수 있다.
...
프레셰 공간은 [바나흐 공간의](https://ko.wikipedia.org/wiki/바나흐_공간 "wikilink") 일반화이다. 바나흐 공간은 노름을 갖추지만, 프레셰 공간은 반면 [거리 공간](https://ko.wikipedia.org/wiki/거리_공간 "wikilink") 또는 [반노름](https://ko.wikipedia.org/wiki/반노름 "wikilink")의 구조를 줄 수 있으나 노름을 갖출 필요는 없다. 모든 바나흐 공간은 프레셰 공간이지만 그 역은 성립하지 않는다.

프레셰 공간의 경우 [함수해석학](../Page/함수해석학.md "wikilink")의 주요 정리들이 성립한다. 예를 들어, [한-바나흐 정리](https://ko.wikipedia.org/wiki/한-바나흐_정리 "wikilink"), [열린 사상 정리](https://ko.wikipedia.org/wiki/열린_사상_정리_\(함수해석학\) "wikilink"), [균등 유계성 원리](../Page/균등_유계성_원리.md "wikilink") 등이 성립한다. 다만, 프레셰 공간에서는 ([바나흐 공간과](https://ko.wikipedia.org/wiki/바나흐_공간 "wikilink") 달리) [역함수 정리가](https://ko.wikipedia.org/wiki/역함수_정리 "wikilink") 일반적으로 성립하지 않는다.

## 예

모든 [바나흐 공간은](https://ko.wikipedia.org/wiki/바나흐_공간 "wikilink") (자명하게) 프레셰 공간이다. 즉, 이 경우 하나의 (반)노름으로 위상이 정의된다.
...
\(B\)가 [바나흐 공간이라고](https://ko.wikipedia.org/wiki/바나흐_공간 "wikilink") 하자. 모든 \(B\) 값의 [수열](https://ko.wikipedia.org/wiki/수열 "wikilink")의 공간
...
[매끄러운 함수들의](https://ko.wikipedia.org/wiki/매끄러운_함수 "wikilink") 프레셰 공간
...
\(T\)의 [치역](https://ko.wikipedia.org/wiki/치역 "wikilink")은 다음과 같이, 치역이 양의 실수로만 구성되는 [매끄러운 함수들의](https://ko.wikipedia.org/wiki/매끄러운_함수 "wikilink") 집합이다.

\[\operatorname{im}T = \{f\in X\colon \forall x\in \mathbb R\colon f(x)>0\}\] 그런데 \(X\)의 [기저는](https://ko.wikipedia.org/wiki/기저_\(위상수학\) "wikilink")

\[B_{f,n,N,\epsilon} = \left\{g\in X\colon \max_{k\le N}\max_{-n\le x\le n} |f^{(k)}(x)-g^{(k)}(x)| < \epsilon \right\}\qquad(\epsilon\in\mathbb R^+,\;f\in X,\;n,N\in\mathbb N)\] 와 같은 꼴의 집합들로 구성되므로, \(X\)의 [열린집합](../Page/열린집합.md "wikilink") 가운데 \(T\)의 [치역](https://ko.wikipedia.org/wiki/치역 "wikilink")의 부분 집합인 것은 [공집합](https://ko.wikipedia.org/wiki/공집합 "wikilink") 밖에 없다.
