...
**구글 검색**()은 [구글](https://ko.wikipedia.org/wiki/구글 "wikilink")이 소유한 [웹 검색 엔진이다](https://ko.wikipedia.org/wiki/웹_검색_엔진 "wikilink"). 구글 검색은 [월드 와이드 웹에서](../Page/월드_와이드_웹.md "wikilink") 가장 많이 쓰이는 검색 엔진으로\[1\], 다양한 서비스를 통해 날마다 수 억 번의 쿼리를 수신한다.\[2\]
