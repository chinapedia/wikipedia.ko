...
**영의 부등식**(Young's inequality, -不等式)은 [영국](https://ko.wikipedia.org/wiki/영국 "wikilink")의 [수학자](https://ko.wikipedia.org/wiki/수학자 "wikilink")인 [윌리엄 헨리 영이](https://ko.wikipedia.org/wiki/윌리엄_헨리_영 "wikilink") 제시한 [부등식](https://ko.wikipedia.org/wiki/부등식 "wikilink")이다. 이 부등식은 [옌센 부등식](https://ko.wikipedia.org/wiki/옌센_부등식 "wikilink") 및 [민코프스키의 적분부등식에](https://ko.wikipedia.org/wiki/민코프스키의_적분부등식 "wikilink") 의해 얻을 수 있으며, [횔더 부등식을](../Page/횔더_부등식.md "wikilink") 증명하는 데 이용된다. 크게 초등적 형태와 [합성곱](../Page/합성곱.md "wikilink") 형태의 두 종류가 있다.
...
\[0, c\]에서 실수로 가는 연속이고 f(0) = 0인 [강증가함수](https://ko.wikipedia.org/wiki/강증가함수 "wikilink") f에 대해 f의 [역함수](https://ko.wikipedia.org/wiki/역함수 "wikilink")를 \(f^{-1}\) 이라 하면, 다음 부등식이 성립한다.
...
## 같이 보기
  ...
  - [옌센 부등식](https://ko.wikipedia.org/wiki/옌센_부등식 "wikilink")
