...
만약 \(E\)가 [켈러 다양체의](../Page/켈러_다양체.md "wikilink") [정칙 접다발인](https://ko.wikipedia.org/wiki/정칙_접다발 "wikilink") 경우, 천 접속은 [리만 계량으로](https://ko.wikipedia.org/wiki/리만_계량 "wikilink") 유도되는 [레비치비타 접속과](https://ko.wikipedia.org/wiki/레비치비타_접속 "wikilink") 같다.
...
비특이 복소수 [대수다양체](../Page/대수다양체.md "wikilink") \(X\) 위의 [대수적 벡터 다발](https://ko.wikipedia.org/wiki/대수적_벡터_다발 "wikilink") \(E\twoheadrightarrow X\)이 주어졌다고 하자. 그렇다면, 이에 대응되는 복소다양체 \(X^{\operatorname{an}}\) 및 [복소다양체](../Page/복소다양체.md "wikilink") 사이의 [정칙 함수](../Page/정칙_함수.md "wikilink") \(E^{\operatorname{an}}\twoheadrightarrow X^{\operatorname{an}}\)를 취할 수 있다. 이 경우, 이는 정칙 벡터 다발을 이룬다.
