...
AOD가 포함된 전화는 [슬립 모드](https://ko.wikipedia.org/wiki/슬립_모드 "wikilink") 중에 화면의 한정된 부분을 유지시킬 수 있다. AOD는 시간, 날짜, 배터리 상태를 기본적으로 표시하지만 다양한 종류의 알림과 [화면 보호기를](../Page/화면_보호기.md "wikilink") 표시하도록 구성할 수 있다.
