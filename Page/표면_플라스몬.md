...
금속 표면에 유도된 표면 플라스몬의 분산 관계식은 다음의 [맥스웰 방정식으로부터](https://ko.wikipedia.org/wiki/맥스웰_방정식 "wikilink") 알 수 있다.
...
여기서 \({\varepsilon }_{1}\), \({\varepsilon }_{2}\)는 각 부분의 [유전율](https://ko.wikipedia.org/wiki/유전율 "wikilink")이다. 유전체와 금속의 경계면에서 가로방향 전기장의 연속 조건에 의해 자기장와 전기장의 경계 조건은 다음과 같이 주어진다.
