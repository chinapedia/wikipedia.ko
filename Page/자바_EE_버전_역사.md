...
## J2EE 1.2 (1999년 10월 12일)

사양 [다운로드](http://java.sun.com/j2ee/1.2/index.jsp)
...
사양 리스트 :
  ...
  - [JAF](https://ko.wikipedia.org/wiki/자바빈즈_액티베이션_프레임워크 "wikilink") (JavaBeans Activation Framework), 버전 1.0

## J2EE 1.3 (2001년 9월 24일)

[JSR 58](http://jcp.org/en/jsr/detail?id=58) 기준으로 개발
...
사양 리스트 :
  ...
  - [자바 메일](https://ko.wikipedia.org/wiki/자바_메일 "wikilink") API 버전 1.1
  - [JAF](https://ko.wikipedia.org/wiki/자바빈즈_액티베이션_프레임워크 "wikilink") (JavaBeans Activation Framework), 버전 1.0
  - [JCA](https://ko.wikipedia.org/wiki/JCA "wikilink"), 버전 1.0
  - [JAXP](https://ko.wikipedia.org/wiki/JAXP "wikilink") , 버전 1.0
  - [JAAS](https://ko.wikipedia.org/wiki/JAAS "wikilink") , 버전 1.0

## J2EE 1.4 (2003년 11월 11일)

[JSR 151](http://jcp.org/en/jsr/detail?id=151) 기준으로 개발
...
사양 리스트:
  ...
  - [JAF](https://ko.wikipedia.org/wiki/자바빈즈_액티베이션_프레임워크 "wikilink") (JavaBeans Activation Framework), 버전 1.0
  - [JCA](https://ko.wikipedia.org/wiki/JCA "wikilink"), 버전 1.5
...
## Java EE 5 (2006년 5월 11일)

[JSR 244](http://jcp.org/en/jsr/detail?id=244) 기준으로 개발
...
<!-- end list -->
  ...
  - [자바 서버 페이지](https://ko.wikipedia.org/wiki/자바_서버_페이지 "wikilink") (Java Server Pages, JSP), 버전 2.1
  - [자바 서블릿](../Page/자바_서블릿.md "wikilink") (Java Servlet), 버전 2.5
  - [자바 서버 페이스](https://ko.wikipedia.org/wiki/자바_서버_페이스 "wikilink") (Java Server Faces, JSF), 버전 1.2
  - [자바 서버 페이지 표준 태그 라이브러리](https://ko.wikipedia.org/wiki/자바_서버_페이지_표준_태그_라이브러리 "wikilink") (Java ServerPages Standard Tag Library, JSTL), 버전 1.2
...
<!-- end list -->
  ...
  - [JAF](https://ko.wikipedia.org/wiki/자바빈즈_액티베이션_프레임워크 "wikilink") (JavaBeans Activation Framework), 버전 1.1
  - [JCA](https://ko.wikipedia.org/wiki/JCA "wikilink") (J2EE Connector Architecture, JCA), 버전 1.5
...
[JSR 313](http://jcp.org/en/jsr/detail?id=313) 기준으로 개발중이었으나 취소되었다. 현재 [JSR 316](http://jcp.org/en/jsr/detail?id=316) 기반하에 2008년 발표를 목표로 개발중이다.

새로이 추가되는 사양

  - [JSR](https://ko.wikipedia.org/wiki/자바_커뮤니티_프로세스#JSR "wikilink")-196 Java Authentication SPI for Containers
