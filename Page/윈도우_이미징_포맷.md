...
**윈도우 이미징 포맷**(Windows Imaging Format, WIM)은 [파일](https://ko.wikipedia.org/wiki/파일 "wikilink") 기반 [디스크 이미지](https://ko.wikipedia.org/wiki/디스크_이미지 "wikilink") [포맷이다](https://ko.wikipedia.org/wiki/파일_포맷 "wikilink"). [마이크로소프트](https://ko.wikipedia.org/wiki/마이크로소프트 "wikilink")가 [윈도우 비스타](https://ko.wikipedia.org/wiki/윈도우_비스타 "wikilink") 및 차기 버전의 [윈도우](https://ko.wikipedia.org/wiki/마이크로소프트_윈도우 "wikilink") [운영 체제](https://ko.wikipedia.org/wiki/운영_체제 "wikilink") 계열 및 [윈도우 구형 PC를 위한 펀더멘털의](https://ko.wikipedia.org/wiki/윈도우_구형_PC를_위한_펀더멘털 "wikilink") 배치를 지원할 목적으로 개발하였다.\[1\]

## 설계

다른 [디스크 이미지](https://ko.wikipedia.org/wiki/디스크_이미지 "wikilink") 포맷들처럼 WIM [파일에는](https://ko.wikipedia.org/wiki/컴퓨터_파일 "wikilink") 여러 파일들의 집합과 관련 [파일 시스템](https://ko.wikipedia.org/wiki/파일_시스템 "wikilink") [메타데이터](https://ko.wikipedia.org/wiki/메타데이터 "wikilink")를 담고 있다. 그러나 [섹터](../Page/디스크_섹터.md "wikilink") 기반 포맷([ISO나](https://ko.wikipedia.org/wiki/ISO_이미지 "wikilink") [VHD](https://ko.wikipedia.org/wiki/VHD_\(파일_포맷\) "wikilink"))과는 달리 WIM은 파일 기반이다: WIM의 필수 정보 단위는 파일이다.
...
## 외부 링크
  ...
  - [ImageX and WIM Image Format](http://technet.microsoft.com/en-us/library/cc507842.aspx) - [마이크로소프트 테크넷](https://ko.wikipedia.org/wiki/마이크로소프트_테크넷 "wikilink")
