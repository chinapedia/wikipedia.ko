...
반복 길이 부호화를 사용하는 대표적인 파일 형식으로 [PCX](https://ko.wikipedia.org/wiki/PCX "wikilink"), [BMP](https://ko.wikipedia.org/wiki/BMP_파일_포맷 "wikilink"), [ILBM](https://ko.wikipedia.org/wiki/ILBM "wikilink") 등이 있다.
