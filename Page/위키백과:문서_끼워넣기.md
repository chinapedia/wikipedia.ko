...
위키백과에서는 **`{{ }}`** 문법을 써서, 한 문서를 다른 문서 안에 **끼워넣을**(transclude) 수 있습니다. [HTML](../Page/HTML.md "wikilink")의 아이프레임과 비슷한 일을 합니다. 보통 [틀을](https://ko.wikipedia.org/wiki/위키백과:틀 "wikilink") 사용하는 데 씁니다.
