...
[섬네일](https://ko.wikipedia.org/wiki/파일:Eprom.jpg "wikilink") **EPROM**(Erasable PROM, 삭제 가능한 롬)은 필요할 때 기억된 내용을 지우고 다른 내용을 기록할 수 있는 롬이다. 지우는 방법에 따라 [자외선](https://ko.wikipedia.org/wiki/자외선 "wikilink")으로 지울 수 있는 **UVEPROM**(Ultra-Violet Erasable Programmable Read Only Memory)과 높은 전압으로 지울 수 있는 **EEPROM**(Electrically Erasable Programmable Read-Only Memory)로 나뉜다. 하지만 일반적으로 UVEPROM을 가리킨다.
...
UVEPROM은 과거 [메인보드](https://ko.wikipedia.org/wiki/메인보드 "wikilink"), [그래픽카드](https://ko.wikipedia.org/wiki/그래픽카드 "wikilink")의 [바이오스](https://ko.wikipedia.org/wiki/바이오스 "wikilink") 칩이나 게임기의 롬으로 많이 사용되었다.

그리고 칩 패키지에서 창을 없앤 UVEPROM을 **OTP**(one-time programmable)라고 하는데 소거창이 없기 때문에 한번 기록 후 지울 수 없으며 주로 [마이크로컨트롤러](https://ko.wikipedia.org/wiki/마이크로컨트롤러 "wikilink")에서 볼 수 있다.

| EPROM 모델명      | 용량 ([비트](https://ko.wikipedia.org/wiki/비트_\(단위\) "wikilink")) | 용량 ([바이트](https://ko.wikipedia.org/wiki/바이트 "wikilink")) | 길이([hex](https://ko.wikipedia.org/wiki/16진수 "wikilink")) | 주소(hex) | 공정         |
| -------------- | ------------------------------------------------------------- | -------------------------------------------------------- | -------------------------------------------------------- | ------- | ---------- |
...
## 같이 보기
  ...
  - [ROM](https://ko.wikipedia.org/wiki/고정_기억_장치 "wikilink")
