...
[일반위상수학](../Page/일반위상수학.md "wikilink")에서, **정규 공간**(正規空間, )은 [서로소](../Page/서로소_집합.md "wikilink") [닫힌집합](https://ko.wikipedia.org/wiki/닫힌집합 "wikilink")들을 [서로소](../Page/서로소_집합.md "wikilink") [근방](../Page/근방.md "wikilink") 또는 [연속](https://ko.wikipedia.org/wiki/연속_함수 "wikilink") 실함수로 분리할 수 있는 [위상 공간이다](https://ko.wikipedia.org/wiki/위상_공간_\(수학\) "wikilink"). 정규 공간에는 "충분한 수의" 연속 실함수가 존재하여, [닫힌집합](https://ko.wikipedia.org/wiki/닫힌집합 "wikilink")에 정의된 실함수를 공간 전체로 연장할 수 있다 (**티체 확장 정리** Tietze擴張定理, ).
...
[섬네일](https://ko.wikipedia.org/wiki/파일:Normal_space.svg "wikilink") [위상 공간](https://ko.wikipedia.org/wiki/위상_공간_\(수학\) "wikilink") \(X\)에 대하여 다음 네 조건이 서로 [동치](../Page/동치.md "wikilink")이며, 이를 만족시키는 [위상 공간을](https://ko.wikipedia.org/wiki/위상_공간_\(수학\) "wikilink") **정규 공간**이라고 한다.
  ...
  - (**우리손 보조정리** Урысон補助定理, ) 임의의 두 [서로소](../Page/서로소_집합.md "wikilink") [닫힌집합](https://ko.wikipedia.org/wiki/닫힌집합 "wikilink") \(E,F\subseteq X\)에 대하여, \(f|_E=0\)이자 \(f|_F=1\)인 [연속 함수](https://ko.wikipedia.org/wiki/연속_함수 "wikilink") \(f\colon X\to[0,1]\)가 존재한다.\[1\]
  - (실수 **티체 확장 정리**) 임의의 [닫힌집합](https://ko.wikipedia.org/wiki/닫힌집합 "wikilink") \(E\subseteq X\) 및 [연속 함수](https://ko.wikipedia.org/wiki/연속_함수 "wikilink") \(f\colon E\to\mathbb R\)에 대하여, \(\tilde f|_E=f\)가 되는 [연속 함수](https://ko.wikipedia.org/wiki/연속_함수 "wikilink") \(\tilde f\colon X\to\mathbb R\)가 존재한다.\[2\]
  - (폐구간 **티체 확장 정리**) 임의의 [닫힌집합](https://ko.wikipedia.org/wiki/닫힌집합 "wikilink") \(E\subseteq X\) 및 [폐구간](https://ko.wikipedia.org/wiki/폐구간 "wikilink") \([a,b]\subseteq\mathbb R\) 및 [연속 함수](https://ko.wikipedia.org/wiki/연속_함수 "wikilink") \(f\colon E\to[a,b]\)에 대하여, \(\tilde f|_E=f\)가 되는 [연속 함수](https://ko.wikipedia.org/wiki/연속_함수 "wikilink") \(\tilde f\colon X\to[a,b]\)가 존재한다.\[3\]

즉, 두 [닫힌집합](https://ko.wikipedia.org/wiki/닫힌집합 "wikilink")을 [근방](../Page/근방.md "wikilink")으로 분리하는 것은 실함수로서 분리하는 것과 동치이다.

**T<sub>4</sub> 공간**(T<sub>4</sub>空間, )은 정규 [하우스도르프 공간이다](https://ko.wikipedia.org/wiki/하우스도르프_공간 "wikilink").
...
(이는 정규 공간의 정의와 비교했을 때 \(E\)와 \(F\)를 각각 그 [여집합](https://ko.wikipedia.org/wiki/여집합 "wikilink") \(A\), \(B\)로 대체한 것이다.)
...
[위상 공간](https://ko.wikipedia.org/wiki/위상_공간_\(수학\) "wikilink") \(X\)에 대하여 다음 세 조건이 서로 [동치](../Page/동치.md "wikilink")이며, 이를 만족시키는 위상 공간을 **완전 정규 공간**(完全正規空間, )이라고 한다.\[4\]
  ...
  - 임의의 서로소 [닫힌집합](https://ko.wikipedia.org/wiki/닫힌집합 "wikilink") \(E,F\subseteq X\)에 대하여, \(f^{-1}(0)=E\)이자 \(f^{-1}(1)=F\)인 [연속 함수](https://ko.wikipedia.org/wiki/연속_함수 "wikilink") \(f\colon X\to[0,1]\)가 존재한다.
  - 임의의 서로소 [닫힌집합](https://ko.wikipedia.org/wiki/닫힌집합 "wikilink") \(E,F\subseteq X\)에 대하여, \(f^{-1}(0)=E\)이자 \(f^{-1}(1)=F\)인 [연속 함수](https://ko.wikipedia.org/wiki/연속_함수 "wikilink") \(f\colon X\to\mathbb R\)가 존재한다.
...
| ------------------------------------------------------------------------------------------------------------ | --------------------------------------------------------------- | --------------------------------------------------------------------- |
| 점과 점                                                                                                         | [하우스도르프 공간](https://ko.wikipedia.org/wiki/하우스도르프_공간 "wikilink") | [완비 하우스도르프 공간](https://ko.wikipedia.org/wiki/완비_하우스도르프_공간 "wikilink") |
...
다음과 같은 포함 관계가 성립한다.\[5\]
  ...
  -
    [거리화 가능 공간](../Page/거리화_가능_공간.md "wikilink") ⊊ 완전 정규 하우스도르프 공간(T<sub>6</sub>) ⊊ 유전 정규 하우스도르프 공간(T<sub>5</sub>) ⊊ 정규 하우스도르프 공간(T<sub>4</sub>) ⊊ [티호노프 공간](../Page/티호노프_공간.md "wikilink")(T<sub>3½</sub>) ⊊ ([정칙](../Page/정칙_공간.md "wikilink") [하우스도르프 공간](https://ko.wikipedia.org/wiki/하우스도르프_공간 "wikilink")(T<sub>3</sub>) ∩ [완비 하우스도르프 공간](https://ko.wikipedia.org/wiki/완비_하우스도르프_공간 "wikilink"))
    완전 정규 공간 ⊊ 유전 정규 공간 ⊊ 정규 공간

모든 [파라콤팩트](https://ko.wikipedia.org/wiki/파라콤팩트 "wikilink") [하우스도르프 공간은](https://ko.wikipedia.org/wiki/하우스도르프_공간 "wikilink") 정규 공간이다.
...
정규 공간의 [닫힌집합](https://ko.wikipedia.org/wiki/닫힌집합 "wikilink")은 정규 공간이다. 그러나 이는 임의의 [부분 집합에](https://ko.wikipedia.org/wiki/부분_집합 "wikilink") 대하여 성립하지 않을 수 있다. 모든 [부분 공간이](https://ko.wikipedia.org/wiki/부분_공간 "wikilink") 정규 공간인 위상 공간을 **유전 정규 공간**(遺傳正規空間, ) 또는 **완비 정규 공간**(完備正規空間, )이라고 하며, 유전 정규 [하우스도르프 공간을](https://ko.wikipedia.org/wiki/하우스도르프_공간 "wikilink") **T<sub>5</sub> 공간**(T<sub>5</sub>空間, )이라고 한다.

정규 공간 \(X\)와 [연속 함수](https://ko.wikipedia.org/wiki/연속_함수 "wikilink") \(f\colon X\to Y\)가 주어졌을 때, 만약 \(f\)의 [치역](https://ko.wikipedia.org/wiki/치역 "wikilink") \(f(X)\)가 \(Y\)의 [닫힌집합](https://ko.wikipedia.org/wiki/닫힌집합 "wikilink")이라면 \(f(X)\)는 정규 공간이다.
...
[대수기하학](https://ko.wikipedia.org/wiki/대수기하학 "wikilink")이나 [일반위상수학](../Page/일반위상수학.md "wikilink")을 제외하고, 수학에 흔히 등장하는 대부분의 위상 공간은 정규 공간이다.
...
정규 공간의 개념은 1923년에 [오스트리아](https://ko.wikipedia.org/wiki/오스트리아 "wikilink")의 수학자 하인리히 프란츠 프리드리히 티체(, 1880\~1964)가 도입하였다.\[10\]
