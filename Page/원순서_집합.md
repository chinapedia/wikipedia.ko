...
[순서론](../Page/순서론.md "wikilink")에서, **원순서 집합**(原順序集合, )은 그 속의 두 원소를 [추이적으로](https://ko.wikipedia.org/wiki/추이적_관계 "wikilink") 비교할 수 있는 [집합](../Page/집합.md "wikilink")이다. [부분 순서 집합과](../Page/부분_순서_집합.md "wikilink"), [동치 관계를](https://ko.wikipedia.org/wiki/동치_관계 "wikilink") 갖는 [집합](../Page/집합.md "wikilink")의 공통적인 일반화이다. 어떤 집합의 [몫집합](https://ko.wikipedia.org/wiki/몫집합 "wikilink") 위의 부분 순서로도 생각할 수 있다.
