...
**XPointer**(XML Pointer Language) 는 웹 상에 존재하는 [XML](https://ko.wikipedia.org/wiki/XML "wikilink") 문서의 일부분에 주소를 부여할 수 있는 방법을 제공하는 [W3C](https://ko.wikipedia.org/wiki/W3C "wikilink") 표준 언어이다.
