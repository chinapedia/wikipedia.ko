...
`           t = '`[`'``   ``..``   ``args.event``   ``..``   ``'`](https://ko.wikipedia.org/wiki/'_.._args.event_.._'_at_the_'_.._args.games_.._' "wikilink")`'`
`           t = t .. ' at the`
`' .. '`[`'``   ``..``   ``args.games``   ``..``   ``'`](https://ko.wikipedia.org/wiki/'_.._args.games_.._' "wikilink")`'`
`       end`
...
[Category:Articles_using_sidebar_games_events_without_correct_name](https://ko.wikipedia.org/wiki/Category:Articles_using_sidebar_games_events_without_correct_name "wikilink")