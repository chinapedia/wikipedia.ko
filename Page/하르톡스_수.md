...
[집합론](../Page/집합론.md "wikilink")에서, **하르톡스 수**(Hartogs數, )는 주어진 집합의 어떤 부분 집합과도 크기가 같지 않은 최소의 [순서수](https://ko.wikipedia.org/wiki/순서수 "wikilink")이다.\[1\]

## 정의

[순서수](https://ko.wikipedia.org/wiki/순서수 "wikilink")의 폰 노이만 정의를 취했을 때, [집합](https://ko.wikipedia.org/wiki/집합 "wikilink") \(X\)의 **하르톡스 수** \(\operatorname h(X)\)는 [단사 함수](https://ko.wikipedia.org/wiki/단사_함수 "wikilink") \(\operatorname h(X)\hookrightarrow X\)가 존재하지 않는 최소 순서수이다.
...
**하르톡스 정리**(Hartogs定理, )에 따르면, 모든 집합은 하르톡스 수를 갖는다. 이 정리는 [선택 공리를](https://ko.wikipedia.org/wiki/선택_공리 "wikilink") 사용하지 않고, [체르멜로-프렝켈 집합론에서](../Page/체르멜로-프렝켈_집합론.md "wikilink") 증명할 수 있다. 또한, 하르톡스 수는 정의에 따라 유일하다.  다음과 같은 [모임](../Page/모임_\(수학\).md "wikilink") \(\alpha\)를 정의하자.
...
[독일](https://ko.wikipedia.org/wiki/독일 "wikilink")의 수학자 [프리드리히 하르톡스가](../Page/프리드리히_하르톡스.md "wikilink") 증명하였다.
