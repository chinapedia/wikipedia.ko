...
[기계 학습](https://ko.wikipedia.org/wiki/기계_학습 "wikilink") 분야에서 [통계적 분류는](https://ko.wikipedia.org/wiki/통계적_분류 "wikilink") 개체의 속성을 이용하여 그 개체가 속하는 그룹, 또는 클래스를 판별하는 것을 목표로 한다. **선형 분류**에서는 주어진 속성의 [선형결합](https://ko.wikipedia.org/wiki/선형결합 "wikilink")을 바탕으로 분류를 수행한다. 개체의 속성은 [피쳐 값이라고](https://ko.wikipedia.org/wiki/피쳐_\(기계_학습\) "wikilink") 부르기도 하는데, 보통 [피쳐 벡터라는](https://ko.wikipedia.org/wiki/피쳐_벡터 "wikilink") 벡터 형태로 제공한다.

## 정의

[thumb](https://ko.wikipedia.org/wiki/파일:Svm_separating_hyperplanes.png "wikilink")
