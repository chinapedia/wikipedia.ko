...
[thumb](https://ko.wikipedia.org/wiki/파일:MediaWiki-smaller-logo.png "wikilink") [오픈 소스](https://ko.wikipedia.org/wiki/오픈_소스 "wikilink") [위키 엔진](https://ko.wikipedia.org/wiki/위키_소프트웨어 "wikilink") [미디어위키](https://ko.wikipedia.org/wiki/미디어위키 "wikilink")의 첫 버전인 1.1 버전은 2003년, 첫 공개되었다. 아래 목록은 현재까지 공개된 미디어위키의 공개 버전 역사를 나열한다.
