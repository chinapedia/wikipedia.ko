> This article is converted from Wikipedia: [벌컨 \(API\)](https://ko.wikipedia.org/wiki/벌컨_\(API\)).


**벌컨**(Vulkan)은 오버헤드가 적은 크로스 플랫폼 3D 그래픽스 및 컴퓨팅 API이다. 이는 GDC 2015에서 [크로노스 그룹에](../Page/크로노스_그룹.md "wikilink") 의해 처음으로 소개되었다.

초기의 Vulkan API는 [OpenGL](../Page/OpenGL.md "wikilink")의 차세대 버전으로 준비되었는데, 현재는 "OpenGL" 이라는 이름을 이어가지 않고 Vulkan 이라는 이름으로 결정되었다.

OpenGL처럼 Vulkan은 게임이나 상호작용성 미디어와 같은 고성능 실시간 3D 그래픽스 애플리케이션을 모든 플랫폼에서 고성능으로 CPU를 적게 사용하도록 개발하는 것을 목표로 만들어진 [API](../Page/API.md "wikilink")이며 [마이크로소프트](../Page/마이크로소프트.md "wikilink")의 [Direct3D 12](https://ko.wikipedia.org/wiki/Direct3D_12 "wikilink"), [애플](../Page/애플.md "wikilink")의 [메탈](../Page/메탈_\(API\).md "wikilink"), [AMD](https://ko.wikipedia.org/wiki/AMD "wikilink")의 [맨틀과](../Page/맨틀_\(API\).md "wikilink") 같은 성격의 [API](../Page/API.md "wikilink")이다. CPU 사용량에 대해서 더 이야기 하자면 Vulkan은 [멀티 코어](../Page/멀티_코어.md "wikilink") CPU의 여러 코어 사이에 로드를 더 잘 분배할 수 있다.

## 역사

크로노스 그룹은 2014년 7월 차세대 그래픽스 API를 만들기 위한 프로젝트를 시작하였으며, 이는 [밸브 코퍼레이션의](../Page/밸브_코퍼레이션.md "wikilink") 킥오프 미팅과 함께한다.\[1\] [SIGGRAPH](../Page/SIGGRAPH.md "wikilink") 2014에서 이 프로젝트는 참여자들의 요청에 따라 공개 발표되었다.\[2\]
...
### 비디오 게임
  ...
  - [둠](../Page/둠_\(2016년_비디오_게임\).md "wikilink") - 2016년 7월 벌컨 지원을 공개.\[5\]
  - vkQuake - 벌컨 [퀘이크](../Page/퀘이크_\(비디오_게임\).md "wikilink") [이식을](../Page/이식_\(컴퓨팅\).md "wikilink") 2016년 7월 공개.\[6\]\[7\]
  - [Roblox](https://ko.wikipedia.org/wiki/Roblox "wikilink") - 2017년 3월, Roblox를 위한 벌컨 지원이 추가됨.
  - [Star Citizen](https://ko.wikipedia.org/wiki/Star_Citizen "wikilink") - 2017년 3월, 클라우드 임페리엄 게임즈의 그래픽스 프로그래밍 감독 Alistair Brown은 공식 스타 시티즌 포럼에서 클라우드 임페리엄이 이제 스타 시티즌과 Squadron 42에 벌컨 구현을 집중할 것이라고 발표하였다. [DirectX](../Page/DirectX.md "wikilink") 지원은 중단될 것인데, 이는 고객들이 윈도우 10을 사용하도록 강제하기 때문이다.\[8\]
  - [매드 맥스](../Page/매드_맥스.md "wikilink") - 2017년 3월, 개발자들은 리눅스 포팅으로 예외적으로 벌컨의 베타 지원을 추가하였다.\[9\]
...
### 게임 콘솔 에뮬레이터
  ...
  - [돌핀](../Page/돌핀_\(에뮬레이터\).md "wikilink")\[11\]
...
### 게임 엔진
  ...
  - [소스](../Page/소스_\(게임_엔진\).md "wikilink") - 2015년 3월, [밸브 코퍼레이션은](../Page/밸브_코퍼레이션.md "wikilink") 소스 2 엔진을 발표하였으며 이는 오리지널 [소스](../Page/소스_\(게임_엔진\).md "wikilink") 엔진의 뒤를 이으며 벌컨을 지원한다.\[13\]\[14\]
  - 시리어스 엔진 4 - 2016년 2월, [Croteam](https://ko.wikipedia.org/wiki/Croteam "wikilink")은 시리어스 엔진에 벌컨을 지원하고 있었다고 발표하였다.\[15\]
  - [언리얼 엔진](../Page/언리얼_엔진.md "wikilink") - 2016년 2월,[에픽게임즈](../Page/에픽게임즈.md "wikilink")는 언리얼 엔진 4가 [삼성그룹](../Page/삼성그룹.md "wikilink")의 [삼성 갤럭시 S7](../Page/삼성_갤럭시_S7.md "wikilink") 언팩 행사에서 벌컨을 지원할 것임을 발표하였다.\[16\]\[17\]
  ...
  - [id Tech 6](https://ko.wikipedia.org/wiki/id_Tech_6 "wikilink") - 2016년 5월, [이드 소프트웨어는](../Page/이드_소프트웨어.md "wikilink") 테크 6 엔진을 구동하는 둠이 벌컨을 지원할 것이라 발표하였다.\[20\]
  - [Xenko](https://ko.wikipedia.org/wiki/Xenko "wikilink") - 2016년 7월 벌컨 지원이 추가되었다.\[21\]
  - [유니티](../Page/유니티_\(게임_엔진\).md "wikilink") - 이 엔진은 버전 5.6부터 벌컨 지원이 추가되었다.\[22\]
  - [크라이엔진](../Page/크라이엔진.md "wikilink") - 5.4 릴리스에 벌컨 지원이 추가되었다.\[23\]
...
벌컨 윈도우 시스템 통합(Vulkan Window System Integration, WSI)은 [EGL이](../Page/EGL_\(API\).md "wikilink") OpenGL ES를 위해 하는 것과 동일한 것을 벌컨을 위해 한다.\[32\] EGL은 네이티브 플랫폼 윈도잉 시스템과 통신할 목적으로 OpenGL ES 프로그램에 쓰인다. EGL은 컨텍스트 관리, 표면 바인딩, 렌더링 동기화를 관리한다.

## 호환성

| 기업                                                                   | 하드웨어                                 | 소프트웨어 지원: Vulkan 1.0                                                                                              |
| -------------------------------------------------------------------- | ------------------------------------ | ----------------------------------------------------------------------------------------------------------------- |
| 마이크로아키텍처                                                             | 이용 가능 시점                             | GPU ([칩](../Page/다이_\(집적_회로\).md "wikilink"))                                                                     |
| AMD                                                                  |                                      |                                                                                                                   |
| [GCN 5th](../Page/그래픽스_코어_넥스트.md "wikilink")                         | 2017년 08월                            | Vega 10                                                                                                           |
| [GCN 4th](../Page/그래픽스_코어_넥스트.md "wikilink")                         | 2016년 06월                            | Polaris 10, Polaris 11, Polaris 12                                                                                |
| [GCN 3rd](../Page/그래픽스_코어_넥스트.md "wikilink")                         | 2014년 08월                            | Tonga, Fiji, [Carrizo](https://ko.wikipedia.org/wiki/엑스카베이터_\(마이크로아키텍처\) "wikilink")                              |
| [GCN 2nd](../Page/그래픽스_코어_넥스트.md "wikilink")                         | 2013년 03월                            | Bonaire, Hawaii, [Kaveri](../Page/스팀롤러_\(마이크로아키텍처\).md "wikilink"), Kabini, Temash, Mullins, Beema, Carrizo-L     |
| [GCN 1st](../Page/그래픽스_코어_넥스트.md "wikilink")                         | 2012년 01월                            | Oland, Cape Verde, Pitcairn, Tahiti                                                                               |
| [TeraScale 3](../Page/테라스케일_\(마이크로아키텍처\).md "wikilink")              | 2010년 12월                            | Cayman, Trinity/Richland                                                                                          |
| [TeraScale 2](../Page/테라스케일_\(마이크로아키텍처\).md "wikilink")              | 2009년 09월                            | Cedar, Cypress, Juniper, Redwood, Palm, Sumo                                                                      |
| [TeraScale 1](../Page/테라스케일_\(마이크로아키텍처\).md "wikilink")              | 2007년 05월                            | R600, RV630, RV610, RV790, RV770, …                                                                               |
| Nvidia                                                               |                                      |                                                                                                                   |
| [볼타](https://ko.wikipedia.org/wiki/볼타_\(마이크로아키텍처\) "wikilink")       | December 2017                        | GV10x                                                                                                             |
| [파스칼](../Page/파스칼_\(마이크로아키텍처\).md "wikilink")                        | 2016년 05월                            | GP10x                                                                                                             |
...
| Intel                                                                | [커피레이크](../Page/커피레이크.md "wikilink") | 2017년 10월                                                                                                         |
...
| [파워VR](../Page/파워VR.md "wikilink") Series 8                          | 2016년 02월                            | GE8200, GE8300                                                                                                    |
...
| Qualcomm                                                             |                                      |                                                                                                                   |
| [아드레노](https://ko.wikipedia.org/wiki/아드레노 "wikilink") 500 series     |                                      | Adreno 510, Adreno 530, Adreno 540, adreno 506                                                                    |
...
## 같이 보기
  ...
  - [Direct3D](../Page/Direct3D.md "wikilink") - 벌컨의 주 경쟁 API
  - [OpenGL](../Page/OpenGL.md "wikilink") - 크로노스 그룹의 다른 그래픽스 API
  - [OpenCL](../Page/OpenCL.md "wikilink") - 크로노스 그룹의 [이기종 컴퓨팅](../Page/이기종_컴퓨팅.md "wikilink") 프레임워크
  - [맨틀](../Page/맨틀_\(API\).md "wikilink") - 벌컨의 재단 AMD의 낮은 수준의 그래픽스 및 연산 API
