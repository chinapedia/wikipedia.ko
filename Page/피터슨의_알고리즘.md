> This article is converted from Wikipedia: [피터슨의 알고리즘](https://ko.wikipedia.org/wiki/피터슨의_알고리즘).
...
## 외부 링크
  ...
  - [자바 환경에서 피터슨의 알고리즘 구현](https://web.archive.org/web/20070929095503/http://paul.luminos.nl/documents/show_document.php?d=339): 문서와 소스 코드를 담고 있다.
