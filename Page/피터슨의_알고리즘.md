...
**피터슨의 알고리즘**(Peterson's algorithm)은 [상호 배제를](https://ko.wikipedia.org/wiki/상호_배제 "wikilink") 위한 [병렬 프로그래밍](https://ko.wikipedia.org/wiki/병렬_컴퓨팅 "wikilink") [알고리즘](https://ko.wikipedia.org/wiki/알고리즘 "wikilink")으로서, 공유 메모리를 활용하여 여러 개의 프로세스가 하나의 자원을 함께 사용할 때 문제가 발생하지 않도록 해준다. [수학자](https://ko.wikipedia.org/wiki/수학자 "wikilink") [개리 피터슨](https://ko.wikipedia.org/wiki/개리_피터슨 "wikilink")(Gary Peterson)은 이 알고리즘을 [1981년](https://ko.wikipedia.org/wiki/1981년 "wikilink")에 [로체스터 대학에서](https://ko.wikipedia.org/wiki/로체스터_대학 "wikilink") 발표하였다. 발표 당시의 알고리즘은 프로세스가 2개인 경우만 적용 가능하고, 이후 3개 이상의 경우에도 적용할 수 있는 방법이 논의되고 있다.
...
## 두 [POSIX](https://ko.wikipedia.org/wiki/POSIX "wikilink") 스레드를 활용하여 C언어로 구현한 예
