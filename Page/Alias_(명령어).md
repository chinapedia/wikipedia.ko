...
[컴퓨팅](https://ko.wikipedia.org/wiki/컴퓨팅 "wikilink")에서 **alias**는 다양한 [명령 줄 인터프리터](https://ko.wikipedia.org/wiki/명령_줄_인터페이스 "wikilink")(워드를 다른 문자열로 치환할 수 있는 [유닉스 셸](https://ko.wikipedia.org/wiki/유닉스_셸 "wikilink"), [4DOS](https://ko.wikipedia.org/wiki/4DOS "wikilink")/[4NT](https://ko.wikipedia.org/wiki/4NT "wikilink"), [윈도우 파워셸](https://ko.wikipedia.org/wiki/윈도우_파워셸 "wikilink") 등의 [셸](https://ko.wikipedia.org/wiki/셸 "wikilink"))의 명령어이다. 시스템 명령어를 단축시키기 위해 주로 사용되며, 그 외에 주기적으로 사용되는 명령어에 기본 변수를 추가하기 위해 사용된다. [MS-DOS](https://ko.wikipedia.org/wiki/MS-DOS "wikilink")와 [마이크로소프트 윈도우](https://ko.wikipedia.org/wiki/마이크로소프트_윈도우 "wikilink") 운영 체제의 앨리어스 기능은 [도스키](https://ko.wikipedia.org/wiki/도스키 "wikilink")(DOSKey) 명령 줄 유틸리티를 통해 제공된다.
...
비영구적인 별칭은 alias 명령에 이름/값 쌍을 인자로 지정하여 만들 수 있다. [유닉스 셸에서](https://ko.wikipedia.org/wiki/유닉스_셸 "wikilink") 문법은 다음과 같다:
...
이와 동일한 [C 셸이나](https://ko.wikipedia.org/wiki/C_셸 "wikilink") [tcsh](https://ko.wikipedia.org/wiki/tcsh "wikilink") 셸의 문법은 다음과 같다:
...
유닉스에서 alias는 [C 셸에](https://ko.wikipedia.org/wiki/C_셸 "wikilink") 도입되었으며 [tcsh](https://ko.wikipedia.org/wiki/tcsh "wikilink")와 [배시와](https://ko.wikipedia.org/wiki/배시_\(유닉스_셸\) "wikilink") 같은 파생 셸들에도 생존해 있다. C 셸의 별칭들은 하나의 줄까지로 제한되었다. 단순한 바로 가기 명령을 만드는 데는 유용하였으나 더 복잡한 구성체에는 적합하지 않았다. 구 버전의 [본 셸은](https://ko.wikipedia.org/wiki/본_셸 "wikilink") alias를 제공하지 않았으나 csh alias 개념보다 더 강력한 기능들을 제공하였다. csh의 alias 개념은 [배시와](https://ko.wikipedia.org/wiki/배시_\(유닉스_셸\) "wikilink") [콘 셸](../Page/콘_셸.md "wikilink")(ksh)에 도입되었다.
