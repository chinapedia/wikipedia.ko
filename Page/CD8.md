...
CD8는 이합체를 이루어 기능을 한다. 가장 흔한 CD8 형태는 CD8-α와 CD8-β 사슬로 이루어진 형태이다. 두 사슬은 [면역글로불린 초족에](https://ko.wikipedia.org/wiki/면역글로불린_초족 "wikilink") 속하며, 면역글로불린의 가변 부위(IgV)와 유사한 세포외 도메인이 세포막에 가느다란 자루로 연결되어 있고, 세포내에는 꼬리가 있다. 몇몇 세포에서는 CD8-α 사슬이 동종이합체로 발현되기도 한다. CD8 사슬의 분자량은 각각 32-34 kDa이다.\[3\] 결정학적으로 밝혀진 CD8는 면역글로불린 유사 베타 병풍구조가 샌드위치처럼 접혀 있는 구조로 114개 아미노산 잔기로 이루어진다. 단백질의 2%는 [α나선](https://ko.wikipedia.org/wiki/α나선 "wikilink"), 46%는 [β병풍](https://ko.wikipedia.org/wiki/β병풍 "wikilink") 구조를 이루고, 나머지 52%는 고리 부분을 이룬다. [섬네일](https://ko.wikipedia.org/wiki/파일:CD8_receptor.svg "wikilink")

## 기능

CD8-α의 세포외에 있는 IgV 유사 도메인은 I형 MHC 분자의 α<sub>3</sub> 부분과 상호작용한다.\[4\] 이 친화성을 통하여 세포독성 T 세포의 수용체와 표적 세포가 가까이 결합하고 T 세포가 항원에 특이적으로 활성화된다.

## 각주 및 참고 문헌

[분류:인간 염색체 유전자](https://ko.wikipedia.org/wiki/분류:인간_염색체_유전자 "wikilink") [분류:면역계통](https://ko.wikipedia.org/wiki/분류:면역계통 "wikilink") [분류:인간 2번 염색체상 유전자](https://ko.wikipedia.org/wiki/분류:인간_2번_염색체상_유전자 "wikilink")
