...
[수학](../Page/수학.md "wikilink")에서, **복소수**(複素數, )는 \(a+bi\) (\(a,b\)는 [실수](https://ko.wikipedia.org/wiki/실수 "wikilink")) 꼴의 수이다. 여기서 \(i\)는 [허수 단위라고](https://ko.wikipedia.org/wiki/허수_단위 "wikilink") 불리는 수이며, \(i^2=-1\)를 만족시킨다. 전류 기호와의 혼동을 피하기 위해 대신 기호 \(j\)를 쓰기도 한다. 복소수의 집합은 [체를](https://ko.wikipedia.org/wiki/체_\(수학\) "wikilink") 이루며, [대수학의 기본 정리가](../Page/대수학의_기본_정리.md "wikilink") 성립한다. 그러나 실수와 달리 표준적인 [전순서](https://ko.wikipedia.org/wiki/전순서 "wikilink")를 줄 수 없다. [기하학](https://ko.wikipedia.org/wiki/기하학 "wikilink")적 관점에서, 복소수의 공간은 2차원 [복소평면](../Page/복소평면.md "wikilink")과 같으며, 이는 실수 공간을 나타내는 1차원 [실수선](https://ko.wikipedia.org/wiki/실수선 "wikilink")을 확장하여 얻을 수 있다. [추상대수학](../Page/추상대수학.md "wikilink")적 관점에서, 복소수의 집합은 유일한 2차원 [노름](https://ko.wikipedia.org/wiki/노름 "wikilink") [나눗셈 대수이다](https://ko.wikipedia.org/wiki/나눗셈_대수 "wikilink"). 복소수 집합의 기호는 \(\mathbb C\) 또는 \(\mathbf C\)이다.

## 정의

**복소수체**(複素數體, ) \(\mathbb C\)는 \(\mathbb R\)-대수 \(\mathbb R\)의 [케일리-딕슨 대수](https://ko.wikipedia.org/wiki/케일리-딕슨_대수 "wikilink") \(\operatorname{CD}(\mathbb R)\)(에서 [체의](https://ko.wikipedia.org/wiki/체_\(수학\) "wikilink") 구조만을 기억하여 얻는 체)이다.
...
\[(a,b)\cdot(c,d)=(ac-bd,ad+bc)\qquad a,b,c,d\in\mathbb R\] 그렇다면, 이는 [나눗셈 대수를](https://ko.wikipedia.org/wiki/나눗셈_대수 "wikilink") 이루며, 여기서 [체를](https://ko.wikipedia.org/wiki/체_\(수학\) "wikilink") 제외한 구조를 잊으면 복소수체를 얻는다. 또한, 실수 단위 \((1,0)=1\)과 [허수 단위](https://ko.wikipedia.org/wiki/허수_단위 "wikilink") \((0,1)=i\)를 정의하면, 이는 \(i^2=-1\)를 만족시키며, 모든 원소는 \((a,b)=a+bi\)로 쓸 수 있다. [실수체](https://ko.wikipedia.org/wiki/실수체 "wikilink")는 \(a\mapsto a+0i\)를 통해 자연스럽게 복소수체의 [부분 집합](https://ko.wikipedia.org/wiki/부분_집합 "wikilink") \(\mathbb R\subseteq\mathbb C\)이라고 생각할 수 있다.
...
복소수는 [직교 좌표계나](https://ko.wikipedia.org/wiki/직교_좌표계 "wikilink") [극좌표계](../Page/극좌표계.md "wikilink")를 갖춘 2차원 [유클리드 평면의](https://ko.wikipedia.org/wiki/유클리드_평면 "wikilink") 점(또는 벡터)과 일대일 대응한다. 이러한 평면을 **[복소평면](../Page/복소평면.md "wikilink")**이라고 한다.
...
\[z=r(\cos\theta+i\sin\theta)\qquad r\ge0,\;\theta\in\mathbb R\] 여기서 \(r\)를 [절댓값](https://ko.wikipedia.org/wiki/절댓값 "wikilink"), \(\theta\)를 [편각](https://ko.wikipedia.org/wiki/편각 "wikilink")이라고 한다. 절댓값은 복소수와 원점 사이의 거리와 같으며, 편각은 복소수와 원점의 연결선과 \(x\)축의 사잇각과 같다.
...
\[z=x+iy=r(\cos\theta+i\sin\theta)=re^{i\theta}\qquad x,y,r,\theta\in\mathbb R,\;r\ge0\] 그렇다면, 복소수에 대한 다음과 같은 단항 연산들을 정의할 수 있다.
  ...
  - \(z\)의 **[절댓값](https://ko.wikipedia.org/wiki/절댓값 "wikilink")**은 원점까지의 거리이다. [피타고라스 정리에](../Page/피타고라스_정리.md "wikilink") 따라, 이는 다음과 같다.
...
\[\frac 1z=\frac 1re^{-i\theta}\qquad z\ne0\] 복소수의 곱셈은 [교환 법칙과](https://ko.wikipedia.org/wiki/교환_법칙 "wikilink") [결합 법칙을](https://ko.wikipedia.org/wiki/결합_법칙 "wikilink") 만족시키며, 덧셈에 대한 [분배 법칙을](https://ko.wikipedia.org/wiki/분배_법칙 "wikilink") 만족시킨다. 이에 따라, 복소수의 집합은 [체를](https://ko.wikipedia.org/wiki/체_\(수학\) "wikilink") 이룬다.
...
[귀류법](https://ko.wikipedia.org/wiki/귀류법 "wikilink")을 사용하여, 복소수체가 순서체가 되게 하는 전순서 \(\le\subseteq\mathbb C\times\mathbb C\)가 존재한다고 하자. 그렇다면,
...
복소수의 [절댓값](https://ko.wikipedia.org/wiki/절댓값 "wikilink")은 다음과 같이 나타낼 수 있다.
...
복소수 \(z\)는 어떤 다항식의 근이 될 수 있는지에 따라 다음과 같이 분류된다.
  ...
  - 만약 \(f(z)=0\)인 복소수 계수 다항식 \(f(x)\ne0\)가 존재한다면, \(z\)를 **[대수적 수](https://ko.wikipedia.org/wiki/대수적_수 "wikilink")**라고 한다.
...
하지만 복소수에 포함되지 않는 다른 수가 존재하지 않는다는 의미는 아니다. 수라는 것은 인간의 자유로운 상상력을 기반으로 얼마든지 만들 수 있기 때문이다. 예를 들어 \(\sqrt{x} = -1\) 을 만족하는 \(x\) 는 복소수가 아니며, 이러한 수를 새로 정의할 수 있다.\[1\] [초월 확대를](https://ko.wikipedia.org/wiki/초월_확대 "wikilink") 사용하면 얼마든지 복소수체를 더 큰 체로 확장할 수 있다. 또한, 복소수체를 [사원수](../Page/사원수.md "wikilink")라는 더 큰 [나눗셈 대수로](https://ko.wikipedia.org/wiki/나눗셈_대수 "wikilink") 확장할 수 있다. 그러나, 3차원 이상의 \(\mathbb R\)-[대수는](../Page/대수_\(환론\).md "wikilink") [체가](https://ko.wikipedia.org/wiki/체_\(수학\) "wikilink") 될 수 없다.
