...
[선형대수학](https://ko.wikipedia.org/wiki/선형대수학 "wikilink")에서, **직교 행렬**(直交行列, orthogonal matrix)은 행벡터와 열벡터가 [유클리드 공간의](../Page/유클리드_공간.md "wikilink") [정규 직교 기저를](../Page/정규_직교_기저.md "wikilink") 이루는 [실수](https://ko.wikipedia.org/wiki/실수 "wikilink") [행렬](https://ko.wikipedia.org/wiki/행렬 "wikilink")이다.

## 정의

[실수](https://ko.wikipedia.org/wiki/실수 "wikilink") \(n\times n\) [행렬](https://ko.wikipedia.org/wiki/행렬 "wikilink") \(Q\)에 대하여, 다음 조건들이 서로 동치이며, 이를 만족시키는 \(Q\)를 **직교 행렬**이라고 한다.
...
모든 직교 행렬은 [가역 행렬이며](https://ko.wikipedia.org/wiki/가역_행렬 "wikilink"), 직교 행렬의 곱은 항상 직교 행렬이므로, \(n\times n\) [직교 행렬의](https://ko.wikipedia.org/wiki/직교_행렬 "wikilink") 집합은 [직교군](../Page/직교군.md "wikilink") \(\operatorname O(n;\mathbb R)\)이라는 [군을](https://ko.wikipedia.org/wiki/군_\(수학\) "wikilink") 이룬다. 행렬식이 1인 직교 행렬의 집합은 [특수직교군](https://ko.wikipedia.org/wiki/특수직교군 "wikilink") \(\operatorname{SO}(n;\mathbb R)\)이라는 [부분군](https://ko.wikipedia.org/wiki/부분군 "wikilink")을 이룬다.
