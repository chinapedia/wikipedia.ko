...
**Mdir**은 [도스](../Page/도스.md "wikilink") 사용자들이 도스 [명령 프롬프트에](https://ko.wikipedia.org/wiki/명령_프롬프트 "wikilink") 명령어를 입력하지 않아도 되도록 [사용자 인터페이스를](../Page/사용자_인터페이스.md "wikilink") 제공해 주는 유틸리티로 대한민국의 최정한이 작성했다. 제작자의 여자친구를 위해 처음 개발된 본 프로그램은, 당시에 컴퓨터를 잘 모르는 사용자들도 쉽게 컴퓨터를 다룰 수 있도록 고안되었다. 또한 개인 사용자들에게는 셰어웨어 버전으로도 다양한 기능들을 제공하였고 사용 기간에 특별한 제한이 없었다.
...
비슷한 프로그램으로는 [마이크로소프트](../Page/마이크로소프트.md "wikilink")의 [DOSSHELL](https://ko.wikipedia.org/wiki/DOSSHELL "wikilink")이 있으나 속도가 느려 인기를 끌지는 못하였다.
...
Mdir 유틸리티 패키지 안에는 다음과 같은 실행 파일들을 제공한다.
  ...
  - **MCD.BAT**: 디렉터리의 트리를 나열하고 들어가는 프로그램 ([노턴](../Page/노턴_유틸리티.md "wikilink") 유틸리티에서 나온 NCD와 비슷함)
  - **MFF.EXE**: 파일 찾기 프로그램
...
도스용 최신 버전 기준으로 사용 환경은 다음과 같다.\[1\]
  ...
  - [IBM](../Page/IBM.md "wikilink")-PC/AT 100% 호환기종. 286, 386, 486, [펜티엄](../Page/펜티엄.md "wikilink")
  - [MS-DOS](../Page/MS-DOS.md "wikilink") 3.3 100% 호환 [운영 체제](../Page/운영_체제.md "wikilink"), 윈도 3.1, 윈도 95.
  - [HGC](../Page/허큘레스_그래픽_카드.md "wikilink"), [EGA](../Page/강화_그래픽_어댑터.md "wikilink"), [VGA](https://ko.wikipedia.org/wiki/VGA "wikilink") ([CGA는](../Page/컬러_그래픽스_어댑터.md "wikilink") MSET과 보라가 지원하지 않음)
...
## 같이 보기
  ...
  - [토탈 커맨더](../Page/토탈_커맨더.md "wikilink") - Mdir, WinM과 비슷한 프로그램
