...
[수학](../Page/수학.md "wikilink")에서, **사원수**(四元數, ) 또는 **[해밀턴](../Page/윌리엄_로언_해밀턴.md "wikilink") 수**()는 [복소수](https://ko.wikipedia.org/wiki/복소수 "wikilink")를 확장해 만든 수 체계이다. 네 개의 실수 성분을 가지며, 덧셈과 곱셈의 [결합법칙](https://ko.wikipedia.org/wiki/결합법칙 "wikilink") 및 덧셈의 [교환법칙](https://ko.wikipedia.org/wiki/교환법칙 "wikilink")을 만족시키지만 곱셈의 [교환법칙](https://ko.wikipedia.org/wiki/교환법칙 "wikilink")은 성립하지 않는다.

따라서, [비가환대수이다](https://ko.wikipedia.org/wiki/비가환환#예 "wikilink").

## 정의

사원수의 집합 \(\mathbb H\)는 집합으로서 \(\mathbb R^4=\{a_0+a_1i+a_2j+a_3k\colon a_0,a_1,a_2,a_3\in\mathbb R\}\)이다. 이 위에 다음과 같은 덧셈과 곱셈 연산을 정의하여, [환으로](https://ko.wikipedia.org/wiki/환_\(수학\) "wikilink") 만들 수 있다.
...
이렇게 덧셈과 곱셈을 정의하면, 사원수의 [환](https://ko.wikipedia.org/wiki/환_\(수학\) "wikilink") \(\mathbb H\)는 [나눗셈환](../Page/나눗셈환.md "wikilink")을 이룬다. 그러나 곱셈의 [교환법칙](https://ko.wikipedia.org/wiki/교환법칙 "wikilink")이 성립하지 않으므로, 이는 [체를](https://ko.wikipedia.org/wiki/체_\(수학\) "wikilink") 이루지 않는다.
...
사원수환 \(\mathbb H\)는 [노름](https://ko.wikipedia.org/wiki/노름 "wikilink")을 갖춘 [나눗셈환](../Page/나눗셈환.md "wikilink")이자 \(\mathbb R\)-[대수이다](../Page/대수_\(환론\).md "wikilink"). 즉, 다음이 성립한다. 임의의 사원수 \(q_1,q_2,q_3\in\mathbb H\)에 대하여,
  ...
  - (덧셈의 [교환법칙](https://ko.wikipedia.org/wiki/교환법칙 "wikilink")) \(q_1+q_2=q_2+q_1\)
  - (덧셈의 [결합법칙](https://ko.wikipedia.org/wiki/결합법칙 "wikilink")) \((q_1+q_2)+q_3=q_1+(q_2+q_3)\)
  - (곱셈의 [결합법칙](https://ko.wikipedia.org/wiki/결합법칙 "wikilink")) \((q_1q_2)q_3=q_1(q_2q_3)\)
  - ([분배법칙](https://ko.wikipedia.org/wiki/분배법칙 "wikilink")) \(q_1(q_2+q_3)=q_1q_2+q_1q_3, (q_1+q_2)q_3=q_1q_3+q_2q_3\)
  - (노름과 곱셈의 호환) \(|q_1q_2|=|q_1|\cdot|q_2|\)
  - ([삼각 부등식](https://ko.wikipedia.org/wiki/삼각_부등식 "wikilink")) \(|q_1+q_2|\le|q_1|+|q_2|\)

### 벡터와의 관계

사원수의 실수부는 스칼라로, 허수부는 3차원 벡터로 간주할 수 있다. 즉, 사원수는 스칼라와 3차원 벡터의 [순서쌍](https://ko.wikipedia.org/wiki/순서쌍 "wikilink") \(q=(w,\mathbf v)\)으로 간주할 수 있다. 이 경우, 사원수의 합과 곱은 다음과 같다.
...
\[\rho\colon a+bi+cj+dk\mapsto\begin{pmatrix}a+bi&c+di\\-c+di&a-bi\end{pmatrix}=a\sigma_0+ib\sigma_3+ic\sigma_2+id\sigma_1\] 여기서 \(\sigma_i\)는 [파울리 행렬이다](https://ko.wikipedia.org/wiki/파울리_행렬 "wikilink"). 그렇다면 다음이 성립한다. 임의의 사원수 \(p,q\in\mathbb H\)에 대하여,
...
해밀턴은 [복소수](https://ko.wikipedia.org/wiki/복소수 "wikilink")가 2차원 평면상의 점으로 표현될 수 있다는 사실로부터, 3차원 공간에서 점을 표현하는 같은 방법을 찾으려 하였다. 3차원 공간에서의 정점은 3개의 수로 이루어지며, 해밀턴은 그 3개의 수들을 어떻게 더하고 곱할 수 있는지에 관해 생각해왔다. 그러나 그는 두개의 정점간의 나누기를 어떻게 정의할지 알지 못했고, 난관에 부딪히고 말았다.

1843년 10월 16일, 해밀턴은 그의 아내와 [더블린](https://ko.wikipedia.org/wiki/더블린 "wikilink")의 로열 운하(, )을 걷고 있었다. 브로엄 다리(, 현재는 브룸 다리 )를 걷고 있을 때, 나누기에 관한 해답이 그의 뇌리를 스쳤다. 그는 3개의 성분을 가진 값은 나눗셈을 정의할 수 없지만, 4개의 성분을 가진 값은 나눗셈이 성립할 수 있다는 것을 알아차렸다. 4개의 성분 가운데 세 개를 사용하여 3차원 공간의 [직교좌표](https://ko.wikipedia.org/wiki/직교좌표 "wikilink")를 표현할 수 있다. 해밀턴은 이 수체계의 기본 규칙을 다리에 새겨놓았다.
...
그러나 사원수는 20세기 말에 공간상에서의 회전에 관한 사원수의 유용성에 의해서 다시 주목받기 시작했다. 사원수를 이용한 회전의 표현은 행렬을 사용하는 표현에 비해 더욱 간결했고 계산이 빨랐다. 이런 이유로, 사원수는 컴퓨터 그래픽, [제어이론](../Page/제어이론.md "wikilink"), [신호처리](https://ko.wikipedia.org/wiki/신호처리 "wikilink"), [자세제어](https://ko.wikipedia.org/wiki/자세제어 "wikilink")(attitude control), [물리학](../Page/물리학.md "wikilink"), [생물정보학](https://ko.wikipedia.org/wiki/생물정보학 "wikilink"), [분자동역학](https://ko.wikipedia.org/wiki/분자동역학 "wikilink"), [컴퓨터 시뮬레이션](https://ko.wikipedia.org/wiki/컴퓨터_시뮬레이션 "wikilink"), [궤도역학](https://ko.wikipedia.org/wiki/궤도역학 "wikilink")(orbital mechanics) 등에 사용되고 있다.
