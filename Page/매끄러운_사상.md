...
[스킴 사상](https://ko.wikipedia.org/wiki/스킴_사상 "wikilink") \(f\colon X\to S\)에 대하여,
  ...
  - 만약 [멱영 아이디얼로부터](https://ko.wikipedia.org/wiki/멱영_아이디얼 "wikilink") 유도되는 [닫힌 몰입에](../Page/닫힌_몰입.md "wikilink") 대하여 [오른쪽 올림 성질이](https://ko.wikipedia.org/wiki/오른쪽_올림_성질 "wikilink") 성립한다면, \(f\)를 **형식적으로 매끄러운 사상**(, )이라고 한다.\[1\] 즉, \((/\mathfrak n)^*\colon\hom_{\operatorname{Sch}/S}(\operatorname{Spec}R,X)\to\hom_{\operatorname{Sch}/S}(\operatorname{Spec}(R/\mathfrak n),X)\)가 [전사 함수이다](https://ko.wikipedia.org/wiki/전사_함수 "wikilink").
  - 만약 [멱영 아이디얼로부터](https://ko.wikipedia.org/wiki/멱영_아이디얼 "wikilink") 유도되는 [닫힌 몰입에](../Page/닫힌_몰입.md "wikilink") 대하여 모든 오른쪽 올림이 (만약 존재한다면) 유일하다면, \(f\)를 **형식적으로 비분기 사상**(, )이라고 한다.\[2\] 즉, \((/\mathfrak n)^*\colon\hom_{\operatorname{Sch}/S}(\operatorname{Spec}R,X)\to\hom_{\operatorname{Sch}/S}(\operatorname{Spec}(R/\mathfrak n),X)\)가 [단사 함수이다](https://ko.wikipedia.org/wiki/단사_함수 "wikilink").
  - 만약 [멱영 아이디얼로부터](https://ko.wikipedia.org/wiki/멱영_아이디얼 "wikilink") 유도되는 [닫힌 몰입에](../Page/닫힌_몰입.md "wikilink") 대하여 [오른쪽 유일 올림 성질이](https://ko.wikipedia.org/wiki/오른쪽_유일_올림_성질 "wikilink") 성립한다면, \(f\)를 **형식적으로 에탈 사상**(, )이라고 한다.\[3\] 즉, \((/\mathfrak n)^*\colon\hom_{\operatorname{Sch}/S}(\operatorname{Spec}R,X)\to\hom_{\operatorname{Sch}/S}(\operatorname{Spec}(R/\mathfrak n),X)\)가 [전단사 함수이다](https://ko.wikipedia.org/wiki/전단사_함수 "wikilink").
    :<math>
...
다음과 같은 함의 관계가 성립한다.
  ...
  -
    [축소 스킴](https://ko.wikipedia.org/wiki/축소_스킴 "wikilink") ⊋ [정규 스킴](../Page/정규_스킴.md "wikilink") ⊋ [정칙 스킴](https://ko.wikipedia.org/wiki/정칙_스킴 "wikilink") ⊋ [체](https://ko.wikipedia.org/wiki/체_\(수학\) "wikilink") 위의 [매끄러운 스킴](https://ko.wikipedia.org/wiki/매끄러운_스킴 "wikilink")
