...
**역어셈블러** 또는 **디스어셈블러**()는 [기계어](https://ko.wikipedia.org/wiki/기계어 "wikilink")를 [어셈블리어](https://ko.wikipedia.org/wiki/어셈블리어 "wikilink")로 변환하는 [컴퓨터 프로그램이다](https://ko.wikipedia.org/wiki/컴퓨터_프로그램 "wikilink"). 역어셈블러는 어셈블리어가 아닌 [고급 프로그래밍 언어를](https://ko.wikipedia.org/wiki/고급_프로그래밍_언어 "wikilink") 대상으로 하는 [역컴파일러](../Page/역컴파일러.md "wikilink")와는 구분한다. 역어셈블러의 출력물인 디스어셈블리(disassembly)는 어셈블러로의 입력에 맞추는 것보다 사람이 읽기 쉽도록 형식을 정하는 경우가 있는데 이것이 바로 [리버스 엔지니어링](https://ko.wikipedia.org/wiki/리버스_엔지니어링 "wikilink") 도구의 역할이다.
