...
**제티**는 자바 [HTTP (웹) 서버이자](https://ko.wikipedia.org/wiki/웹_서버 "wikilink") [자바 서블릿](https://ko.wikipedia.org/wiki/자바_서블릿 "wikilink") 컨테이너이다. 웹 서버가 보통 문서를 사람들에게 제공하는 것과 관련된 반면, 제티는 대규모 소프트웨어 프레임워크에서 기계와 기계의 커뮤니케이션에 사용된다. 제티는 자유 소프트웨어이고 [이클립스 재단의](https://ko.wikipedia.org/wiki/이클립스_재단 "wikilink") 오픈소스 프로젝트로 개발되었다. 제티는 웹서버로 다음과 같은 제품에 사용된다: [Apache ActiveMQ](https://ko.wikipedia.org/wiki/:en:Apache_ActiveMQ "wikilink"),\[1\] [Alfresco](https://ko.wikipedia.org/wiki/:en:Alfresco_\(software\) "wikilink"),\[2\] [아파치 제로니모](https://ko.wikipedia.org/wiki/아파치_제로니모 "wikilink"),\[3\] [아파치 메이븐](../Page/아파치_메이븐.md "wikilink"), [Apache Spark](https://ko.wikipedia.org/wiki/:en:Spark_\(cluster_computing_framework\) "wikilink"), [Google App Engine](https://ko.wikipedia.org/wiki/:en:Google_App_Engine "wikilink"),\[4\] [이클립스](https://ko.wikipedia.org/wiki/이클립스_\(소프트웨어\) "wikilink"),\[5\] [FUSE](https://ko.wikipedia.org/wiki/:en:Fuse_Services_Framework "wikilink"),\[6\] [iDempiere](https://ko.wikipedia.org/wiki/:en:IDempiere "wikilink"),\[7\] [Twitter's Streaming API](https://ko.wikipedia.org/wiki/:en:HOSEbird "wikilink")\[8\], [Zimbra](https://ko.wikipedia.org/wiki/Zimbra "wikilink").\[9\] 제티는 다음과 같은 오픈소스 프로젝트에도 사용된다: [Lift](https://ko.wikipedia.org/wiki/:en:Lift_\(web_framework\) "wikilink"), [Eucalyptus](https://ko.wikipedia.org/wiki/:en:Eucalyptus_\(computing\) "wikilink"), [Red5](https://ko.wikipedia.org/wiki/:en:Red5_\(media_server\) "wikilink"), [하둡](https://ko.wikipedia.org/wiki/하둡 "wikilink"), [I2P](https://ko.wikipedia.org/wiki/:en:I2P "wikilink").\[10\] 제티는 최신 버전의 자바 서블릿 API ([JSP](https://ko.wikipedia.org/wiki/JSP "wikilink") 포함)을 지원할 뿐만 아니라, [HTTP/2](https://ko.wikipedia.org/wiki/HTTP/2 "wikilink")와 [웹소켓](https://ko.wikipedia.org/wiki/웹소켓 "wikilink") 프로토콜도 지원한다.

## 개요

2009년 제티가 [이클립스로](https://ko.wikipedia.org/wiki/이클립스_\(소프트웨어\) "wikilink") 옮겨가면서, 독립적인 오픈 소스 프로젝트로 개발되었다.\[11\]\[12\] 제티는 웹 서비스를 제공한다. 제티는 임베디드 자바 애플리케이션에서 웹 서비스를 제공하고, 이미 이클립스 IDE의 컴포넌트로 포함되어 있다. 제티는 [AJP](https://ko.wikipedia.org/wiki/AJP "wikilink"), JASPI, [JMX](https://ko.wikipedia.org/wiki/JMX "wikilink"), [JNDI](https://ko.wikipedia.org/wiki/JNDI "wikilink"), [OSGi](https://ko.wikipedia.org/wiki/OSGi "wikilink"), WebSocket과 기타 자바 기술들을 지원한다.\[13\]
...
## 추가
  ...
  - [자바 플랫폼, 엔터프라이즈 에디션](https://ko.wikipedia.org/wiki/자바_플랫폼,_엔터프라이즈_에디션 "wikilink")
  - [자바 서블릿](https://ko.wikipedia.org/wiki/자바_서블릿 "wikilink")
  - [자바서버 페이지](https://ko.wikipedia.org/wiki/자바서버_페이지 "wikilink")
