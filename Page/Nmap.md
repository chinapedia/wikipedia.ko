...
Nmap은 [리눅스](https://ko.wikipedia.org/wiki/리눅스 "wikilink"), [윈도](https://ko.wikipedia.org/wiki/마이크로소프트_윈도 "wikilink"), [솔라리스와](https://ko.wikipedia.org/wiki/솔라리스_\(운영_체제\) "wikilink") [맥 OS X를](https://ko.wikipedia.org/wiki/맥_OS_X "wikilink") 포함한 [BSD](https://ko.wikipedia.org/wiki/BSD "wikilink"), [AmigaOS](https://ko.wikipedia.org/wiki/AmigaOS "wikilink") 에서 실행된다. [리눅스](https://ko.wikipedia.org/wiki/리눅스 "wikilink")가 가장 자주 사용하는 nmap 플랫폼이며, 윈도가 그 두 번째이다.
...
## 기능
  ...
  - [운영 체제](https://ko.wikipedia.org/wiki/운영_체제 "wikilink") 탐지 - 원격으로 운영 체제와 네트워크 장치의 하드웨어 특성을 확인한다.
