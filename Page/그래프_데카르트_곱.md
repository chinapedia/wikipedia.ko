...
[thumb](https://ko.wikipedia.org/wiki/파일:Graph-Cartesian-product.svg "wikilink") [thumb](https://ko.wikipedia.org/wiki/파일:Cartesian_product_graph.svg "wikilink") [그래프 이론에서](https://ko.wikipedia.org/wiki/그래프_이론 "wikilink"), **그래프 데카르트 곱**(graph Descartes곱, )은 두 [그래프](https://ko.wikipedia.org/wiki/그래프 "wikilink")를 합치는 [이항 연산이다](https://ko.wikipedia.org/wiki/이항_연산 "wikilink"). 이렇게 얻은 그래프의 [꼭짓점](https://ko.wikipedia.org/wiki/꼭짓점 "wikilink")의 수는 원래 두 그래프의 꼭짓점의 수들의 곱과 같다.
...
그래프 데카르트 곱은 (표준적 그래프 동형 아래) [결합 법칙과](https://ko.wikipedia.org/wiki/결합_법칙 "wikilink") [교환 법칙을](https://ko.wikipedia.org/wiki/교환_법칙 "wikilink") 따른다. 그래프 데카르트 곱의 [항등원](https://ko.wikipedia.org/wiki/항등원 "wikilink")은 한원소 그래프 \(\mathsf K_1\)이다.
...
\sum_{i\in I}|\mathsf E(\Gamma_i)|\prod_{j\in I\setminus\{i\}} |\mathsf V(\Gamma_j)|\] (무한 그래프의 경우 이는 [기수의](https://ko.wikipedia.org/wiki/기수_\(수학\) "wikilink") 연산으로 해석한다.)
...
특히, 두 그래프의 데카르트 곱이 [이분 그래프일](https://ko.wikipedia.org/wiki/이분_그래프 "wikilink") [필요 충분 조건은](https://ko.wikipedia.org/wiki/필요_충분_조건 "wikilink") 다음과 같다.

  - 둘 다 [이분 그래프이거나](https://ko.wikipedia.org/wiki/이분_그래프 "wikilink"), 또는 둘 가운데 하나가 \(\varnothing\)이다.
...
작은 그래프의 데카르트 곱에 대하여 다음이 성립한다. 여기서 \(\mathsf K_i\)는 [완전 그래프이며](https://ko.wikipedia.org/wiki/완전_그래프 "wikilink"), \(\bar{\mathsf K}_i\)는 [무변 그래프이며](../Page/무변_그래프.md "wikilink"), \(\mathsf C_i\)는 [순환 그래프이며](../Page/순환_그래프.md "wikilink"), \(\mathsf P_i\)는 [경로 그래프이다](https://ko.wikipedia.org/wiki/경로_그래프 "wikilink"). \(\Gamma\)는 임의의 [그래프](https://ko.wikipedia.org/wiki/그래프 "wikilink")이다.
...
그래프 데카르트 곱은 1912년에 [알프레드 노스 화이트헤드와](https://ko.wikipedia.org/wiki/알프레드_노스_화이트헤드 "wikilink") [버트런드 러셀이](https://ko.wikipedia.org/wiki/버트런드_러셀 "wikilink") 《[수학 원리](https://ko.wikipedia.org/wiki/수학_원리 "wikilink")》 2권에서 최초로 사용하였다.\[1\] 이후 게르트 자비두시(, 1929〜)가 1960년에 이 연산을 재발견하였다.\[2\]
