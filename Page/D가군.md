...
\(X\)가 [표수 0인](https://ko.wikipedia.org/wiki/체의_표수 "wikilink") [체](../Page/체_\(수학\).md "wikilink") \(k\)에 대한 [비특이 대수다양체라고](https://ko.wikipedia.org/wiki/비특이_대수다양체 "wikilink") 하고, \(X\) 위의 정칙함수들의 [층을](../Page/층_\(수학\).md "wikilink") \(\mathcal O_X\)라고 하자. 또한, \(X\) 위의 (대수적) 벡터장들로 생성되는 \(\mathcal O_X\)-[가군층](../Page/가군층.md "wikilink") \(\mathcal D_X\)를 생각하자. 이는 미분 연산자들로 간주할 수 있다.
...
[국소 자유 가군층은](https://ko.wikipedia.org/wiki/국소_자유_가군층 "wikilink") [벡터 다발로](../Page/벡터_다발.md "wikilink") 여길 수 있으며, [국소 자유 가군층인](https://ko.wikipedia.org/wiki/국소_자유_가군층 "wikilink") D가군은 단순히 평탄한 [코쥘 접속이](../Page/코쥘_접속.md "wikilink") 주어진 [벡터 다발이다](../Page/벡터_다발.md "wikilink").

\(\mathcal D_X\) 자체는 자명하게 D가군을 이룬다.

복소 [아핀 공간](../Page/아핀_공간.md "wikilink") \(\mathbb C^n\) 위의 함수 공간 \(F\)가 다음 성질들을 만족시킨다면, \(F\)는 D가군을 이룬다.
...
\[Df=0\] 을 생각해 보자. 그렇다면, 이 편미분 방정식에 대응되는 D가군은 \(D\)로 생성되는 \(\mathcal D_{\mathbb C^n}\)의 [아이디얼](../Page/아이디얼.md "wikilink") \((D)\)에 대한 [몫환](https://ko.wikipedia.org/wiki/몫환 "wikilink")
