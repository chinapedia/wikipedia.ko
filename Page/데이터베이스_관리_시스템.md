...
**데이터베이스 관리 시스템**(, **DBMS**)은 다수의 사용자들이 [데이터베이스](https://ko.wikipedia.org/wiki/데이터베이스 "wikilink") 내의 데이터를 접근할 수 있도록 해주는 소프트웨어 도구의 집합이다. DBMS은 사용자 또는 다른 프로그램의 요구를 처리하고 적절히 응답하여 데이터를 사용할 수 있도록 해준다.
