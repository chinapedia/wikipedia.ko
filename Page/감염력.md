...
**감염력**(infectivity)이란 [역학(epidemiology)](https://ko.wikipedia.org/wiki/역학_\(의학\) "wikilink") 용어로, 병원체가 [감염](https://ko.wikipedia.org/wiki/감염 "wikilink")을 일으키는 능력을 말한다. 보다 좁혀서 말하면 감염력이란 병원체가 부모-자식간의 전파가 아닌 수평전파를 일으키는 능력을 말한다. 인구집단에서의 감염력 지표는 발생률(incidence)로 불린다.
