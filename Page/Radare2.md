...
**Radare2** (또는 **r2**)는 바이너리를 [리버스 엔지니어링하고](https://ko.wikipedia.org/wiki/리버스_엔지니어링 "wikilink") 분석하기 위한 완전한 [프레임워크](https://ko.wikipedia.org/wiki/프레임워크 "wikilink")이다. 이것은 같이 사용되거나 [명령 줄 인터페이스에서](https://ko.wikipedia.org/wiki/명령_줄_인터페이스 "wikilink") 독립적으로 사용될 수 있는 조그만 유틸리티들의 집합으로 이루어져 있다. [역어셈블러](../Page/역어셈블러.md "wikilink") 위주로 만들어진 이것은 여러 [프로세서](https://ko.wikipedia.org/wiki/프로세서 "wikilink")들과 [운영 체제들을](https://ko.wikipedia.org/wiki/운영_체제 "wikilink") 위한 다양한 [실행 파일](https://ko.wikipedia.org/wiki/실행_파일 "wikilink") 포맷을 지원한다.

## 특징과 사용

Radare2는 [그래픽 사용자 인터페이스를](https://ko.wikipedia.org/wiki/그래픽_사용자_인터페이스 "wikilink") 갖지 않기 때문에 배우기 어렵다. 원래 헥사 에디터 위주로 만들어졌지만 지금은 많은 툴들과 특징들을 가지며 또한 여러 언어들을 위한 바인딩도 제공한다.\[1\]
...
## 지원되는 아키텍처/포맷
  ...
  - 인식되는 파일 포맷
      - COFF 계열, Win32/64/일반 [PE](https://ko.wikipedia.org/wiki/PE_포맷 "wikilink") 포함.
      - [ELF](https://ko.wikipedia.org/wiki/ELF_파일_형식 "wikilink") 계열
      - Mach-O ([Mach](https://ko.wikipedia.org/wiki/Mach_\(커널\) "wikilink")) 계열
      - [게임보이](https://ko.wikipedia.org/wiki/게임보이 "wikilink")와 [게임보이 어드밴스](https://ko.wikipedia.org/wiki/게임보이_어드밴스 "wikilink") 카트리지
      - [MZ](../Page/MZ_실행_파일.md "wikilink") ([MS-DOS](https://ko.wikipedia.org/wiki/MS-DOS "wikilink"))
      - Java class
      - dyld 캐시 덤프\[7\]
      - Dex ([달빅](https://ko.wikipedia.org/wiki/달빅_\(소프트웨어\) "wikilink") 실행 파일)
      - Xbox xbe 포맷\[8\]
      - [플랜9](https://ko.wikipedia.org/wiki/플랜_9_\(운영_체제\) "wikilink") 바이너리
      - [Winrar](https://ko.wikipedia.org/wiki/WinRAR "wikilink") 가상 머신\[9\]
      - [파일 시스템](https://ko.wikipedia.org/wiki/파일_시스템 "wikilink") ([ext](https://ko.wikipedia.org/wiki/Ext4 "wikilink"), ReiserFS, [HFS+](https://ko.wikipedia.org/wiki/HFS_플러스 "wikilink"), [NTFS](https://ko.wikipedia.org/wiki/NTFS "wikilink"), [FAT](https://ko.wikipedia.org/wiki/파일_할당_테이블 "wikilink"), ...)
...
<!-- end list -->
  ...
  - 명령어
      - [인텔](https://ko.wikipedia.org/wiki/인텔 "wikilink") x86 계열
      - [ARM 아키텍처](https://ko.wikipedia.org/wiki/ARM_아키텍처 "wikilink")
      - Atmel AVR 시리즈
      - [브레인퍽](https://ko.wikipedia.org/wiki/브레인퍽 "wikilink")
      - Motorola 68k and H8
      ...
      - [SPARC](https://ko.wikipedia.org/wiki/SPARC "wikilink") 계열
      - TMS320Cxxx 시리즈
      - Argonaut RISC Core
      ...
      - 안드로이드VM 달빅
      - DCPU-16
      - [EFI bytecode](https://ko.wikipedia.org/wiki/통일_확장_펌웨어_인터페이스 "wikilink")
      - 게임보이 (z80-like)
      - 자바 바이트코드
      - Malebolge
      - [MSIL/CIL](https://ko.wikipedia.org/wiki/공통_중간_언어 "wikilink")
      - Nios II
      ...
      - TMS320
      - V850
      - [화이트스페이스](https://ko.wikipedia.org/wiki/화이트스페이스_\(프로그래밍_언어\) "wikilink")
      - XCore
