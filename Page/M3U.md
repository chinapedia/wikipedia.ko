...
**M3U**는 [멀티미디어](../Page/멀티미디어.md "wikilink") [재생목록](https://ko.wikipedia.org/wiki/재생목록 "wikilink")의 파일 포맷이다. [윈도우 미디어 플레이어](https://ko.wikipedia.org/wiki/윈도우_미디어_플레이어 "wikilink"), [아이튠즈](../Page/아이튠즈.md "wikilink"), [윈앰프](../Page/윈앰프.md "wikilink"), [알송](../Page/알송.md "wikilink") 등 대부분의 프로그램이 지원하고 있지만, 정식 사양은 존재하지 않고 대응 상황은 각각 다르다.

## 포맷

M3U 파일은, 하나, 또는 여러 개의 미디어 파일의 [패스를](../Page/디렉토리.md "wikilink") [플레인 텍스트](../Page/플레인_텍스트.md "wikilink")([텍스트 파일](../Page/텍스트_파일.md "wikilink"))로 기재한 것이다. 이 파일을. ".m3u" 또는 ".m3u8"의 확장자로 저장한다. M3U 파일의 인코딩은 [Windows-1252](https://ko.wikipedia.org/wiki/Windows-1252 "wikilink")의 경우가 많으나, [CP932](https://ko.wikipedia.org/wiki/CP932 "wikilink")에 대응하고 있는 것도 존재한다. 인코딩을 [UTF-8](../Page/UTF-8.md "wikilink")로 명시하였을 때, 확장자 M3U8를 사용한다.
...
M3U 포맷의 일반적인 사용방법으로 단일의 엔트리에 URL을 기재할 필요가 있다. 이 파일 덕분에, 스트리밍 액세스, 웹사이트에서의 다운로드, [인터넷 라디오의](../Page/인터넷_라디오.md "wikilink") 청취가 용이해진다.

[iOS](https://ko.wikipedia.org/wiki/iOS "wikilink")의 [HTTP 라이브 스트리밍](../Page/HTTP_라이브_스트리밍.md "wikilink") 포맷은 "M3U" and "M3U8" 파일을 기초로 하고 있다.
...
아래에 [윈도우에서의](../Page/마이크로소프트_윈도우.md "wikilink") 확장 M3U 파일의 예를 나타낸다. Sample.mp3와 Example.ogg는 이번에 사용할 미디어 파일이다. 123 및 321이라는 것은 길이를 초로 지정하고 있다. 지정할 미디어 파일이 스트리밍 파일인 경우, -1을 지정하는 것이 있다. 이것은 실제 길이를 알 수 없기에, 미리 정의하는 것이다. 길이 뒤의 값은 표시될 제목으로, 일반적으로 2번째 행에 적히는 파일의 경우와 비슷하다.

[OS X나](https://ko.wikipedia.org/wiki/OS_X "wikilink") [리눅스](../Page/리눅스.md "wikilink")로 사용할 경우는 [유닉스 패스를](https://ko.wikipedia.org/wiki/유닉스_패스 "wikilink") 사용한다.
...
이 예시에서는 특정 디렉터리(예를 들면, [USB 플래시 드라이브나](../Page/USB_플래시_드라이브.md "wikilink") [CD-ROM](../Page/CD-ROM.md "wikilink") 등)에 링크하는 M3U 파일의 작성방법을 나타낸다. M3U 파일로는 디렉터리의 경로 하나만 포함되지는 않는다. 개시후, 미디어 플레이어는 지정한 폴더에 있는 미디어 파일을 모두 재생한다.
...
아래의 예시는 [Mp3tag](https://ko.wikipedia.org/wiki/Mp3tag "wikilink")로 작성한 [앨리스 인 체인스의](../Page/앨리스_인_체인스.md "wikilink") EP반 [Jar of Flies의](https://ko.wikipedia.org/wiki/Jar_of_Flies "wikilink") M3U 파일이다.
