...
[리만 기하학과](https://ko.wikipedia.org/wiki/리만_기하학 "wikilink") [리 군론에서](https://ko.wikipedia.org/wiki/리_군론 "wikilink"), **대칭 공간**(對稱空間, )은 일반점의 [안정자군](https://ko.wikipedia.org/wiki/안정자군 "wikilink")이 어떤 [대합에](https://ko.wikipedia.org/wiki/대합_\(수학\) "wikilink") 의하여 정의되는 [동차 공간이다](https://ko.wikipedia.org/wiki/동차_공간 "wikilink").

## 정의

**대칭 공간** \(G/H\)는 다음 조건을 만족시키는 [동차 공간이다](https://ko.wikipedia.org/wiki/동차_공간 "wikilink").

\[H\]는 어떤 [대합](https://ko.wikipedia.org/wiki/대합_\(수학\) "wikilink") \(\sigma\colon G\to G\)에 대하여, \(G^\sigma\)의 [열린집합](https://ko.wikipedia.org/wiki/열린집합 "wikilink")이다. 여기서

\[G^\sigma=\{g\in G\colon\sigma g=g\}\] 는 \(\sigma\)에 의한 [고정점](../Page/고정점.md "wikilink")들의 부분 공간이다.

대칭 공간의 **계수**(階數, )는 접공간의 부분 벡터 공간 가운데, 곡률이 0인 것의 최대 차원이다. 대칭 공간 가운데 [에르미트 다양체인](https://ko.wikipedia.org/wiki/에르미트_다양체 "wikilink") 것들은 항상 자동적으로 [켈러 다양체를](https://ko.wikipedia.org/wiki/켈러_다양체 "wikilink") 이루며, 이를 **에르미트 대칭 공간**(Hermite對稱空間, )이라고 한다.

\(G\)의 리 대수가 \(\mathfrak g\)라고 하자. 대합

\[\sigma\colon\mathfrak g\to\mathfrak g\] 는 \(\sigma^2=1\)이므로 [고윳값](https://ko.wikipedia.org/wiki/고윳값 "wikilink") \(\pm1\)을 갖는다. 이에 따라, \(\mathfrak g\)는 두 부분 공간의 [직합](https://ko.wikipedia.org/wiki/직합 "wikilink")으로 나타내어지며, 고윳값이 \(+1\)인 부분 대수는 \(H\)의 리 대수 \(\mathfrak h\)와 같다. 고윳값이 \(-1\)인 부분 대수는 \(\mathfrak m\)이라고 적자.
...
[리 군](https://ko.wikipedia.org/wiki/리_군 "wikilink") \(G\)의 닫힌 부분군 \(H\le G\)가 주어졌으며, 이들에 대응하는 [리 대수가](https://ko.wikipedia.org/wiki/리_대수 "wikilink") 각각 \(\mathfrak h\subseteq\mathfrak g\)라고 하자. 또한, 항상

\[\mathfrak g = \mathfrak h + \mathfrak m\] 이 되는 [실수 벡터 공간](https://ko.wikipedia.org/wiki/실수_벡터_공간 "wikilink") \(\mathfrak m\subseteq\mathfrak g\)를 찾을 수 있다. 이제, \(\mathfrak m\)이 가질 수 있는 다음과 같은 일련의 조건들을 정의할 수 있으며, 이 조건들은 다음과 같은 [동차 공간들을](https://ko.wikipedia.org/wiki/동차_공간 "wikilink") 정의한다.
...
| 리만 대칭 공간 | 대칭 공간이며, \(\mathfrak m\) 위에 \(\operatorname{Ad}(H)\)-불변 [내적이](https://ko.wikipedia.org/wiki/내적_공간 "wikilink") 존재 |
...
콤팩트 대칭 공간은 [엘리 카르탕에](https://ko.wikipedia.org/wiki/엘리_카르탕 "wikilink") 의하여 모두 분류되었다.\[1\]\[2\]

모든 [연결](https://ko.wikipedia.org/wiki/연결_공간 "wikilink") [단일 연결](https://ko.wikipedia.org/wiki/단일_연결 "wikilink") 콤팩트 대칭 공간은 아래 군들의 [직접곱](../Page/직접곱.md "wikilink")이다. 아래 목록에서, [켈러 다양체가](https://ko.wikipedia.org/wiki/켈러_다양체 "wikilink") 되는 것은 특별히 표시하였다.
...
[초구](https://ko.wikipedia.org/wiki/초구 "wikilink")와 [유클리드 공간과](https://ko.wikipedia.org/wiki/유클리드_공간 "wikilink") [쌍곡 공간은](https://ko.wikipedia.org/wiki/쌍곡_공간 "wikilink") 모두 대칭 공간이다. 초구의 경우, 이는
...
[더 시터르 공간과](https://ko.wikipedia.org/wiki/더_시터르_공간 "wikilink") [반 더 시터르 공간은](https://ko.wikipedia.org/wiki/반_더_시터르_공간 "wikilink") 준리만 대칭 공간이다.
