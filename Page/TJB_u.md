...
<!-- end list -->
  ...
  -
    대전방송이 운영하는 비디오 채널이다. 일부 시간대에 자사 TV 방송을 재전송하며, 대부분의 시간대에 SBS의 DMB 채널인 SBS U 프로그램을 재전송한다.
...
<!-- end list -->
  ...
  -
    청주방송이 운영하는 비디오 채널이다. 일부 시간대에 자사 TV 방송을 재전송하며, 대부분의 시간대에 YTN의 DMB 채널인 mYTN 프로그램을 재전송한다. 방송 로고는 CJB YTN과 같은 형식으로 표시된다.
...
| ------- | ------------------- | ------------------------ | --------------- | -- |
| 식장산 송신소 | CH 11C (202.736MHz) | 2kW                      | 대전 동구 세천동 603-1 |    |
...
| 원효봉 중계소 | 1kW                 | 충남 서산시 해미면 산수리 산25       |                 |    |
