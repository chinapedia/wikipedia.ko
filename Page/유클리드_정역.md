...
**유클리드 정역**(Euclid整域, ), 또는 **유클리드 환**(-環, )은 특수한 구조를 가지고 있어서 [유클리드 호제법과](https://ko.wikipedia.org/wiki/유클리드_호제법 "wikilink") 비슷한 과정이 가능한 [정역](../Page/정역.md "wikilink")을 부르는 말이다.
...
모든 [체는](https://ko.wikipedia.org/wiki/체_\(수학\) "wikilink") 자명하게 유클리드 정역을 이루며, 모든 유클리드 정역은 [주 아이디얼 정역이다](../Page/주_아이디얼_정역.md "wikilink"). 일반적으로, 다음 포함 관계가 성립한다.

  -
    [가환환](https://ko.wikipedia.org/wiki/가환환 "wikilink") ⊋ [정역](../Page/정역.md "wikilink") ⊋ [정수적으로 닫힌 정역](https://ko.wikipedia.org/wiki/정수적으로_닫힌_정역 "wikilink") ⊋ [크룰 정역](../Page/크룰_정역.md "wikilink") ⊋ [유일 인수 분해 정역](../Page/유일_인수_분해_정역.md "wikilink") ∪ [데데킨트 정역](../Page/데데킨트_정역.md "wikilink") ⊋ [유일 인수 분해 정역](../Page/유일_인수_분해_정역.md "wikilink") ∩ [데데킨트 정역](../Page/데데킨트_정역.md "wikilink") = [주 아이디얼 정역](../Page/주_아이디얼_정역.md "wikilink") ⊋ 유클리드 정역 ⊋ [체](https://ko.wikipedia.org/wiki/체_\(수학\) "wikilink")

## 예

  - [정수환](https://ko.wikipedia.org/wiki/정수환 "wikilink") \(\mathbb{Z}\)는 유클리드 정역을 이루며, 이 경우 유클리드 함수를 [절댓값](https://ko.wikipedia.org/wiki/절댓값 "wikilink") \(|\cdot|\)으로 잡을 수 있다. 절댓값이 유클리드 함수라는 것은 [나눗셈 정리의](../Page/나눗셈_정리.md "wikilink") 따름정리다.
...
\[f=gq+r\] 를 만족시키는 \(q\in K[x]\)가 존재한다. 이제, \(\deg r<\deg g\)이거나 \(\deg r\ge\deg g\)이다. [귀류법](https://ko.wikipedia.org/wiki/귀류법 "wikilink")을 사용해, \(\deg r\ge\deg g\)라고 가정하자.
...
[실수 이차 수체](https://ko.wikipedia.org/wiki/실수_이차_수체 "wikilink") \(\mathbb Q(\sqrt d)\)의 [대수적 정수환](https://ko.wikipedia.org/wiki/대수적_정수환 "wikilink") \(\mathcal O_{\mathbb Q(\sqrt d)}\)에 대하여, 다음 두 조건이 서로 [동치](../Page/동치.md "wikilink")이다.
  ...
  - [체 노름의](https://ko.wikipedia.org/wiki/체_노름 "wikilink") [절댓값](https://ko.wikipedia.org/wiki/절댓값 "wikilink") \(f(a+b\sqrt d)=|a^2-b^2d|\)은 \(\mathcal O_{\mathbb Q(\sqrt d)}\)의 유클리드 함수이다.
