...
## 같이 보기
  ...
  - [SRM](https://ko.wikipedia.org/wiki/SRM "wikilink")
  - [EFI](https://ko.wikipedia.org/wiki/확장_펌웨어_인터페이스 "wikilink")
  - [FreeVMS](https://ko.wikipedia.org/wiki/FreeVMS "wikilink")
...
## 외부 링크
  ...
  - [HP OpenVMS 시스템 웹사이트](http://www.hp.com/go/openvms/)

[분류:클러스터 컴퓨팅](https://ko.wikipedia.org/wiki/분류:클러스터_컴퓨팅 "wikilink") [분류:휴렛 팩커드](https://ko.wikipedia.org/wiki/분류:휴렛_팩커드 "wikilink") [분류:병렬 컴퓨팅](https://ko.wikipedia.org/wiki/분류:병렬_컴퓨팅 "wikilink") [분류:품질 관리](https://ko.wikipedia.org/wiki/분류:품질_관리 "wikilink") [분류:1977년 소프트웨어](https://ko.wikipedia.org/wiki/분류:1977년_소프트웨어 "wikilink") [분류:시분할 운영 체제](https://ko.wikipedia.org/wiki/분류:시분할_운영_체제 "wikilink")

1.
2.  [Index of /pdf/dec/vax](http://www.bitsavers.org/pdf/dec/vax/)
...
5.
6.  [OpenGL Frequently Asked Questions (FAQ) \[1/3](http://www.faqs.org/faqs/graphics/opengl-faq/part1/) \]
7.  [ШКОЛА N1 - Воронеж](http://www.shkola1.vrn.ru/02.htm)
8.  [YouTube - HP Disaster Proof Solutions](https://www.youtube.com/watch?v=qMCHpUtJnEI)
9.  OpenVMS Alpha Internals and Data Structures : Scheduling and Process Control : Version 7.0, Ruth Goldenberg, Saro Saravanan, Denise Dumas,
10. OpenVMS Alpha Internals and Data Structures: Memory Management, Ruth Goldenberg,
11. VAX/VMS Internals and Data Structures: Version 5.2 ("IDSM"), Ruth Goldenberg, Saro Saravanan, Denise Dumas,
12. [OpenVMS documentation](http://www.hp.com/go/openvms/doc/); see the DECnet and TCP/IP Services documentation, and see the User's Guide
13. [OpenVMS documentation](http://www.hp.com/go/openvms/doc); see the clustering and OpenVMS Galaxy documentation
14. [OpenVMS documentation](http://www.hp.com/go/openvms/doc/); see the RMS and XQP documentation
15. [OpenVMS documentation](http://www.hp.com/go/openvms/doc); see the RMS documentation
16. The [Oracle Rdb](http://www.oracle.com/rdb/) web site
17. [OpenVMS documentation](http://www.hp.com/go/openvms/doc/); see the languages documentation
18. [OpenVMS Freeware](http://www.hp.com/go/openvms/freeware/); see the Bliss, Macro64, OPS5, Perl, PHP, Tcl/Tk and other language kits and tools
19.
20. Writing Real Programs in DCL, second edition, Stephen Hoffman, Paul Anagnostopoulos,
21. [OpenVMS documentation](http://www.hp.com/go/openvms/doc/); see the OpenVMS User's Guide
22. [OpenVMS documentation](http://www.hp.com/go/openvms/doc/); see the OpenVMS Galaxy documentation
23. [OpenVMS documentation](http://www.hp.com/go/openvms/doc/); see OpenVMS Guide to System Security manual
24.
25. National Computer Security Center (NCSC) Trusted Product Evaluation List (TPEL)
26. OpenVMS at [DEFCON9](http://www.defcon.org/html/links/dc_press/archives/9/vmsone_writeup.htm)