...
EXtended의 축약어인 **ex**는 [유닉스](https://ko.wikipedia.org/wiki/유닉스 "wikilink") 시스템들을 위한 [라인 에디터이다](https://ko.wikipedia.org/wiki/라인_에디터 "wikilink").

최초의 `ex`는 표준 유닉스 에디터 [ed의](../Page/Ed_\(문서_편집기\).md "wikilink") 진화된 버전으로 [BSD](https://ko.wikipedia.org/wiki/BSD "wikilink")에 포함되어 있었다. ex는 ed와 비슷하지만 어떤 스위치들과 옵션들이 변형되어 좀 더 [사용성](../Page/사용성.md "wikilink")이 큰 것이 예외다.
