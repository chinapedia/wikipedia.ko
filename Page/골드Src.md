...
골드 소스의 기초 엔진은 퀘이크에 쓰인 엔진이었지만 밸브 코퍼레이션에서 이를 대폭 수정하였다. 밸브는 퀘이크의 도움을 받지 않고도, 대부분의 코드를 입력하여 엔진을 개발하였다. 엔진의 몇몇 코드는 퀘이크 시리즈에서 재사용 된 것으로, 퀘이크2와 퀘이크월드의 요소를 포함시켰지만, 오리지널 퀘이크와 비교해보자면 아주 최소의 것만 옮겨왔다. 1999년 밸브에서는 벤 모리스를 고용하고 월드크래프트를 인수했는데, 툴을 사용하여 커스텀 퀘이크 맵을 만들기 위함이었다. 툴이라는 프로그램은 나중에 가서 밸브 해머 에디터라는 이름으로 바뀌는데, 골드소스의 공식 맵 크리에이트 프로그램이 된다.
...
밸브가 몇몇 개발한 게임에도 골드소스엔진을 적용했는데, 그 중 하나가 하프라이프를 기반으로 한 유저가 만든 새로운 하프라이프 모드다. 1999년 정식 발매된 [팀 포트리스 클래식도](../Page/팀_포트리스_클래식.md "wikilink") 있으며, [카운터-스트라이크: 리코쳇과](https://ko.wikipedia.org/wiki/카운터-스트라이크:_리코쳇 "wikilink") [데이 오브 디피트가](../Page/데이_오브_디피트.md "wikilink") 하프라이프를 수정시킨거였고, 후에 밸브가 이 게임들을 밸브가 매수하였다. 2004년 [카운터-스트라이크](../Page/카운터-스트라이크.md "wikilink")를 변형시켜 시리즈를 냈는데 이가 [카운터-스트라이크: 컨디션 제로이며](../Page/카운터-스트라이크:_컨디션_제로.md "wikilink"), 후엔 카운터 스트라이크를 변형시켜 소스엔진으로 구현시켜 만든 [카운터-스트라이크: 소스를](../Page/카운터-스트라이크:_소스.md "wikilink") 만들었다. 과거의 게임 시리즈들은 여전히 골드소스를 사용하고 있지만, [카운터-스트라이크: 네오와](https://ko.wikipedia.org/wiki/카운터-스트라이크:_네오 "wikilink") [카운터-스트라이크: 온라인은](../Page/카운터-스트라이크:_온라인.md "wikilink") 각 2005년과 2008년에 출시했으며, 이들은 골드소스로 작동하고 있는데, 소스엔진의 개발에도 불구하고 골드소스엔진을 사용하고있다.

## 개발된 게임

  - [하프라이프](https://ko.wikipedia.org/wiki/하프라이프 "wikilink") ([밸브 코퍼레이션](../Page/밸브_코퍼레이션.md "wikilink")), 1998)
  - [팀 포트리스 클래식](../Page/팀_포트리스_클래식.md "wikilink") ([밸브 코퍼레이션](../Page/밸브_코퍼레이션.md "wikilink"), 1999)
  - [하프라이프: 어포징 포스](../Page/하프라이프:_어포징_포스.md "wikilink") ([기어박스](https://ko.wikipedia.org/wiki/기어박스 "wikilink"), 1999)
  - [카운터 스트라이크](https://ko.wikipedia.org/wiki/카운터_스트라이크 "wikilink") ([밸브 코퍼레이션](../Page/밸브_코퍼레이션.md "wikilink"), 2000)
