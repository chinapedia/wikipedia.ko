...
[가환대수학](../Page/가환대수학.md "wikilink")에서, **유일 인수 분해 정역**(有一因數分解整域, , 약자 UFD) 또는 **인자환**()은 0이 아닌 원소를 [소원으로](https://ko.wikipedia.org/wiki/소원_\(환론\) "wikilink") 유일하게 [인수 분해할](https://ko.wikipedia.org/wiki/인수_분해 "wikilink") 수 있는 [가환환](https://ko.wikipedia.org/wiki/가환환 "wikilink")이다. 이는 [정수](https://ko.wikipedia.org/wiki/정수 "wikilink")의 유일 인수 분해 가능성을 일반화한 것이다.
...
\[a=\prod P=\prod Q\]
  ...
  -
    여기서 \(P=\{p_1,\dots,p_m\}=P\) 및 \(Q=\{q_1,\dots,q_n\}\)는 모두 [기약원](../Page/기약원.md "wikilink")들로 구성된 [중복집합](https://ko.wikipedia.org/wiki/중복집합 "wikilink")이다. 그렇다면 [전단사 함수](https://ko.wikipedia.org/wiki/전단사_함수 "wikilink") \(\phi\colon P\to Q\)가 존재하며, 모든 \(p\in P\)에 대하여
    \[\phi(p)=u(p)p\]
...
다음과 같은 포함 관계가 성립한다.
  ...
  -
    [가환환](https://ko.wikipedia.org/wiki/가환환 "wikilink") ⊋ [정역](../Page/정역.md "wikilink") ⊋ [정수적으로 닫힌 정역](https://ko.wikipedia.org/wiki/정수적으로_닫힌_정역 "wikilink") ⊋ [크룰 정역](../Page/크룰_정역.md "wikilink") ⊋ 유일 인수 분해 정역 ∪ [데데킨트 정역](../Page/데데킨트_정역.md "wikilink") ⊋ 유일 인수 분해 정역 ∩ [데데킨트 정역](../Page/데데킨트_정역.md "wikilink") = [주 아이디얼 정역](../Page/주_아이디얼_정역.md "wikilink") ⊋ [유클리드 정역](https://ko.wikipedia.org/wiki/유클리드_정역 "wikilink") ⊋ [체](https://ko.wikipedia.org/wiki/체_\(수학\) "wikilink")
...
수학에서 등장하는 많은 [환들이](https://ko.wikipedia.org/wiki/환_\(수학\) "wikilink") 유일 인수 분해 정역을 이룬다.

  - [정수](https://ko.wikipedia.org/wiki/정수 "wikilink")의 환 \(\mathbb Z\) · [가우스 정수](https://ko.wikipedia.org/wiki/가우스_정수 "wikilink") 환 \(\mathbb Z[i]\) · [아이젠슈타인 정수](https://ko.wikipedia.org/wiki/아이젠슈타인_정수 "wikilink") 환 \(\mathbb Z[\zeta_3]\)은 모두 [주 아이디얼 정역이므로](../Page/주_아이디얼_정역.md "wikilink") 유일 인수 분해 정역이다.
  - 모든 [체](https://ko.wikipedia.org/wiki/체_\(수학\) "wikilink")([유리수체](https://ko.wikipedia.org/wiki/유리수체 "wikilink") · [실수체](https://ko.wikipedia.org/wiki/실수체 "wikilink") · [복소수체](https://ko.wikipedia.org/wiki/복소수체 "wikilink") · [유한체](https://ko.wikipedia.org/wiki/유한체 "wikilink") 등)는 유일 인수 분해 정역이다. 이 경우, 0이 아닌 모든 원소가 [가역원](../Page/가역원.md "wikilink")이며, 따라서 이 경우는 자명한 예이다.
