...
\(M\)이 [추이적 집합이라고](../Page/추이적_집합.md "wikilink") 하자. 또한, 임의의 [집합](https://ko.wikipedia.org/wiki/집합 "wikilink") \(P\) 및 그 [부분 집합](https://ko.wikipedia.org/wiki/부분_집합 "wikilink") \(G\subseteq P\)가 주어졌다고 하자. 그렇다면
...
[집합](https://ko.wikipedia.org/wiki/집합 "wikilink") \(P\)와 그 [부분 집합](https://ko.wikipedia.org/wiki/부분_집합 "wikilink") \(G\subseteq P\) 및 [추이적 집합](../Page/추이적_집합.md "wikilink") \(M\)이 주어졌다고 하자. 그렇다면, \(\mathcal L_P\)의 [추이적 모형](../Page/추이적_모형.md "wikilink") \(M[G]\)를 다음과 같이 정의하자.
...
[집합](https://ko.wikipedia.org/wiki/집합 "wikilink") \(P\)와 그 부분 집합 \(G\subseteq M\) 및 [추이적 집합](../Page/추이적_집합.md "wikilink") \(M\)이 주어졌다고 하자. 그렇다면,
...
순서수의 개념은 [절대적이다](../Page/절대_논리식.md "wikilink"). 즉, 모형 속의 순서수의 개념은 모형 밖의 순서수의 개념과 일치한다. 그러나 [기수의](https://ko.wikipedia.org/wiki/기수_\(수학\) "wikilink") 개념(즉, 어떤 순서수가 기수인지 여부)은 절대적이지 않으며, 모형 \(M\)의 기수가 \(M[G]\)에서는 기수가 아닌 순서수일 수 있다.
...
기수 \(\kappa\)에 대하여, \(\operatorname{Pfn}(X,Y;\kappa)\)가 정의역의 크기가 \(\kappa\) 미만인 [부분 정의 함수](../Page/부분_정의_함수.md "wikilink") \(X\to Y\)들의 [부분 순서 집합이라고](https://ko.wikipedia.org/wiki/부분_순서_집합 "wikilink") 하자. 그렇다면, 이 [부분 순서 집합에](https://ko.wikipedia.org/wiki/부분_순서_집합 "wikilink") 대한 [강제법](../Page/강제법.md "wikilink")을 **코언 강제법**()이라고 하며, 이를 사용하여 [연속체 가설의](https://ko.wikipedia.org/wiki/연속체_가설 "wikilink") 독립성을 보일 수 있다.
