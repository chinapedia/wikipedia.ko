...
[폴 코언이](../Page/폴_코언.md "wikilink") [연속체 가설의](../Page/연속체_가설.md "wikilink") 독립성을 증명하기 위해 1963년에 도입하였다.\[16\]\[17\]\[18\]\[19\]\[20\] 코언이 사용한 기법은 [구성 가능 위계를](../Page/구성_가능_전체.md "wikilink") 핵심적으로 사용하였고, 오늘날 **분기 강제법**(分岐強制法, )이라고 불린다.
