...
[최소 원소를](https://ko.wikipedia.org/wiki/최소_원소 "wikilink") 갖는 상대적 원자 집합은 원자 집합이다. 모든 [유한](https://ko.wikipedia.org/wiki/유한_집합 "wikilink") [부분 순서 집합은](../Page/부분_순서_집합.md "wikilink") 상대적 원자 집합이며, 따라서 [최소 원소를](https://ko.wikipedia.org/wiki/최소_원소 "wikilink") 갖는 유한 부분 순서 집합은 원자 집합이다.

## 예

자연수(음이 아닌 정수)의 [전순서 집합](https://ko.wikipedia.org/wiki/전순서_집합 "wikilink") \((\mathbb N,\le)\)는 [최소 원소](https://ko.wikipedia.org/wiki/최소_원소 "wikilink") 0을 가지며, 이 부분 순서 집합의 원자는 1밖에 없다. 이는 원자 집합이며, 상대적 원자 집합이며, 또한 원자성 집합이다. 보다 일반적으로, 모든 [정렬 집합은](https://ko.wikipedia.org/wiki/정렬_집합 "wikilink") 원자 집합이며, 상대적 원자 집합이며, 원자성 집합이다.

양의 정수의 약수 관계 \(\mid\)에 대한 [격자](../Page/격자_\(순서론\).md "wikilink") \((\mathbb Z^+,\mid)\)는 최소 원소 0을 가지며, 원자는 [소수이다](https://ko.wikipedia.org/wiki/소수_\(수론\) "wikilink"). 이 집합은 역시 원자 집합이며, 상대적 원자 집합이지만 원자성 집합이 아니다. 예를 들어, 4는 원자들의 집합의 상한으로 나타낼 수 없다.
...
음이 아닌 실수의 [전순서 집합](https://ko.wikipedia.org/wiki/전순서_집합 "wikilink") \((\mathbb R_{\ge0},\le)\)은 최소 원소 0을 갖지만, 원자를 갖지 않는다.
