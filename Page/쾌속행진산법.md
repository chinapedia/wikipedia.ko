...
알고리즘은 [데이크스트라 알고리즘과](https://ko.wikipedia.org/wiki/데이크스트라_알고리즘 "wikilink") 유사하고 정보가 시작 영역에서 바깥으로 뻗어나간다는 점을 이용한다. 이 문제는 [레벨 셋 방법의](https://ko.wikipedia.org/wiki/레벨_셋_방법 "wikilink") 특수한 경우이다. [더 일반적인 알고리즘이](https://ko.wikipedia.org/wiki/아이코날_방정식#계산_알고리즘 "wikilink") 있지만 일반적으로 더 느리다.
...
## 같이 보기
  ...
  - [빠른 스위핑 방법](https://ko.wikipedia.org/wiki/빠른_스위핑_방법 "wikilink")
  - [벨먼-포드 알고리즘](https://ko.wikipedia.org/wiki/벨먼-포드_알고리즘 "wikilink")
