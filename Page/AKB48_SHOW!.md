...
## 개요
  ...
  - 스튜디오에서의 라이브 콘서트에 함께 각 멤버에 의한 인터뷰나 토크, 콩트, 촬영, 각종 행사 뒤를 소개하는 다큐멘터리, 등 다양한 곳에서부터 48그룹의 매력을 끌어내 시청자에게 전달하는 엔터테인먼트 쇼 프로그램이다. 초기에 이제 와서 들을 수 없는 AKB 백열 교실이라는 코너도 있었으나 현재는 폐지된 상태다. 그 외에도 AKB48의 각종 대형 이벤트나 극장 공연 소식을 전하는 AKB48 뉴스가 비정기적으로 방영되고 있다.
