...
[직교좌표계](https://ko.wikipedia.org/wiki/직교좌표계 "wikilink")에서 [푸비니-토넬리 정리를](https://ko.wikipedia.org/wiki/푸비니-토넬리_정리 "wikilink") 이용하여 푸는 방법도 있다.\[1\] 함수 \(xe^{-x^2(1+y^2)}\) 를 \((0, \infty)\) × \((0, \infty)\) 에서 순서를 바꿔 가며 [적분](https://ko.wikipedia.org/wiki/적분 "wikilink")하는 것이다. 먼저 x부터 적분하는 경우,
