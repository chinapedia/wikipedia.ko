...
오픈 액세스 저널 : DOAJ \[[http://www.doaj.org/\]는](http://www.doaj.org/%5D는) 접근을 위해 독자와 그 기관이 충전되지 않는 자금 조달 모델을 사용하여 잡지와 같은 오픈 액세스 저널을 정의한다. [BOAI 정의에서](http://www.earlham.edu/~peters/fos/boaifaq.htm#openaccess), "오픈 액세스"가 잡지를 위한 필수이며 "이 기사의 전체 텍스트를 인쇄, 검색 또는 링크를 읽고 다운로드, 복사, 배포"하는 사용자 권리를 지원 디렉토리에 포함되어 있다.
