...
반사경:8m\~18m의 크기의 반사경으로, 주반사경이다.\[21\]\[22\]

코로나그래프:태양빛을 차단하여 태양 주변에 있는 외계행성을 탐사할 예정이다.\[23\]

차광막:적외선과 자외선을 관측하기 때문에,\[24\] 차광이 매우 중요하다.\[25\] 거의 절대영도로 탐사선을 가동할 예정이며, 각 차광판은 로켓안에서 접혀있다가 페이로드가 우주에 도달하면 개막할 것이다.\[26\]
...
23.
24.
25. 이 두 파장을 관측하려면 주변 온도에 많은 영향을 받아서(온도가 높으면 이상한 데이터가 나옴) 온도가 거의 0[K에](https://ko.wikipedia.org/wiki/절대온도 "wikilink") 가까워야 정확한 관측이 가능하다.
26.
27.
28.