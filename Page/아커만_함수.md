...
[계산 가능성 이론에서](../Page/계산_가능성_이론.md "wikilink"), [빌헬름 아커만의](../Page/빌헬름_아커만.md "wikilink") 이름을 딴 **아커만 함수**(Ackermann函數, )는 [원시 재귀 함수가](https://ko.wikipedia.org/wiki/원시_재귀_함수 "wikilink") 아닌 전역적인 [재귀 함수](https://ko.wikipedia.org/wiki/μ-재귀_함수 "wikilink")(계산가능 함수)의 가장 간단한 예시로, 가장 먼저 발견된 것이기도 하다. 모든 원시 재귀 함수는 완전히 정의되고 계산 가능하지만 아커만 함수는 모든 전역적 재귀 함수가 원시 재귀 함수일 필요는 없다는 것을 보였다.\[1\]
...
1920년 말에 [다비트 힐베르트](../Page/다비트_힐베르트.md "wikilink")(David Hilbert)의 제자인 수학자 [가브리엘 수단](https://ko.wikipedia.org/wiki/가브리엘_수단 "wikilink")(Gabriel Sudan)과 [빌헬름 아커만](../Page/빌헬름_아커만.md "wikilink")(Wilhelm Ackermann)은 계산의 기초를 연구하고 있었다. 수단과 아커만은 둘 다 [원시 재귀 함수가](https://ko.wikipedia.org/wiki/원시_재귀_함수 "wikilink") 아닌 [완전히 정의된](https://ko.wikipedia.org/wiki/완전히_정의된_함수 "wikilink") [계산 가능 함수](https://ko.wikipedia.org/wiki/계산_가능_함수 "wikilink") (어떤 문헌에서는 단순히 "재귀적"으로 표현한다)를 발견한 것으로 인정된다.\[4\] 수단은 덜 알려진 [수단 함수를](https://ko.wikipedia.org/wiki/수단_함수 "wikilink") 발표하였고, 그 직후 1928년에 아커만은 독립적으로 그의 함수 \(\varphi\) (그리스 문자 *[Φ](../Page/Φ.md "wikilink")*)를 발표하였다. 아커만의 3변수 함수 \(\varphi(m, n, p)\)는 *p* = 0, 1, 2일 때, 이 함수는 다음과 같은 기본적인 연산([덧셈](https://ko.wikipedia.org/wiki/덧셈 "wikilink"), [곱셈](../Page/곱셈.md "wikilink"), [거듭제곱](../Page/거듭제곱.md "wikilink"))를 나타낸다.
