...
[수학](https://ko.wikipedia.org/wiki/수학 "wikilink")에서, **지연미분방정식**()은 특정한 시간에서의 미지의 함수의 [도함수](https://ko.wikipedia.org/wiki/도함수 "wikilink")가 이전의 함숫값들의 항들로 나타내어지는 [미분 방정식의](https://ko.wikipedia.org/wiki/미분_방정식 "wikilink") 일종이다.
