...
[섬네일가](https://ko.wikipedia.org/wiki/파일:H96566k.jpg "wikilink") [하버드 대학교에](../Page/하버드_대학교.md "wikilink") 설치된 [하버드 마크 II](https://ko.wikipedia.org/wiki/하버드_마크_II "wikilink") 컴퓨터로 작업하던 중, 동료들이 이 [나방](../Page/나방.md "wikilink")이 [계전기](https://ko.wikipedia.org/wiki/계전기 "wikilink")에 끼어 연산을 방해하고 있던 것을 발견하였는데, 이에 그녀가 그들이 시스템에서 "벌레를 잡고 있다"고 표현하였다. 하여 [버그라고](../Page/소프트웨어_버그.md "wikilink") 하는 유명한 단어가 탄생.\]\] 소프트웨어 공학은 10개의 분야로 나뉜다.\[10\]
