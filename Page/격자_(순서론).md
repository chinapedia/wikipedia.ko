...
[순서론](../Page/순서론.md "wikilink")에서, **격자**(格子, )는 두 원소 부분집합의 [상한](../Page/상한과_하한.md "wikilink")(**이음**, )과 [하한](../Page/상한과_하한.md "wikilink")(**만남**, )이 항상 존재하는 [부분 순서 집합이다](../Page/부분_순서_집합.md "wikilink"). 다시 말해, 임의의 \(a, b \in L\)에 대해, \(l \le a, b \le u\)인 최소 원소 \(l\)과 최대 원소 \(u\)가 항상 존재하는 부분 순서 집합 \((L, \le)\)이다.
