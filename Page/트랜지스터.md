...
**트랜지스터** ()는 [저마늄](https://ko.wikipedia.org/wiki/저마늄 "wikilink"), [규소](https://ko.wikipedia.org/wiki/규소 "wikilink") 따위의 [반도체](../Page/반도체.md "wikilink")를 이용하여 [전자 신호](https://ko.wikipedia.org/wiki/신호_\(전자공학\) "wikilink") 및 전력을 [증폭하거나](https://ko.wikipedia.org/wiki/증폭_회로 "wikilink") [스위칭](https://ko.wikipedia.org/wiki/스위칭 "wikilink")하는 데 사용되는 [반도체소자](https://ko.wikipedia.org/wiki/반도체소자 "wikilink")이다.\[1\]

[Julius Edgar Lilienfeld가](https://ko.wikipedia.org/wiki/Julius_Edgar_Lilienfeld "wikilink") 1926년 [장효과 트랜지스터에](../Page/장효과_트랜지스터.md "wikilink") 대한 특허를 냈으나\[2\] 당시 실제로 동작하는 장치를 구성하지는 못했다. 트랜지스터는 [1947년](../Page/1947년.md "wikilink") 미국의 [벨 연구소에서](https://ko.wikipedia.org/wiki/벨_연구소 "wikilink") [월터 브래튼](https://ko.wikipedia.org/wiki/월터_브래튼 "wikilink"), [윌리엄 쇼클리](https://ko.wikipedia.org/wiki/윌리엄_쇼클리 "wikilink"), [존 바딘이](https://ko.wikipedia.org/wiki/존_바딘 "wikilink") 처음 만들었다. "변화하는 저항을 통한 신호 변환기(transfer of a signal through a varister 또는 transit resistor)"로부터 나온 조어이다.

트랜지스터는 현대 [전자 기기를](https://ko.wikipedia.org/wiki/전자_기기 "wikilink") 구성하는 굉장히 흔한 기본 부품중 하나이다. 1947년 미국 물리학자 [존 바딘](https://ko.wikipedia.org/wiki/존_바딘 "wikilink"), [월터 브래튼](https://ko.wikipedia.org/wiki/월터_브래튼 "wikilink"), [윌리엄 쇼클리에](https://ko.wikipedia.org/wiki/윌리엄_쇼클리 "wikilink") 의해 트랜지스터가 개발된 후 트랜지스터는 전자공학의 대변혁을 일으켰다. 트랜지스터의 출현으로 인해 더 작고 값싼 라디오, 계산기 컴퓨터 등이 개발되었다. 트랜지스터는 [IEEE](https://ko.wikipedia.org/wiki/IEEE "wikilink") 마일스톤상 목록에 기재되어 있으며 트랜지스터 개발자는 1956년 [노벨 물리학상을](../Page/노벨_물리학상.md "wikilink") 수상했다.

[트랜지스터](https://ko.wikipedia.org/wiki/트랜지스터 "wikilink")는 크게 [접합형 트랜지스터](https://ko.wikipedia.org/wiki/접합형_트랜지스터 "wikilink")(Bipolar Junction Transistors:BJTs)와 [전계효과 트랜지스터](https://ko.wikipedia.org/wiki/전계효과_트랜지스터 "wikilink")(Field Effect Transistors:FETs)로 구분된다. 트랜지스터는 보통 입력단, 공통단 그리고 출력단으로 구성되어 있다. 입력단과 공통단 사이에 전압 (FET)또는 전류(BJT)를 인가하면 공통단과 출력단 사이의 전기전도도가 증가하게 되고 이를 통해 그들 사이의 전류흐름을 제어하게 된다. 아날로그, 디지털 회로에서 트랜지스터는 증폭기, 스위치, 논리회로, RAM 등을 구성하는 데 이용된다.
...
실제 소자에서 특성 상, 전류 증폭도 완벽하게 일차함수의 관계를 갖는 것은 아니면 전류가 흐르기 시작할 때와 출력 전류가 만들어진 소자의 능력을 벗어나면 증폭비가 왜곡되는 현상을 나타난다. (그림 2)의 경우, 입력 \(V_{in}\)와 \(I_{\text{B}}\) 변환 과정에서도 왜곡이 생긴다. cut-off 전압에 가까울 수록 왜곡이 커진다.

  -
    \(I_b = \frac{V_{in}}{R_{in}}\)

여기서 \(R_{in}\)은 베이스에서 본 입력 임피던스 이다.
...
전압 분배라는 것은 외부 저항 R<sub>1</sub> 과 R<sub>2</sub> 를 사용하는 것이다. 저항 R<sub>2</sub>에 걸리는 전압은 이미터 접합에서 순방향 바이어스 이다. 저항 R<sub>1</sub> 과 R<sub>2</sub>를 잘 선택함에 따라, 트랜지스터의 작동점을 β에 무관하게 만들 수 있다. 이 회로에서, 전압 분배기는 베이스 전압을 베이스 전류에 관계없이 고정시키는 역할을 한다. 하지만 베이스 전압이 고정되어 있어도 컬렉터 전류는 온도 등에 따라 바뀌게 된다. 그러므로 Q-point를 안정화 시키기 위해 이미터 저항을 추가한다.(옆의 회로 또한 마찬가지이다)
...
## 관련 항목
  ...
  - [집적 회로](../Page/집적_회로.md "wikilink") - [증폭 회로](https://ko.wikipedia.org/wiki/증폭_회로 "wikilink") - [논리 회로](../Page/논리_회로.md "wikilink")
