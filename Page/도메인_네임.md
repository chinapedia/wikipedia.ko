...
등록된 도메인 네임은 보통 [호스트명](../Page/호스트명.md "wikilink")의 일부분으로, [DNS](https://ko.wikipedia.org/wiki/도메인_네임_시스템 "wikilink") 상에서 해당 호스트명 및 그 하위의 호스트명들은 일반적으로 해당 등록자에게 권한이 주어진다. [도메인 레지스트리는](https://ko.wikipedia.org/wiki/도메인_레지스트리 "wikilink") 도메인 네임의 종류에 따라 [국제 인터넷 주소자원 관리기관](https://ko.wikipedia.org/wiki/국제_인터넷_주소자원_관리기관 "wikilink")(ICANN)과 해당 국가 기관으로부터 승인을 받아, 일반 사용자들의 도메인 등록을 위임받는 역할을 한다. 이런 도메인 네임은 숫자로 된 [IP 주소에](https://ko.wikipedia.org/wiki/IP_주소 "wikilink") 비해 외우기 쉬우며, 여러 개의 IP 주소가 한 도메인에 대응되거나 ([서브 도메인](https://ko.wikipedia.org/wiki/서브_도메인 "wikilink")) 여러 도메인이 하나의 IP 주소로 대응되는 ([가상 호스트](https://ko.wikipedia.org/wiki/가상_호스트 "wikilink")) 것도 가능하다.
...
도메인 네임은 그 [최상위 도메인이](https://ko.wikipedia.org/wiki/최상위_도메인 "wikilink") 암시하는 관리 기관 및 등록 요건에 따라 다음과 같이 나뉜다.
  ...
  - [국가 코드 최상위 도메인](https://ko.wikipedia.org/wiki/국가_코드_최상위_도메인 "wikilink")(ccTLD): [ISO 3166-1에](https://ko.wikipedia.org/wiki/ISO_3166-1 "wikilink") 의하여 이름이 결정되고 각국의 [NIC](https://ko.wikipedia.org/wiki/NIC "wikilink")에서 관리하는 국가별 도메인이다.
...
gTLD의 등록, 관리, 분쟁 및 법적인 문제 등 도메인 네임에 관한 모든 행정적인 절차 및 기술적인 관리는 ICANN에서 결정 및 시행한다. gTLD 중 가장 잘 알려진 .com, .net, .org는 본래 [네트워크 솔루션즈에서](https://ko.wikipedia.org/wiki/네트워크_솔루션즈 "wikilink") 독점하고 있었으나 [1999년](https://ko.wikipedia.org/wiki/1999년 "wikilink") 이후로는 경쟁체제로 전환되었다. [.int](https://ko.wikipedia.org/wiki/.int "wikilink")는 본래 [IANA](https://ko.wikipedia.org/wiki/IANA "wikilink")가 인터넷의 하부 구조를 위해 사용하던 gTLD였으나, [.arpa](https://ko.wikipedia.org/wiki/.arpa "wikilink")로 대체되고 현재는 [북대서양 조약 기구](https://ko.wikipedia.org/wiki/북대서양_조약_기구 "wikilink")(NATO) 등의 [국제 조약 기구](https://ko.wikipedia.org/wiki/국제_조약_기구 "wikilink") 및 [비정부조직](https://ko.wikipedia.org/wiki/비정부조직 "wikilink")을 위해 사용되고 있다.
