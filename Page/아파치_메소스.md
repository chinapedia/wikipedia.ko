...
**아파치 메소스**(Apache Mesos)는 [컴퓨터 클러스터를](https://ko.wikipedia.org/wiki/컴퓨터_클러스터 "wikilink") 관리하기 위한 [오픈 소스](https://ko.wikipedia.org/wiki/오픈_소스 "wikilink") 프로젝트이다. [캘리포니아 대학교 버클리에서](https://ko.wikipedia.org/wiki/캘리포니아_대학교_버클리 "wikilink") 개발되었다.
...
메소스는 리눅스 [Cgroups](../Page/Cgroups.md "wikilink")를 사용하여 [중앙 처리 장치](https://ko.wikipedia.org/wiki/중앙_처리_장치 "wikilink"), [메모리](https://ko.wikipedia.org/wiki/가상_메모리 "wikilink"), [입출력](https://ko.wikipedia.org/wiki/입출력 "wikilink"), [파일 시스템의](https://ko.wikipedia.org/wiki/파일_시스템 "wikilink") 분리를 제공한다.\[3\] 메소스는 구글의 서비스를 내부적으로 관리하고 배포시키기 위해 사용되는 플랫폼의 하나인 [구글](https://ko.wikipedia.org/wiki/구글 "wikilink")의 보그 스케줄러(Borg scheduler)와 비교된다.\[4\]
