...
[미분기하학](https://ko.wikipedia.org/wiki/미분기하학 "wikilink")에서, **등각 다양체**(登角多樣體, )는 [리만 계량의](https://ko.wikipedia.org/wiki/리만_계량 "wikilink") (스칼라 함수의 곱에 대한) [동치류](https://ko.wikipedia.org/wiki/동치류 "wikilink")가 갖추어진 [매끄러운 다양체이다](https://ko.wikipedia.org/wiki/매끄러운_다양체 "wikilink").
...
\(p\)차 [미분 형식의](https://ko.wikipedia.org/wiki/미분_형식 "wikilink") 경우, [호지 쌍대](https://ko.wikipedia.org/wiki/호지_쌍대 "wikilink") 사상은 등각 변환 \(g(-,-)\mapsto\exp(2\phi)g(-,-)\)에 대하여 다음과 같이 변환한다.
