> This article is converted from Wikipedia: [GNU C ](https://ko.wikipedia.org/wiki/GNU_C_).


[섬네일는](https://ko.wikipedia.org/wiki/파일:Linux_API.svg "wikilink") 리눅스 커널의 시스템 콜 인터페이스, GNU C 라이브러리([GNU](https://ko.wikipedia.org/wiki/GNU "wikilink")), libdrm, [libalsa](../Page/고급_리눅스_사운드_아키텍처.md "wikilink") 그리고 libevdev ([freedesktop.org](https://ko.wikipedia.org/wiki/freedesktop.org "wikilink"))에 의해 구성된다.\]\] [섬네일](https://ko.wikipedia.org/wiki/파일:Linux_kernel_System_Call_Interface_and_glibc.svg "wikilink") [섬네일과](https://ko.wikipedia.org/wiki/파일:Linux_API_and_Linux_ABI.svg "wikilink") **GNU C 라이브러리**는 함께 리눅스 API를 형성한다. 컴파일 이후 바이너리는 [ABI를](../Page/응용_프로그램_이진_인터페이스.md "wikilink") 제공한다.\]\] **GNU C 라이브러리**는, 일반적으로 **glibc**로 알려진, [GNU 프로젝트가](../Page/GNU_프로젝트.md "wikilink") [C 표준 라이브러리를](../Page/C_표준_라이브러리.md "wikilink") 구현한 것이다. 이름과는 달리 현재는 [C++](https://ko.wikipedia.org/wiki/C++ "wikilink")도 지원한다. 이것은 1990년대 초반 [자유 소프트웨어 재단](https://ko.wikipedia.org/wiki/자유_소프트웨어_재단 "wikilink")(FSF)이 자신의 [GNU](https://ko.wikipedia.org/wiki/GNU "wikilink") 운영 체제를 위해 시작되었다.

[GNU 약소 일반 공중 사용 허가서](../Page/GNU_약소_일반_공중_사용_허가서.md "wikilink") 하에 배포되는 glibc는 [자유 소프트웨어이다](https://ko.wikipedia.org/wiki/자유_소프트웨어 "wikilink").
...
FSF가 glibc 2.0을 릴리즈하였을 때 이것은 더 많은 완전한 POSIX 표준과 더 나은 [국제화와 지역화](../Page/국제화와_지역화.md "wikilink"), 다중언어 함수, [IPv6](https://ko.wikipedia.org/wiki/IPv6 "wikilink") 역량, 64비트 데이터 접근, 멀티스레드 애플리케이션을 위한 기능을 가졌으며 코드는 더 이식가능해졌다.\[5\] 이 시점에서 리눅스 커널 개발자들은 자신들의 분기를 중단하고 다시 FSF의 glibc로 돌아왔다.\[6\]
...
이전의 [CVS](https://ko.wikipedia.org/wiki/CVS "wikilink") 저장소 대신, 2009년 glibc는 *Sourceware*의 [깃](../Page/깃_\(소프트웨어\).md "wikilink") 저장소로 옮겼다.\[11\]
...
| 2.3           | 2002/10          |                                                                                                                                                                                             |                                                                                                                                                                                                              |
| 2.3.1         | 2002/10          |                                                                                                                                                                                             |                                                                                                                                                                                                              |
| 2.3.2         | 2003/2           |                                                                                                                                                                                             | [데비안](https://ko.wikipedia.org/wiki/데비안 "wikilink") 3.1 (Sarge)                                                                                                                                              |
| 2.3.3         | 2003/12          |                                                                                                                                                                                             |                                                                                                                                                                                                              |
| 2.3.4         | 2004/12          | [리눅스 기본 규격](../Page/리눅스_기본_규격.md "wikilink") (LSB) 3.0 표준                                                                                                                                   | [RHEL 4 (업데이트 5)](https://ko.wikipedia.org/wiki/레드햇_엔터프라이즈_리눅스 "wikilink")                                                                                                                                   |
| 2.3.5         | 2005/4           |                                                                                                                                                                                             | [SLES 9](https://ko.wikipedia.org/wiki/수세_리눅스_엔터프라이즈_서버 "wikilink")                                                                                                                                          |
| 2.3.6         | 2005/11          |                                                                                                                                                                                             | [데비안](https://ko.wikipedia.org/wiki/데비안 "wikilink") 4.0 (Etch)                                                                                                                                               |
...
| 2.5           | 2006/9           | 전체 [inotify](https://ko.wikipedia.org/wiki/inotify "wikilink") 지원                                                                                                                           | [RHEL 5](https://ko.wikipedia.org/wiki/레드햇_엔터프라이즈_리눅스 "wikilink")                                                                                                                                            |
| 2.6           | 2007/5           |                                                                                                                                                                                             |                                                                                                                                                                                                              |
| 2.7           | 2007/10          |                                                                                                                                                                                             | [데비안](https://ko.wikipedia.org/wiki/데비안 "wikilink") 5 (Lenny), [우분투](https://ko.wikipedia.org/wiki/우분투_\(운영_체제\) "wikilink") 8.04                                                                            |
| 2.8           | 2008/4           |                                                                                                                                                                                             |                                                                                                                                                                                                              |
| 2.9           | 2008/11          |                                                                                                                                                                                             |                                                                                                                                                                                                              |
| 2.10          | 2009/5           |                                                                                                                                                                                             |                                                                                                                                                                                                              |
...
| 2.12          | 2010/5           |                                                                                                                                                                                             | [RHEL 6](https://ko.wikipedia.org/wiki/레드햇_엔터프라이즈_리눅스 "wikilink")                                                                                                                                            |
...
| 2.17          | 2012/12          | [ARMv-A](https://ko.wikipedia.org/wiki/ARMv-A "wikilink") 지원                                                                                                                                | 우분투 13.04, [RHEL 7](https://ko.wikipedia.org/wiki/레드햇_엔터프라이즈_리눅스 "wikilink")                                                                                                                                 |
...
| 2.22          | 2015/8           | [구글 네이티브 클라이언트](../Page/구글_네이티브_클라이언트.md "wikilink") (NaCl) 지원, [유니코드](https://ko.wikipedia.org/wiki/유니코드 "wikilink") 7.0                                                                   | 페도라 23                                                                                                                                                                                                       |
| 2.23          | 2016/2           | [유니코드](https://ko.wikipedia.org/wiki/유니코드 "wikilink") 8.0                                                                                                                                   |                                                                                                                                                                                                              |

## 기능

glibc는 [단일 유닉스 규격과](../Page/단일_유닉스_규격.md "wikilink") [POSIX](https://ko.wikipedia.org/wiki/POSIX "wikilink") (1c, 1d, 1j)가 요구하는 기능들을 제공하며, [ISO](https://ko.wikipedia.org/wiki/국제_표준화_기구 "wikilink") [C11](https://ko.wikipedia.org/wiki/C11 "wikilink"), [ISO](https://ko.wikipedia.org/wiki/국제_표준화_기구 "wikilink") [C99](../Page/C99.md "wikilink"), [버클리 유닉스](https://ko.wikipedia.org/wiki/BSD "wikilink") (BSD) 인터페이스 등에서 요구하는 몇몇 기능들도 제공한다.

추가적으로 glibc는 또한 GNU 개발에 필요하다고 여겨지거나 유용한 확장들도 제공한다.

### 지원되는 하드웨어와 커널

Glibc는 수많은 여러 커널들과 여러 하드웨어 아키텍처에서 돌아간다. 그러나 가장 흔한 사용은 x86 하드웨어 상의 리눅스 커널에서의 사용이다. 공식적으로 지원되는 하드웨어는\[12\] : [ARM 아키텍처](https://ko.wikipedia.org/wiki/ARM_아키텍처 "wikilink"), [알파 프로세서](https://ko.wikipedia.org/wiki/알파_프로세서 "wikilink"), [PA-RISC](../Page/PA-RISC.md "wikilink"), IA-64, Motorola m68k, MicroBlaze, [MIPS 아키텍처](https://ko.wikipedia.org/wiki/MIPS_아키텍처 "wikilink"), Nios II, [파워PC](../Page/파워PC.md "wikilink"), [s390](../Page/IBM_시스템_z.md "wikilink"), [SPARC](https://ko.wikipedia.org/wiki/SPARC "wikilink"), [타일64](../Page/타일64.md "wikilink"), 그리고 [x86](https://ko.wikipedia.org/wiki/x86 "wikilink")이다. 이것은 [Hurd와](../Page/GNU_허드.md "wikilink") [리눅스 커널을](../Page/리눅스_커널.md "wikilink") 지원한다.

### 작은 장치에서의 사용

glibc는 과거 [리누스 토발즈](https://ko.wikipedia.org/wiki/리누스_토발즈 "wikilink")\[13\]와 임베디드 리눅스 프로그래머들에 의해 크고 느리다는 비판을 받아왔다. 이 이유로 여러 대체 C 표준 라이브러리들이 만들어졌다. 대체 libcs로 Bionic ([안드로이드](https://ko.wikipedia.org/wiki/안드로이드_\(운영_체제\) "wikilink")\[14\]에서 사용되는), [dietlibc](https://ko.wikipedia.org/wiki/dietlibc "wikilink"), [uClibc](https://ko.wikipedia.org/wiki/uClibc "wikilink"), Newlib, [Klibc](../Page/Klibc.md "wikilink"), 그리고 musl이 있다.
...
[안드로이드와](https://ko.wikipedia.org/wiki/안드로이드_\(운영_체제\) "wikilink") [윈도우](https://ko.wikipedia.org/wiki/마이크로소프트_윈도우 "wikilink") 같이 다른 시스템을 위해 쓰여진 프로그램들을 시스템이 제공하는 glibc 인터페이스에서 돌아가게 하는 [호환성 계층이](https://ko.wikipedia.org/wiki/호환성_계층 "wikilink") 존재한다. [와인도](https://ko.wikipedia.org/wiki/와인_\(소프트웨어\) "wikilink") [Win32 API](../Page/윈도우_API.md "wikilink")/ABI에서 glibc로의 호환성 계층으로 여겨진다.
