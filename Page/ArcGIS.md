> This article is converted from Wikipedia: [ArcGIS](https://ko.wikipedia.org/wiki/ArcGIS).


**ArcGIS**는 지도 및 지리 정보로 작업하기 위한 [지리 정보 체계](https://ko.wikipedia.org/wiki/지리_정보_체계 "wikilink")(**GIS**)이다.
