...
\[E /\!/\!/ G\] 를 취할 수 있다. 이는 특이점을 가질 수 있으며, [기하 불변량 이론 몫을](https://ko.wikipedia.org/wiki/기하_불변량_이론_몫 "wikilink") 취하여 [준안정점](https://ko.wikipedia.org/wiki/준안정점 "wikilink")이 아닌 점들을 버릴 수 있다. 이렇게 하여 얻는 복소수 [대수다양체](../Page/대수다양체.md "wikilink")를 \((\Gamma,(V_i,W_i)_{i\in\operatorname V(\Gamma)})\)의 **나카지마 화살집 다양체**라고 한다. 이는 흔히 \(\mathcal M(\Gamma,v,w)\)로 표기된다. 그 복소수 차원은
