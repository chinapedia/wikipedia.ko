...
[양자역학](https://ko.wikipedia.org/wiki/양자역학 "wikilink")과 [양자장론](https://ko.wikipedia.org/wiki/양자장론 "wikilink")에서, **전파 인자**(電波因子, ) 또는 **퍼뜨리개**는 [입자](https://ko.wikipedia.org/wiki/입자 "wikilink")가 (위치 또는 운동량 [기저](https://ko.wikipedia.org/wiki/기저 "wikilink")의) 한 상태에서 다른 상태로 [시간 변화를](../Page/시간_변화.md "wikilink") 겪을 [확률 진폭이다](https://ko.wikipedia.org/wiki/확률_진폭 "wikilink"). 입자의 [파동 방정식의](https://ko.wikipedia.org/wiki/파동_방정식 "wikilink") [그린 함수다](../Page/그린_함수.md "wikilink"). [양자장론](https://ko.wikipedia.org/wiki/양자장론 "wikilink")에서는, 상호작용을 고려하면 매우 복잡하므로, 대개 [라그랑지언](../Page/라그랑지언.md "wikilink")의 자유항만을 고려하여 계산한 것을 지칭한다. 상호작용은 자유 전파 인자를 포함하는 [파인먼 도형으로써](../Page/파인먼_도형.md "wikilink") 나타낸다.
...
비상대론적 입자는 [슈뢰딩거 방정식을](https://ko.wikipedia.org/wiki/슈뢰딩거_방정식 "wikilink") 따른다. 따라서, 그 전파인자는 슈뢰딩거 방정식의 그린 함수이다. [계의](../Page/물리계.md "wikilink") [해밀토니안](https://ko.wikipedia.org/wiki/해밀토니안 "wikilink")을 \(H\)로 쓰면, 입자가 \(x,t\)에서 \(x',t'\)로 이동할 확률진폭을 나타내는 전파인자 \(K(x,t; x',t')\)는 다음을 만족한다.
...
\[G(x,y) = \frac{1}{(2 \pi)^4} \int d^4p \, \frac{e^{-ip(x-y)}}{p^2 - m^2}\] 그러나 [민코프스키 공간에서는](https://ko.wikipedia.org/wiki/민코프스키_공간 "wikilink") 이 적분이 [극](https://ko.wikipedia.org/wiki/극_\(복소해석학\) "wikilink")(極)을 가지므로, 적분을 제대로 정의할 수 없다. 따라서 분모에 무한소의 작은 값을 더하여 적분 경로를 명확히 하는데, 이에는 여러 가지 방법이 있다.
...
[광자](https://ko.wikipedia.org/wiki/광자 "wikilink")의 전파 인자는 다음과 같다. (파인먼 게이지)
