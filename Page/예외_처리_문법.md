...
**예외 처리 문법**은 [프로그래밍 언어](https://ko.wikipedia.org/wiki/프로그래밍_언어 "wikilink") 간에 다양하며 부분적으로는 시맨틱 차이를 두며 크게는 각 언어의 전반적인 [문법 구조에](https://ko.wikipedia.org/wiki/통사론 "wikilink") 맞춘다. 일부 언어들은 관련 개념 [예외 처리를](https://ko.wikipedia.org/wiki/예외_처리 "wikilink") 호출하지 않지만, 다른 언어들은 이를 위해 직접적인 기능은 없어도 구현을 위한 수단을 제공하기도 한다.
