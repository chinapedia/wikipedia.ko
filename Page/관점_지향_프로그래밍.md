...
AOP에는 여러 선행자 A1, A2가 있다:\[1\] [반영](https://ko.wikipedia.org/wiki/반영_\(컴퓨터_과학\) "wikilink"), [메타오브젝트 프로토콜](https://ko.wikipedia.org/wiki/메타오브젝트 "wikilink"), [주체 지향 프로그래밍](https://ko.wikipedia.org/wiki/주체_지향_프로그래밍 "wikilink"), 컴포지션 필터(Composition Filters), 적응형 프로그래밍(Adaptive Programming).\[2\]
...
다음의 [프로그래밍 언어들은](https://ko.wikipedia.org/wiki/프로그래밍_언어 "wikilink") 언어 자체적으로, 또는 외부 라이브러리를 통해 AOP를 구현하고 있다:

  - [닷넷 프레임워크](../Page/닷넷_프레임워크.md "wikilink") 언어 ([C\#](https://ko.wikipedia.org/wiki/C_샤프 "wikilink") / [VB.NET](../Page/비주얼_베이직_닷넷.md "wikilink"))<ref>Numerous:
...
[Afterthought](https://github.com/vc3/Afterthought), [LOOM.NET](http://www.rapier-loom.net/), [Enterprise Library 3.0 Policy Injection Application Block](http://www.codeplex.com/entlib), [AspectDNG](http://sourceforge.net/projects/aspectdng/), [DynamicProxy](http://www.castleproject.org/projects/dynamicproxy/), [Compose\*](http://composestar.sourceforge.net/), [PostSharp](http://www.postsharp.net/), [Seasar.NET](http://www.seasar.org/en/dotnet/), [DotSpect (.SPECT)](http://dotspect.tigris.org/), [Spring.NET](http://www.springframework.net/) (as part of its functionality), [Wicca and Phx.Morph](http://www.cs.columbia.edu/~eaddy/wicca), [SetPoint](http://setpoint.codehaus.org/) </ref>
  ...
  - [액션스크립트](https://ko.wikipedia.org/wiki/액션스크립트 "wikilink")\[7\]

  - [에이다](https://ko.wikipedia.org/wiki/에이다 "wikilink")\[8\]

  - [오토핫키](../Page/오토핫키.md "wikilink")\[9\]

  - [C](https://ko.wikipedia.org/wiki/C_\(프로그래밍_언어\) "wikilink") / [C++](https://ko.wikipedia.org/wiki/C++ "wikilink")\[10\]

  - [코볼](../Page/코볼.md "wikilink")\[11\]

  - [코코아](../Page/코코아_\(API\).md "wikilink") [오브젝티브-C](https://ko.wikipedia.org/wiki/오브젝티브-C "wikilink") 프레임워크\[12\]

  - [어도비 콜드퓨전](../Page/어도비_콜드퓨전.md "wikilink")\[13\]

  - [커먼 리스프](https://ko.wikipedia.org/wiki/커먼_리스프 "wikilink")\[14\]

  - [델파이](https://ko.wikipedia.org/wiki/델파이 "wikilink")\[15\]\[16\]\[17\]
  ...
  - [하스켈](https://ko.wikipedia.org/wiki/하스켈 "wikilink")\[20\]

  - [자바](https://ko.wikipedia.org/wiki/자바_\(프로그래밍_언어\) "wikilink")\[21\]

      - [AspectJ](../Page/AspectJ.md "wikilink")

  - [자바스크립트](https://ko.wikipedia.org/wiki/자바스크립트 "wikilink")\[22\]

  - [로그토크](https://ko.wikipedia.org/wiki/로그토크 "wikilink")\[23\]

  - [루아](https://ko.wikipedia.org/wiki/루아_\(프로그래밍_언어\) "wikilink")\[24\]

  - [make](../Page/Make_\(소프트웨어\).md "wikilink")\[25\]

  - [MATLAB](../Page/MATLAB.md "wikilink")\[26\]

  - [ML](https://ko.wikipedia.org/wiki/ML_\(프로그래밍_언어\) "wikilink")\[27\]

  - [펄](https://ko.wikipedia.org/wiki/펄 "wikilink")\[28\]

  - [PHP](https://ko.wikipedia.org/wiki/PHP "wikilink")\[29\]

  - [프롤로그 (프로그래밍 언어)](https://ko.wikipedia.org/wiki/프롤로그_\(프로그래밍_언어\) "wikilink")\[30\]

  - [파이썬](https://ko.wikipedia.org/wiki/파이썬 "wikilink")\[31\]

  - [래킷](../Page/래킷_\(프로그래밍_언어\).md "wikilink")\[32\]

  - [루비](https://ko.wikipedia.org/wiki/루비_\(프로그래밍_언어\) "wikilink")\[33\]\[34\]\[35\]

  - [스퀵](https://ko.wikipedia.org/wiki/스퀵 "wikilink") [스몰토크](https://ko.wikipedia.org/wiki/스몰토크 "wikilink")\[36\]\[37\]

  - [UML 2.0](../Page/통합_모델링_언어.md "wikilink")\[38\]

  - [XML](https://ko.wikipedia.org/wiki/XML "wikilink")\[39\]
...
3.
4.
5.  Note: The examples in this article appear in a syntax that resembles that of the [Java](https://ko.wikipedia.org/wiki/자바_\(프로그래밍_언어\) "wikilink") language.
