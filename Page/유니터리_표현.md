...
[군 표현론에서](https://ko.wikipedia.org/wiki/군_표현론 "wikilink"), **유니터리 표현**(unitary表現, )은 모든 군 원소의 [상이](https://ko.wikipedia.org/wiki/상_\(수학\) "wikilink") 어떤 [복소수 힐베르트 공간](https://ko.wikipedia.org/wiki/복소수_힐베르트_공간 "wikilink") 위의 [유니터리 작용소를](../Page/유니터리_작용소.md "wikilink") 이루는 [군 표현이다](https://ko.wikipedia.org/wiki/군_표현 "wikilink").

## 정의

[위상군](https://ko.wikipedia.org/wiki/위상군 "wikilink") \(G\)의 **유니터리 표현**은 다음과 같은 데이터로 주어진다.
...
이는 다음 조건을 만족시켜야 한다.
  ...
  - \(\pi\)는 [연속 함수이다](https://ko.wikipedia.org/wiki/연속_함수 "wikilink"). (여기서 \(\operatorname U(V)\) 위에는 [작용소 노름](https://ko.wikipedia.org/wiki/작용소_노름 "wikilink") [거리 위상을](https://ko.wikipedia.org/wiki/거리_위상 "wikilink") 부여한다.)
...
[위상군](https://ko.wikipedia.org/wiki/위상군 "wikilink") \(G\)의 유니터리 표현 \(\pi\colon G\to\operatorname U(V)\)이 주어졌다고 하자. 만약 임의의 부분 [복소수 벡터 공간](https://ko.wikipedia.org/wiki/복소수_벡터_공간 "wikilink") \(W\le V\)가 다음 두 조건을 만족시킨다고 하자.
...
사실, 다음과 같은 **제2 페터-바일 정리**가 성립한다.
  ...
  -
    임의의 콤팩트 [위상군](https://ko.wikipedia.org/wiki/위상군 "wikilink") \(G\)의 유니터리 표현 \((\pi,V)\)에 대하여,
...
여기서 \(\widehat\bigoplus\)는 힐베르트 공간의 직합, 즉 (대수적) [직합](https://ko.wikipedia.org/wiki/직합 "wikilink")의 [완비화이다](https://ko.wikipedia.org/wiki/완비_거리_공간 "wikilink").

### 제1 페터-바일 정리

[콤팩트](https://ko.wikipedia.org/wiki/콤팩트_공간 "wikilink") [위상군](https://ko.wikipedia.org/wiki/위상군 "wikilink") \(G\) 위의 [르베그 공간](https://ko.wikipedia.org/wiki/르베그_공간 "wikilink") \(L^2(G;\mathbb C)\)를 생각하자. 여기서 제곱 적분 가능이란 [하르 측도에](https://ko.wikipedia.org/wiki/하르_측도 "wikilink") 따른 것이며, 편의상 \(\operatorname{vol}(G)=1\)로 규격화하자.
...
페터-바일 정리는 프리츠 페터()와 [헤르만 바일이](https://ko.wikipedia.org/wiki/헤르만_바일 "wikilink") 1927년에 증명하였다.\[1\]
