...
**관계형 데이터베이스 관리 시스템**(relational database management system, **RDBMS**)은 [IBM](https://ko.wikipedia.org/wiki/IBM "wikilink") 산호세 연구소의 [에드거 F. 커드가](../Page/에드거_F._커드.md "wikilink") 도입한 [관계형 모델을](../Page/관계형_모델.md "wikilink") 기반으로 하는 [데이터베이스 관리 시스템이다](../Page/데이터베이스_관리_시스템.md "wikilink"). 현재 사용되는 대부분의 데이터베이스는 [관계형 데이터베이스](https://ko.wikipedia.org/wiki/관계형_데이터베이스 "wikilink") 모델을 기반으로 한다.

1980년대 이래로 RDBMS는 재무기록, 제조 및 물류 정보, 인사 데이터 등의 정보를 저장하는데 가장 많이 사용되는 스토리지다. 과거 [계층형 데이터베이스나](../Page/계층형_모델.md "wikilink") [네트워크 데이터베이스에](https://ko.wikipedia.org/wiki/네트워크_데이터베이스 "wikilink") 비해 사용 및 이해가 쉬워 관계형 데이터베이스가 이들을 많이 대체했다. 하지만 요즘은 [XML 데이터베이스나](https://ko.wikipedia.org/wiki/XML_데이터베이스 "wikilink") 객체지향적 모델과 관계형 모델의 불일치 문제를 해결하기 위해 대두된 [객체 지향 데이터베이스와](https://ko.wikipedia.org/wiki/객체_지향_데이터베이스 "wikilink") 같은 새로운 경쟁자들이 대두되고 있다.

## 시장 점유율

리서치 전문회사 [가트너](https://ko.wikipedia.org/wiki/가트너 "wikilink")에 따르면 2011년 매출기준 TOP 5 상용 관계형 데이터베이스 업체는 [오라클](https://ko.wikipedia.org/wiki/오라클 "wikilink")(48.8%), [IBM](https://ko.wikipedia.org/wiki/IBM "wikilink")(20.2%), [마이크로소프트](https://ko.wikipedia.org/wiki/마이크로소프트 "wikilink")(17.0%), [사이베이스](https://ko.wikipedia.org/wiki/사이베이스 "wikilink")를 포함한 [SAP](https://ko.wikipedia.org/wiki/SAP "wikilink")(4.6%), 마지막으로 [테라데이터](https://ko.wikipedia.org/wiki/테라데이터 "wikilink")(3.7%)다.\[1\]

TOP 3 [오픈 소스](https://ko.wikipedia.org/wiki/오픈_소스 "wikilink") DBMS는 [MySQL](https://ko.wikipedia.org/wiki/MySQL "wikilink"), [PostgreSQL](../Page/PostgreSQL.md "wikilink"), [SQLite](https://ko.wikipedia.org/wiki/SQLite "wikilink")다. MySQL이 오라클에 인수된 이후 가장 많이 사용되는 MySQL의 [포크는](../Page/포크_\(소프트웨어_개발\).md "wikilink") [MariaDB](https://ko.wikipedia.org/wiki/MariaDB "wikilink")다.
...
가트너에 따르면 위 DBMS들이 사용되는 사이트들의 비율은 중복을 포함해 다음과 같다.\[2\]
  ...
  - [MySQL](https://ko.wikipedia.org/wiki/MySQL "wikilink") (오라클) - 50%
