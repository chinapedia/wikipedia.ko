...
libjpeg은 다음과 같은 유틸리티들을 포함하고 있다.

  - **cjpeg**, **djpeg**은 JPEG과 다른 사진 파일 포맷간의 변환을 수행한다.
  - **rdjpgcom**, **wrjpgcom**은 [JFIF](https://ko.wikipedia.org/wiki/JFIF "wikilink") 파일 안의 텍스트의 읽고 쓰기를 수행한다.
  - **jpegtran**은 서로 다른 JPEG 포맷간의 무손실 트랜스코딩을 위한 유틸리티이다.
...
## 외부 링크
  ...
  - [Independent JPEG Group 웹사이트](http://www.ijg.org)
