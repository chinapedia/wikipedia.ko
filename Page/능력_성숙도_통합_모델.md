...
#### [소프트웨어 공학](https://ko.wikipedia.org/wiki/소프트웨어_공학 "wikilink")(Software engineering)
...
CMMI의 프로젝트 관리 프로세스 영역은 다음과 같다.
  ...
  - 프로젝트 계획(Project Planning)
  - [프로젝트 감시 및 통제](https://ko.wikipedia.org/wiki/프로젝트_감시_및_통제 "wikilink")(Project Monitoring and Control)
  - 공급자 계약 관리(Supplier Agreement Management)
...
CMMI의 전신에 해당하는 CMM(Capability Maturity Model)은 [미국](https://ko.wikipedia.org/wiki/미국 "wikilink") [카네기 멜론 대학](https://ko.wikipedia.org/wiki/카네기_멜론_대학 "wikilink")([CMU](https://ko.wikipedia.org/wiki/CMU "wikilink"))의 [소프트웨어 공학 연구소](https://ko.wikipedia.org/wiki/소프트웨어_공학_연구소 "wikilink")(SEI; Software Engineering Institute가 IT 개발의 프로세스 관리능력 향상을 위해 미국방성(Department of Defense)의 자금 지원을 받은 프로젝트로 1986년부터 연구하기 시작하여 1991년도에 발표한 표준 모델이다. CMM은 가장 먼저 개발된 SW-CMM을 일컫는 말이기도 하지만 현재는 소프트웨어 이외에도 적용할 수 있는 많은 분야가 있어 이런 부류의 성숙도 모델을 총칭하는 의미로 사용된다. SEI는 2005년부터 CMM에 대한 지원과 업데이트를 중단하고 CMMI 확산에 주력하겠다는 방침을 밝힌바 있다.

CMMI는 [항공전자](https://ko.wikipedia.org/wiki/항공전자 "wikilink") [소프트웨어](https://ko.wikipedia.org/wiki/소프트웨어 "wikilink") 개발이나 [북미](https://ko.wikipedia.org/wiki/북미 "wikilink"), [유럽](https://ko.wikipedia.org/wiki/유럽 "wikilink"), [아시아](https://ko.wikipedia.org/wiki/아시아 "wikilink"), [오스트레일리아](https://ko.wikipedia.org/wiki/오스트레일리아 "wikilink"), [남아메리카](https://ko.wikipedia.org/wiki/남아메리카 "wikilink"), [아프리카](https://ko.wikipedia.org/wiki/아프리카 "wikilink") 등의 나라들의 정부 주체로 실시하는 프로젝트 등에서 넓게 사용되어 오고 있어 이러한 나라들에서 CMMI에 대한 관심은 높다. 현재, 몇 개의 나라들의 정부기관에서는 소프트웨어 개발 계약에 있어서 지원 업체에게 레벨3 기준을 기본으로 요구하고 있는 실정이다.
...
## 외부 링크
  ...
  - [한국 CMMI 포럼](http://www.seri.org/forum/cmmforum/)

  - [S3M](http://www.s3m.ca/)

  -
  - [List of Published SCAMPI Appraisal Results (CMMI레벨검색사이트)](https://sas.cmmiinstitute.com/pars/pars.aspx)
