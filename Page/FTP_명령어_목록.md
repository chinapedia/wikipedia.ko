...
| 명령어  | [RFC](https://ko.wikipedia.org/wiki/RFC "wikilink") | 설명                                                                                                                         |
| ---- | --------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------- |
| ABOR |                                                     | 현재의 파일 전송 중단.                                                                                                              |
| ACCT |                                                     | 계정 정보.                                                                                                                     |
...
| STRU |                                                     | 전송 구조 설정.                                                                                                                  |
| SYST |                                                     | 시스템 유형 반환.                                                                                                                 |
| TYPE |                                                     | 전송 모드 설정 ([ASCII](https://ko.wikipedia.org/wiki/ASCII "wikilink")/[바이너리](https://ko.wikipedia.org/wiki/이진_파일 "wikilink")). |
| USER |                                                     | 인증 사용자 이름.                                                                                                                 |
