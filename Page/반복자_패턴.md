...
**반복자 패턴**(iterator pattern)은 [객체 지향 프로그래밍에서](https://ko.wikipedia.org/wiki/객체_지향_프로그래밍 "wikilink") [반복자](../Page/반복자.md "wikilink")를 사용하여 [컨테이너](https://ko.wikipedia.org/wiki/컨테이너 "wikilink")를 가로지르며 컨테이너의 요소들에 접근하는 [디자인 패턴이다](https://ko.wikipedia.org/wiki/디자인_패턴 "wikilink"). 반복자 패턴은 컨테이너로부터 [알고리즘](https://ko.wikipedia.org/wiki/알고리즘 "wikilink")을 분리시키며, 일부의 경우 알고리즘들은 필수적으로 컨테이너에 특화되어 있기 때문에 분리가 불가능하다.
...
반복자\[1\] 디자인 패턴은 유연하고 재사용 가능한 객체 지향 소프트웨어를 설계하기 위해 반복되는 디자인 문제를 해결하는 방법, 즉 객체는 구현, 변경, 테스트, 재사용이 쉬워야 한다는 것을 기술하는, 잘 알려진 23가지 [GoF 디자인 패턴들](https://ko.wikipedia.org/wiki/디자인_패턴_\(책\) "wikilink") 중 하나이다.
...
## 같이 보기
  ...
  - [컴포지트 패턴](https://ko.wikipedia.org/wiki/컴포지트_패턴 "wikilink")
...
1.
2.  [Gang Of Four](https://ko.wikipedia.org/wiki/디자인_패턴_\(책\) "wikilink")