...
기능들은 주로 [멀티태스킹](https://ko.wikipedia.org/wiki/멀티태스킹 "wikilink")을 지원하지 않는 메모, 계산기, 전화, 문자, [아이튠즈](../Page/아이튠즈.md "wikilink")와 같은 기본적인 전화기 기능만 존재하였으며, 이때 제작된 기본 애플리케이션들은 [iOS 6까지](https://ko.wikipedia.org/wiki/iOS_6 "wikilink") 쭉 변함없이 이어지는 계기가 되었다.
