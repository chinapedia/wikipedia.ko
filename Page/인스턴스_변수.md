...
클래스가 있는 [객체 지향 프로그래밍에서](https://ko.wikipedia.org/wiki/객체_지향_프로그래밍 "wikilink") **인스턴스 변수**()는 클래스(예: [멤버 변수](../Page/멤버_변수.md "wikilink"))에 정의된 변수로, 이를 위해 각각의 인스턴스화된 클래스의 [객체가](https://ko.wikipedia.org/wiki/객체_\(컴퓨터_과학\) "wikilink") 별도의 사본이나 인스턴스를 가지고 있다. 인스턴스 변수는 [클래스 변수와](https://ko.wikipedia.org/wiki/클래스_변수 "wikilink") 비슷하다.\[1\]

인스턴스 변수는 [클래스 변수가](https://ko.wikipedia.org/wiki/클래스_변수 "wikilink") 아니지만 유사점이 있다. [클래스 속성](https://ko.wikipedia.org/wiki/클래스_\(컴퓨터_과학\) "wikilink")(클래스 프로퍼티, 필드, 데이터 멤버)의 일종이다. 인스턴스와 클래스 멤버 간에 동일한 이분법이 [메소드](https://ko.wikipedia.org/wiki/메소드 "wikilink")(멤버 함수)에도 적용되며, 클래스는 [인스턴스 메소드와](https://ko.wikipedia.org/wiki/인스턴스_메소드 "wikilink") [클래스 메소드를](https://ko.wikipedia.org/wiki/클래스_메소드 "wikilink") 둘 다 소유할 수 있다.
