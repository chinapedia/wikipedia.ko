...
**룬 알고리즘**(Luhn algorithm)은 [신용카드](https://ko.wikipedia.org/wiki/신용카드 "wikilink") 번호 검증에 사용되는 알고리즘이다.

이 알고리즘은 지식재산권의 보호기간이 끝난 [퍼블릭 도메인](https://ko.wikipedia.org/wiki/퍼블릭_도메인 "wikilink") 저작물에 속하며 오늘날 널리 사용되고 있다. [ISO/IEC 7812](https://ko.wikipedia.org/wiki/ISO/IEC_7812 "wikilink")-1에 규정되어 있다.\[1\]
