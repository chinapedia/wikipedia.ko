...
[조합론](../Page/조합론.md "wikilink")에서, **완전순열**() 또는 **교란**()은 모든 원소의 위치를 바꾸는 [순열](https://ko.wikipedia.org/wiki/순열 "wikilink")이다.

## 정의

집합 \(S\)의 [순열](https://ko.wikipedia.org/wiki/순열 "wikilink") ([일대일 대응](https://ko.wikipedia.org/wiki/일대일_대응 "wikilink")) \(\sigma\colon S\to S\)가 모든 \(s\in S\)에 대하여 다음 성질을 만족시키면, \(\sigma\)를 **완전순열**이라고 한다.

\[\sigma(s)\ne s.\] 즉, 완전순열은 [고정점](../Page/고정점.md "wikilink")이 없는 순열이다.

## 준계승

\(S\) [유한 집합이라고](https://ko.wikipedia.org/wiki/유한_집합 "wikilink") 하고, 그 크기를 \(|S|=n\)이라고 하자. 그렇다면, \(n\)개의 원소에 대한 완전순열의 수를 **준계승**()이라고 한다. 준계승은 기호로 \(!n\)으로 쓴다.
...
<tbody>
<tr class="odd">
<td><p>이 공식들은 <a href="https://ko.wikipedia.org/wiki/점화식" title="wikilink">점화식</a>을 사용하여 증명할 수 있다.</p>
<p>집합</p>
