...
## 기능
  ...
  - 기능 확장을 위한 내외부적 [XML](https://ko.wikipedia.org/wiki/XML "wikilink")기능 지원
...
EPUB에서 이미지는 [PNG](https://ko.wikipedia.org/wiki/PNG "wikilink"), [JPEG](https://ko.wikipedia.org/wiki/JPEG "wikilink"), [GIF](https://ko.wikipedia.org/wiki/GIF "wikilink"), [SVG](https://ko.wikipedia.org/wiki/SVG "wikilink") 형식을 지원한다. 이들은 각각 [mimetype의](https://ko.wikipedia.org/wiki/인터넷_미디어_타입 "wikilink") `image/png, image/jpeg, image/gif, image/svg+xml`를 사용한다. 다른 미디어 형식도 허용되나, 제작자가 지원 형식으로 된 대체물을 지정해 두어야 한다.\[3\] mimetypes을 위한 표는 Section 1.3.7의 세부사항\[4\]을 참고하면 된다.

국제적이며 다중언어 서적을 위해 [Unicode](https://ko.wikipedia.org/wiki/Unicode "wikilink") 가 사용되며, 제작자는 [UTF-8](https://ko.wikipedia.org/wiki/UTF-8 "wikilink") or [UTF-16](https://ko.wikipedia.org/wiki/UTF-16 "wikilink") 인코딩을 사용해야 한다. 하지만, 읽기 시스템에서 유니코드의 모든 유니코드 문자를 위한 폰트를 제공해야 하는 것은 아니지만, 표시할 수 없는 문자를 위한 표시는 해주어야 한다.\[5\]
...
| [캘리버](../Page/캘리버.md "wikilink")(Calibre)                                           | [윈도](https://ko.wikipedia.org/wiki/마이크로소프트_윈도 "wikilink"), [OS X](https://ko.wikipedia.org/wiki/OS_X "wikilink"), [리눅스](https://ko.wikipedia.org/wiki/리눅스 "wikilink")                |                                                                   | 도서관 관리, 변환, 전자책 연결에 주로 사용,[GPL](https://ko.wikipedia.org/wiki/GPL "wikilink") |
| [EPUBReader](https://ko.wikipedia.org/wiki/EPUBReader "wikilink")                   | Firefox add-on [윈도](https://ko.wikipedia.org/wiki/마이크로소프트_윈도 "wikilink"), [OS X](https://ko.wikipedia.org/wiki/OS_X "wikilink"), [리눅스](https://ko.wikipedia.org/wiki/리눅스 "wikilink") |                                                                   | [파이어폭스](https://ko.wikipedia.org/wiki/파이어폭스 "wikilink") 추가 기능                 |
...
| [Lucidor (software)](https://ko.wikipedia.org/wiki/Lucidor_\(software\) "wikilink") | 윈도, [OS X](https://ko.wikipedia.org/wiki/OS_X "wikilink"), [리눅스](https://ko.wikipedia.org/wiki/리눅스 "wikilink")                                                                       |                                                                   |                                                                               |
...
| [Okular](https://ko.wikipedia.org/wiki/Okular "wikilink")                           | [리눅스](https://ko.wikipedia.org/wiki/리눅스 "wikilink"), 윈도, [Maemo](https://ko.wikipedia.org/wiki/Maemo "wikilink"), [OS X](https://ko.wikipedia.org/wiki/OS_X "wikilink")              |                                                                   |                                                                               |
...
| [IkuReader](https://ko.wikipedia.org/wiki/IkuReader "wikilink")                     | [닌텐도 DS](https://ko.wikipedia.org/wiki/닌텐도_DS "wikilink")                                                                                                                            |                                                                   |                                                                               |
|                                                                                     |                                                                                                                                                                                      |                                                                   |                                                                               |
...
| [eBookStylist (application)](https://ko.wikipedia.org/wiki/eBookStylist_\(application\) "wikilink") | [윈도](https://ko.wikipedia.org/wiki/마이크로소프트_윈도 "wikilink"), [리눅스](https://ko.wikipedia.org/wiki/리눅스 "wikilink"), [OS X](https://ko.wikipedia.org/wiki/OS_X "wikilink") | Adobe AIR기반의 프로그램, CSS를 간단한 설정으로 생성할 수 있는 스타일 EPUB 제작 도구                                                                   |
...
| [eCub](https://ko.wikipedia.org/wiki/eCub "wikilink")                                               | [윈도](https://ko.wikipedia.org/wiki/마이크로소프트_윈도 "wikilink"), [OS X](https://ko.wikipedia.org/wiki/OS_X "wikilink"), [리눅스](https://ko.wikipedia.org/wiki/리눅스 "wikilink") | 암호화 불가능                                                                                                                    |
...
| [Sigil](https://ko.wikipedia.org/wiki/Sigil_\(application\) "wikilink")                             | [윈도](https://ko.wikipedia.org/wiki/마이크로소프트_윈도 "wikilink"), [리눅스](https://ko.wikipedia.org/wiki/리눅스 "wikilink"), [OS X](https://ko.wikipedia.org/wiki/OS_X "wikilink") | GPLv3하의 자유 소프트웨어                                                                                                           |
