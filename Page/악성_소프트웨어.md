...
**악성 소프트웨어**,**유해한 소프트웨어**(惡性-) 또는 **맬웨어**()는 [컴퓨터](../Page/컴퓨터.md "wikilink"), [서버](../Page/서버.md "wikilink"), [클라이언트](https://ko.wikipedia.org/wiki/클라이언트_\(컴퓨팅\) "wikilink"), [컴퓨터 네트워크에](https://ko.wikipedia.org/wiki/컴퓨터_네트워크 "wikilink") 악영향을 끼칠 수 있는 모든 [소프트웨어](https://ko.wikipedia.org/wiki/소프트웨어 "wikilink")의 총칭이다. 예전에는 단순히 [컴퓨터 바이러스만이](../Page/컴퓨터_바이러스.md "wikilink") 활동하였으나, 1990년대 말 들어서 감염 방법과 증상들이 다양해지면서 자세히 분류를 나누기 시작했다. 과거에는 디스크 복제 등 저장매체를 따라 전파되었으나 네트워크가 발달하면서 이메일이나 웹으로 감염되는 경우가 훨씬 많아졌다.
...
## 종류
  ...
  - [스파이웨어](https://ko.wikipedia.org/wiki/스파이웨어 "wikilink"): 사용자의 정보를 빼내는 악성 소프트웨어
  ...
  - [하이재커](https://ko.wikipedia.org/wiki/하이재커 "wikilink"): 의도치 않은 사이트로 이동을 시키고 팝업창을 띄우는 악성 소프트웨어
