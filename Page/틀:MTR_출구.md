...
녹색 「出(출)」자가 표시되지 않도록 선택.
`{{MTR 출구|exitsign=none|A|1}}`
...
[분류:홍콩 지하철에 관한 틀](https://ko.wikipedia.org/wiki/분류:홍콩_지하철에_관한_틀 "wikilink") </noinclude>