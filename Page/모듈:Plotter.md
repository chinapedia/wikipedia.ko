> This article is converted from Wikipedia: [모듈:Plotter](https://ko.wikipedia.org/wiki/모듈:Plotter).
...
`   if mw.ustring.sub(page,1,7) ~= "모듈:" then page="모듈:Plotter/DefaultColors" end`
`   local ct=mw.loadData(page)`
`   if not ct then ct=mw.loadData("모듈:Plotter/DefaultColors") end`
`   local x=0`
`   local color={}`
`   local name={}`
`   repeat`
...
<div style="border:solid transparent;position:absolute;width:'..radius..'px;line-height:0px;'..lr..':'..lrv..'px;top:'..tv..'px;border-width:'..bw1..'px '..bw2..'px '..bw3..'px '..bw4..'px;border-'..bd..'color:'..color..';">
...
<div style="position:absolute;line-height:0px;border-style:solid;'..lrB..':0px;top:0px;border-width:0px '..bw2B..'px '..radius..'px 0px;border-color:'..color..';">
...
<div style="position:absolute;line-height:0px;border-style:solid;left:0px;top:0px;border-width:0px '..radius..'px '..2*radius..'px 0px;border-color:'..color..';">
...
['..(radius\*2)..'px](https://ko.wikipedia.org/wiki/File:Circle_frame.svg "fig:'..(radius*2)..'px")<Module:Plotter internal imgmap insertion token>
...
`           output=piechartslice(color[slice],valuesum,radius)..output.."``"`
`       end`
`   end`
...
<div class="thumb t'..thumb..'">

<div class="thumbinner" style="width:'..2*radius..'px">

<div style="background-color:white;margin:auto;position:relative;width:'..2*radius..'px;height:'..2*radius..'px;overflow:hidden;">
...
`   if nowiki then return frame.preprocess(frame,"`

    <nowiki>"..output.."</nowiki>

") else return frame.preprocess(frame,output) end end
...
`   local output = [[<div_style="position:relative;border-style:solid;border-color:_#0077ff;width:|`

<div style="position:relative;border-style:solid;border-color: #0077ff;width:]] .. plotsizex+(2*iconradius) .. [[px;height:|px;height:]] .. plotsizey+(2*iconradius) .. [[px;">
...
`           output = output .. `[<span style="position:absolute;left:]] .. plotx .. [[px;_top:|px; top:]] .. ploty .. [[px;">`|px;">`](https://ko.wikipedia.org/wiki/\<span_style="position:absolute;left: "wikilink")` .. icon .. "`</span>`"`
`           lastx = plotx`
`           lasty = ploty`
`       end`
`       index = 3`
...
`                 output = output .. `[<span style="position:absolute;left:]] .. lastx+linefix+math.floor(delx*(plotparm/plotdist)) .. [[px;_top:|px; top:]] .. lasty+linefix+math.floor(dely*(plotparm/plotdist)) .. [[px;">`|px;">`](https://ko.wikipedia.org/wiki/\<span_style="position:absolute;left: "wikilink")` .. lineicon .. "`</span>`"`
...
<div style="position:relative;border-style:solid;border-color: #0077ff;width:]] .. width .. [[px;height:|px;height:]] .. height .. [[px;">

|px;"\>\]\]

`   local output='`

<div style="position:relative;overflow:visible;border-style:solid;border-color: #0077ff;width:' .. width .. 'px;height:' .. height .. 'px;">
...
<div style="position:absolute;background-color:' .. data[y].color .. ';width:' .. ew .. 'px;height:' .. eh .. 'px;top:' .. et .. 'px;left:' .. el .. 'px;">
