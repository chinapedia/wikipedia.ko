...
[대수기하학](https://ko.wikipedia.org/wiki/대수기하학 "wikilink")과 [미분기하학](https://ko.wikipedia.org/wiki/미분기하학 "wikilink")에서, **안정 벡터 다발**(安定vector다발, )은 [정칙 벡터 다발](../Page/정칙_벡터_다발.md "wikilink") 가운데, [모듈라이 공간을](../Page/모듈라이_공간.md "wikilink") 잘 정의할 수 있는 것들이다.

## 정의

다음이 주어졌다고 하자.

  - 콤팩트 [복소다양체](https://ko.wikipedia.org/wiki/복소다양체 "wikilink") \(M\)
  - 고차원 [복소수 사영 공간으로의](https://ko.wikipedia.org/wiki/복소수_사영_공간 "wikilink") [단사](https://ko.wikipedia.org/wiki/단사_함수 "wikilink") [정칙 함수](https://ko.wikipedia.org/wiki/정칙_함수 "wikilink") \(M \hookrightarrow \operatorname{\mathbb CP}^N\). 이에 따라, \(M\) 위에는 표준적인 [켈러 다양체](https://ko.wikipedia.org/wiki/켈러_다양체 "wikilink") 구조가 주어지며, 켈러 형식의 코호몰로지류 \([\omega]\in\operatorname H^2(M;\mathbb R)\)는 정수 계수 코호몰로지로 주어진다는 정수 계수이다. ([고다이라 매장 정리에](../Page/고다이라_매장_정리.md "wikilink") 의하여, 그 역 또한 성립한다.)
  - \(M\) 위의 [정칙 벡터 다발](../Page/정칙_벡터_다발.md "wikilink") \(E\twoheadrightarrow M\)

### 다발의 기울기

\(E \ne 0\)이라고 할 때, \(E\)의 **기울기**()는 다음과 같은 [유리수](https://ko.wikipedia.org/wiki/유리수 "wikilink")이다.
...
\[\operatorname U(1)_{\operatorname{diag}} \le G \le \operatorname{GL}(n;\mathbb C)\] 이 주어졌으며, \(E \twoheadrightarrow M\)가 \(M\) 위의, \(G\) 구조의 [정칙 벡터 다발이라고](../Page/정칙_벡터_다발.md "wikilink") 하고, 이에 대응되는 \(G\)-[주다발](https://ko.wikipedia.org/wiki/주다발 "wikilink")이

\[P\twoheadrightarrow M\] 이라고 하자.

그렇다면, \(E\) 위의 어떤 [벡터 다발 접속](https://ko.wikipedia.org/wiki/벡터_다발_접속 "wikilink") \(\nabla\)의 곡률

\[F_{i\bar\jmath}^a \in \Omega^{1,1}(M;\mathfrak{ad}(P))\] 을 정의할 수 있다. 이는 (1,1)차 [벡터 값](../Page/벡터_값_미분_형식.md "wikilink") [복소수 미분 형식이며](https://ko.wikipedia.org/wiki/복소수_미분_형식 "wikilink"), 이것이 값을 갖는 [벡터 다발은](https://ko.wikipedia.org/wiki/벡터_다발 "wikilink") [딸림표현](https://ko.wikipedia.org/wiki/딸림표현 "wikilink") [연관 벡터 다발](https://ko.wikipedia.org/wiki/연관_벡터_다발 "wikilink")
...
\[F \in \mathrm i\mathbb Rm(\omega) \subseteq \Omega^{1,1}(M;\operatorname{End}E)\] 라면, \(\nabla\)를 **에르미트-아인슈타인 접속**이라고 한다. \(\mathrm i\lambda\)는 [허수](https://ko.wikipedia.org/wiki/허수 "wikilink")이므로, 이 경우 \(E\) 위에 임의의 [에르미트 계량을](https://ko.wikipedia.org/wiki/에르미트_계량 "wikilink") 부여한다면, \(\nabla\)는 자명하게 유니터리 접속을 이룬다 (모든 [모노드로미](https://ko.wikipedia.org/wiki/모노드로미 "wikilink")가 에르미트 계량에 대하여 [유니터리 행렬이다](https://ko.wikipedia.org/wiki/유니터리_행렬 "wikilink")).

### 안정 벡터 다발

\(E \ne 0\)일 때, 다음 세 조건이 서로 [동치](https://ko.wikipedia.org/wiki/동치 "wikilink")이며, 이를 만족시키는 정칙 벡터 다발을 **안정 벡터 다발**이라고 한다.\[1\]
...
다음이 주어졌다고 하자.
  ...
  - 콤팩트 [리만 곡면](https://ko.wikipedia.org/wiki/리만_곡면 "wikilink") \(\Sigma\)
  - [정칙 벡터 다발](../Page/정칙_벡터_다발.md "wikilink") \(E \twoheadrightarrow \Sigma\)

이 경우, \(\operatorname H^2(\Sigma)\)가 1차원이므로, \(\Sigma\) 위에 임의의 [켈러 다양체](https://ko.wikipedia.org/wiki/켈러_다양체 "wikilink") 구조를 부여하더라도, 그 스칼라배를 취하여 이것이 사영 다양체가 되게 만들 수 있다. 구체적으로, 이 경우 항상 \(\Sigma\)의 넓이가 1이 되게 규격화할 수 있다.
...
다음이 주어졌다고 하자.
  ...
  - 복소수 1차원 [콤팩트](https://ko.wikipedia.org/wiki/콤팩트_공간 "wikilink") [켈러 다양체](https://ko.wikipedia.org/wiki/켈러_다양체 "wikilink") \(\Sigma\)
  - [정칙 벡터 다발](../Page/정칙_벡터_다발.md "wikilink") \(E \twoheadrightarrow \Sigma\)
...
\[T_\gamma \in \operatorname{GL}(E_{\gamma(0)};\mathbb C)\] 를 정의할 수 있다. 만약 이러한 모노드로미가 모두 [유니터리 군](https://ko.wikipedia.org/wiki/유니터리_군 "wikilink")

\[\operatorname U(E_{\gamma(0)}) \le \operatorname{GL}(E_{\gamma(0)};\mathbb C)\] 에 속한다면, 이러한 접속을 **유니터리 접속**()이라고 하자. 유니터리 접속 \(\nabla\)이 주어졌을 때, 그 곡률

\[F_\nabla \in \Omega^2(\Sigma;\operatorname u(E))\] 를 생각하자. (\(\operatorname u(E)\)는 \(E\) 위의 유니터리 [리 대수들의](https://ko.wikipedia.org/wiki/리_대수 "wikilink") [벡터 다발이다](https://ko.wikipedia.org/wiki/벡터_다발 "wikilink").) 이제, [부피 형식을](../Page/부피_형식.md "wikilink") 통한 [호지 쌍대](https://ko.wikipedia.org/wiki/호지_쌍대 "wikilink")
...
다음이 주어졌다고 하자.
  ...
  - 종수 \(g\)의 [리만 곡면](https://ko.wikipedia.org/wiki/리만_곡면 "wikilink") \(\Sigma\)
  - [자연수](https://ko.wikipedia.org/wiki/자연수 "wikilink") \(r\in\mathbb N\) ([정칙 벡터 다발의](../Page/정칙_벡터_다발.md "wikilink") 차원)
  - [정수](https://ko.wikipedia.org/wiki/정수 "wikilink") \(d \in \mathbb Z\) ([정칙 벡터 다발의](../Page/정칙_벡터_다발.md "wikilink") 차수)

그렇다면, \(\Sigma\) 위의 \(r\)차원 \(d\)차 안정 [정칙 벡터 다발들의](../Page/정칙_벡터_다발.md "wikilink") [모듈라이 공간](../Page/모듈라이_공간.md "wikilink")

\[\mathcal M(\Sigma,r,d)\] 을 정의할 수 있다. 이는 [연결 공간인](https://ko.wikipedia.org/wiki/연결_공간 "wikilink") 복소수 [사영 대수다양체이다](https://ko.wikipedia.org/wiki/사영_대수다양체 "wikilink"). \(E\twoheadrightarrow \Sigma\)에서, 그 [접공간](https://ko.wikipedia.org/wiki/접공간 "wikilink")은 다음과 같다.
...
[리만-로흐 정리에](https://ko.wikipedia.org/wiki/리만-로흐_정리 "wikilink") 따라서,
...
\[\dim \operatorname H^0(\Sigma,\operatorname{End}E) = 1\] 이다. (이는 올별 [항등 함수의](https://ko.wikipedia.org/wiki/항등_함수 "wikilink") 스칼라배로 구성된다.) 물론
...
[데이비드 멈퍼드가](https://ko.wikipedia.org/wiki/데이비드_멈퍼드 "wikilink") 1963년에 도입하였다.

나라심한-세샤드리 정리는 무두바이 세샤차를루 나라심한(, )과 칸지바람 스리랑가차리 세샤드리(, )가 1965에 최초로 대수기하학을 사용하여 증명하였으며,\[5\] 이후 1983년에 [사이먼 도널드슨이](https://ko.wikipedia.org/wiki/사이먼_도널드슨 "wikilink") 미분기하학을 사용하여 다른 정의를 발표하였으며,\[6\] 1985년에 이 정리를 임의의 차원의 [사영](https://ko.wikipedia.org/wiki/사영_대수다양체 "wikilink") [켈러 다양체에](https://ko.wikipedia.org/wiki/켈러_다양체 "wikilink") 대하여 일반화하였다.\[7\]

## 예

모든 정칙 선다발(1차원 [정칙 벡터 다발](../Page/정칙_벡터_다발.md "wikilink"))은 (자명하게) 안정 벡터 다발이다.

양의 차원의 두 정칙 선다발 \(E\), \(F\)의 [직합](https://ko.wikipedia.org/wiki/직합 "wikilink") \(E\oplus F\)은 안정 벡터 다발이 될 수 없다.\[8\] 이 경우,
