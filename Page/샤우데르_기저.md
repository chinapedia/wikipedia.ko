...
\(N\in\{0,1,2,\dots,\infty\}\)라고 하자. [위상체](https://ko.wikipedia.org/wiki/위상체 "wikilink") \(K\) 위의 [위상 벡터 공간](../Page/위상_벡터_공간.md "wikilink") \(V\) 위의 **샤우데르 기저** \(\{e_i\}_{i=1}^N\subset V\)는 다음 조건을 만족시키는 원소들의 [열이다](../Page/수열.md "wikilink").
  ...
  - 임의의 원소 \(v\in V\)에 대하여, \(\textstyle v=\sum_{i=1}^N a_ie_i\)가 되는 [수열](../Page/수열.md "wikilink") \(\{a_i\}_{i=1}^\infty\subset K\)이 유일하게 존재한다.
...
\(N=\infty\)일 경우, 샤우데르 기저의 순서가 중요한데, 이는 위 [급수의](https://ko.wikipedia.org/wiki/급수_\(수학\) "wikilink") 수렴이 [절대 수렴이](https://ko.wikipedia.org/wiki/절대_수렴 "wikilink") 아닐 수 있기 때문이다. 반면, \(N<\infty\)일 경우 샤우데르 기저의 순서는 중요하지 않으며, 이 경우 [벡터 공간의](../Page/벡터_공간.md "wikilink") 일반적 [기저의](../Page/기저_\(위상수학\).md "wikilink") 개념와 일치한다.
...
\(N\in\{0,1,2,\dots,\infty\}\)라고 하자. [위상체](https://ko.wikipedia.org/wiki/위상체 "wikilink") \(K\) 위의 [위상 벡터 공간](../Page/위상_벡터_공간.md "wikilink") \(V\) 위의 샤우데르 기저 \(\{e_i\}_{i=1}^N\subset V\)가 다음 조건을 만족시킨다면, **무조건 샤우데르 기저**(無條件Schauder基底, )라고 한다.
  ...
  - 임의의 \(v\in V\) 및 \(\{1,2,\dots,N\}\)의 임의의 [순열](../Page/순열.md "wikilink") \(\sigma\in\operatorname{Sym}(\{1,2,\dots,N\})\)에 대하여, \(\textstyle v=\sum_{i=1}^Na_ie_i\)라고 하면, \(\sum_{i=1}^Na_{\sigma(i)}e_{\sigma(i)}\) 역시 [수렴](https://ko.wikipedia.org/wiki/수렴 "wikilink")한다.
