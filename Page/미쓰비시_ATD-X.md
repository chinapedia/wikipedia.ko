...
설계 안은 23dmu,24dmu 등의 외형들이 쏟아졌다. 둘 다 쌍발 엔진의 스텔스 형상이라는 공통점이 있지만 23dmu의 형상은 쌍발엔진이 붙어있는 F-15와 같은 형태며 24dmu는 F-14와 같이 쌍발엔진이 서로 떨어져 있으며 그 사이에 내부 무장창을 고려할 수 있는 형태다. 둘다 장단점이 있으며 용도에 따라 쓰임새가 조금씩 달랐다. 하지만 25dmu가 등장하며 23dmu,24dmu,25dmu 이 세개가 후보가 됐다.

## 성능

### 엔진

F-3 전투기의 실제 엔진은 일본 IHI사가 제조한 XF9-1 엔진이 사용될 것으로 보인다.

#### XF5 엔진과 XF9엔진

XF5 엔진은 추력 11,000파운드의 실증기용 엔진이지만, XF9-1 엔진은 추력 33,000 파운드의 엔진으로 공표된 크기는 F-15/F-16에 탑재되는 GE F110이나 P\&W의 F100과 거의 동급이고, 차세대 항공기 엔진 소재로 각광받아 신형 민항기 엔진인 GE9X와 CFM LEAP 등에 채택된 CMC(Ceramic Matrix Composite)\[9\]와 5세대 니켈 단결정 초합금을 사용해 TIT(터빈 입구 온도)를 동급 최고 수준인 1,800도까지 끌어올렸다. 공표 성능은 애프터버너 작동시 15톤 이상(35,000lbs), 밀리터리 추력은 11톤 이상(26,000lbs)으로 예전부터 확언해온 대로 F-22의 F119보다 작으면서 성능은 그에 근접하거나 능가하는 초고성능 엔진을 목표로 하고 있음이 밝혀졌다. 실제로 목표대로 그대로 나오고 이 엔진을 F-3 전투기에 탑재될 경우 초고성능의 엔진이 맞다. 당장 F-22 랩터의 엔진이 35,000 파운드이다.

XF9-1 엔진은 2017년까지 각 파트 성능 확인, 전체 설계도 만들기 등으로 이루어지는 기본 설계가 완료되었고, 2018년 6월 29일에 코어 엔진에 터빈과 팬, 추력을 전방향 20도 각도로 꺾을 수 있는 3차원 TVC가 통합된 프로토타입 엔진이 납품되었다. 이후 삿포로 시험장에서 2019년 말까지 운전 시험이 진행될 예정이며 로드맵에 따르면 실용 엔진 완성과 양산 시작 시기는 2025년으로 예정되어 있다.

### 레이다

AESA 레이다가 탑재될 것으로 보인다. 첨단 4.5세대 전투기인 F-2 전투기도 AESA를 탑재한 전례가 있는데, 미쓰비시 F-2 전투기는 J/APG-1이라는 최고 수준의 레이다를 장착하고 있다. 일본에서 새로 개발하고 있는 J/APG-2 레이다를 장착할 것으로 보인다.

### 부품 제조사

부품은 대부분 일본 제조사들이 제조한다. 엔진부터 레이다까지 모두 일본 방산업체들이 뛰어들었다.
