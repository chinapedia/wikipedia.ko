...
[섬네일| 부가적인 [프린터](https://ko.wikipedia.org/wiki/병렬_포트 "wikilink") 단자를 갖춘 오리지널 허큘레스 그래픽 카드 (1984년). 길이 단위는 [cm이다](https://ko.wikipedia.org/wiki/센티미터 "wikilink").](https://ko.wikipedia.org/wiki/파일:KL_Hercules_HGC.png "wikilink") **허큘레스 그래픽 카드**(Hercules Graphics Card, HGC)는 [허큘레스 컴퓨터 테크놀로지가](https://ko.wikipedia.org/wiki/허큘레스 "wikilink") 개발한 컴퓨터 [그래픽 컨트롤러이다](../Page/그래픽_카드.md "wikilink"). 전성기 동안 널리 지원되는 [디스플레이 표준이](../Page/컴퓨터_디스플레이_표준.md "wikilink") 되었다. [모노크롬 모니터](../Page/모노크롬_모니터.md "wikilink")(녹색, 황갈색, 흰색)에 연결된 [IBM PC](https://ko.wikipedia.org/wiki/IBM_PC "wikilink") 호환 시스템에 일반화되었다. 높은 해상도의 텍스트 모드와 단일 그래픽 모드를 지원하였다. 1984년에 499 달러의 가격으로 판매되었으나 제조사 제안 가격보다 더 낮게 판매되기도 했다.\[1\] [CGA](https://ko.wikipedia.org/wiki/CGA "wikilink")보다 해상도가 높아서 많은 인기를 끌었다.

## 역사

허큘레스는 1982년에 [허큘레스 컴퓨터 테크놀로지의](https://ko.wikipedia.org/wiki/허큘레스 "wikilink") 설립자 Van Suwannukul이 개발하였다. 이 시스템은 본래 Suwannukul이 그가 사용하던 타이어를 이용하여 [IBM PC에서](https://ko.wikipedia.org/wiki/IBM_PC "wikilink") 박사 논문을 작성하기 위해 만들었다.

## 단자

[DE9F](https://ko.wikipedia.org/wiki/D-sub "wikilink") 단자. 5V [TTL](../Page/트랜지스터-트랜지스터_논리.md "wikilink") 전기 신호 사용.\[2\]\[3\]

수평 주파수 18.425 ±0.500 kHz, 수직 주파수 50 Hz.\[4\]

## 프로그래밍

허큘레스 그래픽 카드는 [베이직](https://ko.wikipedia.org/wiki/베이직 "wikilink") 컴퓨터 언어의 해석판인 HBASIC이 포함된 [디스켓](https://ko.wikipedia.org/wiki/디스켓 "wikilink")과 함께 제공된다. 이를 이용하면 모노크롬 모니터의 그래픽을 프로그래밍할 수 있다. 같은 이름의 통합 개발 환경([HBasic](https://ko.wikipedia.org/wiki/HBasic "wikilink"))이 등장하기도 했다.
...
## 참고 문헌
  ...
  - [How to Print Hercules Graphics SCREEN 3 to an Epson Printer](http://support.microsoft.com/kb/51886), *[Microsoft.com](https://ko.wikipedia.org/wiki/마이크로소프트 "wikilink")*
