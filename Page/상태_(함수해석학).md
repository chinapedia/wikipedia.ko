...
[C\* 대수](../Page/C*_대수.md "wikilink") 이론에서, **상태**(狀態, )는 [C\* 대수](../Page/C*_대수.md "wikilink") 위에 정의된, 특정한 부등식을 만족시키는, [작용소 노름](https://ko.wikipedia.org/wiki/작용소_노름 "wikilink") 1의 복소수 값 [유계 작용소이다](https://ko.wikipedia.org/wiki/유계_작용소 "wikilink"). 이는 대략 C\* 대수를 [비가환 공간으로](../Page/비가환_기하학.md "wikilink") 여겼을 때 일종의 “[확률 측도](https://ko.wikipedia.org/wiki/확률_측도 "wikilink")”로 여길 수 있다. [양자역학](https://ko.wikipedia.org/wiki/양자역학 "wikilink")의 [밀도 행렬을](https://ko.wikipedia.org/wiki/밀도_행렬 "wikilink") 추상화한 개념이다.
...
[C\* 대수](../Page/C*_대수.md "wikilink") \(A\)의 상태들의 공간을 \(\operatorname{State}(A)\subseteq A^*\)라고 하자 (\(A^*\)는 \(A\)의 [연속 쌍대 공간](../Page/연속_쌍대_공간.md "wikilink")). 이는 [콤팩트](https://ko.wikipedia.org/wiki/콤팩트_공간 "wikilink") [볼록 집합이며](https://ko.wikipedia.org/wiki/볼록_집합 "wikilink"), [크레인-밀만 정리에](https://ko.wikipedia.org/wiki/크레인-밀만_정리 "wikilink") 의하여 이는 [극점들을](https://ko.wikipedia.org/wiki/극점_\(기하학\) "wikilink") 갖는다. [극점인](https://ko.wikipedia.org/wiki/극점_\(기하학\) "wikilink") 상태들을 **순수 상태**(純粹狀態, )\[3\], 아닌 상태들을 **혼합 상태**(混合狀態,)라고 한다. (이 용어들은 [양자역학](https://ko.wikipedia.org/wiki/양자역학 "wikilink")에서 유래하였다.)
...
[C\* 대수](../Page/C*_대수.md "wikilink") \(A\)의 **\*-표현**(\*-表現) \((\mathcal H,\rho)\)은 다음과 같은 데이터로 주어진다.
  ...
  - \(\rho\colon A\to\operatorname B(\mathcal H,\mathcal H)\)는 [복소수 대합 대수의](https://ko.wikipedia.org/wiki/복소수_대합_대수 "wikilink") 준동형이다. 즉, [환 준동형이며](https://ko.wikipedia.org/wiki/환_준동형 "wikilink"), [복소수 선형 변환이며](https://ko.wikipedia.org/wiki/복소수_선형_변환 "wikilink"), [대합과](https://ko.wikipedia.org/wiki/대합_\(수학\) "wikilink") 항등원을 보존한다. 즉, 다음이 성립한다.
      ...
      - \(\rho(1)=1\) ([항등 함수](https://ko.wikipedia.org/wiki/항등_함수 "wikilink"))

\(A\)의 \*-표현 \((\mathcal H,\rho)\)에 대하여, 만약 \(v\in\mathcal H\)가 다음 조건을 만족시킨다면 **순환 벡터**라고 한다.\[4\]

\[\{\rho(a)x\colon a\in A\}\]는 \(\mathcal H\)의 ([노름](https://ko.wikipedia.org/wiki/노름 "wikilink")으로 정의된 [거리 위상에](https://ko.wikipedia.org/wiki/거리_위상 "wikilink") 대한) [조밀 집합이다](https://ko.wikipedia.org/wiki/조밀_집합 "wikilink").
...
\[B_f\colon (a,b)\mapsto f(a^*b)\] 을 정의할 수 있다. 이는 [양의 준정부호이므로](https://ko.wikipedia.org/wiki/양의_준정부호 "wikilink"), [코시-슈바르츠 부등식](https://ko.wikipedia.org/wiki/코시-슈바르츠_부등식 "wikilink")

\[|B_f(a,b)|^2\le B_f(a,a)B_f(b,b)\qquad\forall a,b\in A\] 가 성립한다. 즉,

\[|f(a^*b)|^2\le f(a^*a)f(b^*b)\qquad\forall a,b\in A\] 이다.

[C\* 대수](../Page/C*_대수.md "wikilink") 위의 상태의 [작용소 노름은](https://ko.wikipedia.org/wiki/작용소_노름 "wikilink") 항상 1이다.\[5\] 특히, 항상 [연속 함수를](https://ko.wikipedia.org/wiki/연속_함수 "wikilink") 이룬다.
...
우선, 다음 보조 정리를 증명하자.
  ...
  -
    ...
    **①의 증명:** \(a\)로 생성되는 (1을 포함하는) 부분 [C\* 대수](../Page/C*_대수.md "wikilink") \(B\subseteq A\)를 생각하자. 이는 [가환](https://ko.wikipedia.org/wiki/가환환 "wikilink") [C\* 대수이며](../Page/C*_대수.md "wikilink"), [겔판트-나이마르크 정리에](https://ko.wikipedia.org/wiki/겔판트-나이마르크_정리 "wikilink") 의하여 어떤 [콤팩트](https://ko.wikipedia.org/wiki/콤팩트_공간 "wikilink") [하우스도르프 공간](https://ko.wikipedia.org/wiki/하우스도르프_공간 "wikilink") \(X\)에 대한 \(B\cong\mathcal C^0(X,\mathbb C)\)로 표현되며, 이 표현 아래 \(x\)는 [치역](https://ko.wikipedia.org/wiki/치역 "wikilink")이 \([-1,1]\)의 부분 집합인 [연속 함수](https://ko.wikipedia.org/wiki/연속_함수 "wikilink") \(f\colon X\to\mathbb C\)에 대응된다. 이 경우, \(\sqrt{1-f}\)에 대응되는 원소가 \(b\in B\subseteq A\)이다.
...
임의의 \(a\in A\)에 대하여, \(\|a\|\le1\)이라고 하자. 이제 \(|f(a)|\le1\)임을 보이면 족하다. 그런데 [코시-슈바르츠 부등식에](https://ko.wikipedia.org/wiki/코시-슈바르츠_부등식 "wikilink") 의하여
...
[폰 노이만 대수](../Page/폰_노이만_대수.md "wikilink") \(A\) 위의 상태 \(f\colon A\to\mathbb C\)에 대하여 다음 조건들이 서로 [동치](https://ko.wikipedia.org/wiki/동치 "wikilink")이며, 이 조건들을 만족시키는 상태를 **정규 상태**(正規狀態, )라고 한다.\[6\]

  - \(f\restriction\operatorname{cl}\operatorname{ball}_A(0,1)\)는 [약한 작용소 위상](https://ko.wikipedia.org/wiki/약한_작용소_위상 "wikilink") 아래 [연속 함수이다](https://ko.wikipedia.org/wiki/연속_함수 "wikilink").
  - \(f\restriction\operatorname{cl}\operatorname{ball}_A(0,1)\)는 [강한 작용소 위상](https://ko.wikipedia.org/wiki/강한_작용소_위상 "wikilink") 아래 [연속 함수이다](https://ko.wikipedia.org/wiki/연속_함수 "wikilink").
  - 임의의 \*-표현 \((\mathcal H,\rho)\)에 대하여, \(\rho(a)=\operatorname{tr}(T\rho(a))\)가 성립하는 [대각합류 작용소](https://ko.wikipedia.org/wiki/대각합류_작용소 "wikilink") \(T\colon\mathcal H\to\mathcal H\)가 존재한다. (이 경우, \(T\)를 \(f\)의 **[밀도 행렬](https://ko.wikipedia.org/wiki/밀도_행렬 "wikilink")**이라고 한다.)
...
**겔판트-나이마르크-시걸 구성**에 따르면, 다음이 성립한다.
  ...
  -
    ...
    ② 위 조건을 만족시키는, 순환 벡터가 부여된 두 \*-표현 \((\mathcal H,\rho,v)\), \((\mathcal H',\rho',v')\)에 대하여, 다음 두 조건을 만족시키는 [전단사](https://ko.wikipedia.org/wiki/전단사_함수 "wikilink") [유니터리 변환](https://ko.wikipedia.org/wiki/유니터리_변환 "wikilink") \(U\colon\mathcal H\to\mathcal H'\)이 존재한다.\[8\]
...
\[\mathcal H=\overline{A/\mathfrak I}\] 이다. (위의 줄은 [내적 공간의](https://ko.wikipedia.org/wiki/내적_공간 "wikilink") [완비화를](https://ko.wikipedia.org/wiki/완비_거리_공간 "wikilink") 뜻한다.) 그 위의 내적은 다음과 같다.
...
임의의 유한 차원 [복소수 힐베르트 공간](https://ko.wikipedia.org/wiki/복소수_힐베르트_공간 "wikilink") \(\mathcal H=\mathbb C^N\) 및 모든 \(N\times N\) 복소수 [행렬](https://ko.wikipedia.org/wiki/행렬 "wikilink")로 구성된 [폰 노이만 대수](../Page/폰_노이만_대수.md "wikilink") \(\mathcal A=\operatorname{Mat}(N,N;\mathbb C)\)를 생각하자. 이 경우, 대각합이 1인 [에르미트 행렬](https://ko.wikipedia.org/wiki/에르미트_행렬 "wikilink") \(\rho\)를 생각하자.
...
상태의 개념은 [양자역학](https://ko.wikipedia.org/wiki/양자역학 "wikilink")에서 유래하였다.

겔판트-나이마르크-시걸 구성은 [이즈라일 겔판트와](../Page/이즈라일_겔판트.md "wikilink") [마르크 아로노비치 나이마르크가](https://ko.wikipedia.org/wiki/마르크_아로노비치_나이마르크 "wikilink") 1943년에 [겔판트-나이마르크 정리를](https://ko.wikipedia.org/wiki/겔판트-나이마르크_정리 "wikilink") 증명하는 데 사용하였으나,\[12\] 명시적으로 정의하지 않았다. 이후 어빙 에즈라 시걸()이 겔판트와 나이마르크의 논문에서 이 개념을 추출하였다.\[13\]
