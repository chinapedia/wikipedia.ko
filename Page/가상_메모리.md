...
[섬네일과](https://ko.wikipedia.org/wiki/파일:Virtual_memory.svg "wikilink") [DASD](../Page/직접_접근_기억_장치.md "wikilink") 상의 비활성 메모리로 결합되어 있다.\]\] **가상 메모리**() 또는 **가상 기억 장치**는 [RAM을](../Page/랜덤_액세스_메모리.md "wikilink") 관리하는 방법의 하나로, 각 프로그램에 실제 메모리 주소가 아닌 가상의 메모리 주소를 주는 방식을 말한다.
