...
## 참여 인원
  ...
  - 폴 매카트니: 베이스 기타, 기타, 피아노, 키보드, 신시사이저, 드럼, 보컬
  - 린다 매카트니: 키보드, 백 보컬
  - 마이클 잭슨: 〈Say Say Say〉, 〈The Man〉의 보컬
  - 에릭 스튜어트: 기타, 백 보컬
  - 데니 레인: 기타, 키보드, 보컬
  - 휴 번: 기타
  - 제프 화이트혼: 기타
  ...
  - 어니 왓츠: 색소폰
  - 개리 그랜트: 호른
  - 링고 스타: 〈So Bad〉와 〈Average Person〉의 드럼
  - 스티브 갯: 드럼
  - 데이브 맷트랙스: 드럼
  - 제임스 키펜: 〈Pipes of Peace〉의 타블라
  - 페스탈로치의 어린이 합창단: 〈Pipes of Peace〉의 백 보컬

## 각주

[분류:1983년 음반](https://ko.wikipedia.org/wiki/분류:1983년_음반 "wikilink") [분류:폴 매카트니의 음반](https://ko.wikipedia.org/wiki/분류:폴_매카트니의_음반 "wikilink") [분류:팔로폰 음반](https://ko.wikipedia.org/wiki/분류:팔로폰_음반 "wikilink") [분류:조지 마틴이 프로듀싱한 음반](https://ko.wikipedia.org/wiki/분류:조지_마틴이_프로듀싱한_음반 "wikilink")
