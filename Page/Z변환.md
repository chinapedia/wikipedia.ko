...
**Z 변환**(Z-transform)은 [수학](https://ko.wikipedia.org/wiki/수학 "wikilink")이나 [신호 처리에서](https://ko.wikipedia.org/wiki/신호_처리 "wikilink") [실 수열](https://ko.wikipedia.org/wiki/수열 "wikilink") 또는 [복소 수열로](https://ko.wikipedia.org/wiki/복소_수열 "wikilink") 나타나는 시간 영역의 신호를 복소 [주파수 영역의](https://ko.wikipedia.org/wiki/주파수_영역 "wikilink") 표현으로 변환한다.

Z 변환은 연속 시간 신호에 대한 [라플라스 변환에](https://ko.wikipedia.org/wiki/라플라스_변환 "wikilink") 대응하는 이산 시간 영역에서의 변환으로 볼 수 있다.

## 역사

Z 변환에 대한 기본적인 생각은 [라플라스](https://ko.wikipedia.org/wiki/라플라스 "wikilink")도 알고 있었고, 1947년에 [W. Hurewicz에](https://ko.wikipedia.org/wiki/wikipedia:Witold_Hurewicz "wikilink") 의해 선형 상수 계수 [차분 방정식을](https://ko.wikipedia.org/wiki/점화식 "wikilink") 푸는 유용한 수단으로 다시 알려졌다.\[1\] Z 변환이라는 이름은 1952년에 [콜롬비아 대학의](https://ko.wikipedia.org/wiki/콜롬비아_대학 "wikilink") sampled-data control group에 속한 [Ragazzini와](https://ko.wikipedia.org/wiki/wikipedia:John_R._Ragazzini "wikilink") [Zadeh로](https://ko.wikipedia.org/wiki/wikipedia:Lotfi_A._Zadeh "wikilink") 부터 유래되었다.\[2\]\[3\]
...
다른 [적분 변환들과](https://ko.wikipedia.org/wiki/적분_변환 "wikilink") 마찬가지로 Z 변환은 단방향 또는 양방향 변환으로 정의될 수 있다.
...
여기서 \(n\)은 정수이고 \(z\)는 일반적으로 [복소수](https://ko.wikipedia.org/wiki/복소수 "wikilink")이다. 즉, \(z\)는 [복소수의 크기](https://ko.wikipedia.org/wiki/절댓값 "wikilink") \(A\)와 [허수 단위](https://ko.wikipedia.org/wiki/허수_단위 "wikilink") \(j\), 그리고 [편각](https://ko.wikipedia.org/wiki/wikipedia:Complex_argument "wikilink") \(\phi\)를 통해 다음과 같이 표현할 수 있다.
...
#### 예제
  ...
  - [단위 계단 신호](https://ko.wikipedia.org/wiki/단위_계단_함수 "wikilink")
...
\[X(z) = 1 + z^{-1} + z^{-2} + \cdots = \frac{z}{z - 1},\quad 1<|z|.\]
  ...
  - [등비수열](https://ko.wikipedia.org/wiki/등비수열 "wikilink")
...
하지만 [라플라스 역변환의](https://ko.wikipedia.org/wiki/라플라스_변환 "wikilink") 경우와 유사하게 대부분의 경우 Z 역변환은 [부분분수](https://ko.wikipedia.org/wiki/부분분수 "wikilink") 분해를 통해 구해진다. 예를 들어 다음과 같은 Z 변환을 생각하자.

\[X(z) = \frac{3z^{2} - 7z}{z^{2} - 5z + 6}.\]

[부분분수](https://ko.wikipedia.org/wiki/부분분수 "wikilink") 분해를 통해 \(X(z)/z\)는 다음과 같이 표현된다.
...
다음과 같이 주어진 상수 계수를 갖는 선형 [차분방정식을](https://ko.wikipedia.org/wiki/점화식 "wikilink") 생각하자.
