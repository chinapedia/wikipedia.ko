...
\----------- HEADER ---------- '{| class="wikitable ' .. _if('open', '', 'collapsible' .. _if('collapsed', ' collapsed')) .. '" style="width:' .. _ifset('width', '100%') .. '; text-align:center; line-height: 1.2em; margin:' .. _ifset('margin', 'auto') .. ';"' .. _if('open',

`       '\n|+' .. _if('location', args.location, '``') .. '의 기후',`

'\\n|-' .. '\\n\!colspan="14" | ' .. _if('name',

`   navbar({_if('location', args.location, '``') .. '의 기후', args.name, collapsible=1}),`
`   _if('location', args.location, '``') .. '의 기후'`

) ) .. \[=\[

|- \!scope="row" |월 \!scope="col" |1월 \!scope="col" |2월 \!scope="col" |3월 \!scope="col" |4월 \!scope="col" |5월 \!scope="col" |6월 \!scope="col" |7월 \!scope="col" |8월 \!scope="col" |9월 \!scope="col" |10월 \!scope="col" |11월 \!scope="col" |12월 \!scope="col" style="border-left-width:medium" |년 \]=\],
...
`   scale_factor = '1',`
`   label = '최고 `[`불쾌지수`](../Page/불쾌지수.md "wikilink")` 기록',`
`   annual_mode = 'max',`
...
`   color_scheme = _ifset('temperature colour', 't'),`
`   scale_factor = '1',`
`   label = '최고 기온 기록 °' .. _if('metric first', 'C', 'F') .. _if('single line', ' (°' .. _if('metric first', 'F', 'C') .. ')'),`
`   annual_mode = 'max',`
...
`   color_scheme = _ifset('temperature colour', 't'),`
`   scale_factor = '1',`
`   label = '평균 최대 기온 °' .. _if('metric first', 'C', 'F') .. _if('single line', ' (°' .. _if('metric first', 'F', 'C') .. ')'),`
`   annual_mode = 'max',`
...
`   color_scheme = _ifset('temperature colour', 't'),`
`   scale_factor = '1',`
`   label = '평균 최고 기온 °' .. _if('metric first', 'C', 'F') .. _if('single line', ' (°' .. _if('metric first', 'F', 'C') .. ')'),`
`   annual_mode = 'avg',`
...
`   color_scheme = _ifset('temperature colour', 't'),`
`   scale_factor = '1',`
`   label = '일 평균 기온 °' .. _if('metric first', 'C', 'F') .. _if('single line', ' (°' .. _if('metric first', 'F', 'C') .. ')'),`
`   annual_mode = 'avg',`
...
`   color_scheme = _ifset('temperature colour', 't'),`
`   scale_factor = '1',`
`   label = '평균 최저 기온 °' .. _if('metric first', 'C', 'F') .. _if('single line', ' (°' .. _if('metric first', 'F', 'C') .. ')'),`
`   annual_mode = 'avg',`
...
`   color_scheme = _ifset('temperature colour', 't'),`
`   scale_factor = '1',`
`   label = '평균 최소 기온 °' .. _if('metric first', 'C', 'F') .. _if('single line', ' (°' .. _if('metric first', 'F', 'C') .. ')'),`
`   annual_mode = 'min',`
...
`   color_scheme = _ifset('temperature colour', 't'),`
`   scale_factor = '1',`
`   label = '최저 기온 기록 °' .. _if('metric first', 'C', 'F') .. _if('single line', ' (°' .. _if('metric first', 'F', 'C') .. ')'),`
`   annual_mode = 'min',`
...
`   color_scheme = _ifset('temperature colour', 't'),`
`   scale_factor = '1',`
`   label = '최저 `[`체감온도`](https://ko.wikipedia.org/wiki/체감온도 "wikilink")` 기록',`
`   annual_mode = 'min',`
...
`   label = makeLabel(args, true, '평균 `[`강수량`](../Page/강수량.md "wikilink")`', 'precipitation'),`
`   annual_mode = 'sum',`
...
`   label = makeLabel(args, true, '평균 강우량', 'rain'),`
`   annual_mode = 'sum',`
...
`   date_mode = true,`
`   scale_factor = '1',`
`   label = makeLabel(args, true, '평균 강설량', 'snow'),`
`   annual_mode = 'sum',`
...
`   color_scheme = _ifset('temperature colour', 't'),`
`   scale_factor = '1',`
`   label = '`[`불쾌지수`](../Page/불쾌지수.md "wikilink")`',`
`   annual_mode = 'max',`
`   second_line = true,`
...
`   color_scheme = _ifset('temperature colour', 't'),`
`   scale_factor = '1',`
`   label = '최고 기온 기록 °' .. _if('metric first', 'F', 'C'),`
`   annual_mode = 'max',`
...
`   color_scheme = _ifset('temperature colour', 't'),`
`   scale_factor = '1',`
`   label = '평균 최고 기온 °' .. _if('metric first', 'F', 'C'),`
`   annual_mode = 'avg',`
...
`   color_scheme = _ifset('temperature colour', 't'),`
`   scale_factor = '1',`
`   label = '일 평균 기온 °' .. _if('metric first', 'F', 'C'),`
...
`   color_scheme = _ifset('temperature colour', 't'),`
`   scale_factor = '1',`
`   label = '평균 최저 기온 °' .. _if('metric first', 'F', 'C'),`
`   show = _if('metric first', '2', '1'),`
`   annual_mode = 'avg',`
...
`   color_scheme = _ifset('temperature colour', 't'),`
`   scale_factor = '1',`
`   label = '최저 기온 기록 °' .. _if('metric first', 'F', 'C'),`
`   show = _if('metric first', '2', '1'),`
`   annual_mode = 'min',`
...
`   color_scheme = _ifset('temperature colour', 't'),`
`   scale_factor = '1',`
`   label = '`[`체감온도`](https://ko.wikipedia.org/wiki/체감온도 "wikilink")`',`
`   annual_mode = 'min',`
...
`   scale_factor = '1',`
`   prefer_cm = precision(_ifset('Jan precipitation inch', '0')) < 1,`
`   label = makeLabel(args, false, '평균 `[`강수량`](../Page/강수량.md "wikilink")`', 'precipitation'),`
`   annual_mode = 'sum',`
...
`   scale_factor = '1',`
`   prefer_cm = precision(_ifset('Jan rain inch', '0')) < 1,`
`   label = makeLabel(args, false, '평균 강우량', 'rain'),`
`   annual_mode = 'sum',`
...
`   date_mode = true,`
`   scale_factor = '1',`
`   label = makeLabel(args, false, '평균 강설량', 'snow'),`
`   annual_mode = 'sum',`
...
`   date_mode = true,`
`   scale_factor = '1',`
`   label = '평균 강수일수' .. _if('unit precipitation days', ' `<span style="font-size:90%;" class="nowrap">`(≥ ' .. _ifset('unit precipitation days', '') .. ')`</span>`'),`
`   annual_mode = 'sum',`
...
`   date_mode = true,`
`   scale_factor = '1',`
`   label = '평균 강우일수' .. _if('unit rain days', ' `<span style="font-size:90%;" class="nowrap">`(≥ ' .. _ifset('unit rain days', '') .. ')`</span>`'),`
`   annual_mode = 'sum',`
...
`   date_mode = true,`
`   scale_factor = '1',`
`   label = '평균 강설일수' .. _if('unit snow days', ' `<span style="font-size:90%;" class="nowrap">`(≥ ' .. _ifset('unit snow days', '') .. ')`</span>`'),`
`   annual_mode = 'sum',`
...
`   scale_factor = '1',`
`   label = '평균 `[`상대``   ``습도`](https://ko.wikipedia.org/wiki/상대_습도 "wikilink")` (%)' ..`
`       _if('time day', ' `<span style="font-size:90%;" class="nowrap">`(' .. _ifset('time day', '') .. ')`</span>`') ..`
`       _if('daily', ' `<span style="font-size:90%;" class="nowrap">`(일 평균)`</span>`'),`
`   annual_mode = 'avg',`
...
`   color_scheme = _ifset('humidity colour', 'h'),`
`   scale_factor = '1',`
`   label = '평균 오후 `[`상대``   ``습도`](https://ko.wikipedia.org/wiki/상대_습도 "wikilink")` (%)' ..`
`       _if('time day', ' `<span style="font-size:90%;" class="nowrap">`(' .. _ifset('time day', '') .. ')`</span>`') ..`
`       _if('daily', ' `<span style="font-size:90%;" class="nowrap">`(일 평균)`</span>`'),`
`   annual_mode = 'avg',`
...
`   color_scheme = _ifset('temperature colour', 't'),`
`   scale_factor = '1',`
`   label = '평균 `[`이슬점`](https://ko.wikipedia.org/wiki/이슬점 "wikilink")` °' .. _if('metric first', 'C', 'F') .. _if('single line', ' (°' .. _if('metric first', 'F', 'C') .. ')'),`
`   annual_mode = 'avg',`
...
`   color_scheme = _ifset('temperature colour', 't'),`
`   scale_factor = '1',`
`   label = '평균 `[`이슬점`](https://ko.wikipedia.org/wiki/이슬점 "wikilink")` °' .. _if('metric first', 'F', 'C'),`
`   show = _if('metric first', '2', '1'),`
`   annual_mode = 'avg',`
...
`   date_mode = true,`
`   scale_factor = '1',`
`   label = '평균 월간 `[`일조시간`](https://ko.wikipedia.org/wiki/일조시간 "wikilink")`',`
`   annual_mode = 'sum',`
...
`   include_space = false,`
`   scale_factor = '30.44',`
`   label = '평균 일일 `[`일조시간`](https://ko.wikipedia.org/wiki/일조시간 "wikilink")`',`
`   annual_mode = 'avg',`
...
`   include_space = false,`
`   scale_factor = '30.44',`
`   label = '평균 일일 `[`낮``   ``시간`](https://ko.wikipedia.org/wiki/낮 "wikilink")`',`
`   annual_mode = 'avg',`
...
`   color_scheme = _ifset('sun colour', 's'),`
`   scale_factor = '7.2',`
`   label = '`[`가능``   ``일조율`](https://ko.wikipedia.org/wiki/일조시간 "wikilink")`',`
`   annual_mode = 'avg',`
...
`   scale_factor = '1',`
`   label = '평균 `[`자외선지수`](https://ko.wikipedia.org/wiki/자외선지수 "wikilink")`',`
`   annual_mode = 'avg',`

}, ----------- SOURCES ---------- makeSources(frame, args), } end
...
' -- prevent Scribunto from inserting a blank line before the table end
