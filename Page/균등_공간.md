...
균등 공간 \((X,\mathcal E)\) 위에 다음과 같은 [기저를](../Page/기저_\(위상수학\).md "wikilink") 주어 표준적인 [위상을](https://ko.wikipedia.org/wiki/위상_공간_\(수학\) "wikilink") 정의할 수 있으며, 이를 **균등 위상**()이라고 한다.
...
[거리 공간의](../Page/거리_공간.md "wikilink") 개념을 추상화하기 위하여 [앙드레 베유가](../Page/앙드레_베유.md "wikilink") 1937년에 도입하였다.\[11\]\[12\]\[13\] 이후 [니콜라 부르바키가](../Page/니콜라_부르바키.md "wikilink") 측근을 사용한 정의를 도입하였다.\[14\]
