...
\(\textrm{erfi}(z)\\)가 복소[오차 함수라고](https://ko.wikipedia.org/wiki/오차_함수 "wikilink") 할 때, [특성 함수는](https://ko.wikipedia.org/wiki/특성_함수_\(확률\) "wikilink") 다음과 같다.

\[\varphi(t)=\]

\[1\!-\!\sigma te^{-\sigma^2t^2/2}\sqrt{\frac{\pi}{2}}\!\left(\textrm{erfi}\!\left(\frac{\sigma t}{\sqrt{2}}\right)\!-\!i\right)\]

\(\textrm{erf}(z)\\)가 [오차 함수일](https://ko.wikipedia.org/wiki/오차_함수 "wikilink") 때, [모멘트생성 함수는](https://ko.wikipedia.org/wiki/모멘트생성_함수 "wikilink") 다음과 같다.
