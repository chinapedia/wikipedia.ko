...
**애플 파일링 프로토콜**(Apple Filing Protocol, AFP)은 계층 6 ([프레젠테이션 계층](https://ko.wikipedia.org/wiki/프레젠테이션_계층 "wikilink")) [통신 프로토콜이며](https://ko.wikipedia.org/wiki/통신_프로토콜 "wikilink"), [OS X과](https://ko.wikipedia.org/wiki/OS_X "wikilink") 클래식 [맥 OS를](https://ko.wikipedia.org/wiki/맥_OS "wikilink") 위한 파일 서비스를 제공한다. 일부에서는 [애플토크](https://ko.wikipedia.org/wiki/애플토크 "wikilink") 네트워크에서 분산형 파일 공유를 지원하는 프로토콜 클라이언트 - 서버 모델에서 응용 프로그램을 대신하여 정보 준비, 교환을 담당하는 시스템의 일부로 정의하고 있다. 맥 오에스 텐에서 AFP는 [서버 메시지 블록](https://ko.wikipedia.org/wiki/서버_메시지_블록 "wikilink") (SMB), [네트워크 파일 시스템](https://ko.wikipedia.org/wiki/네트워크_파일_시스템 "wikilink") (NFS), [파일 전송 프로토콜](https://ko.wikipedia.org/wiki/파일_전송_프로토콜 "wikilink") (FTP), [웹DAV](https://ko.wikipedia.org/wiki/웹DAV "wikilink")를 포함하여 지원하는 여러 파일 서비스 가운데 하나이다. AFP는 현재 [유니코드](https://ko.wikipedia.org/wiki/유니코드 "wikilink") 파일 이름, [POSIX](https://ko.wikipedia.org/wiki/POSIX "wikilink"), [접근 제어 목록](../Page/접근_제어_목록.md "wikilink") 허가, 유닉스 할당, [리소스 포크](https://ko.wikipedia.org/wiki/리소스_포크 "wikilink"), 고급 파일 잠금을 지원한다. [맥 오에스 9](https://ko.wikipedia.org/wiki/맥_오에스_9 "wikilink") 이전에 AFP는 파일 서비스의 주된 프로토콜이었다.
