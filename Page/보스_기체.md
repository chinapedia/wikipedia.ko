...
[통계역학](https://ko.wikipedia.org/wiki/통계역학 "wikilink")에서, **보스 기체**(Bose氣體, )는 서로 상호작용하지 않는, 같은 종류의 [보손](https://ko.wikipedia.org/wiki/보손 "wikilink")으로 이루어진 기체다. 고전적 [이상 기체에](https://ko.wikipedia.org/wiki/이상_기체 "wikilink") 대응하는 두 가지 [양자역학](https://ko.wikipedia.org/wiki/양자역학 "wikilink")적 이상 기체 가운데 하나다. 보스 기체는 [보스-아인슈타인 통계를](https://ko.wikipedia.org/wiki/보스-아인슈타인_통계 "wikilink") 따르며, 매우 낮은 온도에서는 [상전이](../Page/상전이.md "wikilink")를 거쳐 [보스-아인슈타인 응축](https://ko.wikipedia.org/wiki/보스-아인슈타인_응축 "wikilink") 상태가 된다.

## 정의

콤팩트 [리만 다양체](https://ko.wikipedia.org/wiki/리만_다양체 "wikilink") \((M,g)\)가 주어졌다고 하자. 그렇다면, [로런츠 다양체](https://ko.wikipedia.org/wiki/로런츠_다양체 "wikilink") \(M\times\mathbb R\) 위의, 질량 \(m\)의 자유 보손 장 \(\phi\)를 생각하자. 이는 다음과 같은 작용에 의하여 나타내어진다.
...
\[H[\phi,\pi] = \int_M \sqrt{\det g} \frac12(g_{ij}\pi^i \pi^j + g^{ij}\partial_i\phi\partial_j\phi + m^2 \phi^2)\] 여기서 \(\pi^i\)는 \(\phi^i\)에 대한 운동량장이다. 이를 양자화하면, 그 [힐베르트 공간은](https://ko.wikipedia.org/wiki/힐베르트_공간 "wikilink") [포크 공간을](https://ko.wikipedia.org/wiki/포크_공간 "wikilink") 구성하게 된다. 구체적으로, 1입자 힐베르트 공간과 그 위의 1입자 해밀토니언 \((\mathcal H_1,H_1)\)을 다음과 같이 정의할 수 있다.

\[\mathcal H_1 = \operatorname L^2(M;\mathbb C)\]

\[\langle f|H_1|g\rangle = \int_M \sqrt{m^2 + g^{ij}(\partial_jf)(\partial_i g)}\,\sqrt{\det g}\] 그렇다면, 다입자 힐베르트 공간과 해밀토니언 \((\mathcal H,H)\)은 그 위의 [포크 공간으로](https://ko.wikipedia.org/wiki/포크_공간 "wikilink") 주어진다.
...
\[N|f\rangle = n |f\rangle \qquad\forall |f\rangle \in \operatorname{Sym}^n\mathcal H_1\] 를 정의할 수 있다. 이는 [등급 벡터 공간의](https://ko.wikipedia.org/wiki/등급_벡터_공간 "wikilink") 등급에 해당하며, 그 [고윳값](https://ko.wikipedia.org/wiki/고윳값 "wikilink")들은 [자연수](https://ko.wikipedia.org/wiki/자연수 "wikilink")이다.

이제, 이 계의 [큰 분배 함수](../Page/분배_함수_\(통계역학\).md "wikilink")

\[Z(\beta,z) = \operatorname{tr}\left(z^N\exp(-\beta H)\right) = \operatorname{tr}(-\beta H + \beta\mu N)\] 를 정의할 수 있다. 이는 [큰 바른틀 앙상블에](https://ko.wikipedia.org/wiki/큰_바른틀_앙상블 "wikilink") 해당한다. 여기서
...
큰 분배 함수의 [로그](https://ko.wikipedia.org/wiki/로그 "wikilink") × −1인 [큰 퍼텐셜](../Page/큰_퍼텐셜.md "wikilink") \(-\ln Z(\beta,z)\)는 다음과 같다.
...
\[\nabla^2 = g^{ij}\partial_i\partial_j\] 의 [스펙트럼은](https://ko.wikipedia.org/wiki/스펙트럼_\(함수해석학\) "wikilink") 다음 조건을 만족시킨다.
...
= \frac{\pi^{(\dim M)/2}}{\Gamma((\dim M)/2 + 1)}\] 는 \(D\)차원 단위 [공의](https://ko.wikipedia.org/wiki/공_\(수학\) "wikilink") 부피이다. 편의상 비례 상수를
...
\[m\beta \ll 1\] 의 경우 이는 [다중로그](../Page/다중로그.md "wikilink")라는 [특수 함수로](https://ko.wikipedia.org/wiki/특수_함수 "wikilink") 계산될 수 있다. 비상대론적 극한에서
...
\[\operatorname{Li}_s(z) = \sum_{n=1}^\infty \frac{z^n}{n^s}\] 는 [다중로그](../Page/다중로그.md "wikilink") 함수이며, \(\Gamma(-)\)는 [감마 함수이다](https://ko.wikipedia.org/wiki/감마_함수 "wikilink").
...
\[y/n = x\] 와 같은 치환을 사용하였으며, [테일러 급수](https://ko.wikipedia.org/wiki/테일러_급수 "wikilink")
...
\[N = -z\frac{\partial\Omega}{\partial z} \approx\frac{\textrm{Li}_\alpha(z)}{(\beta E_c)^\alpha}\] 이 식에서 [다중로그](../Page/다중로그.md "wikilink") 부분은 양의 실수이어야 하고, \(z=1\)이면 [리만 제타 함수](https://ko.wikipedia.org/wiki/리만_제타_함수 "wikilink") ζ(α)와 같아지게 되는, 최댓값을 얻을 수도 있다. 고정된 *N *에 대하여 가장 큰 값은 β가 임계값 β<sub>c </sub>을 가질 수 있을 때 다음 식과 같이 얻게 된다.
...
1-\frac{\zeta(\alpha)}{2^{\alpha+1}\tau^\alpha}\) |- | align="center" |[기브스 자유 에너지](https://ko.wikipedia.org/wiki/기브스_자유_에너지 "wikilink")
...
\[C_v=\frac{\partial U}{\partial T}=k(\alpha+1)\,U\beta\] [엔트로피](https://ko.wikipedia.org/wiki/엔트로피 "wikilink")는 다음의 식으로 표현된다.
...
[보스-아인슈타인 통계를](https://ko.wikipedia.org/wiki/보스-아인슈타인_통계 "wikilink") 제창한 [사티엔드라 나트 보스의](../Page/사티엔드라_나트_보스.md "wikilink") 이름을 땄다.
