...
**반응 속도 상수**(反應速度常數, ) 혹은 **반응 속도 계수**(反應速度係數, ) *k*는 [화학 속도론에서](https://ko.wikipedia.org/wiki/화학_속도론 "wikilink") [화학 반응의](https://ko.wikipedia.org/wiki/화학_반응 "wikilink") 속도를 정량화한다.\[1\] **속도 상수**(速度常數, )라고도 한다.
...
[반응 속도는](https://ko.wikipedia.org/wiki/반응_속도 "wikilink") 종종 다음의 형태를 한다:

\[r = k(T)[\mathrm{A}]^m [\mathrm{B}]^{n}\]

여기서 *k*(*T*)는 온도에 의존하는 반응 상수이다. \[A\]와 \[B\]는 물질 A와 B의 [몰 농도이다](https://ko.wikipedia.org/wiki/몰_농도 "wikilink").

지수 *m*과 *n*은 부분 [반응 차수라고](https://ko.wikipedia.org/wiki/반응_차수 "wikilink") 불리며 일반적으로 [화학양론계수](https://ko.wikipedia.org/wiki/화학양론계수 "wikilink") *a*와 *b*와는 *같지 않다*. [반응 메커니즘에](https://ko.wikipedia.org/wiki/반응_메커니즘 "wikilink") 의존하지 않으며, 실험적으로 결정된다.

## 온도 의존성

[아레니우스 방정식은](https://ko.wikipedia.org/wiki/아레니우스_방정식 "wikilink") [활성화 에너지와](https://ko.wikipedia.org/wiki/활성화_에너지 "wikilink") [반응 속도의](https://ko.wikipedia.org/wiki/반응_속도 "wikilink") 관계의 정량적 기반을 준다. 반응 속도는 다음과 같이 주어진다:
...
이때 *E<sub>a</sub>*는 [활성화 에너지이고](https://ko.wikipedia.org/wiki/활성화_에너지 "wikilink"), *R*은 기체 상수이다. Since at [온도](https://ko.wikipedia.org/wiki/온도 "wikilink") *T*에서 분자는 [볼츠만 분포에](https://ko.wikipedia.org/wiki/볼츠만_분포 "wikilink") 따라 에너지를 가지기 때문에, *E<sub>a</sub>*보다 큰 에너지로 충돌하는 비율은 *e*<sup></sup>만큼 다양할 것이라고 예측할 수 있다. *A*는 [지수 앞 인자](https://ko.wikipedia.org/wiki/지수_앞_인자 "wikilink") 또는 빈도 인자이다 (반응물 A와 헷갈려선 안 된다).
...
## 같이 보기
  ...
  - [반응 속도](https://ko.wikipedia.org/wiki/반응_속도 "wikilink")
  - [평형 상수](https://ko.wikipedia.org/wiki/평형_상수 "wikilink")
