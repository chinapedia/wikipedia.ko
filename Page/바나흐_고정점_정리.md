...
[수학](https://ko.wikipedia.org/wiki/수학 "wikilink")에서 **바나흐 고정점 정리**(-不動點定理, ) 또는 **축약사상정리**(縮約寫像定理, )는 [거리공간](https://ko.wikipedia.org/wiki/거리공간 "wikilink")에 관한 정리이다. [완비거리공간](https://ko.wikipedia.org/wiki/완비거리공간 "wikilink") 위의 [축소사상](https://ko.wikipedia.org/wiki/축소사상 "wikilink")의 [고정점](../Page/고정점.md "wikilink")의 존재성과 유일성, 그리고 그 고정점을 구하는 [구성적](https://ko.wikipedia.org/wiki/구성주의_\(수학\) "wikilink") 방법을 내용으로 한다. [폴란드](https://ko.wikipedia.org/wiki/폴란드 "wikilink")의 [스테판 바나흐가](https://ko.wikipedia.org/wiki/스테판_바나흐 "wikilink") 1922년에 처음으로 기술하였다.\[1\]
...
**주2.** 전제조건이 \(x\ne y\)인 \(d(T(x),T(y))<d(x,y)\)라는 것으로 약화된 경우, 고정점의 존재를 단정지을 수 없다. \(T:[1, +\infty) \to [1,+\infty),\) \(T(x) = x + \frac1x\)와 같은 반례가 있다. 그러나 추가적으로 \(X\)가 [콤팩트한](https://ko.wikipedia.org/wiki/콤팩트_공간 "wikilink") 경우, 약화된 조건은 고정점의 존재를 함의한다.
...
**증명.** [귀납법으로](https://ko.wikipedia.org/wiki/수학적_귀납법 "wikilink") 증명된다. 먼저 \(n=0\)에 대해,
...
## 응용
  ...
  - [피카르-린델뢰프 정리는](../Page/피카르-린델뢰프_정리.md "wikilink") 일정 조건 하에 [상미분방정식](https://ko.wikipedia.org/wiki/상미분방정식 "wikilink")의 해의 존재성과 유일성에 관한 정리로, 바나흐 고정점 정리를 사용하여 증명한다.
