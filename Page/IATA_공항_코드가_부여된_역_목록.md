...
## 코드 목록
  ...
  - 특히 첫 문자가 Q와 X인 코드는 이러한 철도역에 집중적으로 사용된다.
...
### Q
  ...
  - QFB 프라이부르크 중앙역, 독일
  - QKL 쾰른 중앙역, 독일
  - QLJ 루체른 역, [스위스](https://ko.wikipedia.org/wiki/스위스 "wikilink")
  - QLS 로잔 역, 스위스
  - QJZ 낭트 역, [프랑스](../Page/프랑스.md "wikilink")
  - QXB 엑상프로방스 TGV 역, 프랑스
  - QXG 앙제 생로 역, 프랑스

### X

  - XDB 릴 유럽 역, 프랑스
  - XDT 샤를 드 골 공항 2 TGV역, 프랑스
  - XHK 발랑스 TGV 역, 프랑스
  - XJY 마씨 TGV 역, 프랑스
  - XKL 쿠알라룸푸르 센트럴 역, 말레이시아
  - XOP 프와티에 역, 프랑스
  - XPJ 생 로크 역(몽펠리에), 프랑스
  - XRF 생 샤를 역(마르세유), 프랑스
  - XSH 생 피에르 데 코르 역(투르), 프랑스
  - XYD 라 파르 디외 역(리용), 프랑스
  - XYL 페라슈 역(리용), 프랑스
  - XZN 아비뇽 TGV 역, 프랑스
...
### Z
  ...
  - ZAQ 뉘른베르크 중앙역, 독일
  - ZDH 뮐루즈 역, 프랑스 및 바젤 SNCF 역, 스위스(2개역 공동 사용)
  - ZDJ 베른 역, 스위스
  - ZFJ 렌 역, 프랑스
  - ZFQ 생 장 역(보르도), 프랑스
...
[분류:철도역](https://ko.wikipedia.org/wiki/분류:철도역 "wikilink") [분류:IATA 공항 코드 목록](https://ko.wikipedia.org/wiki/분류:IATA_공항_코드_목록 "wikilink") [분류:철도 교통에 관한 목록](https://ko.wikipedia.org/wiki/분류:철도_교통에_관한_목록 "wikilink")