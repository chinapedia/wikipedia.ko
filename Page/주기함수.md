...
[수학](../Page/수학.md "wikilink")에서, **주기 함수**(週期函數, )는 함숫값이 일정 주기마다 되풀이되는 [함수](https://ko.wikipedia.org/wiki/함수 "wikilink")이다. 일상적인 예로, 시계 시간은 시간에 대한 함수로서 주기 함수이다. 즉, 시계의 행동은 날마다 똑같다.
...
따라서 \(\operatorname{prd}f\)는 덧셈에 대한 [아벨 군을](https://ko.wikipedia.org/wiki/아벨_군 "wikilink") 이룬다.
