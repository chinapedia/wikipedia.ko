...
[파스칼](https://ko.wikipedia.org/wiki/파스칼_\(마이크로아키텍처\) "wikilink") 기반의 **지포스 GTX 10 시리즈**(GeForce GTX 10 Series)는 [엔비디아](https://ko.wikipedia.org/wiki/엔비디아 "wikilink")가 개발한 [그래픽 처리 장치](https://ko.wikipedia.org/wiki/그래픽_처리_장치 "wikilink") 시리즈로서, [지포스 900 시리즈의](https://ko.wikipedia.org/wiki/지포스_900_시리즈 "wikilink") 뒤를 잇는다.

## 아키텍처

[블레즈 파스칼에서](https://ko.wikipedia.org/wiki/블레즈_파스칼 "wikilink") 이름을 따온 파스칼 [마이크로아키텍처](https://ko.wikipedia.org/wiki/마이크로아키텍처 "wikilink")는 2016년 5월 6일에 출현하였다.\[1\] [TSMC](https://ko.wikipedia.org/wiki/TSMC "wikilink")의 [16 nm](https://ko.wikipedia.org/wiki/16_nm "wikilink") [FinFET](https://ko.wikipedia.org/wiki/FinFET "wikilink") 기술을 통합하며 [맥스웰 마이크로아키텍처의](https://ko.wikipedia.org/wiki/맥스웰_\(마이크로아키텍처\) "wikilink") 뒤를 잇는다.\[2\] [삼성전자](https://ko.wikipedia.org/wiki/삼성전자 "wikilink")와 엔비디아는 또한 삼성의 14 나노미터 [FinFET](https://ko.wikipedia.org/wiki/FinFET "wikilink") 기술을 사용하기 위해 설계 상 다이를 축소시키기로 동의하였다.\[3\]

GP10x의 새로운 기능은 다음과 같다:

  - [CUDA](https://ko.wikipedia.org/wiki/CUDA "wikilink") Compute Capability 6.0 (GP100 전용), 6.1 (GP102, GP104, GP106, GP107, GP108)
  - [디스플레이포트](https://ko.wikipedia.org/wiki/디스플레이포트 "wikilink") 1.4
  - [고선명 멀티미디어 인터페이스](https://ko.wikipedia.org/wiki/고선명_멀티미디어_인터페이스 "wikilink") 2.0b
  - 4세대 델타 컬러 압축
  - [퓨어비디오](https://ko.wikipedia.org/wiki/엔비디아_퓨어비디오 "wikilink") Feature Set H 하드웨어 비디오 디코딩 HEVC Main10 (10비트), Main12 (12비트) & VP9 하드웨어 디코딩 (GM200 & GM204은 HEVC Main10/Main12 & VP9 하드웨어 디코딩을 지원하지 않았음)\[4\]
  - 4K DRM 보호 콘텐츠 재생 및 스트리밍을 위한 [HDCP](https://ko.wikipedia.org/wiki/고대역_디지털_콘텐츠_보호 "wikilink") 2.2 지원 (맥스웰 GM200 & GM204은 HDCP 2.2 지원 부족, GM206은 HDCP 2.2 지원)\[5\]
...
엔비디아는 파스칼 GP100 GPU가 4개의 [고대역 메모리](https://ko.wikipedia.org/wiki/고대역_메모리 "wikilink") 스택을 갖춤으로써 최신형 모델에서 16 GB의 HBM2,\[21\] 16 nm 기술,\[22\] [통합 메모리](https://ko.wikipedia.org/wiki/그래픽_처리_장치 "wikilink"), [NVLink](https://ko.wikipedia.org/wiki/NVLink "wikilink")를 허용할 것이라 발표하였다.\[23\]
...
### 지포스 10 (10xx) 시리즈
  ...
  - 지원 디스플레이 표준: [DP 1.3/1.4](https://ko.wikipedia.org/wiki/디스플레이포트 "wikilink"), [HDMI 2.0b](https://ko.wikipedia.org/wiki/고선명_멀티미디어_인터페이스 "wikilink"), [듀얼 링크 DVI](https://ko.wikipedia.org/wiki/디지털_비주얼_인터페이스 "wikilink")\[24\]
  - 지원 API: [Direct3D](https://ko.wikipedia.org/wiki/Direct3D "wikilink") 12.0 (12_1), [OpenGL](https://ko.wikipedia.org/wiki/OpenGL "wikilink") 4.6, [OpenCL](https://ko.wikipedia.org/wiki/OpenCL "wikilink") 1.2, [벌컨](../Page/벌컨_\(API\).md "wikilink") 1.0
...
<th><p>모델</p></th>
<th><p>런칭일</p></th>
<th><p><a href="https://ko.wikipedia.org/wiki/암호명" title="wikilink">코드명</a>(s)</p></th>
...
<th><p>메모리</p></th>
<th><p>처리 파워 (<a href="https://ko.wikipedia.org/wiki/플롭스" title="wikilink">플롭스</a>)</p></th>
...
<th><p>런칭 가격 (<a href="https://ko.wikipedia.org/wiki/미국_달러" title="wikilink">USD</a>)</p></th>
</tr>
</thead>
<tbody>
<tr class="odd">
<td><p>베이스 코어 클럭 (<a href="https://ko.wikipedia.org/wiki/헤르츠" title="wikilink">MHz</a>)</p></td>
<td><p>부스트 코어 클럭 (<a href="https://ko.wikipedia.org/wiki/헤르츠" title="wikilink">MHz</a>)</p></td>
...
<td><p>버스 유형</p></td>
<td><p>버스 너비 (<a href="https://ko.wikipedia.org/wiki/비트_(단위)" title="wikilink">비트</a>)</p></td>
...
| 모델                                                              | 런칭일                                                             | [코드명](https://ko.wikipedia.org/wiki/암호명 "wikilink")               | 팹 ([nm](https://ko.wikipedia.org/wiki/나노미터 "wikilink"))  | 트랜지스터                                                             | 다이 크기 (mm<sup>2</sup>)                                     | [버스](https://ko.wikipedia.org/wiki/버스_\(컴퓨팅\) "wikilink") [인터페이스](https://ko.wikipedia.org/wiki/입출력 "wikilink") | 코어 구성          | SM 카운트                                                           | 클럭 속도                                                       | [필레이트](https://ko.wikipedia.org/wiki/필레이트 "wikilink")     | 메모리                                                       | [API](https://ko.wikipedia.org/wiki/API "wikilink") 지원 (버전) | 처리 파워 (GFLOPS)                                                      | [TDP](https://ko.wikipedia.org/wiki/열_설계_전력 "wikilink") (와트)      | [SLI](https://ko.wikipedia.org/wiki/스케일러블_링크_인터페이스 "wikilink") 지원 |
| --------------------------------------------------------------- | --------------------------------------------------------------- | ----------------------------------------------------------------- | -------------------------------------------------------- | ----------------------------------------------------------------- | ---------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------- | -------------- | ---------------------------------------------------------------- | ----------------------------------------------------------- | --------------------------------------------------------- | --------------------------------------------------------- | ----------------------------------------------------------- | ------------------------------------------------------------------- | ----------------------------------------------------------------- | ----------------------------------------------------------------- |
| 베이스 코어 클럭 ([MHz](https://ko.wikipedia.org/wiki/헤르츠 "wikilink")) | 부스트 코어 클럭 ([MHz](https://ko.wikipedia.org/wiki/헤르츠 "wikilink")) | 메모리 ([MT/s](https://ko.wikipedia.org/wiki/전송_\(컴퓨팅\) "wikilink")) | 픽셀 ([GP](https://ko.wikipedia.org/wiki/화소 "wikilink")/s) | 텍스처 ([GT](https://ko.wikipedia.org/wiki/텍셀_\(그래픽\) "wikilink")/s) | 크기 ([GiB](https://ko.wikipedia.org/wiki/기비바이트 "wikilink")) | 대역폭 ([GB](https://ko.wikipedia.org/wiki/기가바이트 "wikilink")/s)                                                    | 버스 유형          | 버스 너비 ([비트](https://ko.wikipedia.org/wiki/비트_\(단위\) "wikilink")) | [DirectX](https://ko.wikipedia.org/wiki/DirectX "wikilink") | [OpenGL](https://ko.wikipedia.org/wiki/OpenGL "wikilink") | [OpenCL](https://ko.wikipedia.org/wiki/OpenCL "wikilink") | [벌컨](../Page/벌컨_\(API\).md "wikilink")                      | [단일정밀도](https://ko.wikipedia.org/wiki/단일정밀도_부동소수점 "wikilink") (부스트) | [배정밀도](https://ko.wikipedia.org/wiki/배정밀도_부동소수점 "wikilink") (부스트) | [반정밀도](https://ko.wikipedia.org/wiki/반정밀도_부동소수점 "wikilink") (부스트) |
...
| GeForce GTX 1080 (Notebook)\[57\]                               | GP104-400 (N17E-G3)                                             | 2560:160:64                                                       | 20                                                       | 1556                                                              | 1733                                                       | 10000                                                                                                           | 99.6           | 249                                                              | 320                                                         | [GDDR5](https://ko.wikipedia.org/wiki/GDDR5 "wikilink")   | 7967 (8873)                                               | 249                                                         | 124                                                                 | 150                                                               |                                                                   |

## 칩셋표

## 같이 보기

  - [지포스 400 시리즈](https://ko.wikipedia.org/wiki/지포스_400_시리즈 "wikilink")
  - [지포스 500 시리즈](https://ko.wikipedia.org/wiki/지포스_500_시리즈 "wikilink")
  - [지포스 600 시리즈](https://ko.wikipedia.org/wiki/지포스_600_시리즈 "wikilink")
  - [지포스 700 시리즈](../Page/지포스_700_시리즈.md "wikilink")
  - [지포스 800M 시리즈](https://ko.wikipedia.org/wiki/지포스_800M_시리즈 "wikilink")
  - [지포스 900 시리즈](https://ko.wikipedia.org/wiki/지포스_900_시리즈 "wikilink")
  - [엔비디아 쿼드로](https://ko.wikipedia.org/wiki/엔비디아_쿼드로 "wikilink")
  - [엔비디아 테슬라](https://ko.wikipedia.org/wiki/엔비디아_테슬라 "wikilink")
