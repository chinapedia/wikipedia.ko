...
[지수함수적 붕괴의](https://ko.wikipedia.org/wiki/지수함수적_붕괴 "wikilink") **반감기**(半減期, half-life)란 어떤 양이 초기 값의 절반이 되는데 걸리는 시간이다. 원개념은 [방사성 붕괴에서](../Page/방사성_붕괴.md "wikilink") 기인한 것이나, 현재는 여러 다른 분야에서도 쓰이고 있다.
