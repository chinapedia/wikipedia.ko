...
클라우드 스토리지 및 표준 프로토콜을 지원하는 장비를 외부에서 원격으로 연결할 수 있다. 개인용, 기업용, 교육용 클라우드 스토리지를 모두 지원하며, 표준 프로토콜을 지원하는 [NAS](https://ko.wikipedia.org/wiki/네트워크_결합_스토리지 "wikilink")\[4\], [공유기](https://ko.wikipedia.org/wiki/라우터 "wikilink")\[5\], 서버\[6\]와도 연결가능하다.

### 클라우드 스토리지

  - [구글 드라이브](https://ko.wikipedia.org/wiki/구글_드라이브 "wikilink") (Google Drive)
  ...
  - [원드라이브](https://ko.wikipedia.org/wiki/원드라이브 "wikilink") (OneDrive)
  - [셰어포인트](../Page/셰어포인트.md "wikilink") (SharePoint)
  - [드롭박스](https://ko.wikipedia.org/wiki/드롭박스 "wikilink") (Dropbox)
...
### 표준 프로토콜
  ...
  - [WebDAV](https://ko.wikipedia.org/wiki/WebDAV "wikilink") (Web Distributed Authoring and Versioning, 웹 분산 저작 및 버전 관리)
  - [FTP](https://ko.wikipedia.org/wiki/파일_전송_프로토콜 "wikilink")/[FTPS](https://ko.wikipedia.org/wiki/FTPS "wikilink") (FTP Secure, FTP-SSL)
...
6.  [아파치 웹 서버](https://ko.wikipedia.org/wiki/아파치_HTTP_서버 "wikilink"), [OwnCloud](https://ko.wikipedia.org/wiki/OwnCloud "wikilink"), vsftp 등
7.