...
[호몰로지 대수학에서](https://ko.wikipedia.org/wiki/호몰로지_대수학 "wikilink"), **삼각 분할 범주**(三角分割範疇, )는 [유도 범주](../Page/유도_범주.md "wikilink") 및 [안정 호모토피 범주와](https://ko.wikipedia.org/wiki/안정_호모토피_범주 "wikilink") 유사한 성질을 가지는 [범주이다](https://ko.wikipedia.org/wiki/범주_\(수학\) "wikilink"). 이 위에 일반적인 코호몰로지 함자의 개념을 정의할 수 있다.

## 정의

### 삼각형

범주 \(\mathcal C\) 위의 자기 [동치](https://ko.wikipedia.org/wiki/범주의_동치 "wikilink") \(\Sigma\colon\mathcal C\to\mathcal C\)가 주어졌다고 하자. \((\mathcal C,\Sigma)\) 위의 **삼각형**()은 다음과 같은 꼴의 사상들이다.
...
\[X'\xrightarrow{f'}Y'\xrightarrow{g'}Z'\xrightarrow{h'}\Sigma X'\] 사이의 **동형**은 다음 조건을 만족시키는 [동형 사상](https://ko.wikipedia.org/wiki/동형_사상 "wikilink")
...
**삼각 분할 범주**는 다음과 같은 데이터로 구성된다.
  ...
  - 삼각형들로 구성된 [모임](https://ko.wikipedia.org/wiki/모임_\(수학\) "wikilink"). 이 모임의 원소를 **특별 삼각형**()이라고 한다.
...
체 \(K\) 위의 [벡터 공간들의](https://ko.wikipedia.org/wiki/벡터_공간 "wikilink") 범주 \(\operatorname{Vect}_K\) 위에 다음과 같이 삼각 분할 범주의 구조를 줄 수 있다.

  - 자기 동치는 항등 함자 \(\Sigma=\operatorname{Id}\)이다.
  - 특별 삼각형은 [완전열](https://ko.wikipedia.org/wiki/완전열 "wikilink") \(U\to V\to W\to U\to V\)이다.

### 아벨 범주의 유도 범주

[아벨 범주](https://ko.wikipedia.org/wiki/아벨_범주 "wikilink") \(\mathcal A\)가 주어졌다고 하자. 그렇다면, 그 위의 호모토피 범주 \(\mathcal K(\mathcal A)\) (즉, 대상은 [사슬 복합체](https://ko.wikipedia.org/wiki/사슬_복합체 "wikilink"), 사상은 사슬 사상의 호모토피류)는 삼각 분할 범주를 이룬다. 이 경우 특별 삼각형은 [호몰로지 대수학에서의](https://ko.wikipedia.org/wiki/호몰로지_대수학 "wikilink") 사상뿔과 동형인 삼각형이다.

[아벨 범주](https://ko.wikipedia.org/wiki/아벨_범주 "wikilink") \(\mathcal A\)의 호모토피 범주 \(\mathcal K(\mathcal A)\)의 [약한 동치를](https://ko.wikipedia.org/wiki/약한_동치 "wikilink") 국소화하면 [유도 범주](../Page/유도_범주.md "wikilink") \(\operatorname D(\mathcal A)\)를 얻는다. 이 역시 삼각 분할 범주를 이룬다. 이는 [약한 동치의](https://ko.wikipedia.org/wiki/약한_동치 "wikilink") 국소화가 삼각 분할 구조와 호환되기 때문이다.

### 안정 호모토피 범주

[스펙트럼들로](https://ko.wikipedia.org/wiki/스펙트럼_\(위상수학\) "wikilink") 구성된 안정 호모토피 범주 역시 삼각 분할 범주를 이룬다. 자기 동치 \(\Sigma\)는 스펙트럼의 [현수이다](../Page/현수_\(위상수학\).md "wikilink").

## 역사

[장루이 베르디에가](https://ko.wikipedia.org/wiki/장루이_베르디에 "wikilink") 1963년 박사 학위 논문에서 [유도 범주와](../Page/유도_범주.md "wikilink") 함께 정의하였다.\[4\] 베르디에는 유도 범주에서 등장하는 특별 삼각형들의 성질들을 공리화하여 삼각 분할 범주의 개념을 추출하였다.
