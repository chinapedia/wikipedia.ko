...
**Ctags**는 다양한 [프로그래밍 언어로](../Page/프로그래밍_언어.md "wikilink") 된 소스와 헤더 파일에서 보이는 이름의 인덱스(또는 태그) 파일을 생성하는 [프로그래밍 도구이다](../Page/프로그래밍_도구.md "wikilink"). 언어에 따라 [함수](../Page/함수.md "wikilink"), [변수](https://ko.wikipedia.org/wiki/변수 "wikilink"), [클래스](https://ko.wikipedia.org/wiki/클래스 "wikilink") 멤버, [매크로](../Page/매크로_\(컴퓨터_과학\).md "wikilink") 등을 색인할 수 있다. 이 태그들은 정의들을 빠르고 쉽게 [문서 편집기나](../Page/문서_편집기.md "wikilink") 다른 유틸리티에 의해 위치시킬 수 있게 한다. 그 외에, [상호 참조](https://ko.wikipedia.org/wiki/상호_참조 "wikilink") 파일을 생성하는 출력 모드도 있어서 언어 파일 집합에서 보이는 다양한 이름에 대한 정보를 [사람이 읽을 수 있는](https://ko.wikipedia.org/wiki/사람이_읽을_수_있는_매체 "wikilink") 형태로 나열할 수 있다.

오리지널 **Ctags**는 [BSD](../Page/BSD.md "wikilink")에 도입되었으며 [켄 아놀드가](https://ko.wikipedia.org/wiki/켄_아놀드 "wikilink") 작성하였고, 짐 클레크너가 [포트란](../Page/포트란.md "wikilink") 지원을, [빌 조이가](../Page/빌_조이.md "wikilink") [파스칼](../Page/파스칼_\(프로그래밍_언어\).md "wikilink") 지원을 맡았다.
...
태그 인덱스 파일들은 다음을 포함하여 수많은 [소스 코드 편집기에](../Page/소스_코드_편집기.md "wikilink") 의해 지원된다:
  ...
  - [에디트플러스](../Page/에디트플러스.md "wikilink")
  - [이맥스](../Page/이맥스.md "wikilink"), [XEmacs](https://ko.wikipedia.org/wiki/XEmacs "wikilink")
  - [엠에디터 프로페셔널](../Page/엠에디터.md "wikilink")
  - [기니](../Page/기니_\(소프트웨어\).md "wikilink")
  - [Gedit](../Page/Gedit.md "wikilink") (gedit-symbol-browser-plugin을 통해. \[[https://web.archive.org/web/20080117145432/http://www.micahcarrick.com/11-14-2007/gedit-symbol-browser-plugin.html\]에서](https://web.archive.org/web/20080117145432/http://www.micahcarrick.com/11-14-2007/gedit-symbol-browser-plugin.html%5D에서) 확인 가능.)
  - 그놈 빌더
  - [JED](https://ko.wikipedia.org/wiki/JED_\(문서_편집기\) "wikilink")
  - [JEdit](../Page/JEdit.md "wikilink") (플러그인 CodeBrowser, Tags, ClassBrowser, CtagsSideKick, Jump를 통해)
  ...
  - [노트패드++](../Page/노트패드++.md "wikilink") (OpenCTags 플러그인을 통해)
  ...
  - [Vi](../Page/Vi.md "wikilink") (및 [Elvis](https://ko.wikipedia.org/wiki/Elvis "wikilink"), [Nvi](https://ko.wikipedia.org/wiki/Nvi "wikilink"), [Vim](../Page/Vim.md "wikilink"), [vile](https://ko.wikipedia.org/wiki/vile "wikilink") 등의 파생 편집기를 통해)
