...
x, y, z 가 3차원 [유클리드 공간을](../Page/유클리드_공간.md "wikilink") 나타내는 [직교 좌표계라](https://ko.wikipedia.org/wiki/직교_좌표계 "wikilink") 하고, **i**, **j**, **k**를 각각에 해당하는 [단위벡터](../Page/단위벡터.md "wikilink")라고 하자.
