...
잠재적인 Double Free(C 동적 메모리 할당에러) 해결은 [CVS](https://ko.wikipedia.org/wiki/CVS "wikilink") 커밋 로그(명시적 [널 포인터](../Page/널_포인터.md "wikilink") 변수 할당 포함)\[12\]에 언급되어있다.또한 인자 길이, 부호없는 변수를 부호화된 변수에 할당, 포인터 변수, 함수의 반환 값의 보장과 관련된 Sanity 검사또한 커밋 로그에 언급되어있다.
