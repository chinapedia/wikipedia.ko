...
**스토크스 변수**는 ([가시광선](https://ko.wikipedia.org/wiki/가시광선 "wikilink") 등을 포함한) [전자기파](https://ko.wikipedia.org/wiki/전자기파 "wikilink")의 [편광](../Page/편광.md "wikilink") 상태를 설명하기 위해 도입된 값이다. 이 변수들은 [1852년](https://ko.wikipedia.org/wiki/1852년 "wikilink") [조지 가브리엘 스토크스에](https://ko.wikipedia.org/wiki/조지_가브리엘_스토크스 "wikilink") 의해, 결맞지 않거나 부분 편광된 광선에서 전체 광량 (Intensity, *I*), 편광도(Degree of polarization, *p*), 그리고 [편광 타원의](https://ko.wikipedia.org/wiki/편광_타원 "wikilink") 모양변수 등에 대한 일반적인 설명을 간편하게 수학적으로 대체하기 위해 도입되었다. 스토크스 변수와 광량, 편광 타원의 매개변수들 사이의 관계는 다음의 관계식과 그림에 나타나 있다.
...
광학계의 편광 효율는 입사광의 스토크스 벡터 집합에 [뮬러 행렬을](https://ko.wikipedia.org/wiki/뮬러_행렬 "wikilink") 곱하면 빛이 광학계를 투과한 후의 스토크스 벡터를 구하면서 바로 확인할 수 있다.
...
## 같이 보기
  ...
  - [뮬러 행렬](https://ko.wikipedia.org/wiki/뮬러_행렬 "wikilink")
  - [존스 행렬](https://ko.wikipedia.org/wiki/존스_행렬 "wikilink")
