...
**벨 다항식**(Bell polynomial)은 [조합론](https://ko.wikipedia.org/wiki/조합론 "wikilink")에서 [에릭 템플 벨](https://ko.wikipedia.org/wiki/에릭_템플_벨 "wikilink")(Eric Temple Bell)의 이름을 따서 명명된 다항식이다. 벨(Bell) 다항식은 [집합 분할](../Page/집합의_분할.md "wikilink") 연구에 사용된다. 이것은 [스털링 수](../Page/스털링_수.md "wikilink") 및 [벨 수와](https://ko.wikipedia.org/wiki/벨_수 "wikilink") 관련이 있다. 이것들은 또한 [파 디 브루노](https://ko.wikipedia.org/wiki/파_디_브루노 "wikilink")(Faà di Bruno)의 [브루노 공식과](https://ko.wikipedia.org/wiki/브루노_공식 "wikilink") 같은 많은 응용에서 언급된다.
...
벨 다항식은 또한 다음과 같은 [미분](https://ko.wikipedia.org/wiki/미분 "wikilink")으로 표현가능하다.\[1\]
...
## 함께보기
  ...
  - [이항 정리](https://ko.wikipedia.org/wiki/이항_정리 "wikilink")
