...
[소프트웨어 개발에서](https://ko.wikipedia.org/wiki/소프트웨어_개발 "wikilink") **메소드 스텁(method stub)** 혹은 간단히 **스텁은** 다른 프로그래밍 기능을 대리하는 코드이다. 스텁은 기존 코드(예를 들어 원격 머신의 [프로시저](https://ko.wikipedia.org/wiki/함수_\(전산학\) "wikilink"))를 [흉내내거나](https://ko.wikipedia.org/wiki/시뮬레이션 "wikilink") 아직 개발되지 않은 코드를 임시로 대치하는 역할을 수행한다. 따라서 스텁은 일반 소프트웨어 개발과 [테스팅을](https://ko.wikipedia.org/wiki/소프트웨어_테스트 "wikilink") 포함하여 특히 [이식과](https://ko.wikipedia.org/wiki/이식_\(컴퓨팅\) "wikilink") [분산 컴퓨팅에](https://ko.wikipedia.org/wiki/분산_컴퓨팅 "wikilink") 유용하다

[의사코드](https://ko.wikipedia.org/wiki/의사코드 "wikilink")로 기술한 스텁의 예를 들면:
...
## 같이 보기
  ...
  - 추상 메소드
  - [모의 객체](https://ko.wikipedia.org/wiki/모의_객체 "wikilink")
  - 더미 코드
  - 테스트 스텁
