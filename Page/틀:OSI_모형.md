...
| list1name = 응용 | list1title = 7.  [응용 계층](../Page/응용_계층.md "wikilink") | list1 =
  ...
  - [기타..](https://ko.wikipedia.org/wiki/:분류:응용_계층_프로토콜 "wikilink")
...
| list3name = 세션 | list3title = 5.  [세션 계층](https://ko.wikipedia.org/wiki/세션_계층 "wikilink") | list3 =
...
| list4name = 전송 | list4title = 4.  [전송 계층](../Page/전송_계층.md "wikilink") | list4 =
  ...
  - [SPX](https://ko.wikipedia.org/wiki/IPX/SPX "wikilink")
...
| list6name = 데이터 | list6title = 2.  [데이터 링크 계층](https://ko.wikipedia.org/wiki/데이터_링크_계층 "wikilink") | list6 =
  ...
  - [ARP](../Page/주소_결정_프로토콜.md "wikilink")
  - [IS-IS](https://ko.wikipedia.org/wiki/IS-IS "wikilink")
  - [SDLC](https://ko.wikipedia.org/wiki/동기식_데이터_연결_제어 "wikilink")
  - [HDLC](https://ko.wikipedia.org/wiki/고급_데이터_연결_제어 "wikilink")
  - [CSLIP](../Page/직렬_회선_인터넷_프로토콜.md "wikilink")
  - [SLIP](../Page/직렬_회선_인터넷_프로토콜.md "wikilink")
  - [GFP](https://ko.wikipedia.org/wiki/제네릭_프레이밍_프로시저 "wikilink")
  - [PLIP](https://ko.wikipedia.org/wiki/PLIP "wikilink")
  - [IEEE 802.2](https://ko.wikipedia.org/wiki/IEEE_802.2 "wikilink")
  - [LLC](https://ko.wikipedia.org/wiki/논리_링크_제어 "wikilink")
  - [MAC](https://ko.wikipedia.org/wiki/매체_접근_제어 "wikilink")
  - [L2TP](https://ko.wikipedia.org/wiki/레이어_2_터널링_프로토콜 "wikilink")
...
| list7name = 물리 | list7title = 1.  [물리 계층](../Page/물리_계층.md "wikilink") | list7 =

  - [RS-232](../Page/RS-232.md "wikilink")
  - [EIA/TIA-449](https://ko.wikipedia.org/wiki/EIA/TIA-449 "wikilink")
  - [ITU-T V 계열](https://ko.wikipedia.org/wiki/ITU-T_V_계열_권고 "wikilink")
  - [I.430](https://ko.wikipedia.org/wiki/I.430 "wikilink")
  - [I.431](https://ko.wikipedia.org/wiki/I.431 "wikilink")
  - [PDH](https://ko.wikipedia.org/wiki/유사_동기식_디지털_계위 "wikilink")
  - [SONET/SDH](https://ko.wikipedia.org/wiki/SONET/SDH "wikilink")
  - [PON](../Page/수동_광통신망.md "wikilink")
