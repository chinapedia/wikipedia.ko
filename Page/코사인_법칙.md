...
[유클리드](https://ko.wikipedia.org/wiki/유클리드 "wikilink")의 《[원론](https://ko.wikipedia.org/wiki/에우클레이데스의_원론 "wikilink")》 2권 명제12 및 명제 13은 코사인 법칙과 동치인 명제를 서술한다.
...
[섬네일의](https://ko.wikipedia.org/wiki/파일:Obtuse_Triangle_With_Altitude_ZP2.svg "wikilink") 《[원론](https://ko.wikipedia.org/wiki/에우클레이데스의_원론 "wikilink")》에서의 증명\]\] 그림과 같이, \(C\)를 둔각으로 하는 둔각 삼각형 \(ABC\)의 높이선 \(BH\)를 긋자. 그렇다면, \(ABH\)는 \(H\)를 직각으로 하는 직각 삼각형이므로, [피타고라스의 정리에](https://ko.wikipedia.org/wiki/피타고라스의_정리 "wikilink") 따라 다음이 성립한다.
...
\[AB^2=AC^2+2(AC)(CH)+BC^2\] 이로써 [유클리드](https://ko.wikipedia.org/wiki/유클리드 "wikilink")의 《[원론](https://ko.wikipedia.org/wiki/에우클레이데스의_원론 "wikilink")》 2권 명제12가 증명된다. 코사인의 정의에 따라
...
\[\mathbf a=\overrightarrow{CB},\;\mathbf b=\overrightarrow{CA},\;\mathbf c=\overrightarrow{AB}=\mathbf a-\mathbf b\] 그렇다면, 벡터 \(\mathbf a,\mathbf b,\mathbf c\)의 길이는 각각 \(a,b,c\)이며, 벡터 \(\mathbf a\)와 \(\mathbf b\) 사이의 각도는 \(C\)이다. 따라서, 코사인 법칙을 [벡터](https://ko.wikipedia.org/wiki/벡터 "wikilink")의 [스칼라곱](https://ko.wikipedia.org/wiki/스칼라곱 "wikilink")의 성질에 따라 다음과 같이 간단히 증명할 수 있다.\[8\]
...
\[c=\ln\frac{|1-rz|+|z-r|}{|1-rz|-|z-r|}\] 여기서 \(\ln\)은 [자연 로그이며](https://ko.wikipedia.org/wiki/자연_로그 "wikilink"), \(|-|\)은 복소수의 [절댓값](https://ko.wikipedia.org/wiki/절댓값 "wikilink")이다. 이 셋을 다음과 같이 변형할 수 있다.

\[\tanh\frac a2=r\]

\[\tanh\frac b2=|z|\]

\[\tanh\frac c2=\frac{|z-r|}{|1-rz|}\] 여기서 \(\tanh\)는 [쌍곡 탄젠트이다](https://ko.wikipedia.org/wiki/쌍곡_탄젠트 "wikilink"). [쌍곡선 함수의](https://ko.wikipedia.org/wiki/쌍곡선_함수 "wikilink") 항등식을 사용한 뒤 위의 결과를 대입하여 정리하면 다음을 얻는다.
