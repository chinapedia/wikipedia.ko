...
RSS 2.0은 공식적으로 완료된 것으로 선언되었으며, [하버드 대학교가](../Page/하버드_대학교.md "wikilink") 저작권을 보유하고 있다.

## 여러 표준

RSS는 [XML](../Page/XML.md "wikilink") 기반의 표준이며, 여러 표준들이 존재한다. 표준들은 크게 [RDF](https://ko.wikipedia.org/wiki/RDF "wikilink") (또는 RSS 1.\*)과 RSS 2.\* 로 나뉜다.
