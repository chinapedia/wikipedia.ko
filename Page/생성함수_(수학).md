...
[수학](https://ko.wikipedia.org/wiki/수학 "wikilink")에서 어떤 [수열](https://ko.wikipedia.org/wiki/수열 "wikilink") *a*<sub>*n*</sub> (n은 [자연수](https://ko.wikipedia.org/wiki/자연수 "wikilink"))에 대하여,

\[f(x)= a_0+a_1x+a_2x^2+\cdots+a_nx^n+\cdots = \sum_{k=0}^\infty a_k x^k\] 와 같이 미지수의 계수가 수열의 각 항으로 되어 있는 [멱급수](../Page/형식적_멱급수.md "wikilink") 형태의 [함수](https://ko.wikipedia.org/wiki/함수 "wikilink") 즉, 그 수열을 계수로 하는 [멱급수](https://ko.wikipedia.org/wiki/멱급수 "wikilink")를 **생성함수**(generating function)라고 한다.

따라서, 이러한 기능이 생성함수가 어떤 [수열](https://ko.wikipedia.org/wiki/수열 "wikilink")의 정보를 담고 있는 [급수](https://ko.wikipedia.org/wiki/급수_\(수학\) "wikilink") 또는 [곱집합](https://ko.wikipedia.org/wiki/곱집합 "wikilink")의 형태가 되어야 하는지를 결정한다.

[아브라암 드무아브르가](../Page/아브라암_드무아브르.md "wikilink") 1730년에 일반 선형 점화식 문제를 풀기 위해 도입하였다.\[1\] 생성함수는 여러 경우에 이용되는데 예를 들어 어떤 수열에 대한 [점화식](https://ko.wikipedia.org/wiki/점화식 "wikilink")을 이용해 [일반항](https://ko.wikipedia.org/wiki/일반항 "wikilink")을 알아낼 때에도 쓰인다.
