> This article is converted from Wikipedia: [어반 삭스](https://ko.wikipedia.org/wiki/어반_삭스).
...
이 프로젝트는 주변과 공간에 있는 소리를 색서폰으로 구현해보자 하는 것이다. 색서폰은 연주자와 관객의 사이를 매개한다. 이것은 [미니멀리즘](../Page/미니멀리즘.md "wikilink")과도 연결된다.
