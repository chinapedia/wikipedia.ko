...
[수학](https://ko.wikipedia.org/wiki/수학 "wikilink")에서, **베셀 함수**()는 [헬름홀츠 방정식을](https://ko.wikipedia.org/wiki/헬름홀츠_방정식 "wikilink") [원통좌표계](https://ko.wikipedia.org/wiki/원통좌표계 "wikilink")에서 [변수분리할](https://ko.wikipedia.org/wiki/변수분리법 "wikilink") 때 등장하는 [특수 함수다](https://ko.wikipedia.org/wiki/특수_함수 "wikilink"). [물리학](https://ko.wikipedia.org/wiki/물리학 "wikilink")에서 [맥스웰 방정식이나](https://ko.wikipedia.org/wiki/맥스웰_방정식 "wikilink") [열 방정식](https://ko.wikipedia.org/wiki/열_방정식 "wikilink"), [슈뢰딩거 방정식](https://ko.wikipedia.org/wiki/슈뢰딩거_방정식 "wikilink") 등 다양한 문제를 풀 때 쓰인다.

## 정의

베셀 함수는 다음과 같은 [상미분 방정식의](https://ko.wikipedia.org/wiki/상미분_방정식 "wikilink") 해 \(y(x)\)다.

\[x^2 \frac{d^2 y}{dx^2} + x \frac{dy}{dx} + (x^2 - \alpha^2)y = 0\] 여기서 \(\alpha\)는 임의의 [복소수](https://ko.wikipedia.org/wiki/복소수 "wikilink")다. 이 상미분 방정식을 \(\alpha\)차수의 **베셀 방정식**()이라고 한다.
...
베셀 방정식은 2차원 [헬름홀츠 방정식](https://ko.wikipedia.org/wiki/헬름홀츠_방정식 "wikilink")

\[(\Delta+k^2)f=0\] 을 [극좌표계](https://ko.wikipedia.org/wiki/극좌표계 "wikilink")에서 [변수분리할](https://ko.wikipedia.org/wiki/변수분리법 "wikilink") 때 나타난다. 즉, 원통좌표계 [라플라스 연산자는](https://ko.wikipedia.org/wiki/라플라스_연산자 "wikilink")
...
α가 임의의 [복소수](https://ko.wikipedia.org/wiki/복소수 "wikilink")일 때, 베셀 방정식의 가장 기본적인 해를 **제1종 베셀 함수** J<sub>α</sub>(x)라고 하며 다음과 같이 정의한다.

\[J_\alpha(x) = \sum_{m=0}^\infty \frac{(-1)^m}{m! \Gamma(m+\alpha+1)} {\left({\frac{x}{2}}\right)}^{2m+\alpha}\] 여기서 Γ(x)는 [감마 함수를](https://ko.wikipedia.org/wiki/감마_함수 "wikilink") 의미한다.

이 때 만약 α가 [정수](https://ko.wikipedia.org/wiki/정수 "wikilink")가 아니라면, J<sub>α</sub>(x)와 J<sub>-α</sub>(x)는 선형 독립이면서 베셀 방정식의 해가 된다. 따라서
...
[경로적분법](https://ko.wikipedia.org/wiki/경로적분법 "wikilink")을 사용하여 베셀 함수를 다음과 같이 표현할 수 있다.
...
\[\exp(ir\cos\theta)=\sum_ni^nJ_n(r)\exp(in\theta)=J_0(r)+\sum_n2i^nJ_n(r)\cos n\theta\]. 이는 [카를 구스타프 야코프 야코비와](https://ko.wikipedia.org/wiki/카를_구스타프_야코프_야코비 "wikilink") 카를 테오도어 앙거()의 이름을 딴 것이다.

마찬가지로, 구면 베셀 함수도 다음과 같이 [생성 함수로](../Page/생성함수_\(수학\).md "wikilink") 표현할 수 있다. 이 공식을 **레일리 전개**()라고 한다.

\[\exp(ir\cos\theta)=\sum_ni^n(2n+1)j_n(r)P_n(\cos\theta)\]. 여기서 \(P_n\)은 [르장드르 다항식이다](https://ko.wikipedia.org/wiki/르장드르_다항식 "wikilink").

## 역사

[다니엘 베르누이가](https://ko.wikipedia.org/wiki/다니엘_베르누이 "wikilink") 최초로 정의하였다. [프리드리히 베셀이](https://ko.wikipedia.org/wiki/프리드리히_베셀 "wikilink") 연구하고, 일반화하였다.\[1\]

## 같이 보기

  - [헬름홀츠 방정식](https://ko.wikipedia.org/wiki/헬름홀츠_방정식 "wikilink")
  - [구면 조화 함수](https://ko.wikipedia.org/wiki/구면_조화_함수 "wikilink")
  - [프로베니우스 방법](https://ko.wikipedia.org/wiki/프로베니우스_방법 "wikilink")
