...
[범주론](https://ko.wikipedia.org/wiki/범주론 "wikilink")에서, **내적 범주**(內的範疇, )는 [작은 범주의](../Page/작은_범주.md "wikilink") 정의에서 사용되는 집합의 범주를 대체하여, 임의의 범주 속에서 범주처럼 작동하는 구조이다. [작은 범주의](../Page/작은_범주.md "wikilink") 개념의 일반화이다.

## 정의

[범주](https://ko.wikipedia.org/wiki/범주_\(수학\) "wikilink") \(\mathcal C\)가 유한 [곱](https://ko.wikipedia.org/wiki/곱_\(범주론\) "wikilink") 및 [당김을](../Page/당김_\(범주론\).md "wikilink") 갖는다고 하자. 그렇다면, \(\mathcal C\) 속의 **내적 범주**() \((O,M,i,s,t,c)\)은 다음과 같은 데이터로 주어진다.
...
유한 곱과 당김을 갖는 범주 \(\mathcal C\) 속의 **내적 [준군](https://ko.wikipedia.org/wiki/준군 "wikilink")**() \((O,M,s,t,e,i)\)은 다음과 같은 데이터로 구성된다.
...
[집합](https://ko.wikipedia.org/wiki/집합 "wikilink")과 함수의 범주 \(\operatorname{Set}\) 속의 내적 범주는 [작은 범주이다](../Page/작은_범주.md "wikilink").

[군과](https://ko.wikipedia.org/wiki/군_\(수학\) "wikilink") [군 준동형의](https://ko.wikipedia.org/wiki/군_준동형 "wikilink") 범주 \(\operatorname{Grp}\) 속의 내적 범주는 작은 범주의 범주 \(\operatorname{Cat}\) 속의 [군 대상과](https://ko.wikipedia.org/wiki/군_대상 "wikilink") 사실상 같으며,\[1\] [교차 가군](https://ko.wikipedia.org/wiki/교차_가군 "wikilink")()이라고 불린다.\[2\]
...
## 같이 보기
  ...
  - [군 대상](https://ko.wikipedia.org/wiki/군_대상 "wikilink")
