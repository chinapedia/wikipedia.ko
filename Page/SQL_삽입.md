...
다음과 같이 사용자의 아이디와 비밀번호를 확인하고 일치하면 로그인을 하는 [PHP](https://ko.wikipedia.org/wiki/PHP "wikilink") 프로그램이 있다고 하자.
