...
대부분의 1세대 [PC들은](../Page/개인용_컴퓨터.md "wikilink") 날짜와 시간을 추적하지 못했다. 여기에는 [CP/M](https://ko.wikipedia.org/wiki/CP/M "wikilink") 운영 체제를 구동하던 시스템뿐 아니라 초기 모델의 [애플 II](../Page/애플_II.md "wikilink"), [BBC 마이크로](https://ko.wikipedia.org/wiki/BBC_마이크로 "wikilink"), [코모도어 PET도](https://ko.wikipedia.org/wiki/코모도어_PET "wikilink") 포함되었다. [IBM PC/AT](https://ko.wikipedia.org/wiki/IBM_PC/AT "wikilink") 은 [메인보드](../Page/메인보드.md "wikilink")에 날짜/시간 하드웨어가 장착된 최초의 상용화된 개인용 컴퓨터였다. 온보드 [배터리 백업이](../Page/전지.md "wikilink") 있는 [실시간 시계](../Page/실시간_시계.md "wikilink") 칩이 포함된 애드온 [주변 기판이](../Page/주변기기.md "wikilink") [IBM PC와](../Page/IBM_PC.md "wikilink") [XT용으로](../Page/IBM_PC_XT.md "wikilink") 이용이 가능하게 되었다. [컴퓨터 네트워크가](../Page/컴퓨터_네트워크.md "wikilink") 널리 사용할 수 있기 전까지 시스템 시간을 추적하였던 대부분의 개인용 컴퓨터 시스템들은 오직 로컬 시간과만 관계를 맺었고 [시간대](../Page/시간대.md "wikilink")에 대한 허용을 두지 않았다.
...
<tr class="even">
<td><p><a href="../Page/맥_OS.md" title="wikilink">맥 OS</a> (<a href="https://ko.wikipedia.org/wiki/애플_(기업)" title="wikilink">애플</a>)</p></td>
