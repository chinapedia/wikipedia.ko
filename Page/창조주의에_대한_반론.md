...
[진화](../Page/진화.md "wikilink")의 과정에 필요한 "우연"이라는 단어는 역시 과학의 용어인 "무작위성"을 두고 하는 말인 경우가 많으며, 이는 일상에서 사용하는 우연의 의미와는 다르다. 진화는 메커니즘이 있고, 각각의 메커니즘이 관찰되었으며, 실제 진화 현상 자체도 관찰 가능한 자연현상이다. 즉, **이 질문은 진화와 [과학주의](../Page/과학주의.md "wikilink")의 일부를 혼동해서 나타나는 질문에 불과하다.** 해당 주장을 하는 사람들 중 [지적설계론](https://ko.wikipedia.org/wiki/지적설계론 "wikilink")을 주장하는 경우가 있는데, 이는 과학으로서 중립적인 [진화](../Page/진화.md "wikilink")에 대한 기본적인 이해 결여에서 나타나는 경우가 많다.
