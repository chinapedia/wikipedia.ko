...
이 대수적 정의는 위의 정의와 [동치](https://ko.wikipedia.org/wiki/동치 "wikilink")이다. 구체적으로, C\* 항등식으로부터 노름이 항상 \(\|a\|=\sup\operatorname{sp}(a^*a)=\operatorname{sp}(aa^*)\)임을 보일 수 있으며, 반대로 임의의 [복소수 바나흐 대수에서](https://ko.wikipedia.org/wiki/복소수_바나흐_대수 "wikilink") \(\operatorname{sp}(ab)\cup\{0\}=\operatorname{sp}(ba)\cup\{0\}\)이므로 이는 B\* 항등식을 함의한다.
...
\[\iota\colon A\to\operatorname B(\mathcal H,\mathcal H)\] 가 존재하며, 또한 이는 [단사 함수이자](https://ko.wikipedia.org/wiki/단사_함수 "wikilink") [복소수 선형 변환이자](https://ko.wikipedia.org/wiki/복소수_선형_변환 "wikilink") [등거리 변환이며](https://ko.wikipedia.org/wiki/등거리_변환 "wikilink"), 또한 수반 연산 \(^*\)에 대한 [준동형](https://ko.wikipedia.org/wiki/준동형 "wikilink")이며, 그 [상은](https://ko.wikipedia.org/wiki/상_\(수학\) "wikilink") C\* 대수의 구체적 정의에 부합한다.
...
물론, 만약 \(I\)가 유한 집합이라면, 이는 단순히 [직합](https://ko.wikipedia.org/wiki/직합 "wikilink") \(\textstyle\bigoplus_{i\in I}A_i\)과 같다.
...
그렇다면, \(f\)는 [작용소 노름이](https://ko.wikipedia.org/wiki/작용소_노름 "wikilink") 1 이하인 [유계 작용소이다](https://ko.wikipedia.org/wiki/유계_작용소 "wikilink").
...
C\* 대수의 원소의 [스펙트럼은](https://ko.wikipedia.org/wiki/스펙트럼_\(함수해석학\) "wikilink") 항상 [공집합](https://ko.wikipedia.org/wiki/공집합 "wikilink")이 아니다. 또한, 임의의 C\* 대수 \(A\)의 원소 \(a\in A\)에 대하여

\[\operatorname{sp}(a^*)=\{\bar\lambda\colon\lambda\in\operatorname{sp}(a)\}\] 이다.

C\* 대수의 [자기 수반 원소의](https://ko.wikipedia.org/wiki/자기_수반_원소 "wikilink") [스펙트럼은](https://ko.wikipedia.org/wiki/스펙트럼_\(함수해석학\) "wikilink") 실수의 부분 집합이다. C\* 대수의 [유니터리 원소의](https://ko.wikipedia.org/wiki/유니터리_원소 "wikilink") 스펙트럼은 \(\{z\in\mathbb C\colon|z|=1\}\)의 부분 집합이다.

## 분류

모든 C\* 대수는 겔판트-나이마르크 정리에 의하여 어떤 [복소수 힐베르트 공간](https://ko.wikipedia.org/wiki/복소수_힐베르트_공간 "wikilink") 속의 [유계 작용소](https://ko.wikipedia.org/wiki/유계_작용소 "wikilink") C\* 대수의 부분 대수로 나타내어진다. 특히, 이 C\* 대수를 포함하는 최소의 [폰 노이만 대수를](https://ko.wikipedia.org/wiki/폰_노이만_대수 "wikilink") 정의할 수 있으며, 원래 C\* 대수는 이 [폰 노이만 대수의](https://ko.wikipedia.org/wiki/폰_노이만_대수 "wikilink") 강한 [연산자 위상에서의](https://ko.wikipedia.org/wiki/연산자_위상 "wikilink") [조밀 집합을](https://ko.wikipedia.org/wiki/조밀_집합 "wikilink") 이룬다. [폰 노이만 대수의](https://ko.wikipedia.org/wiki/폰_노이만_대수 "wikilink") 경우 자세한 구조 이론이 알려져 있다.
...
\[A=\bigoplus_{i\in I}\operatorname{Mat}(n,n;\mathbb C)\] 여기서 \(\operatorname{Mat}(n,n;\mathbb C)\)는 [작용소 노름이](https://ko.wikipedia.org/wiki/작용소_노름 "wikilink") 부여된, \(n\times n\) 복소수 [정사각 행렬들의](https://ko.wikipedia.org/wiki/정사각_행렬 "wikilink") C\* 대수이다.

### 가환 C\* 대수

(항등원을 갖는) 가환 C\* 대수 \(A\)의 **스펙트럼**()은 다음과 같은 집합이다. (이 개념은 C\* 대수의 원소의 [스펙트럼의](https://ko.wikipedia.org/wiki/스펙트럼_\(함수해석학\) "wikilink") 개념과 관계가 없다.)
...
\[\mathcal C^0(X,-)\colon\operatorname{CompHausTop}^{\operatorname{op}}\to\operatorname{comC^*Alg}\] 를 정의할 수 있다.
  ...
  - 임의의 [콤팩트](https://ko.wikipedia.org/wiki/콤팩트_공간 "wikilink") [하우스도르프 공간](https://ko.wikipedia.org/wiki/하우스도르프_공간 "wikilink") \(X\)에 대하여, \(\mathcal C^0(-,\mathbb C)\)는 복소수 값 [연속 함수들의](https://ko.wikipedia.org/wiki/연속_함수 "wikilink") 공간이다. 이 위에 ∞-[르베그 노름](https://ko.wikipedia.org/wiki/르베그_공간 "wikilink") \(\|f\|_\infty=\sup_{x\in X}|f|\) 및 점별 덧셈 · 곱셈 · 복소수 켤레를 부여하면, 이는 가환 C\* 대수를 이룬다.
  - 임의의 두 [콤팩트](https://ko.wikipedia.org/wiki/콤팩트_공간 "wikilink") [하우스도르프 공간](https://ko.wikipedia.org/wiki/하우스도르프_공간 "wikilink") \(X\), \(Y\) 사이의 [연속 함수](https://ko.wikipedia.org/wiki/연속_함수 "wikilink") \(f\colon X\to Y\)의 \(\mathcal C^0(-,\mathbb C)\)에 대한 [상은](https://ko.wikipedia.org/wiki/상_\(수학\) "wikilink") 다음과 같다.
...
**겔판트 표현 정리**(Гельфанд表現定理, )에 따르면, \(\mathcal C^0(-,\mathbb C)\)와 \(\hat{\color{White}{A}}\) 함자는 사실 두 [범주](https://ko.wikipedia.org/wiki/범주_\(수학\) "wikilink") \(\operatorname{comC*Alg}\)와 \(\operatorname{CompHausTop}^{\operatorname{op}}\) 사이의 [범주의 동치를](https://ko.wikipedia.org/wiki/범주의_동치 "wikilink") 정의한다.

특히, 모든 (항등원을 갖는) [가환](https://ko.wikipedia.org/wiki/가환환 "wikilink") C\* 대수 \(A\)에 대하여

\[A\cong\mathcal C^0(\hat A,\mathbb C)\] 이며, 모든 (항등원을 갖는) [가환](https://ko.wikipedia.org/wiki/가환환 "wikilink") C\* 대수 \(A\)는 위와 같은 꼴로 (유일하게) 표현된다.

### 유계 작용소 대수

임의의 [복소수 힐베르트 공간](https://ko.wikipedia.org/wiki/복소수_힐베르트_공간 "wikilink") \(V\) 위의 모든 [유계 작용소들의](https://ko.wikipedia.org/wiki/유계_작용소 "wikilink") 집합 \(\operatorname B(V,V)\)은 [함수의 합성을](https://ko.wikipedia.org/wiki/함수의_합성 "wikilink") 곱셈으로 삼을 때 C\* 대수를 이룬다. (이는 특히 I종 [인자 대수이다](https://ko.wikipedia.org/wiki/인자_대수 "wikilink").) 특히, 만약 \(V=\mathbb C^n\)가 유한 차원이라면, 이는 \(n\times n\) [복소수 행렬들로](https://ko.wikipedia.org/wiki/복소수_행렬 "wikilink") 구성된다.
