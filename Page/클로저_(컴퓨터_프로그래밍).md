...
클로저(closure)의 개념은 1960년대 [람다 표현식에](https://ko.wikipedia.org/wiki/람다_표현식 "wikilink") 의하여 만들어졌다. 1970년 대 펄(PAL) [프로그래밍 언어가](https://ko.wikipedia.org/wiki/프로그래밍_언어 "wikilink") 일급 객체 함수(first-class functions)를 지원하기 시작했다.
