> This article is converted from Wikipedia: [캐논 EOS 600D](https://ko.wikipedia.org/wiki/캐논_EOS_600D).
...
## 550D보다 향상된 기능
  ...
  - 동영상 촬영시 디지털 10배줌
      - 비디오 스냅 기능으로 2\~8초 동영상 촬영시 배경음악 삽입, 연속재생 기능
  - 사진 보정이 가능한 크리에이티브 필터
  - 초보자 가이드
  - 내장-외장 플래쉬 무선 동조 기능
  - 회전형(스위블) LCD
...
## 외부 링크
  ...
  - [SLRCLUB의 리뷰](http://www.slrclub.com/bbs/vx2.php?id=slr_review&no=224)
