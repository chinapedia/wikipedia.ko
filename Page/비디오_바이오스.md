...
[섬네일](https://ko.wikipedia.org/wiki/파일:Generic_block_diagram_of_a_GPU.svg "wikilink") [섬네일](https://ko.wikipedia.org/wiki/파일:POST_card_98usd.jpg "wikilink") **비디오 바이오스**(Video BIOS)는 컴퓨터 안의 [그래픽 카드에](../Page/그래픽_카드.md "wikilink") 장착된 [바이오스](../Page/바이오스.md "wikilink")를 말한다. 특정 비디오 드라이버가 로드되기 전에 기초적인 텍스트와 비디오 모드를 위한 Int 10h 인터럽트도 구현한다.\[1\]
