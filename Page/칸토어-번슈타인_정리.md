...
[집합론](https://ko.wikipedia.org/wiki/집합론 "wikilink")에서, **칸토어-번슈타인 정리**()는 두 집합 사이에 두 방향으로 [단사 함수가](https://ko.wikipedia.org/wiki/단사_함수 "wikilink") 존재하면 그 사이에 [일대일 대응이](https://ko.wikipedia.org/wiki/일대일_대응 "wikilink") 존재한다는 정리이다. 이는 [선택 공리에](https://ko.wikipedia.org/wiki/선택_공리 "wikilink") 의존하지 않고 증명할 수 있다.

## 정의

다음 두 명제가 서로 동치이며, 이를 **칸토어-번슈타인 정리**라고 한다.

  - 만약 두 집합 \(A\)와 \(B\) 사이에 [단사 함수](https://ko.wikipedia.org/wiki/단사_함수 "wikilink") \(f\colon A\to B\)와 \(g\colon B\to A\)가 존재하면, [전단사 함수](https://ko.wikipedia.org/wiki/전단사_함수 "wikilink") \(h\colon A\to B\)가 존재한다.
  - 만약 두 집합 \(A\)와 \(B\)의 [기수가](https://ko.wikipedia.org/wiki/기수_\(수학\) "wikilink") \(|A|\le|B|\)이며 \(|A|\ge|B|\)라면, \(|A|=|B|\)이다.
