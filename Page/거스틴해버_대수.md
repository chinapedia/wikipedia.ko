...
[추상대수학](https://ko.wikipedia.org/wiki/추상대수학 "wikilink")과 [대수적 위상수학](../Page/대수적_위상수학.md "wikilink") 및 [양자장론](https://ko.wikipedia.org/wiki/양자장론 "wikilink")에서, **거스틴해버 대수**()는 결합 법칙을 만족시키는 대수와 [리 대수의](https://ko.wikipedia.org/wiki/리_대수 "wikilink") 구조를 합친 [대수 구조의](https://ko.wikipedia.org/wiki/대수_구조 "wikilink") 하나이다.
...
이들 사이의 처음 몇 개의 항등식들은 다음과 같다.
  ...
  - (멱영성) \(d^2=0\)
  - ([곱의 법칙](https://ko.wikipedia.org/wiki/곱의_법칙_\(미적분학\) "wikilink")) \(d(ab)=(da)b+a(db)\)
...
호모토피 거스틴해버 대수는 [A<sub>∞</sub>-대수](https://ko.wikipedia.org/wiki/A∞-대수 "wikilink")(결합 대수의 호모토피화)와 호모토피 리 대수의 공통적인 일반화이다.
  ...
  - 호모토피 거스틴해버 대수의 연산들 \(m_{n_1,\dots,n_k}\) 가운데, \(k=n\)인 연산들의 완전 등급 반대칭화는 [L<sub>∞</sub>-대수의](https://ko.wikipedia.org/wiki/L∞-대수 "wikilink") 항등식들을 만족시킨다. 즉, 거스틴해버 대수는 추가 구조를 갖는 [L<sub>∞</sub>-대수이다](https://ko.wikipedia.org/wiki/L∞-대수 "wikilink").
...
결합 법칙을 따르는 [대수](../Page/대수_\(환론\).md "wikilink") \(A\)의 [호흐실트 코호몰로지](https://ko.wikipedia.org/wiki/호흐실트_코호몰로지 "wikilink") \(H^\bullet(A,A)\)는 거스틴해버 대수를 이루며, 호흐실트 공사슬들의 대수는 호모토피 거스틴해버 대수를 이룬다.\[3\] 또한, 위상 [꼭짓점 연산자 대수](https://ko.wikipedia.org/wiki/꼭짓점_연산자_대수 "wikilink") 역시 자연스럽게 호모토피 거스틴해버 대수를 이루며,\[4\] 여기에 [BRST 양자화로](https://ko.wikipedia.org/wiki/BRST_양자화 "wikilink") 물리적인 상태들로 구성된 코호몰로지를 취하면 이 위에는 거스틴해버 대수의 구조가 존재한다.\[5\]

[바탈린-빌코비스키 대수는](../Page/바탈린-빌코비스키_대수.md "wikilink") 추가 구조 (\(\Delta\) 연산자)를 갖춘 거스틴해버 대수이다.

리 대수 \(\mathfrak g\)의 [외대수](https://ko.wikipedia.org/wiki/외대수 "wikilink") \(\bigwedge^\bullet\mathfrak g\)는 자연스럽게 거스틴해버 대수의 구조를 갖는다.
