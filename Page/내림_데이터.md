...
[범주론](https://ko.wikipedia.org/wiki/범주론 "wikilink")에서, **내림 데이터**(-data, , )는 어떤 [올범주](../Page/올범주.md "wikilink")의 밑범주 속의 대상의 덮개 위에 주어진, 각 덮개 원소 위의 올범주의 대상들로 구성된 구조이다. 이를 사용하여, 일부 경우 밑범주 속의 대상의 올범주의 한 원소를 유일하게 재구성할 수 있다. 어떤 경우 이러한 재구성이 가능한지를 연구하는 수학 분야를 **내림 이론**(, )이라고 한다.
...
만약 [올범주](../Page/올범주.md "wikilink") \(\mathcal F/\mathcal C\)의 쪼갬이 주어졌다면, 쪼갬에 의하여 주어진 표준적 올림 \(u^*F_j\to F_j\)이 주어지며, 이 경우 ([데카르트 사상의](https://ko.wikipedia.org/wiki/데카르트_사상 "wikilink") [보편 성질에](../Page/보편_성질.md "wikilink") 의하여) \(\phi_u\)는 (유일하게 결정되는) [동형 사상](https://ko.wikipedia.org/wiki/동형_사상 "wikilink") \(F_i\to u^*F_j\)으로 생각해도 된다. 그러나 내림 데이터의 개념은 선택한 쪼갬에 의존하지 않는다.
