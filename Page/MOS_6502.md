...
[섬네일](https://ko.wikipedia.org/wiki/파일:MOS_6502AD_4585_top.jpg "wikilink") **MOS 6502**는 ﻿[MOS 테크놀로지사의](https://ko.wikipedia.org/wiki/MOS_테크놀로지 "wikilink") 8비트 [MPU이다](../Page/중앙_처리_장치.md "wikilink"). [모토로라](https://ko.wikipedia.org/wiki/모토로라 "wikilink")의 6809계열의 CPU로 분류되며 명칭 또한 [인텔](../Page/인텔.md "wikilink") 계열이 [CPU](../Page/중앙_처리_장치.md "wikilink")(중앙 처리 장치)라는 단어를 사용한 데 반해, [모토로라](https://ko.wikipedia.org/wiki/모토로라 "wikilink") 계열은 [MPU](../Page/중앙_처리_장치.md "wikilink")(Main Processing Unit)라는 용어를 사용한다.
