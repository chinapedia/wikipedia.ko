...
기대 컬럼이 어떤 것인지를 보여주지 않으며, 컬럼의 변화는 결과를 바꿀 것이다. 동일한 필드명을 가진 2개의 테이블에서 실행된 내부 조인 은 동일한 결과물을 가진다.\[4\] [SQL:2011](../Page/SQL:2011.md "wikilink") 표준에서, 자연 조인은 F401 (확장 조인된 테이블) 패키지의 선택적 부분이다.
