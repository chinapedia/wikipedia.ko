...
[공병우](../Page/공병우.md "wikilink") 박사가 직결식 한글을 처음 개발한 환경은 [애플](https://ko.wikipedia.org/wiki/애플_\(기업\) "wikilink") [매킨토시](../Page/매킨토시.md "wikilink")였으나 이후 여러 시스템과 워드프로세서에서 쓸 수 있도록 글꼴이 개발되었다. [세벌식 최종 자판을](https://ko.wikipedia.org/wiki/세벌식_자판#종류 "wikilink") 따르는 글꼴이 배포되어 있다.\[1\]
