...
이때, *f*<sub>s</sub>는 심볼 속도이다.
  ...
  -
    **예시**: 1 킬로 보(kBd)=1,000Bd 의 전송 속도는 초당 1,000심볼의 심볼 속도와 같다. [모뎀](https://ko.wikipedia.org/wiki/모뎀 "wikilink")의 경우 1kBd는 초당 1,000톤에 상응하며, 전송로 부호(line code)의 경우 이 속도는 초당 1,000 펄스에 상응한다. 심볼 주기는 1/1,000 초=1 밀리초(millisecond)이다.
...
## 같이 보기
  ...
  - [변조](https://ko.wikipedia.org/wiki/변조 "wikilink")
