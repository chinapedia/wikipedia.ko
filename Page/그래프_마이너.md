...
[그래프 이론에서](https://ko.wikipedia.org/wiki/그래프_이론 "wikilink"), **마이너**()는 어떤 그래프의 변들을 축약시켜 얻는 그래프이다.
...
(무향) 그래프 \(G\)의 **마이너**는 \(G\)에 다음의 연산들을 가하여 얻을 수 있는 그래프이다.
  ...
  - 변의 축약 \(G\mapsto G/uv\)
  - 변의 삭제 \(G\mapsto G-uv\)
  - 인접하는 변이 없는 [꼭짓점](https://ko.wikipedia.org/wiki/꼭짓점 "wikilink")의 삭제 \(G\mapsto G\setminus\{v\}\)

## 예

[완전 그래프](https://ko.wikipedia.org/wiki/완전_그래프 "wikilink") K<sub>5</sub>
