...
SFML은 [zlib/png 라이선스](../Page/Zlib_라이선스.md "wikilink") 조항으로 제공되는 [자유-오픈 소스 소프트웨어이다](../Page/자유-오픈_소스_소프트웨어.md "wikilink"). [윈도우](../Page/마이크로소프트_윈도우.md "wikilink"), [리눅스](../Page/리눅스.md "wikilink"), [macOS](https://ko.wikipedia.org/wiki/macOS "wikilink"), [FreeBSD](../Page/FreeBSD.md "wikilink")에서 이용할 수 있다.\[3\]\[4\]</ref> 최초 버전 1.0은 2007년 8월 9일 출시되었으며 최신 버전 v2.5.0은 2018년 5월 9일 출시되었다.
...
SFML은 다양한 모듈로 구성되어 있다:
  ...
  - 시스템 – [벡터](https://ko.wikipedia.org/wiki/벡터_\(물리\) "wikilink"), [유니코드](../Page/유니코드.md "wikilink") [문자열](https://ko.wikipedia.org/wiki/문자열 "wikilink") 클래스, 포터블 [스레드](https://ko.wikipedia.org/wiki/스레드 "wikilink") 및 타이머 기능
  - 창 – [창](../Page/창_\(컴퓨팅\).md "wikilink") 및 [입력 장치](../Page/컴퓨터_입력_장치.md "wikilink") 관리 ([조이스틱](../Page/조이스틱.md "wikilink"), [OpenGL](../Page/OpenGL.md "wikilink") 컨텍스트 관리 지원 포함)
  - 그래픽스 – [스프라이트](https://ko.wikipedia.org/wiki/스프라이트_\(컴퓨터_그래픽스\) "wikilink"), [다각형](../Page/다각형.md "wikilink"), 텍스트 렌더링을 포함한 2차원 그래픽스의 [하드웨어 가속](https://ko.wikipedia.org/wiki/하드웨어_가속 "wikilink")
  - 오디오 – 하드웨어 가속 [스페셜](https://ko.wikipedia.org/wiki/스페셜_뮤직 "wikilink") 오디오 재생 및 녹음
  - 네트워크 – TCP 및 UDP [네트워크 소켓](https://ko.wikipedia.org/wiki/네트워크_소켓 "wikilink"), 데이터 캡슐화 기능, [HTTP](../Page/HTTP.md "wikilink") 및 [파일 전송 프로토콜](../Page/파일_전송_프로토콜.md "wikilink") 클래스
...
| 이름                                                                                      | 언어                                                                                         | 지원 버전 |
| --------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------ | ----- |
| [CSFML](http://www.sfml-dev.org/download/csfml)<sup>1</sup>                             | [C](../Page/C_\(프로그래밍_언어\).md "wikilink")                                                  | 2.3   |
| [SFML.Net](http://www.sfml-dev.org/download/sfml.net)<sup>1</sup>                       | [.NET](../Page/닷넷_프레임워크.md "wikilink")                                                     | 2.2   |
| [CrSFML](https://github.com/oprypin/crsfml)                                             | [Crystal](https://crystal-lang.org)                                                        | 2.4.1 |
| [DerelictSFML2](https://github.com/DerelictOrg/DerelictSFML2)                           | [D](../Page/D_\(프로그래밍_언어\).md "wikilink")                                                  | 2.3   |
| [DSFML](https://github.com/Jebbs/DSFML)                                                 | [D](../Page/D_\(프로그래밍_언어\).md "wikilink")                                                  | 2.1   |
...
| [csfml-fpc](https://github.com/DJMaster/csfml-fpc)                                      | [프리 파스칼](../Page/프리_파스칼.md "wikilink")                                                     | 2.4.0 |
| [GoSFML2](https://bitbucket.org/krepa098/gosfml2/wiki/Home)                             | [Go](../Page/Go_\(프로그래밍_언어\).md "wikilink")                                                | 2.2   |
| [Hackage](https://hackage.haskell.org/package/SFML)                                     | [Haskell](../Page/하스켈.md "wikilink")                                                       | 2.3.2 |
| [JSFML](https://jsfml.sfmlprojects.org/)                                                | [Java](../Page/자바_\(프로그래밍_언어\).md "wikilink")                                              | 2.2   |
...
| [Ocsfml](https://github.com/JoeDralliam/Ocsfml)                                         | [OCaml](../Page/OCaml.md "wikilink")                                                       | 2.3   |
| [OCaml-SFML](http://ocaml-sfml.forge.ocamlcore.org/)                                    | [OCaml](../Page/OCaml.md "wikilink")                                                       | 2.0   |
| [PasSFML](https://github.com/CWBudde/PasSFML)                                           | [Pascal](../Page/파스칼_\(프로그래밍_언어\).md "wikilink")                                           | 2.3   |
| [pySFML](https://web.archive.org/web/20180527201512/https://python-sfml.org/)           | [Python](../Page/파이썬.md "wikilink")                                                        | 2.3.2 |
| [rbSFML](https://web.archive.org/web/20180527120743/https://groogy.se/mainsite/rbsfml/) | [Ruby](../Page/루비_\(프로그래밍_언어\).md "wikilink")                                              | 2.3.2 |
