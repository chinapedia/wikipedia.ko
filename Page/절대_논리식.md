...
[모형 이론에서](https://ko.wikipedia.org/wiki/모형_이론 "wikilink"), **절대 논리식**(絶對論理式, )은 모든 [모형에서](https://ko.wikipedia.org/wiki/모형_\(논리학\) "wikilink") 참인 [논리식](https://ko.wikipedia.org/wiki/논리식 "wikilink")이다.

## 정의

### 절대 문장

[1차 논리](https://ko.wikipedia.org/wiki/1차_논리 "wikilink") 언어 \(\mathcal L\)의 [논리식](https://ko.wikipedia.org/wiki/논리식 "wikilink") \(\phi(x_1,\dots,x_n)\in\operatorname{wff}(\mathcal L)\)가 \(n\)개의 자유 변수 \(x_1,\dots,x_n\)를 갖는다고 하자. 또한, \(\mathcal L\)-[구조들의](../Page/구조_\(논리학\).md "wikilink") 모임 \(\mathcal M\)이 주어졌다고 하자. (예를 들어, \(\mathcal M\)은 어떤 \(\mathcal L\)의 문장들의 집합 \(\mathcal T\subseteq\operatorname{Sent}(\mathcal L)\)이 성립하는 \(\mathcal L\)-구조들의 모임일 수 있다.)
...
다음과 같은 논리식들은 추이적 절대 논리식이다.
  ...
  - \(x=\varnothing\)
  - \(x\)는 (폰 노이만 정의) [순서수](https://ko.wikipedia.org/wiki/순서수 "wikilink")이다.
  - \(x\)는 유한 [순서수](https://ko.wikipedia.org/wiki/순서수 "wikilink")이다.
  - \(x=\omega\)
  - \(x\)는 [함수의 그래프이다](https://ko.wikipedia.org/wiki/함수의_그래프 "wikilink").
...
[체르멜로-프렝켈 집합론](https://ko.wikipedia.org/wiki/체르멜로-프렝켈_집합론 "wikilink")(\(\mathsf{ZF}\))의 모형 \(M\)이 주어졌을 때, 그 속의 [자연수](https://ko.wikipedia.org/wiki/자연수 "wikilink") 집합 \(\mathbb N^M\)은 [페아노 공리계의](https://ko.wikipedia.org/wiki/페아노_공리계 "wikilink") 모형을 이룬다. [체르멜로-프렝켈 집합론](https://ko.wikipedia.org/wiki/체르멜로-프렝켈_집합론 "wikilink")(\(\mathsf{ZF}\))의 [표준 추이적 모형](https://ko.wikipedia.org/wiki/표준_추이적_모형 "wikilink") \(M\)과, 그 속의 [구성 가능 전체](../Page/구성_가능_전체.md "wikilink") \(L^M\subseteq M\)를 생각하자. 그렇다면, \(L^M\)을 포함하는, \(M\)의 부분 구조 가운데 \(\mathsf{ZF}\)의 모형인 것들의 집합
...
**숀필드 절대성 정리**()에 따르면, [페아노 공리계의](https://ko.wikipedia.org/wiki/페아노_공리계 "wikilink") 언어의 \(\Pi_2^1\) 문장과 \(\Sigma^1_2\) 문장들은 \(\mathcal N\)에 대하여 절대 문장이다.
