...
단조 수렴 정리를 [자연수](../Page/자연수.md "wikilink")의 집합 \(\mathbb N\) 위의 [셈측도 공간](https://ko.wikipedia.org/wiki/셈측도_공간 "wikilink") \((\mathbb N,\mathcal P(\mathbb N),|\cdot|)\)에 적용하면 [무한 급수에](https://ko.wikipedia.org/wiki/무한_급수 "wikilink") 대한 [푸비니 정리를](https://ko.wikipedia.org/wiki/푸비니_정리 "wikilink") 얻으며, 이는 다음과 같다. 임의의 음이 아닌 [확장된 실수들의](../Page/확장된_실수.md "wikilink") 무한차 행렬 \((a_{mn})_{m,n\in\mathbb N}\subseteq[0,\infty]\)에 대하여, 다음이 성립한다.\[2\]
