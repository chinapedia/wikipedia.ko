...
[실해석학](https://ko.wikipedia.org/wiki/실해석학 "wikilink")에서, **단조 수렴 정리**(單調收斂定理, )는 [가측 함수의](../Page/가측_함수.md "wikilink") 증가 함수열의 [르베그 적분과](https://ko.wikipedia.org/wiki/르베그_적분 "wikilink") 점별 극한의 순서를 교환할 수 있다는 정리이다.
...
\[\int_Xsd\mu\le\int_Xf_nd\mu\] 를 얻는다. [르베그 적분의](https://ko.wikipedia.org/wiki/르베그_적분 "wikilink") 정의에 따라,
...
단조 수렴 정리를 [자연수](https://ko.wikipedia.org/wiki/자연수 "wikilink")의 집합 \(\mathbb N\) 위의 [셈측도 공간](https://ko.wikipedia.org/wiki/셈측도_공간 "wikilink") \((\mathbb N,\mathcal P(\mathbb N),|\cdot|)\)에 적용하면 [무한 급수에](https://ko.wikipedia.org/wiki/무한_급수 "wikilink") 대한 [푸비니 정리를](https://ko.wikipedia.org/wiki/푸비니_정리 "wikilink") 얻으며, 이는 다음과 같다. 임의의 음이 아닌 [확장된 실수들의](../Page/확장된_실수.md "wikilink") 무한차 행렬 \((a_{mn})_{m,n\in\mathbb N}\subseteq[0,\infty]\)에 대하여, 다음이 성립한다.\[2\]
...
## 같이 보기
  ...
  - [파투 보조정리](https://ko.wikipedia.org/wiki/파투_보조정리 "wikilink")
  - [지배 수렴 정리](https://ko.wikipedia.org/wiki/지배_수렴_정리 "wikilink")
