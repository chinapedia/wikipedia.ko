...
현재도 대다수가 사용중에 있으며, 전 세계에서 100만 시간 이상을 비행했다.
...
</ref> --\> |crew=2 |capacity= |length main= 10.13 m |length alt= 33 ft 3 in |span main= 10.12 m |span alt= 33 ft 2 in |height main= 3.30 m |height alt= 10 ft 10 in |area main= 16.3 m² |area alt= 175 ft² |airfoil= |empty weight main= 1,670 kg |empty weight alt= 3,680 lb |loaded weight main= |loaded weight alt= |useful load main= |useful load alt= |max takeoff weight main= 2,700 kg |max takeoff weight alt= 5,940 lb |more general=

|engine (prop)=[Pratt & Whitney Canada PT6A](https://ko.wikipedia.org/wiki/Pratt_&_Whitney_Canada_PT6A "wikilink")-25C |type of prop= [turboprop](https://ko.wikipedia.org/wiki/turboprop "wikilink") |number of props=1 |power main= 522 kW |power alt= 700 shp |power original=

|max speed main= 460 km/h |max speed alt= 250 kt, 290 mph |cruise speed main= |cruise speed alt= 180kt |never exceed speed main= |never exceed speed alt= 270kt |stall speed main= |stall speed alt= 65kt |range main= 1,950 km |range alt= 1,050 nm, 1,210 mi |ceiling main= 9,150 m |ceiling alt= 25,000 ft |climb rate main= 865 m/min |climb rate alt= 2,840 ft/min |loading main= |loading alt= |thrust/weight= |power/mass main= |power/mass alt= |more performance= |armament=
...
### 경쟁기종
  ...
  - [KT-1](https://ko.wikipedia.org/wiki/KT-1 "wikilink") - 대한민국 웅비
