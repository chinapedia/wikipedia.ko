...
[해석학에서](https://ko.wikipedia.org/wiki/해석학_\(수학\) "wikilink"), **이항 급수**(二項級數, )는 [이항 계수를](https://ko.wikipedia.org/wiki/이항_계수 "wikilink") 계수로 하는 [멱급수](https://ko.wikipedia.org/wiki/멱급수 "wikilink")이다. [이항식](https://ko.wikipedia.org/wiki/이항식 "wikilink")의 [거듭제곱](https://ko.wikipedia.org/wiki/거듭제곱 "wikilink")의 [매클로린 급수이다](https://ko.wikipedia.org/wiki/매클로린_급수 "wikilink"). [이항 정리의](https://ko.wikipedia.org/wiki/이항_정리 "wikilink") 일반화이다.

## 정의

[복소수](https://ko.wikipedia.org/wiki/복소수 "wikilink") \(\alpha\in\mathbb C\)가 주어졌을 때, **이항 급수**는 \((1+x)^\alpha\)의 [매클로린 급수이다](https://ko.wikipedia.org/wiki/매클로린_급수 "wikilink"). 이는 다음과 같다.

\[(1+x)^\alpha=\sum_{k=0}^\infty\binom\alpha kx^k=\sum_{k=0}^\infty\frac{(\alpha)_k}{k!}x^k=1+\alpha x+\frac{\alpha(\alpha-1)}2x^2+\frac{\alpha(\alpha-1)(\alpha-2)}6x^3+\cdots\] 여기서 \(\textstyle\binom\alpha k\)는 [이항 계수](https://ko.wikipedia.org/wiki/이항_계수 "wikilink"), \((\alpha)_k\)는 [하강 계승](https://ko.wikipedia.org/wiki/하강_계승 "wikilink"), \(k!\)는 [계승](https://ko.wikipedia.org/wiki/계승 "wikilink")이다.
...
이항 급수의 \(\alpha\in\{0,1,2,\dots\}\)의 경우를 [이항 정리라고](https://ko.wikipedia.org/wiki/이항_정리 "wikilink") 하며, 다음과 같다.
