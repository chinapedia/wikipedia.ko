...
[대수적 위상수학에서](../Page/대수적_위상수학.md "wikilink"), **류스테르니크-시니렐만 범주**(Люстерник-Шнирельман範疇, ) 또는 **LS 범주**()는 [자연수](https://ko.wikipedia.org/wiki/자연수 "wikilink") 값으로 된 위상 공간의 호모토피 불변량이다.\[1\]\[2\] 구체적으로는 주어진 위상 공간 위에 존재할 수 있는, 그 속에서 축약 가능인 집합들로 구성된 [열린 덮개의](https://ko.wikipedia.org/wiki/열린_덮개 "wikilink") 최소의 개수를 나타낸다. 거칠게 말하면 공간이 얼마나 복잡한지를 나타내는 척도 중 하나라고 할 수 있다.

## 정의

류스테르니크-시니렐만 범주의 개념은 여러 가지로 정의될 수 있으며, 이 정의들은 ([CW 복합체와](https://ko.wikipedia.org/wiki/CW_복합체 "wikilink") [호모토피 동치인](https://ko.wikipedia.org/wiki/호모토피_동치 "wikilink") 위상 공간에 대하여) 서로 [동치](https://ko.wikipedia.org/wiki/동치 "wikilink")이다.

### 열린 덮개를 통한 정의

[점을 가진 공간](../Page/점을_가진_공간.md "wikilink") \((X,\bullet_X)\)가 주어졌으며, \(X\)가 [CW 복합체와](https://ko.wikipedia.org/wiki/CW_복합체 "wikilink") [호모토피 동치이며](https://ko.wikipedia.org/wiki/호모토피_동치 "wikilink"), \(\bullet_X \hookrightarrow X\)가 [쌍대올뭉치](https://ko.wikipedia.org/wiki/쌍대올뭉치 "wikilink")라고 하자.

\((X,\bullet)\)의 **류스테르니크-시니렐만 범주** \(\operatorname{cat}(X)\)를 다음 조건을 만족시키는 최소의 [자연수](https://ko.wikipedia.org/wiki/자연수 "wikilink") \(\kappa\)로 정의한다.

  - 어떤 점을 가진 [열린 덮개](https://ko.wikipedia.org/wiki/열린_덮개 "wikilink") \((U_i,\bullet_X)_{0\le i\le \kappa}\)에 대하여, 모든 포함 함수 \(U_i\hookrightarrow X\)가 [상수 함수와](https://ko.wikipedia.org/wiki/상수_함수 "wikilink") [호모토피 동치하다](https://ko.wikipedia.org/wiki/호모토피_동치 "wikilink").
...
[영 대상](https://ko.wikipedia.org/wiki/영_대상 "wikilink")([시작 대상이자](https://ko.wikipedia.org/wiki/시작_대상 "wikilink") [끝 대상인](https://ko.wikipedia.org/wiki/끝_대상 "wikilink") 대상)을 갖는 [모형 범주](../Page/모형_범주.md "wikilink") \(\mathcal C\)가 주어졌다고 하자. 이 [모형 범주에서](../Page/모형_범주.md "wikilink"), 다음과 같은 성질을 생각할 수 있다.
  ...
  -
    **육면체 공리**(): 임의의 [정육면체](https://ko.wikipedia.org/wiki/정육면체 "wikilink") 꼴의 호모토피 가환 그림
      -
...
\[T_2 \simeq X\vee X\] (스스로와의 [쌍대곱](https://ko.wikipedia.org/wiki/쌍대곱 "wikilink"))
...
\((X,\bullet)\)의 **류스테르니크-시니렐만 범주**는 다음 그림을 호모토피 가환 그림으로 만드는 [연속 함수](https://ko.wikipedia.org/wiki/연속_함수 "wikilink") \(f \colon X\to T_n\)가 존재하는 최소의 자연수 \(n\)이다.
...
\[\pi_n \colon G_n \to X\] 이 [호모토피 범주에서](../Page/호모토피_범주.md "wikilink") [오른쪽 역사상](https://ko.wikipedia.org/wiki/오른쪽_역사상 "wikilink")(즉, 단면) \(X\to G_n\)을 가질 수 있는 최소의 [자연수](https://ko.wikipedia.org/wiki/자연수 "wikilink") \(n\)이다.
...
\[F_n = (\Omega X)^{\star n}\] 으로 잡을 수 있다.\[3\] (여기서 \(\star\)는 두 위상 공간의 [이음이다](https://ko.wikipedia.org/wiki/이음_\(위상수학\) "wikilink").) 또한, 이 경우

\[G_1 = \Sigma \Omega X\] 로 잡을 수 있다. 여기서 \(\Sigma\)는 [축소 현수이다](https://ko.wikipedia.org/wiki/축소_현수 "wikilink").

### 정의 사이의 관계

영대상을 가지며 육면체 공리를 따르는 모형 범주가 주어질 경우, [올대상](../Page/올대상.md "wikilink")이자 [쌍대올대상](https://ko.wikipedia.org/wiki/쌍대올대상 "wikilink")인 대상에 대하여 류스테르니크-시니렐만 범주의 화이트헤드 정의와 가네아 정의는 서로 일치한다.\[4\] 또한 그 범주가 \(\operatorname{Top}\backslash\bullet\)일 경우, [CW 복합체와](https://ko.wikipedia.org/wiki/CW_복합체 "wikilink") [호모토피 동치인](https://ko.wikipedia.org/wiki/호모토피_동치 "wikilink") 위상 공간에 대하여 [열린 덮개를](https://ko.wikipedia.org/wiki/열린_덮개 "wikilink") 통한 정의와 일치한다.

## 성질

류스테르니크-시니렐만 범주는 [호모토피 불변량이다](https://ko.wikipedia.org/wiki/호모토피_불변량 "wikilink"). 즉, 서로 [호모토피 동치인](https://ko.wikipedia.org/wiki/호모토피_동치 "wikilink") 두 위상 공간은 같은 류스테르니크-시니렐만 범주를 갖는다.
...
\[\operatorname{cat}(X) \le \frac {\dim X}k\] 여기서 \(\dim X\)는 \(X\)의 [르베그 덮개 차원이다](https://ko.wikipedia.org/wiki/르베그_덮개_차원 "wikilink"). ([다양체](https://ko.wikipedia.org/wiki/다양체 "wikilink")의 경우 이는 물론 다양체 차원과 일치한다.)

### 모스 이론과의 관계

[연결](https://ko.wikipedia.org/wiki/연결_공간 "wikilink") [콤팩트](https://ko.wikipedia.org/wiki/콤팩트_공간 "wikilink") [매끄러운 다양체](https://ko.wikipedia.org/wiki/매끄러운_다양체 "wikilink") \(M\) 위의 [연속 미분 가능 함수](https://ko.wikipedia.org/wiki/연속_미분_가능_함수 "wikilink") \(f\colon M\to\mathbb R\)의 [임계점](https://ko.wikipedia.org/wiki/임계점 "wikilink")의 집합

\[\operatorname{Crit}(f) = \{x\in M \colon \mathrm df = 0 \}\] 의 [크기](https://ko.wikipedia.org/wiki/집합의_크기 "wikilink") − 1은 류스테르니크-시니렐만 범주의 [상계를](https://ko.wikipedia.org/wiki/상계_\(수학\) "wikilink") 이룬다.\[10\]
...
\(M\)에 임의의 [리만 다양체](https://ko.wikipedia.org/wiki/리만_다양체 "wikilink") 구조를 주고, \(f\)의 기울기 흐름

\[\frac{\mathrm d}{\mathrm dt}\phi_t (x) = \mathrm d^\# f|_{\phi_t(x)}\] 을 생각하자. 그렇다면, 각 임계점 \(c\in\operatorname{Crit}f\)에 대하여

\[W_c = \left\{x\in M \colon \lim_{t\to\infty}\phi_t(x) = c\right\}\] 를 정의하자. \(M\)이 콤팩트 공간이며 임계점들이 유한 개 밖에 없기 때문에, 이들은 \(M\)의 [덮개를](https://ko.wikipedia.org/wiki/덮개_\(위상수학\) "wikilink") 정의한다. 그 원소들은 [닫힌집합](https://ko.wikipedia.org/wiki/닫힌집합 "wikilink")이며, 또한 기울기 흐름의 존재에 의하여 \(W_ c\hookrightarrow M\)은 모두 [상수 함수](https://ko.wikipedia.org/wiki/상수_함수 "wikilink") \(W_c \to \{c\} \subseteq M\)와 [호모토피 동치이다](https://ko.wikipedia.org/wiki/호모토피_동치 "wikilink").
...
예를 들어, 초구 \(\mathbb S^n\)을 [유클리드 공간](https://ko.wikipedia.org/wiki/유클리드_공간 "wikilink") \(\mathbb R^{n+1}\) 위의 단위구로 놓았을 때, 높이 함수는 두 개의 임계점(북극과 남극)을 갖는다. 초구의 류스테르니크-시니렐만 범주는 1이므로, 등호가 성립한다.
...
\[\operatorname{cdgAlg}_{\mathbb Q}/\mathbb Q\] 는 [영 대상을](https://ko.wikipedia.org/wiki/영_대상 "wikilink") 가지는 [모형 범주이며](../Page/모형_범주.md "wikilink"), 육면체 공리를 따른다. 따라서, 이 범주 위에서 류스테르니크-시니렐만 범주를 정의할 수 있다. ([CW-복합체](https://ko.wikipedia.org/wiki/CW-복합체 "wikilink")와 [호모토피 동치이며](https://ko.wikipedia.org/wiki/호모토피_동치 "wikilink"), 점 포함 사상이 [쌍대올뭉치](https://ko.wikipedia.org/wiki/쌍대올뭉치 "wikilink")인) [점을 가진 공간](../Page/점을_가진_공간.md "wikilink") \(\{\bullet\}\hookrightarrow X\)에 대하여, 이에 대응되는 [가환 미분 등급 대수](https://ko.wikipedia.org/wiki/가환_미분_등급_대수 "wikilink") \(A\to\mathbb Q\)의 류스테르니크-시니렐만 범주를
...
\[\operatorname{cat}_0(X) \le \operatorname{cat}(X)\] 또한, 만약 \(X\)와 \(Y\)가 [단일 연결 공간이며](https://ko.wikipedia.org/wiki/단일_연결_공간 "wikilink"), 그 [최소 설리번 대수들이](https://ko.wikipedia.org/wiki/최소_설리번_대수 "wikilink") 등급별 유한 차원이라고 하자. 그렇다면, 다음이 성립한다.\[14\]
...
| [초구](https://ko.wikipedia.org/wiki/초구 "wikilink")\[16\] \(\mathbb S^n\), \(n\ge1\)                                                    | 1               |
| [축약 불가능한](../Page/축약_가능_공간.md "wikilink") [현수](../Page/현수_\(위상수학\).md "wikilink") \(\Sigma X\)\[17\]                                  | 1               |
| [원환면](https://ko.wikipedia.org/wiki/원환면 "wikilink")\[18\] \(\mathbb T^n\)                                                             | \(n\)           |
...
| 콤팩트 [단일 연결](https://ko.wikipedia.org/wiki/단일_연결 "wikilink") [심플렉틱 다양체](https://ko.wikipedia.org/wiki/심플렉틱_다양체 "wikilink") \(M\)\[21\] | \((\dim M)/2\)  |
| \(\mathbb S^2 \times \mathbb T^2\)\[22\]                                                                                              | 3               |

<div class="mw-collapsible mw-collapsed toccolours">

**콤팩트 [단일 연결](https://ko.wikipedia.org/wiki/단일_연결 "wikilink") [심플렉틱 다양체](https://ko.wikipedia.org/wiki/심플렉틱_다양체 "wikilink") \((M,\omega)\)에 대하여 \(\operatorname{cat}M = (\dim M)/2\)의 증명:**\[23\]

<div class="mw-collapsible-content">

[심플렉틱 형식](https://ko.wikipedia.org/wiki/심플렉틱_형식 "wikilink") \(\omega\in\Omega^2(M)\)의 [드람 코호몰로지류](https://ko.wikipedia.org/wiki/드람_코호몰로지 "wikilink")
...
\[\frac{\dim M}2\le\operatorname{cat}M\] 이다. 반면, \(M\)이 [단일 연결 공간이므로](https://ko.wikipedia.org/wiki/단일_연결_공간 "wikilink") \(\operatorname{cat}M \le (\dim M)/2\)이다.
...
[라자리 류스테르니크와](https://ko.wikipedia.org/wiki/라자리_류스테르니크 "wikilink") [레프 시니렐만이](https://ko.wikipedia.org/wiki/레프_시니렐만 "wikilink") 도입하였다.\[24\]\[25\] 두 명의 공동 논문은 시니렐만의 사후인 1947년에 처음 출판되었다. 그들은 위상 공간의 LS 범주와 그 공간 위의 연속 함수의 [임계점](https://ko.wikipedia.org/wiki/임계점 "wikilink")의 수의 관계를 밝힘으로써 [위상수학](https://ko.wikipedia.org/wiki/위상수학 "wikilink")과 [미분기하학](https://ko.wikipedia.org/wiki/미분기하학 "wikilink") 사이에 관계가 있음을 알아냈다. 그들은 공간의 성질을 나타내는 이 불변량에 ‘범주’(, )라는 이름을 붙였는데, 이는 [범주론](https://ko.wikipedia.org/wiki/범주론 "wikilink")의 범주와는 관련이 없고 당시는 아직 범주론이 정립되기 전이었다.
