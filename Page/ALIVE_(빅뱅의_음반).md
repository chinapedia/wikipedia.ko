...
이 음반은 5 가지 버전: 2 CD+2DVD+포토북(E 타입에는 굿즈와 DVD Disc 2에 독점 비디오가 실렸다.)으로 구성 되어 발매 되었다.\[4\] 이 버전은 2 CD+DVD (타입 B에는 DVD Disc 2와 타입 C에는 DVD Disc 3)와 레귤러 에디션으로 [HMV 재팬에서](https://ko.wikipedia.org/wiki/HMV_그룹 "wikilink") 판매가 되었다.\[5\]

## ALIVE -MONSTER EDITION-

*ALIVE*의 리패키지 음반으로 "*Alive -Monster Edition-*"라는 이름으로 2012년 6월 20일 YGEX를 통해 3가지 버전으로 CD+DVD+T-Shirt,\[6\] CD+DVD\[7\]와 CD만으로 구성 되어 발매 되었다.\[8\]\[9\]
...
이 음반에는 오리지널 일본 곡인 "Ego"와 "Feeling" 외에도 일본어 버전으로 새롭게 녹음한 "Blue", "Fantastic Baby", "Bad Boy"와 "Haru Haru(하루하루)", 이전에 한국어로 발표 된 곡, "Intro (Alive)", "Love Dust(사랑먼지)", "Ain't No Fun(재미없어)"와 [대성의](https://ko.wikipedia.org/wiki/대성_\(가수\) "wikilink") 솔로 곡 "Wings(날개)"가 수록 되었다. 또한 일본어 버전의 "Haru Haru(하루하루)"는 이전의 베스트 앨범인 *[The Best Of BIGBANG](https://ko.wikipedia.org/wiki/The_Best_Of_BIGBANG "wikilink")*에 수록 되었다. 또한 "Feeling"은 [독일](https://ko.wikipedia.org/wiki/독일 "wikilink") [EDM과](https://ko.wikipedia.org/wiki/전자_댄스_음악 "wikilink") [일렉트로 하우스](https://ko.wikipedia.org/wiki/일렉트로_하우스 "wikilink") [프로듀서](https://ko.wikipedia.org/wiki/프로듀서 "wikilink")의 [DJ](https://ko.wikipedia.org/wiki/DJ "wikilink") [보이즈 노이즈가](https://ko.wikipedia.org/wiki/보이즈_노이즈 "wikilink") 편곡에 참여했다.
...
빅뱅은 일본어 버전의 곡 "Fantastic Baby"를 2012년 3월 30일에 [NTV](https://ko.wikipedia.org/wiki/NTV "wikilink") 음악 프로그램 《Happy Music》, 4월 1일에 [NHK](https://ko.wikipedia.org/wiki/NHK "wikilink") 음악 프로그램 《Music Japan》와 [NTV](https://ko.wikipedia.org/wiki/NTV "wikilink") 음악 프로그램 《Music Lovers》에 출연하였다.
...
| 발매                                             | 차트    | 최고 순위   | 첫주 판매량 | 판매량 합계 | 차트 롱런 |
| ---------------------------------------------- | ----- | ------- | ------ | ------ | ----- |
| 2012년 3월 28일                                   | 일간 차트 | 2       | 23,430 | 98,546 | 12주   |
| 주간 차트                                          | 3     | 52,987  |        |        |       |
| 월간 차트                                          | 7     | 66,043  |        |        |       |
| 연간 차트 <small>(ALIVE + MONSTER EDITION)</small> | 31    | 187,865 |        |        |       |

| 발매                             | 차트    | 최고 순위  | 첫주 판매량 | 판매량 합계 | 차트 롱런 |
| ------------------------------ | ----- | ------ | ------ | ------ | ----- |
| 2012년 6월 20일 (MONSTER EDITION) | 일간 차트 | 2      | 16,101 | 92,315 | 28주   |
| 주간 차트                          | 3     | 38,861 |        |        |       |
| 월간 차트                          | 11    | 54,160 |        |        |       |
...
| 차트                                                                    | 기록            |
| --------------------------------------------------------------------- | ------------- |
| *[RIAJ](https://ko.wikipedia.org/wiki/일본_레코드_협회 "wikilink")* 인증\[10\] | 골드 (100,000+) |
| 합계                                                                    | 214,614       |
...
[분류:2012년 음반](https://ko.wikipedia.org/wiki/분류:2012년_음반 "wikilink") [분류:빅뱅의 음반](https://ko.wikipedia.org/wiki/분류:빅뱅의_음반 "wikilink") [분류:일본어 음반](https://ko.wikipedia.org/wiki/분류:일본어_음반 "wikilink") [분류:YG 엔터테인먼트 음반](https://ko.wikipedia.org/wiki/분류:YG_엔터테인먼트_음반 "wikilink")
