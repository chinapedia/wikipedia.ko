...
**교차 출처 리소스 공유**(Cross-origin resource sharing, CORS), **교차 출처 자원 공유**는 [웹 페이지](https://ko.wikipedia.org/wiki/웹_페이지 "wikilink") 상의 제한된 [리소스를](https://ko.wikipedia.org/wiki/웹_리소스 "wikilink") 최초 자원이 서비스된 도메인 밖의 다른 [도메인으로부터](https://ko.wikipedia.org/wiki/도메인_네임 "wikilink") 요청할 수 있게 허용하는 구조이다.\[1\] 웹페이지는 교차 출처 이미지, [스타일시트](https://ko.wikipedia.org/wiki/스타일시트 "wikilink"), 스크립트, [iframe](https://ko.wikipedia.org/wiki/HTML_요소 "wikilink"), 동영상을 자유로이 임베드할 수 있다.\[2\] 특정한 도메인 간(cross-domain) 요청, 특히 [Ajax](https://ko.wikipedia.org/wiki/Ajax "wikilink") 요청은 [동일-출처 보안 정책에](../Page/동일-출처_정책.md "wikilink") 의해 기본적으로 금지된다.
