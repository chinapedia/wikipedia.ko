...
[이론물리학](https://ko.wikipedia.org/wiki/이론물리학 "wikilink")과 [수학](../Page/수학.md "wikilink")에서, **베스-추미노-위튼 모형**(), 혹은 **베스-추미노-노비코프-위튼 모형**()은 간단한 [2차원 등각 장론의](../Page/2차원_등각_장론.md "wikilink") 하나이다. 이는 비선형 [시그마 모형의](../Page/시그마_모형.md "wikilink") 일종이며, 그 과녁 공간(target space)은 (반)단순 [리 군이다](../Page/리_군.md "wikilink").
