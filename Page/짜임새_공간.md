...
\[\operatorname{Conf}^nX=X^n/\operatorname{Sym}(n)\] 여기서 \(\operatorname{Sym}(n)\)은 \(n\)개의 원소 위의 [대칭군이며](https://ko.wikipedia.org/wiki/대칭군_\(군론\) "wikilink"), [몫공간](../Page/몫공간.md "wikilink")은 \(\operatorname{Sym}(n)\)의 \(X^n\) 위의 표준적인 [작용](../Page/군의_작용.md "wikilink") (각 성분들의 [순열](https://ko.wikipedia.org/wiki/순열 "wikilink"))에 대한 몫공간이다. 만약 \(X\)가 [다양체](https://ko.wikipedia.org/wiki/다양체 "wikilink")라면, 그 위의 짜임새 공간은 [오비폴드](../Page/오비폴드.md "wikilink")를 이룬다.
...
\[\operatorname{Conf}^0X\hookrightarrow \operatorname{Conf}^1X\hookrightarrow\operatorname{Conf}^2X\hookrightarrow\operatorname{Conf}^3X\hookrightarrow\cdots\] 이 존재한다. 이들의 [귀납적 극한을](https://ko.wikipedia.org/wiki/귀납적_극한 "wikilink") **무한 짜임새 공간**()

\[\operatorname{Conf}^\infty X=\varinjlim_{n\to\infty}\operatorname{Conf}^nX\] 이라고 한다.

## 성질

**돌트-톰 정리**()에 따르면, [점을 가진](../Page/점을_가진_공간.md "wikilink") [연결](../Page/연결_공간.md "wikilink") [CW 복합체](../Page/CW_복합체.md "wikilink") \(X\)의 무한 짜임새 공간 \(\operatorname{Conf}^\infty X\)의 \(i\)차 [호모토피 군](../Page/호모토피_군.md "wikilink") \(\pi_i(\operatorname{Conf}^\infty X)\)은 \(X\)의 \(i\)번째 [축소](https://ko.wikipedia.org/wiki/축소_호몰로지 "wikilink") [특이 호몰로지](https://ko.wikipedia.org/wiki/특이_호몰로지 "wikilink") \(\operatorname{\tilde H}_i(X;\mathbb Z)\)와 동형이다.

\[\pi_i(\operatorname{Conf}^\infty X)\cong \operatorname{\tilde H}_i(X;\mathbb Z)\] 특히, 무한 짜임새 공간의 [기본군](../Page/기본군.md "wikilink")은 항상 [아벨 군이다](https://ko.wikipedia.org/wiki/아벨_군 "wikilink").
...
[섬네일](https://ko.wikipedia.org/wiki/파일:Standardsimplex.svg "wikilink") \(\triangle^3\). 이는 [닫힌구간](https://ko.wikipedia.org/wiki/닫힌구간 "wikilink") \([0,1]\) 위의 3차 짜임새 공간 \(\operatorname{Conf}^3[0,1]\)이다.\]\] [전순서 집합](https://ko.wikipedia.org/wiki/전순서_집합 "wikilink") \((L,\le)\) 위에 [순서 위상을](https://ko.wikipedia.org/wiki/순서_위상 "wikilink") 주자. 그렇다면, \(L\) 위의 \(n\)차 짜임새 공간 \(\operatorname{Conf}^nL\)은 [곱공간](https://ko.wikipedia.org/wiki/곱공간 "wikilink") \(L^n\)의 [부분 공간](https://ko.wikipedia.org/wiki/부분_공간 "wikilink")
...
[유클리드 평면을](https://ko.wikipedia.org/wiki/유클리드_평면 "wikilink") [복소평면](../Page/복소평면.md "wikilink") \(\mathbb C\)로 생각하자. [대수학의 기본 정리에](https://ko.wikipedia.org/wiki/대수학의_기본_정리 "wikilink") 따라, 복소수 계수 \(n\)차 [다항식](https://ko.wikipedia.org/wiki/다항식 "wikilink")
...
\[p(z)=(z-z_1)(z-z_2)\cdots(z-z_n)\] 을 재구성할 수 있다. 따라서, \(\operatorname{Conf}^n\mathbb C\)는 \(n\)차 복소수 [일계수 다항식들의](https://ko.wikipedia.org/wiki/일계수_다항식 "wikilink") [모듈라이 공간](../Page/모듈라이_공간.md "wikilink")

\[\mathbb C^n\] 과 [위상 동형이다](https://ko.wikipedia.org/wiki/위상_동형 "wikilink"). 특히 이는 [매끄러운 다양체로](https://ko.wikipedia.org/wiki/매끄러운_다양체 "wikilink") 나타낼 수 있다.
...
[구](https://ko.wikipedia.org/wiki/구_\(기하학\) "wikilink") \(\mathbb S^2\) 위의 \(n\)개의 입자의 짜임새 공간 \(\operatorname{Conf}^n\mathbb S^2\)를 생각하자. [구를](https://ko.wikipedia.org/wiki/구_\(기하학\) "wikilink") [리만 구](https://ko.wikipedia.org/wiki/리만_구 "wikilink") \(\mathbb{CP}^1=\mathbb C\sqcup\{\widehat\infty\}\)로 여길 수 있다.
...
\[\mathbb S^1=\mathbb R/\mathbb Z\] 에 임의의 [방향을](https://ko.wikipedia.org/wiki/방향_\(다양체\) "wikilink") 주자. 이제, \(n\)개의 점 가운데 임의의 한 점 \(x_0\in\mathbb S^1\)을 고르고, 나머지 점들을 반시계 방향으로
...
\[\operatorname{Conf}^3(\mathbb S^1)\] 은 [정삼각형](https://ko.wikipedia.org/wiki/정삼각형 "wikilink") 기둥에서, 윗면과 아랫면을 60도 뒤틀어 붙여 얻는 [오비폴드](../Page/오비폴드.md "wikilink")이다. 이는 (원과 동형인) 하나의 1차원 경계 및 ([뫼비우스 띠와](https://ko.wikipedia.org/wiki/뫼비우스_띠 "wikilink") 동형인) 하나의 2차원 경계를 갖는데, 이는 각각 3개의 점이 일치하는 부분 공간과 2개의 점이 일치하는 부분 공간에 해당한다.

## 역사

돌트-톰 정리는 [알브레히트 돌트와](../Page/알브레히트_돌트.md "wikilink") [르네 톰이](https://ko.wikipedia.org/wiki/르네_톰 "wikilink") 1958년에 증명하였다.\[2\]

## 같이 보기

  - [라그랑주 역학](../Page/라그랑주_역학.md "wikilink")
  - [위상 공간 (물리학)](../Page/위상_공간_\(물리학\).md "wikilink")
  - [힐베르트 스킴](https://ko.wikipedia.org/wiki/힐베르트_스킴 "wikilink")
