...
<timeline> ImageSize = width:800 height:auto barincrement:25 PlotArea = left:115 bottom:110 top:20 right:10 Alignbars = justify DateFormat= dd/mm/yyyy Period = from:01/01/1984 till:30/06/1992 TimeAxis = orientation:horizontal format:yyyy Legend = orientation:vertical position:bottom columns:4 ScaleMajor= increment:1 start:1984 ScaleMinor= increment:2 start:1984
...
## 외부 링크
  ...
  -
[암스트래드_CPC](https://ko.wikipedia.org/wiki/분류:암스트래드_CPC "wikilink") [분류:암스트래드](https://ko.wikipedia.org/wiki/분류:암스트래드 "wikilink") [분류:Z80 기반 가정용 컴퓨터](https://ko.wikipedia.org/wiki/분류:Z80_기반_가정용_컴퓨터 "wikilink")
