...
`           return ("`<strong class='error'>`from과 to는 nil 또는 서로 같을 수 없습니다.`</strong>`")`
`       else`
...
<div name='line' style='clear:both;width:100%;max-width:100%;border-top:0.1em solid black;height:1em;'>
