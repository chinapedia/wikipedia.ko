...
수학에서, **세타 표현**(θ表現, )은 [하이젠베르크 군의](../Page/하이젠베르크_군.md "wikilink"), [정칙 함수의](https://ko.wikipedia.org/wiki/정칙_함수 "wikilink") 공간 위의 특별한 [표현이다](https://ko.wikipedia.org/wiki/군의_표현 "wikilink"). 이 표현에서, 정수 계수 하이젠베르크 군의 [작용의](https://ko.wikipedia.org/wiki/군의_작용 "wikilink") [고정점](../Page/고정점.md "wikilink")은 [야코비 세타 함수이다](https://ko.wikipedia.org/wiki/야코비_세타_함수 "wikilink").\[1\]

## 정의

임의의 양의 실수 \(t \in \mathbb R^+\)에 대하여, [복소평면](https://ko.wikipedia.org/wiki/복소평면 "wikilink") 위에, 다음과 같은 [측도](https://ko.wikipedia.org/wiki/측도 "wikilink")를 정의하자.

\[\mathrm d^2\mu_t(z) = \exp\left(-2\pi t^{-1}(\operatorname{Im}z)^2\right)\, \mathrm d^2z\] 이 측도에 대하여, 다음과 같은 내적을 정의할 수 있다.

\[\langle f|g\rangle = \int_{\mathbb C}\mathrm d^2\mu(z)\, \bar f(\bar z)g(z)\] 이 내적에 대한 노름이 유한한 [정칙 함수들의](https://ko.wikipedia.org/wiki/정칙_함수 "wikilink") [복소수 힐베르트 공간을](https://ko.wikipedia.org/wiki/복소수_힐베르트_공간 "wikilink") \(\mathcal H_t\)라고 하자.
...
[데이비드 멈퍼드가](https://ko.wikipedia.org/wiki/데이비드_멈퍼드 "wikilink") 1983년에 도입하였다.\[3\]
