...
[수론](https://ko.wikipedia.org/wiki/수론 "wikilink")과 [조합론](../Page/조합론.md "wikilink")에서, **뫼비우스 함수**(Möbius函數, )는 정수가 [제곱 인수가 없는 정수인지](../Page/제곱_인수가_없는_정수.md "wikilink") 여부에 따라 분류하는 [곱셈적 함수이다](../Page/곱셈적_함수.md "wikilink"). [뫼비우스 반전 공식에](../Page/뫼비우스_반전_공식.md "wikilink") 사용되며, [리만 가설과도](https://ko.wikipedia.org/wiki/리만_가설 "wikilink") 깊은 관계를 가진다. 기호는 \(\mu(n)\).
...
[소수 정리에](https://ko.wikipedia.org/wiki/소수_정리 "wikilink") 따라 다음이 성립한다.
...
[리만 가설은](https://ko.wikipedia.org/wiki/리만_가설 "wikilink") 메르텐스 함수에 대한 다음 조건과 [동치](../Page/동치.md "wikilink")이다.
...
\[\limsup \frac{M(n)}{\sqrt n}>1.06\] 그러나 [리만 가설은](https://ko.wikipedia.org/wiki/리만_가설 "wikilink") 현재 (2019년) 미해결 문제이다. 메르텐스 추측보다 더 약하지만 리만 가설보다 더 강한 명제
