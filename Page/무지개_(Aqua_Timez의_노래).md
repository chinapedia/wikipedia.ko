...
<!-- end list -->
  ...
  - 2008년 5월 6일, NTV 《줌 인\!\! SUPER》 생방송에 출연해 이 곡을 불렀다.

<!-- end list -->

  - [오리콘 차트](https://ko.wikipedia.org/wiki/오리콘_차트 "wikilink") 초동 매출과 첫 등장 순위 및 연간 순위는 모두 자신의 최고 기록을 갱신하였다.

<!-- end list -->

  - 5월 6일부터 개시 된 벨소리 다운로드(완곡) 첫 날에 5만 다운로드를 기록하였으며, 불과 닷새만에 30만 다운로드를 돌파하였다.

<!-- end list -->

  - 캐치프레이즈는, '괜찮을 이유같은 건 하나도 없어, 지금 필요한 것은 이유가 아니거든.' ().
...
1.  / 무지개 (작사·작곡 : 후토시)
      ...
      -
        "슬픔을 극복하면 행복이 있다"는 메시지를 담았다.

2.  \~evalasting II\~ / 친절한 기억 - (작사·작곡 : 후토시)

3.  / 사실은 말야 (작사·작곡 : 후토시)

      -
        2008년 2월 9일 다운로드 한정으로 발매되었던 곡.

4.  No Live, No Life (작사 : 후토시 / 작곡 : Aqua Timez)
...
## 차트
  ...
  - 2008년 연간순위 34위 (오리콘 차트)
  - 등장 횟수 31회 (오리콘 차트)

[분류:2008년 싱글](https://ko.wikipedia.org/wiki/분류:2008년_싱글 "wikilink") [분류:Aqua Timez의 노래](https://ko.wikipedia.org/wiki/분류:Aqua_Timez의_노래 "wikilink") [분류:2008년 노래](https://ko.wikipedia.org/wiki/분류:2008년_노래 "wikilink") [분류:드라마 주제가](https://ko.wikipedia.org/wiki/분류:드라마_주제가 "wikilink") [분류:무지개를 소재로 한 노래](https://ko.wikipedia.org/wiki/분류:무지개를_소재로_한_노래 "wikilink")