...
[thumb를](https://ko.wikipedia.org/wiki/파일:Constructing_nerve.png "wikilink") 갖는다. 각 [열린집합](https://ko.wikipedia.org/wiki/열린집합 "wikilink")은 체흐 신경의 꼭짓점(0차 단체)에 대응하며, 두 열린집합의 교집합은 체흐 신경의 변(1차 단체)에 대응한다. 이 예에서 세 개의 열린집합의 교집합(즉, 2차 단체)은 존재하지 않는다.\]\] [범주론](https://ko.wikipedia.org/wiki/범주론 "wikilink")과 [대수적 위상수학에서](../Page/대수적_위상수학.md "wikilink"), **체흐 신경**(Čech神經, )은 (충분한 [올곱](https://ko.wikipedia.org/wiki/올곱 "wikilink")을 갖는) [범주에서](https://ko.wikipedia.org/wiki/범주_\(수학\) "wikilink"), 어떤 사상을 통해 정의되는 [단체 대상이다](https://ko.wikipedia.org/wiki/단체_대상 "wikilink"). 기하학적으로, 이 사상은 대략 어떤 “덮개”로 해석된다. [체흐 코호몰로지를](https://ko.wikipedia.org/wiki/체흐_코호몰로지 "wikilink") 구성하는 데 사용된다.
...
다음이 주어졌다고 하자.
  ...
  - \(\mathcal C\) 속의 [사상](https://ko.wikipedia.org/wiki/사상_\(수학\) "wikilink") \(f\colon U\to X\)
...
[매끄러운 다양체와](https://ko.wikipedia.org/wiki/매끄러운_다양체 "wikilink") [매끄러운 함수의](https://ko.wikipedia.org/wiki/매끄러운_함수 "wikilink") 범주 \(\operatorname{Diff}\)에서, 매끄러운 다양체 \(M\)의 [열린 덮개](https://ko.wikipedia.org/wiki/열린_덮개 "wikilink") \(\mathcal U = \{U_i\}_{i\in I}\)가 주어졌다고 하자. (대신 [위상 공간의](https://ko.wikipedia.org/wiki/위상_공간_\(수학\) "wikilink") 범주를 사용할 수도 있다.) 그렇다면,
...
[체흐 코호몰로지는](https://ko.wikipedia.org/wiki/체흐_코호몰로지 "wikilink") 이 [단체 대상에](https://ko.wikipedia.org/wiki/단체_대상 "wikilink") 대한 [코호몰로지](https://ko.wikipedia.org/wiki/코호몰로지 "wikilink") 이론이다.

### 분류 공간

[위상군](https://ko.wikipedia.org/wiki/위상군 "wikilink") \(G\)가 주어졌다고 하자. 이제, [자명군](https://ko.wikipedia.org/wiki/자명군 "wikilink")으로 가는 (유일한) [군 준동형](https://ko.wikipedia.org/wiki/군_준동형 "wikilink")
...
\[g \colon (h_0,h_1,h_2,\dots,h_n) \mapsto  (h_0g,h_1g,h_2g,\dots,h_ng)\] 이 [오른쪽 군 작용은](https://ko.wikipedia.org/wiki/오른쪽_군_작용 "wikilink") [추이적 작용이며](https://ko.wikipedia.org/wiki/추이적_작용 "wikilink"), 기하학적 실현을 취하면 이는 \(G\)-[주다발](https://ko.wikipedia.org/wiki/주다발 "wikilink")
...
## 참고 문헌
  ...
  -
  -
  - [Samuel Eilenberg](https://ko.wikipedia.org/wiki/사무엘_에일렌베르크 "wikilink") and Norman Steenrod: *Foundations of Algebraic Topology*, Princeton University Press, 1952, p. 234.
