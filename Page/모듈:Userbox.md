...
`   if sort then`
`       return mw.ustring.format('`[`%s`](https://ko.wikipedia.org/wiki/분류:%s "wikilink")`', cat, sort)`
`   else`
`       return mw.ustring.format('`[`분류:%s`](https://ko.wikipedia.org/wiki/분류:%s "wikilink")`', cat)`
`   end`
...
`   -- Does argument processing for ``.`
`   local data = {}`

`   -- Get div tag values.`
`   data.float = args ['정렬'] or args.float or 'left'`
`   local borderWidthNum = checkNum(args['border-width'] or args['border-s'] or args['테두리두께'], 1) -- Used to calculate width.`
`   data.borderWidth = addSuffix(borderWidthNum, 'px')`
`   data.borderColor = args['border-color'] or args[1] or args['border-c'] or args['테두리색'] or args['id-c'] or args['항목바탕색'] or '#999'`
`   data.width = addSuffix(240 - 2 * borderWidthNum, 'px') -- Also used in the table tag.`
`   data.bodyClass = args.bodyclass`

`   -- Get table tag values.`
`   data.backgroundColor = args['info-background'] or args[2] or args['info-c'] or args['내용바탕색'] or '#eee'`

`   -- Get info values.`
`   data.info = args.info or args['내용'] or args[4] or args.info or "``"`
`   data.infoTextAlign = args['info-a'] or args['내용정렬'] or 'left'`
`   data.infoFontSize = checkNumAndAddSuffix(args['info-size'] or args[6] or args['info-s'] or args['내용글자크기'], 9, 'pt')`
`   data.infoHeight = checkNumAndAddSuffix(args['logo-height'] or args['id-h'], 45, 'px')`
`   data.infoPadding = args['내용여백'] or args['info-padding'] or args['info-p'] or '0 4px 0 4px'`
`   data.infoLineHeight = args['info-line-height'] or args['info-lh'] or '1.25em'`
`   data.infoColor = args['info-color'] or args['info-fc'] or args['내용글자색'] or 'black'`
`   data.infoOtherParams = args['info-other-param'] or args['info-op']`
`   data.infoClass = args['info-class']`

`   -- Get id values.`
`   local id = args.logo or args[3] or args['항목'] or args.id`
`   data.id = id`
...
`   data.idBackgroundColor = args['logo-background'] or args[1] or args['id-c'] or args['항목바탕색'] or '#ddd'`
`   data.idTextAlign = args['항목정렬'] or args['id-a'] or 'center'`
`   data.idFontSize = checkNumAndAddSuffix(args['logo-size'] or args[5] or args['id-s'] or args['항목글자크기'], 14, 'pt')`
`   data.idColor = args['logo-color'] or args['id-fc'] or args['항목글자색'] or data.infoColor`
`   data.idPadding = args['항목여백'] or args['logo-padding'] or args['id-p'] or '0 1px 0 0'`
...
`   -- Get div tag values.`
`   data.float = args['정렬'] or args.float or 'left'`
`   local borderWidthNum = checkNum(args[9] or args['border-s'] or args['테두리두께'] or args['항목바탕색'], 1) -- Used to calculate width.`
`   data.borderWidth = addSuffix(borderWidthNum, 'px')`
`   data.borderColor = args[1] or args['border-c'] or args['테두리색'] or args['id1-c'] or '#999999'`
`   data.width = addSuffix(240 - 2 * borderWidthNum, 'px') -- Also used in the table tag.`
`   data.bodyClass = args.bodyclass`

`   -- Get table tag values.`
`   data.backgroundColor = args[2] or args['info-c'] or args['내용바탕색'] or '#eeeeee'`

`   -- Get info values.`
`   data.info = args[4] or args.info or args['내용'] or "``"`
`   data.infoTextAlign = args['내용정렬'] or args['info-a'] or 'left'`
`   data.infoFontSize = checkNumAndAddSuffix(args[6] or args['info-s'] or args['내용글자크기'], 9, 'pt')`
`   data.infoColor = args[8] or args['info-fc'] or args['내용글자색'] or 'black'`
`   data.infoPadding = args['내용여백'] or args['info-p'] or '0 4px 0 4px'`
`   data.infoLineHeight = args['info-lh'] or '1.25em'`
`   data.infoOtherParams = args['info-op']`

`   -- Get id values.`
`   data.showId = true`
`   data.id = args.logo or args[3] or args['항목'] or args.id1 or 'id1'`
`   data.idWidth = checkNumAndAddSuffix(args['id1-w'], 45, 'px')`
`   data.idHeight = checkNumAndAddSuffix(args['id-h'], 45, 'px')`
`   data.idBackgroundColor = args['항목바탕색'] or args[1] or args['id1-c'] or '#dddddd'`
`   data.idTextAlign = 'center'`
`   data.idFontSize = checkNumAndAddSuffix(args['항목글자크기'] or args['id1-s'], 14, 'pt')`
`   data.idLineHeight = args['id1-lh'] or '1.25em'`
`   data.idColor = args['항목글자색'] or args['id1-fc'] or data.infoColor`
`   data.idPadding = args['항목여백'] or args['id1-p'] or '0 1px 0 0'`
`   data.idOtherParams = args['id1-op']`

`   -- Get id2 values.`
`   data.showId2 = true`
`   data.id2 = args['항목2'] or args.logo or args[5] or args.id2 or 'id2'`
`   data.id2Width = checkNumAndAddSuffix(args['id2-w'], 45, 'px')`
`   data.id2Height = data.idHeight`
`   data.id2BackgroundColor = args['항목2바탕색'] or args[7] or args['id2-c'] or args[1] or '#dddddd'`
`   data.id2TextAlign = 'center'`
`   data.id2FontSize = checkNumAndAddSuffix(args['항목2글자크기'] or args['id2-s'], 14, 'pt')`
`   data.id2LineHeight = args['id2-lh'] or '1.25em'`
`   data.id2Color = args['항목2글자색'] or args['id2-fc'] or data.infoColor`
`   data.id2Padding = args['항목2여백'] or args['id2-p'] or '0 0 0 1px'`
...
`   -- Get info values.`
`   data.info = args.info or args['내용'] or args[4] or "``"`
`   data.infoTextAlign = args['내용정렬'] or args['info-align'] or args['info-a'] or 'left'`
`   data.infoFontSize = checkNumAndAddSuffix(args['info-size'] or args[6] or args['info-s'] or args['내용글자크기'], 9, 'pt')`
`   data.infoPadding = args['내용여백'] or args['info-padding'] or args['info-p'] or '0 4px 0 4px'`
`   data.infoLineHeight = args['info-line-height'] or args['info-lh'] or '1.25em'`
`   data.infoColor = args['info-color'] or args['info-fc'] or args['내용글자색'] or 'black'`
...
`   -- Get id2 values.`
`   data.showId2 = true`
`   data.id2 = args.logo or args[3] or args['항목'] or args.id or 'id'`
...
`   data.id2BackgroundColor = args['logo-background'] or args[1] or args['id-c'] or args['항목바탕색'] or '#ddd'`
`   data.id2TextAlign = args['항목정렬'] or args['id-a'] or 'center'`
`   data.id2FontSize = checkNumAndAddSuffix(args['logo-size'] or args[5] or args['id-s'] or args['항목글자크기'], 14, 'pt')`
`   data.id2Color = args['logo-color'] or args['id-fc'] or args['항목글자색'] or data.infoColor`
`   data.id2Padding = args['항목여백'] or args['logo-padding'] or args['id-p'] or '0 0 0 1px'`
...
`   if not legible then`
`       root:wikitext('`[`분류:잠재적``   ``문제가``   ``있는``   ``유저박스`](https://ko.wikipedia.org/wiki/분류:잠재적_문제가_있는_유저박스 "wikilink")`')`
`   end`
...
`   -- Gets categories from `[`Module:Category``   ``handler`](https://ko.wikipedia.org/wiki/Module:Category_handler "wikilink")`.`
`   -- The page parameter makes the function act as though the module was being called from that page.`
`   -- It is included for testing purposes.`
`   local cats = {}`
`   cats[#cats + 1] = args.usercategory or args['사용자분류']`
`   cats[#cats + 1] = args.usercategory2 or args['사용자분류2']`
`   cats[#cats + 1] = args.usercategory3 or args['사용자분류3']`
`   cats[#cats + 1] = args.usercategory4 or args['사용자분류4']`
`   cats[#cats + 1] = args.usercategory5 or args['사용자분류5']`
`   if #cats > 0 then`
...
[Category:Pages_with_misplaced_templates](https://ko.wikipedia.org/wiki/Category:Pages_with_misplaced_templates "wikilink")