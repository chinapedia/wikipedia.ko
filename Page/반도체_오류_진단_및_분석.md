...
**반도체 오류 진단 및 분석**은 스캔 기반의 장치들의 오작동이나 고장의 원인이 되는 회로를 찾아내는 예측 [알고리즘](https://ko.wikipedia.org/wiki/알고리즘 "wikilink")이다.\[1\]

## 오류 진단 및 분석의 적용

[소프트웨어](https://ko.wikipedia.org/wiki/소프트웨어 "wikilink") 기반의 오류 진단은 [반도체](https://ko.wikipedia.org/wiki/반도체 "wikilink") 설계자가 반도체 [도선](https://ko.wikipedia.org/wiki/도선 "wikilink")을 개선하거나 수리하는데 필요한 정보를 얻기 위해 이용된다. 오류 진단은 반도체의 수율 개선 및 오류 분석에 이용된다.
