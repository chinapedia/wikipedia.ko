...
**안드로이드 응용 프로그램 패키지**(, APK)는 [안드로이드의](../Page/안드로이드_\(운영_체제\).md "wikilink") [소프트웨어](../Page/소프트웨어.md "wikilink")와 [미들웨어](../Page/미들웨어.md "wikilink") 배포에 사용되는 [패키지](https://ko.wikipedia.org/wiki/패키지_형식 "wikilink") [파일](https://ko.wikipedia.org/wiki/파일 "wikilink")이며, '.apk'확장자를 가진다. APK 파일은 [우분투](https://ko.wikipedia.org/wiki/우분투 "wikilink") 같은 [데비안](../Page/데비안.md "wikilink") 기반 운영 체제에서 사용하는 [뎁 패키지와](https://ko.wikipedia.org/wiki/deb_\(파일_형식\) "wikilink") [마이크로소프트 윈도에서](https://ko.wikipedia.org/wiki/마이크로소프트_윈도 "wikilink") 사용하는 [MSI 패키지와](https://ko.wikipedia.org/wiki/윈도_인스톨러 "wikilink") 같은 설치 파일과 비슷하다. APK 파일을 만들려면, 안드로이드용 [프로그램](https://ko.wikipedia.org/wiki/프로그램 "wikilink")을 먼저 컴파일한 후, 모든 파일들을 하나의 패키지 파일로 모은다. APK 파일은 해당하는 프로그램의 모든 코드를 포함하며, 자원, 정보, 인증서 및 [매니페스트 파일](https://ko.wikipedia.org/wiki/매니페스트_파일 "wikilink") ([:en:Manifest file](https://ko.wikipedia.org/wiki/:en:Manifest_file "wikilink")) 등을 포함한다.\[1\]\[2\]\[3\]\[4\]
