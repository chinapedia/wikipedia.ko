...
이 싱글과 동시 발매한 타카야마 미루의 싱글을 모두 구매한 사람들에게는 특별히 화면 보호기를 담은 CD를 증정하였다.
...
## 수록 작품
  ...
  - **BODY MAKES STREAM** (싱글 버전)
      - 7th anniversary BEST
      - Categorhythm

<!-- end list -->

  - **BODY MAKES STREAM 2002** (앨범 버전)
      - RHYTHM FORMULA

<!-- end list -->

  - **Body Makes Stream(RED MONSTER TRANCE Mix)** (리믹스 버전)
      - BPM "DANCE∞"Ⅱ
...
<!-- end list -->
  ...
  -
    ※앨범『7th anniversary BEST』에는 **JUSTICE**로 표기되어 있다.
