...
[수학](https://ko.wikipedia.org/wiki/수학 "wikilink") 및 [추상 대수학](https://ko.wikipedia.org/wiki/추상_대수학 "wikilink") 에서 [부울](https://ko.wikipedia.org/wiki/조지_불 "wikilink") 도메인(Boolean domain,부울 영역) 은 거짓 및 참을 포함하는 해석이 포함 된 정확히 두 개의 요소로 구성된 집합이다 . [수리 논리학](https://ko.wikipedia.org/wiki/수리_논리학 "wikilink") 및 이론 컴퓨터 과학 에서 부울 도메인은 일반적으로 {0, 1},\[1\]\[2\]\[3\] {false, true}, {F, T},\[4\] \(\left \{ \bot,\top \right \}\)\[5\] 또는 \(\mathbb{B}.\)\[6\]\[7\]
...
[컴퓨터 과학](https://ko.wikipedia.org/wiki/컴퓨터_과학 "wikilink") 에서 부울 [변수](https://ko.wikipedia.org/wiki/변수 "wikilink")는 일부 부울 도메인에서 값을 취하는 변수이다. 일부 [프로그래밍 언어](https://ko.wikipedia.org/wiki/프로그래밍_언어 "wikilink") 에는 Boolean 도메인의 요소에 대해 [예약어](https://ko.wikipedia.org/wiki/예약어 "wikilink") 또는 [기호](https://ko.wikipedia.org/wiki/기호 "wikilink")가 사용된다 (예 : false 및 true ) 그러나 많은 프로그래밍 언어는 엄격한 의미에서 부울 데이터 유형 을 가지고 있지 않다. 예를 들어, [C](https://ko.wikipedia.org/wiki/C_\(프로그래밍_언어\) "wikilink") 또는 [BASIC](https://ko.wikipedia.org/wiki/BASIC "wikilink") 에서 **거짓**은 숫자 0으로 표시되고 **참**은 숫자 1 또는 -1로 표시되며 이 값을 사용할 수있는 모든 변수는 다른 숫자 값으로 대체해서 사용할 수도 있다.
...
이러한 값을 논리적 진리 값으로 해석하면 다중 값 논리가 산출되어 [퍼지 논리](https://ko.wikipedia.org/wiki/퍼지_논리 "wikilink") 및 [확률론](https://ko.wikipedia.org/wiki/확률론 "wikilink")적 논리의 기초가 된다. 이러한 해석에서 가치는 진리의 "정도"로 해석된다 - 어느 정도의 명제가 사실인지 또는 명제가 사실 일 확률-
