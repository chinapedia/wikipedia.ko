...
이 중 특히 me-, pe- 접사는 복잡한 음운 변형 규칙을 따르는데, 정리하면 다음과 같다. 이러한 음운 현상은 [일본어](https://ko.wikipedia.org/wiki/일본어 "wikilink")에서 [ん](../Page/ん.md "wikilink")의 발음 규칙과 비슷한 점이 있다.
  ...
  - 어근의 첫 음이 비음이 아닌 [연구개음](https://ko.wikipedia.org/wiki/연구개음 "wikilink")(k, g, kh)이거나, [성문음](https://ko.wikipedia.org/wiki/성문음 "wikilink")(h)이면 meng-, peng-을 붙인다. 어근이 k로 시작되는 경우는 k를 탈락시키며, 다른 경우는 그대로 접두한다.
