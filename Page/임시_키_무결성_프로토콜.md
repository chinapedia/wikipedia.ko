...
Beck-Tews공격에 기반하여 일본인 연구자인 Toshihiro Ohigashi와 Masakatu Morii가 원래의 공격보다 더 간단하고 빠른 방식을 고안했다.\[8\] 이 방식은 원래의 방식을 최적화했지만, man-in-the-middle공격방식을 사용하며, [QoS](https://ko.wikipedia.org/wiki/QoS "wikilink")가 작동되는 취약점이 있는 [AP](https://ko.wikipedia.org/wiki/AP "wikilink")가 필요하지 않다.
