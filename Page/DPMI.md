...
**도스 보호 모드 인터페이스**(DOS Protected Mode Interface), 곧 **DPMI**는 [도스](../Page/도스.md "wikilink") 프로그램이 [리얼 모드에서](../Page/리얼_모드.md "wikilink") 사용할 수 없는 수많은 프로세서 기능들에 접근할 수 있게 해 주며 [보호 모드에서](../Page/보호_모드.md "wikilink") 돌아가도록 도와 주는 인터페이스이다. 거의 모든 도스 확장자들은 DPMI에 바탕을 두며 DOS 프로그램들이, [개인용 컴퓨터](../Page/개인용_컴퓨터.md "wikilink") 안에서 사용할 수 있는 모든 메모리의 기억 장치에 번지를 넣게 하여 보호 모드에서 돌아가도록 도와준다. 처음에 윈도 3.0을 위해 [마이크로소프트](../Page/마이크로소프트.md "wikilink")사에서 고안된 것이다.
