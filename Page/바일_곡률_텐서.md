...
[미분기하학](https://ko.wikipedia.org/wiki/미분기하학 "wikilink")에서, **바일 곡률 텐서**(Weyl曲率tensor, )는 [리만 다양체의](https://ko.wikipedia.org/wiki/리만_다양체 "wikilink") [곡률](../Page/곡률.md "wikilink")을 나타내는 완전 무대각합 () 4-[텐서](https://ko.wikipedia.org/wiki/텐서 "wikilink")장이다. [리만 곡률 텐서에서](../Page/리만_곡률_텐서.md "wikilink") [리치 곡률 텐서에](../Page/리치_곡률_텐서.md "wikilink") 해당하는 성분을 빼 없애고 남은 성분으로 생각할 수 있다.
...
\[W^a{}_{bcd}\] 그렇다면 이 텐서는 [바일 변환](https://ko.wikipedia.org/wiki/바일_변환 "wikilink") (등각 변환) \(g_{ab}(x)\to\lambda(x)g_{ab}\)에 대하여 불변이다. 반면 [리만 곡률 텐서](../Page/리만_곡률_텐서.md "wikilink") 전체나 [리치 곡률 텐서](../Page/리치_곡률_텐서.md "wikilink"), [스칼라 곡률은](https://ko.wikipedia.org/wiki/스칼라_곡률 "wikilink") 바일 변환에 대하여 복잡하게 변환한다.

3차원이 아닌 [리만 다양체](https://ko.wikipedia.org/wiki/리만_다양체 "wikilink") \((M,g)\)에 대하여, 다음 두 조건이 서로 [동치](../Page/동치.md "wikilink")이다.
...
[일반 상대성 이론에서](https://ko.wikipedia.org/wiki/일반_상대성_이론 "wikilink"), [리만 곡률 텐서의](../Page/리만_곡률_텐서.md "wikilink") 성분 가운데 [리치 곡률 텐서는](../Page/리치_곡률_텐서.md "wikilink") [아인슈타인 방정식을](https://ko.wikipedia.org/wiki/아인슈타인_방정식 "wikilink") 통해 결정되지만, 바일 곡률 텐서는 아무런 제한이 없다. 즉, 이는 중력의 고유한 자유도, 다시 말해 미시적으로 [중력자](https://ko.wikipedia.org/wiki/중력자 "wikilink") 또는 거시적으로 [중력파](https://ko.wikipedia.org/wiki/중력파 "wikilink")를 나타낸다.
