...
[함수해석학](../Page/함수해석학.md "wikilink")에서, **힐베르트 공간**(Hilbert空間, )은 모든 [코시 열의](../Page/완비_거리_공간.md "wikilink") [극한](https://ko.wikipedia.org/wiki/극한 "wikilink")이 존재하는 [내적 공간이다](../Page/내적_공간.md "wikilink"). [유클리드 공간을](../Page/유클리드_공간.md "wikilink") 일반화한 개념이다.

## 정의

\(K\)가 \(\mathbb R\) 또는 \(\mathbb C\)라고 하자. \(K\)-**힐베르트 공간** \((\mathcal H,\langle\cdot,\cdot\rangle)\)은 [완비 거리 공간을](../Page/완비_거리_공간.md "wikilink") 이루는 \(K\)-[내적 공간이다](../Page/내적_공간.md "wikilink"). 내적 공간으로서, 힐베르트 공간은 표준적인 [위상 공간](https://ko.wikipedia.org/wiki/위상_공간_\(수학\) "wikilink") 및 [거리 공간](https://ko.wikipedia.org/wiki/거리_공간 "wikilink") 및 [벡터 공간](../Page/벡터_공간.md "wikilink") 및 [노름 공간의](https://ko.wikipedia.org/wiki/노름_공간 "wikilink") 구조를 갖는다.

이와 동치로, \(K\)-힐베르트 공간을 다음과 같은 **평행사변형 항등식**(平行四邊形恒等式, )을 만족시키는 \(K\)-[바나흐 공간](https://ko.wikipedia.org/wiki/바나흐_공간 "wikilink") \((\mathcal H,\|\cdot\|)\)으로 정의할 수 있다.
...
\[\operatorname{Span}B=\left\{a_1e_1+\cdots+a_ne_n|n\in\mathbb N,\;e_1,\dots,e_n\in B,\;a_1,\dots,a_n\in K\right\}\subset\mathcal H\] [초른의 보조정리에](https://ko.wikipedia.org/wiki/초른의_보조정리 "wikilink") 의하여, 모든 힐베르트 공간은 정규 직교 기저를 갖는다. 주어진 힐베르트 공간 \(\mathcal H\)의 모든 정규 직교 기저의 [크기는](../Page/집합의_크기.md "wikilink") 항상 같은 [기수임을](../Page/기수_\(수학\).md "wikilink") 보일 수 있으며, 이 기수를 힐베르트 공간의 **차원** \(\dim\mathcal H\)이라고 한다.
...
만약 \(\mathcal F\)가 [분해가능 시그마 대수](https://ko.wikipedia.org/wiki/분해가능_시그마_대수 "wikilink")(\(d(A,B)=\mu(A\setminus B\cup B\setminus A)\)로 정의한 [거리 공간이](https://ko.wikipedia.org/wiki/거리_공간 "wikilink") [분해 가능 공간인](../Page/분해_가능_공간.md "wikilink") 경우)이며, 또한 \(X\)가 시그마 유한 공간(가산개의 유한 측도 부분집합들의 합집합)이라면, \(L^2(X,K)\)는 [분해 가능 공간이다](../Page/분해_가능_공간.md "wikilink").\[4\]

## 응용

힐베르트 공간은 [해석학의](https://ko.wikipedia.org/wiki/해석학_\(수학\) "wikilink") 다양한 분야에 응용되며, 특히 [편미분방정식](https://ko.wikipedia.org/wiki/편미분방정식 "wikilink") 이론에서 널리 쓰인다.

[양자역학](https://ko.wikipedia.org/wiki/양자역학 "wikilink")에서, 양자계의 [상태 공간은](https://ko.wikipedia.org/wiki/양자역학의_수학적_공식화 "wikilink") [분해 가능](https://ko.wikipedia.org/wiki/분해_가능 "wikilink") 힐베르트 공간으로 나타내어진다. 이 밖에도, [신호처리](https://ko.wikipedia.org/wiki/신호처리 "wikilink")에도 힐베르트 공간이 응용된다.

## 역사

[다비트 힐베르트가](https://ko.wikipedia.org/wiki/다비트_힐베르트 "wikilink") 1912년에 힐베르트 공간 \(\ell^2(\mathbb N)\)을 정의하였다.\[5\] 이는 유클리드 공간이 아닌 최초의 힐베르트 공간으로 여겨진다. 이후 1929년에 [존 폰 노이만](https://ko.wikipedia.org/wiki/존_폰_노이만 "wikilink")\[6\] 이 힐베르트 공간을 추상적으로 정의하였다.
