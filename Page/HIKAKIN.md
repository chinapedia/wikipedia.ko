...
어렸을 때에는 교실의 구석에 있는, 조금 변한 소년이였다고 한다\[19\].

초3부터 고3까지, [스키 점프](https://ko.wikipedia.org/wiki/스키_점프 "wikilink") 경험이 있으며\[20\], HIKAKIN이라는 이름의 유래는 스키 점프 선배로부터 HIKAKIN의 본명인 히카루(HIKAKIN 본명 : 開発 光, 카이하츠 히카루)를 비꼬아서 히카킨이라고 부르기 시작함으로 인해서이다\[21\]. 본인이 말하길, 초등학생 시절에 한 시기에 불렸던 예명이며, ‘킨’이 어디서부터 온 것인지는 수수께끼라고 한다\[22\]. 중학생 경에 비트박스의 음성을 올리는 게시판에 ‘HIKAKIN’이라는 이름으로 올리고 있다가 조금씩 넓혀왔는데, 이대로 정착했다고 말하고 있다\[23\].

누군가에게 [비트박스](https://ko.wikipedia.org/wiki/비트박스 "wikilink")를 배운 적 없이, 유튜브에서 볼 수 있는 비트박스 영상을 참고로 하는 등, 독학으로 지금의 스타일이 이루어질 수 있었다고 한다\[24\]. 고교생 때부터 조에츠에서 라이브 활동을 하거나, 유튜브에 퍼포먼스 영상을 업로드하거나 하고 있었다\[25\].
...
자신의 팬층에 대해서, 초등학생이나 중학생이 메인이라고 말하고 있으며, 가족 모두 밥을 먹으면서라도 볼 수가 있는 컨텐츠를 하고 싶다고 말하고 있다\[31\].

좋아하는 음식과 음료는 메뉴 보다는 특이하게 대부분이 상품&먹는 방법형인데, 대표적 다섯가지로,

1\. 自製チョコレート(자작 초콜렛) 2. ポテナゲコラボ(포테이토&치킨너겟 콜라보) 3. [日清 UFO焼きそば](https://ko.wikipedia.org/wiki/日清_UFO焼きそば "wikilink")(닛신 유에포 야키소바) 4. [ペヤング 焼きそば](https://ko.wikipedia.org/wiki/ペヤング_焼きそば "wikilink")(페양그 야키소바) 5. 鉄道 車内の弁当(철도 차내에서 도시락 먹는 것)

이다.

2013년 봄 정도부터 현재까지 계속 안경이지만, 옛날에는 콘택트를 하고 있어서 중1, 2학년 때부터 10년 정도 계속 콘택트 렌즈였던 히카킨이 갑자기 콘택트를 하지 않는 이유는 자신의 유튜브 영상에서 말했었다.
...
<!-- end list -->
  ...
  -
      ...
      -
        소속사무소 [UUUM](https://ko.wikipedia.org/wiki/UUUM "wikilink") 대표이사, 카마다 카즈키와 집필.
