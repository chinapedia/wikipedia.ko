...
예를 들어, [ASCII](https://ko.wikipedia.org/wiki/ASCII "wikilink")의 첫 네 제어 문자([유니코드](https://ko.wikipedia.org/wiki/유니코드 "wikilink") U+0000에서 U+0003, 십진수로 0에서 3, 8진수로 000에서 003)는 다음과 같이 행들로 표시될 수 있다.
