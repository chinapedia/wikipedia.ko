...
[right](https://ko.wikipedia.org/wiki/파일:GameOfLife_Glider_Animation.gif "wikilink") **라이프 게임**() 또는 **생명 게임**은 [영국](https://ko.wikipedia.org/wiki/영국 "wikilink")의 수학자 [존 호턴 콘웨이가](../Page/존_호턴_콘웨이.md "wikilink") 고안해낸 [세포 자동자의](../Page/세포_자동자.md "wikilink") 일종으로, 가장 널리 알려진 세포 자동자 가운데 하나이다.

[미국](https://ko.wikipedia.org/wiki/미국 "wikilink")의 과학 잡지 [사이언티픽 어메리칸](https://ko.wikipedia.org/wiki/사이언티픽_어메리칸 "wikilink") [1970년](https://ko.wikipedia.org/wiki/1970년 "wikilink") 10월호 중 [마틴 가드너의](../Page/마틴_가드너.md "wikilink") 칼럼 〈Mathematical Games(수학 게임)〉란을 통해 처음으로 대중들에게 소개되어 단순한 규칙 몇가지로 복잡한 패턴을 만들어낼 수 있다는 점 때문에 많은 관심과 반응을 불러일으켰다. 라이프 게임은 [컴퓨터 과학에서도](../Page/컴퓨터_과학.md "wikilink") 의미가 있는데, 왜냐하면 라이프 게임이 범용 [튜링 기계와](https://ko.wikipedia.org/wiki/튜링_기계 "wikilink") 동등한 계산능력을 가진 세포 자동자이기 때문이다. 즉, 어떤 [알고리즘](https://ko.wikipedia.org/wiki/알고리즘 "wikilink")에 의해 계산될 수 있는 것이라면 모두 이를 이용하여 계산할 수 있다.
...
[존 호턴 콘웨이는](../Page/존_호턴_콘웨이.md "wikilink") 규칙을 다음의 기준에 따라 설정하였다.
  ...
  - 예측할 수 없고 혼돈스러운 패턴.
  - 규칙은 최대한 간단해야 한다.
  - [존 폰 노이만의](https://ko.wikipedia.org/wiki/존_폰_노이만 "wikilink") [세포 자동자을](../Page/세포_자동자.md "wikilink") 기반으로 하여야 한다.
...
[해커](https://ko.wikipedia.org/wiki/해커 "wikilink") 빌 가스퍼(Bill Gosper)가 [1970년](https://ko.wikipedia.org/wiki/1970년 "wikilink") 11월에 처음 그러한 패턴들을 찾아 상금을 탔다. 패턴들 가운데에는 ‘글라이더’나 ‘우주선’을 발사하는 ‘총’과 안정화한 패턴들을 꼬리에 남기며 전진하는 ‘기관차’, 그리고 양쪽을 다 행하는 ‘갈퀴’ 패턴이 있었다. 그는 또한 제곱 비례로 성장하는 패턴인 ‘사육사’ 패턴도 찾아냈는데, 이것은 ‘총’ 패턴을 꼬리에 남기며 앞으로 전진한다. 이 후로 글라이더를 이용한 논리 게이트, 가산기, 소수 발생기와 라이프 게임을 더 큰 스케일과 느린 속도로 모방하는 단위 세포 등 다양한 패턴들이 만들어졌다.
...
## 외부 링크
  ...
  - [Eric Weisstein's Treasure Trove of the Life C.A.](http://www.ericweisstein.com/encyclopedias/life/) - [Dr. Eric Weisstein의](https://ko.wikipedia.org/wiki/Eric_Weisstein "wikilink") 홈페이지. 여러 가지 라이프게임의 패턴들과 설명이 실려 있다.
