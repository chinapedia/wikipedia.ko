...
[양자장론](https://ko.wikipedia.org/wiki/양자장론 "wikilink")에서, **유효 작용**(有效作用, )은 고전적인 [작용을](../Page/작용_\(물리학\).md "wikilink") [양자역학](https://ko.wikipedia.org/wiki/양자역학 "wikilink")적인 효과를 고려하여 수정한 것이다. 고전적인 작용은 고전적 장의 [범함수](https://ko.wikipedia.org/wiki/범함수 "wikilink")인데 반해, 유효작용은 양자론적 장의 [진공 기댓값](https://ko.wikipedia.org/wiki/진공_기댓값 "wikilink") \(\phi_\text{cl}\)의 범함수다. 대개 기호 \(\Gamma[\phi_\text{cl}]\)로 나타낸다.

[고전역학](https://ko.wikipedia.org/wiki/고전역학 "wikilink")에서는 [운동 방정식을](https://ko.wikipedia.org/wiki/운동_방정식 "wikilink") [최소 작용 원리로](https://ko.wikipedia.org/wiki/해밀턴_원리 "wikilink") 계산할 수 있다. 그러나 양자론에서는 최소 작용 원리는 단순히 [경로 적분을](https://ko.wikipedia.org/wiki/경로_적분 "wikilink") 근사할 뿐이다. 그러나 고전적 작용을 유효 작용으로 바꾸면 고전적인 경우와 같이 유효 작용에 최소 작용 원리를 사용하여 [진공 기댓값의](https://ko.wikipedia.org/wiki/진공_기댓값 "wikilink") 운동 방정식을 정확히 계산할 수 있다.
...
\[E[J]=i\log Z[J]\] 와 같이 정의한다. 이는 [통계역학](https://ko.wikipedia.org/wiki/통계역학 "wikilink")의 [자유 에너지에](https://ko.wikipedia.org/wiki/자유_에너지 "wikilink") 해당하는 값이다.
