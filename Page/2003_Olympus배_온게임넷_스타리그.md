...
## 특이사항
  ...
  - 모든 리그를 통틀어 최초로 한국 가수의 곡 사용.(**이철민-신세계**, Inst.로만 사용됐다.)
  - 사상 최초 4시즌 동안 사용된 맵 탄생(Neo Bifrost)
  - 오리지널버전이 아닌 이미테이션 버전으로 수정한 맵 사용(신개마고원)\[1\]
  - 최초로 공식맵에서 섬맵 제외
  - 방의 개념을 도입한 맵 등장(Guillotine)
  - 듀얼토너먼트 시드자인 [김동수](https://ko.wikipedia.org/wiki/김동수 "wikilink")의 은퇴로 추가선발전 진행 (각 조 3위만 출전) - 추가선발전 승자 [나도현](../Page/나도현.md "wikilink")
  - Zerg 정규리그 준우승 징크스 지속 + 이윤열 우승자 징크스 16강 탈락
  - 2시즌 연속 8강에 프로토스 입성 실패
  - 임요환 VS 이재훈의 바카닉 경기가 나온 대회(이 경기로 인해 전용준 캐스터가 MC용준이란 별명을 얻게 됨)
  - 우승 후 [서지훈](https://ko.wikipedia.org/wiki/서지훈 "wikilink")의 눈물이 화제가 되었음
  - 결승전 식전행사를 토크쇼 형식으로 진행.
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 박신영 | 나도현 | 조정현 | 전태규 | 임균태 | 박용욱 | 박성훈 | 박동욱 | 이현승 | 최수범 | 윤정민 | 이재항 |
| M조  | N조  | O조  | P조  | Q조  | R조  | S조  | T조  | U조  | V조  | W조  | X조  |
| 김정민 | 강 민 | 최인규 | 이재훈 | 정재호 | 나경보 | 임성춘 | 조병호 | 박상익 | 장진수 | 문준희 | 김성제 |
...
| A조                                                  | B조    |
| --------------------------------------------------- | ----- |
| [전태규](../Page/전태규.md "wikilink")                    | 1승 3패 |
| **[박용욱](../Page/박용욱.md "wikilink")**                | 3승 1패 |
| [김성제](https://ko.wikipedia.org/wiki/김성제 "wikilink") | 2승 2패 |

### 와일드카드전

|                                                     |       |
| --------------------------------------------------- | ----- |
| [박성훈](../Page/박성훈_\(프로게이머\).md "wikilink")          | 1승 1패 |
| [윤정민](../Page/윤정민.md "wikilink")                    | 0승 1패 |
| [박동욱](../Page/박동욱_\(프로게이머\).md "wikilink")          | 2승 1패 |
| [나경보](../Page/나경보.md "wikilink")                    | 0승 1패 |
| [조정현](https://ko.wikipedia.org/wiki/조정현 "wikilink") | 0승 1패 |
| **[나도현](../Page/나도현.md "wikilink")**                | 2승 0패 |
...
| -- | ------------------------------------------------------- | --------------------------------------------------- | ------------------------------------------------------------------- | --------------------------------------------------- | ------------------------------------------------------------------- |
| 조  | Match1                                                  | Match2                                              | 승자전                                                                 | 패자전                                                 | 최종전                                                                 |
| A조 | **[성학승](../Page/성학승.md "wikilink")**                    | [강민](../Page/강민_\(프로게이머\).md "wikilink")            | **[강도경](../Page/강도경.md "wikilink")**                                | [최인규](../Page/최인규_\(1981년\).md "wikilink")          | **[성학승](../Page/성학승.md "wikilink")**                                |
...
<thead>
<tr class="header">
<th><p>2003 Olympus배 온게임넷 스타리그 우승</p></th>
</tr>
</thead>
<tbody>
<tr class="odd">
...
<tr class="even">
<td><p><strong><a href="https://ko.wikipedia.org/wiki/서지훈" title="wikilink">서지훈</a></strong><br />
(첫 번째 우승)</p></td>
</tr>
</tbody>
</table>
...
| 종족     | Guillotine | Neo Bifrost | Sin Gaema Gowon | Nostalgia |
| ------ | ---------- | ----------- | --------------- | --------- |
| 인원     | 4          | 2           | 4               | 4         |
| P vs Z | 0:0        | 0:1         | 0:2             | 0:2       |
| Z vs T | 4:1        | 3:3         | 2:4             | 3:5       |
| T vs P | 1:0        | 1:0         | 0:1             | 0:1       |
| Z vs Z | 5번         | 3번          | 2번              | 2번        |
| T vs T | 2번         | 2번          | 0번              | 1번        |
| P vs P | 0번         | 0번          | 0번              | 0번        |
...
## 외부 링크
  ...
  - [오프닝](https://www.youtube.com/watch?v=LvMEkGqXoLw)
  - [경기시작전 오프닝](https://www.youtube.com/watch?v=xAj1nao_Se8)

[분류:스타리그](https://ko.wikipedia.org/wiki/분류:스타리그 "wikilink") [분류:2003년 이스포츠](https://ko.wikipedia.org/wiki/분류:2003년_이스포츠 "wikilink")

1.  원제작자 김진태씨가 군복무를 가게되었는데 수정용 맵이 유실되는 바람에 새로운 맵제작자인 변종석씨가 개마고원의 스크린 샷만 가지고 이미테이션 맵을 제작하여 수정을 한 일화가 있다.