...
리 이론에서, **카츠-무디 대수**(Кац-Moody代數, )는 복소수 [리 대수의](https://ko.wikipedia.org/wiki/리_대수 "wikilink") 일종이다. [단순 리 대수와](https://ko.wikipedia.org/wiki/단순_리_대수 "wikilink") [아핀 리 대수의](https://ko.wikipedia.org/wiki/아핀_리_대수 "wikilink") 공통적인 일반화이다.

## 정의

**카츠-무디 대수** \((A,\mathfrak h,\{(\alpha_i,\alpha^\vee_i)\}_{i\in\{1,2,\dots,n\}})\)는 다음과 같은 데이터로 구성된다.

  - \(A\in\operatorname{Mat}(n;\mathbb Z)\)는 정수 성분의 \(n\times n\) [정사각 행렬이며](https://ko.wikipedia.org/wiki/정사각_행렬 "wikilink"), 그 [계수는](https://ko.wikipedia.org/wiki/계수_\(선형대수학\) "wikilink") \(r\)이다. 이를 **(일반화) 카르탕 행렬**(一般化Cartan行列, )이라고 한다.
  - \(\mathfrak h\)는 \(2n-r\)차원 복소수 [벡터 공간이다](https://ko.wikipedia.org/wiki/벡터_공간 "wikilink"). 이를 **카르탕 부분 대수**(Cartan部分代數, )라고 한다.
...
이 경우, **카츠-무디 대수** \(\mathfrak g\)는 \(\mathfrak h\) 및 생성원 \(e_1,\dots,e_n\), \(f_1,\dots,f_n\)으로 생성되며, 다음과 같은 리 괄호를 갖는 복소수 [리 대수이다](https://ko.wikipedia.org/wiki/리_대수 "wikilink").
...
카츠-무디 대수 \(\mathfrak g\)의 **계수**() \(\operatorname{rank}\mathfrak g\)는 그 카르탕 행렬의 [계수](https://ko.wikipedia.org/wiki/계수_\(선형대수학\) "wikilink") \(r=\operatorname{rank}A\)와 같다.
...
모든 카츠-무디 대수 \(\mathfrak g\)는 복소수 벡터 공간으로서 다음과 같은 [직합](https://ko.wikipedia.org/wiki/직합 "wikilink")으로 나타내어진다.
...
대칭화 가능 카츠-무디 대수 \(\mathfrak g\)의 카르탕 행렬 \(A\)는 대각 행렬과 대칭 행렬의 곱 \(A=DS\)로 나타낼 수 있다. 카츠-무디 대수는 \(S\)의 [부호수](https://ko.wikipedia.org/wiki/부호수 "wikilink")에 따라서 다음과 같이 분류된다.
  ...
  - 만약 \(S\)가 [양의 준정부호이지만](https://ko.wikipedia.org/wiki/양의_준정부호 "wikilink") 양의 정부호가 아닐 경우, \(\mathfrak g\)는 **[아핀 리 대수](https://ko.wikipedia.org/wiki/아핀_리_대수 "wikilink")**이다. 이 경우, \(r=n-1\)이다.
...
이들 가운데, [단순 리 대수](https://ko.wikipedia.org/wiki/단순_리_대수 "wikilink") 및 [아핀 리 대수는](https://ko.wikipedia.org/wiki/아핀_리_대수 "wikilink") 완전히 분류되었다. 또한, 부정부호 카츠-무디 대수 가운데 **쌍곡선형 카츠-무디 대수**()라는 것은 총 238개가 있으며, 역시 완전히 분류되었다.\[1\] 그러나 단순 리 대수 · 아핀 리 대수 · 쌍곡 카츠-무디 대수가 아닌 것들은 아직 잘 알려지지 않았다.

## 역사

[캐나다](https://ko.wikipedia.org/wiki/캐나다 "wikilink")의 로버트 본 무디()\[2\]\[3\] 가 [토론토 대학교](https://ko.wikipedia.org/wiki/토론토_대학교 "wikilink") 박사 학위 논문에서 도입하였다. 이와 독자적으로 [소비에트 연방의](https://ko.wikipedia.org/wiki/소비에트_연방 "wikilink") [빅토르 카츠가](../Page/빅토르_카츠.md "wikilink") 거의 동시에 이들을 발견하였다.\[4\]
