...
`                       if link then`
`                           label = '`[`'``   ``..``   ``label``   ``..``   ``'`](https://ko.wikipedia.org/wiki/'_.._link_.._' "wikilink")`'`
`                       end`
`                       pRange = pRange .. label`
`                   end`
`                   pRange = pRange .. ')'`
...
`           end`
`       end`
`       --`[`Todo:``   ``References``   ``if``   ``prevalenceClaim.references``   ``then``   ``end``   ``--`](https://ko.wikipedia.org/wiki/Todo:_References_if_prevalenceClaim.references_then_end_-- "wikilink")
`   end`
`   return pRange`
