...
**일반항 판정법**(一般項判定法, ) 또는 ***n*항 판정법**()은 다음과 같은 서로 [대우인](https://ko.wikipedia.org/wiki/대우_\(논리학\) "wikilink") 두 명제 중 하나로 서술되는 [무한급수](https://ko.wikipedia.org/wiki/무한급수 "wikilink")의 [수렴판정법](https://ko.wikipedia.org/wiki/수렴판정법 "wikilink")이다.

  - \(\textstyle \sum_{n=1}^{\infty} a_n\)이 [수렴하면](https://ko.wikipedia.org/wiki/수렴급수 "wikilink"), \(\textstyle \lim_{n\to\infty} a_n = 0\)이다.
...
또, 일반항 판정법은 [코시 수렴판정법의](https://ko.wikipedia.org/wiki/코시_수렴판정법 "wikilink") 특별한 경우이며, 많은 곳에서 코시 판정법에 의해 증명된다. 에 대해, 이어서 에 대해
...
\(\textstyle \lim_{n\to\infty} a_n = 0\)은 급수 \(\textstyle \sum_{n=1}^{\infty} a_n\)의 수렴을 보장하지 않는다. 즉 일반항 판정법의 역은 성립치 않는다. 다음 급수들은 항이 0으로 수렴하나, 각기 다른 수렴성이 있다.
  ...
  - \(\textstyle \sum_{n=1}^{\infty} \frac{1}{n}\)([조화급수](https://ko.wikipedia.org/wiki/조화급수 "wikilink"))은 무한대로 발산한다.
...
[이상적분](https://ko.wikipedia.org/wiki/이상적분 "wikilink"), [무한곱](https://ko.wikipedia.org/wiki/무한곱 "wikilink"), [균등수렴](../Page/균등수렴.md "wikilink")에 대해 급수의 일반항 판정법과 비슷한 결론이 있다.

  - [단조함수](https://ko.wikipedia.org/wiki/단조함수 "wikilink") 의 이상적분 \(\textstyle \int_a^{\infty} f(x) \,dx\)가 수렴한다면, 는 0으로 수렴한다(). 가 단조함수가 아닌 경우는 일반적으로 틀린 결론이다.
