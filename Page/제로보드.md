...
### 배포중단 및 이전
  ...
  - [XpressEngine](../Page/XpressEngine.md "wikilink")으로 이전하기 위해서는 데이터를 [XML](../Page/XML.md "wikilink") 형식인 XEXML로 옮긴 후 업로드해야 한다. 제로보드4 외에도 [워드프레스](https://ko.wikipedia.org/wiki/워드프레스 "wikilink"), [그누보드](../Page/그누보드.md "wikilink"), [스프링보드](https://ko.wikipedia.org/wiki/스프링보드 "wikilink") 등의 게시판에서 XEXML 데이터를 추출할 수 있는 프로그램을 공개하고 있다.
...
2007년 3월 14일 [네이버](../Page/네이버.md "wikilink")와 [한게임](https://ko.wikipedia.org/wiki/한게임 "wikilink")을 운영하는 인터넷 기업 [NHN](../Page/네이버_\(기업\).md "wikilink")(지금의 네이버)이 국내 인터넷 환경의 질적 발전 도모를 위하여 제로보드를 인수한다고 밝혔다.\[3\] 더불어 NHN은 '제로보드'와 'Zeroboard'에 대해 상표권을 출원하였는데, 상표권이 출원된 날짜가 2006년 12월 15일이었므로\[4\] 인수 발표가 되기 최소 4달 전부터 제로보드 인수에 관한 논의가 되었던 것으로 추측되고 있다.
