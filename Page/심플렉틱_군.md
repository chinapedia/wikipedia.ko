...
[군론](https://ko.wikipedia.org/wiki/군론 "wikilink")에서, **심플렉틱 군**(-群, ) 또는 **사교군**(斜交群)은 고전적 [행렬](https://ko.wikipedia.org/wiki/행렬 "wikilink") [리 군의](https://ko.wikipedia.org/wiki/리_군 "wikilink") 하나다.

## 정의

### 심플렉틱 군 Sp(2*n*; *K*)

\(K\)가 [체라고](https://ko.wikipedia.org/wiki/체_\(수학\) "wikilink") 하자. 다음과 같은 \(2n\times2n\) 행렬을 정의하자.
...
그렇다면 \(\operatorname{Sp}(2n;K)\)는 \(M^\top\Omega M=\Omega\)를 만족하는 \(2n\times2n\) [행렬](https://ko.wikipedia.org/wiki/행렬 "wikilink") \(A\)들의 곱셈군이다. 즉,
...
**유니터리 심플렉틱 군** \(\operatorname{USp}(2n)\)은 \(2n\times2n\) [유니터리](https://ko.wikipedia.org/wiki/유니터리_행렬 "wikilink") 심플렉틱 복소수 행렬의 [리 군이다](https://ko.wikipedia.org/wiki/리_군 "wikilink"). 즉,
...
유니터리 심플렉틱 군 \(\operatorname{USp}(2n)\)은 [사원수](https://ko.wikipedia.org/wiki/사원수 "wikilink")의 [유니터리 군과](../Page/유니터리_군.md "wikilink") 같다.

\[\operatorname{USp}(2n)\cong\operatorname U(n;\mathbb H)=\{M\in\operatorname{GL}(n;\mathbb H)\colon M^{-1}=M^\dagger\}\]

### 리 대수

\(\operatorname{Sp}(2n;\mathbb R)\)에 대응하는 [리 대수](https://ko.wikipedia.org/wiki/리_대수 "wikilink") \(\mathfrak{sp}(2n;\mathbb R)\)는 **해밀턴 행렬**(), 즉 \(\Omega M\)이 [대칭 행렬인](https://ko.wikipedia.org/wiki/대칭_행렬 "wikilink") 행렬 \(M\)들로 구성된다.
...
[유한체](https://ko.wikipedia.org/wiki/유한체 "wikilink")에 대한 심플렉틱 군의 크기는 다음과 같다.
...
\(\operatorname{USp}(2n)\)을 \(n\times n\) [사원수](https://ko.wikipedia.org/wiki/사원수 "wikilink") 유니터리 행렬들의 군으로 생각한다면, \(\operatorname{USp}(2n)\)의 극대 원환면은 다음과 같다.
...
\[-1\colon\lambda_i\mapsto\bar\lambda_i\] 와 같이 대응시키며, \(\sigma\in\operatorname{Sym}(n)\)은 극대 원환면의 기저에 대하여 [순열](https://ko.wikipedia.org/wiki/순열 "wikilink")로 작용한다.

### 위상수학적 성질

복소수 심플렉틱 군 \(\operatorname{Sp}(2n;\mathbb C)\)은 \(n(2n+1)\) 복소수 차원의 [연결](../Page/연결_공간.md "wikilink") [단일 연결](https://ko.wikipedia.org/wiki/단일_연결 "wikilink") [리 군이다](https://ko.wikipedia.org/wiki/리_군 "wikilink"). 이는 [콤팩트하지](../Page/콤팩트_공간.md "wikilink") 않으며, 다음과 같은 [위상 동형이](https://ko.wikipedia.org/wiki/위상_동형 "wikilink") 존재한다.

\[\operatorname{Sp}(2n;\mathbb C)\cong\operatorname{USp}(2n)\times\mathbb R^{2n^2+n}\]

실수 심플렉틱 군 \(\operatorname{Sp}(2n;\mathbb R)\)은 \(n(2n+1)\) (실수) 차원의 [연결](../Page/연결_공간.md "wikilink") [리 군이며](https://ko.wikipedia.org/wiki/리_군 "wikilink"), 이는 [콤팩트하지](../Page/콤팩트_공간.md "wikilink") 않는다. 또한, 다음과 같은 [호모토피 동치가](../Page/호모토피_동치.md "wikilink") 존재한다.
...
유니터리 심플렉틱 군 \(\operatorname{USp}(2n)\)은 \(n(2n + 1)\) (실수) 차원의 [콤팩트](../Page/콤팩트_공간.md "wikilink") [연결](../Page/연결_공간.md "wikilink") [단일 연결](https://ko.wikipedia.org/wiki/단일_연결 "wikilink") [리 군이다](https://ko.wikipedia.org/wiki/리_군 "wikilink").
...
[유한체](https://ko.wikipedia.org/wiki/유한체 "wikilink")에 대한 심플렉틱 군의 경우 다음과 같은 동형이 존재한다.

\[\operatorname{Sp}(2;\mathbb F_2)\cong\operatorname{Sym}(3)\]

\[\operatorname{Sp}(4;\mathbb F_2)\cong\operatorname{Sym}(6)\]

\[\operatorname{PSp}(2;\mathbb F_3)\cong\operatorname{Alt}(4)\] 여기서 \(\operatorname{Sym}(n)\) 및 \(\operatorname{Alt}(n)\)은 각각 [대칭군과](https://ko.wikipedia.org/wiki/대칭군_\(군론\) "wikilink") [교대군](../Page/교대군.md "wikilink")을 뜻한다.

## 역사

심플렉틱 군은 [닐스 헨리크 아벨이](https://ko.wikipedia.org/wiki/닐스_헨리크_아벨 "wikilink") 도입하였다.
