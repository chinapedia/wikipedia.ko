...
[섬네일](https://ko.wikipedia.org/wiki/파일:AGP_slot.jpg "wikilink") 슬롯\]\] **가속 그래픽 포트**(Accelerated Graphics Port , **고급 그래픽 포트**, **AGP**)는 고속의 [점대점](https://ko.wikipedia.org/wiki/점대점_프로토콜 "wikilink") 채널로, [그래픽 카드가](../Page/그래픽_카드.md "wikilink") [컴퓨터](../Page/컴퓨터.md "wikilink")의 [메인보드](https://ko.wikipedia.org/wiki/메인보드 "wikilink")에 장착된다. 주로 [3D 컴퓨터 그래픽의](https://ko.wikipedia.org/wiki/3D_컴퓨터_그래픽 "wikilink") 가속에 도움을 준다. 2004년\~2007년 동안 AGP는 기술적으로 더 진보된 [PCI 익스프레스로](https://ko.wikipedia.org/wiki/PCI_익스프레스 "wikilink") 대체되었다.

## 출시와 지원

AGP는 [소켓 7](https://ko.wikipedia.org/wiki/소켓_7 "wikilink") [펜티엄](https://ko.wikipedia.org/wiki/펜티엄 "wikilink"), [슬롯 1](https://ko.wikipedia.org/wiki/슬롯_1 "wikilink") [펜티엄 II](https://ko.wikipedia.org/wiki/펜티엄_II "wikilink") 보드에 처음 사용되었다. 인텔은 1997년 8월 26일 i440LX 슬롯 1 칩셋을 발표하였고 VIA 아폴로 VP3, SiS 5591/5592, ALI 알라딘 V 등의 소켓 7 칩셋도 출시되었다.

초창기 AGP 카드로는 인텔 i740, 렌디션 베리떼 V2200, [3dfx](../Page/3dfx.md "wikilink") 부두 밴시, [엔비디아](https://ko.wikipedia.org/wiki/엔비디아 "wikilink") [리바 128](https://ko.wikipedia.org/wiki/리바_128 "wikilink"), 3Dlads 퍼미디어 2, [ATI 레이지](https://ko.wikipedia.org/wiki/ATI_레이지 "wikilink") 시리즈, [매트록스](../Page/매트록스.md "wikilink") 밀리니엄 II, [S3](https://ko.wikipedia.org/wiki/S3 "wikilink") [버지 GX/2](https://ko.wikipedia.org/wiki/S3_버지 "wikilink") 등이 출시되었지만 인텔 i740을 제외하고는 모두 PCI 그래픽 칩을 AGP 버스로 변경한 것이라 66MHz로 늘어난 대역폭 사용할 뿐 AGP의 기능을 이용하지 못했다.

마이크로소프트는 1997년 [윈도 95](https://ko.wikipedia.org/wiki/윈도_95 "wikilink") OSR2(OEM 서비스팩 2) [USB](https://ko.wikipedia.org/wiki/USB "wikilink") 지원 패치 버전과 [윈도 NT](https://ko.wikipedia.org/wiki/윈도_NT "wikilink") 4.0 서비스팩 3로 AGP를 지원했다. [리눅스](https://ko.wikipedia.org/wiki/리눅스 "wikilink")는 1999년 AGPgart 커널 모듈로 AGP를 지원하기 시작했다.
