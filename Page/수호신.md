...
**수호신**(Suhosin, 'su-ho-shin'으로 발음한다, 守護神)은 [PHP](https://ko.wikipedia.org/wiki/PHP "wikilink")를 위한 [오픈 소스](https://ko.wikipedia.org/wiki/오픈_소스_소프트웨어 "wikilink") [패치이며](https://ko.wikipedia.org/wiki/패치_\(컴퓨팅\) "wikilink") PHP 확장 기능이다. 패치와 확장 기능은 구분 또는 결합해서 사용할 수 있는 두 독립적인 부분이다. "수호신의 목표는 보안적이지 않는 PHP 코딩 관행으로부터 서버를 지켜주는 안전한 넷이 되는 것이다."\[1\]
...
일부 [리눅스 배포판에서](https://ko.wikipedia.org/wiki/리눅스_배포판 "wikilink"), 특히 6.x ("squeeze"/"oldstable")로 버전이 올라간 [데비안](https://ko.wikipedia.org/wiki/데비안 "wikilink")과 [젠투 리눅스에서](https://ko.wikipedia.org/wiki/젠투_리눅스 "wikilink"), 기본적으로 패치와 확장 기능 둘 다 제공되었다. 수호신은 버전 7 (wheezy)의 데비안에서 제거되었으나 현재 개발 브랜치에서 다시 나타났다.\[3\]

[맥 OS X 서버에서](https://ko.wikipedia.org/wiki/맥_OS_X_서버 "wikilink") 기본적으로 활성화되어 있다.

PHP 5.4에서, [오픈수세](https://ko.wikipedia.org/wiki/오픈수세 "wikilink")는 수호신 패치를 버렸지만, 수호신 확장 기능 부분은 유지하고 있다.\[4\]
