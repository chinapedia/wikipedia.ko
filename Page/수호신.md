...
**수호신**(Suhosin, 'su-ho-shin'으로 발음한다, 守護神)은 [PHP](../Page/PHP.md "wikilink")를 위한 [오픈 소스](../Page/오픈_소스_소프트웨어.md "wikilink") [패치이며](../Page/패치_\(컴퓨팅\).md "wikilink") PHP 확장 기능이다. 패치와 확장 기능은 구분 또는 결합해서 사용할 수 있는 두 독립적인 부분이다. "수호신의 목표는 보안적이지 않는 PHP 코딩 관행으로부터 서버를 지켜주는 안전한 넷이 되는 것이다."\[1\]
