...
## 지원 포맷
  ...
  - [DiskDoubler](https://ko.wikipedia.org/wiki/DiskDoubler "wikilink") (.dd)
  - [BinHex](https://ko.wikipedia.org/wiki/BinHex "wikilink") (.hqx)
  ...
  - [CAB](https://ko.wikipedia.org/wiki/Cabinet_\(파일_포맷\) "wikilink")
  - [Comic book archive](https://ko.wikipedia.org/wiki/Comic_book_archive "wikilink") (.cbz, .cbr)
  - [RPM](https://ko.wikipedia.org/wiki/RPM_Package_Manager "wikilink")
  - Self-Extracting Archive (.sea, if the format itself is supported)
  - 윈도 Self-Extracting (.exe)
  - [CPIO](https://ko.wikipedia.org/wiki/cpio "wikilink")
  - Pax (.pax)
  - HA (.ha)
  - [아미가 디스크 파일](https://ko.wikipedia.org/wiki/아미가_디스크_파일 "wikilink")
  - 아미가 DMS 디스크 아카이브(.dms)
  - 아미가 LhF (.f)
  - 아미가 LZX (.lzx)
  - 아미가 DCS 디스크 아카이브(.dcs)
  - 아미가 PackDev 디스크 아카이브(.pkd)
  - 아미가 xMash 디스크 아카이브(.xms)
  - 아미가 Zoom 디스크 아카이브(.zom)

## 외부 링크

  -
  - [Circlesoft 웹사이트](http://wakaba.c3.cx)

  - [구글코드 프로젝트 페이지](http://code.google.com/p/theunarchiver/)
