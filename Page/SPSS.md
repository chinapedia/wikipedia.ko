...
1968년 [스탠퍼드 대학교](../Page/스탠퍼드_대학교.md "wikilink") [정치학](../Page/정치학.md "wikilink") [박사](../Page/박사.md "wikilink")과정에 있었던 노먼 니(Norman H. Nie) 박사가 통계 경로와 구조를 구상하고, 컴퓨터 공학자였던 데일 벤트(Dale H. Bent)와 해들레이 헐(C. Hadlai Hull)과 개발하였다. 개발 초기에는 펀칭카드를 이용한 데이터 관리 방식을 사용하였고, 메인프레임에 접속하여 사용하고 명령어를 입력하는 방식이었다. 노먼 니 박사는 대학교에서 연구교수로 재직하며 개발자들과 함께 SPSS주식회사를 설립하여 운영하였고, 지속적인 기능 향상과 통계적 기법을 개량하였다. 10판 SPSS 이후에는 점차 PC, 맥, 윈도우에 사용할 수 있는 프로그램으로 발전하였고, 그래픽 기능을 추가하였다.
