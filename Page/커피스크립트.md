...
**커피스크립트**(CoffeeScript)는 [프로그래밍 언어로](https://ko.wikipedia.org/wiki/프로그래밍_언어 "wikilink"), 자바스크립트의 여러 단점을 해결하기 위해 제안되었다. 커피스크립트는 자신의 언어로 작성된 프로그램을 [자바스크립트](https://ko.wikipedia.org/wiki/자바스크립트 "wikilink")로 변환할 수 있는(소스 대 소스 컴파일) [컴파일러](https://ko.wikipedia.org/wiki/컴파일러 "wikilink")를 제공하기 때문에 개발할 때 자바스크립트를 쉽게 대체하여 사용할 수 있다.

커피스크립트는 2013년 3월 현재 [깃허브](https://ko.wikipedia.org/wiki/깃허브 "wikilink")에서 11번째로 널리 사용되는 언어이다.\[1\]
