...
[양자역학](https://ko.wikipedia.org/wiki/양자역학 "wikilink")에서, **포크 공간** (Фок空間, )은 임의의 수의 자유입자의 상태를 나타내는 [힐베르트 공간이다](https://ko.wikipedia.org/wiki/힐베르트_공간 "wikilink"). [소련](https://ko.wikipedia.org/wiki/소련 "wikilink")의 물리학자 [블라디미르 포크가](../Page/블라디미르_포크.md "wikilink") [1932년](https://ko.wikipedia.org/wiki/1932년 "wikilink") 도입하였다.\[1\]

수학적으로, 다음과 같이 정의한다. 단입자 [힐베르트 공간을](https://ko.wikipedia.org/wiki/힐베르트_공간 "wikilink") *H*라고 하자. *S*는 입자가 [보손](https://ko.wikipedia.org/wiki/보손 "wikilink")이면 공간을 대칭화하는 연산자, [페르미온](https://ko.wikipedia.org/wiki/페르미온 "wikilink")이면 반대칭화하는 연산자라고 하자. 그렇다면 포크 공간 \(F(H)\)은 다음과 같이 단입자 힐베르트 공간의 [텐서곱](../Page/텐서곱.md "wikilink")의 [가군](../Page/가군.md "wikilink") [직합](../Page/직합.md "wikilink")의 [완비화로](../Page/완비_거리_공간.md "wikilink") 나타낸다.

\[F(H)=\overline{\bigoplus_{n=0}^{\infty}SH^{\otimes n}}\] 만약 여러 종류의 입자가 존재할 경우 이에 대해 자연스럽게 확장할 수 있다.

## 하크 정리

포크 공간은 자유입자만을 나타낼 수 있다. 즉 상호작용하는 입자는 포크 공간으로 나타낼 수 없다. 이를 **하크 정리**(Haag's theorem)이라고 한다.\[2\] 이 사실은 독일의 [루돌프 하크가](../Page/루돌프_하크.md "wikilink") [1955년](https://ko.wikipedia.org/wiki/1955년 "wikilink")에 지적하였다.\[3\]
...
이 공간에 다음과 같은 [노름](https://ko.wikipedia.org/wiki/노름 "wikilink")을 주어, [힐베르트 공간으로](https://ko.wikipedia.org/wiki/힐베르트_공간 "wikilink") 만들 수 있다.
