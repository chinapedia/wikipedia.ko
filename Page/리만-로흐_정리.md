...
[대수기하학](https://ko.wikipedia.org/wiki/대수기하학 "wikilink")에서, **리만-로흐 정리**(Riemann-Roch 定理, )는 [콤팩트](../Page/콤팩트_공간.md "wikilink") [리만 곡면에](https://ko.wikipedia.org/wiki/리만_곡면 "wikilink") 주어진 꼴의 [특이점을](https://ko.wikipedia.org/wiki/특이점_\(해석학\) "wikilink") 갖는 [일차 독립](https://ko.wikipedia.org/wiki/일차_독립 "wikilink") [유리형 함수들의](../Page/유리형_함수.md "wikilink") 개수에 대한 정리다.

## 정의

\(M\)이 [콤팩트](../Page/콤팩트_공간.md "wikilink") [리만 곡면이라고](https://ko.wikipedia.org/wiki/리만_곡면 "wikilink") 하자. \(M\) 위의 [인자는](../Page/인자_\(대수기하학\).md "wikilink") \(M\)의 점들에 의하여 생성되는 자유 [아벨 군의](https://ko.wikipedia.org/wiki/아벨_군 "wikilink") 원소다. 즉, 인자 \(D\)는 다음과 같은 꼴이다.
...
인자 \(D\)에 대하여, \(\operatorname{div}(f)+D\)의 계수가 모두 음이 아닌 [유리형 함수](../Page/유리형_함수.md "wikilink") \(f\)들의 복소 [벡터 공간의](https://ko.wikipedia.org/wiki/벡터_공간 "wikilink") (복소) 차원을 \(I(D)\)라고 하자.

\(D\)가 \(M\) 위의 [인자](https://ko.wikipedia.org/wiki/인자 "wikilink")이고, \(K\)가 [표준 인자라고](../Page/표준_선다발.md "wikilink") 하자. 그렇다면 다음이 성립한다.

\[I(D)-I(K-D)=\deg D+\chi(M)/2\]. 여기서 \(\chi(M)\)은 \(M\)의 [오일러 지표이다](https://ko.wikipedia.org/wiki/오일러_지표 "wikilink"). 이를 리만 곡면의 종수(genus) \(g\)로 쓰면
...
\[\chi(M,L)=\dim\operatorname H^0(M,\mathcal O(L))-\dim \operatorname H^1(M,\mathcal O(L))=\deg L-g+1\] (여기서 \(\chi(M,L)\)은 \(L\)의 [오일러 지표다](https://ko.wikipedia.org/wiki/오일러_지표 "wikilink").) [세르 쌍대성을](../Page/세르_쌍대성.md "wikilink") 사용하여,
...
보다 일반적으로, [리만 곡면](https://ko.wikipedia.org/wiki/리만_곡면 "wikilink") \(M\) 위의 (임의의 계수의) [정칙 벡터 다발](../Page/정칙_벡터_다발.md "wikilink") \(E\)가 주어졌다고 하자. 그렇다면, 이에 대하여 다음과 같은 리만-로흐 정리가 성립한다.
...
리만-로흐 정리를 써서, [곡면 종수가](../Page/곡면_종수.md "wikilink") \(g\)인 콤팩트 [리만 곡면의](https://ko.wikipedia.org/wiki/리만_곡면 "wikilink") [표준 인자](https://ko.wikipedia.org/wiki/표준_인자 "wikilink") \(K\)의 차수가 \(\deg K=2g-2\)임을 보일 수 있다.
...
\[\dim\operatorname H^0(\mathbb P^1,\mathcal O(k)) = \dim\operatorname H^0(\mathbb P^1,\mathcal O(-2-k)) = \max\{-k-1,0\}\] 이다. 그 특별한 경우는 다음과 같다.
  ...
  - 1차 선다발은 [스피너](https://ko.wikipedia.org/wiki/스피너 "wikilink") 다발이다. 그 단면 공간은 2차원이며, 그 기저는 \(\textstyle\{\sqrt{\partial/\partial z},z\sqrt{\partial/\partial z}\}\)이다.

## 곡면 리만-로흐 정리

[대수 곡면에](../Page/대수_곡면.md "wikilink") 대해서도 리만-로흐 정리가 존재하며, 다음과 같다.\[1\] [대수적으로 닫힌 체](../Page/대수적으로_닫힌_체.md "wikilink") \(k\)에 대한 [비특이](https://ko.wikipedia.org/wiki/비특이_대수다양체 "wikilink") [대수 곡면](../Page/대수_곡면.md "wikilink") (2차원 비특이 완비() 대수다양체) \(X\) 위에 [베유 인자](https://ko.wikipedia.org/wiki/베유_인자 "wikilink") \(D\)가 존재한다고 하고, 그 (정칙) [오일러 지표를](https://ko.wikipedia.org/wiki/오일러_지표 "wikilink") \(\chi(D)\)라고 하자. 그렇다면 다음이 성립한다.
...
[섬네일](https://ko.wikipedia.org/wiki/파일:Roch.jpeg "wikilink") 곡선에 대한 리만-로흐 정리는 [베른하르트 리만이](https://ko.wikipedia.org/wiki/베른하르트_리만 "wikilink") 1857년 표준 인자 항 \(I(K-D)\)를 무시한, [부등식](https://ko.wikipedia.org/wiki/부등식 "wikilink")의 형태로 증명하였다.\[2\] 리만의 제자였던 [구스타프 로흐가](../Page/구스타프_로흐.md "wikilink") 1865년 표준 인자 항을 삽입하여 등식으로 만들었다.\[3\] 로흐는 이 정리를 24세에 증명하였는데, 불행히도 2년 뒤 [결핵](https://ko.wikipedia.org/wiki/결핵 "wikilink")에 걸려 26세의 나이로 요절하였다.
