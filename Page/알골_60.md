...
**알골 60**(ALGOL 60, **ALGO**rithmic **L**anguage 19**60**의 준말)은 [알골](https://ko.wikipedia.org/wiki/알골_\(프로그래밍_언어\) "wikilink") 계열의 컴퓨터 프로그래밍 언어의 멤버이다. [BCPL](../Page/BCPL.md "wikilink"), [B](https://ko.wikipedia.org/wiki/B_\(프로그래밍_언어\) "wikilink"), [파스칼](https://ko.wikipedia.org/wiki/파스칼_\(프로그래밍_언어\) "wikilink"), [시뮬라](../Page/시뮬라.md "wikilink"), [C](https://ko.wikipedia.org/wiki/C_\(프로그래밍_언어\) "wikilink") 등의 다른 수많은 프로그래밍 언어에 영향을 주었다. [알골 58은](https://ko.wikipedia.org/wiki/알골_58 "wikilink") 코드 블록 및 이들을 제거할 `begin`과 `end` 쌍을 도입하였다. 알골 60은 [어휘 범위의](https://ko.wikipedia.org/wiki/범위 "wikilink") [네스티드 함수](https://ko.wikipedia.org/wiki/네스티드_함수 "wikilink") 정의를 처음 추가한 언어이다.

## 역사

[존 배커스는](../Page/존_배커스.md "wikilink") 알골 58에 맞춘 프로그래밍 언어를 기술하는 [바쿠스 표기법을](https://ko.wikipedia.org/wiki/바쿠스-나우르_표기법 "wikilink") 개발하였다. [페테르 나우르는](https://ko.wikipedia.org/wiki/페테르_나우르 "wikilink") 알골 60에 맞추어 이를 개선하고 확장하였으며 [도널드 커누스의](https://ko.wikipedia.org/wiki/도널드_커누스 "wikilink") 제안에 따라 이름을 [바쿠스-나우르 표기법으로](https://ko.wikipedia.org/wiki/바쿠스-나우르_표기법 "wikilink") 변경하였다.\[1\]
