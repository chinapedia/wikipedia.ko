...
**교대 튜링 기계**(Alternating Turing machine, **ATM**)는 [비결정론적 튜링 기계에](https://ko.wikipedia.org/wiki/비결정론적_튜링_기계 "wikilink") 몇가지 조건이 추가된 기계이다.
...
*M*은 입력열 *w* 를 초기 구성 *M*이 허용일때 입력을 허용하고 거부일때 입력을 거부한다. 이 기계는 [형식 언어로](https://ko.wikipedia.org/wiki/형식_언어 "wikilink") 된 길이 n의 입력을 시간단위 n 만에 처리한다.
...
이것은 [P](https://ko.wikipedia.org/wiki/P_\(복잡도\) "wikilink"), [PSPACE](../Page/PSPACE.md "wikilink"), [EXPTIME](../Page/EXPTIME.md "wikilink")의 정의와 비슷하다.
