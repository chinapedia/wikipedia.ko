...
[집합론](https://ko.wikipedia.org/wiki/집합론 "wikilink")에서, **가측 기수**(可測基數, )는 [기본 매장으로](https://ko.wikipedia.org/wiki/기본_매장 "wikilink") 정의될 수 있는 [기수이다](https://ko.wikipedia.org/wiki/기수_\(수학\) "wikilink"). [큰 기수의](../Page/큰_기수.md "wikilink") 하나이다.
...
[선택 공리를](https://ko.wikipedia.org/wiki/선택_공리 "wikilink") 추가한 [체르멜로-프렝켈 집합론에서](https://ko.wikipedia.org/wiki/체르멜로-프렝켈_집합론 "wikilink"), 모든 가측 기수는 [도달 불가능한 기수이며](https://ko.wikipedia.org/wiki/도달_불가능한_기수 "wikilink") 또한 [약콤팩트 기수이다](../Page/약콤팩트_기수.md "wikilink").\[6\] (그러나 선택 공리를 가정하지 않으면, 가측 기수가 따름기수일 수 있다.) 모든 [강콤팩트 기수는](../Page/강콤팩트_기수.md "wikilink") 가측 기수이다.\[7\] 즉, 다음과 같은 함의 관계가 존재한다.

  -
    [초콤팩트 기수](../Page/초콤팩트_기수.md "wikilink") ⇒ [강콤팩트 기수](../Page/강콤팩트_기수.md "wikilink") ⇒ 가측 기수 ⇒ [약콤팩트 기수](../Page/약콤팩트_기수.md "wikilink") ⇒ [말로 기수](https://ko.wikipedia.org/wiki/말로_기수 "wikilink") ⇒ [도달 불가능한 기수](https://ko.wikipedia.org/wiki/도달_불가능한_기수 "wikilink") ⇒ [정칙 기수](https://ko.wikipedia.org/wiki/정칙_기수 "wikilink") ⇒ [기수](https://ko.wikipedia.org/wiki/기수_\(수학\) "wikilink") ⇒ [순서수](https://ko.wikipedia.org/wiki/순서수 "wikilink")
