...
[저우 다양체](https://ko.wikipedia.org/wiki/저우_다양체 "wikilink") \(\operatorname{Chow}(d,\mathbb P^3)\)는 \(\mathbb P^3\) 속의 차수 \(d\)의 곡선들의 모듈라이 공간이다. 보다 일반적으로, [힐베르트 스킴은](https://ko.wikipedia.org/wiki/힐베르트_스킴 "wikilink") [사영 공간](../Page/사영_공간.md "wikilink") 속의 모든 닫힌 부분 스킴들을 분류하는 모듈라이 공간이다.
