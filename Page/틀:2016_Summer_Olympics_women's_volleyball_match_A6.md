...
The template takes one parameter: bgc (background color, no default), which is passed to the [volleyballbox](https://ko.wikipedia.org/wiki/Template:Volleyballbox "wikilink") template. </noinclude><noinclude>  [여자 A06](https://ko.wikipedia.org/wiki/분류:2016년_하계_올림픽_여자_배구_경기_틀 "wikilink") </noinclude>