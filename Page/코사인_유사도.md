...
코사인 유사도는 어떤 개수의 차원에도 적용이 가능하여 흔히 다차원의 양수 공간에서의 유사도 측정에 자주 이용된다. 예를 들어 [정보 검색](https://ko.wikipedia.org/wiki/정보_검색 "wikilink") 및 [텍스트 마이닝](https://ko.wikipedia.org/wiki/텍스트_마이닝 "wikilink") 분야에서, 단어 하나 하나는 각각의 차원을 구성하고 문서는 각 단어가 문서에 나타나는 회수로 표현되는 벡터값을 가진다. 이러한 다차원 공간에서 코사인 유사도는 두 문서의 유사를 측정하는 매우 유용한 방법이다.\[1\]

코사인 유사도는 [데이터 마이닝](https://ko.wikipedia.org/wiki/데이터_마이닝 "wikilink") 분야에서 [클러스터](https://ko.wikipedia.org/wiki/클러스터 "wikilink")들간의 응집도를 측정하는 방법으로도 사용된다.\[2\]
...
두 벡터의 코사인값은 유클리디안 [스칼라곱](https://ko.wikipedia.org/wiki/스칼라곱 "wikilink") 공식에서 유도할 수 있다.
...
[정보 검색의](https://ko.wikipedia.org/wiki/정보_검색 "wikilink") 경우, 문서의 단어 빈도([tf-idf](https://ko.wikipedia.org/wiki/tf-idf "wikilink") 가중치)가 음의 값이 되는 것이 불가능하므로 두 문서 사이의 코사인 유사도는 0에서 1까지의 값으로 표현되며, 두 단어 빈도간의 각도는 90°를 넘을 수 없다.
...
## 같이 보기
  ...
  - [해밍 거리](https://ko.wikipedia.org/wiki/해밍_거리 "wikilink")
