> This article is converted from Wikipedia: [WHITE REFLECTION](https://ko.wikipedia.org/wiki/WHITE_REFLECTION).


〈**WHITE REFLECTION**〉(**화이트 리플렉션**)은 [TWO-MIX](../Page/TWO-MIX.md "wikilink")의 6번째 싱글이다.
...
같은 건담에 타이업 되었던 〈[JUST COMMUNICATION](../Page/JUST_COMMUNICATION.md "wikilink")〉, 〈RHYTHM EMOTION〉에 비하면 누계 매상은 떨어지고 있지만, [오리콘 차트](https://ko.wikipedia.org/wiki/오리콘_차트 "wikilink") 최고 순위 6위를 기록하였다. 또한, 첫 매상은 자신들의 최고기록인 7만 1천장을 기록했다.

또한, [명탐정 코난](../Page/명탐정_코난.md "wikilink") 만화책에는 (15권 FILE.4 목소리가 닮았다?\!\~FILE.6 듀엣?\!) TWO-MIX의 무도관 라이브에서 소년탐정단과 같이 부른 곡이 〈WHITE REFLECTION〉을 노래하는 부분이 나왔으나, 애니메이션에서는 [BREAK를](https://ko.wikipedia.org/wiki/LIVING_DAYLIGHTS "wikilink") 부르고 있다.

## 수록곡

작사：나가노 시이나，작곡：타카야마 미나미，편곡：나가노 시이나,타카야마 미나미
...
<!-- end list -->
  ...
  -
    ※싱글 버전의 샘플기타였던 부분을 생 기타를 도입하였다. (RADIO TWO-MIX에서 앨범소개 할 때 발언하였다.)
    수록 앨범의 가사집에는, 편곡이 바뀐 취지는 표기되어 있지 않다.

<!-- end list -->

  - **WHITE REFLECTION(D-Z Jet Stream Attack Mix)**
      - BPM "DANCE∞"
      - 20010101
      - Categorhythm
...
<!-- end list -->
  ...
  -
    ※싱글버전에서 약간 리믹스되어 있기 때문에, 싱글버전은 앨범에 수록되어 있지 않다.
    수록 앨범의 가사집에는, 편곡이 바뀐 취지는 표기되어 있지 않다.
