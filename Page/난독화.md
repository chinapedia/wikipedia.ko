...
다음과 같은 [소수인지를](https://ko.wikipedia.org/wiki/소수_\(수론\) "wikilink") 판별하는 [액션스크립트 3](https://ko.wikipedia.org/wiki/액션스크립트 "wikilink") 소스에 있는 isPrime 함수를 난독화 시켜보자.
...
위 [C](https://ko.wikipedia.org/wiki/C_\(프로그래밍_언어\) "wikilink") 코드를
...
## 사용 예
  ...
  - [자바스크립트](https://ko.wikipedia.org/wiki/자바스크립트 "wikilink") 코드의 용량을 줄이는 데 쓰는 Packer는, 또한 자바스크립트를 읽기 어렵게 하는 데 쓰인다.
