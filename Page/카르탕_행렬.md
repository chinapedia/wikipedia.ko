...
카르탕 행렬 \(A\in\operatorname{Mat}(n;\mathbb Z)\)가 주어졌을 때, 이에 대응하는 **딘킨 도표**()는 다음과 같은 데이터로 주어진다.
  ...
  - 각 변 \(\{i,j\} \in\operatorname E(\Gamma)\)에 대하여, 양의 정수 [순서쌍](https://ko.wikipedia.org/wiki/순서쌍 "wikilink") \((|A_{ij}|, |A_{ji}|)\)
...
\[D=\operatorname{diag}(D_{11},\dotsc,D_{nn})\] 이 경우, 항상 \(D_{ij}\)의 대각선 성분을 양의 정수로, \(S_{ij}\)의 성분을 [유리수](https://ko.wikipedia.org/wiki/유리수 "wikilink")로 잡을 수 있다.
...
\[D_i/D_j = A_{ij}/A_{ji} \in \mathbb Q^+\] 이다. 분해 불가능 조건에 따라, 이 값들은 \((D_{11},\dotsc,D_{nn})\)의 [사영](https://ko.wikipedia.org/wiki/사영_공간 "wikilink") [동치류](https://ko.wikipedia.org/wiki/동치류 "wikilink")를 결정하며, 성분의 비가 모두 양의 유리수이므로 이 동치류는 양의 정수 성분의 대표원
...
대칭화 가능 카르탕 행렬은 \(n\)개의 실수 [고윳값](https://ko.wikipedia.org/wiki/고윳값 "wikilink")을 가진다. 대칭화 가능 카르탕 행렬 \(A\)들은 그 [고윳값](https://ko.wikipedia.org/wiki/고윳값 "wikilink")에 따라 다음과 같이 분류된다.
  ...
  - 만약 \(A\)의 [고윳값](https://ko.wikipedia.org/wiki/고윳값 "wikilink")이 모두 양수 또는 0이며, 0을 하나 이상 포함할 경우, 카르탕 행렬을 **아핀 카르탕 행렬**이라고 한다. 이 경우, 카르탕 행렬은 [아핀 리 대수와](https://ko.wikipedia.org/wiki/아핀_리_대수 "wikilink") [일대일 대응한다](https://ko.wikipedia.org/wiki/일대일_대응 "wikilink").
  - 만약 \(A\)의 [고윳값](https://ko.wikipedia.org/wiki/고윳값 "wikilink")이 음수를 포함한다면, 카르탕 행렬을 **아핀 카르탕 행렬**이라고 한다. 이 경우, 카르탕 행렬은 [아핀 리 대수와](https://ko.wikipedia.org/wiki/아핀_리_대수 "wikilink") [일대일 대응한다](https://ko.wikipedia.org/wiki/일대일_대응 "wikilink").
...
이 경우,
  ...
  - 아핀 카르탕 행렬은 (\(a\le b\)라고 놓으면) \((a,b)\in\{(-4,-1), (-2,-2) \}\)이다. 이들은 각각 [아핀 리 대수](https://ko.wikipedia.org/wiki/아핀_리_대수 "wikilink") \(\mathfrak a_1^{(1)}\) 및 \(\mathfrak a_2^{(2)}\)에 해당한다.

## 역사

[엘리 카르탕의](https://ko.wikipedia.org/wiki/엘리_카르탕 "wikilink") 이름을 땄으나, 이름과 달리 [빌헬름 킬링이](../Page/빌헬름_킬링.md "wikilink") 최초로 사용하였다.
