...
R는 다양한 통계 기법과 수치 해석 기법을 지원한다. R는 사용자가 제작한 패키지를 추가하여 기능을 확장할 수 있다. 핵심적인 패키지는 R와 함께 설치되며, [CRAN(the Comprehensive R Archive Network)](http://cran.r-project.org/)을 통해 [2016년](../Page/2015년.md "wikilink") 현재 10,300개 이상의 패키지를 내려 받을 수 있다.
