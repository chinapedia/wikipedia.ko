...
`        Hop count is 2`
  ...
  - MTU ([최대 전송 단위](https://ko.wikipedia.org/wiki/최대_전송_단위 "wikilink")): 최소 경로의 최대 전송 단위 (메트릭 계산에는 쓰이지 않음)
