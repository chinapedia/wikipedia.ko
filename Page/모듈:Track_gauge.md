...
`           return '`[`:'``   ``..``   ``ns``   ``..``   ``cat``   ``..``   ``sortlabel``   ``..``   ``'`](https://ko.wikipedia.org/wiki/:'_.._ns_.._cat_.._sortlabel_.._' "wikilink")`'`
...
`   local ft = tgEntry.ft`
`   if ft then`
`       local ftlink = addUnitlink and measurementToLink ~= 'imp' and '`[`ft`](https://ko.wikipedia.org/wiki/Foot_\(unit\) "wikilink")`' or 'ft'`
...
`       local incheslink = addUnitlink and measurementToLink ~= 'imp' and '`[`in`](https://ko.wikipedia.org/wiki/inch "wikilink")`' or 'in'`
...
`       return mw.ustring.format('`[`%s`](https://ko.wikipedia.org/wiki/%s "wikilink")`', tgEntry.pagename, gaugeSize)`
`   else`
`       return gaugeSize`
`   end`
...
`   local gaugeSize`
`   if m then`
`       local mUnit = addUnitlink and measurementToLink ~= 'met' and '`[`m`](https://ko.wikipedia.org/wiki/metre "wikilink")`' or 'm'`
...
`       end`
`       local mmUnit = addUnitlink and measurementToLink ~= 'met' and '`[`mm`](https://ko.wikipedia.org/wiki/millimetre "wikilink")`' or 'mm'`
...
`       -- switched off per `[`Wikipedia:Categories_for_discussion/Log/2016_December_6#Category:Articles_that_mention_a_specific_track_gauge`](https://ko.wikipedia.org/wiki/Wikipedia:Categories_for_discussion/Log/2016_December_6#Category:Articles_that_mention_a_specific_track_gauge "wikilink")
`       -- 2016-12-19`
...
return p --20161219: maintenance categorisation switched off per CfD --20170602: fix bug, show name when al=on

[Category:Articles_using_template_'Track_gauge'_with_unrecognized_input](https://ko.wikipedia.org/wiki/Category:Articles_using_template_'Track_gauge'_with_unrecognized_input "wikilink")