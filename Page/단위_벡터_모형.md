...
[통계역학](https://ko.wikipedia.org/wiki/통계역학 "wikilink")에서, **단위 벡터 모형**(單位vector模形, ) 또는 **직교군 모형**(直交群模形, ) 또는 **크라트키-포로트 모형**()은 [강자성](https://ko.wikipedia.org/wiki/강자성 "wikilink") 또는 [중합체](https://ko.wikipedia.org/wiki/중합체 "wikilink")의 모형이다. 이 경우, 서로 이웃한 [스핀](https://ko.wikipedia.org/wiki/스핀_\(물리학\) "wikilink")(또는 [단량체](https://ko.wikipedia.org/wiki/단량체 "wikilink")) 사이의 각이 \(\theta\)라면, \(\cos\theta\)에 비례하는 퍼텐셜이 존재한다. 이는 자석의 경우 이웃하는 스핀 사이의 상호 작용을 나타내며, 중합체의 경우 중합체가 뻣뻣한 정도를 나타낸다.
...
이에 대한 [분배 함수](https://ko.wikipedia.org/wiki/분배_함수_\(통계역학\) "wikilink")
...
단위 벡터 모형은 [강자성](https://ko.wikipedia.org/wiki/강자성 "wikilink") 또는 [반강자성](https://ko.wikipedia.org/wiki/반강자성 "wikilink")의 고전적 모형으로 해석될 수 있다. 이 경우, \(h\)는 외부 자기장을 나타낸다.

단위 벡터 모형은 또한 [중합체](https://ko.wikipedia.org/wiki/중합체 "wikilink")의 모형으로 해석될 수 있다. 여기서 \(\Gamma\)는 중합체의 모양이며, \(\mathbf s_i\cdot\mathbf s_j\) 항은 중합체가 굽는 것에 대한 저항을 나타낸다. 이러한 모형을 **크라트키-포로트 모형**()이라고 한다.\[1\] 즉, 중합체를 접으려면 에너지가 필요하다. 이 경우 \(\mathbf h\cdot\mathbf s_i\) 항은 외부 중력장으로 해석할 수 있다.
...
1차원 단위 벡터 모형은 [이징 모형과](https://ko.wikipedia.org/wiki/이징_모형 "wikilink") 같다. 3차원 단위 벡터 모형은 보통 **고전 하이젠베르크 모형**()이라고 하는데, 이는 이 모형이 [SU(2)](https://ko.wikipedia.org/wiki/SU\(2\) "wikilink") [하이젠베르크 스핀 사슬의](../Page/하이젠베르크_스핀_사슬.md "wikilink") 고전적 극한이기 때문이다.
