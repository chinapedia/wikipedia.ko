...
"위키상형"은 png 그림으로 [이집트 상형 문자를](https://ko.wikipedia.org/wiki/이집트_상형_문자 "wikilink") 렌더하기 위한 PHP 스크립트입니다. 이집트 상형 문자는 현재 부분적으로만 [유니코드](https://ko.wikipedia.org/wiki/유니코드 "wikilink")가 지원되므로 이는 올린 사용자 정의 그림의 짧은 문서 텍스트에 상형 문자를 렌더링할 수 있는 유일한 방법입니다.
