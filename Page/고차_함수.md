...
**고차 함수**(高次函數, )는 [수학](https://ko.wikipedia.org/wiki/수학 "wikilink")과 [컴퓨터 과학에서](https://ko.wikipedia.org/wiki/컴퓨터_과학 "wikilink") 적어도 다음 중 하나를 수행하는 [함수](https://ko.wikipedia.org/wiki/함수 "wikilink")이다.\[1\]\[2\]\[3\]

  - 하나 이상의 함수를 인수로 취한다. (예: [절차적 매개변수](https://ko.wikipedia.org/wiki/절차적_매개변수 "wikilink"))
  - 함수를 결과로 반환한다.

다른 모든 함수들은 일차(first order) 함수이다. 수학에서 고차 함수들은 [연산자](https://ko.wikipedia.org/wiki/연산자 "wikilink"), [범함수](https://ko.wikipedia.org/wiki/범함수 "wikilink")라고도 한다. [미적분에서](https://ko.wikipedia.org/wiki/미적분학 "wikilink") [미분 연산자가](https://ko.wikipedia.org/wiki/미분_연산자 "wikilink") 일반적인 예인데, 그 이유는 함수를 그 [미분](https://ko.wikipedia.org/wiki/미분 "wikilink")에 연결시키기 때문이다.

형식화되지 않은 [람다 대수에서](https://ko.wikipedia.org/wiki/람다_대수 "wikilink") 모든 함수들은 고차 함수이다. 대부분의 [함수형 프로그래밍](https://ko.wikipedia.org/wiki/함수형_프로그래밍 "wikilink") 언어를 파생시키는 [형식화된 람다 대수에서](https://ko.wikipedia.org/wiki/형식화된_람다_대수 "wikilink") 하나의 함수를 인수로 취하는 고차 함수들은 \((\tau_1\to\tau_2)\to\tau_3\)의 형태의 값이다.
...
## 같이 보기
  ...
  - [함수형 프로그래밍](https://ko.wikipedia.org/wiki/함수형_프로그래밍 "wikilink")
  - [전략 패턴](https://ko.wikipedia.org/wiki/전략_패턴 "wikilink")
