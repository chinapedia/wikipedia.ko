...
이 예외 조항은 다음의 몇 가지 조건을 충족한다면 GFDL 기반의 다중 저자 협력 프로젝트 사이트 (Massive Multiauthor Collaboration Site)에서 CC-BY-SA-3.0으로 변경할 수 있도록 허가하고 있다.
  ...
  - 저작물은 [위키](../Page/위키.md "wikilink")와 같은 대규모 다중 저자 협력 프로젝트에서 생성되어야 한다.
...
아래 목록들 중 몇 가지는 GNU FDL과는 별개로 발전해 온 것들이다. 그리고 몇 가지는 GNU FDL의 결함에 대응하기 위한 목적으로 만들어졌다.
  ...
  - [오픈 콘텐츠 라이선스](https://ko.wikipedia.org/wiki/오픈_콘텐츠_라이선스 "wikilink")
  - [오픈 게이밍 라이선스](https://ko.wikipedia.org/wiki/오픈_게이밍_라이선스 "wikilink")
  - [Open Publication License](https://ko.wikipedia.org/wiki/Open_Publication_License "wikilink")
  - [WTFPL](../Page/WTFPL.md "wikilink")
...
## GFDL을 사용하는 프로젝트 목록
  ...
  - [Last.fm](https://ko.wikipedia.org/wiki/Last.fm "wikilink") - 음악가 기술정보는 GFDL로 기술됨.
  - [Marxists Internet Archive](https://ko.wikipedia.org/wiki/Marxists_Internet_Archive "wikilink")
  - [PlanetMath](https://ko.wikipedia.org/wiki/PlanetMath "wikilink")
  - [로제타 코드](https://ko.wikipedia.org/wiki/로제타_코드 "wikilink")
  - [소스워치](https://ko.wikipedia.org/wiki/소스워치 "wikilink")
  - 기업 아키텍처 프리임워크 [TRAK](https://ko.wikipedia.org/wiki/TRAK "wikilink")를 정의하는 사양서로 GFDL로 배포.
  - [버지니아 코먼웰스 대학교](https://ko.wikipedia.org/wiki/버지니아_코먼웰스_대학교 "wikilink") 수학과 Thomas W. Judson 교수가 저술한 *Abstract Algebra*를 포함한 수학 교과서는 GFDL로 배포됨.
  - [Baseball-Reference](https://ko.wikipedia.org/wiki/Baseball-Reference "wikilink") BR 불펜, 공개 사용자 기여 야구 위키.
