...
이다. \(\theta\)는 면적 요소에 대한 법선과 단위 방향 벡터 \(\hat{\mathbf{n}}\)이 만드는 각이다. 스펙트럼 세기의 단위는 에너지/시간/면적/입체각/주파수가 되도록 보인다. 이것은 MKS 단위에서 W·m<sup>-2</sup>·sr<sup>-1</sup>·Hz<sup>-1</sup>가 된다 (와트/미터^2-[스테라디안](https://ko.wikipedia.org/wiki/스테라디안 "wikilink")-헤르츠).
...
로 쓸 수 있다. \(\tau(s_1,s_2)\)는 \(s_1\) and \(s_2\) 사이에서 대기의 [광학적 깊이](https://ko.wikipedia.org/wiki/광학적_깊이 "wikilink") (optical depth)이다.
...
이며 \(B_\nu(T)\)는 온도 *T*에서 [흑체](https://ko.wikipedia.org/wiki/흑체 "wikilink") (black body)의 세기이다. 그래서 복사전달 방정식의 해는
