...
[환](https://ko.wikipedia.org/wiki/환_\(수학\) "wikilink") \(R\)에 대하여 다음 조건들이 서로 [동치](https://ko.wikipedia.org/wiki/동치 "wikilink")이며, 이를 만족시키는 환을 **폰 노이만 정칙환**() 또는 **절대 평탄환**()이라고 한다.
  ...
  - 모든 [주 왼쪽 아이디얼은](https://ko.wikipedia.org/wiki/주_왼쪽_아이디얼 "wikilink") [멱등원](https://ko.wikipedia.org/wiki/멱등원 "wikilink")에 의하여 생성된다. 즉, 임의의 \(r\in R\)에 대하여, \(Rr=Re\)이자 \(e^2=e\)인 \(e\in R\)가 존재한다.
  - 모든 [주 오른쪽 아이디얼은](https://ko.wikipedia.org/wiki/주_오른쪽_아이디얼 "wikilink") [멱등원](https://ko.wikipedia.org/wiki/멱등원 "wikilink")에 의하여 생성된다. 즉, 임의의 \(r\in R\)에 대하여, \(rRr=eR\)이자 \(e^2=e\)인 \(e\in R\)가 존재한다.
  - 모든 [유한 생성](../Page/유한_생성_가군.md "wikilink") [왼쪽 아이디얼은](https://ko.wikipedia.org/wiki/왼쪽_아이디얼 "wikilink") [멱등원](https://ko.wikipedia.org/wiki/멱등원 "wikilink")에 의하여 생성된다. 즉, 임의의 \(r_1,r_2,\dots,r_k\in R\)에 대하여, \(Rr_1+Rr_2+\cdots+Rr_k=Re\)이자 \(e^2=e\)인 \(e\in R\)가 존재한다.
  - 모든 [유한 생성](../Page/유한_생성_가군.md "wikilink") [오른쪽 아이디얼은](https://ko.wikipedia.org/wiki/오른쪽_아이디얼 "wikilink") [멱등원](https://ko.wikipedia.org/wiki/멱등원 "wikilink")에 의하여 생성된다. 즉, 임의의 \(r_1,r_2,\dots,r_k\in R\)에 대하여, \(Rr_1+Rr_2+\cdots+Rr_k=Re\)이자 \(e^2=e\)인 \(e\in R\)가 존재한다.
