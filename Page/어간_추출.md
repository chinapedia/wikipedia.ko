...
이후 또 다른 스테머가 [마틴 포터에](https://ko.wikipedia.org/wiki/마틴_포터 "wikilink") 의해 작성되어 1980년 7월 *프로그램*(Program) 저널에 실렸다. 이 스테머는 매우 널리 사용되었으며 영어를 위한 알고리즘의 사실상의 표준(de facto standard)이 되었다. 포터 박사는 스테밍 및 정보 검색에서의 공로를 인정 받아 2000년 토니 켄트 스트릭스 상(Tony Kent Strix award)을 수상하였다.
