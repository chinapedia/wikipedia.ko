> This article is converted from Wikipedia: [멱의 법칙](https://ko.wikipedia.org/wiki/멱의_법칙).
...
자연수 \(n\)에 대한 명제는 [수학적 귀납법으로](../Page/수학적_귀납법.md "wikilink") 증명 가능하다. 우선 \(n=0\)인 경우는 [상수 함수의](../Page/상수_함수.md "wikilink") 미분이 0이라는 명제가 되므로 자명하게 성립한다. 이제 어떤 \(n\)에 대하여 성립한다고 가정하자. 그렇다면, [곱의 법칙에](../Page/곱의_법칙_\(미적분학\).md "wikilink") 따라, \(n+1\)에 대한 명제
