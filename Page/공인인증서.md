...
공인인증서는 [OpenSSL](https://ko.wikipedia.org/wiki/OpenSSL "wikilink")의 ssl-ca나 [수세 리눅스의](https://ko.wikipedia.org/wiki/수세_리눅스 "wikilink") gensslcert와 같은 도구를 포함한 [유닉스](https://ko.wikipedia.org/wiki/유닉스 "wikilink") 기반 서버용으로 작성되었다.\[1\] 비대면 온라인 방식의 전자상거래에서 상대방과의 계약서 작성, 신원확인 등에 전자서명이 필요하며 동시에 공인인증서로 해당 전자서명을 생성한 자의 신원을 확인하게 된다.
...
한국의 공인인증서 및 개인키 역시 파일 양식 자체는 국제표준을 따르고 있지만, 그 파일들이 보관, 저장되는 위치와 방법이 독특하여 웹브라우저로는 사용이 불가능하였었다. 그 결과, 한국의 공인인증서를 이용하려면 이용자가 추가프로그램을 반드시 설치해야만 했었다. 그러나 이후 [액티브X](https://ko.wikipedia.org/wiki/액티브X "wikilink")나 [EXE](https://ko.wikipedia.org/wiki/EXE "wikilink") 등 [플러그인](https://ko.wikipedia.org/wiki/플러그인 "wikilink") 없이, 웹 표준 [HTML5](https://ko.wikipedia.org/wiki/HTML5 "wikilink") 기반의 비설치형 인증프로그램등이 이용되어 공인인증서를 [브라우저](https://ko.wikipedia.org/wiki/브라우저 "wikilink")에 저장해 사용할 수 있는 '브라우저 인증' 서비스를 2015년 이후, 국민은행, 신한은행,NH 등 시중은행 및 대구은행 등 지방은행들에서 적용했다. 추가로, 인증 프로그램 외에 각종 [보안 프로그램의](https://ko.wikipedia.org/wiki/보안_프로그램 "wikilink") 비설치는 [OTP나](https://ko.wikipedia.org/wiki/일회용_비밀번호 "wikilink") 가상키보드등으로 이용 시에 가능하도록 했다.
...
[대한민국](https://ko.wikipedia.org/wiki/대한민국 "wikilink")에서는 1999년 전자서명법을 제정하고 공인인증서의 발급 및 관리의 체계를 마련하였다. [행정안전부](https://ko.wikipedia.org/wiki/행정안전부 "wikilink") 장관이 지정한 공인인증기관에서 발급한 인증서를 공인인증서라 하며 기타 인증기관에서 발급한 인증서를 사설인증서라 부른다.

공인인증서가 사용되는 분야는 [인터넷뱅킹](https://ko.wikipedia.org/wiki/인터넷뱅킹 "wikilink")·[증권거래](https://ko.wikipedia.org/wiki/증권거래 "wikilink")·[인터넷](../Page/인터넷.md "wikilink")을 통한 카드 결제·[보험](https://ko.wikipedia.org/wiki/보험 "wikilink") 등의 금융업무와 [전자세금계산서](https://ko.wikipedia.org/wiki/전자세금계산서 "wikilink")·[전자입찰](https://ko.wikipedia.org/wiki/전자입찰 "wikilink")·[전자계약](https://ko.wikipedia.org/wiki/전자계약 "wikilink") 등의 기업 조달업무, 정부에서 제공하는 [전자민원](https://ko.wikipedia.org/wiki/전자민원 "wikilink")·[전자정부](https://ko.wikipedia.org/wiki/전자정부 "wikilink") 업무 등이 있다.

공인인증서 발급에 필요한 서류는 다음과 같다.

  - 개인 : 신청서 1부, [신분증](https://ko.wikipedia.org/wiki/신분증 "wikilink") 사본 1부
  - [법인](https://ko.wikipedia.org/wiki/법인 "wikilink"), [개인사업자](https://ko.wikipedia.org/wiki/개인사업자 "wikilink"), [단체](https://ko.wikipedia.org/wiki/단체 "wikilink") : 신청서 1부, [사업자등록증](https://ko.wikipedia.org/wiki/사업자등록증 "wikilink") 사본 1부, [인감증명서](https://ko.wikipedia.org/wiki/인감증명서 "wikilink") 또는 대표자 [개인인감증명](https://ko.wikipedia.org/wiki/개인인감증명 "wikilink") 원본 1부, 신청서 상에 기재된 [대리인](https://ko.wikipedia.org/wiki/대리인 "wikilink")의 신분증 [사본](https://ko.wikipedia.org/wiki/사본 "wikilink") 1부
...
<tr class="odd">
<td><p>발급대상</p></td>
<td><p><a href="https://ko.wikipedia.org/wiki/자연인" title="wikilink">자연인</a> 또는 <a href="https://ko.wikipedia.org/wiki/법인" title="wikilink">법인</a>, 서버 및 기계장치</p></td>
<td><p>행정기관, 보조기관, 보좌기관 및 공무원</p></td>
</tr>
<tr class="even">
<td><p>용도</p></td>
<td><p>전자 상거래, <a href="https://ko.wikipedia.org/wiki/전자정부" title="wikilink">전자정부</a></p></td>
<td><p><a href="https://ko.wikipedia.org/wiki/행정행위" title="wikilink">행정행위</a></p></td>
</tr>
</tbody>
</table>
...
## 같이 보기
  ...
  - [X.509](https://ko.wikipedia.org/wiki/X.509 "wikilink")
