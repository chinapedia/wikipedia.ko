...
\[h^2=b^2-(\frac{1}{2c} ( -a^2 +b^2 +c^2))^2\] 위의 등식을 h에 대해 정리하면,
...
\[S=\frac{ch}{2}= \frac {c} {2} \frac{1} {2c} \sqrt {4b^2 c^2 -(-a^2 +b^2 +c^2 )^2}\]
...
헤론의 공식은 원에 내접하는 사각형의 넓이를 구하는 [브라마굽타의 공식의](https://ko.wikipedia.org/wiki/브라마굽타의_공식 "wikilink") 특별한 경우로 생각할 수 있다.

헤론의 공식과 브라마굽타의 공식은 [브레치나이더 공식의](https://ko.wikipedia.org/wiki/브레치나이더_공식 "wikilink") 사변형에 대한 특별한 경우이다
...
[사면체](https://ko.wikipedia.org/wiki/사면체 "wikilink")의 부피를 [케일리-멩거 행렬식을](../Page/케일리-멩거_행렬식.md "wikilink") 통해 나타낸 공식은 헤론의 공식의 일반화이다. 이를 전개한 공식은 15세기에 [피에로 델라 프란체스카가](../Page/피에로_델라_프란체스카.md "wikilink") 발견한 공식과 일치한다.\[1\]\[2\]
