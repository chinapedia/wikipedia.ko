> This article is converted from Wikipedia: [IMAP \(우주선\)](https://ko.wikipedia.org/wiki/IMAP_\(우주선\)).
...
2017년 말, 이 탐사선이 솔러 테레설 프로브 미션에 제출되었다.\[3\] 이후 예산이 발사 비용을 포함해 492백만 달러가 배정되었다.\[4\] 현재, 연구가 진행 중이다.

## 발사

2024년 발사된다는 것만 공개되었다. 자세한 발사 장소는 아직 미정이다. 특이사항으로는 [LSP의](https://ko.wikipedia.org/wiki/:en:Launch_Services_Program "wikilink") 일환으로 발사된다.
