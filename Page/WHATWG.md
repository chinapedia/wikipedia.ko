...
## 규격
  ...
  - 이전에 [HTML5](../Page/HTML5.md "wikilink")로 알려진 HTML\[3\] (이전 이름은 웹 애플리케이션 1.0)
  - [웹 워커](https://ko.wikipedia.org/wiki/웹_워커 "wikilink")\[4\]
  - [마이크로데이터](https://ko.wikipedia.org/wiki/마이크로데이터_\(HTML\) "wikilink") 어휘\[5\]
  - [웹 폼](../Page/폼_\(HTML\).md "wikilink") 2.0\[6\]
  - [웹 애플리케이션](../Page/웹_애플리케이션.md "wikilink") 1.0\[7\]
...
## 외부 링크
  ...
  -
[분류:표준화 기구](https://ko.wikipedia.org/wiki/분류:표준화_기구 "wikilink") [분류:월드 와이드 웹](https://ko.wikipedia.org/wiki/분류:월드_와이드_웹 "wikilink") [분류:웹 애플리케이션](https://ko.wikipedia.org/wiki/분류:웹_애플리케이션 "wikilink") [분류:워킹 그룹](https://ko.wikipedia.org/wiki/분류:워킹_그룹 "wikilink") [분류:2004년 설립](https://ko.wikipedia.org/wiki/분류:2004년_설립 "wikilink") [분류:HTML5](https://ko.wikipedia.org/wiki/분류:HTML5 "wikilink")
