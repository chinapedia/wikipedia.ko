...
기존 모델인 대시 9-40CW의 차기 모델로 4,000마력의 직류모터 모델이다.

### ES44DC

기존 모델인 대시 9-44CW의 차기 모델로 4,400마력의 직류모터 모델이다.

### ES44AC

기존 모델인 AC4400CW의 차기 모델로 4,400마력 교류모터 모델이다.

### ES44AC4

기존 모델인 ES44AC와 동일하나 대차 형식이 C-C가 아닌 A1A-A1A으로 동력축이 6축에서 4축으로 줄어든 모델이다. AC 모터가 장착되었다.
...
## 외부 링크
  ...
  - GE Transportation Systems. *[Evolution Series locomotive](https://web.archive.org/web/20131231235628/http://www.getransportation.com/rail/rail-products/locomotives/evolutionr-series-locomotive.html)*.
  - NorthEast Rails. *[GE AC4400-6000 Diesel Railroad Locomotives](http://www.northeast.railfan.net/diesel129.html)*. Retrieved on February 23, 2005.
  - GE Evolution Locomotives. Published by Voyageur Press 2007 "[1](http://www.voyageurpress.com/Store/ProductDetails_37154.ncm)"

[분류:제너럴 일레트릭의 디젤 기관차](https://ko.wikipedia.org/wiki/분류:제너럴_일레트릭의_디젤_기관차 "wikilink")