...
**OpenSSL**은 [네트워크를](../Page/컴퓨터_네트워크.md "wikilink") 통한 데이터 통신에 쓰이는 [프로토콜](https://ko.wikipedia.org/wiki/프로토콜 "wikilink")인 [TLS와](https://ko.wikipedia.org/wiki/트랜스포트_레이어_보안 "wikilink") [SSL](https://ko.wikipedia.org/wiki/SSL "wikilink")의 [오픈 소스](../Page/오픈_소스.md "wikilink") 구현판이다. [C 언어로](https://ko.wikipedia.org/wiki/C_언어 "wikilink") 작성되어 있는 중심 라이브러리 안에는, 기본적인 암호화 기능 및 여러 유틸리티 함수들이 구현되어 있다.
...
거의 모든 버전의 [유닉스 계열](../Page/유닉스_계열.md "wikilink") [운영 체제](../Page/운영_체제.md "wikilink")([솔라리스](https://ko.wikipedia.org/wiki/솔라리스 "wikilink"), [맥 OS X](https://ko.wikipedia.org/wiki/맥_OS_X "wikilink"), [리눅스](../Page/리눅스.md "wikilink"), BSD 포함) 및 OpenVMS, [윈도우에서](../Page/마이크로소프트_윈도우.md "wikilink") OpenSSL을 이용할 수 있다.
...
OpenSSL은 각기 다른 다양한 암호화 알고리즘을 지원한다:
  ...
  - [공개 키 암호 방식](../Page/공개_키_암호_방식.md "wikilink"):
    [RSA](../Page/RSA_암호.md "wikilink"), [DSA](../Page/디지털_서명_알고리즘.md "wikilink"), [디피-헬만 키 교환](https://ko.wikipedia.org/wiki/디피-헬만_키_교환 "wikilink"), [타원 암호](../Page/타원곡선_암호.md "wikilink"), [GOST R 34.10-2001](https://ko.wikipedia.org/wiki/GOST_R_34.10-2001 "wikilink")
