...
{\\Gamma(\\nu/2)2^{\\nu/2-1}},\\;\\nu\>0</math>, \(K_{\nu}(x)\)는 [베셀 함수](../Page/베셀_함수.md "wikilink") }} **스튜던트 t 분포**(Student t分布, )는 [정규 분포의](https://ko.wikipedia.org/wiki/정규_분포 "wikilink") 평균을 측정할 때 주로 사용되는 분포이다.

## 정의

**스튜던트 t 분포**는 다음 [확률변수](https://ko.wikipedia.org/wiki/확률변수 "wikilink")의 분포로 정의된다.

\[\frac{Z}{\sqrt{V/\nu}}\] 여기에서 \(Z\)는 [표준정규분포](https://ko.wikipedia.org/wiki/표준정규분포 "wikilink"), \(V\)는 [카이제곱 분포](https://ko.wikipedia.org/wiki/카이제곱_분포 "wikilink") \(\nu\)인 [자유도](https://ko.wikipedia.org/wiki/자유도 "wikilink")이다.
...
어떤 정규분포의 [평균](../Page/평균.md "wikilink")이 \(\mu\)이고 [분산](https://ko.wikipedia.org/wiki/분산 "wikilink")이 \(\sigma^2\)일 때, 그 분포에서 n개의 표본을 추출한 것을 \(X_1, \cdots, X_n\)라고 표기한다. 표본평균과 표본분산은 다음과 같다.
...
\[V = (n-1)\frac{S^2}{\sigma^2}\] 은 자유도가 \(n-1\)인 [카이제곱 분포가](https://ko.wikipedia.org/wiki/카이제곱_분포 "wikilink") 된다는 것이 Cochran 정리에 의해 알려져 있다. 또한
...
1908년에 [윌리엄 고셋이](https://ko.wikipedia.org/wiki/윌리엄_고셋 "wikilink") "스튜던트"(, ‘학생’)라는 [필명](https://ko.wikipedia.org/wiki/필명 "wikilink")으로 1908년 재발견하였다.\[8\] 고셋은 [기네스 양조 공장에서](https://ko.wikipedia.org/wiki/기네스_\(맥주\) "wikilink") 일했고, 맥주에 사용되는 보리의 질을 시험하기 위해 이 분포를 도입하였고, 경쟁사들에게 기네스의 획기적인 통계 기법을 숨기기 위해 필명을 사용하였다고 한다.\[9\] 이후 저명한 통계학자인 [로널드 피셔는](https://ko.wikipedia.org/wiki/로널드_피셔 "wikilink") 이 분포를 "스튜던트 분포"라고 불렀고, *t*라는 기호를 사용하였다.\[10\] 피셔 이후 이 분포는 고셋의 필명을 따 "스튜던트 t 분포"로 알려지게 되었다.

## 참고 문헌

## 같이 보기

  - [카이제곱 분포](https://ko.wikipedia.org/wiki/카이제곱_분포 "wikilink")
  - [F 분포](https://ko.wikipedia.org/wiki/F_분포 "wikilink")
