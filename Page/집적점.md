...
특별한 값의 \(\kappa\)에 대하여, 다음과 같은 특별한 용어들이 존재한다.
  ...
  - \(x\in X\)가 \(Y\)의 **극한점**(極限點, )이라는 것은 임의의 \(x\)의 [근방](../Page/근방.md "wikilink") \(X\supseteq U\ni x\)에 대하여, \((U\setminus\{x\})\cap Y\ne\varnothing\)를 만족하는 것이다. 극한점의 집합을 **유도 집합**(誘導集合, )이라고 하며, 흔히 \(Y'\)으로 표기한다.
      - \(Y\subseteq X\)의 극한점이 아닌 점 \(x\in Y\setminus Y'\)은 **고립점**(孤立點, , )이라고 한다. (즉, \(x\in X\)가 고립점이라는 것은 [한원소 집합](../Page/한원소_집합.md "wikilink") \(\{x\}\)가 [열린집합](../Page/열린집합.md "wikilink")이라는 것이다.)
  - 1-집적점을 **밀착점**(密着點, )이라고 한다. \(Y\subseteq X\)의 1-집적점은 \(Y\)의 원소이거나 아니면 \(Y\)의 극한점이다. 1-집적점들의 집합은 **[폐포](../Page/폐포_\(위상수학\).md "wikilink")**라고 한다.
...
\[\operatorname{cl}Y=\operatorname{acc\,pt}_1(Y)=Y\cup Y'\]
