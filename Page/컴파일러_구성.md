...
**컴파일러 구조** (Compiler construction)는 [컴퓨터 과학의](https://ko.wikipedia.org/wiki/컴퓨터_과학 "wikilink") 한 영역으로서 [프로그래밍 언어들과](https://ko.wikipedia.org/wiki/프로그래밍_언어 "wikilink") 그들과 관련된 [컴파일러](https://ko.wikipedia.org/wiki/컴파일러 "wikilink")들을 개발하는 것의 이론과 실행을 다룬다.
...
## 하위 분야
  ...
  - [컴파일러](https://ko.wikipedia.org/wiki/컴파일러 "wikilink") 또는 [프로그램 최적화](https://ko.wikipedia.org/wiki/프로그램_최적화 "wikilink")
