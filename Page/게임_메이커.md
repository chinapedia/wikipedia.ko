> This article is converted from Wikipedia: [게임 메이커](https://ko.wikipedia.org/wiki/게임_메이커).


**게임 메이커**(; GM)는 [델파이](../Page/델파이.md "wikilink") 프로그래밍 언어로 제작된 게임 개발 도구 ([IDE](../Page/통합_개발_환경.md "wikilink"))이다. 네덜란드의 컴퓨터 프로그래머이며, 위트 레흐트 대학의 교수인 [마르크 오버르마르스](https://ko.wikipedia.org/wiki/마르크_오버르마르스_\(컴퓨터_과학자\) "wikilink")(Mark Overmars)가 만든 프로그램이다. 현재는 [요요 게임즈](https://ko.wikipedia.org/wiki/요요_게임즈 "wikilink")(YoYo Games)가 현재 개발 중이며, 다른 프로그래밍 언어를 이용하여 게임을 개발하는 것 보다 더 빠르고 편하게 컴퓨터 게임을 개발할 수 있도록 고안을 했다.
...
### 디자인
  ...
  -
    게임 메이커에서는 [GUI](../Page/그래픽_사용자_인터페이스.md "wikilink") 형태의 인터페이스를 채용하였으며, 액션을 사용할 때에는 오른쪽 마우스를 누르거나 [드래그 앤드 드롭을](https://ko.wikipedia.org/wiki/드래그_앤드_드롭 "wikilink") 사용하면 된다.

### 기능

  -
    게임 메이커에서는 GML이라는 자체적인 언어를 지원하며, [DLL](../Page/동적_링크_라이브러리.md "wikilink") 라이브러리 파일을 추가하여 기능을 더 추가할 수도 있다. 부가적인 프로그램인 라이브러리 메이커(Library Maker)나 확장 패키지 제작기(Extension Maker)를 통하여 액션이나 확장 패키지를 제작하여 게임 메이커의 기능을 추가할 수 있다. 또한 5.0 이상과 8.0 이하 버전 파일을 지원한다.
...
2010년 3월 10일에 요요 게임즈 CEO 샌디 던칸은 [플레이스테이션 포터블](../Page/플레이스테이션_포터블.md "wikilink") 시스템용으로 출시될 예정인 새로운 버전의 게임 메이커를 발표하였다.\[6\]\[7\]
...
## 외부 링크
  ...
  - [요요 게임즈 위키](https://web.archive.org/web/20081202004450/http://wiki.yoyogames.com/) — 공식 위키
