...
**윈도우 임베디드 컴팩트**(, 과거 명칭: 윈도우 CE 또는 Windows CE)는 소형 컴퓨터나 PDA 등에 사용되는 [마이크로소프트 윈도우](../Page/마이크로소프트_윈도우.md "wikilink") 전용 커널로, [도스](../Page/MS-DOS.md "wikilink") 계열인 [윈도우 3.11을](https://ko.wikipedia.org/wiki/윈도우_3.1 "wikilink") 기반으로 완전히 새롭게 만든 제품이다. 인텔 [X86](https://ko.wikipedia.org/wiki/X86 "wikilink") 및 호환 제품, [MIPS](https://ko.wikipedia.org/wiki/MIPS_아키텍처 "wikilink"), [ARM](https://ko.wikipedia.org/wiki/ARM_아키텍처 "wikilink"), [히타치](https://ko.wikipedia.org/wiki/히타치_제작소 "wikilink") SuperH 프로세서를 지원한다. [윈도우 10](../Page/윈도우_10.md "wikilink") IoT Core 제품이 [라즈베리 파이와](../Page/라즈베리_파이.md "wikilink") 같은 마이크로프로세서 제품에 설치할 수 있도록 배포되었지만 윈도우 CE가 윈도우 10 IoT Core로 전환되는 것인지는 알려지지 않았다.
...
윈도우 CE는 초기에 [PDA](https://ko.wikipedia.org/wiki/PDA "wikilink")의 운영 체제로 주로 사용되었지만 AutoPC, 스마트폰 등의 기기에도 사용되었다. 어떤 윈도우 CE 버전은 [세가](https://ko.wikipedia.org/wiki/세가 "wikilink")의 [드림캐스트](https://ko.wikipedia.org/wiki/드림캐스트 "wikilink")에서 작동하고, [엑스박스 360](https://ko.wikipedia.org/wiki/엑스박스_360 "wikilink") 게임기에서 동작하는 버전도 있다.
