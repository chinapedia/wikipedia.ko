...
[대수적 수론에서](https://ko.wikipedia.org/wiki/대수적_수론 "wikilink"), **이차 수체**(二次數體, )는 [차원](https://ko.wikipedia.org/wiki/차원 "wikilink")이 2인 [대수적 수체이다](https://ko.wikipedia.org/wiki/대수적_수체 "wikilink").

## 정의

**이차 수체**는 \(\mathbb Q(\sqrt d)\)의 꼴인 [대수적 수체이다](https://ko.wikipedia.org/wiki/대수적_수체 "wikilink"). 여기서 \(d\)는 \(+1\)이 아닌 (음 또는 양의) [제곱 인수가 없는 정수이다](https://ko.wikipedia.org/wiki/제곱_인수가_없는_정수 "wikilink"). 만약 \(d>0\)이면 \(\mathbb Q(\sqrt d)\)를 **실수 이차 수체**(實數二次數體, )라고 하고, \(d<0\)이면 **복소 이차 수체**(複素二次數體, )라고 한다. 이차 수체의 [대수적 정수환의](https://ko.wikipedia.org/wiki/대수적_정수환 "wikilink") 원소를 **이차 정수**(二次整數, )라고 한다.
...
[체의 확대](https://ko.wikipedia.org/wiki/체의_확대 "wikilink") \(\mathbb Q(\sqrt d)/\mathbb Q\)에서, 유리 소수 \(p\in\mathbb Z\)는 확대에 따라서 다음과 같은 [분기화](https://ko.wikipedia.org/wiki/분기화 "wikilink")를 보인다.

  - 만약 [크로네커 기호](https://ko.wikipedia.org/wiki/크로네커_기호 "wikilink") \(\left(\tfrac\Delta p\right)=-1\)이라면, \((p)\)는 \(\mathcal o_{\mathbb Q(\sqrt d)}\)에서 여전히 [소 아이디얼이다](https://ko.wikipedia.org/wiki/소_아이디얼 "wikilink").
  - 만약 [크로네커 기호](https://ko.wikipedia.org/wiki/크로네커_기호 "wikilink") \(\left(\tfrac\Delta p\right)=+1\)이라면, \((p)\)는 \(\mathcal o_{\mathbb Q(\sqrt d)}\)에서 두 개의 서로 다른 [소 아이디얼의](https://ko.wikipedia.org/wiki/소_아이디얼 "wikilink") 곱이다.
  - 만약 \(p\mid\Delta\)라면, \((p)\)는 \(\mathcal o_{\mathbb Q(\sqrt d)}\)의 어떤 [소 아이디얼의](https://ko.wikipedia.org/wiki/소_아이디얼 "wikilink") 제곱이다.
...
유수가 \(h\)인 허수 이차 수체 \(\mathbb Q(\sqrt{-d})\)의 \(d\)들의 목록은 다음과 같다. 작은 \(d\)에 대하여 이 목록은 유한하며, 특히 \(h=1\)인 경우를 **[헤그너 수](https://ko.wikipedia.org/wiki/헤그너_수 "wikilink")**라고 한다.
...
## 같이 보기
  ...
  - [이차 유수 상수](https://ko.wikipedia.org/wiki/이차_유수_상수 "wikilink")
