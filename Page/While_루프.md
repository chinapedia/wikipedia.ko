...
[섬네일](https://ko.wikipedia.org/wiki/파일:While-loop-diagram.svg "wikilink") 대부분의 컴퓨터 [프로그래밍](https://ko.wikipedia.org/wiki/프로그래밍 "wikilink") 언어에서 **while 루프**는 [반복문](https://ko.wikipedia.org/wiki/반복문 "wikilink")의 일종으로, 주어진 [불린 자료형](https://ko.wikipedia.org/wiki/불린_자료형 "wikilink") 조건을 기반으로 코드가 반복적으로 수행할 수 있게 도와준다. 이 while 루프는 [if 문의](https://ko.wikipedia.org/wiki/조건문 "wikilink") 반복으로 생각할 수도 있다.
...
이를테면, [C 프로그래밍 언어에서](https://ko.wikipedia.org/wiki/C_\(프로그래밍_언어\) "wikilink") (같은 구문을 사용하는 [자바](https://ko.wikipedia.org/wiki/자바_\(프로그래밍_언어\) "wikilink"), [C++](https://ko.wikipedia.org/wiki/C++ "wikilink")에도 해당), 다음과 같은 코드의 파편은
...
물론 언제나 "true"라는 조건을 성립하게 만들 수도 있으며, 이때 [무한 반복을](https://ko.wikipedia.org/wiki/무한_루프 "wikilink") 만들어 낸다. 고의로 이러한 루프를 만들 경우, [break문과](https://ko.wikipedia.org/wiki/제어_흐름 "wikilink") 같은 다른 제어 구조를 사용하여 루프를 끝낼 수 있다.
...
또한 [C](https://ko.wikipedia.org/wiki/C_\(프로그래밍_언어\) "wikilink") 계열 언어에서 while 루프는 초기화나 셈식(counting expression)이 없는 [for 루프이다](https://ko.wikipedia.org/wiki/for_루프 "wikilink"). 이를테면 다음과 같다.
