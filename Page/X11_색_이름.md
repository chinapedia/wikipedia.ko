...
**X11 색 이름**은 [X 윈도 시스템에서](../Page/X_윈도_시스템.md "wikilink") [RGB](https://ko.wikipedia.org/wiki/RGB "wikilink") [색](../Page/색.md "wikilink")에 대응하는 이름을 말한다.

## 색 이름 목록

아래 표는 [CSS](https://ko.wikipedia.org/wiki/CSS "wikilink")에서 사용되는 색상 이름 목록이다.

| 색 이름                                                 | 256 복합수     | 16진수 코드  |
| ---------------------------------------------------- | ----------- | -------- |
