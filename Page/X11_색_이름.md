> This article is converted from Wikipedia: [X11 색 이름](https://ko.wikipedia.org/wiki/X11_색_이름).


**X11 색 이름**은 [X 윈도 시스템에서](../Page/X_윈도_시스템.md "wikilink") [RGB](../Page/RGB.md "wikilink") [색](../Page/색.md "wikilink")에 대응하는 이름을 말한다.

## 색 이름 목록

아래의 표는 [CSS](https://ko.wikipedia.org/wiki/CSS "wikilink")에서 사용되는 색상 이름 목록이다.

| 색 이름                                                 | 256 복합수     | [16진수](https://ko.wikipedia.org/wiki/16진수 "wikilink") 코드 |
| ---------------------------------------------------- | ----------- | -------------------------------------------------------- |
...
| <span style="color: #ffffff;">Black</span>           | 0 0 0       | \#000000                                                 |
| <span style="color: #ffffff;">DarkSlateGray</span>   | 47 79 79    | \#2F4F4F                                                 |
| <span style="color: #ffffff;">DimGray</span>         | 105 105 105 | \#696969                                                 |
| <span style="color: #ffffff;">SlateGray</span>       | 112 128 144 | \#708090                                                 |
| <span style="color: #ffffff;">LightSlateGray</span>  | 119 136 153 | \#778899                                                 |
| Gray                                                 | 190 190 190 | \#BEBEBE                                                 |
| LightGray                                            | 211 211 211 | \#D3D3D3                                                 |
| <span style="color: #ffffff;">MidnightBlue</span>    | 25 25 112   | \#191970                                                 |
| <span style="color: #ffffff;">NavyBlue</span>        | 0 0 128     | \#000080                                                 |
| CornflowerBlue                                       | 100 149 237 | \#6495ED                                                 |
| <span style="color: #ffffff;">DarkSlateBlue</span>   | 72 61 139   | \#483D8B                                                 |
...
| <span style="color: #ffffff;">DarkGreen</span>       | 0 100 0     | \#006400                                                 |
| <span style="color: #ffffff;">DarkOliveGreen</span>  | 85 107 47   | \#556B2F                                                 |
| DarkSeaGreen                                         | 143 188 143 | \#8FBC8F                                                 |
| <span style="color: #ffffff;">SeaGreen</span>        | 46 139 87   | \#2E8B57                                                 |
...
| <span style="color: #ffffff;">ForestGreen</span>     | 34 139 34   | \#228B22                                                 |
| <span style="color: #ffffff;">OliveDrab</span>       | 107 142 35  | \#6B8E23                                                 |
...
| <span style="color: #ffffff;">SaddleBrown</span>     | 139 69 19   | \#8B4513                                                 |
