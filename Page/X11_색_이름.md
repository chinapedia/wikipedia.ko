> This article is converted from Wikipedia: [X11  ](https://ko.wikipedia.org/wiki/X11__).


**X11 색 이름**은 [X 윈도 시스템에서](../Page/X_윈도_시스템.md "wikilink") [RGB](https://ko.wikipedia.org/wiki/RGB "wikilink") [색](https://ko.wikipedia.org/wiki/색 "wikilink")에 대응하는 이름을 말한다.

## 색 이름 목록

아래 표는 CSS에서 사용되는 색상 이름 목록이다.
