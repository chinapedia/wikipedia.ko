...
\(D\)차원의 격자 \(\Lambda\)위의 **XY 모형**은 다음과 같은 자유도 및 [해밀토니언으로](../Page/해밀토니언_\(양자역학\).md "wikilink") 정의되는 통계역학 모형이다.
...
위 식에서, \(\textstyle\sum_{\langle ij\rangle}\)은 격자에서 서로 이웃한 격자점의 쌍에 대한 합을 뜻한다. \(J>0\)인 경우는 [강자성](../Page/강자성.md "wikilink"), \(J<0\)인 경우는 [반강자성](https://ko.wikipedia.org/wiki/반강자성 "wikilink")에 해당한다.
...
\[H=-J\sum_{i=1}^N\cos\phi_i\] 이며, 그 [분배 함수는](../Page/분배_함수_\(통계역학\).md "wikilink") 다음과 같다.
...
2차원 XY 모형은 **코스털리츠-사울리스 전이**()라는 [상전이](../Page/상전이.md "wikilink")를 보인다. 높은 온도에서는 스핀의 기댓값은 0이며, 스핀의 상관 함수는 긴 거리에서 지수적으로 0으로 수렴한다.
...
[머민-바그너 정리로](../Page/머민-바그너_정리.md "wikilink") 인하여 2차원에는 [자발 대칭 깨짐이](../Page/자발_대칭_깨짐.md "wikilink") 부재하므로, 절대 영도에서도 스핀의 기댓값은 0이다. 그러나 스핀의 상관 함수는 낮은 온도에서 지수 법칙 대신 거듭제곱 법칙을 따른다.
...
2차원 XY 모형의 저에너지 극한은 자유 주기 보손의 [2차원 등각 장론이다](../Page/2차원_등각_장론.md "wikilink").

### 3차원

3차원 XY 모형은 자유 아벨 [게이지 이론의](../Page/게이지_이론.md "wikilink") 격자화로 해석할 수 있다. 3차원에서 게이지장 \(F_{ij}\)는 한 개의 자유도를 가지며, 구체적으로 이는 쌍대화

\[4\pi g^2\partial_i\theta=\epsilon_{ijk}F_{jk}\] 를 통해 나타낼 수 있다. 이렇게 정의한 스칼라장 \(\theta\)는 게이지 변환에 의하여 주기적이며, 따라서 XY 모형의 각도로 해석할 수 있다.

낮은 온도에서는 [U(1)](https://ko.wikipedia.org/wiki/U\(1\) "wikilink") 게이지 대칭의 [자발 대칭 깨짐으로](../Page/자발_대칭_깨짐.md "wikilink") 인하여, 스핀이 기댓값을 갖는다.
...
\[\langle\exp(i(\theta_i-\theta_j))\rangle_\beta
\sim \exp(-c(\beta)|i-j|)\qquad(\beta\ll1)\] 이 두 상 사이에서는 어떤 임계 온도 \(T_{\text{c}}\)에서 [상전이](../Page/상전이.md "wikilink")([자발 대칭 깨짐](../Page/자발_대칭_깨짐.md "wikilink"))가 발상한다.

3차원에서도 상전이는 [솔리톤](../Page/솔리톤.md "wikilink")과 관계있다. 고온 상에서는 여차원이 1인 소용돌이가 발생하며, 주기 스칼라장 \(\theta\)는 소용돌이 둘레에 자명하지 않은 [모노드로미](../Page/모노드로미.md "wikilink")를 갖는다. 반면, 저온 상에서는 소용돌이가 억제된다.
