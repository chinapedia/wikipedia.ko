...
\[g(x)=f(x)-f(a)-\frac{f(b)-f(a)}{b-a}(x-a)\] 그렇다면, \(g\)는 [롤의 정리의](../Page/롤의_정리.md "wikilink") 조건을 다음과 같이 만족시킨다.
...
이 정리의 최초의 입안자는 [인도](../Page/인도.md "wikilink")의 [바타세리 파라메슈바라](https://ko.wikipedia.org/wiki/바타세리_파라메슈바라 "wikilink")(Vatasseri Parameshvara)로 기록되어 있으며\[4\] 처음으로 공식화한 사람은 [오귀스탱 루이 코시이다](../Page/오귀스탱_루이_코시.md "wikilink").
