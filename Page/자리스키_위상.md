...
[대수기하학](../Page/대수기하학.md "wikilink")에서, **자리스키 위상**()은 [대수다양체](../Page/대수다양체.md "wikilink")나 [스킴에](../Page/스킴_\(수학\).md "wikilink") 일반적으로 주어지는 [위상이다](https://ko.wikipedia.org/wiki/위상_공간_\(수학\) "wikilink"). 자리스키 위상에서는 다항식의 해집합을 닫힌 집합으로 정의한다.
