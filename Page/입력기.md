...
[섬네일](https://ko.wikipedia.org/wiki/파일:Interface_of_Weasel_Input_Method.png "wikilink") 기반 IME를 조작하는 모습.\]\] **입력기** 또는 **입력 방식 편집기**()는 [한글](https://ko.wikipedia.org/wiki/한글 "wikilink"), [한자](../Page/한자.md "wikilink")처럼 [컴퓨터 자판에](../Page/컴퓨터_자판.md "wikilink") 있는 글쇠보다 수가 더 많은 문자를 계산하거나 조합하여 입력해 주는 [시스템 소프트웨어이다](../Page/시스템_소프트웨어.md "wikilink").
