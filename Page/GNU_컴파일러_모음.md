...
버전 4.3을 기준으로 GCC는 다음의 프로세서 계열을 대상으로 한다:
  ...
  - [IA-32](https://ko.wikipedia.org/wiki/IA-32 "wikilink") ([x86](https://ko.wikipedia.org/wiki/x86 "wikilink"))
  ...
  - [SPARC](https://ko.wikipedia.org/wiki/SPARC "wikilink")
...
표준 릴리즈에서 지원되는, 위보다 잘 알려지지 않은 프로세서는 다음을 포함한다:
  ...
  - [MMIX](https://ko.wikipedia.org/wiki/MMIX "wikilink")
