> This article is converted from Wikipedia: [데이터 분산 서비스](https://ko.wikipedia.org/wiki/데이터_분산_서비스).
...
[분류:분산 컴퓨팅](https://ko.wikipedia.org/wiki/분류:분산_컴퓨팅 "wikilink") [분류:통신](https://ko.wikipedia.org/wiki/분류:통신 "wikilink") [분류:컴퓨터 표준](https://ko.wikipedia.org/wiki/분류:컴퓨터_표준 "wikilink")