...
원래 OpenGL 유틸리티 툴킷 라이브러리는 X 윈도 시스템을 지원하기 위하여 마크 킬가드가 개발하였으며 이후에 네이트 로빈스에 의하여 [마이크로소프트](../Page/마이크로소프트.md "wikilink")사의 WiggleWin32로 포팅되었다. 또한 현재는 [애플사의](https://ko.wikipedia.org/wiki/애플_\(기업\) "wikilink") [매킨토시](../Page/매킨토시.md "wikilink") 운영 체제에서도 사용되고 있다.
