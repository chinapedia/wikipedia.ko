...
[추상대수학](https://ko.wikipedia.org/wiki/추상대수학 "wikilink")에서, **프로베니우스 대수**()는 호환되는 내적이 주어진 유한 차원 [단위 결합 대수이다](https://ko.wikipedia.org/wiki/단위_결합_대수 "wikilink").

## 정의

체 \(k\) 위의 유한 차원 [결합 대수](https://ko.wikipedia.org/wiki/결합_대수 "wikilink") \(A\)가 주어졌다고 하자. 이는 스스로 위의 [쌍가군](https://ko.wikipedia.org/wiki/쌍가군 "wikilink") \(_AA_A\)을 이룬다. 마찬가지로, 그 [쌍대 가군](https://ko.wikipedia.org/wiki/쌍대_가군 "wikilink")

\[A^\vee = \hom_K(K,A)\] 역시 스스로 위의 쌍가군 \(_AA^\vee_A\)을 이룬다. 구체적으로,

\[a\cdot \phi \cdot b \colon x \mapsto \phi(bxa)\] 이다.

그렇다면, 다음 조건들이 서로 [동치](https://ko.wikipedia.org/wiki/동치 "wikilink")이다.
...
또한, 이러한 동형이 존재할 [필요 조건은](https://ko.wikipedia.org/wiki/필요_조건 "wikilink") 물론 \(A\)가 유한 차원 \(k\)-[벡터 공간인](https://ko.wikipedia.org/wiki/벡터_공간 "wikilink") 것이다.

이러한 동형이 갖추어진 \(k\)-[결합 대수를](https://ko.wikipedia.org/wiki/결합_대수 "wikilink") **프로베니우스 대수**라고 한다.
...
[가환환](https://ko.wikipedia.org/wiki/가환환 "wikilink")인 프로베니우스 대수를 **가환 프로베니우스 대수**()라고 한다.

### 프로베니우스 대상

보다 일반적으로 [모노이드 범주](https://ko.wikipedia.org/wiki/모노이드_범주 "wikilink") \((\mathcal C, \otimes,1)\)가 주어졌다고 하자. 그렇다면, 그 [반대 범주](https://ko.wikipedia.org/wiki/반대_범주 "wikilink") \((\mathcal C^{\operatorname{op}}, \otimes,1)\) 역시 같은 텐서곱으로 [모노이드 범주를](https://ko.wikipedia.org/wiki/모노이드_범주 "wikilink") 이룬다.

\(\mathcal C\) 속의 **프로베니우스 대상**()은 다음과 같은 데이터로 주어진다.

  - [모노이드 대상](https://ko.wikipedia.org/wiki/모노이드_대상 "wikilink") \((A,\mu\colon A\otimes A\to1,\eta\colon 1\to A)\)
  - [쌍대 모노이드 대상](https://ko.wikipedia.org/wiki/쌍대_모노이드_대상 "wikilink") (즉, \(\mathcal C^{\operatorname{op}}\)의 [모노이드 대상](https://ko.wikipedia.org/wiki/모노이드_대상 "wikilink")) \((A,\delta\colon A\to A\otimes A,\eta\colon A\to1)\)
...
[thumb](https://ko.wikipedia.org/wiki/파일:Pair_of_pants_cobordism_\(pantslike\).svg "wikilink") 2차원 [위상 양자장론은](https://ko.wikipedia.org/wiki/위상_양자장론 "wikilink") 가환 프로베니우스 대수로 나타내어진다.\[1\]\[2\] 정확히 말하면, (복소) 가환 프로베니우스 대수의 [범주는](https://ko.wikipedia.org/wiki/범주_\(수학\) "wikilink") 2차원 위상 양자장론의 범주와 [동치이다](https://ko.wikipedia.org/wiki/범주의_동치 "wikilink"). 프로베니우스 대수와 위상 양자장론은 다음과 같이 대응된다.

| 기호                             | 가환 프로베니우스 대수 | 2차원 [위상 양자장론](https://ko.wikipedia.org/wiki/위상_양자장론 "wikilink")                                                                                                                        |
| ------------------------------ | ------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| \(V\)                          | 프로베니우스 대수    | 원 \(S^1\)의 힐베르트 공간 \(E(S^1)\)                                                                                                                                                          |
| \(\langle\cdot,\cdot\rangle\)  | 프로베니우스 형식    | [힐베르트 공간의](https://ko.wikipedia.org/wiki/힐베르트_공간 "wikilink") 내적                                                                                                                        |
...
임의의 유한군 \(G\)에 대하여, [군환](https://ko.wikipedia.org/wiki/군환 "wikilink") \(K[G]\) 위에 프로베니우스 형식
...
[유한군](https://ko.wikipedia.org/wiki/유한군 "wikilink") \(G\)가 주어졌다고 하자. \(G\)의 유리수 계수 유니터리 [표현환](https://ko.wikipedia.org/wiki/표현환 "wikilink")
...
[리하르트 브라우어와](https://ko.wikipedia.org/wiki/리하르트_브라우어 "wikilink") 세실 네스빗()이 1937년 도입하였고,\[3\] [페르디난트 게오르크 프로베니우스의](https://ko.wikipedia.org/wiki/페르디난트_게오르크_프로베니우스 "wikilink") 이름을 땄다.
