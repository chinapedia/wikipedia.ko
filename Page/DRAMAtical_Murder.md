...
지금보다 더 앞선 미래. 일본 열도의 남서에 위치하는 **'미도리 섬**'. 과거의 그 곳은 자연과 사람이 공존하는 풍요로운 섬이었다. 그러나 일본 유수의 재벌 중 하나인 '토우에 재벌'에 의해 섬이 팔려, 섬의 약 3분의 1이 고급 회원제 오락 시설 **'플래티넘 제일**'로 모습을 바꾸었다.
...
공통 루트로 선택사항(2택)을 올바르게 선택함으로써 효율적으로 각 캐릭터의 루트로 분기할 수 있다.

## 외부 링크

  - [Nitro+CHiRAL 공식 사이트](http://www.nitrochiral.com/) - <span style="color:red">18세 미만 열람 금지 페이지로의 링크 있음</span>

  - [『DRAMAtical Murder』 오리지널 사운드 트랙 「- shape.memory.music -」 특설](https://web.archive.org/web/20121016045614/http://www.georide.jp/special/dmmd_soundtrack/)

  - [PS Vita『DRAMAtical Murder re:code』](http://dmmd.jp/)
