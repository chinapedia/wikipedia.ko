...
[섬네일에](https://ko.wikipedia.org/wiki/파일:Free_and_open-source-software_display_servers_and_UI_toolkits.svg "wikilink") 통합되었다.\]\] **udev**는 [리눅스 커널을](https://ko.wikipedia.org/wiki/리눅스_커널 "wikilink") 위한 장치 관리자이다. [devfsd](https://ko.wikipedia.org/wiki/devfsd "wikilink")와 hotplug를 계승하는 udev는 주로 [/dev](https://ko.wikipedia.org/wiki/Devfs "wikilink") 디렉터리의 [장치 노드를](https://ko.wikipedia.org/wiki/장치_파일 "wikilink") 관리한다. 동시에 udev는 특정 장치에 필요한 [펌웨어](https://ko.wikipedia.org/wiki/펌웨어 "wikilink") 적재를 포함하여 하드웨어 장치가 시스템에 추가되거나 제거되는 동안 발생한 모든 사용자 공간 이벤트들을 관리한다.

## 개요

/dev 디렉터리의 [장치 노드들에](https://ko.wikipedia.org/wiki/장치_노드 "wikilink") 정적인 파일들을 모아두는 전통적인 [유닉스](https://ko.wikipedia.org/wiki/유닉스 "wikilink") 시스템과는 달리, 리눅스의 udev 장치 관리자는 시스템에 실제로 존재하는 장치들의 노드들만 동적으로 제공한다. [devfs가](https://ko.wikipedia.org/wiki/장치_파일 "wikilink") 비슷한 기능을 제공하는데 사용되지만, [그레그 크로아 하트먼은](https://ko.wikipedia.org/wiki/그레그_크로아_하트먼 "wikilink") devfs 보다 udev를 선호하는 이유\[1\]를 다수 언급하였다.
...
udev를 크게 보면 세 가지로 나뉜다:
  ...
  - [라이브러리](https://ko.wikipedia.org/wiki/라이브러리_\(컴퓨팅\) "wikilink") libudev는 장치 정보의 접근을 허용한다. [systemd](https://ko.wikipedia.org/wiki/systemd "wikilink") 소프트웨어 번들에 통합되었다.
  - 가상 /dev를 관리하는 사용자 공간 [데몬](https://ko.wikipedia.org/wiki/데몬_\(컴퓨팅\) "wikilink") udevd.
