...
**전자회로 소자**는 고체 내 전자의 [전도](https://ko.wikipedia.org/wiki/전기전도 "wikilink")(傳導)를 이용한 전자 부품 즉, 다이오드, 태양 전지, 트랜지스터 등을 이르는 말이다. 전자/전기회로를 구성할 때 많은 [전자 부품을](../Page/전자_부품.md "wikilink") 사용한다. 이론적 측면에서 보면 [수동소자](https://ko.wikipedia.org/wiki/수동소자 "wikilink")와 [능동소자](https://ko.wikipedia.org/wiki/능동소자 "wikilink")로 구별할 수 있다. 이 소자들은 각각 [회로이론](https://ko.wikipedia.org/wiki/회로이론 "wikilink"), [논리 회로](../Page/논리_회로.md "wikilink")([디지털공학](https://ko.wikipedia.org/wiki/디지털_전자공학 "wikilink")) 등과 기타 전자공학과 연결되어 있다. [수동소자](https://ko.wikipedia.org/wiki/수동소자 "wikilink")는 R([저항](https://ko.wikipedia.org/wiki/저항기 "wikilink")), L([코일](../Page/코일.md "wikilink")),C([축전기](../Page/축전기.md "wikilink"), 콘덴서) 등이 대표적이다. 수동소자로 구성된 회로를 해석하는 것이 회로이론(회로망) 이다. 능동소자로는 [다이오드](https://ko.wikipedia.org/wiki/다이오드 "wikilink"), [BJT](https://ko.wikipedia.org/wiki/접합형_트랜지스터 "wikilink"), [FET](../Page/장효과_트랜지스터.md "wikilink") 등이 있고 이것들은 전자회로에서 해석한다. 능동소자의 결합으로 [연산 증폭기](../Page/연산_증폭기.md "wikilink")(op amp)을 만들 수 있고 이것 역시 전자회로에서 해석한다. 연산증폭기는 [아날로그](https://ko.wikipedia.org/wiki/아날로그 "wikilink") 신호처리에서 기본이다. 증폭기가 가장 기본으로 많이 사용한다.

수학의 디지털 개념을 적용하기 위해 논리회로 적인 개념을 만들고, [조합 논리](https://ko.wikipedia.org/wiki/조합_논리 "wikilink") 회로([combinational logic](https://ko.wikipedia.org/wiki/:en:Combinational_logic "wikilink"))와 [순차 논리](https://ko.wikipedia.org/wiki/순차_논리 "wikilink")([sequential logic](https://ko.wikipedia.org/wiki/:en:Sequential_logic "wikilink"))으로 나뉜다. 이것과 메모리를 결합으로 [마이크로프로세서](https://ko.wikipedia.org/wiki/마이크로프로세서 "wikilink")를 만든다. 좀더 복잡한 디지털회로라면 개발자가 임의의 디지털 회로를 만들 기 위해 [FPGA](../Page/FPGA.md "wikilink")을 사용하여 원하는 디지털 회로를 넣을 수 있다.
...
수동소자:
  ...
  - L: 전기 에너지를 [자기장](https://ko.wikipedia.org/wiki/자기장 "wikilink")으로 저장한다. 이론적으로 에너지를 소모하지 않고 저장 한다. (인덕터)
...
#### 능동소자
  ...
  - [다이오드](https://ko.wikipedia.org/wiki/다이오드 "wikilink"): 기본적으로 전기 흐름의 방향을 한 쪽으로만 흐르게 한다. 제너다이오드 등은 역방향의 전류를 이용하는 경우도 있다.
...
## 같이 보기
  ...
  - [능동소자](https://ko.wikipedia.org/wiki/능동소자 "wikilink")
