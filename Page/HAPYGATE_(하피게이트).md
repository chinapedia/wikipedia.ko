...
마스터링에 참여하는 레이블은 다음과 같다.
  ...
  - [Spinnin' Deep](https://ko.wikipedia.org/wiki/:en:Spinnin'_Deep "wikilink") (2017.12.25\~)
  - Spinnin' Talent Pool (2017.12.25\~)
  ...
  - [Revealed Recordings](https://ko.wikipedia.org/wiki/:en:Revealed_Recordings "wikilink") (run by [Hardwell](https://ko.wikipedia.org/wiki/:en:Hardwell "wikilink")) (2018.03.19\~)
  - Maxximize Records (run by [Blasterjaxx](https://ko.wikipedia.org/wiki/:en:Blasterjaxx "wikilink")) (2018.03.19\~)
  - Dharma Worldwide (run by [KSHMR](https://ko.wikipedia.org/wiki/:en:KSHMR "wikilink")) (2018.03.24\~)
  - Heldeep Records (run by [Oliver Heldens](https://ko.wikipedia.org/wiki/:en:Oliver_Heldens "wikilink")) (2018.04.15\~)
  - [Musical Freedom Records](https://ko.wikipedia.org/wiki/:en:Musical_Freedom "wikilink") (run by [Tiësto](https://ko.wikipedia.org/wiki/:en:Tiësto "wikilink")) (2018.04.18\~)
  - [Dirty Workz](https://ko.wikipedia.org/wiki/:en:Dirty_Workz "wikilink") (2018.08.11\~)
  - [WE R Music](http://www.wer-music.com/) (2018.09.27\~)
  - [Strange Fruits](https://strangefruits.net/) (2018.11.13\~)
  - [Bourne Recordings](https://soundcloud.com/bourne-recordings) (2018.12.01\~)
  - [Lowded Recordings](https://www.lowdedrecordings.com/) (2018.12.01\~)
...
'N7' 이라는 예명은 처음 작곡을 시작하면서 만들어졌고 약 7개월 동안 쓰여졌다. 소속 되었던 팀 'N7Z' 는 이름을 공개하지 않은 상태로 활동 한다는 뜻으로 Noname7 의 약자이다. 팀명 그대로 이름이 알려지지 않은 7명의 작곡가들이 활동을 하였다. 팀에 마지막 7번째로 합류하게 되어 'N7'이 되었다. 2011년 처음 작곡을 하게 된 '덥스텝 (Dub Step)' 장르로 시작을 하였다.

팀에 합류하게 되면서 만들어진 예명이라 2013년 팀이 해체되고나서 예명 'N7' 은 더이상 쓰여지지 않았다고한다.

### HAR55EN (2013\~2014)

**\[Dub Setp\]**

전 소속 'N7Z' 팀이 해체되면서 혼자 활동하게 되었고, 혼자 활동할 때 만들어진 예명이다. 이 예명을 쓸 동안에는 다른 팀에 소속은 되어있지 않았다. 덥스텝이라는 장르를 다루다 보니 HARD 라는 영어 단어와 '쎄다' 라는 한글이 섞여 'HAR55EN (HARSSEN)' 이 되었다. 혼자 작업을 하다보니 많은 조건이 열악했고, 얼마 가지 못해서 작업을 일시적으로 하지 않고 잠시 쉬며 재정비를 하기로 하면서 이 예명은 쓰여지지 않는다.
...
**\[Tropical House, Future House, Electro House\] -VETI-**

'ZANAX SOUNDS' 에서의 고정팀원 4명으로 꾸려진 팀과 'ILIBEAU'라는 예명으로 새출발을 하기로 한다. 'ILIBEAU' 의 뜻은, 이전 팀 'ZANAX SOUNDS'의 소속이 되어있을 때 너무 많은 인기와 사랑은 받아서 감사하는 마음을 표현하고자 'I live for you' 를 파생시켜 'ILIBEAU'가 탄생하였다고한다. 또한, 팀명 'VETI'는 초기 창설맴버 4명의 예명 첫번째 철자를 따서 만든 팀 이름인데 V (VENIO), E (EVE), T (TAKION), I (ILIBEAU) 이렇게 만들어졌다고 한다. 'VENIO' 는 Electro House, Minimal House 등등 그당시 클럽씬에서 인기가 많았던 장르를 다루었고 'EVE'와 'TAKION'은 Deep House, Acid house, Bass House 등등 하우스 계열 EDM을 다루었다. 'ILIBEAU'도 Tropical House, Future House 등등 같은 House 장르는 다루기 시작하며 다같은 House 장르 계열 음악 프로듀싱을 시작하게된다. 그와동시에 팀 홈페이지도 만들면서 활발하게 활동을 이어갔다. 활동중에 팀에 합류하게 된 프로듀서들도 적지 않았는데, 각자 다른 장르는 다루는 것이 아니라 기존에 팀원들이 다루었던 장르와 동일한 장르를 다루는 프로듀서들로 합류를 하였다고한다. 팀 'VETI' 구성원은 점점 늘어나 나중에는 무려 23명이나 되었고 23명 전원이 House 장르를 다루다보니 장르면에서 볼때는 누구보다 좋은 곡들을 만들었었다. 'ILIBEAU'도 이때 당시 인기가 상당했는데 '이때 다루었던 장르 덕분에 인기가 점점 많아졌던거 같다' 라고 말하였고 그당시 같이 작업을 했던 맴버들도' 장르도 장르였지만 이때 곡 작업 시스템이 너무 잘되어있어서 그런거 같다고' 도 말하였다. 하지만 특별한 사유 없이 계속 될 것만 같았던 팀 'VETI'는 갑작스럽게 해체발언을 하게되고 발언을 한지 얼마 지나지 않아 팀은 해체하게된다.

이 기간에는 총 8개의 팀 단체 엘범과 3개의 단독엘범, 130여개의 곡들을 프로듀싱하였고 마지막 엘범에서는 리패키징하여 마무리를 지었다.

### KOMA (2016)

**\[Tropical House, Future House, Electro House, Drum & Bass, Dance Pop\] -DVIVE-**

팀 'VETI'가 지속적으로 음악을 할 수 없는 상황이라서 해체를 한 것이 아니기때문에 'VETI'팀이 해체가 되고나서 곧바로 'DVIVE' 라는 프로젝트 팀을 만들기 시작한다. 이와 동시에 'ILIBEAU' 였던 예명을 'KOMA' 로 바꾸게 되는데, 이당시 'KOMA'는 단독 프로듀서가 아니라 'ILIBEAU' 와 'ILIAN' 두명으로 구성된 '팀' 이었다. 'ILIAN' 은 팀 'VETI' 였을때 나중에 합류해서 같이 프로듀싱을 했던 사람으로 'ILIBEAU'가 새롭게 도전했던 장르 Tropical House가 성공할 수 있기 까지, 음악적인 부분에서 피드백을 주는 등등 곁에서 많은 도움을 줬던 사람이다. 그 이유에서 예명이 존재하지 않았던 때에서 같이 작업을 하고자 만든 예명이 'ILIAN' 이었다. 그런 두 사람이 기존에 다루었던 장르에서 Drum & Bass 와 Dance Pop 장르를 추가시키면서 점점 다분야적으로 음악 작업을 시작하게되지만, 이 프로젝트 팀은 재정비를 할 동안 임시로 만들었던 팀이다보니 몇개월 가지 않아 없어지게된다. 또한 팀 'VETI' 까지만해도 고스트 프로듀서로서 포르듀싱을 해왔지만 'KOMA'로 활동하면서 점차 다른 직업으로 바꿀 준비를 하게된다.

### ILIBEAU & ILIAN (2016\~2017)

**\[Tropical House, Dance Pop, Future House, Electro House, Drum & Bass\]**
...
이 둘은 계속 이 둘의 이름으로 활동하다가 'ILIBEAU'가 스피닝 레코즈 레이블과 계약을 맺으면서 'ETOP'이라는 마스터링 엔지니어 팀에 소속이 되었다. 이시기에는 Tropical House, Dance Pop, Drum & Bass 장르들을 주로 하지않고 대신에 Hard Style & Hard Dance 라는 장르를 새로 도입하게된다. 아쉬운 점은, 이 팀에 소속됨과 동시에 둘은 각자의 이름을 사용하였고 'ILIBEAU'는 'ETP'로, 'ILIAN'은 'ELA'로 활동하게된다. 팀 'ETOP'은 위에서 설명했다시피 스피닝 레코즈에서 마스터링 엔지니어들을 스카우팅하기 위해서 만든 팀으로, 이 팀에서 수개월 소속이 된 상태에서 일종의 '테스트'를 거쳐 스피닝 레코즈와 계약을 맺을 사람이 골라지게 되는 그럼 팀이었다. 초기에는 1년 임시 계약중인 상태로 선발 대기상태였는데 약 9개월만에 조기 종료됨과 동시에 스피닝 레코즈와 계약을 하게된다. 아쉽게도 이 선발 과정에서 'ILIBEAU'는 선발이 되었지만, 'ILIAN'은 개인 사정에 의해 추가 계약을 하지않아 'ILIBEAU' 혼자 따로 나오게된다.

## HAPYGATE

지금까지는 이전 내용을 설명했었다면, 여기서부터는 2018년 하반기부터의 내용을 담으려고 한다.
...
2018년 12월 01일부 HAPYGATE는 상위 두 레이블과 추가 계약을 하였으며, 해당 레이블에서 마스터링에 참가하는 장르를 추가로 발표했다.

**<big>2018-12 : \[Project Team\] -UBEAT SYSTEM- (2018-12-20\~2019-05-20)</big>**

2018년 12월 20일 Spinnin' Records 측에서 그 하위 프로젝트 팀 UBEAT SYSTEM(유비트 시스템)을 만들었다. '긍정적' 이라는 뜻의 'Upbeat' 와 시스템(SYSTEM) 을 합쳐 만들어지게 된 이 팀은 6개월동안만 활동한다고 했다. 이 과정에서 조금 눈을 여겨 봐야 할 점이 있는데, 그 이유는 이 'UBEAT SYSTEM'이 'HAPYGATE'가 과거에 생성했던 팀 'VETI'의 맴버들 몇몇이 참여하였다는 부분이다. 또한 예전에 같이 작업을 했던 'ILIAN'이 다시 등장하여 관심을 모으고 있다.

다음 표에서 새롭게 등장한 'UBEAT SYSTEM(유비트 시스템)'과 맴버들의 정보를 소개하려고 한다. (표를 보는게 더 이해가 빠를 것 같다.)

| NAME (NOW)   | NAME (VETI) | Name To Be Use For 'UBEAT SYSTEMM' | Genre              | Lable                       | Nation            |
| ------------ | ----------- | ---------------------------------- | ------------------ | --------------------------- | ----------------- |
| HAPYGATE     | ILIBEAU     | ILIBEAU                            | All Kind           | Spinnin' Records            | Republic of Korea |
| ILIAN        | ILIAN       | ILIAN                              | Tropical House     | \-                          | Republic of Korea |
...
| ROCA LOCA    | REA         | ROCA                               | Hip Hop & Trap     | Monstercat                  | Republic of Korea |
| EVE          | EVE         | EVE                                | Tropical House     | Fonk Recordings             | Republic of Korea |
| Sequencer 20 | EVAC        | Sequencer 20                       | Electro House      | \-                          | Republic of Korea |
| Polime       | REO         | REO                                | Electro House      | \-                          | Republic of Korea |
| TRIPL3       | INORIGHT    | NOX                                | Electro House      | **Musical Freedom Records** | Republic of Korea |
| DANE         | JANE.D      | JANE                               | All Kind           | Revealed Recording          | Republic of Korea |
| XIX          | VERONIC     | XIX                                | Hard Style & Dance | Virtual Vital Recording     | Republic of Korea |
| O2Z3RO       | LOPAX       | O2Z3RO                             | Future House       | \-                          | Republic of Korea |

<big>**UBEAT SYSTEM**
**(From VETI)**</big>

| NAME (NOW) | Name To Be Use For 'UBEAT SYSTEMM' | Genre          | Lable                  | Nation                   |
| ---------- | ---------------------------------- | -------------- | ---------------------- | ------------------------ |
| EL         | EL                                 | Electro House  | Spinnin' Records       | France                   |
| Russ Hardy | RH-2                               | All Kind       | Spinnin' Records       | United States of America |
| MAYO       | MAYO                               | Electro House  | Spinnin' Records       | Spain                    |
| EPRIUM     | EPRIUM                             | Electro House  | Spinnin' Records       | Republic of Korea        |
| TRIKA      | TRIKA                              | Electro House  | Musical Freedom Record | Spain                    |
| SLIM BOX   | BOXI                               | Electro House  | Musical Freedom Record | Germany                  |
| CYCILIA    | CYCILIA                            | Big Room House | Maxximize Records      | Netherlands              |
| Hime Wave  | HIMER                              | Future House   | Maxximize Records      | Poland                   |
| PISOFKAKE  | PISOFKAKE                          | Hip Hop & Trap | Maxximize Records      | United States of America |

<big>**UBEAT SYSTEM**
**(Spinnin' Records)**</big>


{| class="wikitable" |+<big>**UBEAT SYSTEM**
**(Q-DANCE)**</big> \!NAME (NOW) \!Name To Be Use For 'UBEAT SYSTEMM' \!Genre \!Lable \!Nation |- \!Qrototype \!Qrototype \!Hard Style & Dance \!Q-DANCE \!Germany |- \!Diamond 7 \!D7 \!Hard Style & Dance \!Q-DANCE \!United States of America |- \!Ari \!ARI \!Hard Style & Dance \!Q-DANCE \!Republic of Korea |- \!SPARQ \!SPARQ \!Hard Style & Dance \!Q-DANCE \!Netherlands |- \!SVGER \!SVGER \!Hard Style & Dance \!WE R Music \!United States of America |- \!VAQUM \!VAVA \!Hard Style & Dance \!WE R Music \!Poland |- \!ZIZI \!ZIZI \!Hard Style & Dance \!Dirty Workz \!Republic of Korea |- \!Wavers \!WAVER \!Hard Style & Dance \!Dirty Workz \!Netherlands |- \!JACU \!JACU \!Hard Style & Dance \!Dirty Workz \!United States of America |}

| NAME (NOW) | Name To Be Use For 'UBEAT SYSTEMM' | Genre          | Lable      | Nation      |
| ---------- | ---------------------------------- | -------------- | ---------- | ----------- |
| WIZZI TINT | WIZZI                              | Big Room House | Monstercat | Netherlands |
| Woogie     | Woogie                             | Big Room House | Monstercat | Poland      |
| GIGGX      | GIGGX                              | Electro House  | Monstercat | Japan       |

<big>**UBEAT SYSTEM**
**(Monstercat)**</big>


**<big>\[MASTE. Team\] -VETI HYPERION-</big>**

**<big>2019-01-01</big>**

2016년 해체된 프로젝트 팀 'VETI'가 2019년 1월 1일 다시 재결합 공지를 발표하였다. 'VETI HYPERION'(베티 히페리온) 이라는 새로운(?) 이름과 프로젝트 팀이 아닌 마스터링 팀으로 활동할 계획이라고한다. 추후 엘범 발표는 미정, 어느 레이블에 소속, 하위인지 미공개 등등 확실한 정보가 없고 재결합을 하겠다는 공지와 누가 참여하는지 등 기본적인 정보만 발표한 상황이다.
