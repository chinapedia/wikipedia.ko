...
오라클 데이터베이스에 대한 임베디드 SQL 프리 프로세서로 Pro\* C/C++ 가 보급되어 있지만, 다른 Pro \* COBOL, Pro \* FORTRAN, Pro \* Pascal, SQL \* Module 등이 있다. 다른 데이터베이스 제품에서는 [Sybase](https://ko.wikipedia.org/wiki/Sybase "wikilink") 및 [PostgreSQL](../Page/PostgreSQL.md "wikilink")(ECPG)이 C 언어에 포함을 지원하고 있다.

## 임베디드 SQL을 지원하지 않는 시스템

### 마이크로소프트 SQL 서버

C용 임베디드 SQL은 [마이크로소프트 SQL 서버](../Page/마이크로소프트_SQL_서버.md "wikilink") 2008부터 미지원 상태이지만 초기 버전의 제품은 이를 지원한다.\[1\]

### MySQL

[MySQL](../Page/MySQL.md "wikilink")은 임베디드 SQL을 지원하지 않는다.
