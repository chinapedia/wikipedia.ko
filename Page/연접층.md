...
[대수기하학](https://ko.wikipedia.org/wiki/대수기하학 "wikilink")과 [복소기하학](https://ko.wikipedia.org/wiki/복소기하학 "wikilink")에서, **연접 가군층**(連接加群層, , ) 또는 단순히 **연접층**(連接層)은 유한 계수 [벡터 다발](../Page/벡터_다발.md "wikilink")(국소 자유층)의 [핵](https://ko.wikipedia.org/wiki/핵_\(수학\) "wikilink") · [여핵](https://ko.wikipedia.org/wiki/여핵 "wikilink")으로 구성할 수 있는 [가군층](../Page/가군층.md "wikilink")이다. 연접 가군층은 벡터 다발과 마찬가지로 공간의 기하학적 성질과 밀접하게 연관된 좋은 성질을 가지며, [카르탕 정리나](../Page/카르탕_정리.md "wikilink") [가가 정리](../Page/가가_정리.md "wikilink") 등 대수기하학과 복소해석기하학에서의 여러 정리가 성립한다.

벡터 다발은 [수학](https://ko.wikipedia.org/wiki/수학 "wikilink")의 여러 분야에서 매우 중요한 개념이다. 대수기하학에서 [세르-스완 정리에](../Page/세르-스완_정리.md "wikilink") 따라 (유한 차원) "벡터 다발"은 (유한 계수) [국소 자유 가군층에](https://ko.wikipedia.org/wiki/국소_자유_가군층 "wikilink") 대응한다. 그러나 주어진 [위상 공간](https://ko.wikipedia.org/wiki/위상_공간_\(수학\) "wikilink") \(X\) 위에 주어진 벡터 다발과 선형 [다발 사상의](https://ko.wikipedia.org/wiki/다발_사상 "wikilink") [범주](../Page/범주_\(수학\).md "wikilink") \(\operatorname{Vect}(X)\)는 [아벨 범주를](../Page/아벨_범주.md "wikilink") 이루지 않는다. 구체적으로, 벡터 다발의 [핵과](https://ko.wikipedia.org/wiki/핵_\(수학\) "wikilink") [여핵](https://ko.wikipedia.org/wiki/여핵 "wikilink")은 항상 [층으로서](https://ko.wikipedia.org/wiki/층_\(수학\) "wikilink") 존재하지만 벡터 다발을 이루지 않을 수 있다. 예를 들어, \(E\)가 \(X\) 위의 \(n\)차원 실수 벡터 다발이고, \(f\colon X\to\mathbb R\)가 [연속 함수라고](https://ko.wikipedia.org/wiki/연속_함수 "wikilink") 하자. 그렇다면 \(f^*\colon E\to E\), \(f^*\colon v\in E_x\mapsto f(x)v\in E_x\)는 선형 다발 사상이다. 만약 \(f\)가 어느 곳에서도 0이 아니라면, 핵 \(\ker f^*\)는 0차원의 자명한 벡터 다발이고, 공핵 \(\operatorname{coker}f^*\cong E\) 또한 \(n\)차원 벡터 다발이다. 그러나 \(f\)가 \(x\in X\)에서 0이라면, 이 점에서 \(f^*\)의 핵 \(\ker f^*\)는 0차원이 아니라 \(n\)차원이며, 반대로 \(\operatorname{coker}f^*\)는 0차원이다. 벡터 다발의 모든 올들은 차원이 같아야 하므로, 이 경우 \(f^*\)의 핵과 여핵은 \(X\) 벡터 다발을 이루지 않는다.
...
[환](https://ko.wikipedia.org/wiki/환_\(수학\) "wikilink") \(R\) 위의 [왼쪽 가군](https://ko.wikipedia.org/wiki/왼쪽_가군 "wikilink") \(_RM\)이 다음 조건을 만족시킨다면, **연접 왼쪽 가군**(連接-加群, )이라고 한다.\[1\]

  - [유한 생성 왼쪽 가군이다](https://ko.wikipedia.org/wiki/유한_생성_왼쪽_가군 "wikilink").
  - 임의의 \(R\)-[부분 가군](https://ko.wikipedia.org/wiki/부분_가군 "wikilink") \(N\subseteq M\)에 대하여, 만약 \(N\)이 [유한 생성 왼쪽 가군이라면](https://ko.wikipedia.org/wiki/유한_생성_왼쪽_가군 "wikilink"), [유한 표시 왼쪽 가군이다](https://ko.wikipedia.org/wiki/유한_표시_왼쪽_가군 "wikilink"). (즉, 임의의 \(R\)-[가군 준동형](https://ko.wikipedia.org/wiki/가군_준동형 "wikilink") \(R^n\to M\)의 [핵은](https://ko.wikipedia.org/wiki/핵_\(수학\) "wikilink") [유한 생성 왼쪽 가군이다](https://ko.wikipedia.org/wiki/유한_생성_왼쪽_가군 "wikilink").)
...
위 정의는 [장피에르 세르나](https://ko.wikipedia.org/wiki/장피에르_세르 "wikilink") [알렉산더 그로텐디크가](https://ko.wikipedia.org/wiki/알렉산더_그로텐디크 "wikilink") 사용하는 정의다. [로빈 하츠혼이](https://ko.wikipedia.org/wiki/로빈_하츠혼 "wikilink") 사용하는 정의\[4\]는 조금 다르지만, [뇌터 스킴의](https://ko.wikipedia.org/wiki/뇌터_스킴 "wikilink") 경우에는 위 정의와 동치이다.

### 연접환과 연접 공간

[환](https://ko.wikipedia.org/wiki/환_\(수학\) "wikilink") \(R\)에 대하여 다음 조건들이 서로 [동치](../Page/동치.md "wikilink")이며, 이를 만족시키는 환을 **왼쪽 연접환**(-連接環, )이라고 한다.
  ...
  - 임의의 \(r\in R\)에 대하여 \(\operatorname{Ann}(_Rr)\)는 [유한 생성](../Page/유한_생성_가군.md "wikilink") [왼쪽 아이디얼이며](https://ko.wikipedia.org/wiki/왼쪽_아이디얼 "wikilink"), 임의의 두 [유한 생성](../Page/유한_생성_가군.md "wikilink") [왼쪽 아이디얼의](https://ko.wikipedia.org/wiki/왼쪽_아이디얼 "wikilink") [교집합](https://ko.wikipedia.org/wiki/교집합 "wikilink")은 [유한 생성](../Page/유한_생성_가군.md "wikilink") [왼쪽 아이디얼이다](https://ko.wikipedia.org/wiki/왼쪽_아이디얼 "wikilink").\[11\]

**오른쪽 연접환**(-連接環, )도 마찬가지로 정의된다. 물론, [가환환](https://ko.wikipedia.org/wiki/가환환 "wikilink")의 경우 왼쪽·오른쪽을 구별할 필요가 없다.
...
[스킴](https://ko.wikipedia.org/wiki/스킴_\(수학\) "wikilink") 사상에 대하여, [준연접층](../Page/준연접층.md "wikilink")의 밂은 “거의 항상” [준연접층](../Page/준연접층.md "wikilink")이다. 즉, 매우 약한 조건 아래 준연접성이 보존된다. 그러나 연접성을 보존하려면 이는 매우 강한 조건([유한 사상](https://ko.wikipedia.org/wiki/유한_사상 "wikilink"))이 필요하다.
...
임의의 왼쪽 연접환 \(R\) 위의 연접 [왼쪽 가군들의](https://ko.wikipedia.org/wiki/왼쪽_가군 "wikilink") [범주](../Page/범주_\(수학\).md "wikilink") \(_R\operatorname{Coh}\)는 [아벨 범주이다](../Page/아벨_범주.md "wikilink"). 보다 일반적으로, 임의의 [환 달린 공간](../Page/환_달린_공간.md "wikilink") \((X,\mathcal O_X)\) 위의 연접 가군층들의 [범주](../Page/범주_\(수학\).md "wikilink") \(\operatorname{Coh}(X)\)는 [아벨 범주이다](../Page/아벨_범주.md "wikilink"). 즉, [핵과](https://ko.wikipedia.org/wiki/핵_\(범주론\) "wikilink") [여핵](https://ko.wikipedia.org/wiki/여핵 "wikilink") 등이 존재하며, [호몰로지 대수학을](https://ko.wikipedia.org/wiki/호몰로지_대수학 "wikilink") 할 수 있다. 그러나 이는 (거의 항상) [완비 범주나](../Page/완비_범주.md "wikilink") [쌍대 완비 범주가](https://ko.wikipedia.org/wiki/쌍대_완비_범주 "wikilink") 아닌데, 이는 유한 계수 [국소 자유 가군층들의](https://ko.wikipedia.org/wiki/국소_자유_가군층 "wikilink") 무한 직합 또는 직접곱은 유한 계수가 아니어서 연접 가군층이 아니기 때문이다.

### 아핀 스킴 위의 연접층

[뇌터](../Page/뇌터_환.md "wikilink") [가환환](https://ko.wikipedia.org/wiki/가환환 "wikilink") \(R\)에 대하여 다음 세 개념이 일치한다.
...
또한, \(R\) 위의 [유한 생성 가군들의](../Page/유한_생성_가군.md "wikilink") 범주 \(\operatorname{fgMod}(R)\)와 연접 가군층의 범주\(\operatorname{Coh}(X)\)는 서로 [동치이다](https://ko.wikipedia.org/wiki/범주의_동치 "wikilink").
...
**오카 연접성 정리**()에 따르면, [복소다양체](https://ko.wikipedia.org/wiki/복소다양체 "wikilink") \(M\) 위의 [정칙 함수의](https://ko.wikipedia.org/wiki/정칙_함수 "wikilink") 층은 연접 가군층이다.\[20\] 보다 일반적으로, \(M\) 위의 [해석적 벡터 다발](https://ko.wikipedia.org/wiki/해석적_벡터_다발 "wikilink") \(E\twoheadrightarrow M\)이 주어졌을 때, \(E\)의 단면층은 연접 가군층이다.
...
연접 가군층의 개념은 원래 [앙리 카르탕이](https://ko.wikipedia.org/wiki/앙리_카르탕 "wikilink") 1944년 경에 다변수 복소해석학에서 도입하였다. 1946년에 [오카 기요시는](https://ko.wikipedia.org/wiki/오카_기요시 "wikilink") 오카 연접성 정리를 증명하였다.\[21\]

1955년에 [장피에르 세르는](https://ko.wikipedia.org/wiki/장피에르_세르 "wikilink") 유명한 논문 〈대수적 연접층〉\[22\] 에서 연접층의 개념을 대수기하학에 응용하였다.
