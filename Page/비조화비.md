...
이는 [대칭군](https://ko.wikipedia.org/wiki/대칭군_\(군론\) "wikilink") \(S_4\)의 [작용으로](https://ko.wikipedia.org/wiki/군의_작용 "wikilink") 볼 수 있다. 다만, \(S_4\) 가운데 일부 원소들은 자명하게 작용한다.

\[(z_1,z_2;z_3,z_4) = (z_2,z_1;z_4,z_3) = (z_3,z_4;z_1,z_2) = (z_4,z_3;z_2,z_1)\] \(S_4\)의 작용의 [핵은](https://ko.wikipedia.org/wiki/핵_\(수학\) "wikilink") [클라인 4원군](https://ko.wikipedia.org/wiki/클라인_4원군 "wikilink") \((\mathbb Z/2)^2\)이며, 따라서 이는 사실 \(S_4/(\mathbb Z/2)^2\cong S_3\)의 작용이 된다. 이 군을 **비조화군**(非調和群, )이라고 하며, 이는 [모듈러 군](https://ko.wikipedia.org/wiki/모듈러_군 "wikilink") \(\operatorname{PSL}(2,\mathbb Z)=\langle S,T|S^2=(ST)^3=1\rangle\)의 [꼬임 부분군](https://ko.wikipedia.org/wiki/꼬임_부분군 "wikilink") \(\langle S,ST|S^2=(ST)^3=1\rangle\)에 대응한다.
