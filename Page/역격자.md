...
[결정학](https://ko.wikipedia.org/wiki/결정학 "wikilink")에서, [브라베 격자의](https://ko.wikipedia.org/wiki/브라베_격자 "wikilink") **역격자**(逆格子, )는 원래 격자의 모든 격자 벡터와의 내적이 정수인 벡터들이 이루는 브라베 격자이다.

## 정의

\(\Lambda\subset\mathbb R^n\)이 [브라베 격자라고](https://ko.wikipedia.org/wiki/브라베_격자 "wikilink") 하자. 즉, 유한한 수의 생성원을 가지고, 그 [선형생성 부분공간](https://ko.wikipedia.org/wiki/선형생성_부분공간 "wikilink")()이 \(\mathbb R^n\) 전체인 [아벨 군이라고](https://ko.wikipedia.org/wiki/아벨_군 "wikilink") 하자. 그렇다면 \(\Lambda\)의 **역격자** \(\Lambda^{-1}\)는 다음과 같은 집합이다.
...
3차원에서는 역격자의 기저를 [벡터곱](https://ko.wikipedia.org/wiki/벡터곱 "wikilink")을 사용하여 다음과 같이 쓸 수 있다.
...
[수학](https://ko.wikipedia.org/wiki/수학 "wikilink")과 [결정학](https://ko.wikipedia.org/wiki/결정학 "wikilink")에서는 위와 같은 정의를 사용하지만, [고체물리학](https://ko.wikipedia.org/wiki/고체물리학 "wikilink")에서는 간혹 다음과 같은 정의를 사용하기도 한다.
