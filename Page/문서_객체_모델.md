...
[섬네일](https://ko.wikipedia.org/wiki/파일:DOM-model.svg "wikilink")  **문서 객체 모델**(DOM; Document Object Model)은 [객체 지향](https://ko.wikipedia.org/wiki/객체_지향 "wikilink") 모델로써 구조화된 문서를 표현하는 형식이다. DOM은 플랫폼/언어 중립적으로 구조화된 문서를 표현하는 [W3C](../Page/W3C.md "wikilink")의 공식 표준이다. DOM은 또한 W3C가 표준화한 여러 개의 [API](../Page/API.md "wikilink")의 기반이 된다.
