> This article is converted from Wikipedia: [모듈:Catalog lookup link](https://ko.wikipedia.org/wiki/모듈:Catalog_lookup_link).
...
\--[--------------------------\< I S _ S E T \>------------------------------------------------------------------ Returns true if argument is set; false otherwise. Argument is 'set' when it exists (not nil) or when it is not an empty string.](https://ko.wikipedia.org/wiki/--------------------------\<_I_S_S_E_T_\>------------------------------------------------------------------_Returns_true_if_argument_is_set;_false_otherwise._Argument_is_'set'_when_it_exists_\(not_nil\)_or_when_it_is_not_an_empty_string. "wikilink")
...
Makes a wikilinked or plain text label from arguments; when both link and display text is provided, makes a wikilink in the form [D](https://ko.wikipedia.org/wiki/L "wikilink"); if only link is provided, makes a wikilinked label in the form [L](https://ko.wikipedia.org/wiki/L "wikilink"); if only display is provided, makes a plain-text label; if neither are provided makes a label from suffix, returns an empty string else.
...
`           label = table.concat ({'`[`',``   ``display,``   ``'`](https://ko.wikipedia.org/wiki/',_link,_' "wikilink")`'});            -- make `[`D`](https://ko.wikipedia.org/wiki/L "wikilink")` wikilinked label`
`       else`
`           label = table.concat ({'`[`',``   ``link,``   ``'`](https://ko.wikipedia.org/wiki/',_link,_' "wikilink")`'});                           -- make `[`L`](https://ko.wikipedia.org/wiki/L "wikilink")` wikilinked label`
`       end`
