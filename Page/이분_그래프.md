...
[그래프 이론에서](../Page/그래프_이론.md "wikilink"), **이분 그래프**(二分graph, )란 모든 꼭짓점을 빨강과 파랑으로 색칠하되, 모든 변이 빨강과 파랑 꼭짓점을 포함하도록 색칠할 수 있는 [그래프](https://ko.wikipedia.org/wiki/그래프 "wikilink")이다.
