...
[수학](https://ko.wikipedia.org/wiki/수학 "wikilink")에서 골롬-딕맨 상수(Golomb-Dickman constant)는 무작위 [순열](https://ko.wikipedia.org/wiki/순열 "wikilink") (랜덤 순열)이론과 [수 이론에서](https://ko.wikipedia.org/wiki/정수론 "wikilink") 각각 보여진다.이것은 정수들의 확장에서 [소수들간의](https://ko.wikipedia.org/wiki/소수_\(수론\) "wikilink") 출현길이와 무작위한 랜덤 순열을 가장 크게 확장했을 때의 분포가 일치하는 값을 보이고 있다는 사실을 보여주는 놀라운 상수들간의 관계이다. 딕맨(Dickman,1930)에의해 가장 큰 정수들 집합\(\{1,....,n \}\)중에서 균일하게 선택된 임의의 정수의 소수(prime number) 요소\(P_1\)에서, \(E\left({{log P_1}\over{log n}}\right) \to 0.62432\) [딕맨 함수로](https://ko.wikipedia.org/wiki/딕맨_함수 "wikilink") 알려진 이 상수는 가장 큰 소수의 자릿수로 예상되는 수에서 해석된다. 이러한 "가장 크다고 여겨질수있는 무작위 정수의 자릿수에 대한 비율문제" 이후로, 골롬(Golomb,1964)이 무작위 순열에서 가장 긴 주기의 길이 \(L_1\)을 연구 했을때, \(S_n\) 에서 \(E\left({{L_1}\over n}\right)  \to  0.62432\) 를 발견했다. 여기서 딕맨의 상수가 골롬이 발견한 상수와 동일함에도 이 두 상수의 상관관계가 곧 바로 강하게 연관되지는 못했다.\[1\]

그러나 이들의 관계가 확률상의 [푸아송 분포와](https://ko.wikipedia.org/wiki/푸아송_분포 "wikilink") [정규 분포](https://ko.wikipedia.org/wiki/정규_분포 "wikilink")
...
이것은 [구간](https://ko.wikipedia.org/wiki/구간 "wikilink") \(\; x \in (0,1)\)에서,
...
[확률 이론에서](https://ko.wikipedia.org/wiki/확률_이론 "wikilink"), \(\lambda n\)은 [균일 분포에서](https://ko.wikipedia.org/wiki/이산균등분포 "wikilink") 가장 긴주기의 [예상](https://ko.wikipedia.org/wiki/기대값 "wikilink") 크기 \(n\)세트의 랜덤순열이다.

[수 이론에서](https://ko.wikipedia.org/wiki/정수론 "wikilink") 골롬-딕맨 상수는 정수의 가장 큰 [소수](https://ko.wikipedia.org/wiki/소수_\(수론\) "wikilink") 인자의 평균 크기와 관련되어 나타난다.
...
여기서 \(P_1 (k)\)는 \(k\)의 가장 큰 소수 인자이다. 따라서 \(k\)가 \(d\)자릿수 인 경우, \(\lambda d\)는 \(k\)의 최대 [소수](https://ko.wikipedia.org/wiki/소수_\(수론\) "wikilink") 자릿수의 평균 자릿수이다.
...
\[\gamma\][오일러-마스케로니 상수](https://ko.wikipedia.org/wiki/오일러-마스케로니_상수 "wikilink")
...
\[\rho(t)\] [딕맨 함수(Dickman–de Bruijn function)](https://ko.wikipedia.org/wiki/딕맨_함수 "wikilink")
...
\[H_n\]는 [조화수](https://ko.wikipedia.org/wiki/조화급수 "wikilink") \(,\;\; big \; O\) [점근 표기법](https://ko.wikipedia.org/wiki/점근_표기법 "wikilink")

## 함께보기

  - [수학 상수](https://ko.wikipedia.org/wiki/수학_상수 "wikilink")
  - [구간](https://ko.wikipedia.org/wiki/구간 "wikilink")
  - [푸아송 분포](https://ko.wikipedia.org/wiki/푸아송_분포 "wikilink")
  - [완전순열](https://ko.wikipedia.org/wiki/완전순열 "wikilink")
