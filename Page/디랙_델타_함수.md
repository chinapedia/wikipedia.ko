...
**디랙 델타 함수**는 이론물리학자 [폴 디랙이](../Page/폴_디랙.md "wikilink") 고안해낸 [함수](../Page/함수.md "wikilink")로, δ(x)와 같이 표기하며, [크로네커 델타의](https://ko.wikipedia.org/wiki/크로네커_델타 "wikilink") 연속함수화로도 볼 수 있다. 이 함수는 일반적인 의미에서의 함수는 아니며, 0에서 완전히 축퇴된 [분포의](../Page/분포_\(해석학\).md "wikilink") [확률밀도함수](https://ko.wikipedia.org/wiki/확률밀도함수 "wikilink")같은 것으로 정의할 수 있다. 신호 처리 분야에서는 **임펄스 함수**라고 부르기도 한다. 이 함수는 다음과 같은 값을 가진다.
...
1.
2.  [정보통신기술용어해설, <http://www.ktword.co.kr/abbr_view.php?m_temp1=3722>](http://www.ktword.co.kr/abbr_view.php?m_temp1=3722)