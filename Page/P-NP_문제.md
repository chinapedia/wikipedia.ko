...
P는 [결정론적 튜링 기계를](https://ko.wikipedia.org/wiki/결정론적_튜링_기계 "wikilink") 사용해 [다항 시간](https://ko.wikipedia.org/wiki/다항_시간 "wikilink") 내에 답을 구할 수 있는 문제의 집합이고, NP는 [비결정론적 튜링 기계를](../Page/비결정론적_튜링_기계.md "wikilink") 사용해 다항 시간 내에 답을 구할 수 있는 문제의 집합이다. 여기에서 결정론적 튜링 기계에 사용한 프로그램을 비결정론적 튜링 기계에 적용할 수 있으므로, P는 NP의 부분집합이 된다.사실 진부분 분배속이됨을 세학자가 증명했다.
