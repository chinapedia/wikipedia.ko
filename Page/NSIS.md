...
NSIS는 주로 [zlib 라이선스인](https://ko.wikipedia.org/wiki/zlib_라이선스 "wikilink") [자유 소프트웨어 라이선스와](https://ko.wikipedia.org/wiki/자유_소프트웨어_라이선스 "wikilink") 결합한 [자유 소프트웨어이다](https://ko.wikipedia.org/wiki/자유_소프트웨어 "wikilink").\[1\]
...
NSIS 버전 1은 여러 방면에서 [윈도 인스톨러의](https://ko.wikipedia.org/wiki/윈도_인스톨러 "wikilink") 기본 형태와 비슷하다. 그러나 스크립트를 작성하기 더 쉽고 더 많은 압축 포맷을 지원한다는 점에서 차이가 있다. NSIS 버전 2부터는 새로운 스트림라인 [GUI를](https://ko.wikipedia.org/wiki/그래픽_사용자_인터페이스 "wikilink") 제공하며 [LZMA](../Page/LZMA.md "wikilink") 압축, 다국어를 지원하며 플러그인 시스템을 쉽게 이용할 수 있게 되었다.
...
NSIS는 설치 프로그램과 통신할 수 있는 [플러그인](../Page/플러그인.md "wikilink")으로 확장할 수 있다. 플러그인은 [C](https://ko.wikipedia.org/wiki/C_\(프로그래밍_언어\) "wikilink"), [C++](https://ko.wikipedia.org/wiki/C++ "wikilink"), [델파이로](https://ko.wikipedia.org/wiki/델파이_프로그래밍_언어 "wikilink") 작성할 수 있으며 설치 작업을 수행하거나 설치 프로그램 인터페이스를 확장하는 데 사용할 수도 있다. NSIS 코드에서 줄 하나만 추가하면 플러그인을 호출할 수 있다.
...
그 밖의 플러그인들은 [ZipDLL](http://nsis.sourceforge.net/ZipDLL), [파이썬](https://ko.wikipedia.org/wiki/파이썬 "wikilink") [플러그인](http://nsis.sourceforge.net/Python_Interpreter)을 비롯하여 온라인에서 내려받을 수 있다.
...
<tr class="odd">
<td><ul>
<li><a href="https://ko.wikipedia.org/wiki/7-Zip" title="wikilink">7-Zip</a></li>
...
<li><a href="https://ko.wikipedia.org/wiki/FL_스튜디오" title="wikilink">FL 스튜디오</a></li>
...
<li><a href="https://ko.wikipedia.org/wiki/구글" title="wikilink">구글</a> (<a href="../Page/피카사.md" title="wikilink">피카사</a>, <a href="https://ko.wikipedia.org/wiki/구글_토크" title="wikilink">토크</a>)</li>
<li><a href="https://ko.wikipedia.org/wiki/인텔" title="wikilink">인텔</a> <a href="https://ko.wikipedia.org/wiki/인텔_C_컴파일러" title="wikilink">C 컴파일러</a></li>
<li><a href="https://ko.wikipedia.org/wiki/IrfanView" title="wikilink">IrfanView</a></li>
<li>WireShark</li>
</ul></td>
<td><ul>
<li><a href="https://ko.wikipedia.org/wiki/카스퍼스키" title="wikilink">카스퍼스키</a> <a href="https://ko.wikipedia.org/wiki/카스퍼스키_안티바이러스" title="wikilink">안티바이러스</a></li>
...
<li><a href="https://ko.wikipedia.org/wiki/모질라_파이어폭스" title="wikilink">모질라 파이어폭스</a></li>
...
<li><a href="https://ko.wikipedia.org/wiki/VLC_미디어_플레이어" title="wikilink">VLC 미디어 플레이어</a></li>
...
NSIS 프로젝트는 (.nsi 확장자의) 간단히 문서 파일을 편집하여 구성할 수 있다. 그러나 다음과 같은 외부 소프트웨어를 이용하여 편집할 수도 있다:
  ...
  - [HM NIS Edit](http://hmne.sourceforge.net/)는 사용자 지정 [C++](https://ko.wikipedia.org/wiki/C++ "wikilink")/[델파이](https://ko.wikipedia.org/wiki/델파이 "wikilink") 플러그인을 지원하는 프리웨어 NSIS 편집기이다.
...
이 압축 형태의 파일은 [7-Zip](https://ko.wikipedia.org/wiki/7-Zip "wikilink")이나 [토탈 커맨더](../Page/토탈_커맨더.md "wikilink") 플러그인[InstallExplorer](http://www.totalcmd.net/plugring/InstallExplorer.html), [전처리기](https://web.archive.org/web/20050309212710/http://plugring.farmanager.com/cgi-bin/downld.cgi?Lang=Eng)를 이용하여 압축을 풀 수 있다.
...
짐 파크의 유니코드 변종을 이용하고 있는 프로젝트들은 다음과 같다\[6\]:
  ...
  - [구글](https://ko.wikipedia.org/wiki/구글 "wikilink") ([피카사](../Page/피카사.md "wikilink"))
