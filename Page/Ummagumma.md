...
이 단어에 대해서 정확한 발음은 알려져 있지 않다. 공식적으로, 닉 메이슨은 [BBC](https://ko.wikipedia.org/wiki/BBC "wikilink")의 TV 프로그램에서 이를 *우마구마*라고 발음했지만, 로저 워터스가 *우마굼마*라고 발음한 해적판 음반도 존재한다.\[2\]

## 곡 목록

### Disc 1: 라이브 앨범

[섬네일](https://ko.wikipedia.org/wiki/파일:Former_Mothers_Club_02.JPG "wikilink"), [Birmingham](https://ko.wikipedia.org/wiki/Birmingham "wikilink"), above two shops, where some of the live album was recorded (seen in March 2013)--\>\]\]

원래 밴드는 라이브 앨범을 내버리고 여기 수록된 곡을 더이상 연주하지 않으려 했다. 하지만 앨범이 의외로 인기를 끌자, 그들은 어쩔 수 없이 곡들을 계속 공연해야 했다.\[3\]
...
1.  "Set the Controls for the Heart of the Sun" (워터스) – 9:15
2.  "A Saucerful of Secrets" (길모어/워터스/메이슨/라이트) – 12:48
      - "Something Else"
...
2.  "Grantchester Meadows" (워터스) – 7:26
3.  "Several Species of Small Furry Animals Gathered Together in a Cave and Grooving with a Pict" (워터스) – 4:59

#### B면

1.  "The Narrow Way" (길모어)
      - Part 1 – 3:27
      - Part 2 – 2:53
      - Part 3 – 5:57
2.  "The Grand Vizier's Garden Party" (메이슨)
      - Part 1: "Entrance" – 1:00
      - Part 2: "Entertainment" – 7:06
      - Part 3: "Exit" – 0:38
    <!-- end list -->
      -
        이 곡은 핑크 플로이드가 만든 곡 중에서 가장 짧은 길이의 곡이다.
...
[분류:1969년 음반](https://ko.wikipedia.org/wiki/분류:1969년_음반 "wikilink") [분류:핑크 플로이드의 음반](https://ko.wikipedia.org/wiki/분류:핑크_플로이드의_음반 "wikilink") [분류:사이키델릭 록 음반](https://ko.wikipedia.org/wiki/분류:사이키델릭_록_음반 "wikilink") [분류:1969년 10월](https://ko.wikipedia.org/wiki/분류:1969년_10월 "wikilink") [분류:1969년 라이브 음반](https://ko.wikipedia.org/wiki/분류:1969년_라이브_음반 "wikilink")

1.  [Echoes FAQ](http://www.pink-floyd.org/faq/faq5.html#3)
2.
3.