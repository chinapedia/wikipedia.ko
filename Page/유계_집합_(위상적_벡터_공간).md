...
[함수해석학](https://ko.wikipedia.org/wiki/함수해석학 "wikilink")과 [수학](https://ko.wikipedia.org/wiki/수학 "wikilink")의 관련 분야에서, [영벡터](https://ko.wikipedia.org/wiki/영벡터 "wikilink")의 모든 [근방](https://ko.wikipedia.org/wiki/근방 "wikilink")을 *팽창*시켜서 [위상 벡터 공간의](../Page/위상_벡터_공간.md "wikilink") 어떤 [집합](https://ko.wikipedia.org/wiki/집합 "wikilink")을 포함할 수 있으면 **유계 집합** 또는 **폰 노이만 유계 집합**이라고 불린다. 반대로 집합이 유계가 아니면 **무계 집합**이라고 불린다.

유계 집합의 [극은](https://ko.wikipedia.org/wiki/극_집합 "wikilink") [절대 볼록 집합이고](../Page/절대_볼록_집합.md "wikilink") [흡수 집합이기](../Page/흡수_집합.md "wikilink") 때문에, 유계집합은 [쌍대 쌍인](https://ko.wikipedia.org/wiki/쌍대_쌍 "wikilink") [백터 공간의](https://ko.wikipedia.org/wiki/백터_공간 "wikilink") [국소 볼록](https://ko.wikipedia.org/wiki/국소_볼록_위상 "wikilink") [극 위상을](https://ko.wikipedia.org/wiki/극_위상 "wikilink") 정의하는 일반적인 방법이다. 이 개념은 1935년에 [존 폰 노이만과](https://ko.wikipedia.org/wiki/존_폰_노이만 "wikilink") [안드레이 콜모고로프에](https://ko.wikipedia.org/wiki/안드레이_콜모고로프 "wikilink") 의해서 처음으로 나타나게 되었다.

## 정의

[체](https://ko.wikipedia.org/wiki/체_\(수학\) "wikilink") *F*의 [위상 벡터 공간](../Page/위상_벡터_공간.md "wikilink") (*X*,τ)가 주어졌을 때, 영벡터의 모든 근방 *N*에 대해서 다음을 만족하는 α가 존재할 때, *S*를 **유계 집합**이라고 부른다:

\[S \subseteq \alpha N\] 이 때, \(\alpha N\)은 다음과 같다:

\[\alpha N := \{ \alpha x \mid x \in N\}\]

이것은 *S*가 영벡터의 모든 [근방](https://ko.wikipedia.org/wiki/근방 "wikilink")에 [흡수된다는](../Page/흡수_집합.md "wikilink") 조건과 동등하다\[1\]. 즉, 모든 근방 *N*에 대해서, 다음을 만족시키는 *t*가 존재한다:
...
## 유계인 예시와 유계가 아닌 예시
  ...
  - 모든 유한한 점들의 집합은 유계이다
  - [코시 열의](https://ko.wikipedia.org/wiki/코시_열 "wikilink") 점들의 집합은 유계집합이지만, 코시 [그물의](https://ko.wikipedia.org/wiki/그물_\(수학\) "wikilink") 점들의 집합은 유계일 필요는 없다.
...
## 특성
  ...
  - 유계 집합의 [폐포는](https://ko.wikipedia.org/wiki/폐포_\(위상수학\) "wikilink") 유계이다.
  ...
  - 유계 집합의 유한한 [합집합](https://ko.wikipedia.org/wiki/합집합 "wikilink")이나 유한합은 유계이다.
