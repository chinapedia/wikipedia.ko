...
여기서 \(|\sigma|\)는 부호수 \(\sigma\)에 속한 연산의 [집합의 크기와](https://ko.wikipedia.org/wiki/집합의_크기 "wikilink") 관계의 [집합의 크기의](https://ko.wikipedia.org/wiki/집합의_크기 "wikilink") 합이다.

## 고차 논리에서의 부재

표준 모형()을 갖춘 [고차 논리에서는](https://ko.wikipedia.org/wiki/고차_논리 "wikilink") 뢰벤하임-스콜렘 정리가 성립하지 않는다.\[3\] 다만, 고차 논리에서 헹킨 모형( 또는 )을 사용하면, 고차 논리는 사실상 [1차 논리가](../Page/1차_논리.md "wikilink") 된다. 이 경우, 뢰벤하임-스콜렘 정리가 자명하게 적용된다.
...
임의의 자연수 \(n\) 및 \(M\)의 각 1차 논리 명제 \(\phi(x_1,\dots,x_n,y)\)에 대하여, [선택 공리를](https://ko.wikipedia.org/wiki/선택_공리 "wikilink") 사용하여 다음 성질을 만족시키는 함수 \(f_\phi\colon M^n\to M\)를 정의할 수 있다.
...
[1차 논리로](../Page/1차_논리.md "wikilink") 서술된 [집합론](../Page/집합론.md "wikilink")(예를 들어, [선택 공리를](https://ko.wikipedia.org/wiki/선택_공리 "wikilink") 추가한 [체르멜로-프렝켈 집합론](../Page/체르멜로-프렝켈_집합론.md "wikilink"))을 생각하자. 만약 이 집합론이 충분히 강력하다면, 이 집합론에서 [비가산 집합의](https://ko.wikipedia.org/wiki/가산_집합 "wikilink") 존재를 증명할 수 있다. 그러나 하향 뢰벤하임-스콜렘 정리에 따르면 이 집합론은 [가산 무한](https://ko.wikipedia.org/wiki/가산_집합 "wikilink") 모형을 가진다. 이를 **스콜렘 역설**()이라고 하며, [토랄프 스콜렘이](../Page/토랄프_스콜렘.md "wikilink") 1922년에 지적하였다.\[4\]

스콜렘 역설은 모순이 아니며, 다음과 같이 해소된다. [집합론](../Page/집합론.md "wikilink")에서는 함수 역시 집합의 일종으로 구현된다. 비가산 집합의 존재는 다음 성질을 만족시키는 집합 \(S\)의 존재를 의미한다.

  - [단사 함수](https://ko.wikipedia.org/wiki/단사_함수 "wikilink") \(f\colon\mathbb N\to S\)가 존재한다.
  - [전사 함수](https://ko.wikipedia.org/wiki/전사_함수 "wikilink") \(f\colon\mathbb N\to S\)는 존재하지 않는다.

집합론의 가산 모형에서, 이는 다음과 같이 해석된다.

  - 모형 속에서, [단사 함수](https://ko.wikipedia.org/wiki/단사_함수 "wikilink") \(f\colon\mathbb N\to S\)를 나타내는 원소가 존재한다.
  - 모형 속에서, [전사 함수](https://ko.wikipedia.org/wiki/전사_함수 "wikilink") \(f\colon\mathbb N\to S\)를 나타내는 원소는 존재하지 않는다. (그러나 물론 모형이 가산 모형이므로 모형 밖에서는 이러한 전사 함수를 정의할 수 있다.)

## 역사

[독일](https://ko.wikipedia.org/wiki/독일 "wikilink")의 수리논리학자 [레오폴트 뢰벤하임](https://ko.wikipedia.org/wiki/레오폴트_뢰벤하임 "wikilink")(Leopold Löwenheim)과 [노르웨이](https://ko.wikipedia.org/wiki/노르웨이 "wikilink")의 수리논리학자 [토랄프 스콜렘이](../Page/토랄프_스콜렘.md "wikilink") [1915년](https://ko.wikipedia.org/wiki/1915년 "wikilink")에 증명하였다.\[5\]
