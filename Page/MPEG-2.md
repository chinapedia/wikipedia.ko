...
각 블록은 8x8 [이산 코사인 변환](../Page/이산_코사인_변환.md "wikilink")(discrete cosine transformation)의 과정을 거치게 된다. 변환으로 얻어진 각 계수들은 미리 정해진 값들로 나누어 양자화 되고, 지그재그로 재배열 된 후 영에 대한 [RLC](https://ko.wikipedia.org/wiki/RLC "wikilink")을 하게 된다. 마지막으로 [허프만 코딩으로](https://ko.wikipedia.org/wiki/허프만_코딩 "wikilink") 부호화를 마친다.
