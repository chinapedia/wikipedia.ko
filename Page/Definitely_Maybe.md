...
[노엘 갤러거의](../Page/노엘_갤러거.md "wikilink") 말에 따르면, 음반 제목은 술집에 걸려있던 한 포스터에서 따왔다고 하는데, 무슨 광고였는지는 기억나지 않는다고 한다.

## 트랙 목록

모든 트랙은 [노엘 갤러거가](../Page/노엘_갤러거.md "wikilink") 작곡하였다.
...
11. 〈[Married with Children](https://ko.wikipedia.org/wiki/Married_with_Children "wikilink")〉 – 3:15
...
1.  〈[Whatever](https://ko.wikipedia.org/wiki/Whatever_\(song\) "wikilink")〉
...
1번 디스크의 오디오 트랙을 재생하면서 '아래' 버튼을 누르면 다음과 같은 숨겨진 트랙들을 들을 수 있다.

  - 〈Rock 'n' Roll Star〉: 녹음 과정에서 리암이 온갖 이상한 악기들을 쓰자고 주장한 이야기.
  - 〈Live Forever〉: 이 곡을 중요한 3번 트랙으로 선택하게 된 이야기. 어떤 부분을 깜짝 놀랄 만한 누군가가 불렀다는 사실.
  - 〈Supersonic〉: 노엘이 들려주는 '음악 이론'.
  - 〈Cigarettes & Alcohol〉: 이 곡을 듣는 데 질려버린 노엘의 이웃.
  - 〈Slide Away〉: 제목과 관련된 에피소드.
  - 〈Married with Children〉: [귁시에](https://ko.wikipedia.org/wiki/폴_"귁시"_맥기건 "wikilink") 관한 짧은 이야기.

### 감독 코멘터리

미국판의 〈Supersonic〉,〈Live Forever〉, 영국판의 〈Shakermaker〉,〈Cigarettes & Alcohol〉뮤직비디오 재생 중 '오디오' 버튼을 누르면 들을 수 있다. (어떤 코멘터리는 노래 진행 후 약 1분이 지나서야 들을 수 있음)

### 다른 버전의 뮤직비디오

〈Supersonic〉,〈Live Forever〉뮤직비디오는 미국 버전이 디폴트로 재생되고, '앵글' 버튼을 누르면 영국 버전의 뮤직비디오를 볼 수 있다.

### 기타

  - 〈[Wibbling Rivalry](https://ko.wikipedia.org/wiki/Wibbling_Rivalry "wikilink")〉:〈Married with Children〉이 끝난 후 몇 초 동안 화면이 검은색으로 바뀐다. 이때 (〈Sad Song〉이 시작하기 전) '아래' 버튼을 누르면 그 유명한 〈Wibbling Rivalry〉인터뷰를 들을 수 있다.
  - 〈Sad Song〉: DVD에 수록된 이 곡은 1994년 발표된 원래 곡과 약간 차이가 있다. 노엘이 부르는 "Throwing it all away / don't throw it all away" 부분에서 보컬 트랙이 더블 트랙으로 되어 있는 것이다. 왜 차이가 나게 됐는지 이유는 알 수 없지만, 원래 버전을 듣고 싶다면 《Definitely Maybe》영국 LP판이나 일본판, 또는 일본에서만 발매된 〈Don't Go Away〉싱글을 구해야 할 것이다.
...
<li>차트 최고 순위: 10위 (UK) / 2위 (US Modern Rock)</li>
</ul></td>
</tr>
<tr class="even">
...
## 참여
  ...
  - [노엘 갤러거](../Page/노엘_갤러거.md "wikilink") - 리드 기타, 배킹 보컬
  - [폴 아더스](https://ko.wikipedia.org/wiki/폴_아더스 "wikilink") - 리듬 기타
...
### 그밖에
  ...
  - 토니 그리피스(Anthony Griffiths) - 배킹 보컬
  - 데이빗 배첼러(David Batchelor) – 프로듀서
  - 마크 코일(Mark Coyle) – 프로듀서, 엔지니어, 믹싱
  - 오웬 모리스(Owen Morris) – 프로듀서, 마스터링, 믹싱, 프로덕션 콘셉트
  - 안잘리 더트(Anjali Dutt), 데이브 스콧(Dave Scott), 로이 스퐁(Roy Spong) – 엔지니어
  - 브라이언 캐논(Brian Cannon) – 아트 디렉션, 디자인, 콘셉트, 표지 디자인
  - 마이클 스펜서 존스(Michael Spencer Jones) – 사진

## 차트 순위

| 연도              | 차트                                                                 | 순위 |
| --------------- | ------------------------------------------------------------------ | -- |
| 1994년           | [영국 음반 차트](https://ko.wikipedia.org/wiki/영국_음반_차트 "wikilink")\[6\] | 1  |
| US 톱 힛시커스\[7\]  | 1                                                                  |    |
| 뉴질랜드 음반 차트\[8\] | 5                                                                  |    |
| 1995년           | [빌보드 200](../Page/빌보드_200.md "wikilink")\[9\]                      | 58 |

## 각주와 참고자료

<references/>

[분류:1994년 데뷔 음반](https://ko.wikipedia.org/wiki/분류:1994년_데뷔_음반 "wikilink") [분류:오아시스의 음반](https://ko.wikipedia.org/wiki/분류:오아시스의_음반 "wikilink") [분류:에픽 레코드 음반](https://ko.wikipedia.org/wiki/분류:에픽_레코드_음반 "wikilink") [분류:영어 음반](https://ko.wikipedia.org/wiki/분류:영어_음반 "wikilink")

1.  [Channel 4/HMV best music of this millennium](http://www.rocklistmusic.co.uk/channel4.htm)
2.  [Channel4.com : The 100 Greatest Albums](http://www.channel4.com/entertainment/tv/microsites/G/greatest/albums/results.html)
3.
4.
5.
6.
