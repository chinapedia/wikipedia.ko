...
KSVG2는 [KDOM](https://ko.wikipedia.org/wiki/KDOM "wikilink")2를 기반으로 하고 있다. KSVG는 KDE4 버전과 함께 릴리즈될 전망이다. KSVG2 는 [웹키트](https://ko.wikipedia.org/wiki/웹키트 "wikilink")()의 "실험적"(experimental) 소프트웨어 파트로 개발되고 있다.\[3\]

## 각주

## 외부 링크

  - [KSVG 홈페이지](https://web.archive.org/web/20110422231014/http://svg.kde.org/)

  - [Webkit's project page for SVG](http://webkit.org/projects/svg/)

[분류:KDE](https://ko.wikipedia.org/wiki/분류:KDE "wikilink") [분류:SVG](https://ko.wikipedia.org/wiki/분류:SVG "wikilink")

1.
2.
3.  [Webkit's project page for SVG](http://webkit.org/projects/svg/)