...
\[\bigwedge(\mathfrak g) = \bigoplus_{n\in\mathbb N} \bigwedge^n\mathfrak g^* = K \oplus \mathfrak g^* \oplus \mathfrak g^*\wedge\mathfrak g^* \oplus \dotsb\] 위에 다음과 같은 [미분을](https://ko.wikipedia.org/wiki/미분_\(대수학\) "wikilink") 다음과 같이 [곱의 법칙을](../Page/곱의_법칙_\(미적분학\).md "wikilink") 통해 정의할 수 있다.
