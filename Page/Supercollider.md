...
2018-10-31기준으로 최신 버전은 3.9.3으로 2018-4-8일에 수정되었으며 <http://supercollider.github.io>를%5B깨진+링크(과거+내용+찾기)%5D 통해 다운로드할 수 있다.
