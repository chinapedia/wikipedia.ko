...
오피스 XP는 2001년 3월 5일에 RTM 버전을 출시했다.\[1\] 메인스트림 지원동안 3개의 서비스 팩이 출시되었고, 2006년 7월 11일에 윈도우 98, 윈도우 98 SE, 윈도우 ME, 윈도우 NT 4.0 임베디드, 윈도우 XP RTM과 동시에 메인스트림 지원이 끝났다. 마이크로소프트는 2011년 7월 12일로 윈도우 비스타 서비스팩 1과 동시에 판매와 확장 지원을 종료했다.\[2\]
...
마이크로소프트는 오피스 XP에 많은 메이저 업데이트와 기능을 추가했다.
  ...
  - **클립보드**
  - **스마트 태그**
  - 오피스 XP는 [윈도우 XP의](../Page/윈도우_XP.md "wikilink") 베타 버전인 윈도우 휘슬러의 워터칼라 테마를 적용하고 있다. 후에 나오는 [오피스 2003은](../Page/마이크로소프트_오피스_2003.md "wikilink") [루나 테마를](../Page/윈도우_XP_테마.md "wikilink") 적용한다.
...
이 프로그램은 여러가지 에디션으로 배포되었고, 몇몇 에디션은 업그레이드나 전체 버전으로도 사용이 가능하였다. 볼륨 라이선스 버전은 제품 인증을 거치지 않아도 되었고, 모든 에디션은 워드, 엑셀, 아웃룩을 포함한다.또한 스몰 비즈니스 에디션을 제외한 모든 에디션은 파워포인트를 포함했다.\[3\]
...
### 리테일 제품군
  ...
  - 오피스 XP 프로페셔널 스페셜 에디션 (프로페셔널 + [프론트페이지와](../Page/마이크로소프트_프론트페이지.md "wikilink") [퍼블리셔](../Page/마이크로소프트_퍼블리셔.md "wikilink")), 업그레이드 전용
...
## 외부 링크
  ...
  - [오피스 온라인의 오피스 XP용 다운로드 목록](https://web.archive.org/web/20100724184625/http://office.microsoft.com/en-us/downloads/CD010224911033.aspx)

[분류:마이크로소프트의 소프트웨어](https://ko.wikipedia.org/wiki/분류:마이크로소프트의_소프트웨어 "wikilink") [분류:마이크로소프트 오피스](https://ko.wikipedia.org/wiki/분류:마이크로소프트_오피스 "wikilink") [분류:윈도우 소프트웨어](https://ko.wikipedia.org/wiki/분류:윈도우_소프트웨어 "wikilink") [분류:2001년 소프트웨어](https://ko.wikipedia.org/wiki/분류:2001년_소프트웨어 "wikilink")
