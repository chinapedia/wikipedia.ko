...
<!-- end list -->
  ...
  - 또한 [다샤오제](../Page/다샤오제.md "wikilink")의 첫 번째 미니 앨범에도 "GO GO Girl"로 제목을 바꾼 중국어 커버 버전이 수록되었다.
...
2.  **ING**
      -
        작사, 작곡: 층쿠 / 편곡: 스즈키Daichi히데유키
3.  Go Girl\~\~ ([Instrumental](https://ko.wikipedia.org/wiki/Instrumental "wikilink"))

## 참여 뮤지션

※ 괄호는 트랙 번호

  - 스즈키Daichi히데유키 - 전 악기 (1, 2)
  - 다케우치 히데아키 - 코러스 (1)
  - 이나바 아쓰코 - 코러스 (1)
  - 층쿠♂ - 코러스 (1)
...
## 외부 링크
  ...
  - [UP-FRONT WORKS 음반 목록](https://web.archive.org/web/20080505022757/http://www.up-front-works.jp/discography/zetima/29/s_21/)

  - [층쿠♂ 공식 사이트 코멘트](https://web.archive.org/web/20100704100920/http://www.tsunku.net/pw_Music.php?@PS@=none&@DB_ID@=239)
