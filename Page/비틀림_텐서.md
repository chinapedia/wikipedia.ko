...
[미분기하학](https://ko.wikipedia.org/wiki/미분기하학 "wikilink")에서, **비틀림 텐서**()는 [주다발](https://ko.wikipedia.org/wiki/주다발 "wikilink")의 [코쥘 접속이](../Page/코쥘_접속.md "wikilink") [레비치비타 접속에서](https://ko.wikipedia.org/wiki/레비치비타_접속 "wikilink") 얼마나 벗어나는지를 측정하는, (1,2)차 [텐서장](https://ko.wikipedia.org/wiki/텐서장 "wikilink")이다.
...
다음이 주어졌다고 하자.
  ...
  - \(M\)의 [주다발](https://ko.wikipedia.org/wiki/주다발 "wikilink") \(\mathrm TM\) 위의 [코쥘 접속](../Page/코쥘_접속.md "wikilink") \(\nabla\)
...
보다 일반적으로, 임의의 [필바인](https://ko.wikipedia.org/wiki/필바인 "wikilink")

\[e^\mu_1\,\dotsc,e^\mu_n \in\Gamma(\mathrm TM)\] 을 잡자. 그렇다면, 다음을 정의할 수 있다.

\[[e_a,e_b]^\mu = \gamma^c_{ab} e_c^\mu\]

\[e^\mu_a(\nabla_\mu e^b)_\nu = \omega^b{}_{ac}e_\nu^c\] 여기서 \(\omega\)는 [스핀 접속이다](https://ko.wikipedia.org/wiki/스핀_접속 "wikilink").
