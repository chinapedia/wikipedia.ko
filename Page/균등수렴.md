...
[해석학에서](https://ko.wikipedia.org/wiki/해석학_\(수학\) "wikilink"), **균등수렴**(均等收斂, )하는 함수열은, 주어진 함수로 일제히 '동일한 속도'로 수렴하는 함수열이다. 균등수렴은 [점마다 수렴보다](../Page/점마다_수렴.md "wikilink") 더 강한 개념이며, 점마다 수렴이 보존하지 않는 여러 성질(예: [연속성](https://ko.wikipedia.org/wiki/연속함수 "wikilink"))을 보존한다.
