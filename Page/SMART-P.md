...
[KSS-III](https://ko.wikipedia.org/wiki/KSS-III "wikilink")사업과 관련하여, SMART-P의 열출력이 65MWt\[1\]로 처음 사업계획보다 5분의1 수준으로 줄어들고 크기 역시 7미터ㆍ직경 3.5미터로 축소되자 원천기술 측면에서 잠수함용 원자로 개발과 관련돼 있다는 관측\[2\]이 대두됐었다. SMART-P는 소련의 원자력 잠수함 원자로 제작사에서 기술이전을 받아 국내 독자 개발한 원자로이다.
...
세계 최초의 핵잠수함인 [USS 노틸러스 (SSN-571)](../Page/USS_노틸러스_\(SSN-571\).md "wikilink") 이래 수십년 동안 미국의 [SSN](https://ko.wikipedia.org/wiki/SSN "wikilink")(공격원잠)은 수중배수량 4천톤, 열출력 70MWt 가압경수로를 사용했다.

  - [USS 노틸러스 (SSN-571)](../Page/USS_노틸러스_\(SSN-571\).md "wikilink"), [S2W 원자로](https://ko.wikipedia.org/wiki/S2W_원자로 "wikilink"), 열출력 70 MWt, 수중배수량 4092톤
  - [USS 시울프 (SSN-575)](https://ko.wikipedia.org/wiki/USS_시울프_\(SSN-575\) "wikilink"), [S2W 원자로](https://ko.wikipedia.org/wiki/S2W_원자로 "wikilink"), 열출력 70 MWt, 수중배수량 4150톤
  - [스킵잭급 잠수함](../Page/스킵잭급_잠수함.md "wikilink") 6척, [S5W 원자로](https://ko.wikipedia.org/wiki/S5W_원자로 "wikilink"), 열출력 70 MWt, 수중배수량 3600톤
  - [퍼밋급 잠수함](https://ko.wikipedia.org/wiki/퍼밋급_잠수함 "wikilink") 14척, [S5W 원자로](https://ko.wikipedia.org/wiki/S5W_원자로 "wikilink"), 열출력 70 MWt, 수중배수량 4369톤
  - [스터전급 잠수함](https://ko.wikipedia.org/wiki/스터전급_잠수함 "wikilink") 37척, [S5W 원자로](https://ko.wikipedia.org/wiki/S5W_원자로 "wikilink"), 열출력 70 MWt, 수중배수량 4714톤
...
대전에 위치한 [KAERI](https://ko.wikipedia.org/wiki/KAERI "wikilink")의 부지면적 1,388,000m<sup>2</sup> 보다 더 넓은 1,983,480m<sup>2</sup> 부지에 제2의 [KAERI](https://ko.wikipedia.org/wiki/KAERI "wikilink")를 설립할 예정이다.[3](http://news.naver.com/main/read.nhn?mode=LSD&mid=sec&sid1=105&oid=029&aid=0001996582) 우선적으로 스마트 실증로 사업부지로서의 역할을 하게 되는데, 장차 [파이로 프로세싱도](https://ko.wikipedia.org/wiki/파이로_프로세싱 "wikilink") 여기서 하게 된다. 울산시가 매우 적극적으로 유치하려고 노력 중이다.

## 미국

미국의 [하이페리온 파워 제네레이션사는](https://ko.wikipedia.org/wiki/하이페리온_파워_제네레이션 "wikilink") 25MW 정도의 전력을 생산하는 욕조 크기의 초소형 원자로 HPM을 개발하고 있다. 이 원자로는 전지처럼 연결할 수 있는 점이 특징이다. 마을의 인구가 증가해 더 많은 전력이 필요해지면 원자로를 하나 더 연결해 해결한다.\[3\] 10MW 전기출력인 [도시마 4S가](https://ko.wikipedia.org/wiki/도시마_4S "wikilink") 중형차 크기인데 비해, 하이페리온은 더 고출력이면서 훨씬 작다. HPM은 70MWt의 열출력을 내며, 발전기에 연결하면 27MW의 전기를 생산할 수 있다. 이는 미국 평균 규모의 가정 또는 동급 산업체 2만 곳에 전기를 공급할 수 있는 규모다. 초기 설계 제품은 총 4,000대가 세계 각지에 위치한 3곳의 공장을 통해 생산될 계획이다.\[4\] HPM은 열출력 65메가와트인 SMART-P 보다 5메가와트 더 고출력이면서 욕조형 크기로 극소형이다.
