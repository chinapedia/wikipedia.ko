...
[frame](https://ko.wikipedia.org/wiki/파일:HTML_source_code_example.svg "wikilink") 구문 강조\]\] **구문 강조**(構文強調, syntax highlighting)는 문자열(특히 [소스 코드](../Page/소스_코드.md "wikilink"))을 형식의 틀에 따라 여러 가지 색과 [글꼴](https://ko.wikipedia.org/wiki/글꼴 "wikilink")로 다르게 보여 주는 [문서 편집기의](https://ko.wikipedia.org/wiki/문서_편집기 "wikilink") 기능이다. 이러한 기능은 [프로그래밍 언어나](https://ko.wikipedia.org/wiki/프로그래밍_언어 "wikilink") [마크업 언어와](https://ko.wikipedia.org/wiki/마크업_언어 "wikilink") 같은 구조화 언어로 프로그램을 짜기 쉽게 해 주며, [구문 오류와](https://ko.wikipedia.org/wiki/구문_오류 "wikilink") 구조가 눈에 더 잘 들어오게 만든다. 일부 편집기들은 또한 구문 강조 외에 다른 기능들을 포함하고 있는데, 이를테면 [코드 폴딩과](https://ko.wikipedia.org/wiki/:en:Code_folding "wikilink") [맞춤법 검사기가](https://ko.wikipedia.org/wiki/맞춤법_검사기 "wikilink") 있다.
...
아래는 [C](https://ko.wikipedia.org/wiki/C_\(프로그래밍_언어\) "wikilink") 코드 부분을 비교한 것이다:
