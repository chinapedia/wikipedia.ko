...
2차원 영역에서, Mark Drela와 Michael Giles가 MIT의 대학원생 시절 에어포일 설계와 해석에 사용하기 위한 오일러 해석 코드인 [ISES](https://ko.wikipedia.org/wiki/ISES "wikilink")를 개발하였다. (사실 이것은 여러 프로그램들을 하나로 묶은 것이었다) [1986년](../Page/1986년.md "wikilink"), 이 코드의 실제 사용이 가능해졌고 이후 단일 에어포일뿐만 아니라 다요소 에어포일(앞전의 [슬랫](https://ko.wikipedia.org/wiki/슬랫 "wikilink")이나 뒷전의 [플랩](../Page/플랩.md "wikilink") 등이 있음을 의미)에 대한 해석, 설계 및 최적화가 가능한 [MSES](https://ko.wikipedia.org/wiki/MSES "wikilink")로 발전되게 된다. 현재에도 MSES는 전 세계적으로 널리 사용되고 있다. MSES로부터 발전되어 익렬(블레이드와 같이 여러 에어포일이 나열된 것을 말함)에 대한 해석 및 설계가 가능한 MISES라는 프로그램이 당시 MIT의 대학원생이었던 Harold "Guppy" Youngren에 의해 개발되었다.
