...
**보손화**(boson化, )는 2차원 [등각장론](https://ko.wikipedia.org/wiki/등각장론 "wikilink")에서 [페르미온](https://ko.wikipedia.org/wiki/페르미온 "wikilink")과 [보손](https://ko.wikipedia.org/wiki/보손 "wikilink")이 서로 동등한 현상이다.\[1\]\[2\]\[3\] 이에 따라, 2차원 등각장론에서는 일반적인 [스핀-통계 정리가](https://ko.wikipedia.org/wiki/스핀-통계_정리 "wikilink") 무의미하며, 임의로 입자의 통계를 정할 수 있다. 대략, 한 쌍의 페르미온이 짝을 지어 보손을 이루는 것으로 이해할 수 있다.

## 전개

### 바일 페르미온의 보손화

2차원 [등각 장론에서](../Page/등각_장론.md "wikilink") 바일 [스피너](https://ko.wikipedia.org/wiki/스피너 "wikilink")로 다루는 [페르미온](https://ko.wikipedia.org/wiki/페르미온 "wikilink")을 생각하자. 2차원 바일 스피너는 하나의 복소수 성분을 지니고, 또 전칙함수 및 반정칙함수의 합
...
\[:\psi(z)\bar\psi(z):=i\partial\phi(z)\] 와 같이 대응시키면 모든 성질이 같은 사실을 알 수 있다. 여기서 \(:\cdots:\)는 [표준 순서다](https://ko.wikipedia.org/wiki/표준_순서 "wikilink"). 즉 2차원 등각장론에서 페르미온과 보손이 동등하다는 사실을 알 수 있다.
...
\[\phi(z,\bar z)=\phi(z)+\bar\phi(\bar z)\in\mathbb R/2\pi\] 으로 보손화된다. 구체적으로, 대응 관계는 다음과 같다. 여기서 \(\mu\)는 [표준 순서](https://ko.wikipedia.org/wiki/표준_순서 "wikilink") \(:\cdots:\)를 가하는 에너지 눈금이다. (질량항의 경우, [등각 대칭을](../Page/등각_대칭.md "wikilink") 깨므로 이 에너지 눈금이 중요해진다.)
...
만약 페르미온 계가 비아벨 맛깔 대칭 등을 갖는다고 하자. 2차원에서는 이에 따라 계가 [아핀 리 대수](../Page/아핀_리_대수.md "wikilink") 대칭을 갖게 된다. 이 경우, 보손화는 이 대칭을 보존하여야 한다. 이 경우, 일반적인 (아벨) 보손화 대신 **비아벨 보손화**()를 사용한다. 이 경우, 페르미온 계의 보손화는 적절한 아핀 리 대수 대칭을 갖는 [베스-추미노-위튼 모형이다](https://ko.wikipedia.org/wiki/베스-추미노-위튼_모형 "wikilink"). 이를 사용하여, 예를 들어 2차원 [양자 색역학을](https://ko.wikipedia.org/wiki/양자_색역학 "wikilink") 보손화하여 완전히 풀 수 있다.

비아벨 보손화는 [에드워드 위튼이](https://ko.wikipedia.org/wiki/에드워드_위튼 "wikilink") 1984년 도입하였다.\[5\]
...
보손화는 응집물질물리학에서 중요한 역할을 한다. [초전도체](https://ko.wikipedia.org/wiki/초전도체 "wikilink")를 다루는 [BCS 이론에서는](https://ko.wikipedia.org/wiki/BCS_이론 "wikilink") 두 전자가 [쿠퍼 쌍을](https://ko.wikipedia.org/wiki/쿠퍼_쌍 "wikilink") 이루어 보손처럼 행동하여 초전도를 가능하게 한다. 또한, [헬륨](https://ko.wikipedia.org/wiki/헬륨 "wikilink")-3이나 [리튬](../Page/리튬.md "wikilink")-7과 같은 페르미온이 보손화하면 [보스-아인슈타인 응축](https://ko.wikipedia.org/wiki/보스-아인슈타인_응축 "wikilink") 상태에 도달할 수 있다.

보손화는 [끈 이론에서도](https://ko.wikipedia.org/wiki/끈_이론 "wikilink") 쓰인다. 예를 들어, RNS 초끈을 다룰 때 나타나는 페르미온 장 \(\psi\)와 페르미온 유령 \(\beta,\gamma\)는 보손화를 통하여 간단히 다룰 수 있다.
