...
간판 자체는 선거 운동 본부 직원들이 보라고 내걸은 것이었지만, 'The economy, stupid'는 사실상 클린턴 후보의 선거 운동 표어로 활용되었다. 클린턴의 승리로 끝난 대선 이후에도 미국 정계와 언론에서는 '경제'라는 단어만 바꾼 채 계속되서 활용되는 일종의 [스노클론](https://ko.wikipedia.org/wiki/스노클론 "wikilink")\[5\]으로 자리잡기에 이르렀다.

이 말은 한국에서도 클린턴의 선거 승리 요인 중 하나로 회자되었고, 원본처럼 경제문제를 지적하는 데 있어 쓰거나 단어를 바꿔 사용하게 되었다. 가장 최근에는 2018년 [문재인 정부의](https://ko.wikipedia.org/wiki/문재인_정부 "wikilink") 외교 안보 정책의 성과와는 별개로 경기 악화 등의 내정 문제로 지지율이 최저치를 기록하자, 각 언론에서 '문제는 경제다'라는 수사로 요약한 사례가 있다.\[6\]\[7\]\[8\]

## 더 보기

  - [KISS 원칙](https://ko.wikipedia.org/wiki/KISS_원칙 "wikilink") - "Keep it simple, stupid" (심플하게 둬, 바보야)의 약자로 해석하는 경우가 있다.
