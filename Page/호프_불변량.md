...
[호모토피 이론에서](https://ko.wikipedia.org/wiki/호모토피_이론 "wikilink"), **호프 불변량**(Hopf不變量, )은 특정한 차원의 두 [초구](https://ko.wikipedia.org/wiki/초구 "wikilink") 사이의 [연속 함수를](https://ko.wikipedia.org/wiki/연속_함수 "wikilink") 분류하는 [정수](https://ko.wikipedia.org/wiki/정수 "wikilink")이다.

## 정의

[연속 함수](https://ko.wikipedia.org/wiki/연속_함수 "wikilink")

\[f\colon\mathbb S^{2n-1}\to\mathbb S^n\] 가 주어졌다고 하자. 그렇다면 \(\mathbb S^{2n-1}=\partial\mathbb D^{2n}\)이므로 이를 사용하여 [CW 복합체](https://ko.wikipedia.org/wiki/CW_복합체 "wikilink")

\[\mathbb D^{2n}\cup_f\mathbb S^n\] 를 정의할 수 있다. 이는 1개의 0차원 세포 · 1개의 \(n\)차원 세포 · 1개의 \(2n\)차원 세포를 갖는다.

\(n=1\)일 경우, 이러한 함수는 [브라우어르 차수에](https://ko.wikipedia.org/wiki/브라우어르_차수 "wikilink") 의하여 완전히 분류된다. 만약 \(n\ge2\)라면, [세포 코호몰로지를](https://ko.wikipedia.org/wiki/세포_코호몰로지 "wikilink") 사용하여 [CW 복합체의](https://ko.wikipedia.org/wiki/CW_복합체 "wikilink") [코호몰로지](https://ko.wikipedia.org/wiki/코호몰로지 "wikilink")를 바로 계산할 수 있다.
...
[상수 함수의](https://ko.wikipedia.org/wiki/상수_함수 "wikilink") 호프 불변량은 0이다.

[유리수 호모토피 이론](https://ko.wikipedia.org/wiki/유리수_호모토피_이론 "wikilink") 등에 의하여, [호모토피 군](../Page/호모토피_군.md "wikilink") \(\pi_{2n-1}(\mathbb S^n)\)은 유한한 [아벨](https://ko.wikipedia.org/wiki/아벨_군 "wikilink") [꼬임 부분군과](https://ko.wikipedia.org/wiki/꼬임_부분군 "wikilink") [무한 순환군의](https://ko.wikipedia.org/wiki/무한_순환군 "wikilink") [직합](https://ko.wikipedia.org/wiki/직합 "wikilink")이다. 꼬임 부분군은 물론 호프 불변량 준동형 아래 0으로 대응된다.

호프 불변량 준동형의 [치역](https://ko.wikipedia.org/wiki/치역 "wikilink")은 다음과 같다.
...
1960년에 [존 프랭크 애덤스는](https://ko.wikipedia.org/wiki/존_프랭크_애덤스 "wikilink") 호프 불변량이 1인 경우는 2, 4, 8차원 [호프 올뭉치](../Page/호프_올뭉치.md "wikilink") 밖에 없다는 것을 보였다.\[2\]\[3\] 이후 1966년에 애덤스와 [마이클 아티야는](https://ko.wikipedia.org/wiki/마이클_아티야 "wikilink") 이를 [위상 K이론을](../Page/위상_K이론.md "wikilink") 사용하여 재증명하였다.\[4\]
