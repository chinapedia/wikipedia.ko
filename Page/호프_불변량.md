...
1960년에 [존 프랭크 애덤스는](../Page/존_프랭크_애덤스.md "wikilink") 호프 불변량이 1인 경우는 2, 4, 8차원 [호프 올뭉치](../Page/호프_올뭉치.md "wikilink") 밖에 없다는 것을 보였다.\[2\]\[3\] 이후 1966년에 애덤스와 [마이클 아티야는](https://ko.wikipedia.org/wiki/마이클_아티야 "wikilink") 이를 [위상 K이론을](../Page/위상_K이론.md "wikilink") 사용하여 재증명하였다.\[4\]
