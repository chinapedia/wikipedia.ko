...
[조합론](https://ko.wikipedia.org/wiki/조합론 "wikilink")에서, **음계산법**(陰計算法, )은 특정 [수열](https://ko.wikipedia.org/wiki/수열 "wikilink") · 다항식열에서의 아랫첨자를 마치 거듭제곱처럼 여겨 계산하는 계산법이다.

## 정의

표수가 0인 체 \(K\)가 주어졌다고 하자. 그렇다면, 그 위의 [다항식환](../Page/다항식환.md "wikilink") \(K[x]\)는 \(K\) 위의 [벡터 공간을](https://ko.wikipedia.org/wiki/벡터_공간 "wikilink") 이룬다. 이 속의 **다항식열**()은 다음과 같은 조건들을 만족시키는 [열이다](https://ko.wikipedia.org/wiki/수열 "wikilink").
...
\[(p\circ q)_i=p_i\circ q\] 이에 따라, 다항식열들은 [모노이드](https://ko.wikipedia.org/wiki/모노이드 "wikilink")를 이룬다. 음합성의 항등원은 다음과 같다.
...
두 셰퍼 다항식열의 음합성 역시 셰퍼 다항식열을 이루며, 음합성에 대하여 셰퍼 다항식열들은 [군을](https://ko.wikipedia.org/wiki/군_\(수학\) "wikilink") 이룬다.
...
두 아펠 다항식열의 음합성 역시 아펠 다항식열을 이루며, 음합성에 대하여 아펠 다항식열들은 [아벨 군을](https://ko.wikipedia.org/wiki/아벨_군 "wikilink") 이룬다. 이는 셰퍼 다항식열의 군의 [정규 부분군이다](https://ko.wikipedia.org/wiki/정규_부분군 "wikilink").
...
아펠 다항식열의 예로는 다음이 있다.
  ...
  - \(p_n(x)=x^n\). 이에 대응하는 수열은 \(a_n=\delta_{n,0}\)이다 (\(\delta\)는 [크로네커 델타](https://ko.wikipedia.org/wiki/크로네커_델타 "wikilink")).

### 이항형 다항식열

셰퍼 다항식열 \(p_i\)에 대하여, 다음 두 조건이 서로 [동치](https://ko.wikipedia.org/wiki/동치 "wikilink")이며, 이를 만족시키는 셰퍼 다항식열을 **이항형 다항식열**()이라고 한다.

  - \(p_0(x)=1\)이며 \(p_n(0)=0\qquad\forall n\ge1\)이다.
  - 다음 항등식이 성립한다.
    \[p_n(x+y)=\sum_{k=0}^n\binom nkp_k(x)p_{n-k}(y)\]

이항형 다항식열은 음합성에 대하여, 셰퍼 다항식열의 군의 [부분군](https://ko.wikipedia.org/wiki/부분군 "wikilink")을 이룬다. 이는 [정규 부분군이](https://ko.wikipedia.org/wiki/정규_부분군 "wikilink") 아니며, [아벨 군이](https://ko.wikipedia.org/wiki/아벨_군 "wikilink") 아니다. 셰퍼 다항식열의 군 \(\operatorname{Sheffer}\)은 아펠 다항식열의 군 \(\operatorname{Appell}\)과 이항형 다항식열의 군 \(\operatorname{Binom}\)의 [반직접곱](../Page/반직접곱.md "wikilink")이다.
...
이항형 다항식열의 예로는 다음이 있다.
  ...
  - \(p_n(x)=x^n\). 이에 대응하는 델타 작용소는 [미분](https://ko.wikipedia.org/wiki/미분 "wikilink") \(d/dx\)이다.
...
두 수열 \(a_n\), \(b_n\)에 대하여, 다음 두 조건이 서로 [동치](https://ko.wikipedia.org/wiki/동치 "wikilink")이다.
