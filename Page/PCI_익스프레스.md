...
**PCI 익스프레스**()는 2002년 [PCI SIG가](https://ko.wikipedia.org/wiki/PCI_SIG "wikilink") 책정한 입출력을 위한 직렬 구조의 [인터페이스이며](https://ko.wikipedia.org/wiki/물리_인터페이스 "wikilink") [인텔](https://ko.wikipedia.org/wiki/인텔 "wikilink") 주도하에 만들어졌다. 공식적인 약어로 **PCIe**로 표기한다. 옛 [PCI](https://ko.wikipedia.org/wiki/PCI "wikilink"), [PCI-X](https://ko.wikipedia.org/wiki/PCI-X "wikilink")와 [AGP](../Page/가속_그래픽_포트.md "wikilink") [버스](https://ko.wikipedia.org/wiki/버스 "wikilink")를 대체하기 위하여 개발 되었다. PCIe는 앞서 언급한 버스 표준들과 비교하여 높은 시스템 버스 대역폭, 적은 I/O 핀 수, 적은 물리적 면적, 버스 장치들에게 더 뛰어난 성능 확장성, 상세한 오류 검출 및 보고 구조(Advanced Error Reporting (AER)\[1\]), 네이티브 [핫-플러그](https://ko.wikipedia.org/wiki/핫_스와핑 "wikilink") 기능등 여러 장점을 가지고 있다. 최근에는 하드웨어 I/O 가상화도 지원한다.
...
2004년에 [인텔](https://ko.wikipedia.org/wiki/인텔 "wikilink")이 초당 250MB의 데이터 속도와 초당 2.5 [GT의](https://ko.wikipedia.org/wiki/전송_\(컴퓨팅\) "wikilink") [전송 속도를](https://ko.wikipedia.org/wiki/전송_\(컴퓨팅\) "wikilink") 지닌 PCIe 1.0을 도입하였다.
...
| 3               | Reserved  | \+12V    |                                                                                                                    |
| 4               | Ground    | Ground   |                                                                                                                    |
| 5               | SMCLK     | TCK      | [SM버스](https://ko.wikipedia.org/wiki/SM버스 "wikilink") 및 [JTAG](https://ko.wikipedia.org/wiki/JTAG "wikilink") 포트 핀 |
| 6               | SMDAT     | TDI      |                                                                                                                    |
| 7               | Ground    | TDO      |                                                                                                                    |
| 8               | \+3.3V    | TMS      |                                                                                                                    |
| 9               | TRST\#    | \+3.3V   |                                                                                                                    |
...
PCI 익스프레스 미니 카드 (미니 PCI 익스프레스, 미니 PCIe, 미니 PCI-E로도 불림)는 [미니 PCI](../Page/PCI_버스.md "wikilink") 폼 팩터를 대체한다. 이것은 [PCI-SIG](https://ko.wikipedia.org/wiki/PCI-SIG "wikilink")가 개발한 것이다. 호스트 장치는 PCI 익스프레스와 [USB](https://ko.wikipedia.org/wiki/USB "wikilink") 2.0 연결을 둘 다 지원한다. 2005년 뒤에 제조된 대부분의 노트북 컴퓨터는 PCI 익스프레스에 기반을 두며 미니 카드 슬롯도 몇 개 포함되어 있다.
...
PCI 익스프레스 미니 카드 모서리 단자는 여러 개의 연결과 버스를 제공한다:
  ...
  - PCIex1
  - [USB](https://ko.wikipedia.org/wiki/USB "wikilink") 2.0
  - [SM버스](https://ko.wikipedia.org/wiki/SM버스 "wikilink")
  - [GPS](https://ko.wikipedia.org/wiki/GPS "wikilink")
  - [와이파이](https://ko.wikipedia.org/wiki/와이파이 "wikilink")와 같은 무선 네트워크의 진단 LED 상태 선
  - [GSM](https://ko.wikipedia.org/wiki/GSM "wikilink"), [WCDMA](https://ko.wikipedia.org/wiki/WCDMA "wikilink"), [LTE](https://ko.wikipedia.org/wiki/LTE "wikilink")를 위한 [SIM 카드](https://ko.wikipedia.org/wiki/SIM_카드 "wikilink")
...
### 파생된 용어
  ...
  - [익스프레스카드](https://ko.wikipedia.org/wiki/익스프레스카드 "wikilink"): [PC 카드](https://ko.wikipedia.org/wiki/PC_카드 "wikilink") 폼 팩터의 뒤를 이음.
  ...
  - PCI 익스프레스 외부 케이블링\[9\]
  - [모바일 PCI 익스프레스 모듈](../Page/모바일_PCI_익스프레스_모듈.md "wikilink") (MXM): [엔비디아](https://ko.wikipedia.org/wiki/엔비디아 "wikilink")사가 만든 노트북용 그래픽스 모듈 규격
