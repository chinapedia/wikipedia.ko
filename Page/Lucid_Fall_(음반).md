...
5.  너는 내 마음속에 남아
6.  해바라기
7.  새(Acoustic) feat. [이규호](https://ko.wikipedia.org/wiki/이규호_\(가수\) "wikilink")
8.  Take 1
...
## 참여·제작자
  ...
  - 제작: RADIO MUSIC Co., Ltd.(2000. 12.)
  - 전곡(8번곡 제외) 작사·작곡 [루시드 폴](https://ko.wikipedia.org/wiki/루시드_폴 "wikilink")
  - 레코딩·믹싱: 고기모(하자 스튜디오)
  - 마스터링: 이태경(서울 사운드)
  - 프로듀싱: 루시드 폴
  - 아트 디렉션·디자인: 어어부2D마부(조언:유정선)
