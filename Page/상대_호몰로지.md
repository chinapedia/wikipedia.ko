...
\(X\)가 [위상 공간이고](https://ko.wikipedia.org/wiki/위상_공간_\(수학\) "wikilink"), \(A\subset X\)가 그 부분공간이라고 하자. 그렇다면 그 [사슬 복합체에](../Page/사슬_복합체.md "wikilink") 대하여 다음과 같은 [벡터 공간의](https://ko.wikipedia.org/wiki/벡터_공간 "wikilink") [짧은 완전열이](https://ko.wikipedia.org/wiki/짧은_완전열 "wikilink") 존재한다.
...
\(C_\bullet(X)\)에 대한 경계 연산자 \(\partial\)은 \(C_\bullet(A)\)를 보존한다. 따라서 \(C_\bullet(X)/C_\bullet(A)\)의 경계를 정의할 수 있다. 이에 따라 \(C_\bullet(X)/C_\bullet(A)\)는 사슬 복합체를 이루며, 그 [호몰로지](https://ko.wikipedia.org/wiki/호몰로지 "wikilink")를 **상대 호몰로지** \(H_\bullet(X,A)\)라고 한다.
...
\(U\subset A\)가 \(\operatorname{cl}U\subset\operatorname{int}(A)\)를 만족한다고 하자. 여기서 \(\operatorname{cl}\)은 [닫힘이고](https://ko.wikipedia.org/wiki/닫힘_\(위상수학\) "wikilink"), \(\operatorname{int}\)는 [내부이다](https://ko.wikipedia.org/wiki/내부_\(위상수학\) "wikilink"). 그렇다면 \(H_\bullet(X,A)=H_\bullet(X\setminus U,A\setminus U)\)이다. 이를 **절단 정리**()이라고 한다.

나아가, \((X,A)\)가 위상수학적으로 비교적 정상적인 경우 보통 \(H_\bullet(X,A)=H_\bullet(X/A)\)이다.

### 상대 호몰로지의 긴 완전열

[지그재그 보조정리](https://ko.wikipedia.org/wiki/지그재그_보조정리 "wikilink")()를 사용하여, 다음과 같은 [완전열](https://ko.wikipedia.org/wiki/완전열 "wikilink")을 정의할 수 있다.
