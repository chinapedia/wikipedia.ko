...
**어휘기능문법** (Lexical Functional Grammar, LFG) 은 [이론언어학](https://ko.wikipedia.org/wiki/이론언어학 "wikilink")의 이론 틀 중 하나로, 그 이론적 지향에 따라 [생성문법](https://ko.wikipedia.org/wiki/생성문법 "wikilink")과 [구구조문법](https://ko.wikipedia.org/wiki/구구조문법 "wikilink")의 한 유형으로 분류된다. 이 이론은 1970년대에 조안 브레즈넌과 로널드 카플란이 처음 주창한 것으로, [변형문법](https://ko.wikipedia.org/wiki/변형문법 "wikilink")의 이론적 지향에 대한 반발로 시작되었다. 어휘기능문법 학파의 연구는 대체로 [통사론](https://ko.wikipedia.org/wiki/통사론 "wikilink")에 집중되어 있으며, [형태론](https://ko.wikipedia.org/wiki/형태론 "wikilink")과 [의미론](https://ko.wikipedia.org/wiki/의미론 "wikilink")에도 얼마간 관심을 기울인다. 어휘기능문법을 기반으로 한 [음운론](https://ko.wikipedia.org/wiki/음운론 "wikilink") 연구는 거의 존재하지 않는다.
...
예를 들어 *The old woman eats the falafel*라는 문장이 있다면, 이 문장의 c-구조는 먼저 명사구(NP)와 동사구(VP)로 분석된다. 동사구(VP)는 다시 동사(V)와 다른 명사구(NP)로 분석된다. 명사구는 다시 하위 구조로 분석될 수 있다. 분석의 종단 교점에 단어가 삽입됨으로써 문장의 c-구조가 완성된다. 한편 이 문장의 f-구조를 분석하면 문장이 속성(attributes)들, 즉 수, [시제](../Page/시제.md "wikilink") 등의 자질과 [주어](https://ko.wikipedia.org/wiki/주어 "wikilink"), [서술어](https://ko.wikipedia.org/wiki/서술어 "wikilink"), [목적어](https://ko.wikipedia.org/wiki/목적어 "wikilink") 등의 기능 단위로 이루어져 있는 것으로 바라보게 된다.
...
확률론적 어휘기능분석은 [데이터 지향 파싱](https://ko.wikipedia.org/wiki/데이터_지향_파싱 "wikilink")(DOP)의 방법론을 어휘기능문법에 적용한 연구이다. 이 연구 모형에서는 [말뭉치](https://ko.wikipedia.org/wiki/말뭉치 "wikilink")를 어휘기능문법에서 상정하고 있는 개념들로 분석하고, 분석 결과를 다시 문법 이론에 반영하게 된다.
...
## 함께 보기
  ...
  - [핵중심구구조문법](https://ko.wikipedia.org/wiki/핵중심구구조문법 "wikilink")
