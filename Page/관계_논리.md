...
관계 논리를 구현한 [데이터베이스 언어](../Page/데이터베이스_언어.md "wikilink")(질의어)로, [QUEL](https://ko.wikipedia.org/wiki/QUEL "wikilink") 및 [SQL](https://ko.wikipedia.org/wiki/SQL "wikilink"), [Tutorial D](https://ko.wikipedia.org/wiki/Tutorial_D "wikilink") 등이 있다. 그러나 SQL은 관계 논리를 완전한 형태로 구현하지 않는다고 비판하는 의견도 있다.
