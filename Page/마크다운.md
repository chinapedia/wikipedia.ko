...
[존 그루버는](https://ko.wikipedia.org/wiki/존_그루버 "wikilink") 2004년에 문법 면에서 [에런 스워츠와](../Page/에런_스워츠.md "wikilink") 중대한 협업을 통해 마크다운 언어를 만들었으며\[2\]\[3\], 사람들이 읽기 쉽고 쓰기 쉬운 플레인 텍스트 포맷을 사용하여 쓸 수 있으면서 구조적으로 유효한 [XHTML](../Page/XHTML.md "wikilink")(또는 HTML)로 선택적 변환이 가능하게 하는 것이 목표이다.\[4\]
