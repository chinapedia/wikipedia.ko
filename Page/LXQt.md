...
**LXQt**는 완전한 [데스크톱 환경을](https://ko.wikipedia.org/wiki/데스크톱_환경 "wikilink") 제공하는 것을 목표로 하는, 개발 중인 소프트웨어 패키지의 번들이다. [LXDE](https://ko.wikipedia.org/wiki/LXDE "wikilink")과 [Razor-qt](https://ko.wikipedia.org/wiki/Razor-qt "wikilink") 프로젝트의 병합을 통해 만들어졌다.

## 역사

[GTK+](https://ko.wikipedia.org/wiki/GTK+ "wikilink") 3에 만족하지 못한\[1\] [LXDE](https://ko.wikipedia.org/wiki/LXDE "wikilink")의 유지보수자 Hong Jen Yee는 2013년 초에 [Qt를](https://ko.wikipedia.org/wiki/Qt_\(프레임워크\) "wikilink") 실험하였으며\[2\] 2013년 3월 26일 최초 버전의 Qt 기반 [PCManFM](https://ko.wikipedia.org/wiki/PCManFM "wikilink")을 출시하였다.\[3\] 그러나 그는 "Gtk+와 Qt 버전은 공존할 것이다"라고 못박았다. 나중에 그는 LXDE의 [Xrandr](https://ko.wikipedia.org/wiki/Xrandr "wikilink") 프론트엔드를 Qt로 [이식하였다](https://ko.wikipedia.org/wiki/이식_\(컴퓨팅\) "wikilink").\[4\]
...
| ----- | ---------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 0.7.0 | 2014-05-07\[12\] |                                                                                                                                                                                                 |
| 0.8.0 | 2014-10-13\[13\] | 완전한 [Qt 5](https://ko.wikipedia.org/wiki/Qt_\(프레임워크\) "wikilink") [호환성](https://ko.wikipedia.org/wiki/컴퓨터_호환성 "wikilink")                                                                       |
| 0.9   | 2015-02-08       | 상당한 내부 정리 및 [리팩터링](https://ko.wikipedia.org/wiki/리팩터링 "wikilink") 처리. Qt 4 호환 지원이 중단되어 Qt 5 및 [KDE 프레임워크](https://ko.wikipedia.org/wiki/KDE_프레임워크 "wikilink") 5 필요. Qt 5.3이 현재 최소 요구 버전임.\[14\] |
| 0.10  | 2015-11-02\[15\] |                                                                                                                                                                                                 |
| 0.11  | 2016-09-24\[16\] |                                                                                                                                                                                                 |
...
## 외부 링크
  ...
  -
[LXDE](https://ko.wikipedia.org/wiki/분류:LXDE "wikilink") [분류:2013년 소프트웨어](https://ko.wikipedia.org/wiki/분류:2013년_소프트웨어 "wikilink")
...
16.
17.
18. <http://lxqt.org/release/2017/09/22/libqtxdg-300/>