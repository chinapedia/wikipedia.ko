...
[호몰로지 대수학에서](https://ko.wikipedia.org/wiki/호몰로지_대수학 "wikilink"), **뱀 완전열**(-完全列, )은 아벨 대상의 [아벨 범주](https://ko.wikipedia.org/wiki/아벨_범주 "wikilink") 속의 6개의 대상들 사이의 가환하는 사상으로부터, 사상들의 [핵과](https://ko.wikipedia.org/wiki/핵_\(수학\) "wikilink") [여핵](https://ko.wikipedia.org/wiki/여핵 "wikilink")들 사이를 연결하는 [완전열](https://ko.wikipedia.org/wiki/완전열 "wikilink")이다.

## 정의

[아벨 범주에서](https://ko.wikipedia.org/wiki/아벨_범주 "wikilink"), 다음과 같은 그림이 가환한다고 하자.

  -
    [파일:Snake lemma origin.svg](https://ko.wikipedia.org/wiki/파일:Snake_lemma_origin.svg "wikilink")

여기에서 각 행은 [완전열](https://ko.wikipedia.org/wiki/완전열 "wikilink")이며 0은 [영 대상이다](https://ko.wikipedia.org/wiki/영_대상 "wikilink"). 이 경우, 세 사상 \(a\), \(b\), \(c\)의 [핵과](https://ko.wikipedia.org/wiki/핵_\(수학\) "wikilink") [여핵](https://ko.wikipedia.org/wiki/여핵 "wikilink")들로 구성된 6항 [완전열](https://ko.wikipedia.org/wiki/완전열 "wikilink")이 존재하며, 이를 **뱀 완전열**이라고 한다.\[1\]
...
연결 사상 \(d\)는 만약 \(\mathcal A\)가 [아벨 군](https://ko.wikipedia.org/wiki/아벨_군 "wikilink") 범주의 부분 범주라고 할 경우 구체적으로 다음과 같다.
...
\[d\colon \gamma\mapsto \alpha'+\operatorname{im}a\] 이는 \(\beta\in B\)의 선택에 의존하지 않으며, 또한 연결 사상을 통해 얻는 열이 [완전열](https://ko.wikipedia.org/wiki/완전열 "wikilink")임을 보일 수 있다.
...
그림의 위에 [핵을](https://ko.wikipedia.org/wiki/핵_\(수학\) "wikilink"), 밑에 [여핵](https://ko.wikipedia.org/wiki/여핵 "wikilink")을 추가하여 다음과 같은 그림을 만들자.
...
이들은 서로 쌍대적이다. 즉, [아벨 범주](https://ko.wikipedia.org/wiki/아벨_범주 "wikilink") \(\mathcal A\)에서의 명제 (가)는 [반대 범주](https://ko.wikipedia.org/wiki/반대_범주 "wikilink") \(\mathcal A^{\operatorname{op}}\)에서의 명제 (나)와 같다.
...
구체적으로, [아벨 범주에서](https://ko.wikipedia.org/wiki/아벨_범주 "wikilink"), [사슬 복합체](../Page/사슬_복합체.md "wikilink") \(A_\bullet\), \(B_\bullet\), \(C_\bullet\)가 주어졌다고 하고, 이들이 다음과 같은 [짧은 완전열을](https://ko.wikipedia.org/wiki/짧은_완전열 "wikilink") 이룬다고 하자.
...
\end{matrix}\] 뱀 정리에 따라서, 다음 두 행들은 [완전열](https://ko.wikipedia.org/wiki/완전열 "wikilink")을 이룬다.
...
&{\scriptstyle\partial_n^A}\downarrow&&{\scriptstyle\partial_n^B}\downarrow&&{\scriptstyle\partial_n^C}\downarrow\\
0\to&\ker\partial_n^A&\to&\ker\partial_n^B&\to&\ker\partial_n^C
\end{matrix}\] 이 그림에서 각 열의 핵과 여핵은 각각 [호몰로지](https://ko.wikipedia.org/wiki/호몰로지 "wikilink") \(\operatorname H_{n-1}(-)\)와 \(\operatorname H_n(-)\)이다. 따라서, 여기에 뱀 보조정리를 다시 한 번 더 적용하면, 다음과 같은 긴 완전열을 얻는다.
...
[데이비드 앨빈 북스바움은](https://ko.wikipedia.org/wiki/데이비드_앨빈_북스바움 "wikilink") 1955년 논문\[4\]에서 [아벨 범주의](https://ko.wikipedia.org/wiki/아벨_범주 "wikilink") 개념을 도입하였는데, 이 논문에서 이미 뱀 정리가 등장한다.\[5\]
