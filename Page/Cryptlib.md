...
## 출시 역사
  ...
  - cryptlib 3.4.2 출시일: .\[15\]
  - cryptlib 3.4.1 출시일: .\[16\]
  - cryptlib 3.4.0 출시일: .\[17\]
  - cryptlib 3.3.2 출시일: .\[18\]
  - cryptlib 3.3.1 출시일: .\[19\]
  - cryptlib 3.3 출시일: .\[20\]
  - cryptlib 3.2.3a 출시일: .\[21\]
  - cryptlib 3.2.3 출시일: .\[22\]
  - cryptlib 3.2.2 출시일: .\[23\]
  - cryptlib 3.2.1 출시일: .\[24\]
  - cryptlib 3.2 출시일: .\[25\]
  - cryptlib 3.1 출시일: .\[26\]
...
## 외부 링크
  ...
  -
[분류:암호 소프트웨어](https://ko.wikipedia.org/wiki/분류:암호_소프트웨어 "wikilink") [분류:C 라이브러리](https://ko.wikipedia.org/wiki/분류:C_라이브러리 "wikilink") [분류:자유 보안 소프트웨어](https://ko.wikipedia.org/wiki/분류:자유_보안_소프트웨어 "wikilink") [분류:크로스 플랫폼 소프트웨어](https://ko.wikipedia.org/wiki/분류:크로스_플랫폼_소프트웨어 "wikilink") [분류:OpenPGP](https://ko.wikipedia.org/wiki/분류:OpenPGP "wikilink") [분류:전송 계층 보안 구현](https://ko.wikipedia.org/wiki/분류:전송_계층_보안_구현 "wikilink")

1.
2.
3.  <http://www.cryptlib.com/>
4.  Disabled by default due to its insecurity
5.  Disabled by default due to it being patented
6.  Disabled by default due to it being obsolete
7.
8.
9.
10.
