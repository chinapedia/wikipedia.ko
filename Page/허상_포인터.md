...
[섬네일](https://ko.wikipedia.org/wiki/파일:Dangling_Pointer.pdf "wikilink") **허상 포인터**(Dangling pointer) 그리고 **와일드 포인터**(wild pointers)는 [컴퓨터 프로그래밍에서](https://ko.wikipedia.org/wiki/컴퓨터_프로그래밍 "wikilink") 적절한 타입의 유효한 객체를 가리키고 있지 않는 [포인터를](https://ko.wikipedia.org/wiki/포인터_\(프로그래밍\) "wikilink") 말한다. 이것들은 [메모리 보안](../Page/메모리_보안.md "wikilink") 위반의 특별한 경우들이다. 일반적으로 허상 포인터는 인터넷의 [죽은 링크 (link rot)](https://ko.wikipedia.org/wiki/죽은_링크 "wikilink") 형상들처럼 유효하지 않은 목적지 주소에 대한 [참조](https://ko.wikipedia.org/wiki/참조 "wikilink")이다.
