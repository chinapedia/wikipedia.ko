...
`       else`
`           errorcats = errorcats .. ''`
`           errorcats = errorcats .. 'Error: Goals/Progression mismatch: S1 = ' .. s1 .. ' S2 = ' .. s2 .. ' GT1 = ' .. (gt1[k] or '') .. ' GT2 = ' .. (gt2[k] or '') .. '`
`'`
`       end`
`   end`
`   if not (#gt1 == #pt) or not(#gt2 == #pt) then`
`       errorcats = errorcats .. ''`
`       errorcats = errorcats .. 'Error: Goals/Progression mismatch: N1 = ' .. #gt1 .. ' N2 = ' .. #gt2 .. ' PN = ' .. #pt .. '`
`'`
`   end`
...
`   cell:wikitext(isnotempty(args['time']) and '`
`' .. args['time'] or '')`
`   -- Team 1`
`   cell = row:tag('td')`
`       :css('width', '25%')`
...
`           cell:tag('b'):wikitext('[' .. args['reference'] .. ' 경기 참조]')`
`       end`
`       -- Empty spacing`
...
`           soshots1 = table.concat(mysplit(args['soshots1'] or ''), '`
`')`
`           soshots2 = table.concat(mysplit(args['soshots2'] or ''), '`
`')`
`           row = root:tag('tr'):css('font-size', '85%')`
`           row:tag('td')`
`               :css('width', '25%')`
...
`               :css('vertical-align', 'top')`
`               :css('text-align', 'center')`
`               :tag('i'):wikitext('`[`Shootout`](https://ko.wikipedia.org/wiki/Overtime_\(ice_hockey\)#Shootout "wikilink")`')`
`           row:tag('td')`
`               :css('width', '25%')`
`               :css('vertical-align', 'top')`
`               :css('text-align', 'left')`
...
`           cell:tag('i'):wikitext(args['penalties1'] .. ' 분')`
`       end`
`       cell = row:tag('td')`
`           :css('width', '15%')`
`           :css('vertical-align', 'top')`
...
`           cell:tag('i'):wikitext(args['penalties2'] .. ' 분')`
`       end`
`       -- Shots`
`       row = root:tag('tr'):css('font-size', '85%')`
`       cell = row:tag('td')`
...
[Category:Pages_using_icehockeybox_with_improperly_formatted_progression_or_goals](https://ko.wikipedia.org/wiki/Category:Pages_using_icehockeybox_with_improperly_formatted_progression_or_goals "wikilink") [Category:Pages_using_icehockeybox_with_improperly_formatted_progression_or_goals](https://ko.wikipedia.org/wiki/Category:Pages_using_icehockeybox_with_improperly_formatted_progression_or_goals "wikilink") [Category:Pages_using_icehockeybox_with_the_note_parameter](https://ko.wikipedia.org/wiki/Category:Pages_using_icehockeybox_with_the_note_parameter "wikilink") [Category:Pages_using_icehockeybox_with_improperly_formatted_progression_or_goals](https://ko.wikipedia.org/wiki/Category:Pages_using_icehockeybox_with_improperly_formatted_progression_or_goals "wikilink")