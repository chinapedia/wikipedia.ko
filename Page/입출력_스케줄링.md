...
[thumb](https://ko.wikipedia.org/wiki/파일:IO_stack_of_the_Linux_kernel.svg "wikilink") 스토리지 스택 내의 입출력 스케줄러의 위치.\[1\]\]\] **입출력 스케줄링**(I/O scheduling)은 [운영 체제가](https://ko.wikipedia.org/wiki/운영_체제 "wikilink") [다수의 프로세스들로부터](../Page/프로세스.md "wikilink") 디스크를 읽거나 쓰려는 요청을 받았을 때, 우선순위를 정해주고 이를 관리하는 것을 말한다.

## 원리

[디스크 제어기](https://ko.wikipedia.org/wiki/디스크_제어기 "wikilink") 내에는 디스크 작업에 대한 요청을 저장해 두는 [큐가](https://ko.wikipedia.org/wiki/큐_\(자료_구조\) "wikilink") 있다. 이 큐에 있는 작업의 순서를 적절히 조절함으로써 스케줄링이 가능하다.
