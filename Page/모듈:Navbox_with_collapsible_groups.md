> This article is converted from Wikipedia: [모듈:Navbox with collapsible groups](https://ko.wikipedia.org/wiki/모듈:Navbox_with_collapsible_groups).
...
`   local pargs = require('Module:Arguments').getArgs(frame, {wrappers = {'틀:접이식 묶음 둘러보기 상자'}})`
