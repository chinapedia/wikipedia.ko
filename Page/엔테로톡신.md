...
베타-손잡이방향 도메인은 SCOP 데이터베이스에 의해 확인된 바에 따르면 면역글로불린 결합 도메인, 유비퀴틴, 2Fe-2 S 페레독신과 번역개시인자 3 등에 있는 베타-손잡이 방향 모티프와 구조적 유사성을 보인다.
  ...
  - *[Staphylococcus aureus](https://ko.wikipedia.org/wiki/황색포도상구균 "wikilink")* (Staphylococcal Enterotoxin B)\[7\]
  - *Yersinia enterocolitica*
  - *Shigella dysenteriae* (Shiga toxin)\[8\]

### 바이러스성 엔테로톡신

  - *[Rotavirus](https://ko.wikipedia.org/wiki/로타바이러스 "wikilink")* (NSP4)
