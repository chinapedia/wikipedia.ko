...
[대수기하학](https://ko.wikipedia.org/wiki/대수기하학 "wikilink")에서, **인자**(因子, ) 또는 **베유 인자**(Weil因子, )는 [여차원](https://ko.wikipedia.org/wiki/여차원 "wikilink")이 1인 부분 대수다양체들의 정수 계수 형식적 [선형 결합이다](https://ko.wikipedia.org/wiki/선형_결합 "wikilink"). 특별한 경우, 이를 함수의 영점 또는 특이점으로 여겨 이에 [카르티에 인자](../Page/카르티에_인자.md "wikilink") 및 [가역층](../Page/가역층.md "wikilink")을 대응시킬 수 있다.
...
[국소 뇌터](https://ko.wikipedia.org/wiki/국소_뇌터_스킴 "wikilink") [정역 스킴](https://ko.wikipedia.org/wiki/정역_스킴 "wikilink") \(X\)의 **소인자**(素因子, ) \(Z\subset X\)는 다음 조건을 만족시키는 \(X\)의 [닫힌 부분 스킴이다](https://ko.wikipedia.org/wiki/닫힌_부분_스킴 "wikilink").\[1\]
  ...
  - [여차원](https://ko.wikipedia.org/wiki/여차원 "wikilink")이 1이다. 즉, \(Z\)의 [일반점](../Page/일반점.md "wikilink")이 \(z\in Z\)라고 하면, [줄기](../Page/줄기_\(수학\).md "wikilink") \(\mathcal O_{X,z}\)의 [크룰 차원이](https://ko.wikipedia.org/wiki/크룰_차원 "wikilink") 1차원이다.

이는 [가환환](https://ko.wikipedia.org/wiki/가환환 "wikilink")의 [높이가](https://ko.wikipedia.org/wiki/아이디얼의_높이 "wikilink") 1인 [소 아이디얼의](../Page/소_아이디얼.md "wikilink") 개념의 일반화이다.

\(X\)의 소인자들의 집합을 \(\operatorname{PrimeDiv}(X)\)라고 하자. 그렇다면, 다음과 같은 [아벨 군의](https://ko.wikipedia.org/wiki/아벨_군 "wikilink") [직접곱](../Page/직접곱.md "wikilink")을 생각하자.
...
\[\mathbb Z^{\times \operatorname{PrimeDiv}(X)}\] (이는 [자유 아벨 군보다](../Page/자유_아벨_군.md "wikilink") 더 큰 군이다.) 그 원소 \(\textstyle\sum_{Z\in\operatorname{PrimeDiv}(X)}n_ZZ\) 가운데 다음 조건을 만족시키는 것을 **베유 인자**라고 한다.
  ...
  - (국소 유한성) 임의의 \(x\in X\)에 대하여, [집합](https://ko.wikipedia.org/wiki/집합 "wikilink") \(\{Z\in\operatorname{PrimeDiv}(X)\colon n_Z\ne0,\;U\cap Z\ne\varnothing\}\)이 [유한 집합이](https://ko.wikipedia.org/wiki/유한_집합 "wikilink") 되는 [근방](../Page/근방.md "wikilink") \(U\ni x\)가 존재한다.

베유 인자들은 \(\mathbb Z^{\times \operatorname{PrimeDiv}(X)}\)의 [부분군](https://ko.wikipedia.org/wiki/부분군 "wikilink")을 이루며, 이를 \(X\)의 **베유 인자군**(Weil因子群, ) \(\operatorname{Div}(X)\)라고 한다.
...
[국소 뇌터](https://ko.wikipedia.org/wiki/국소_뇌터_스킴 "wikilink") [정역 스킴](https://ko.wikipedia.org/wiki/정역_스킴 "wikilink") \(X\)의 **효과적 베유 인자**(效果的Weil因子, )는 모든 계수가 음이 아닌 정수인 베유 인자이다. 이는 덧셈에 대하여 [모노이드](https://ko.wikipedia.org/wiki/모노이드 "wikilink")를 이룬다.
...
\[\Gamma(X,\mathcal K_X)\to\operatorname{Div}(X)\] 는 두 [아벨 군](https://ko.wikipedia.org/wiki/아벨_군 "wikilink") 사이의 [군 준동형을](https://ko.wikipedia.org/wiki/군_준동형 "wikilink") 이룬다. 그 [여핵](https://ko.wikipedia.org/wiki/여핵 "wikilink")을 **베유 인자 유군**(Weil因子類群, )이라고 한다. 즉, 다음과 같은 아벨 군의 [완전열](https://ko.wikipedia.org/wiki/완전열 "wikilink")이 존재한다.
...
\[\Gamma(X;\mathcal K_X^\times)\to\operatorname{Div}(X)\] 을 정의하며, 그 [여핵](https://ko.wikipedia.org/wiki/여핵 "wikilink")을 **베유 인자 유군** \(\operatorname{DivCl}(X)\)이라고 한다. 즉, 다음과 같은 아벨 군의 [완전열](https://ko.wikipedia.org/wiki/완전열 "wikilink")이 존재한다.
...
임의의 [뇌터](https://ko.wikipedia.org/wiki/뇌터_스킴 "wikilink") [분리](https://ko.wikipedia.org/wiki/분리_스킴 "wikilink") [정규 스킴](../Page/정규_스킴.md "wikilink") \(X\)에 대하여, [카르티에 인자군에서](https://ko.wikipedia.org/wiki/카르티에_인자군 "wikilink") 베유 인자군으로 가는 표준적인 [단사](https://ko.wikipedia.org/wiki/단사_함수 "wikilink") [군 준동형이](https://ko.wikipedia.org/wiki/군_준동형 "wikilink") 존재한다.\[3\]

\[\operatorname{CaDiv}(X)\to\operatorname{Div}(X)\] 이에 따라, [카르티에 인자군은](https://ko.wikipedia.org/wiki/카르티에_인자군 "wikilink") 베유 인자군의 [부분군](https://ko.wikipedia.org/wiki/부분군 "wikilink")이며, 이 부분군은 구체적으로 다음 조건을 만족시키는 베유 인자 \(D\)로 구성된다.\[4\]

  - \(X\)의 충분히 섬세한 [열린 덮개](https://ko.wikipedia.org/wiki/열린_덮개 "wikilink") \(\{U_i\}_{i\in I}\)에 대하여, \(D|_{U_i}\)는 \(U_i\)의 베유 주인자이다.

즉, [카르티에 인자는](../Page/카르티에_인자.md "wikilink") 국소적으로 베유 주인자가 되는 베유 인자이다. 이 준동형이 동형을 이룰 [필요 충분 조건은](https://ko.wikipedia.org/wiki/필요_충분_조건 "wikilink") \(X\)의 구조층의 모든 [줄기가](../Page/줄기_\(수학\).md "wikilink") [유일 인수 분해 정역인](https://ko.wikipedia.org/wiki/유일_인수_분해_정역 "wikilink") 것이다. 특히, [비특이 대수다양체의](https://ko.wikipedia.org/wiki/비특이_대수다양체 "wikilink") 경우에는 [카르티에 인자군과](https://ko.wikipedia.org/wiki/카르티에_인자군 "wikilink") 베유 인자군이 서로 동형이다.
...
[리만 곡면](https://ko.wikipedia.org/wiki/리만_곡면 "wikilink") 위의 모든 가역층은 유한 개의 영점을 갖는 대역적 단면을 갖은 가역층들과 이러한 가역층의 역원들의 텐서곱으로 표현될 수 있다. (다시 말해, 유효 인자의 [가환 모노이드는](https://ko.wikipedia.org/wiki/가환_모노이드 "wikilink") 인자 유군 전체를 생성한다.) 또는, 이러한 대역적 단면을 갖지 않은 가역층의 경우, ‘유리형’ 단면의 개념을 도입하여, 유한 개의 극점과 영점을 갖는 유리형 단면으로써 그 인자를 정의할 수 있다.
...
| 베유 인자의 [아벨 군](https://ko.wikipedia.org/wiki/아벨_군 "wikilink")                       | [인자 아이디얼의](https://ko.wikipedia.org/wiki/인자_아이디얼 "wikilink") [아벨 군](https://ko.wikipedia.org/wiki/아벨_군 "wikilink") \(\operatorname{DivIdeal}(D)\) (=높이 1의 [소 아이디얼로](../Page/소_아이디얼.md "wikilink") 생성되는 아벨 군) |
| 베유 주인자                                                                             | (가역) [주 분수 아이디얼의](https://ko.wikipedia.org/wiki/주_분수_아이디얼 "wikilink") [아벨 군](https://ko.wikipedia.org/wiki/아벨_군 "wikilink") \(\operatorname{PrFracIdeal}(D)^\times\)                                         |
...
예를 들어, [정수환](https://ko.wikipedia.org/wiki/정수환 "wikilink")의 [스펙트럼](../Page/환의_스펙트럼.md "wikilink") \(\operatorname{Spec}\mathbb Z\)에서, 베유 인자들은 양의 [유리수](https://ko.wikipedia.org/wiki/유리수 "wikilink")와 [일대일 대응하며](https://ko.wikipedia.org/wiki/일대일_대응 "wikilink"), 이 경우 유리수
...
| -------- | -------------------------------------------------------- |
| 베유 인자    | 양의 유리수                                                   |
| 소인자      | [소수](https://ko.wikipedia.org/wiki/소수_\(수론\) "wikilink") |
| 유효 베유 인자 | 양의 정수                                                    |
| 베유 인자의 합 | 유리수의 곱셈                                                  |
| 주인자      | 양의 유리수                                                   |
...
이름에서도 알 수 있듯, 인자의 개념은 [수론](https://ko.wikipedia.org/wiki/수론 "wikilink")에서 유래하였다. 인자의 개념의 역사는 [레오폴트 크로네커의](https://ko.wikipedia.org/wiki/레오폴트_크로네커 "wikilink") **인자 이론**()에서부터 시작되었다. 이는 오늘날 환론에서 쓰이는 [리하르트 데데킨트의](https://ko.wikipedia.org/wiki/리하르트_데데킨트 "wikilink") [아이디얼](../Page/아이디얼.md "wikilink") 이론을 일반화하는 이론이었다. [에른스트 쿠머는](https://ko.wikipedia.org/wiki/에른스트_쿠머 "wikilink") 크로네커의 이론을 추상화하여 [데데킨트 정역의](../Page/데데킨트_정역.md "wikilink") [인자 아이디얼의](https://ko.wikipedia.org/wiki/인자_아이디얼 "wikilink") 개념을 도입하였다.

[앙드레 베유는](https://ko.wikipedia.org/wiki/앙드레_베유 "wikilink") 데데킨트 정역의 인자 아이디얼의 개념을 [대수다양체](https://ko.wikipedia.org/wiki/대수다양체 "wikilink")에 일반화하여, 베유 인자를 도입하였다.\[7\]
