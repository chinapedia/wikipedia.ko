> This article is converted from Wikipedia: [플로이드-스타인버그 디더링](https://ko.wikipedia.org/wiki/플로이드-스타인버그_디더링).


**플로이드-스타인버그 디더링**은 1976년 [로버트 플로이드와](../Page/로버트_플로이드.md "wikilink") [루이스 스타인버그가](https://ko.wikipedia.org/wiki/루이스_스타인버그 "wikilink") 고안한 영상 [디더링](https://ko.wikipedia.org/wiki/디더링 "wikilink") 알고리듬이다. 이는 영상 편집 소프트웨어에서 널리 쓰이는데, 예를 들어 최대 256색만을 지원하는 [GIF](../Page/GIF.md "wikilink") 형식으로 영상을 저장하기 위해 변환할 때 쓰일 수 있다.
