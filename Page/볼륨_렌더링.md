...
[섬네일과](https://ko.wikipedia.org/wiki/파일:CTSkullImage.png "wikilink") [난반사](https://ko.wikipedia.org/wiki/난반사 "wikilink")를 이용해 볼륨 렌더링된 해골 머리\]\] [섬네일](https://ko.wikipedia.org/wiki/파일:CTWristImage.png "wikilink") 스캔본. 근육, 뼈, 지방, 혈액에 각각 다른 색상을 부여했다.\]\] 과학적 시각화와[ 컴퓨터 그래픽스](https://ko.wikipedia.org/wiki/컴퓨터_그래픽스 "wikilink") 분야에서, **볼륨 렌더링**은 3차원 스칼라 장 형태의 이산 샘플링 데이터를 2차원 투시로 보여주는 기술을 말한다.
...
1.  Marc Levoy, "Display of Surfaces from Volume Data", [IEEE](https://ko.wikipedia.org/wiki/전기_전자_기술자_협회 "wikilink") CG\&A, May 1988.
2.
