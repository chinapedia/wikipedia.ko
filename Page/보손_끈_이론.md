...
**보손 끈 이론**(boson끈理論, )은 [초대칭](https://ko.wikipedia.org/wiki/초대칭 "wikilink")을 도입하지 않은 [끈 이론이다](https://ko.wikipedia.org/wiki/끈_이론 "wikilink").
...
\[S[X^\mu]=-T\int d^2\xi\;\sqrt{-\det h}\] 이나, 이는 제곱근 때문에 [양자화](https://ko.wikipedia.org/wiki/양자화 "wikilink")가 어렵다. 따라서 세계면 계량 텐서를 [보조장](https://ko.wikipedia.org/wiki/보조장 "wikilink")으로 승격시킨 [폴랴코프 작용](../Page/폴랴코프_작용.md "wikilink")

\[S[X^\mu,h_{ab}]=-\frac12T\int d^2\xi\;\sqrt{-\det h}h^{ab}\partial_aX\cdot\partial_bX\] 를 쓴다. 여기서 \(T=1/(2\pi\alpha')\)는 작용을 무차원화시키기 위한 상수로서, 끈의 [장력](https://ko.wikipedia.org/wiki/장력 "wikilink") 또는 에너지 밀도를 나타낸다. \(\alpha'\)는 **레제 기울기**() 또는 "알파 프라임"으로 불리는 상수다.
...
\[(\partial_0\pm\partial_1X)^2=0\] 을 얻는다. 운동 방정식은 단순히 [파동 방정식이므로](https://ko.wikipedia.org/wiki/파동_방정식 "wikilink"), 경계 조건이 주어지면 간단히 풀 수 있다. 우선 닫힌 끈의 경우 \(X^\mu(\xi^0,\xi^1)=X^\mu(\xi^0,\xi^1+2\pi)\)의 주기성 (periodicity) 조건을 주자. 그리고 편의상 [빛원뿔 좌표계](../Page/빛원뿔_좌표계.md "wikilink")
...
\[X^\mu_\mathrm R(\xi^-)=\frac12x^\mu+\frac12\alpha'p^\mu+\sqrt{\frac{\alpha'}2}\sum_{n\ne0}\frac1n\exp(-\mathrm in\xi^-)\beta_n^\mu\] 이 된다. 여기서 \(p^\mu\)는 [뇌터 정리를](../Page/뇌터_정리.md "wikilink") 쓰면 끈의 [운동량](https://ko.wikipedia.org/wiki/운동량 "wikilink")임을 알 수 있다. 방식으로 전개한 이 표현에 게이지 조건 \((\partial_\pm X)^2=0\)을 적용하면 임의의 \(m\in\mathbb Z\)에 대하여
...
보손 끈 이론은 1960년대에 [끈 이론](https://ko.wikipedia.org/wiki/끈_이론 "wikilink") 가운데 최초로 발견되었다. 이는 원래 [강입자](../Page/강입자.md "wikilink")의 스펙트럼을 설명하기 위하여 등장하였다. 현대적인 용어로, [중간자](https://ko.wikipedia.org/wiki/중간자 "wikilink")를 구성하는 두 쿼크를 잇는 [글루온](../Page/글루온.md "wikilink")은 마치 끈처럼 행동하며, 그 진동 모드 스펙트럼을 끈 이론으로 나타낼 수 있다. 이 경우, 상수 \(\alpha'\)은 [중간자](https://ko.wikipedia.org/wiki/중간자 "wikilink")의 질량-스핀 그래프의 기울기로 나타난다. \(\alpha'\)의 이름인 “레제 기울기”는 [툴리오 레제의](../Page/툴리오_레제.md "wikilink") 이름을 땄으며, 여기서 유래하였다.
