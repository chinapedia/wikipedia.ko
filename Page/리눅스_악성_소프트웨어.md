...
**리눅스 악성 소프트웨어**는 [리눅스](https://ko.wikipedia.org/wiki/리눅스 "wikilink") [운영 체제에](https://ko.wikipedia.org/wiki/운영_체제 "wikilink") 영향을 주는 바이러스, 트로이의 목마, 웜 등 여러 종류의 악성 소프트웨어이다. 리눅스, [유닉스](https://ko.wikipedia.org/wiki/유닉스 "wikilink") 및 여러 [유닉스 계열의](https://ko.wikipedia.org/wiki/유닉스_계열 "wikilink") 컴퓨터 운영 체제들은 일반적으로 공격에 잘 보호된다고 여겨지나, [컴퓨터 바이러스에게서](https://ko.wikipedia.org/wiki/컴퓨터_바이러스 "wikilink") 면역된 것은 아니다.\[1\]\[2\]
...
리눅스를 공격하는 악성 소프트웨어들이 최근 몇년 새 급격하게 증가했지만, [카스퍼스키 랩의](https://ko.wikipedia.org/wiki/카스퍼스키_랩 "wikilink") 수석 기술 고문인 Shane Coursen은 "리눅스 악성 소프트웨어의 성장은 단지 점유율의 증가, 특히 데스크탑 운영 체제로서의 성장 때문으로, 운영 체제의 사용은 악성 소프트웨어 개발자의 개발 의욕과 연관되어있다."\[4\]
...
소프트웨어 저장소(Software Repository)는 관리자가 항상 저장소를 점검하기 때문에 소프트웨어 저장소의 사용은 악성 소프트웨어 설치의 위협을 상당히 줄여준다. 뒤이어 안전한 소프트웨어의 배포를 위해 [체크섬](https://ko.wikipedia.org/wiki/체크섬 "wikilink")이라는 것을 사용할 수 있게 되어있다. 이러한 것들은 [중간자 공격을](https://ko.wikipedia.org/wiki/중간자_공격 "wikilink") 이용한 상호간 통신 탈취, ARP poisoning이나 DNS poisoning같은 방향 전환 공격에서 침투될 수 있는 악성 소프트웨어를 찾아 낼 수 있다. [디지털 서명의](https://ko.wikipedia.org/wiki/디지털_서명 "wikilink") 적절한 사용은 공격자의 범위를 상당히 줄여 추가적은 방어선을 구축해준다.
...
이 부분에 대한 우려는 2007년에 [크로스플랫폼](https://ko.wikipedia.org/wiki/크로스플랫폼 "wikilink") 응용 프로그램들의 사용 증가로 인해 생긴 바이러스로 인식되었다. [오픈오피스](https://ko.wikipedia.org/wiki/오픈오피스 "wikilink")를 감염시키는 Badbunny라는 바이러스로 이러한 위협은 최전방으로 나오게 되었다.
...
아래 응용 프로그램들은 실제 리눅스 컴퓨터에대한 위협을 찾는다.
  ...
  - [chkrootkit](https://ko.wikipedia.org/wiki/chkrootkit "wikilink") (무료, [오픈 소스 소프트웨어](https://ko.wikipedia.org/wiki/오픈_소스_소프트웨어 "wikilink"))\[6\]
  - [ESET](https://ko.wikipedia.org/wiki/ESET "wikilink") (proprietary) ( OS X, 윈도 대상 악성프로그램 또한 감지)\[7\]\[8\]\[9\]
  - [rkhunter](https://ko.wikipedia.org/wiki/rkhunter "wikilink") (무료, [오픈 소스 소프트웨어](https://ko.wikipedia.org/wiki/오픈_소스_소프트웨어 "wikilink"))\[10\]
...
리눅스 악성프로그램들은 아래와 같은 메모리 감식툴을 통해 감지(또는 분석)할 수 있다.
  ...
  - Second Look (상용)\[12\]
  - Volatility\[13\] (무료, [오픈 소스 소프트웨어](https://ko.wikipedia.org/wiki/오픈_소스_소프트웨어 "wikilink"))\[14\]
...
### 루트킷
  ...
  - Snakso-A - 64-bit Linux webserver [루트킷](https://ko.wikipedia.org/wiki/루트킷 "wikilink")\[15\]
